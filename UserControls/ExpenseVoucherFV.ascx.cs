...
public partial class UserControls_ExpenseVoucherFV : System.Web.UI.UserControl
{
    ...
    protected void txtRow1_TextChanged(object sender, EventArgs e)
    {
        string rowno;
        int mroww = 0;
        int miroww = 0;
    ...
    protected void dgExpense_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            ((TextBox)e.Item.FindControl("txtVehNo")).Attributes.Add("OnBlur", "javascript:checkVehNo1(" + e.Item.DataSetIndex + "," + ((TextBox)e.Item.FindControl("txtVehNo")).ClientID.ToString() + ");");
        }
    ...
    protected void dgExpense2_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            //string url = "~/UserCOntrols/wfrm_Popup_Vehicle";
            ...
            ((TextBox)e.Item.FindControl("txtVehNo")).Attributes.Add("OnBlur", "javascript:checkVehNo2(" + e.Item.DataSetIndex + "," + ((TextBox)e.Item.FindControl("txtVehNo")).ClientID.ToString() + ");");
    ...
    protected void dgExpense3_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            ((TextBox)e.Item.FindControl("txtVehNo")).Attributes.Add("OnBlur", "javascript:checkVehNo3(" + e.Item.DataSetIndex + "," + ((TextBox)e.Item.FindControl("txtVehNo")).ClientID.ToString() + ");");
        }
    ...
    protected void dgExpense4_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            ((TextBox)e.Item.FindControl("txtVehNo")).Attributes.Add("OnBlur", "javascript:checkVehNo4(" + e.Item.DataSetIndex + "," + ((TextBox)e.Item.FindControl("txtVehNo")).ClientID.ToString() + ");");
        }
    ...
    protected void dgExpenseRepair_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            ((TextBox)e.Item.FindControl("txtVehNo")).Attributes.Add("OnBlur", "javascript:checkVehNo(" + e.Item.DataSetIndex + "," + ((TextBox)e.Item.FindControl("txtVehNo")).ClientID.ToString() + ");");
