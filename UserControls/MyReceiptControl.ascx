<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyReceiptControl.ascx.cs" Inherits="UserControls_MyReceiptControl" %>
		            ...
		            //alert("h....")
		             if(chqdate!=''&&chqno!=''&&transtype=='Bank')
		             {
				            ...
				            { 
		                        ...
		                        if (Flag=="Y")
                    			{
									//alert("i"+document.getElementById(UC_FRM_NM+'Hnd_Party').value+"i")
									//alert("i"+val_arr[9]+"i")
                    			    if(val_arr[8]!="C")
		                           {
		                           ...
		                           else if(val_arr[9] != '' && document.getElementById(UC_FRM_NM+'Hnd_Party').value!=val_arr[9])
                    			   {
                    			    ...
                    			    {
		                                if(parseFloat(document.getElementById(UC_FRM_NM+'Txt_ColAmt').value)>parseFloat(rounditn(val_arr[3],2)))
		                                {
 ...
 <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="90%">
                    ...
                    <tr style="background-color: White">
                     <td style="text-align: left" class="blackfnt">
                        ...
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtChqNo" MaxLength="10" Columns="10" runat="server" BorderStyle="Groove" CssClass="blackfnt" Width="150px" Enabled="False" onblur="javascript:OnBlurChqDetail()" onkeypress="return validAlfaNum(event);" ></asp:TextBox></td>
