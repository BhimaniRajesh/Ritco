<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ExpenseVoucherFV.ascx.cs" Inherits="UserControls_ExpenseVoucherFV" %>
...
<script language="javascript">
 ...
 var mVehiclePopoupPath= "<%=Session["VehiclePopoupPath"]%>";       
    ...
    function checkVehNo1(row_Index,txtVehNo)
    {
        var currentTime = new Date()
        var ConnStr="<%= Session["SqlProvider"] %>";
        var LocBranch="<%= Session["brcd"] %>";
        var str_Index = "";
        if (txtVehNo.value == "")
        {
            txtVehNo="";
...
//            if (document.getElementById("ctl00_MyCPH1_UCMyExpenseVoucher1_dgExpense1_ctl" + str_Index + "_txtVehNo").value == txtVehNo.value)
//            {
...
//            }
        ...
        if (xmlHttpRequest)
        {
            ...
            xmlHttpRequest.open("GET", "wfrm_AJAX_Validator.aspx?Function=CheckVehNo&datetime="+currentTime+"&Vehno=" + txtVehNo.value+"&LocBranch="+LocBranch+"&ConnStr="+ConnStr, false);
            xmlHttpRequest.send(null);
        }	
    }
    function checkVehNo2(row_Index,txtVehNo)
    {
        var currentTime = new Date()
        var ConnStr="<%= Session["SqlProvider"] %>";
        var LocBranch="<%= Session["brcd"] %>";
...
//            if (document.getElementById("ctl00_MyCPH1_UCMyExpenseVoucher1_dgExpense2_ctl" + str_Index + "_txtVehNo").value == txtVehNo.value)
//            {
//                alert("This Part already exist at row " + (intIndex - 1));
//                txtVehNo.value = "";
//                txtVehNo.focus();
...
//            }
    ...
    function checkVehNo3(row_Index,txtVehNo)
    {
        var currentTime = new Date()
        var ConnStr="<%= Session["SqlProvider"] %>";
        var LocBranch="<%= Session["brcd"] %>";
...
//            if (document.getElementById("ctl00_MyCPH1_UCMyExpenseVoucher1_dgExpense3_ctl" + str_Index + "_txtVehNo").value == txtVehNo.value)
//            {
//                alert("This Part already exist at row " + (intIndex - 1));
//                txtVehNo.value = "";
//                txtVehNo.focus();
...
//            }
    ...
    function checkVehNo4(row_Index,txtVehNo)
    {
        var currentTime = new Date()
        var ConnStr="<%= Session["SqlProvider"] %>";
        var LocBranch="<%= Session["brcd"] %>";
...
//            if (document.getElementById("ctl00_MyCPH1_UCMyExpenseVoucher1_dgExpense4_ctl" + str_Index + "_txtVehNo").value == txtVehNo.value)
//            {
//                alert("This Part already exist at row " + (intIndex - 1));
//                txtVehNo.value = "";
//                txtVehNo.focus();
...
//            }
    ...
    function checkVehNo(row_Index,txtVehNo)
    {
        var currentTime = new Date()
        var ConnStr="<%= Session["SqlProvider"] %>";
        var LocBranch="<%= Session["brcd"] %>";
...
//            if (document.getElementById("ctl00_MyCPH1_UCMyExpenseVoucher1_dgExpense_ctl" + str_Index + "_txtVehNo").value == txtVehNo.value)
//            {
//                alert("This Part already exist at row " + (intIndex - 1));
//                txtVehNo.value = "";
//                txtVehNo.focus();
                               ...
                               <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Nature Of Expense">
                                          ...
                                          <asp:TemplateColumn HeaderText="Vehicle No.">
                                               <ItemTemplate>
                                                      <asp:TextBox ID="txtVehNo" CssClass="input"  runat=server  Text='<%#Eval("VehicleNo")%>' OnTextChanged="txtVehNo_TextChanged"></asp:TextBox>
