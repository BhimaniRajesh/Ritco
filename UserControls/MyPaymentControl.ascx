<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyPaymentControl.ascx.cs" Inherits="UserControls_MyPaymentControl" %>
...
function roundit(Num)
	...
	function CheckCashBank()
	{
	    ...
	    if(document.getElementById('ctl00$MyCPH1$UCMyPaymentControl1$ddlPayMode').value == "Cash")
	    {
         ...
         {
            var txtChqAmt=document.getElementById('ctl00$MyCPH1$UCMyPaymentControl1$txtChqAmt');
            var txtNetPay=document.getElementById('ctl00$MyCPH1$UCMyPaymentControl1$txtNetPay');
            if(txtChqAmt!=null && txtNetPay!=null)
            {
            ...
            <ContentTemplate>--%>
                <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
                    <tr style="background-color: White">
                        ...
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtAmtApplA" runat="server" BorderStyle="Groove" CssClass="Blackfnt" Width="80px" ReadOnly=true></asp:TextBox></td><%--Enabled="False"--%>
                    </tr>
                    <tr style="background-color: White">
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;Cash Amount
                        ...
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtCashAmt" runat="server" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="Groove" CssClass="input" Width="80px" ReadOnly=true></asp:TextBox></td><%-->Enabled="False"--%>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;Cash Account
                        </td>
                        <td style="text-align: left" class="blackfnt"> 
                    ...
                    <tr style="background-color: White">
                        ...
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtChqAmt" runat="server"  onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="Groove" CssClass="input" Width="80px" ReadOnly=true ></asp:TextBox></td><%--Enabled="False"--%>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;Bank Account
                        </td>
                        <td style="text-align: left" class="blackfnt">
                    ...
                    <tr style="background-color: White">
                        ...
                        <td style="text-align: left" class="blackfnt">
                            ...
                            <%--<a href="#" onclick="cal.select(ctl00$MyCPH1$UCMyPaymentControl1$txtChqDate,'anchor11','dd/MM/yyyy'); return false;" id="a1" name="anchor11">
                             ...
                             <a href="#" onclick="cal.select(ctl00$MyCPH1$UCMyPaymentControl1$txtChqDate,'anchor99','dd/MM/yyyy'); return false;" id="a1" name="anchor99"><asp:image id="img_Calendar" runat="server" ImageUrl="~/GUI/images/calendar.jpg" BackColor="White" BorderColor="White" ForeColor="White"></asp:image></a>
                    ...
                    <tr style="background-color: White">
                        ...
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtNetPay" runat="server" BorderStyle="Groove" CssClass="input" Width="80px" ReadOnly=true></asp:TextBox>
                            </td><%--Enabled="False"--%>
                    </tr>
                </table>
           <%-- </ContentTemplate>
