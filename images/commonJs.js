...
function validNegativeFloat(e, txtid) {
    var code;
    ...
    if (code == 13 || code == 8 || code == 9 || code==45)
        return true;
...
// Return No of days difference between Start date and End Date
// E.g.,startDt:29/04/2015 and endDt:20/04/2015 then it returns -374
