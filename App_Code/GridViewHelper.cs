...
public class GridViewHelper
{
    ...
    private GridViewRow InsertGridRow(GridViewRow beforeRow, GridViewGroup g)
    {
        ...
        //Total's row's cssclass and back color can be set from here as follows
        newRow.Cells.AddRange(tcArray);
        tbl.Controls.AddAt(newRowIndex, newRow);
        newRow.Cells[0].Text = "Total";
        newRow.Cells[0].Font.Bold = true;
        newRow.Cells[0].HorizontalAlign = HorizontalAlign.Left;    
        newRow.CssClass = "blackfnt";
        newRow.BackColor = System.Drawing.Color.White; 
        return newRow;
    }
    ...
    public string GetDataFieldName(DataControlField field)
    {
        ...
        {
            return (field as HyperLinkField).DataTextField; 
        }
        {
