...
public partial class GUI_UNI_MIS_LocationHirarchy_to : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //String sqlstr = "select '1' as loc_level from webx_location where loccode='" + brcd + "'";
    ...
    protected void cboRO_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (loclevel <= 2)
        {
            sqlstr = " select loccode,loccode + ' : '+ locname from webx_location where loc_level='3' and  report_loc='" + cboRO.SelectedValue.ToString() + "' or loccode='" + cboRO.SelectedValue.ToString() + "'";
            sqlstr1 = " select loccode,loccode + ' : '+ locname from webx_location where (loc_level='4' or loc_level='3') and  (report_loc='" + cboRO.SelectedValue.ToString() + "' or loccode='" + cboRO.SelectedValue.ToString() + "' or report_loc in (select loccode  from webx_location where report_loc='" + cboRO.SelectedValue.ToString() + "'))";
        }
        else
        {
