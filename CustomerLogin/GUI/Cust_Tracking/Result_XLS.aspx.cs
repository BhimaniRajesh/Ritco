...
public partial class GUI_Cust_Tracking_Result_XLS : System.Web.UI.Page
{
    ...
    {
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=CustTracking.xls");
        Response.Charset = "";
