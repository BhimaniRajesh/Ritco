            ...
            <asp:Table runat="server" CellSpacing="1" CssClass="boxbg" Style="width: 100%;">
                ...
                <asp:TableRow BackColor="#ffffff">
                  ...
                  <asp:TableRow BackColor="#ffffff">
                    ...
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">Reassigned Delivery Location </asp:TableCell>
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">
...
***************************************************************************************************************--%>
            ...
            <asp:GridView HorizontalAlign="Center" ID="grvdoc" runat="server" BorderWidth="0"
                ...
                PagerStyle-HorizontalAlign="left" CssClass="boxbg" BackColor="#8ba0e5" HeaderStyle-CssClass="bgbluegrey"
            ...
            <asp:Table ID="tbldocgrid" runat="server" CellSpacing="1" BackColor="#8ba0e5" Style="width: 100%;
                display: none;">
                <asp:TableRow CssClass="bgbluegrey">
...
***************************************************************************************************************--%>
            ...
            <asp:GridView HorizontalAlign="Center" ID="gvdocketdrill" BorderWidth="0" runat="server"
                ...
                CssClass="boxbg" BackColor="#8ba0e5" FooterStyle-CssClass="boxbg" PagerSettings-Mode="NumericFirstLast"
            ...
            <asp:Table ID="tblinvoice" runat="server" CellSpacing="1" BackColor="#8ba0e5" Style="width: 100%;
                display: none;">
                <asp:TableRow CssClass="bgbluegrey">
...
***************************************************************************************************************--%>
            <asp:Table runat="server" CssClass="boxbg" CellSpacing="1" Style="width: 100%;">
                ...
                <asp:TableRow BackColor="#ffffff">
                    ...
                    <asp:TableCell CssClass="blackfnt" align="right">
...
***************************************************************************************************************--%>
                        <asp:Table runat="server" ID="tblcharges" CssClass="boxbg" Visible="false" Style="width: 100%"
                          ...
                          <asp:GridView HorizontalAlign="left" CellPadding="1" ID="grvcharges" runat="server" BorderWidth="0"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Applicable in State" HeaderStyle-CssClass="blackfnt"
                                    ...
                                    <ItemTemplate>
                                    <asp:Label ID="lblcharge1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"chargevalue1") %>' CssClass="blackfnt"></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Applicable in State" HeaderStyle-CssClass="blackfnt"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lbloperand2" runat="server" CssClass="bluefnt" Font-Bold="true"></asp:Label>
                ...
                <asp:TableRow BackColor="#ffffff">
                    ...
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="right">
                        <asp:Label ID="lblsubtoal" Font-Bold="true" runat="server"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow BackColor="#ffffff">
                ...
                <asp:TableRow BackColor="#ffffff">
                    ...
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">Education Cess on Sub Total </asp:TableCell>
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="right">
                ...
                <asp:TableRow BackColor="#ffffff">
                    ...
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">Higher Education Cess on Sub Total </asp:TableCell>
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="right">
                ...
                <asp:TableRow BackColor="#ffffff">
                    ...
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left"><strong><%=sdkt_call %> TOTAL</strong></asp:TableCell>
                    <asp:TableCell CssClass="blackfnt" HorizontalAlign="right">
                        <asp:Label ID="lbldockettotal" Font-Bold="true" runat="server"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </asp:Panel>
