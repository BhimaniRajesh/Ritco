...
public class ChequeDet
{
    ...
    public void OnAccountEntry()
    {
            ...
            arParms[3].Value = HttpContext.Current.Session["FinYear"].ToString().Substring(2,2);
    ...
    public DataSet getChkDepList(string chqNo, string datefrom, string dateto, string finyr, string tablename)
    {
        ...
        arParms[4] = new SqlParameter("@finyear", SqlDbType.VarChar, 50);
        arParms[4].Value = chqNo;

        arParms[5] = new SqlParameter("@Tablename", SqlDbType.VarChar, 50);
        arParms[5].Value = tablename;
    ...
    public void updChequeDeposit(string lstchqno, string lstchqdt, string lstchqamt, DateTime voucherDate, string Narration, string bankAcccode)
    {
        ...
        string date = HttpContext.Current.Session["FinYear"].ToString().Trim().Substring(2,2);
