...
public class GridViewSummary
{
    ...
    private object PerformSum(object a, object b)
    {
        ...
        switch (a.GetType().FullName)
        {
            ...
            case "System.Int32": return Convert.ToInt32(a == System.DBNull.Value ? 0 : a ) + Convert.ToInt32(b == System.DBNull.Value ? 0 : b);
            ...
            case "System.Decimal": return (Convert.ToDecimal(a == System.DBNull.Value ? 0.00 : a)) + (Convert.ToDecimal(b == System.DBNull.Value ? 0.00 : b));
