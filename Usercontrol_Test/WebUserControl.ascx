...
var tottds;	
var val;
	function fcaltotchqamt1(txtchqno,txtchqdt,txtindchqamt,txtonacctamt,txtonacct,txtindclamt,cbopaytype,colamt,txtbanknm,txtbankbrn)
	{
							//alert(txtchqno)
																...
																if(chqno!="")
																{
																	//check for valid cheque date
																		...
																		if(txtchqdt[i].value!="")
																		{
																			...
																			txtbanknm[i].value=txtbanknm[i].value.toUpperCase()
																txtbankbrn[i].value=txtbankbrn[i].value.toUpperCase()
																}
																else
																{
...
function OnBlurChqDetail(txtchqno,txtchqdt,txtindchqamt,txtonacctamt,txtonacct,txtindclamt,cbopaytype,colamt,txtbanknm,txtbankbrn,Party)
	{
		            ...
		            if(chqdate!=''&&chqno!=''&&transtype=='Cheque')
		            {
				           // MyDiv = document.getElementById("divchqamt" + currRow);
				            ...
				            { 
					            ...
					            //ptmscd=Party.value
					            doc.open("GET", "dyn_combo.aspx?Search=onacctmrchq&chqno=" + chqno + "&chqdate=" + chqdate + "&RandText="+arg+"&Party="+Party[currRow].value, false);
					            doc.send(null);
					            //alert(chqno)
				            }	
				             //alert(val)
		                        ...
		                        else if (Flag=="N")
		                        {
		                            ...
		                            txtchqdt[currRow].value=""
		                            txtchqno[currRow].value=""
		                            return false;
		                        }
		            }
...
//alert(cbopaytype.value)
   if(cbopaytype.value=="Cash")
   {
								...
								{
											//chqno=txtchqno[i].value
											txtchqno[i].disabled=true
											txtchqdt[i].disabled=true
											txtindchqamt[i].disabled=true
											txtonacctamt[i].disabled=true
											txtonacct[i].disabled=true
											txtindclamt[i].disabled=true
											txtbanknm[i].disabled=true
											txtbankbrn[i].disabled=true
											colamt.focus()
...
<table border="0" cellspacing="1" cellpadding="4" width="100%" align="center" class="boxbg">
          ...
          <td colspan=4 align="center"><font class="blackfnt">
           Collection Details
				        ...
				        <td >
                            <asp:DropDownList ID="cbopaytype" runat="server" TabIndex="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          <td vAlign="top" colspan="4">
            <table width="100%" border="1" cellspacing="2" cellpadding="2" align="center">
              ...
              <%--  <td> 
                  <div align="center"><font class="blackfnt">Party</font></div>
                </td>--%>
              ...
              <%for(int i=0;i<3;i++)
                ...
                <tr  bgcolor="white">
                    <td align="center">
                        <asp:TextBox ID="txtchqno" TabIndex="1" runat="server" Columns="6" MaxLength="6"     Enabled="false"></asp:TextBox>
                        
                        </td>
                    <td align="center">
                        <asp:TextBox ID="txtchqdt"  TabIndex="1" runat="server" Columns="10" MaxLength="10"    Enabled="false"></asp:TextBox>
                         <%--<a href="#"  onclick="cal.select(ctl00$MyCPH1$chqdetail11$txtchqdt[<%=i %>],'anchor1<%=i %>','dd/MM/yyyy'); return false;"  name="anchor1<%=i %>" id="anchor1<%=i %>" ><img alt="" src="./calendar.jpg" border="0" /> 
                         </a>--%></td>
                    <td align="center">
                        <asp:TextBox ID="txtindchqamt" TabIndex="1" runat="server" Columns="10" MaxLength="10"   Enabled="false"></asp:TextBox>
                    ...
                    <td align="center">
                        <asp:TextBox ID="txtindclamt"  TabIndex="1" runat="server" Columns="10" MaxLength="10"   Enabled="false"></asp:TextBox></td>
                    <td align="center">
                        <asp:TextBox ID="txtbanknm" TabIndex="1" runat="server" Columns="20" MaxLength="50"    Enabled="false"></asp:TextBox></td>
                    <td align="center">
                        <asp:TextBox ID="txtbankbrn"  TabIndex="1" runat="server" Columns="20" MaxLength="50"   Enabled="false"></asp:TextBox></td>
                   <%-- <td align="center">
                        
       <asp:Label Text="" runat="server" ID="LblParty" CssClass="blackfnt"></asp:Label></td>--%>
                </tr>
                <%} %>
                <tr bgcolor="white">
                    <td>
                    ...
                    <td>
                        <asp:DropDownList  TabIndex="1" ID="tdsacccode" runat="server">
