...
public partial class GUI_Finance_Billing_BillEdit_BringBillDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //string qry = "Exec Usp_Get_Date_Rule_Result '" + DocCode + "','" + fn.Mydate1(Value) + "','" + Session["Finyear"].ToString().Substring(2, 2) + "','" + Session["empcd"].ToString() + "'";
        
        /* Following Query Add By Rajesh Bhimani */
        string qry = "Exec Usp_Get_Date_Rule_Result_Ver1 '" + DocCode + "','" + fn.Mydate1(Value) + "','" + Session["Finyear"].ToString().Substring(2, 2) + "','" + Session["empcd"].ToString() + "'";
        //Response.Write(qry);
