<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ViewPrint_Bill_2.aspx.cs" Inherits="GUI_UNI_MIS_Login_View_Login_2" %>
...
<script language="javascript" type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        {
            window.open("../octroi_bill/octroibill_viewprint.aspx?billno=" + arg1 + "&printyn=" + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
        }
                    ...
                    <table border="0" cellpadding="3" style="background-color: #808080; width: 341px;" cellspacing="1" align="left" class="boxbg">
                        ...
                        <tr style="background-color: #FFFFFF">
                            ...
                            <td style="width: 343; height: 6px;">
                                &nbsp;
                                <asp:Label ID="lblbilltype" runat="server" CssClass="blackfnt"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
    ...
    <tr>  
        <asp:GridView ID="GV_Booking" runat="server" align="left" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey" 
            ...
            <Columns>
                ...
                <asp:BoundField  DataField="bgndt"   ItemStyle-Wrap="true"  HeaderText="Bill Date "   > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="ptmscd"   ItemStyle-Wrap="true" HeaderText="Bill Party Code  "      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="ptmsnm"   ItemStyle-Wrap="true" HeaderText="  Bill Party  "      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="billamt"   ItemStyle-Wrap="true" HeaderText="  Bill Amount  "      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                ...
                <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="View/Print" HeaderStyle-Font-Bold="true">
                    ...
                    <ItemTemplate>
                        <label class="blackfnt">
                            ...
                            <a href="Javascript:ViewPrint('<%#DataBinder.Eval(Container.DataItem, "billno")%>',0)">View </a>
                            /<a href="Javascript:ViewPrint('<%#DataBinder.Eval(Container.DataItem, "billno")%>',1)">Print </a>
                        </label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
