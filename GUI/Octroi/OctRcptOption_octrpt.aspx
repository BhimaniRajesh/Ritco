<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="OctRcptOption_octrpt.aspx.cs" Inherits="octroi_OctRcptOption" %>
    ...
    <br />
      ...
      <%--  <tr bgcolor="white" style="height:25px">
        ...
        <tr bgcolor="white" style="height:25px">
            ...
            <td style="width: 339px"><font class="blklnkund">
                        <a href="ViewnPrint/OctroiBill_Step1.aspx">
                            View & Print Octroi Bills
                        </a>
                        </font></td>
       </tr>
        <tr bgcolor="white" style="height:25px">
            ...
            <td style="width: 339px">
                <font class="blklnkund">
                     <a href="ViewnPrint/ManualOctroiMr_Step1.aspx">
                        View & Print Octroi MRs
                     </a>
                </font>
            </td>
       </tr>
