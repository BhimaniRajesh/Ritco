<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="FrmBillDetail_RITCO.aspx.cs" Inherits="GUI_Octroi_ViewOctroiBill_FrmBillDetail_RITCO" %>
...
//        }
    function OpenPopupBillDetailRITCO(Bill_Number) 
        { 
         location.href("BillDetail_RITCO.aspx?Bill_No=" + Bill_Number);
        }
</script>
    ...
    <asp:GridView ID="grvOctroi" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Bill Details">
                ...
                <ItemStyle BackColor="White" HorizontalAlign="Center" />
                <ItemTemplate>
                    <a class="Blackfnt" href="JavaScript:OpenPopupBillDetailRITCO('<%#DataBinder.Eval(Container.DataItem, "BillNo") %>')">
                        <asp:Label ID="lblCL" runat="server" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"BillNo") %>'></asp:Label>
                    </a>
                </ItemTemplate>
            </asp:TemplateField>
