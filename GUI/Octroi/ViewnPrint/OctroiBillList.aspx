...
--%>
              ...
              <%--  <asp:HyperLink  Font-Underline="true" CssClass="blackfnt" NavigateUrl='<%#"OctroiBill_viewPrint.aspx?billno=" + DataBinder.Eval(Container.DataItem,"billno")  %>' Text='<%# DataBinder.Eval( Container.DataItem,"billno") %>' runat="server"></asp:HyperLink>--%>
                 <a href="javascript:popupmenu2('OctroiBill_viewPrint.aspx?billno=<%# DataBinder.Eval( Container.DataItem,"BILLNO") %>&printyn=0')" > <%# DataBinder.Eval(Container.DataItem, "BILLNO")%> </a>
   ...
   <asp:TemplateField HeaderText="Print" >
        ...
        <ItemTemplate>
                <asp:LinkButton ID="lnkview" runat="server">
                    <a href="javascript:popupmenu2('OctroiBill_viewPrint.aspx?billno=<%# DataBinder.Eval( Container.DataItem,"billno") %>&printyn=1')" > Print</a>
                </asp:LinkButton>
