...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"  CodeFile="OctroiBill_Step1.aspx.cs" Inherits="GUI_Octroi_DirectPayVoucher_ViewPrint2"%>
...
//        THIS FUNCTION PERFORMS CLIENT VALIDATION FOR BOTH DATE CONTROLS AND USES isValidDate() FUNCTION
...
=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=
    ...
    <table style="width: 100%">
        <tr>
            <td align="left"  colspan="3">
                <asp:Label ID="lblWelcome" runat="server" Text="View & Print Octrio Bills" CssClass="blackfnt" Font-Bold="true"></asp:Label>
    ...
    <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" width="85%">
          ...
          <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
              ...
              <td style="font-size: 12pt; font-family: Times New Roman; width: 352px;" valign="top" align="left">
                   &nbsp;<asp:TextBox ID="txtoctbillno" runat="server" Style="left: 0px; position: relative;top: 0px" ValidationGroup="billnogroup"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="billnogroup" ControlToValidate="txtoctbillno" runat="server" ErrorMessage="Enter the Location Properly......"></asp:RequiredFieldValidator>
              </td>
              <td valign="top" align="left">
                    <asp:Button  runat="server" ID="lbloctsubmit1" Text="Submit" ValidationGroup="billnogroup" OnClick="btnoctgo_Click"/>
              </td>
          </tr>
          ...
          <tr bgcolor="#ffffff">
              <td align ="right" style="font-size: 12pt; font-family: Times New Roman"><font class="blackfnt"> Enter Location : </font></td>
              <td  align="left" colspan="2">
                  <asp:TextBox ID="txtoctloc" runat="server" Style="left: 0px; position: relative;top: 0px" Width="60px"></asp:TextBox>
                  
                 <input id="btnPopUp" type="button" value="Go" name="custpup12"  runat="server" />
               </td>
           </tr>
           ...
           <tr bgcolor="#ffffff">
               <td align="right" valign="top">
                      <asp:Label ID="lblDateRange1" runat="server" CssClass="blackfnt" Font-Bold="False" Width="120px">Select Bill Date : </asp:Label>
               </td>
               <td colspan="2">
           ...
           <tr bgcolor="#ffffff">
              <td align="center" colspan="3">
                    <asp:Button  runat="server" ID="lbloctsubmit2" Text="Submit" OnClick="lbloctsubmit2_Click"/>
              </td>
           </tr>
       </table>
