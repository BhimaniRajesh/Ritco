...
public partial class GUI_Octroi_ViewnPrint_VendorVoucher_Stept1 : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (optdatetype.Checked == true)
        {
            ...
            FINAL = FINAL + "&docno=" + txtdocno.Text;
            FINAL = FINAL + "&voucherno=" + txtvoucherno.Text;
            ...
            Response.Redirect("VendorVoucherList.aspx?" + FINAL);
        }
