...
public partial class GUI_admin_AirportMaster_dyn_combo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        SqlDataReader dr;
        string sql = "select  isnull(octroi,'N') as octroi,isnull(octroibill,'N') as octroibill,isnull(octroimr,'N') as octroimr ,paybas,docket_mode,* from vw_docket_net where dockno='" + dno + "'";
...
if octroimr='Y'-----Octroi MR already generated 
        ...
        {
            result = "Octroi is Already Paid for this Docket ";
        }
        ...
        else
        {
            ...
            string sql2 = "select octamt as d from WebX_oct_det where dockno='" + dno + "'";
