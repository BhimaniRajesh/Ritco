...
public partial class Finance_Billing_Billcollection_billmr_step2 : System.Web.UI.Page
{
    ...
    string Party_code, fincmplbr, fromdt, Todt, PAYBAS, Financial_Year="";
    string billno_nos;
        ...
        if (ErrMsg == "")
        {
            ...
            try  //  try FOR ALL
            {
               ...
               // conn.Close();
                ...
                chqno = chqno_arr[0];
                chqdt = chq_dtarr[0];
                string MRSCHQNO = chqno;
                string MRSCHQDT1 = chqdt;
                ...
                //conn.Close();
               // conn.Open();
                cmd = new SqlCommand("usp_OctroiBIllTransaction", conn, trn);
                cmd.CommandType = CommandType.StoredProcedure;
                int transno = 3;
                //string finYear = "07";
