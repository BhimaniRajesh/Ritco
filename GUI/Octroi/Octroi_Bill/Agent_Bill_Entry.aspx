<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" EnableEventValidation="false"    CodeFile="Agent_Bill_Entry.aspx.cs" Inherits="octroi_OctCustBillStep2" %>
	     ...
	     //alert(doc.responseText)
	           ...
	           if (res[0]!="OK")
	           {
	            ...
	            rt="";
	             ...
	             var san= document.getElementById("ctl00_MyCPH1_h_dno").value;
	             document.getElementById(san).value="";
	             //document.getElementById(san).focus();
                    ...
                    <tr bgcolor="white" style="height: 25px">
                        ...
                        <td>
                            <font class="blackfnt">Agent Bill number</font>
                             ...
                             <asp:HiddenField ID="h_H" runat="server" />
                    ...
                    <table border="0" cellpadding="1" cellspacing="1" class="boxbg" align="center">
                        <tr bgcolor="white">
                            ...
                            <td style="height: 40px">
                                <asp:TextBox ID="roww" runat="server" Text="10" Width="40px" BorderStyle="Groove" AutoPostBack="True"
