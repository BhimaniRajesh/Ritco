<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"  CodeFile="update_Manual_MR_4.aspx.cs" Inherits="octroi_OctCustBillStep2" %>
    ...
    <tr class="bgbluegrey">
                                <td colspan="3" align="center" style="height: 21px">
                                    <asp:Label ID="lblQry" CssClass="blackfnt" 
                                        Font-Bold="True" runat="server" ForeColor="Red">Following Document has Successfully Generated/Updated</asp:Label>
                                </td>
                            </tr>
