...
public partial class Finance_Billing_Billsubmission_start : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("billsub_step1.aspx?billno=" + billno + "&party_code=" + custcd.ToString() + "&paybas=" + Cbopaybas.SelectedValue.ToString() + "&fromtdate=" + txtDateFrom.Text.ToString() + "&todate=" + txtDateTo.Text.ToString() + "&manualbillno=" + txtmanualbillno.Text.ToString());
