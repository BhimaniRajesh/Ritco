...
public partial class GUI_Octroi_Octroi_Bill_BillListReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sqlstr = "SELECT BILLNO,BBRCD=BBRCD +'~'+(select locname from webx_location a where  a.loccode=BBRCD),BILLAMT,BILLSTATUS,convert(varchar,BGNDT,106) as BGNDT,convert(varchar,BSBDT,106) as BSBDT,convert(varchar,BDUEDT,106) as BDUEDT,convert(varchar,BCLDT,106) as BCLDT FROM webx_billmst WHERE " + sqlstr1 + " and paybas='6'";
