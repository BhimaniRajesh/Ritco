<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ViewPrint_MR_2.aspx.cs" Inherits="GUI_UNI_MIS_Login_View_Login_2" %>
...
<script language="javascript" type="text/javascript">
       ...
       /* function checked(obj)
        {
            ...
            if(txt.checked == true)
            {
                document.getElementById("btn_submit").Visible = true; 
            else
            {
                document.getElementById("btn_submit").Visible = false;
            }
        }*/
    ...
    <script language="javascript" type="text/javascript">
        ...
        {
            window.open("../octroi_mr/mr_summ_popup.aspx?mrsno=" + arg1 + "&printyn=" + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
        }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <br />                                                    
            <p align="left">
                ...
                <asp:Panel ID="p1" runat="server" style="display:none" >
                    <table border="0" cellpadding="3" style="background-color: #808080; width: 341px;" cellspacing="1" align="left" class="boxbg">
                ...
                <asp:Panel ID="p3" runat="server" style="display:none" >
                    <table border="0" cellpadding="3" style="background-color: #808080; width: 343px;" cellspacing="1" align="left" class="boxbg">
                        <tr style="background-color: #ffffff">
    ...
    <tr>  
        <asp:GridView ID="GV_Booking" runat="server" align="left" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey" 
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="View/Print" HeaderStyle-Font-Bold="true">
                    ...
                    <ItemTemplate>
                        <label class="blackfnt">
                            ...
                            <a href="Javascript:ViewPrint('<%#DataBinder.Eval(Container.DataItem, "mrsno")%>',0)">View </a>
                            /<a href="Javascript:ViewPrint('<%#DataBinder.Eval(Container.DataItem, "mrsno")%>',1)">Print </a>
                        </label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
