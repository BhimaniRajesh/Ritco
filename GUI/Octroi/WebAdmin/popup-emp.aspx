<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup-emp.aspx.cs" Inherits="GUI_WebAdmin_popup_emp" %>
            ...
            <asp:DataList ID="DataList1" runat="server" width="90%">
                ...
                <ItemTemplate>
                    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr>
                            <td width="10%" bgcolor="white" align="left">&nbsp;<input name=chk type=radio onclick="Child(this);" value='<%#DataBinder.Eval(Container.DataItem,"empcd") %>' ></td>
                            <td width="30%" bgcolor="white" align="left"><font class="blackfnt">&nbsp;<%#DataBinder.Eval(Container.DataItem, "empcd")%></font></td>
                            <td bgcolor="white" align="left"><font class="blackfnt">&nbsp;<%#DataBinder.Eval(Container.DataItem, "empnm")%></font></td>
                        </tr>
                    </table>
                </ItemTemplate>
            </asp:DataList>
