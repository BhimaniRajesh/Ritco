<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmCriteria.aspx.cs" Inherits="FrmCriteria" %>
...
<body>
    ...
    <asp:ScriptManager EnablePartialRendering="true" runat="server" ID="sm1">
            ...
            <table style="width: 1008px">
                <tr>
                    <td align="left">
                        ...
                        </b><a><font class="blklnkund"><b>Track Docket</b></font></a>
                    </td>
                    <td align="right">
        ...
        <div align="center" style="width: 10in">
            ...
            <br />
            <br />
            <table style="width: 715px; height: 173px;" border="0" cellpadding="5" cellspacing="1"
                class="boxbg">
                <tr bgcolor="white" class="bgbluegrey">
                    <td colspan="4" align="center" class="blackfnt" style="height: 23px">
                        <b>Select Criteria</b>
                    </td>
                </tr>
                <tr bgcolor="white">
                    <td class="blackfnt" valign="top" align="left" style="width: 144px">
                        Select Date</td>
                    <td class="blackfnt" align="left" style="width: 195px">
                    ...
                    <td align="left" class="blackfnt" colspan="2" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server"      UpdateMode="Conditional" RenderMode="Inline">
                            <ContentTemplate>
                                ...
                                <a href="#" onclick="cal.select(txtDateFrom, 'alnkDateFrom', 'dd/MM/yyyy'); return false;"
                                    id="alnkDateFrom">
                                    <img src="../images/calendar.jpg" border="0" alt="" />
                                </a>
                                <asp:TextBox ID="txtDateTo" runat="Server" Width="80"></asp:TextBox>
                                <a href="#" onclick="cal.select(txtDateTo, 'alnkDateTo', 'dd/MM/yyyy'); return false;"
                                    id="alnkDateTo">
                                    <img src="../images/calendar.jpg" border="0" alt="" />
                                </a>
                            </ContentTemplate>
                ...
                <tr>
                    <td colspan="2" align="center" class="bgbluegrey">
                ...
                <tr bgcolor="white">
                    <td align="left" id="trro" runat="server" class="blackfnt" style="width: 144px">
                        Select RO</td>
                    ...
                    <td align="left" id="Td1" runat="server" class="blackfnt" style="width: 203px">
                        Select RO</td>
                    <td class="blackfnt" align="left">
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server"    UpdateMode="Conditional" RenderMode="Inline">
                            <ContentTemplate>
                                <asp:DropDownList ID="CmbRO2" runat="server" OnSelectedIndexChanged="CmbRO2_SelectedIndexChanged"
                                    Width="206px" AutoPostBack="True">
                                </asp:DropDownList></ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                ...
                <tr bgcolor="white">
                    ...
                    <td align="left" class="blackfnt" style="width: 203px">
                        Select Location</td>
                    <td align="left">
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server"  UpdateMode="Conditional" RenderMode="Inline">
                            <ContentTemplate>
                                <asp:DropDownList ID="CmbLoc2" runat="server" Width="153px">
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="CmbRO2" EventName="SelectedIndexChanged" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                </tr>
                ...
                <tr bgcolor="white">
                    ...
                    <td colspan="3" align="left" class="blackfnt">
                        <asp:TextBox ID="txtdockno" runat="server" Width="110px"></asp:TextBox></td>
                </tr>
            </table>
        </div>
        ...
        <div align="center" style="width: 10in">
            <asp:Button ID="BtnSubmit" runat="server" OnClick="BtnSubmit_Click" Text="Submit"
                PostBackUrl="~/GUI/CustomerLogin/FrmDocketDetail.aspx" ForeColor="Black" /><br />
        </div>
