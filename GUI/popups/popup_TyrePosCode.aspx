<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup_TyrePosCode.aspx.cs"
...
<head runat="server">
    <title>Select Tyre Position Code</title>
    <link id="Link1" href="~/GUI/images/style.css" rel="Stylesheet" type="text/css" runat="server" />
     <script type="text/javascript" language="javascript">
         function selectTyrePosCode(obj) 
         {
            var returnValue = obj.value.split("~");
            var hf_Opener_PosCode = document.getElementById("hPosCode").value
            //var hf_Opener_Id = document.getElementById("hSizeId").value
            window.opener.document.getElementById(hf_Opener_PosCode).value=returnValue[0];
        ...
        <div>
            ...
            <table cellspacing="1" style="width: 100%; font-size: 8pt; font-family: Verdana;"  border="1" cellpadding="0">
                ...
                <tr style="background-color: white">
                    ...
                    <asp:HiddenField ID="hPosCode" runat="server" Value=""/>
                        <asp:Label ID="Label1" runat="server" Text="Enter Tyre Position Code:"></asp:Label></td>
                    <td align="left" style="width: 60%">
                        <asp:TextBox ID="txtPosCode" runat="server" Font-Names="Verdana" Font-Size="8pt"></asp:TextBox>
                                     
                   <ajaxToolkit:AutoCompleteExtender
                runat="server" 
                BehaviorID="AutoCompleteEx"
                ID="autoComplete1" 
                TargetControlID="txtPosCode"
                ...
                <tr style="background-color: white">
                    <td align="left" style="height: 56px; width: 100%;" colspan="2">
                        <asp:GridView Width="100%" HeaderStyle-CssClass="dgHeaderStyle" CssClass="dgRowStyle" BorderColor="#8BA0E5"
                            ...
                            AutoGenerateColumns="False" DataKeyNames="TYREPOS_ID" >
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <input type="radio" name="radSelect" onclick="javascript:selectTyrePosCode(this);" value='<%#Eval("TYREPOS_CODE")%>~<%#Eval("TYREPOS_ID")%>' />
                                    </ItemTemplate>
                                    <ControlStyle Width="20%" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="TYREPOS_CODE" HeaderText="Tyre Position Code" ReadOnly="True" SortExpression="TYREPOS_CODE" >
