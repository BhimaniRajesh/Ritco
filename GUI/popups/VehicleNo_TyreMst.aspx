<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VehicleNo_TyreMst.aspx.cs"
                ...
                <tr style="background-color: white">
                    <td align="left" style="height: 56px">
                        ...
                        <asp:GridView Width="100%" HeaderStyle-CssClass="dgHeaderStyle" CssClass="dgRowStyle" BorderColor="#8BA0E5"
                            ...
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <input type="radio" name="radSelect" onclick="javascript:selectVehno(this);" value='<%#Eval("VEHNO")%>~<%#Eval("VEH_INTERNAL_NO")%>~<%#Eval("VehCategory")%>' />
                                    </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlConn" runat="server" ProviderName="System.Data.SqlClient"
                            SelectCommand="select distinct VEHNO,VEH_INTERNAL_NO,
...
webx_vehicle_hdr VH on vh.vehicle_type=vt.type_code WHERE VENDORTYPE='05'">
                        </asp:SqlDataSource>
                    </td>
                </tr>
            </table>
