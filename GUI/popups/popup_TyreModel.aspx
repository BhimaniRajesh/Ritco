<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup_TyreModel.aspx.cs"
...
<head runat="server">
    <title>Select Tyre Model</title>
    <link id="Link1" href="~/GUI/images/style.css" rel="Stylesheet" type="text/css" runat="server" />
     <script type="text/javascript" language="javascript">
         function selectTyreModelNo(obj) 
         {
            var returnValue = obj.value.split("~");
            var hf_Opener_hModelNo = document.getElementById("hModelNo").value
            //var hf_Opener_Id = document.getElementById("hSizeId").value
            window.opener.document.getElementById(hf_Opener_hModelNo).value=returnValue[0];
        ...
        <div>
            ...
            <table cellspacing="1" style="width: 100%; font-size: 8pt; font-family: Verdana;"  border="1" cellpadding="0">
                ...
                <tr style="background-color: white">
                    ...
                    <asp:HiddenField ID="hModelNo" runat="server" Value=""/>
                        <asp:Label ID="Label1" runat="server" Text="Enter Model No:"></asp:Label></td>
                    <td align="left" style="width: 60%">
                        <asp:TextBox ID="txtModelNO" runat="server" Font-Names="Verdana" Font-Size="8pt"></asp:TextBox>
                ...
                <tr style="background-color: white">
                    <td align="left" style="height: 56px; width: 100%;" colspan="2">
                        <asp:GridView Width="100%" HeaderStyle-CssClass="dgHeaderStyle" CssClass="dgRowStyle" BorderColor="#8BA0E5"
                            ...
                            AutoGenerateColumns="False" DataKeyNames="TYRE_MODEL_ID" >
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <input type="radio" name="radSelect" onclick="javascript:selectTyreModelNo(this);" value='<%#Eval("MODEL_NO")%>~<%#Eval("TYRE_MODEL_ID")%>' />
                                    </ItemTemplate>
                                    <ControlStyle Width="20%" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="MODEL_NO" HeaderText="Tyre Model Name" ReadOnly="True" SortExpression="MODEL_NO" >
