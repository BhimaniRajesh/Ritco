...
public partial class GUI_Tracking_New_TAB_Tracking_Docket_Docket_track : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       call_dkt = Session["DocketCalledAs"].ToString();
        ...
        string sql_STstus = " exec  webx_Docket_status_new '" + docket + "' ";
        ...
        //SqlConnection conn = new SqlConnection(Session["SqlProvider"].ToString().Trim());
        //conn.Open();
        string sqlstr3 = "webx_life_cycle_operation_New";
        ...
        while (dr3.Read())
        {
            ...
            lo_docksf = Convert.ToString(dr3["docksf"]);
            ...
            tr3tc6.Text = "<a href=\"JavaScript:OpenPopupWindow1('" + lo_dockno + "','" + lo_docksf + "')\"> View </a>";
        ...
        string sqlstr4 = "WEBX_LifeCycle_Fin_new";
        ...
        while (dr3.Read())
        {
          ...
          //  TR4TC4.ColumnSpan = 5;
            ...
            TR4TC6.Text = "<a href=\"JavaScript:OpenPopupWindow2('" + Convert.ToString(dr3["mrsno"]).Trim() + "')\"><u> " + Convert.ToString(dr3["mrsno"]).Trim() + "</u></a>";
         //   TR4TC6.ColumnSpan = 5;
            TR4TC6.CssClass = "blackfnt";
            TR4.Cells.Add(TR4TC6);
