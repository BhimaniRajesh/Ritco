...
function OpenPopupWindow1(strDocketNo,docsf)
       ...
       // alert(strDocketNo1)
        ...
        {
            var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=830,height=540,status=no,left=60,top=270"
            var strPopupURL = "../../../Operation/Singlescreen_docketentry/DocketPrint/PaidMR/MR_Summ_Popup.aspx?mrsno=" + strDocketNo + ",0"    
            winNew = window.open(strPopupURL, "_blank", strWinFeature)
        }
        function OpenWindow(strMF,view)
        {
            var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"
            var strURL = "../../../Operations/TCS/PrintTCS/FrmMenifestView.aspx?MFNo=" + strMF + ",0"   
            winNew = window.open(strURL,"_blank",strWinFeature)
        }
        ...
        {
            var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"
            var strPopupURL = "../../../Operations/PRS/PRS_View_Print.aspx?PRSNo=" + pdcno + ",0"  
            winNew = window.open(strPopupURL,"_blank",strWinFeature)
        }
        ...
        {
            var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=830,height=540,status=no,left=60,top=270"
            var strPopupURL = "../../../Operation/Singlescreen_docketentry/DocketPrint/PaidMR/MR_Summ_Popup.aspx?mrsno=" + mrsno    
            winNew = window.open(strPopupURL, "_blank", strWinFeature)
        ...
        {
            var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=830,height=540,status=no,left=60,top=270"
            var strPopupURL = "../../../Finance/Billing/BillViewPrint/BillNo_Popup.aspx?Bill_No=" + mrsno    
            winNew = window.open(strPopupURL, "_blank", strWinFeature)
...
<body>
    ...
    <div style="border: 1px solid gray; width: 450px; margin-bottom: 1em; padding: 10px">
        <div id="country1" class="tabcontent">
                ...
                <tr>
                    <td width="48%" valign="top">
                        <table border="0" width="100%" align="center" bgcolor="#808080" cellspacing="1" cellpadding="2"
                            class="boxbg">
            <tr> 
              <td class="bgbluegrey" width="40%"> <font class="blackfnt">Service 
                Type</font></td>
              <td bgcolor="#FFFFFF"> <font class="blackfnt"> <%=Service_Class%> 
                </font> </td>
            </tr>
            <tr> 
              <td nowrap class="bgbluegrey"> <font class="blackfnt">Pkgs/ Charged 
                Weight</font></td>
              <td bgcolor="#FFFFFF"> <font class="blackfnt"> <%=pkgsno%> / <%=chrgwt%> 
                </font> </td>
            </tr>
            <tr> 
              <td class="bgbluegrey"> <font class="blackfnt">Pay Basis</font></td>
              <td bgcolor="#FFFFFF"> <font class="blackfnt"> <%=PAYBASis%> </font> 
              </td>
            </tr>
            <tr> 
              <td class="bgbluegrey"> <font class="blackfnt">Mode</font></td>
              <td bgcolor="#FFFFFF"> <font class="blackfnt"> <%=tranportmode%> 
                </font> </td>
            </tr>
            <tr> 
              <td class="bgbluegrey"> <font class="blackfnt">Consignor Name</font></td>
              <td nowrap bgcolor="#FFFFFF"> <font class="blackfnt"> <%=Cnor%> 
                </font> </td>
            </tr>
            <tr> 
              <td nowrap class="bgbluegrey"> <font class="blackfnt">Consignee 
                Name</font></td>
              <td bgcolor="#FFFFFF"> <font class="blackfnt"> <%=Cnee%> </font> 
              </td>
            </tr>
            <tr>
              <td nowrap class="bgbluegrey"><font class="blackfnt">Recd. Person</font></td>
              <td bgcolor="#FFFFFF"><font class="blackfnt"><%=recd_person%> </font></td>
            </tr>
          </table>
                    </td>
                    <td>
            ...
            <center>
                <table border="0" width="60%" bgcolor="#808080" cellspacing="1" cellpadding="3" class="boxbg">
                    <tr bgcolor="#FFFFFF">
                        <td align="center" width="35%">
                            <font class="blackfnt"><a href="JavaScript:OpenPopupWindow1('<%=dockno%>','<%=docksf%>')" title="View Docket">
        ...
        <div id="country3" class="tabcontent">
            ...
            <br />
            <br />
            <asp:Table ID="TblBillStatus" Visible="true" runat="server" CellPadding="3" CellSpacing="1"
                Style="width: 9.5in;" CssClass="boxbg">
            </asp:Table>
            <br />
            <br />
