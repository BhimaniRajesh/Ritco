<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResultVoucherView.aspx.cs" Inherits="GUI_UNI_Net_MIS_THCAdvVendrBillPay_ResultVoucherView" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                ...
                <ServerReport DisplayName="Market Vehicle"></ServerReport>
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
