<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="RPT_Oneclick.aspx.cs" Inherits="GUI_UNI_Net_MIS_RPT_Oneclick" %>
...
<font class=bluefnt><strong> &gt; </strong>
		  <strong>One Click Fleet Reports</strong> </font></td>
        </tr>
        <tr> 
        ...
        <tr >
        <td align="center">
        <asp:Label ID="Label2"  ForeColor="Red" Text="No Fleet Reports Available For This User" CssClass="blackfnt" runat="server"></asp:Label>
        </td>
        </tr>
        </table>
