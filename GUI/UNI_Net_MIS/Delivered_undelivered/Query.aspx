<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_Net_MIS_Delivered_undelivered_Query" %>
            ...
            <tr>
                <td height="30">
                    <font class="blklnkund"><strong>Module</strong></font> <strong>&gt; </strong><font
                        class="blklnkund"></font><font class="blckfnt">Report &gt; Operation</font><strong><font class="bluefnt">
                            &gt; </strong><strong>Delivered UnDelivered Report</strong> </font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
                        ...
                        <tr style="background-color: white">
                          ...
                          <tr style="background-color: white">
                            ...
                            <td align="left" colspan="2">
                                 ...
                                 <asp:ListItem Text="Detained" Value="Detained"></asp:ListItem>
                                 <asp:ListItem Text="At Booking Location" Value="At Booking Location"></asp:ListItem>
                                   <asp:ListItem Text="In Transit" Value="In Transit"></asp:ListItem>
                                    <asp:ListItem Text="A Waiting For DRS" Value="A Waiting For DRS"></asp:ListItem>
                                 <asp:ListItem Text="Delivered" Value="Delivered"></asp:ListItem>
                                 <asp:ListItem Text="UnDelivered" Value="UnDelivered"></asp:ListItem>
                                  <asp:ListItem Text="Gone For Delivery" Value="Gone For Delivery"></asp:ListItem>
                                    <asp:ListItem Text="At Enroute Location Available For LS/MF" Value="At Enroute Location Available For LS/MF"></asp:ListItem>
