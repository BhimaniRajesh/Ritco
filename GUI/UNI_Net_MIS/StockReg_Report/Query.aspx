<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query.aspx.cs" Inherits="GUI_UNI_MIS_Stock_Report_Query" %>
            ...
            <tr>
                <td height="30">
                    ...
                    <font class="blklnkund"><strong>Reports </strong></font><font class="bluefnt">
                        ...
                        <strong>&gt;</strong>
                        <strong>Stock Register Report</strong> </font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
            ...
            <tr>
                <td valign="top">
                    <table cellspacing="1" style="width: 8.0in" class="boxbg" align="left">
                        ...
                        <tr style="background-color: white">
                            <td align="left">
                                <font class="blackfnt">Select Stock Type </font>
                            </td>
                            <td align="left" colspan="3">
                                <asp:DropDownList ID="cboStockType" runat="server">
                                <asp:ListItem Value="4" Text="All"></asp:ListItem>
                                <asp:ListItem Value="1" Text="Booking"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Delivery"></asp:ListItem>
                                <asp:ListItem Value="3" Text="TransShipment"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
