<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_Net_MIS_TripStatement_Query" %>
        ...
        <table style="width: 10.5in" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
                <td height="30">
                    ...
                    <font class="blklnkund"><strong>Reports </strong></font><font class="bluefnt">
                        <strong>&gt;</strong>
                        <strong>Operation </strong></font><font class="bluefnt">
                        <strong>&gt;</strong>
                        <strong>TripStatement Report</strong> </font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
            ...
            <tr>
                <td valign="top">
                    <table cellspacing="1" style="width: 8.0in" class="boxbg" align="left">
                        ...
                        <tr style="background-color: white">
                            <td align="left">
                                <font class="blackfnt">Select Transport Mode</font>
                            </td>
                            <td align="left" colspan="3">
                                <asp:DropDownList ID="cboTransmode" runat="server">
                                <asp:ListItem Value="1" Text="All"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Air"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Standard"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Train"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Express"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
