...
public partial class GUI_UNI_MIS_BILL_MR_Register_Result : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        if (RPT == "B")
        {
            SQL_STR = "EXEC WebxNet_BILL_Register '" + fromdt + "','" + todt + "','" + RO + "','" + LO + "','" + st_cust_vend + "','" + BM_TYP + "','" + BM_STATUS + "','" + CS_CHQ + "','" + M_L_TYP + "','" + RTP_DT + "','" + OV_DYS + "','" + AMT_G_THAN + "','" + Select_list + "','" + BILLNO_list + "','" + MANBNOLIST + "','" + DKTSNOLIST + "','" + ASONDT + "','" + ASONDT_To + "'";
        }
        else if (RPT == "M")
        {
