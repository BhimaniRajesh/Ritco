...
public partial class GUI_UNI_Net_MIS_Expected_Arrival_Query : System.Web.UI.Page
{
    SqlConnection conn;
    int loclevel;
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        string dateselection = cbmSelectDate.SelectedValue.ToString();
        ...
        sb.Append("win.close ();");
        sb.Append("}");
        sb.Append("window.open('./Result_RS.aspx" + final + "', '_blank',");
