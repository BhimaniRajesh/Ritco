<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_UNI_Net_MIS_Expected_Arrival_Result" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
        ...
        function OpenPopupWindow1(strDocketNo)
            {
                ...
                var strPopupURL ="./Result_Det.aspx?" + strDocketNo    
            ...
            <td height="30">
                <font class="blklnkund"><strong>Module</strong></font> <strong>&gt; </strong><font
                    class="blklnkund"><strong>Reports </strong></font><font class="bluefnt"><strong>&gt;
                        <strong>Operation</strong></font><font class="bluefnt"><strong></strong>&gt;<strong>Expected
                            Arrival Report </strong></font>
            </td>
        </tr>
        <tr>
            <td class="horzblue">
    ...
    <br />
    <br />
    <table id="selection" runat="server" style="width: 10.5in" border="0" align="left"
    ...
    <br />
    <br />
    <table id="Table1" runat="server" style="width: 10.5in" border="0" align="left" cellpadding="0"
        cellspacing="0">
        <tr>
            <td align="left">
                <br />
