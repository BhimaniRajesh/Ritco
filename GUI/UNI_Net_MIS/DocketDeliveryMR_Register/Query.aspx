<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_NET_MIS_DocketDeliveryMR_Register_Query" %>
                ...
                <td height="30">
                    <font class="blklnkund"><strong>Module</strong></font> <strong>&gt; </strong><font
                        class="blklnkund"><strong>Oprations</strong></font><font class="bluefnt"><strong>
                            &gt; </strong><strong>Docket Delivery MR Report</strong> </font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
                    ...
                    <table cellspacing="1" style="width: 9.5in" class="boxbg" align="left">
                        ...
                        <tr style="background-color: white">
                            <td align="left" colspan="2">
                                <font class="blackfnt"><b>Branch Name</b></font>
                            </td>
                            <td align="left" colspan="2">
                        ...
                        <tr style="background-color: white">
                            <td align="left" colspan="2">
                                <font class="blackfnt"><b>Select Date</b></font>
                            </td>
                            <td align="left" colspan="2">
                        ...
                        <tr style="background-color: white;">
                            <td align="left" colspan="2">
                                <font class="blackfnt"><b>Docket No.</b></font>
                            </td>
                            <td align="left" colspan="2">
                                <asp:TextBox runat="server" Text="" ID="txtDocketNo" Width="250"> </asp:TextBox>
                            </td>
                        </tr>
