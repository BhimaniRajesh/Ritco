<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/GUI/UNI_Net_MIS/PODReports/resultRegister.aspx.cs" Inherits="GUI_UNI_Net_MIS_PODReports_resultRegister" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                   ...
                   Height="650px" ShowParameterPrompts="false" ShowBackButton="true" ShowPromptAreaButton="false"
