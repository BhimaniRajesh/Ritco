...
public partial class GUI_UNI_Net_MIS_PODReports_ResultRS : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Type=="C")
            {
                ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportPathPrefix + "/CustomerWiseSummaryReport";
				  ReportViewer1.ShowParameterPrompts = true;
            }
            else
            {
                ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportPathPrefix + "/LocationWiseSummaryReport";
				  ReportViewer1.ShowParameterPrompts = true;
            }
