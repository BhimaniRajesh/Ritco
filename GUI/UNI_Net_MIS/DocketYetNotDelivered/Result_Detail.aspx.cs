...
public partial class GUI_UNI_Net_MIS_DocketYetNotDelivered_Result_Detail : System.Web.UI.Page
{
    SqlConnection Conn;
    ...
    public void BindGrid()
    {
        ...
        string SQL_STR = "exec  WbxNet_Yet_Not_delivered_det '" + Fromdt + "','" + todt + "','" + rptmd + "','" + loc + "'";
