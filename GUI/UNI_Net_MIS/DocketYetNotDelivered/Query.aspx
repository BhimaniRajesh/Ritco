<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_Net_MIS_DocketYetNotDelivered_Query" %>
            ...
            <tr>
                <td height="30">
                    ...
                    <font class="blklnkund"><strong>Reports </strong></font><font class="bluefnt">
                        ...
                        <strong>&gt;</strong>
                        <strong>Stock Report</strong> </font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
