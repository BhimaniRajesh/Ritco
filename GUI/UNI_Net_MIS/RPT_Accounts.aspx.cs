...
public partial class GUI_UNI_Net_MIS_RPT_Accounts : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sqlstr = "select srno,report_name,Link as link_name,'' as link_title,Descp as discription,Subtitle from webx_reports_ver1 where  title='A' and srno in (select reportid from Webx_Master_ReportsAccess_ver1 where HasAccess='Y' and Userid='" + empcd + "') and activeflag='Y' order by subtitle";
        ...
        while (dr.Read())
        {
            ...
            if (st_subtitle.ToUpper() == "A1")
            {
                st_subtitlenm = "Register Reports";
            }
            if (st_subtitle.ToUpper() == "A2")
            {
