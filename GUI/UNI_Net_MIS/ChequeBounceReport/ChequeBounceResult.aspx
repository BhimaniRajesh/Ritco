<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChequeBounceResult.aspx.cs" Inherits="GUI_UNI_Net_MIS_ChequeBounceReport_ChequeBounceResult" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                   ...
                   <ServerReport DisplayName="ChequeBounce Register" ></ServerReport>                
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
