...
public partial class GUI_UNI_Net_MIS_ChequeBounceReport_ChequeBounceReceivedResult : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportPathPrefix + "/ChequeBounceReceivedRegister";
