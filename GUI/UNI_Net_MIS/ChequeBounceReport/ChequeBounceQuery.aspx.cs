...
public partial class GUI_UNI_Net_MIS_ChequeBounceReport_ChequeBounceQuery : System.Web.UI.Page
{
    ...
    {       
        ...
        string final;
        final = "?RO=" + objcboRO.SelectedValue;
        final += "&LO=" + objcboLO.SelectedValue;
        final += "&BankName=" + objDDL_BankList.SelectedValue; 
        final += "&fromdt=" + dtFrom;
        final += "&todt=" + dtTo;
      

        Response.Redirect("ChequeBounceResult.aspx" + final);
