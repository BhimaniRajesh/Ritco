<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChequeBounceReceivedResult.aspx.cs" Inherits="GUI_UNI_Net_MIS_ChequeBounceReport_ChequeBounceReceivedResult" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                   ...
                   <ServerReport DisplayName="ChequeBounce Received Register" ></ServerReport>                
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
