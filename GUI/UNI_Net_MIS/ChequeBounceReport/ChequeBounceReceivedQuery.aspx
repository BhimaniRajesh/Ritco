<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ChequeBounceReceivedQuery.aspx.cs" Inherits="GUI_UNI_Net_MIS_ChequeBounceReport_ChequeBounceReceivedQuery" %>
        ...
        <table style="width: 10.5in" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
                <td height="30">
                    ...
                    </strong><strong>Cheque Bounce Received Amount Register</strong> </font></td>
            </tr>
            <tr>
                <td class="horzblue">
