...
public partial class GUI_UNI_Net_MIS_BIll_MR_Register_ver1_Query : System.Web.UI.Page
{
    ...
    {
        MySQLDataSource_GeneralMaster.ConnectionString = ConfigurationManager.ConnectionStrings["dbConnection"].ConnectionString;
            //  MySQLDataSource_GeneralMaster1.ConnectionString = Session["SqlProvider"].ToString().Trim();
        MySQLDataSource_BILLCHARGES.ConnectionString = ConfigurationManager.ConnectionStrings["dbConnection"].ConnectionString;
        MySQLDataSource_CLLIST_ALL_BILL.ConnectionString = ConfigurationManager.ConnectionStrings["dbConnection"].ConnectionString;
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
       ...
       // }
        ...
        if (MAxSTR_LV == "")
            MAxSTR_LV = "1";
        Guid g = Guid.NewGuid();
        Session[g.ToString()] = Select_list;
