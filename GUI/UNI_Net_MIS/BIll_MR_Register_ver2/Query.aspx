...
<asp:content id="Content1" contentplaceholderid="MyCPH1" runat="Server">
    <asp:sqldatasource id="MySQLDataSource_GeneralMaster" runat="server" selectcommand="Select CodeID='All', CodeDesc='--All--'    Union   Select CodeID, CodeDesc From WebX_Master_General where CodeType IN ('BILLTYP','MRSTYPE') AND LEFT(CodeType,1)=@BM order by CodeDesc"
        selectcommandtype="Text">
        <selectparameters>
            <asp:ControlParameter Name="BM" Type="String" ControlID="documet_type" />
        </selectparameters>
    </asp:sqldatasource>
    <asp:sqldatasource id="MySQLDataSource_BILLCHARGES" runat="server" selectcommand="Webxnet_BILL_REgister_Charges"
    ...
    <asp:sqldatasource id="MySQLDataSource_CLLIST_ALL_BILL" runat="server" selectcommand="Webxnet_BILL_MR_REgister_Charges_CLLIST_Ver1"
        selectcommandtype="StoredProcedure">
        <selectparameters>
            <asp:ControlParameter Name="TYP" Type="String" ControlID="documet_type" />
           <asp:ControlParameter Name="BM_TY" Type="String" ControlID="Bill_Type" />          
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function ShowDKTFilter() { //alert("Hiiiiiiii")
                ...
                <td valign="top">
                    <table cellspacing="1" style="width: 9.5in" class="boxbg" align="left">
                        ...
                        <tr id="Tr1" runat="server" style="background-color: white;">
                            <td align="left">
                                <asp:Label ID="Label12" CssClass="blackfnt" visible="false" Text="Document" runat="server"></asp:Label>
                            </td>
                            <td align="left" colspan="3" valign="top">
                               <asp:RadioButtonList ID="documet_type" visible="false" runat="server" RepeatDirection="horizontal"
                                    CssClass="blackfnt" >
                    ...
                    <tr align="center" bgcolor="white">
                        <td colspan="4">
                             <asp:Button ID="btnDownloadCSV" runat="server" Text="Download Xls" Width="110px"
                    CssClass="blackfnt" Font-Bold="true"  OnClientClick="Javascript:return OnSub_DATACHECK();" OnClick="btnDownloadCSV_Click"/>&nbsp;
