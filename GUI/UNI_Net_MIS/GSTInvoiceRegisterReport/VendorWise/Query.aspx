<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_NET_MIS_GSTInvoiceRegisterReport_VendorWise_Query" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var txtVendorCode = $("#" + controlIdPrefix + "txtVendorCode");
        var txtVendorName = $("#" + controlIdPrefix + "txtVendorName");
        var reqData = {};
        $(document).ready(function () {
            var txtVendorName = $("#" + controlIdPrefix + "txtVendorName");

            AutoCompleteByAjaxVer1("[id*='txtVendorCode']", serviceUrl + 'GetVendor', 'POST', 'application/json; charset=utf-8', 'json', 'searchText', 2, 'vl', 'vl', 'l', 'v', 'ctl00_MyCPH1_txtVendorName', 'No Customer found!', reqData, false);
        ...
        cal.showNavigationDropdowns();
		 ...
		 function OnSubmit() {
            try {
				...
				var txtVendorCode = '<%=txtVendorCode.ClientID%>';
    ...
    <asp:UpdatePanel ID="upSubmit" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        ...
        <tr>
            <td valign="top">
                <br />
                <font class="blklnkund"><strong>Reports &gt;Finance &gt;Account receivable & payable report &gt;</strong></font>
                <font class="blklnkund"><strong>Vendor GST Invoice Register Report</strong></font>
                <br />
                <br />
            </td>
        </tr>
