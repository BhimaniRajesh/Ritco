<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="Report_Result.aspx.cs" Inherits="GUI_UNI_Net_MIS_AccessRightReport_Report_Result"  %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <rsweb:ReportViewer ID="rvDocuments" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="500px"
                ...
                <ServerReport ReportPath="/Report Project1/ReportAccessRights_Report"></ServerReport>
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
