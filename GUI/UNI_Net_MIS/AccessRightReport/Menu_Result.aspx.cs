...
public partial class GUI_UNI_Net_MIS_AccessRightReport_Result : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack && !IsCallback)
        {
			...
			rvDocuments.ServerReport.ReportPath = ReportServiceUtilities.ReportPathPrefix + "/AccessRightsReport";
