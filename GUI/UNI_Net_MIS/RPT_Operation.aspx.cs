...
public partial class GUI_UNI_Net_MIS_RPT_Operation : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String sqlstr = "select srno,report_name,Link as link_name,'' as link_title,Descp as discription,Subtitle from webx_reports_ver1 where  title='O' and srno in (select reportid from Webx_Master_ReportsAccess_ver1 where HasAccess='Y' and Userid='" + empcd + "') and activeflag='Y' order by subtitle";
        ...
        while (dr.Read())
        {
            ...
            if (st_subtitle.ToUpper() == "O1")
            {
                st_subtitlenm = "Register Reports";
            }
            if (st_subtitle.ToUpper() == "O2")
            {
                st_subtitlenm = "Summary Reports";
            }
            if (st_subtitle.ToUpper() == "O3")
            {
                st_subtitlenm = "Movement Summary Reports";
            }
