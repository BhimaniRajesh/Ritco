<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query.aspx.cs" Inherits="GUI_UNI_NET_MIS_CrossingRegister_Query" %>
            ...
            <tr>
                <td height="30">
                    <font class="blklnkund"><strong>Operation </strong></font><font class="bluefnt"><strong>&gt;</strong>
                            <strong>Crossing Register Report</strong> </font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
            ...
            <tr>
                <td valign="top">
                    <table cellspacing="1" style="width: 8.0in" class="boxbg" align="left">
                        ...
                        <tr style="background-color: white">
                            <td align="left">
                                <font class="blackfnt">Enter Challan No</font>
                            </td>
                            <td align="left" colspan="3">
                              <asp:TextBox ID="txtCrossingChallanNo" runat="server"></asp:TextBox>
                            </td>
                        </tr>
