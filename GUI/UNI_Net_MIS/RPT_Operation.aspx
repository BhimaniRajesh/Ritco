<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="RPT_Operation.aspx.cs" Inherits="GUI_UNI_Net_MIS_RPT_Operation" %>
...
<font class=bluefnt><strong> &gt; </strong>
		  <strong>Operation</strong> </font></td>
        </tr>
        <tr> 
        ...
        <asp:TableCell>
        <asp:Label ID="Label1"  Text="No Reports Available For This User" CssClass="blackfnt" runat="server"></asp:Label>
        ...
        <tr >
        <td align="center">
        <asp:Label ID="Label2" ForeColor="Red" Text="No Operations Reports Available For This User" CssClass="blackfnt" runat="server"></asp:Label>
        </td>
        </tr>
        </table>
