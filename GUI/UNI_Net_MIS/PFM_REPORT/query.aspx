                ...
                <div align="left">
                    <table cellspacing="1" style="width: 9.0in" class="boxbg" align="left">
                        ...
                        <tr style="background-color: white">
                            ...
                            <tr style="background-color: white">
                                <td align="left">
                                    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="Select Date :" Width="102px"></asp:Label>&nbsp;<asp:DropDownList ID="ddlType" runat="server">
                                        <asp:ListItem Selected="True" Value="dockdt">Booking Date</asp:ListItem>
                                        <asp:ListItem Value="dely_date">Delivery Date</asp:ListItem>
                                    </asp:DropDownList></td>
                                <td>
