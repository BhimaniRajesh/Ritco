<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_UNI_Net_MIS_THCBalancePaymentTDS_Result" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                   ...
                   <ServerReport DisplayName="THC Balance Payment TDS" ></ServerReport>                
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
