<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_Net_MIS_THCBalancePaymentTDS_Query" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        //        if (txtAccount.value == "") {
        //            alert("Please Enter AccountCode")
        //            txtAccount.focus();
        //            return false;
        //        }
        //    }
            ...
            <tr>
                <td valign="top">
                    <table id="Table1" runat="server" cellpadding="3" cellspacing="1" style="width: 7.5in;">
                        <tr>
                            <td>
                                <table cellspacing="1" style="width: 7.5in" class="boxbg" border="0">
                                    <tr class="bgbluegrey">
                                    ...
                                    <tr  runat="server" style="font-size: 12pt; font-family: Times New Roman; background-color: white">
                                        <td align="center" colspan="4" valign="top">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:RadioButtonList ID="radFlow" runat="server" CssClass="blackfnt" OnSelectedIndexChanged="rdiochanges"
                                                        AutoPostBack="true" RepeatDirection="Horizontal">
                                                        <asp:ListItem Selected="True" Text="Individual" Value="N"></asp:ListItem>
                                                        <asp:ListItem Text="Cumulative (Transaction includes all branches)" Value="Y"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    ...
                                    <tr align="center" bgcolor="white">
                                        <td colspan="6">
                                            <asp:RadioButtonList ID="rptfrt" RepeatDirection="horizontal"
                                                CssClass="blackfnt" runat="server">
                                                <asp:ListItem Selected="True" Text="TDS Deducted Amount" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="TDS Not Deducted Amount" Value="2"></asp:ListItem>
