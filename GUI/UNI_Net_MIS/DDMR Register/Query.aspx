<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_Finance_GeneralizedPO_POViewPrint_POViewPrintCriteria" %>
...
//        }
        ...
        if (document.getElementById('ctl00_MyCPH1_rdDocketCri').checked == true && document.getElementById('ctl00_MyCPH1_txtDDMRNo').value == '')
        {
            alert('Please Enter The DDMR Or Docket Number');
            document.getElementById('ctl00_MyCPH1_txtDDMRNo').focus();
            document.getElementById('ctl00_MyCPH1_txtDDMRNo').select();
            return false;
        }
    }
        ...
        <table cellspacing="1" class="boxbg" align="left">
            <tr class="bgbluegrey">
                <td colspan="3" align="center">
                    <asp:Label ID="lblQry" CssClass="ffnt" Font-Bold="true" runat="server" Text="Selection Criteria For DDMR Register"></asp:Label>
                </td>
            </tr>  
            <tr bgcolor="white">
                <td valign="middle">
                ...
                <td style="width: 150px">
                    <asp:Label ID="lblDocketNo" runat="server" CssClass="blackfnt" Text="DDMR Number"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDDMRNo" runat="server" BorderStyle="groove" CssClass="ltxt"
            ...
            <tr bgcolor="white">
                ...
                <td align="left" style="width: 130px">
                    <font class="blackfnt">Select DDMR Date </font>&nbsp;
                </td>
            ...
            <tr bgcolor="white">
                ...
                <td>
                    <asp:TextBox ID="txtPartyCode" runat="server" CssClass="ltxtm" Width="70px" MaxLength="20"></asp:TextBox>
                    <asp:TextBox ID="txtPartyName" runat="server" Width="150px" MaxLength="200"></asp:TextBox><br />
                    <xac:WebxComplete ID="xacpartycode" runat="server" MinPrefixLength="2" WebxEntity="VendorCode"
            ...
            <tr bgcolor="white">
                ...
                <td style="width: 130px">
                    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="DDMR DOCKET WISE"></asp:Label>
                </td>
                <td>
