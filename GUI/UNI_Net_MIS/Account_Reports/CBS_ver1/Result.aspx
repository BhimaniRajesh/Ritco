...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        {   
            ...
            var arg1 = arg1.toUpperCase();
            var res = arg1.split(":");
            var typ = res[0].substring(0,res[1].length - 1);
                ...
                <asp:GridView Visible="false" align="left" ID="dgDocket" runat="server" BorderWidth="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Voucher No." ItemStyle-Wrap="false" ItemStyle-BackColor="white">
                            <ItemTemplate>
                                <a href="Javascript:ViewPrint('<%# DataBinder.Eval(Container.DataItem,"Voucherno") %>')" style="text-decoration:underline"><%# DataBinder.Eval(Container.DataItem, "Voucherno")%></a>
                            </ItemTemplate>
