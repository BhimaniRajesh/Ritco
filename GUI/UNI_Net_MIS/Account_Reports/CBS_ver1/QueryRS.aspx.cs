...
public partial class GUI_UNI_NET_MIS_Account_Reports_CBS_ver1_QueryRS : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DropDownList DDL_BankList = (DropDownList)Fromlc.FindControl("DDL_BankList");
            DDL_BankList.Items.Clear();
            DDL_BankList.Items.Add(new ListItem("All", "All"));
            HiddenField lblflag = (HiddenField)Fromlc.FindControl("lblflag");

            string sqlstr = " select acccode ,acccode + ' : ' + accdesc from webx_acctinfo where activeFlag='Y' and ( acccategory='CASH' )  order  by accdesc";
            ...
            DDL_BankList.SelectedValue = "All";
            lblflag.Value = "CASH";
        }
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        st_Acc = DDL_BankList.SelectedValue.ToString();
        st_ro = cboRO.SelectedValue.ToString();
        st_lo = cboLO.SelectedValue.ToString();
        string Acc = DDL_BankList.SelectedItem.ToString();
        ...
        Response.Redirect("ResultRS.aspx" + final);
