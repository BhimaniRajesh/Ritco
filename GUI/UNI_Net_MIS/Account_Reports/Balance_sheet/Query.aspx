<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query.aspx.cs" Inherits="GUI_UNI_Net_MIS_Account_Reports_Balance_sheet_Query" %>
...
var cal = new CalendarPopup("testdiv1"); 
	...
	function ChkCust(val)
	{
	    ...
	    DL_DRI=document.getElementById("ctl00_MyCPH1_txtDriver"); 
	  	     document.getElementById('ctl00_MyCPH1_tr_acc').style.display = "none";
...
function OnSub_DATACHECK()
        ...
        if(document.getElementById("ctl00_MyCPH1_rpttyp_1").checked==true)
        ...
        else if(document.getElementById("ctl00_MyCPH1_rpttyp_3").checked==true)
	     {
	      txtAccount=document.getElementById("ctl00_MyCPH1_txtEmployee"); 
            if(txtAccount.value=="")
		     {
		      alert("Please Enter Atleast One Employee")
		      txtAccount.focus();
		      return false;
		     }    
        }
        ...
        else if(document.getElementById("ctl00_MyCPH1_rpttyp_4").checked==true)
	     {
	      txtAccount=document.getElementById("ctl00_MyCPH1_txtDriver"); 
            if(txtAccount.value=="")
		     {
		      alert("Please Enter Atleast One Driver")
		      txtAccount.focus();
		      return false;
		     }    
        }
    ...
    <div align="left">
        <table style="width: 8.5in" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td valign="top">
                    <table id="Table1" runat="server" cellpadding="3" cellspacing="1" style="width: 8.0in;">
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <table cellspacing="1" style="width: 8.0in" class="boxbg" border="0">
                                    ...
                                    <tr style="background-color: white">
                                        <td align="center">
                                            <asp:Label ID="Label2" CssClass="blackfnt" Font-Bold="false" runat="server">
                                      Groupwise  
                                            </asp:Label></td>
                                        <td align="left" colspan="3">
                                            <asp:CheckBox Checked="true" ID="grpchk" runat="server" /></td>
                                    </tr>
                                    <tr align="center" bgcolor="white">
                                        <td colspan="6">
