...
public partial class GUI_UNI_NET_MIS_Account_Reports_GL_TB_Query_ADV_TR : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        string TYP_CD = "";
        report_type = rpttyp.SelectedValue.ToString();
        if (report_type == "4")
        {
            TYP_CD = custcd;
        }
        ...
        string final;
        final = "?branch=" + PF_LOC;
        final += "&RPTTYP=" + rpttyp.SelectedValue.ToString();
        final += "&RPTTYP_SUB=" + rptsubtyp.SelectedValue.ToString();
        ...
        sb.Append("window.open('./Result_ADV_TR.aspx" + final + "', '_blank',");
        ...
        //Response.Redirect("Result_ADV_TR.aspx" + final);
    }
