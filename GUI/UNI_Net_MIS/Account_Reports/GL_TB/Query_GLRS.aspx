<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query_GLRS.aspx.cs" Inherits="GUI_UNI_NET_MIS_Account_Reports_GL_TB_Query_GLRS" %>
                                    ...
                                    <tr align="center" bgcolor="white">
                                        <td colspan="6">
                                            <asp:RadioButtonList ID="rptfrt" RepeatDirection="horizontal"
                                                ...
                                                <asp:ListItem Text="Month Wise" Value="2"></asp:ListItem>
                                                <asp:ListItem Text="A4 Landscape" Value="3"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
