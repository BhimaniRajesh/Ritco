...
public partial class GUI_UNI_Net_MIS_Account_Reports_GL_TB_Result_TB : System.Web.UI.Page
{
    SqlConnection Conn;
    ...
    public void BindGrid()
    {
       ...
       // DateType = Request.QueryString["report_mode"].ToString();
        ...
        try
        {
            ...
            string SQL_TB = "exec WebxNet_TR_Balance '" + fromdt + "','" + todt + "','" + Cumulative + "','" + yearSuffix + "','" + TYP_CD + "','" + RO + "','1'";
            ...
            while (dr.Read())
            {
                ...
                if (FL_CLOSE == "Y" || FL_CURR == "Y" || FL_OPN == "Y")
                {
                    ...
                    if (Rtyp == "1")
                    {
                        ...
                        string ST_DWN_XLS = "N";
                        string dirlldown = "branch=" + RO + "&ACCODE=" + ST_ACCCD + "&Rtyp=" + Rtyp + "&dateFrom=" + fromdt + "&dateTo=" + todt + "&Cumlative=" + Cumulative + "&TYP_CD=" + TYP_CD + "&PGNO=1&Psize=50&DWN_XLS=" + ST_DWN_XLS;
