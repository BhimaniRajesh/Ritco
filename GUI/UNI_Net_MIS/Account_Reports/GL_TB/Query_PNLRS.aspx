<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query_PNLRS.aspx.cs" Inherits="GUI_UNI_Net_MIS_Account_Reports_GL_TB_Query_PNL" %>
   ...
   <input type="hidden" id="hdnRptId" runat="server" /> <%-- added by Manisha 22/5/2014 --%>
    ...
    <div align="left">
        <table style="width: 10.5in" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
                <td height="30">
                 <font class="bluefnt"><strong><u>&gt;&gt;&gt; Profit & Loss Statement</u> </strong></font>
                        ...
                        <tr>
                            <td>
                                <table cellspacing="1" style="width: 7.5in" class="boxbg" border="0">
                                    ...
                                    <tr align="center" style=" display:none;" bgcolor="white">
                                    <td colspan="2">
                                    ...
                                    <tr align="center" bgcolor="white" style=" display:none;">
                                        <td colspan="6">
