...
public partial class GUI_UNI_Net_MIS_Account_Reports_GL_TB_Query_PNL : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string strtodt = "31/03/" + Convert.ToString(Convert.ToInt32(Session["FinYear"].ToString()) + 1);
           
            txtDateTo.Text = System.DateTime.Today.ToString("dd/MM/yyyy");
            txtDateTo.Text = strtodt;
            if (Convert.ToInt16(strtodt.ToString().Substring(6, 4)) > Convert.ToInt16(System.DateTime.Today.ToString("yyyy")))
                txtDateTo.Text = System.DateTime.Today.ToString("dd/MM/yyyy");
    ...
    protected void rdiochanges(object sender, EventArgs e)
    {
        ...
        string sqlstr = "";
        string brcd = Session["brcd"].ToString();
        if (radFlow.SelectedValue.ToString() == "0" || radFlow.SelectedValue.ToString() == "4")
        {
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        else if (radFlow.Items[1].Selected)
        {
            Cumulative = "N";
            RPT = "Month";
        }
        else if (radFlow.Items[2].Selected)
        {
            Cumulative = "Y";
        }
        else if (radFlow.Items[3].Selected)
        {
            Cumulative = "Y";
            RPT = "Location";
        }
        else if (radFlow.Items[4].Selected)
        {
            Cumulative = "Y";
            RPT = "Month";
        }
        ...
        Response.Redirect("Result_PNL.aspx" + final);
    }
