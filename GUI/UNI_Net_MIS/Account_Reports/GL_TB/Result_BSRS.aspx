<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Result_BSRS.aspx.cs" Inherits="GUI_UNI_NET_MIS_Account_Reports_GL_TB_Result_BSRS" %>
...
<rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                                ...
                                <ServerReport DisplayName="Balance Sheet" ></ServerReport>
                            </rsweb:ReportViewer>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    <br />
