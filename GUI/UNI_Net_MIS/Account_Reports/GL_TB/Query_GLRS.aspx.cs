...
public partial class GUI_UNI_NET_MIS_Account_Reports_GL_TB_Query_GLRS : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        //string Customer = "";
        //Customer = txtCustomer.Text.ToString();
        //custcd = Customer.Remove(Customer.Length - 1, 1);
        ...
        final += "&RPTTYP=" + rptfrt.SelectedValue.ToString();
        final += "&hdnRptId=" + hdnRptId.Value.ToString(); // added by Manisha 22/5/2014


        //Response.Redirect("Result_GLRS.aspx" + final);
	System.Text.StringBuilder sb = new System.Text.StringBuilder();
        sb.Append("<");
        sb.Append("script language='javascript'>");
        sb.Append("window.open('./Result_GLRS.aspx" + final + "', '_blank',");
