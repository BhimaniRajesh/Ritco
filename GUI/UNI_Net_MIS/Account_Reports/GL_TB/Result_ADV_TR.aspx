<%@ Page Language="C#"   AutoEventWireup="true" CodeFile="Result_ADV_TR.aspx.cs" Inherits="GUI_UNI_NET_MIS_Account_Reports_GL_TB_Result_ADV_TR" %>
...
<rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                                ...
                                <ServerReport DisplayName="Advance Trial Balance" >
                                </ServerReport>
                            </rsweb:ReportViewer>
    </div>
    </form>
