<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="Query_BSRS.aspx.cs" Inherits="GUI_UNI_NET_MIS_Account_Reports_GL_TB_Query_BSRS" %>
                        ...
                        <tr>
                            <td>
                                <table cellspacing="1" style="width: 7.5in" class="boxbg" border="0">
                                    ...
                                    <tr align="center" bgcolor="white" id="trgrp" runat="server" style=" display:none;">
                                    <td colspan="2">
                                    ...
                                    <tr align="center" bgcolor="white" id="trgrp1" runat="server" style=" display:none;">
                                        <td colspan="6">
