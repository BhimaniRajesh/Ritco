...
public partial class GUI_UNI_Net_MIS_RPT_Audit : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String sqlstr = "select report_name,Link as link_name,'' as link_title,Descp as discription,Subtitle from webx_reports_ver1 where  title='AU' and srno in (select reportid from Webx_Master_ReportsAccess_ver1 where HasAccess='Y' and Userid='" + empcd + "') and activeflag='Y' order by Subtitle, Report_Name";
