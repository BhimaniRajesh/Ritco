<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query.aspx.cs" Inherits="GUI_UNI_Net_MIS_ReportCounterSummary_Ver2_Query" %>
                       ...
                       <%-- <tr style="background-color: white" id="LocationID" runat="server">
                        ...
                        <tr style="background-color: white" id="EmpID" runat="server">
                         ...
                         <tr style="background-color: white" id="Tr1" runat="server">
                            <td align="left">
                                <font class="blackfnt">Report ID</font>
                            </td>
                            <td align="left" colspan="3">
                                <asp:TextBox ID="txtreportid" runat="server" Width="127px"></asp:TextBox>
                                <input type="button" onclick="cust('R');" value="..." style="width: 18px; height: 21px"
                                    size="" />
                            </td>
                        </tr>
                        <tr align="center" bgcolor="white">
                            <td colspan="4">
                                <asp:RadioButtonList ID="rptmd" onClick="javascript:ChkSelection(this);" RepeatDirection="horizontal"
                                    ...
                                    <asp:ListItem Text="Report Wise" Selected="True" Value="R"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr align="center" bgcolor="white">
