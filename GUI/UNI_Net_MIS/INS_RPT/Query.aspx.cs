...
public partial class GUI_UNI_Net_MIS_INS_RPT_Query : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        final += "&str_ststus=" + radBtnType.SelectedValue.ToString();
        final += "&RTYP=" + RDRPTTYP.SelectedValue.ToString();
