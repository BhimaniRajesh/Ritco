...
if(!IsPostBack){
        ...
        parameters.Add(new ReportParameter("ConnectionStr", Session["SqlProvider"].ToString().Trim()));
        ...
        parameters.Add(new ReportParameter("billnolsit", BILLNOSTR.ToString()));
        parameters.Add(new ReportParameter("mrsnolsit", MRNOSTR.ToString()));
        parameters.Add(new ReportParameter("docknolsit", DKTNOSTR.ToString()));
        parameters.Add(new ReportParameter("Datetyp", DT_TYPE.ToString()));
        ...
        ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportPathPrefix + "/STAX_COLL_Register";
