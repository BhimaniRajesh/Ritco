<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResultRS.aspx.cs" Inherits="GUI_UNI_Net_MIS_THCTransshipmentRegisterReport_ResultRS" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                   ...
                   <ServerReport DisplayName="THC Transshipment Register" ></ServerReport>                
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
