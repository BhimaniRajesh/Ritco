...
public partial class GUI_UNI_Net_MIS_THCTransshipmentRegisterReport_Query : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        final = "?fromdt=" + dtFrom;
        final += "&todt=" + dtTo;
        final += "&LocationLevel=" + cboRO.SelectedValue.ToString();
		final += "&LocationCode=" + cboLO.SelectedValue.ToString();
        final += "&Status=" + ddlStatus.SelectedValue.ToString();
        final += "&ThcNo=" + txtTHCNo.Text.ToString();
