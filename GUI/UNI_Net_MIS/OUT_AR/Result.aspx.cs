...
public partial class GUI_UNI_Net_MIS_OUT_AR_Result : System.Web.UI.Page
{
    string Doc_type;
    ...
    public void BindGrid()
    {
        ...
        string fromdt, todt,strrightnow = "", strrightnow1 = "", dtFrom = "", dtTo = "";
        ...
        Rtyp = Request.QueryString.Get("RMD");
	...
	sqlcmd12.CommandTimeout = 480;
        SqlDataReader dr = sqlcmd12.ExecuteReader();
            ...
            while (dr.Read())
            {
                ...
                if (dr["doc"].ToString() == "0")
                {
                    tr2atc3.Text = dr["doc"].ToString();
                }
                else
                {
                ...
                if (dr["doc_close"].ToString() == "0")
                {
                    tr2atc5.Text = dr["doc_close"].ToString();
                }
                else
                {
                ...
                if (dr["doc_Outstd"].ToString() == "0")
                {
                    tr2atc7.Text = dr["doc_Outstd"].ToString();
                }
                else
                {
                ...
                if (dr["doc_today"].ToString() == "0")
                {
                    tr2atc9.Text = dr["doc_today"].ToString();
                }
                else
                {
                ...
                if (dr["doc_Outstd_today"].ToString() == "0")
                {
                    tr2atc11.Text = dr["doc_Outstd_today"].ToString();
                }
                else
                {
                ...
                if (dr["paid_tbb_doc"].ToString() == "0")
                {
                    tr2atc13.Text = dr["paid_tbb_doc"].ToString();
                }
                else
                {
                ...
                if (dr["paid_tbb_doc_close"].ToString() == "0")
                {
                    tr2atc15.Text = dr["paid_tbb_doc_close"].ToString();
                }
                else
                {
                ...
                if (dr["paid_tbb_doc_Outstd"].ToString() == "0")
                {
                    tr2atc17.Text = dr["paid_tbb_doc_Outstd"].ToString();
                }
                else
                {
                ...
                if (dr["paid_tbb_doc_today"].ToString() == "0")
                {
                    tr2atc19.Text = dr["paid_tbb_doc_today"].ToString();
                }
                else
                {
                ...
                if (dr["paid_tbb_doc_Outstd_today"].ToString() == "0")
                {
                    tr2atc21.Text = dr["paid_tbb_doc_Outstd_today"].ToString();
                }
                else
                {
                ...
                if (dr["topay_mis_doc"].ToString() == "0")
                {
                    tr2atc23.Text = dr["topay_mis_doc"].ToString();
                }
                else
                {
                ...
                if (dr["topay_mis_doc_close"].ToString() == "0")
                {
                    tr2atc25.Text = dr["topay_mis_doc_close"].ToString();
                }
                else
                {
                ...
                if (dr["topay_mis_doc_Outstd"].ToString() == "0")
                {
                    tr2atc27.Text = dr["topay_mis_doc_Outstd"].ToString();
                }
                else
                {
                ...
                if (dr["topay_mis_doc_today"].ToString() == "0")
                {
                    tr2atc29.Text = dr["topay_mis_doc_today"].ToString();
                }
                else
                {
                ...
                if (dr["topay_mis_doc_Outstd_today"].ToString() == "0")
                {
                    tr2atc31.Text = dr["topay_mis_doc_Outstd_today"].ToString();
                }
                else
                {
                ...
                if (dr["oct_doc"].ToString() == "0")
                {
                    tr2atc33.Text = dr["oct_doc"].ToString();
                }
                else
                {
                ...
                if (dr["oct_doc_close"].ToString() == "0")
                {
                    tr2atc35.Text = dr["oct_doc_close"].ToString();
                }
                else
                {
                ...
                if (dr["oct_doc_Outstd"].ToString() == "0")
                {
                    tr2atc37.Text = dr["oct_doc_Outstd"].ToString();
                }
                else
                {
                ...
                if (dr["oct_doc_today"].ToString() == "0")
                {
                    tr2atc39.Text = dr["oct_doc_today"].ToString();
                }
                else
                {
                ...
                if (dr["oct_doc_Outstd_today"].ToString() == "0")
                {
                    tr2atc41.Text = dr["oct_doc_Outstd_today"].ToString();
                }
                else
                {
    ...
    public void DWN_XLS()
    {
        ...
        TBL_MonthlySales.Font.Size = 8;
        TBL_MonthlySales.Font.Name = "verdana";

        StringWriter stringWrite;
        HtmlTextWriter htmlWrite;
        HtmlForm frm = new HtmlForm();
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=OutStandingA_R.xls");
        Response.Charset = "";
        ...
        frm.Controls.Add(TBL_MonthlySales);
