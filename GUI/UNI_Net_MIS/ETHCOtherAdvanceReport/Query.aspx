<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_Operations_ETHCOtherAdvanceReport_Query" %>
                ...
                <td height="30">
                    <font class="blklnkund"><strong>Module</strong></font> <strong>&gt; </strong><font
                        class="blklnkund"><strong>Reports</strong></font><font class="bluefnt"><strong>
                            &gt; </strong><strong>ETHC Other Advance Report</strong> </font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
            ...
            <tr>
                ...
                <asp:DropDownList ID="cboLoc" runat="server" AutoPostBack="false" EnableViewState="true"
                    DataTextField="LocName" DataValueField="LocCode" />
                        ...
                        <tr style="background-color: white; ">
                            <td align="left" colspan="2">
                                <font class="blackfnt">ETHC No.</font>
                            </td>
                            <td align="left" colspan="2">
