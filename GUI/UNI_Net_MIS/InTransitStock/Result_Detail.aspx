<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Result_Detail.aspx.cs" Inherits="GUI_UNI_Net_MIS_InTransitStock_Result_Detail" EnableEventValidation="false" %>
            ...
            <td height="30">
                <font class="blklnkund"><strong>Module</strong></font> <strong>&gt; </strong><font
                    class="blklnkund"><strong>Report </strong></font><font class="bluefnt"><strong><font
                        ...
                        </strong><strong>In Transit Stock Detail</strong> </font>
            </td>
        </tr>
        <tr>
            <td class="horzblue">
                ...
                <table border="0" runat="server" id="TBL_CRI" horizontalalign="left" cellpadding="3"
                    ...
                    <tr bgcolor="white" class="blackfnt">
                        <td>
                           To Location</td>
                        <td>
                            <asp:Label runat="server" ID="LBLRPTTO"></asp:Label></td>
                    </tr>
                </table>
            </td>
        </tr>
