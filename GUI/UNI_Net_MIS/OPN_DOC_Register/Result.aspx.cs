...
public partial class GUI_UNI_MIS_OPN_DOC_Register_Result : System.Web.UI.Page
{
    ...
    public static string st_status_str, st_paybasis_str, st_trnmod_str, st_type_str, BUSTYP_str;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Dictionary<string, string> dReportData = (Dictionary<string, string>)Session[Request.QueryString["GUID"].ToString()];
            RO_TO = dReportData["RO_TO"].ToString();
            LO_TO = dReportData["LO_TO"].ToString();
            RO = dReportData["RO"].ToString();
            LO = dReportData["LO"].ToString();
            BUSTYP = dReportData["BUSTYP"].ToString();
            select_Text = dReportData["select_Text"].ToString();
            select_list = dReportData["select_list"].ToString();
            st_doctyp = dReportData["st_doctyp"].ToString();
            DateType = dReportData["DateType"].ToString();
            fromdt = dReportData["fromdt"].ToString();
            todt = dReportData["todt"].ToString();
            st_Docnolist = dReportData["st_Docnolist"].ToString();
            View_Sales = dReportData["View_Sales"].ToString();
            st_paybasis = dReportData["st_paybasis"].ToString();
            st_trnmod = dReportData["st_trnmod"].ToString();
            st_type = dReportData["st_type"].ToString();
            st_custcd = dReportData["st_custcd"].ToString();
            st_status = dReportData["st_status"].ToString();
            st_status_str = dReportData["st_status_str"].ToString();
            st_paybasis_str = dReportData["st_paybasis_str"].ToString();
            st_trnmod_str = dReportData["st_trnmod_str"].ToString();
            st_type_str = dReportData["st_type_str"].ToString();
            BUSTYP_str = dReportData["BUSTYP_str"].ToString();
            DWN_XLS = dReportData["DWN_XLS"].ToString();
    ...
    public void BindGrid(int attempt)
    {
