<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocketEditHistory.aspx.cs" Inherits="GUI_UNI_Net_MIS_DocketGST_Register_DocketEditHistory" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
                   ...
                   <ServerReport DisplayName="CN Edit Register" ></ServerReport>                
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
