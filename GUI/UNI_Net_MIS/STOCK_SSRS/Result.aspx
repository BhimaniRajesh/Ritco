<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_UNI_NET_MIS_STOCK_SSRS_Result" %>
...
<rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer1"
            ...
            <ServerReport DisplayName="Advance Trial Balance"></ServerReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
