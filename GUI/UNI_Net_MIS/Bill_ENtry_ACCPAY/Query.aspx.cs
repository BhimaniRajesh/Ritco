...
public partial class GUI_UNI_NET_MIS_Bill_ENtry_ACCPAY_Query : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        final += "&BILTYP=" + cbobiltyp.SelectedValue.ToString();
        final += "&RTYP=" + DLLRPTTYP.SelectedValue.ToString();
        final += "&DTTYPE=" + DT_TYPE.SelectedValue.ToString();
        final += "&Vendcdstr=" + txtVendor.Text.ToString();
