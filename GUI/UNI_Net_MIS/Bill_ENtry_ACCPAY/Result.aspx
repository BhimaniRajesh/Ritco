<%--<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_UNI_NET_MIS_Bill_ENtry_ACCPAY_Result" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_UNI_NET_MIS_Bill_ENtry_ACCPAY_Result" %>
...
<body>
    ...
    <div>
       ...
       <%-- <rsweb:ReportViewer ExportContentDisposition="AlwaysAttachment" ID="ReportViewer2"
                   ...
                   <ServerReport DisplayName="CN GST Register" ></ServerReport>                
        </rsweb:ReportViewer>--%>
