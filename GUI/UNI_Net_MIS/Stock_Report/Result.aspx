<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_UNI_MIS_Stock_Report_Result" %>
...
<img alt="Back" src="./../../images/back.gif" border="0"> </a>
    ...
    <table  runat="server" id="TBL_CRI"   border="0" cellpadding="3" width="400" cellspacing="1" align="left" class="boxbg">
        ...
        <tr style="background-color: #FFFFFF">
            ...
            <tr>
                <td  valign="top">
<br />
    <asp:Table id="TBL_Stock" border="0" HorizontalAlign="left" runat="server" CellPadding="3" CellSpacing="1" style="width:8.5in;" CssClass="boxbg"></asp:Table>
