                                    ...
                                    <asp:TemplateField HeaderText="Account Code">
                                        ...
                                        <ItemTemplate>
                                         ...
                                         <%--   <atlas:autocompleteextender runat="server" id="Ext1" dropdownpanelid="Dic_Acccode">
                                              <atlas:AutoCompleteProperties TargetControlID="txtacccode" ServicePath="../AtlasAutoComplete.asmx" 
                                              ServiceMethod="GetAcccode" MinimumPrefixLength="1" Enabled="true" />
                                              </atlas:autocompleteextender>
                                              --%>
                                            <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" Enabled="True"
                                                MinimumPrefixLength="1" ServiceMethod="GetAcccode" CompletionListItemCssClass="autocomplete_listItem"
