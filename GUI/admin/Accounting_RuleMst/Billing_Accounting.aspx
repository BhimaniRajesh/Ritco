<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"  
    CodeFile="Billing_Accounting.aspx.cs" Inherits="GUI_admin_setting_cust_opn_bal_sel_brnch" %>
...
<br /><br />
    ...
    <td colspan="3"> <font class="bluefnt"> <strong> Set Billing Module Rules</strong> </font></td>
    </tr>
        <tr bgcolor="#FFFFFF">
         ...
         <tr bgcolor="#FFFFFF">
                    ...
                    <td> <font class="blackfnt"><asp:DropDownList ID="DLL_Octroi" CssClass="blackfnt" runat="server"></asp:DropDownList></font>
