...
public partial class GUI_Octroi_ViewnPrint_DText : System.Web.UI.Page
{
    ...
    protected void ddllist_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        strsql = "SELECT *,(select Accdesc+'~'+Company_Acccode from webx_acctinfo where Acccode=A.acccode) as Acccdesc  FROM webx_master_billcharge A WHERE chargetype='BILL' ORDER BY chargename";
