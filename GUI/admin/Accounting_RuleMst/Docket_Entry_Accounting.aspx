<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"  
    CodeFile="Docket_Entry_Accounting.aspx.cs" Inherits="GUI_admin_setting_cust_opn_bal_sel_brnch" %>
...
<br /><br /><br />
<font class="blackfnt" c ><b>* <u>NOTE </u>:- Plz Set Proper Accounting instance And Accounting Based On</b> </font>
<br /><br />
    ...
    <td colspan="3"> <font class="bluefnt"> <strong>Paybas Wise Entry</strong> </font></td>
    </tr>
        <tr bgcolor="#FFFFFF">
                    <td> <font class="blackfnt">1</font></td>
                    <td> <font class="blackfnt"><asp:DropDownList ID="DLL_Module" CssClass="blackfnt" runat="server"></asp:DropDownList></font>
                    ...
                    <td colspan="3" >
                        <table cellspacing="1" cellpadding="5" align="left" border="0" class="boxbg">
                            <!-- <tr bgcolor="#FFFFFF">
                                 <td>
                                 <font class="blackfnt">Accounting Instance</font>
                                 </td>
                                      <td>
                                        
                                       <asp:ListBox ID="LT_Acct_instance"    SelectionMode="Single" runat="server" CssClass="blackfnt"  >
                                       </asp:ListBox>
                            ...
                            <tr bgcolor="#FFFFFF">
                                  <td>
                                   <font class="blackfnt">Accounting Based On</font>
                                 </td>
                                 
                                  <td>
                                  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                  <asp:ListBox ID="LT_Acct_Based_On"    SelectionMode="Single" runat="server" CssClass="blackfnt"  OnSelectedIndexChanged="LT_Acct_Based_On_SelectedIndexChanged"  AutoPostBack="true">
                                    </asp:ListBox>
                                </ContentTemplate>
                                </asp:UpdatePanel>
                                 </td>
                        ...
                        <td colspan="2">
                         <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                            <asp:GridView ID="GV_PayBaseWise" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
        ...
        <td ><font class="blackfnt">Set Rule For S.Tax Details</font></td>
        <td bgcolor="#FFFFFF">
        <table cellspacing="1" cellpadding="5" align="left" border="0" class="boxbg">
          <tr bgcolor="#FFFFFF">
                                 ...
                                 <asp:TemplateField HeaderText="Accounting Type">
                                   ...
                                   <asp:TemplateField HeaderText="Debit To Ledger">
                                    ...
                                    <asp:TemplateField HeaderText="Narration Accounting Entry">
                                        ...
                                        <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                         <ItemTemplate>
                                           <asp:TextBox ID="Narration_Entry" runat="server"   onblur="javascript:this.value=this.value.toUpperCase()" CssClass="Blackfnt" BorderStyle="Groove" ></asp:TextBox>
                                        </ItemTemplate>
                                   </asp:TemplateField>
                                   <asp:TemplateField HeaderText="Narration Accounting Cancel">
                                        <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center" Wrap="false"  />
                                        <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                         <ItemTemplate>
                                             <asp:TextBox ID="Narration_Cancel" runat="server"  onblur="javascript:this.value=this.value.toUpperCase()" CssClass="Blackfnt" BorderStyle="Groove" ></asp:TextBox>
                                        </ItemTemplate>
                                   </asp:TemplateField>
