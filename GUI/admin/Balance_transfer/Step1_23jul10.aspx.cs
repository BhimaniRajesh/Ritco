...
{ 
    ...
    protected void Btn_ledger_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            Sql_Ledger = "exec Usp_Balance_TRF '1','" + Rd_Ledger_1.Text.ToString() + "','1','" + SessionUtilities.FinYear.ToString() + "','" + SessionUtilities.CurrentEmployeeID.ToString() + "','" + SessionUtilities.DefaultCompanyCode.ToString().Trim() + "'";
    ...
    protected void Btn_Sub_ledger_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if(Rd_Sub_Ledger_1.Checked)
                Sql_Sub_Ledger = "exec Usp_Balance_TRF '2','ALL','ALL','" + SessionUtilities.FinYear.ToString() + "','" + SessionUtilities.CurrentEmployeeID.ToString() + "','" + SessionUtilities.DefaultCompanyCode.ToString().Trim() + "'";  
            else if(Rd_Sub_Ledger_2.Checked)
                Sql_Sub_Ledger = "exec Usp_Balance_TRF '2','ALL','1','" + SessionUtilities.FinYear.ToString() + "','" + SessionUtilities.CurrentEmployeeID.ToString() + "','" + SessionUtilities.DefaultCompanyCode.ToString().Trim() + "'";
            else if (Rd_Sub_Ledger_3.Checked)
                Sql_Sub_Ledger = "exec Usp_Balance_TRF '2','ALL','2','" + SessionUtilities.FinYear.ToString() + "','" + SessionUtilities.CurrentEmployeeID.ToString() + "','" + SessionUtilities.DefaultCompanyCode.ToString().Trim() + "'";
            else if (Rd_Sub_Ledger_4.Checked)
                Sql_Sub_Ledger = "exec Usp_Balance_TRF '2','ALL','3','" + SessionUtilities.FinYear.ToString() + "','" + SessionUtilities.CurrentEmployeeID.ToString() + "','" + SessionUtilities.DefaultCompanyCode.ToString().Trim() + "'";
            else if (Rd_Sub_Ledger_5.Checked)
                Sql_Sub_Ledger = "exec Usp_Balance_TRF '2','ALL','4','" + SessionUtilities.FinYear.ToString() + "','" + SessionUtilities.CurrentEmployeeID.ToString() + "','" + SessionUtilities.DefaultCompanyCode.ToString().Trim() + "'";
            if (Sql_Sub_Ledger != "")
            {
