                ...
                <td>
                    ...
                    <table border="0" cellpadding="2" cellspacing="1" class="boxbg" style="width: 100%"
                        ...
                        <tr bgcolor="white">
                         ...
                         <tr bgcolor="white">
                            <td align="center">
                                <asp:Button ID="Btn_Ledger" runat="server" Text="Transfer Ledger Balance" CssClass="blackfnt"  BorderStyle="Groove"  OnClick="Btn_ledger_Click" />
                            </td>
                            <td align="center">
                                <asp:Button ID="Btn_SubLedger" runat="server" Text="Transfer Sub-Ledger Balance" CssClass="blackfnt"  BorderStyle="Groove"  OnClick="Btn_Sub_ledger_Click"/>
                            </td>
                        </tr>
                    </table>
                </td>
