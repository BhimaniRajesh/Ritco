...
*************************************************************************************************************/
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        string sq = "DELETE FROM webx_Customer_News_updates WHERE ID='N'";
        ...
        for (int i = 0; i < grvcontrols.Rows.Count; i++)
        {
            ...
            {
                string sql = "INSERT INTO webx_Customer_News_updates VALUES('" + txtheadline.Text + "','" + txtnews.Text + "','','N','" + txtcolor.Text + "')";
