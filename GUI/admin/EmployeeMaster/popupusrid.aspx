<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupusrid.aspx.cs" Inherits="popupbranch" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
                ...
                window.opener.document.forms[0].ctl00$MyCPH1$txtuid.value = objLocation.value
              window.close();       
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" ItemStyle-BackColor="white" ItemStyle-Width="40px" >
                                    <ItemTemplate>
                                        <input name="MyRadioButton" type="radio" value='<%# Eval("userid") %>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
