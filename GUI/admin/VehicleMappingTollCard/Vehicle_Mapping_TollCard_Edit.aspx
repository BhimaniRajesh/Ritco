<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Vehicle_Mapping_TollCard_Edit.aspx.cs" Inherits="GUI_admin_VehicleMappingTollCard_Vehicle_Mapping_TollCard_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <script type="text/javascript">
        ...
        function Confirmation() {
            var activeCnt = 0;
            $("#ctl00_MyCPH1_gvFuelCard tr td").each(function () {
            ...
            if (activeCnt > 1) {
                alert("Only One card should be active at a time !!");
                return false;
            }
        ...
        function OnActiveCheck(ctrl) {
            var chkActive = $(ctrl);
            $("#ctl00_MyCPH1_gvFuelCard tr td").each(function () {
                var chkActiveRow = $(this).find('input[id*="chkActive"]');
                if (chkActive.attr('id') != chkActiveRow.attr('id')) {
                    if (chkActiveRow.prop("checked")) {
                        chkActiveRow.prop("checked", false);
                    }
                }
            });
        }
                            ...
                            <asp:GridView runat="server" CssClass="boxbg" ID="gvFuelCard" AutoGenerateColumns="False" CellSpacing="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Active">
                                        <ItemStyle CssClass="alignCenter" />
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="chkActive" CssClass="blackfnt" onclick="OnActiveCheck(this)"></asp:CheckBox>
