<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="VendorMaster.aspx.cs" Inherits="octroi_OctCustBillStep2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ValidatePanNo(ctrl) {
            var PanNo = $(ctrl);
            if (PanNo.val() != "") {
                var PANCardRegx = new RegExp('^[a-z-A-Z]{5}[0-9]{4}[a-z-A-Z]{1}$');
            ...
            <table border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width: 80%" align="center">
                ...
                <tr bgcolor="white" style="height: 25px">
                    ...
                    <td style="width: 195px" colspan="3">
                        <asp:TextBox ID="txtSystemDate" runat="server" MaxLength="39" Width="94px"></asp:TextBox>                        
                    </td>
                </tr>
                <tr bgcolor="white" style="height: 25px">
                    ...
                    <td style="width: 188px"><font class="blackfnt">
                        <p align="left">
                            <font class="blackfnt" color="red">*</font> <font class="blackfnt">Name</font>
                        </p>
                    </font></td>
                    <td style="width: 264px">
                        <asp:TextBox ID="txtvenname" runat="server" MaxLength="39" Width="94px"></asp:TextBox>
                ...
                <tr bgcolor="white" style="height: 25px">
                    <td><font class="blackfnt" color="red">*</font> <font class="blackfnt">Vendor Type </font></td>
                    <td style="width: 195px">
                        <asp:DropDownList ID="ddVendorType" runat="server" Width="200px" OnChange ="onChangeVenderType();">
                        </asp:DropDownList></td>
                    <td><font class="blackfnt" color="red">*</font> <font class="blackfnt">Address</font></td>
                    <td style="width: 264px">
                ...
                <tr bgcolor="white" style="height: 25px">
                    <td><font class="blackfnt" color="red">*</font> <font class="blackfnt">Customer Locations 
                ...
                <tr bgcolor="white" style="height: 25px">
                    <td><font class="blackfnt" color="red">*</font> <font class="blackfnt">Vendor City </font></td>
                    <td style="width: 195px">
                    ...
                    <td><font class="blackfnt" color="red">*</font> <font class="blackfnt">Pincode</font></td>
                    <td style="width: 264px">
                ...
                <tr bgcolor="white" style="height: 25px">
                    <td><font class="blackfnt" color="red">*</font> <font class="blackfnt">Vendor Phone No. </font></td>
                    <td style="width: 195px">
                        <asp:TextBox ID="txttel" runat="server" MaxLength="10" Width="100px"></asp:TextBox>

                    </td>
                    <td><font class="blackfnt" color="red">*</font> <font class="blackfnt">E - Mail </font></td>
                    <td style="width: 264px">
                        <asp:TextBox ID="txtemail" runat="server" MaxLength="45" onblur="EmailCheck(this)" Width="250px"></asp:TextBox>
                ...
                <tr bgcolor="white" style="height: 25px">
                    <td>
                        <font class="blackfnt" color="red">*</font> <font class="blackfnt">Contact Person</font></td>
                    <td style="width: 195px">
                        <asp:TextBox ID="txtContactPerson" name="txtContactPerson" runat="server" MaxLength="20" Width="100px"></asp:TextBox>
                    </td>
                    <td>
                        <font class="blackfnt" color="red">*</font> <font class="blackfnt">Phone Number</font></td>
                    <td style="width: 264px">
                ...
                <tr class="bgbluegrey">
                    <td align="center" colspan="4"><font class="bluefnt"><b>Other Information</b></font></td>
                </tr>

                <%--<tr bgcolor="white" style="height: 25px">
                    <td><font class="blackfnt">PAN No.  </font></td>
                    <td style="width: 195px">
                        <asp:TextBox ID="PanNo" MaxLength="10" runat="server" Width="123px"></asp:TextBox>
                    </td>
                    <td><font class="blackfnt">Service Tax No. </font></td>
                    <td style="width: 264px">
                ...
                <tr bgcolor="white" style="height: 25px">
                    <td><font class="blackfnt">GST No.  </font></td>
                    <td style="width: 195px" colspan="3">
                        <asp:TextBox ID="vendorbstno" MaxLength="15" runat="server" Width="123px"></asp:TextBox>
                    </td>
                    <%--<td><font class="blackfnt">Central Sales Tax No. </font></td>
                    <td style="width: 264px">
                ...
                <tr bgcolor="white" style="height: 25px">
                    <td><font class="blackfnt">Remarks : </font></td>
                    <td>
