<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="AddCustLocwithDiffAddress.aspx.cs" Inherits="GUI_admin_CustomerMaster_AddCustLocwithDiffAddress" Title="Untitled Page" %>
											...
											<table align="center" border="0" cellpadding="0" cellspacing="1" width="100%" class="boxbg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font class="blackfnt" color="red">
                                                        <asp:Label ID="lblCstCd" runat="server"></asp:Label></td>
