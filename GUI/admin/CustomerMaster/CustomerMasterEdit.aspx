<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="CustomerMasterEdit.aspx.cs" Inherits="GUI_admin_CustomerMaster_CustomerMasterAdd"
    Title="Untitled Page" %>
                                                                    ...
                                                                    <table border="1" cellspacing="0" cellpadding="3" width="100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <font class="blackfnt">:</font></td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtCstNm" runat="server" MaxLength="45" CssClass="input" OnChange="Javascript:this.value=this.value.toUpperCase();"></asp:TextBox>
                                                                            </td>
                                                                            <%--<td></td>--%>
                                                                            <td>
                                                                                <font class="blackfnt"></font>
                                                                            ...
                                                                            <td>
                                                                                :</td>
                                                                            <td>
                                                                                <%-- <asp:TextBox ID="txtPwd" TextMode="Password" runat="server" MaxLength="10"></asp:TextBox>--%>
