...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
            ...
            //if(mNo == 1)
            //{
                window.opener.document.forms[0].ctl00$MyCPH1$txtctlloc.value = objLocation.value
            //}
            //else if(mNo == 2)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtBranch2.value = objLocation.value
//            }
//            else if(mNo == 3)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtBranch3.value = objLocation.value
//            }
//            else if(mNo == 4)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtBranch4.value = objLocation.value
//            }
//            else if(mNo == 5)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtBranch5.value = objLocation.value
//            }
//            else if(mNo == 6)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtBranch6.value = objLocation.value
//            }
//            else if(mNo == 7)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtBranch7.value = objLocation.value
//            }
//            else if(mNo == 8)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtBranch8.value = objLocation.value
//            }
        }
