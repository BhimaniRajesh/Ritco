    ...
    <asp:Panel runat="server" HorizontalAlign="left" Style="width: 10in" ID="pnlMain">
        ...
        <asp:Table CssClass="boxbg" CellPadding="1" ID="tblMain" runat="server" CellSpacing="1"
            ...
            <asp:TableRow CssClass="bgwhite">
                ...
                <asp:TableCell HorizontalAlign="left" Width="70%">
                    To make Happay/Fuel wallet/Toll wallet
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="center">
                    <asp:LinkButton ID="LinkButton18" CssClass="bluefnt" runat="server" Font-Bold="false" Text="Add" PostBackUrl="~/GUI/admin/Happay_Fuel_Wallet/Happay_Fuel_Wallet.aspx" />
                    <font class="blackfnt">|</font>
                    <asp:LinkButton ID="LinkButton19" CssClass="bluefnt" runat="server" Font-Bold="false" Text="Edit" PostBackUrl="~/GUI/admin/Happay_Fuel_Wallet/Happay_Fuel_Wallet_Edit.aspx" />
                    <font class="blackfnt">|</font>
                    <asp:LinkButton ID="LinkButton20" CssClass="bluefnt" runat="server" Font-Bold="false" Text="View" PostBackUrl="~/GUI/admin/Happay_Fuel_Wallet/Happay_Fuel_Wallet_View.aspx" />
                </asp:TableCell>
            </asp:TableRow>
