...
public partial class GUI_admin_Vendor_contract_vendorContract_longhaulroad_trip_City : System.Web.UI.Page
{
    ...
    private void RetriveData()
    {
        ...
        String sql_edit = "select otherchrg from webx_vendor_contract_matrix where vendorcode='" + vendorCode + "' and contractcd='" + ContID + "' and matrixcode='11'";
        ...
        dr.Close();
        String sql_edit1 = "select Distinct vehtype from webx_vendor_contract_charges where vendorcode='" + vendorCode + "' and contractcd='" + ContID + "' and matrixcode='11' and chargetype='Variable'     ";
        ...
        String sql_edit12 = "select Distinct routecd from webx_vendor_contract_charges where vendorcode='" + vendorCode + "' and contractcd='" + ContID + "' and matrixcode='11'  and chargetype='Variable'    ";
        ...
        foreach (GridViewRow gridrow in GV_D.Rows)
        {
            ...
            if (i < Rl)
            {
                ...
                for (int vi = 0; vi < v1; vi++)
                {
                    ...
                    String sql_edit3 = "select  vehtype,slabvalue=isnull(slabvalue,''),routecd=isnull(routecd,'') from webx_vendor_contract_charges where vendorcode='" + vendorCode + "' and contractcd='" + ContID + "' and matrixcode='11'  and routecd='" + Route_cd + "' and convert(varchar,vehtype,106)='" + Vehtypno + "'  order by chargeid";
    ...
    private void intetilisedrows()
    {
        ...
        foreach (GridViewRow gridrow in GV_D.Rows)
        {
            ...
            string sqlstr = "select '--Select--' as rutnm,'' as rutcd from webx_rutmas  union select (rutcd +' : '+rutnm) as rutnm,rutcd from webx_rutmas where rutcat='L' AND substring(rutcd,1,2)='CR' and activeFlag='Y' order by [rutnm]";
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        ...
        Chargetype = "NA";
        matrixcode = "11";
        Matrixdesc = "Long haul-road- Per Trip (City Wise Route Matrix) basis";
