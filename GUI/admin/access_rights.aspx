<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="access_rights.aspx.cs" Inherits="GUI_admin_access_rights" Title="Untitled Page" %>

<%--<%@ Register TagPrefix="cc1" Namespace="BunnyBear"%>
--%>
<%--<%@ Register Src="~/GUI/usercontrol/javaparent.ascx" TagName="JavaUpdate" TagPrefix="JU" %>
--%>
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <table cellspacing="1" style="width: 500px">
        <tr>
            ...
            <td align="left">
                <asp:TextBox EnableViewState="true" runat="server" ID="txtEmpCode" MaxLength="10"
...
--%>
                            ...
                            <Columns>
                                ...
                                <%-- Level 0 --%>
                                <asp:TemplateField ItemStyle-Width="175px" HeaderText="Menu Level 0" ItemStyle-HorizontalAlign="left"
...
--%>
                                ...
                                <%-- Level 1 --%>
                                <asp:TemplateField ItemStyle-Width="175px" HeaderText="Menu Level 1" ItemStyle-HorizontalAlign="left"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                ...
                                <%-- Level 2 --%>
                                <asp:TemplateField ItemStyle-Width="175px" HeaderText="Menu Level 2" ItemStyle-HorizontalAlign="left"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
