...
public partial class GUI_admin_access_rights : System.Web.UI.Page
{
    ...
    protected void SetDataSet()
    {
        ...
        string sql = "Select Chk=(Case When IsNull(UserId,'')='' then 'false' Else 'true' End),Level0Text=L0_Text, Level1Text=L1_Text, Level2Text=[Text],L0_App_Module,L1_App_Module,App_Module From vw_Menu_All_Levels_With_FinalAppModule Left Outer Join Webx_Master_ModuleAccess2 On FinalAppModule = ModuleCode and HasAccess='Y' and UserId='" + txtEmpCode.Text.Trim() + "' ORDER BY Level0Text,Level1Text,Level2Text";
