<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerMasterAdd.aspx.cs" Inherits="GUI_admin_CustomerMaster_CustomerMasterAdd" Title="Untitled Page" %>
...
<tr class="bgbluegrey">
<td colspan="3" align="center" style="height: 19px"><font class="blackfnt"><b>CUSTOMER MASTER SCREEN</b></font></td>
</tr>
<tr>
<td bgcolor="#FFFFFF">
<table border="0" cellspacing="0" cellpadding="3" width="100%" >
                                  <tr> 
                                   ...
                                   <%--</tr>--%>  
                                    <td valign="top"><font class="blackfnt">Customer 
                                      Code</font></td>
                                    <td><font class="blackfnt">:</font></td>
                                    <td><font class="blackfnt" color="red">< System 
                                      Generated... ></font></td>
                                   ...
                                   <tr> 
                                    ...
                                    <td><font class="blackfnt">:</font></td>
                                    <td>
                                        <asp:TextBox ID="txtCstNm" runat="server" CssClass="input" OnChange="Javascript:this.value=this.value.toUpperCase();"></asp:TextBox>
                                       </td>
                                    <%--<td></td>--%>
                                    <td><font class="blackfnt"></font></td>
                                    ...
                                    <td>
                                        :</td>
                                    <td> 
                                      <font class="blackfnt" color="red">< System 
                                      Generated... ></font> 
                                    </td>
                                  </tr>
                                  <tr> 
                                  ...
                                  <tr> 
                                    ...
                                    <td>
                                        :</td>
                                    <td>
                                        <asp:TextBox ID="txtMblNo" MaxLength="12"  runat="server"></asp:TextBox></td>
                                  </tr>
                                  <tr> 
