...
public partial class GUI_admin_CustomerMaster_ListAll : System.Web.UI.Page
{
    ...
    public void bindGrid()
    {
        ...
        cn.Open();
            ...
            if (chkval == "true")
            {
                sql = "select GRPCD,CUSTCD,CUSTNM,CUSTCAT from webx_CUSTHDR where CUST_ACTIVE='Y' order by CUSTNM";
            }
            else
            {
               sql="select GRPCD,CUSTCD,CUSTNM,CUSTCAT from webx_CUSTHDR  where CUST_ACTIVE='N' order by CUSTNM";
            }
