...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
            ...
            if(mNo == 1)
            {
                window.opener.document.forms[0].ctl00$MyCPH1$TextBox1.value = objLocation.value
            }
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" ItemStyle-BackColor="white" ItemStyle-Width="40px" >
                                    <ItemTemplate>
                                        <input name="MyRadioButton" type="radio" value='<%# Eval("loccd") %>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="loccd" HeaderText="Branch Code">
