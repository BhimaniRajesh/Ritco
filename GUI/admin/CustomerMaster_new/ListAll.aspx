                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Edit" HeaderStyle-Font-Bold="true">
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:HyperLink  Font-Underline="True"  Runat="server"  NavigateUrl='<%#"CustomerMasterEdit.aspx?para=2&cno="+DataBinder.Eval(Container.DataItem, "CUSTCD")+"&grpcd="+DataBinder.Eval(Container.DataItem, "GRPCD")%>' Text= 'Edit' ID="Hyperlink3"/>
