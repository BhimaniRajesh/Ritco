                                                                  ...
                                                                  <asp:TemplateField HeaderText="Origin Branch1 " >
                                                                                ...
                                                                                <ItemTemplate>
                                                                                       ...
                                                                                       <%--<atlas:AutoCompleteExtender ID="Extender1" runat="server">
                                                                                        ...
                                                                                        ServiceMethod="GetlocationList" ServicePath="../../../GUI/services/WebService.asmx"
                                                                                         TargetControlID="txtloc1" /></atlas:AutoCompleteExtender>--%>
...
ServicePath="../../../GUI/services/WebService.asmx" TargetControlID="txtloc2" /></atlas:AutoCompleteExtender>--%>

 <ajaxToolkit:AutoCompleteExtender ID="Extender2" runat="server" Enabled="True" CompletionListItemCssClass="autocomplete_listItem"
                                                CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" MinimumPrefixLength="1"
                                                ServiceMethod="GetlocationList" ServicePath="../../../GUI/services/WebService.asmx" TargetControlID="txtloc2">
                                            </ajaxToolkit:AutoCompleteExtender>
