<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="EditCustomerContractStep2.aspx.cs" Inherits="EditCustomerContractStep2"
...
function fuelSurChargeClick()
{
    ...
    var tblfuelsurcharge=document.getElementById("ctl00_MyCPH1_tblfuelsurcharge");
    var chkfuelsurcharge=document.getElementById("ctl00_MyCPH1_chkfuelsurcharge");
        if(chkfuelsurcharge.checked==true)
                tblfuelsurcharge.style.display="block";
        else
                tblfuelsurcharge.style.display="none";
...
function chkMultiPointPickUp(id)
{
    ...
    if(id=="ctl00_MyCPH1_chkflatmultipoint")
        {
...
function roundit(Num)
{
    ...
    function chkcoddodchange()
    {
        ...
        var hdn=document.getElementById("ctl00_MyCPH1_HidCODDODApp");
    ...
    <div>
        ...
        <table style="width: 9in" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left">
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <table border="0" cellpadding="2" width="90%" cellspacing="1" align="center" class="boxbg">
                                                ...
                                                <tr id="trmultipointpickup" runat="server" style="background-color: White">
                                                    <td>
                                                        Flat MultiPoint PickUp
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="chkflatmultipointpickup" onclick="javascript:return chkMultiPoint(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                    <td>
                                                        Location Wise MultiPoint PickUp
                                                    </td>
                                                    <td colspan="3">
                                                        <input type="checkbox" id="chklocmultipointpickup" onclick="javascript:return chkMultiPoint(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                </tr>
                                                <tr id="trloading" runat="server" style="background-color: White">
                                                    <td>
                                                        Flat Loading Charges
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="chkflatloading" onclick="javascript:return chkLoading(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td colspan="3">
                                                        <input type="checkbox" id="chklocloading" onclick="javascript:return chkLoading(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                </tr>
                                                <tr id="trmultipointdelivery" runat="server" style="background-color: White">
                                                    <td>
                                                        Flat MultiPoint Delivery
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="chkflatmultipointdelivery" onclick="javascript:return chkMultiPoint(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td colspan="3">
                                                        <input type="checkbox" id="chklocmultipointdelivery" onclick="javascript:return chkMultiPoint(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                </tr>
                                                <tr id="trunloading" runat="server" style="background-color: White">
                                                    <td>
                                                        Flat Unloading Charges
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="chkflatunloading" onclick="javascript:return chkUnLoading(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td colspan="3">
                                                        <input type="checkbox" id="chklocunloading" onclick="javascript:return chkUnLoading(this.getAttribute('id'))"
                                                            runat="server" style="margin-left: 1px;" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr style="background-color: white; width: 100%" id="trFOVCharge" runat="server"
                                                    visible="false">
                                                    <td>
                                                        <label class="blackfnt">
                                                            &nbsp;FOV Type:
                                                ...
                                                <tr style="background-color: White">
                                                    <td>Risk Type</td>
                                                    <td colspan="5">
                                                        <asp:RadioButtonList ID="optrisktype" runat="server" RepeatDirection="Horizontal" CssClass="blackfnt">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color: White">
                                                        <asp:CheckBox ID="chkTSCODDOD" runat="server" AutoPostBack="true" OnCheckedChanged="chkTSCODDOD_CheckedChanged"
                                                ...
                                                <tr bgcolor="White">
                                                    <td colspan="6">
                                                        <table runat="server" id="tblfuelsurcharge" style="width: 100%;" class="boxbg" cellspacing="1">
                                                            <tr bgcolor="White">
                                                                <td></td>
                                                                <td>Air</td>
                                                                <td>Road</td>
                                                ...
                                                <tr id="trTSVolumetricChecked" style="display: none;" runat="server">
                                                    <td colspan="6" style="background-color: White">
                                                        <table width="100%" border="0" class="boxbg" cellspacing="1" cellpadding="3">
                                                            <tr style="background-color: White">
                                                                ...
                                                                <td>
                                                                    <input id="txtCFTToKg" type="text" size="10" class="blackfnt" maxlength="8" onblur="return Nagative_Chk_wDecimal(this)"
                                                                        style="margin-left: 5px; border-style: groove; text-align: right" runat="server" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr style="background-color: White">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="cmbstaxpaidby" BackColor="White" runat="server">
                                                ...
                                                <tr id="trcombus" runat="server" style="background-color: White; display: none;">
                                                    ...
                                                    <td>
                                                        <input type="text" id="txtcommitedbusiness" class="input" maxlength="11" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))"
                ...
                <td>
                    ...
                    <table border="0" cellpadding="2" width="40%" bgcolor="#808080" cellspacing="1" align="center"
                        ...
                        <tr style="background-color: White">
                            ...
                            <td>
                                <input id="txtAirRateForFreight" type="text" size="10" class="blackfnt" maxlength="8"
                                    onblur="return Nagative_Chk_wDecimal(this)" style="margin-left: 5px; border-style: groove;
                        ...
                        <tr style="background-color: White">
                            ...
                            <td>
                                <input id="txtRoadRateForFreight" type="text" size="10" class="blackfnt" maxlength="8"
                                    onblur="return Nagative_Chk_wDecimal(this)" style="margin-left: 5px; border-style: groove;
                                    text-align: right;" runat="server" />
                            </td>
                            <td>
                        ...
                        <tr style="background-color: White">
                            ...
                            <td>
                                <input id="txtTrainRateForFreight" type="text" size="10" class="blackfnt" maxlength="8"
                                    onblur="return Nagative_Chk_wDecimal(this)" style="margin-left: 5px; border-style: groove;
                                    text-align: right;" runat="server" />
                            </td>
                            <td>
                        ...
                        <tr style="background-color: White">
                            ...
                            <td>
                                <input id="txtExpressRateForFreight" type="text" size="10" class="blackfnt" maxlength="8"
                                    onblur="return Nagative_Chk_wDecimal(this)" style="margin-left: 5px; border-style: groove;
                                    text-align: right;" runat="server" />
                            </td>
                            <td>
