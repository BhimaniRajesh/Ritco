    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
       ...
       sqltran = con.BeginTransaction();
        ...
        if (ftl.CompareTo("FTL") == 0)
            Response.Redirect("AddCCMStep3FreightFTL.aspx?TL=" + ftl + "&contractid=" + contractid + "&custcode=" + custcode + "&ODA=" + oda);
        else if (ftl.CompareTo("") == 0 && oda.CompareTo("Y") == 0)
            Response.Redirect("AddCCMODA.aspx?contractid=" + contractid + "&custcode=" + custcode);
        else
            Response.Redirect("CCM_DisplayResult.aspx?ContractID=" + contractid + "&custcode=" + custcode + "&CustCodeName=" + custname + "&CCMMode=E");
