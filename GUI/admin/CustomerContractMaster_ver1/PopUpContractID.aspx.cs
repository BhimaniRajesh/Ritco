...
public partial class GUI_admin_CustomerContractMaster_PopUpContractID : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string sqlstr = "SELECT DISTINCT custcode,custname=(SELECT top 1 custnm FROM webx_custhdr WHERE custcd=custcode) FROM webx_custcontract_hdr ORDER BY custname";
