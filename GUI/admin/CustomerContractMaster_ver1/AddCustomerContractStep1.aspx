<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddCustomerContractStep1.aspx.cs" Inherits="AddCustomerContractStep1"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <asp:Panel runat="server" Style="width: 10in;" HorizontalAlign="left">
        <asp:Table runat="server" CssClass="blackfnt" Width="100%">
            <asp:TableRow BackColor="White">
                <asp:TableCell Font-Bold="true" ColumnSpan="2">
				            Customer Contract Master - Add New Contract
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BackColor="white">
                <asp:TableCell HorizontalAlign="left">
                        Note:- mark indicates compulsory fields.
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />
