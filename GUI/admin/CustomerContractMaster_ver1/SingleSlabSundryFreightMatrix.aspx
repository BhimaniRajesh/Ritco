                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtairdays" BorderStyle="Groove" Text='<%# DataBinder.Eval( Container.DataItem,"air_days") %>'
                                                                ...
                                                                MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txttraindays" BorderStyle="Groove" Text='<%# DataBinder.Eval( Container.DataItem,"train_days") %>'
                                                                Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
