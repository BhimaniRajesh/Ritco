<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddCCMStep3BMSC.aspx.cs" Inherits="GUI_admin_CustomerContractMaster_AddCCMStep3BMSC"
    Title="Local" %>
...
function validateUpperSlabs()
{
    ...
    var cmb=document.getElementById("ctl00_MyCPH1_cmbratetype");
    if(cmb.value=="0")
    {
...
function popuplisthead(mode,ctlid,tbl,head)
 { 
    ...
    <script language="javascript" type="text/javascript">
        ...
        <font class="blackfnt">Add Multi Slab Freight Matrices</font><br />
        ...
        <table border="0" cellpadding="0" width="100%" cellspacing="1" align="center" class="boxbg">
            <tr style="background-color: White">
                ...
                <td align="left" style="height: 24px">
                    ...
                    <asp:DropDownList ID="cmbratetype" ontextchage="javascript:return resetRateType()" OnTextChanged="cmbratetype_TextChanged" AutoPostBack="true" runat="server" CssClass="blackfnt">
...
<div id="divgrids" style="display:none;">
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center" style="width: 25%">
                            ...
                            <asp:Button ID="btnrowsroadfreightbranch" Text="Generate Rows" OnClick="txtrowsroadfreightbranch_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="2"><br />
                                ...
                                <Columns>
                                 ...
                                 <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtfrom" onblur="javascript:return locCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnfrom" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" BackColor="White" Wrap="False" CssClass="blackfnt" />
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtto" onblur="javascript:return locCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txttransit" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" BackColor="White" Wrap="False" CssClass="blackfnt" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtslab1" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" BackColor="White" Wrap="False" CssClass="blackfnt" />
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtslab2" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" BackColor="White" Wrap="False" CssClass="blackfnt" />
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtslab3" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" BackColor="White" Wrap="False" CssClass="blackfnt" />
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtslab4" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" BackColor="White" Wrap="False" CssClass="blackfnt" />
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtslab5" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" BackColor="White" Wrap="False" CssClass="blackfnt" />
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtslab6"  Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="left" style="width: 25%">
                            <asp:TextBox ID="txtrowsexpressfreightbranch" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                            <asp:Button ID="btnrowsexpressfreightbranch" Text="Generate Rows" OnClick="txtrowsexpressfreightbranch_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="4"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="left" style="width: 25%">
                            <asp:TextBox ID="txtrowsairfreightbranch" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowsairfreightbranch" Text="Generate Rows" OnClick="txtrowsairfreightbranch_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="4"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center" style="width: 25%">
                            No of Rows : <asp:TextBox ID="txtrowstrainfreightbranch" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowstrainfreightbranch" Text="Generate Rows" OnClick="txtrowstrainfreightbranch_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="2"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center" style="width: 25%">
                            No of Rows : <asp:TextBox ID="txtrowsroadfreightzone" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowsroadfreightzone" Text="Generate Rows" OnClick="txtrowsroadfreightzone_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="2"><br />
                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtfrom" onblur="javascript:return zoneCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnfrom" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtto" onblur="javascript:return zoneCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnto" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="left" style="width: 25%">
                            <asp:TextBox ID="txtrowsexpressfreightzone" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                       <asp:Button ID="btnrowsexpressfreightzone" Text="Generate Rows" OnClick="txtrowsexpressfreightzone_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="4"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="left" style="width: 25%">
                            <asp:TextBox ID="txtrowsairfreightzone" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowsairfreightzone" Text="Generate Rows" OnClick="txtrowsairfreightzone_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="4"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center" style="width: 25%">
                            No of Rows : <asp:TextBox ID="txtrowstrainfreightzone" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowstrainfreightzone" Text="Generate Rows" OnClick="txtrowstrainfreightzone_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="2"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center" style="width: 25%">
                            No of Rows : <asp:TextBox ID="txtrowsroadfreightcity" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowsroadfreightcity" Text="Generate Rows" OnClick="txtrowsroadfreightcity_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="2"><br />
                                ...
                                <Columns>
                                  <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtfrom" onblur="javascript:return cityCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnfrom" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtto" onblur="javascript:return cityCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnto" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="left" style="width: 25%">
                            <asp:TextBox ID="txtrowsexpressfreightcity" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowexpressfreightcity" Text="Generate Rows" OnClick="txtrowsexpressfreightcity_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="4"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="left" style="width: 25%">
                            <asp:TextBox ID="txtrowsairfreightcity" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowairfreightcity" Text="Generate Rows" OnClick="txtrowsairfreightcity_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="4"><br />
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center" style="width: 25%">
                            No of Rows : <asp:TextBox ID="txtrowstrainfreightcity" Width="50px" Style="text-align: right;"
                                onkeypress="javascript:return noEnter(event)" runat="server"></asp:TextBox>
                        <asp:Button ID="btnrowtrainfreightcity" Text="Generate Rows" OnClick="txtrowstrainfreightcity_TextChanged" runat="server" />
                        </td>
                    </tr>
                    <tr bgcolor="#ffffff">
                        <td colspan="2"><br />
