...
public partial class GUI_AllTest_NewFTL : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            sqlstr = "SELECT DISTINCT ftltype,srno,ftl1_trip_ratetype FROM webx_custcontract_frtmatrix_ftlslabhdr";
            ...
            while (dr.Read())
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    try
                    {
                        // FIRST RECORD IS READ IN WHILE LOOP
                        if (i != 0)
                            dr.Read();
                        if (i == 0)
                        {
                        ...
                        {
                            case 0:
                                dtf.Rate1 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays1 = dr["ftl1_trdays"].ToString();
                                break;
                            case 1:
                                dtf.Rate2 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays2 = dr["ftl1_trdays"].ToString();
                                break;
                            case 2:
                                dtf.Rate3 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays3 = dr["ftl1_trdays"].ToString();
                                break;
                            case 3:
                                dtf.Rate4 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays4 = dr["ftl1_trdays"].ToString();
                                break;
                            case 4:
                                dtf.Rate5 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays5 = dr["ftl1_trdays"].ToString();
                                break;
                            case 5:
                                dtf.Rate6 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays6 = dr["ftl1_trdays"].ToString();
                                break;
                            case 6:
                                dtf.Rate7 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays7 = dr["ftl1_trdays"].ToString();
                                break;
                            case 7:
                                dtf.Rate8 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays8 = dr["ftl1_trdays"].ToString();
                                break;
                            case 8:
                                dtf.Rate9 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays9 = dr["ftl1_trdays"].ToString();
                                break;
                            case 9:
                                dtf.Rate10 = dr["ftl1_trip_rate"].ToString();
                                dtf.TrDays10 = dr["ftl1_trdays"].ToString();
            ...
            foreach (GridViewRow grv in grvcharges.Rows)
            {
                ...
                if (chk.Checked == true)
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        ...
                        strsql = strsql + "ftl1_trip_rate,ftl1_trip_ratetype,ftl1_trdays,contract_type) VALUES(";
                        ...
                        strsql = strsql + txttrdays[i].Text + ",'";
...
//                   {
//                       // FIRST RECORD IS READ IN WHILE LOOP
//                       if (i != 0 && oldfrom.CompareTo(dtf.From) == 0 && oldto.CompareTo(dtf.To) == 0)
//                           dr.Read();
