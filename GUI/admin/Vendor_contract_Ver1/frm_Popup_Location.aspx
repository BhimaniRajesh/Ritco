<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_Popup_Location.aspx.cs" Inherits="frm_Popup_Location" %>
    ...
    <form id="form1" runat="server">
            ...
            <tr>
                <td>
                    <font class="blackfnt"><b><u>Note:</u></b> 
                        <br />- For All Location list, keep blank the input box.
                    </font>
                </td>
            </tr>
        </table>
        ...
        <table border="1" cellspacing="1" cellpadding="2">
            ...
            <tr>
                ...
                <td>
                    <font class="blackfnt">
                        <asp:TextBox ID="tb_Location_Code" runat="server" BorderStyle="Groove" CssClass="input" MaxLength="15" Width="111px"></asp:TextBox>
                    </font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="250px">
                        <tr class="bgbluegrey">
                            ...
                            <td align="left" width="40%"><font class="blackfnt">Location Code</font></td>
                            <td align="left" width="50%"><font class="blackfnt">Location Name</font></td>
                        </tr>
                    </table>
                            ...
                            <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="250px">
                                <tr bgcolor="white">
                                    <td align="left" width="10%">
                                        <input type="radio" onclick="javascript:selectLocation(this);" value='<%#Eval("loccode")%>'~'<%#Eval("locname")%>' />
                                    </td>
                                    <td align="left" width="40%">
                                        <label class="blackfnt"><%#Eval("loccode")%></label>                                        
                                    </td>
                                    <td align="left" width="50%">
                                        <label class="blackfnt"><%#Eval("locname")%></label>                                        
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
