...
public partial class GUI_admin_Vendor_contract_Ver1_Docket_Based_Contract_Del : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Lbl_Contract_title2.Text = SessionUtilities.DocketCalledAs + " Based Contract Matrix : Delivery Charges";
    ...
    public void BindGrid()
    {
        ...
        ListVSD = VendorContract_DocketBasedController.GetByChgType(ContractCode, "D");
        if (ListVSD.Count <= 0)
        {
            ListVSD.Add(new VendorContract_DocketBased());
        }
