<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Docket_Based_Contract_Del.aspx.cs" Inherits="GUI_admin_Vendor_contract_Ver1_Docket_Based_Contract_Del" %>
                ...
                if(ChkInd.checked==true)
                {
                    ...
                    for(var j = 2; j < len; j++)
                    {
                        ...
                        if(i!=j)
                        {
                           ...
                           {
                               if(jTxt_Location.value==Txt_Location.value && jTxt_City.value==Txt_City.value &&  
                                  jDdl_Mode.value==Ddl_Mode.value && jDdl_Paybas.value==Ddl_Paybas.value)
                               {
                    ...
                    <tr>
                        <td>
                            ...
                            <table border="0" style="width: 8.0in" align="left" cellpadding="5" cellspacing="1"
                                ...
                                <tr bgcolor="#ffffff">
                                    <td class="bgbluegrey" colspan="2" align="Left">
                                        <asp:Label ID="Lbl_Contract_title2" Text="Cnote Based Contract Matrix : Delivery Charges" runat="server" Font-Bold="true"></asp:Label>
                                    </td>
                                </tr>
                                <tr bgcolor="#ffffff">
                                    <td align="Left">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Mode" ItemStyle-BackColor="white">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:ListItem Text="Delivery" Value="D" Selected="true"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="blackfnt" HorizontalAlign="left" />
                                                    <HeaderStyle CssClass="blackfnt" />
