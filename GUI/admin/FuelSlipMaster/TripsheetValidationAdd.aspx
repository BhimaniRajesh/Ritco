<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="TripsheetValidationAdd.aspx.cs" Inherits="GUI_admin_FuelSlipMaster_TripsheetValidationAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <%-- <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            document.getElementById('ctl00_MyCPH1_txtFitness').focus();
        });
    </script>
            ...
            <table border="0" cellspacing="1" cellpadding="3" width="500px" class="boxbg" id="tblDCRCriteria" runat="server" visible="true">
                <tr class="bgbluegrey">
                    <td colspan="6" style="text-align: left" align="center">
                        <asp:Label ID="lblTblHeader" runat="server" CssClass="blackfnt" Text="Validation Form: Add"
                ...
                <tr bgcolor="white">
                    <td align="right" colspan="3">
                        <asp:Button ID="btnSubmit" Width="47px" ValidationGroup="grpQuery" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
