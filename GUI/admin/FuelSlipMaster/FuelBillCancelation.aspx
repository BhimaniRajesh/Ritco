<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="FuelBillCancelation.aspx.cs" Inherits="GUI_admin_FuelSlipMaster_FuelBillCancelation" %>
            ...
            <table border="0" cellspacing="1" cellpadding="3" width="500px" class="boxbg" id="tblDCRCriteria"
                ...
                <tr class="bgbluegrey">
                    <td colspan="4" style="text-align: left" align="center">
                        <asp:Label ID="lblTblHeader" runat="server" CssClass="blackfnt" Text="Fuel Bill Cancelation"
                ...
                <tr bgcolor="white">
                    <td align="right" id="tdVendorlbl" width="25%">
                        <font class="blackfnt">Enter Bill No:</font>&nbsp;&nbsp;
                    </td>
                    <td align="left" id="tdVendortxt">
                        <asp:TextBox ID="txtBillNo" CssClass="input" BorderStyle="Groove" Width="200px" runat="server" TabIndex="1"></asp:TextBox>
                    </td>
                </tr>
                <tr bgcolor="white">
                    <td align="right" colspan="2">
                        <asp:Button ID="btnSubmit" ValidationGroup="grpQuery" runat="server" Text="Submit" OnClick="GetFuelBillCancellation"/>
                    </td>
                </tr>
            </table>
            <br />
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="dgGeneral" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                       ...
                                       <%-- <asp:BoundField DataField="Bill_No" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderText="Bill Number" ItemStyle-HorizontalAlign="Left" ReadOnly="True" SortExpression="BillNo" />

                                        <asp:TemplateField HeaderText="View Details" ItemStyle-Width="200px">
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server" Target="_blank" NavigateUrl='<%# string.Format("~/GUI/admin/FuelSlipMaster/FuelIssueSlipCancelationView.aspx?Bill_No={0}", HttpUtility.UrlEncode(Eval("Bill_No").ToString())) %>' Text="View" />
                                            </ItemTemplate> 
                                        </asp:TemplateField>--%>  

                                          <asp:HyperLinkField HeaderStyle-Width="200px" DataTextField="Bill_No"  Target="_blank" ItemStyle-HorizontalAlign="Left" DataNavigateUrlFields="Bill_No" DataNavigateUrlFormatString="~/GUI/admin/FuelSlipMaster/FuelBillCancelation_View.aspx?Bill_No={0}" InsertVisible="false" HeaderText="Fuel Bill No" HeaderStyle-HorizontalAlign="Left" />

                                        <asp:TemplateField HeaderText="Remarks">
                                            <ItemTemplate>
                                                <asp:TextBox CssClass="input" Width="270px" BorderStyle="Groove" runat="server" ID="txtbxRemarks"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
