<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="FuelBillCancelation_View.aspx.cs" Inherits="GUI_admin_FuelSlipMaster_FuelBillCancelation_View" %>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="dgGeneral" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Bill_No" HeaderText="Bill Number" ReadOnly="true" />
                                        ...
                                        <asp:BoundField DataField="TotalLtr" HeaderText="Total Litre" ReadOnly="true" />
