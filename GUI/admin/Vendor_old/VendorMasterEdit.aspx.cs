...
public partial class GUI_admin_Vendor_VendorMasterEdit : System.Web.UI.Page
{
    ...
    protected void ddVendorType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            cn.Open();
            SqlCommand cmd = new SqlCommand("select vendorname + ' : ' + vendorcode as a,vendorcode as b from webx_VENDOR_HDR where Vendor_Type='" + strVndrCd[1].ToString().Trim() + "' order by vendorname", cn);
