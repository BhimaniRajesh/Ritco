                                 ...
                                 <asp:Label ID="lblsrnocomplainlist" text ="<%# Container.DataItemIndex+1 %>" runat="server">
                                                                  ...
                                                                  <asp:TemplateField HeaderText="Location Code " >
                                                                                ...
                                                                                <ItemTemplate>
                                                                                       ...
                                                                                       <asp:TextBox ID="txtloc" Width="40" runat="server"  onblur="return checklocation(this)" BorderStyle="Groove"></asp:TextBox>
                              ...
                              <ajaxToolkit:AutoCompleteExtender ID="Extender1" runat="server" Enabled="True" CompletionListItemCssClass="autocomplete_listItem"
                                                ...
                                                ServiceMethod="GetlocationList" ServicePath="../../../GUI/services/location.asmx" TargetControlID="txtloc">
                                                                                ...
                                                                                <ItemTemplate>
                                                                                     ...
                                                                                     <asp:TextBox ID="txtcontper" Width="120" runat="server" BorderStyle="Groove"  Columns="8"    ></asp:TextBox>				<%--OnTextChanged="OnAmtChg" AutoPostBack="true" --%>		              
                                                                                ...
                                                                                <ItemTemplate>
                                                                                       ...
                                                                                       <asp:TextBox ID="txtadr" Width="120" runat="server" TextMode="multiLine" BorderStyle="Groove" Columns="8" ></asp:TextBox>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TextBox ID="txtcity" Width="70" runat="server" BorderStyle="Groove" Columns="8"   ></asp:TextBox>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TextBox ID="txtpin" Width="70" runat="server" BorderStyle="Groove" Columns="8"   ></asp:TextBox>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TextBox ID="txttel" Width="70" MaxLength="10" runat="server" BorderStyle="Groove" Columns="8"   ></asp:TextBox>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TextBox ID="txtmob" Width="70"  MaxLength="10" runat="server" BorderStyle="Groove" Columns="8"   ></asp:TextBox>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TextBox ID="txtemail" Width="120" runat="server" BorderStyle="Groove" Columns="8"   ></asp:TextBox>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TextBox ID="txtactflag" Width="20" runat="server" BorderStyle="Groove" Columns="8"   ></asp:TextBox>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TextBox ID="txtblack" Width="20" runat="server" BorderStyle="Groove" Columns="8"   ></asp:TextBox>
