<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="View_acctGroups.aspx.cs" Inherits="GUI_admin_Accounts_masters_Acctgroup_View_acctGroups" Title="Untitled Page" %>
...
{
    var Groupcode= document.getElementById(Form_name+"dlstAccountsGroups");
        ...
        <tr>   
            <td>
                <table  border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width:7in"  align="Center" >
                   <tr  class="bgbluegrey" >
                        <td align="center" colspan="2" class="blackfnt" ><b>Quick View Accounts Group</b> </td>
                   </tr>
                   <tr bgcolor="#ffffff">
                   ...
                   <tr bgcolor="#ffffff">
                        <td align="Right" class="blackfnt" style="width: 190px"><asp:Label ID="lblgroupheader" runat="server" Text="Enter Company Group Code : "></asp:Label>&nbsp; </td>
                   ...
                   <tr  class="bgbluegrey" >
                        <td align="center" colspan="2" class="blackfnt" ><b><asp:Button ID="Submit" Text="View" CssClass="blackfnt" Width="1in" runat="server" OnClick="Edit_Click" /></b></td>
                   </tr>
                </table>
            </td>
        </tr>
