<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLocation.aspx.cs" Inherits="GUI_WebAdmin_popup_cust" %>
...
<head runat="server">
   ...
   <script language="javascript">
    ...
    function Child(obj)
    {
        ...
        if(hdnflag.value == "Y")
	        window.opener.document.aspnetForm.ctl00$MyCPH1$txtbrcd.value=Str;
	    else
	        window.opener.document.aspnetForm.ctl00$MyCPH1$txtLocation.value=Str;    
    }
    ...
    <tr>
        <td>
            <table border="0" width="90%" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr class="bgbluegrey">
                            <td width="10%" align="center"><input name="chkall" type="checkbox" onclick="Checkall(this);" value='ALL' ></td>
            ...
            <asp:DataList ID="DataList1" runat="server" width="90%">
                ...
                <ItemTemplate>
                    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr>
                            <td width="10%" bgcolor="white" align="left">&nbsp;<input name="chk" type="checkbox" onclick="Child(this);" value='<%#DataBinder.Eval(Container.DataItem,"LocCode") %>' ></td>
