<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="View_accounts_step_2.aspx.cs" Inherits="GUI_admin_Accounts_masters_Acctgroup_View_acctGroups_step_2" Title="Untitled Page" %>
                                            ...
                                            <div align="left">
                                                <asp:GridView CssClass="boxbg" runat="server" CellSpacing="1" BorderWidth="0" ID="grvcontrols"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Font-Bold="true" HeaderText="Account Code">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblacccode" Text='<%# DataBinder.Eval(Container.DataItem,"AccCode") %>'
                                                                    runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                        <asp:TemplateField HeaderStyle-Font-Bold="true" HeaderText="Account Description">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblgroupdesc"  Text='<%# DataBinder.Eval(Container.DataItem,"Accdesc") %>'
                                                                    runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-Font-Bold="true" HeaderText="Group Code">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblparentcode" Text='<%# DataBinder.Eval(Container.DataItem,"GroupCode") %>'
                                                                    runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-Font-Bold="true" HeaderText="Company Account Code">
                                                            <HeaderStyle HorizontalAlign="left" Wrap="False" BackColor="#d4e0e7" CssClass="blackfnt" />
                                                            <ItemStyle CssClass="blackfnt" BackColor="white" HorizontalAlign="left" Width="20%"/>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblcompanygroupcode" Text='<%# DataBinder.Eval(Container.DataItem,"Company_Acccode") %>'
                                                                    runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
