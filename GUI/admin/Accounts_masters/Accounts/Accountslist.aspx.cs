...
public partial class GUI_admin_Accounts_masters_Accounts_Accountslist : System.Web.UI.Page
{
    public static string pcode = "", srchcol = "", srchcolval = "", srchcolvalstr="";
    ...
    public void DipsplayReport()
    {
        ...
        sqlCommand.CommandText = "webx_Account_details";

        sqlCommand.Parameters.AddWithValue("@srchcol", srchcol);
        sqlCommand.Parameters.AddWithValue("@srchcolval", srchcolval);
        sqlCommand.Parameters.AddWithValue("@srchcolvalstr", srchcolvalstr);
