<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account_Add_SubGroup_PopUp.aspx.cs" Inherits="GUI_admin_Accounts_masters_Accounts_Account_Add_PopUp" %>
    ...
    <table border="0" width="100%">
        <tr>
            ...
            <td width="90%">
                <br />
                <br />
                <table border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width: 720px; height: 241px;">
                    <tr class="bgbluegrey">
                    ...
                    <tr bgcolor="white">
                        ...
                        <td align="left">
                            ...
                            <font class="blackfnt">&nbsp;<asp:UpdatePanel ID="UP1" runat="server"   UpdateMode="Conditional" RenderMode="Inline">
                                <ContentTemplate>
                                <asp:DropDownList ID="dlstCategory" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Change_Group">
                    ...
                    <tr bgcolor="white">
                        ...
                        <td align="left">
                            &nbsp;<asp:UpdatePanel ID="UpdatePanel1" runat="server"  UpdateMode="Conditional" RenderMode="Inline">
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="dlstCategory" EventName="SelectedIndexChanged" />
                                </Triggers>
                                </asp:UpdatePanel>
                    ...
                    <br />
                    <table border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width: 720px; height: 89px;">
                     <tr class="bgbluegrey">
                        <td align="center" colspan="2">
