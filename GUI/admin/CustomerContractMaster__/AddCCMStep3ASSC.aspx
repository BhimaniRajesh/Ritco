<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="AddCCMStep3ASSC.aspx.cs" Inherits="AddCCMStep3ASSC" EnableEventValidation="false" %>
...
function noEnter(event)
{
 ...
 <br />
 <font class="blackfnt"><b><u>Customer Contract</u> >> <font class="bluefnt"><b>Single Slab Matrices - Sundry Add New</b></font></b></font>
  <br /><br />
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtairrate" Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtairtransit" Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtroadrate" Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtroadtransit" Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txttrainrate" Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txttraintransit" Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtexpressrate" Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtexpresstransit" Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
