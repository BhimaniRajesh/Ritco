...
<br />
 <font class="blackfnt"><b><u>Customer Contract</u> >> <font class="bluefnt"><b>Single Slab Matrices - Sundry Edit</b></font></b></font>
  <br /><br />
            ...
            <ContentTemplate>
                <table border="0" id="tblbranch" runat="server" cellpadding="0" style="width: 100%" cellspacing="1" class="boxbg">
                    ...
                    <tr bgcolor="#ffffff">
                        ...
                        <td align="center" style="width: 25%">
                            No of Rows : <asp:TextBox ID="txtrowsbranch" MaxLength="3" Width="50px" Style="text-align: right;"
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtfrom" Text='<%# DataBinder.Eval( Container.DataItem,"fromlocode") %>' onblur="javascript:return locCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtto" Text='<%# DataBinder.Eval( Container.DataItem,"tolocode") %>' onblur="javascript:return locCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtairrate" Text='<%# DataBinder.Eval( Container.DataItem,"air_rate") %>' Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtairtransit" Text='<%# DataBinder.Eval( Container.DataItem,"air_days") %>' Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtroadrate" Text='<%# DataBinder.Eval( Container.DataItem,"road_rate") %>' Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtroadtransit" Text='<%# DataBinder.Eval( Container.DataItem,"road_days") %>' Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txttrainrate" Text='<%# DataBinder.Eval( Container.DataItem,"train_rate") %>' Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txttraintransit" Text='<%# DataBinder.Eval( Container.DataItem,"train_days") %>' Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtexpressrate" Text='<%# DataBinder.Eval( Container.DataItem,"express_rate") %>' Style="text-align: right;" MaxLength="8" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtexpresstransit" Text='<%# DataBinder.Eval( Container.DataItem,"express_days") %>' Style="text-align: right;" MaxLength="3" onkeypress="javascript:return validInt(event)" Width="50px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtfrom" Text='<%# DataBinder.Eval( Container.DataItem,"fromregion") %>' onblur="javascript:return zoneCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnfrom" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtto" Text='<%# DataBinder.Eval( Container.DataItem,"toregion") %>' onblur="javascript:return zoneCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnto" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtfrom" Text='<%# DataBinder.Eval( Container.DataItem,"fromcity") %>' onblur="javascript:return cityCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnfrom" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtto" Text='<%# DataBinder.Eval( Container.DataItem,"tocity") %>' onblur="javascript:return cityCodeTest(this.getAttribute('id'))" Width="50px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnto" Text="...." runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
