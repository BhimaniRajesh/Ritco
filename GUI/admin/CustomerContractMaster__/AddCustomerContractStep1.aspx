<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="AddCustomerContractStep1.aspx.cs" Inherits="AddCustomerContractStep1" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        {   
            ...
            //Check for Contract Signing Location
            if(document.getElementById("ctl00_MyCPH1_txtContractSigningLocation"))
            {
                if(document.getElementById("ctl00_MyCPH1_txtContractSigningLocation").value == "")
                {
                    alert("Enter 'Contract Signing Location'");
                    document.getElementById("ctl00_MyCPH1_txtContractSigningLocation").focus();
                    return false;
                }
                
                //Hide error message lable for 
                //Contract Signing Location
                if(document.getElementById("ctl00_MyCPH1_lblErrorContSignLocation"))
                {
                    if(document.getElementById("ctl00_MyCPH1_lblErrorContSignLocation").style.display == '')
                    {
                        alert("Enter valid 'Contract Signing Location'");
                        document.getElementById("ctl00_MyCPH1_txtContractSigningLocation").focus();
                        return false;
                    }
                }
            ...
            if(document.getElementById("ctl00_MyCPH1_txtPinCode"))
            {
                if(document.getElementById("ctl00_MyCPH1_txtPinCode").value != "")
                {
                    if(!IsNumeric(document.getElementById("ctl00_MyCPH1_txtPinCode").value))
                    {
                        alert("Enter 'Pin Code' in Numeric format");
                        document.getElementById("ctl00_MyCPH1_txtPinCode").focus();
                        return false;
                    }
                    
                    if(parseFloat(document.getElementById("ctl00_MyCPH1_txtPinCode").value.length) < 6)	
			        {
    ...
    <div>
        ...
        <table cellpadding="1" cellspacing="1" border="0" width="100%">
            ...
            <tr>
			    <td colspan="2">
				    <label class="blackfnt">
				        <b>
				            Customer Contract Master - New Contract				            
				        </b>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Label Font-Bold="true" Font-Underline="true" CssClass="blackfnt" runat="server">
                        Note:-    
                    </asp:Label>
                    ...
                    <label class="blackfnt">
                        mark indicates compulsory fields.&nbsp;
                    </label>
                </td>
            </tr>
        </table>
                    ...
                    <td style="width: 90%">
                        <table cellpadding="1" cellspacing="1" class="boxbg" width="100%" border="0">
                            ...
                            <tr class="bgbluegrey" runat="server">
                                <td colspan="4" align="left" style="height: 25px;" nowrap>
                                    <label class="blackfnt">
                                        <strong>
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtContractDate" class="input" size="12" 
                                        runat="server" maxlength="10" onblur="return ValidateDate(this)" />
                                    
                                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtContractDate, 'alnkContractDate', 'dd/MM/yyyy'); return false;" 
							            id="alnkContractDate">
                                    ...
                                    <label class="blackfnt" style="margin-left: 3px;">
                                        &nbsp;(dd/mm/yyyy)&nbsp;
                                    </label>
                                </td>
                                ...
                                <td align="left" valign="top" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtValidUntil" class="input" size="12" 
                                        runat="server" maxlength="10" onblur="return ValidateDate(this)" />        
                                    
                                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtValidUntil, 'alnkValidUntil', 'dd/MM/yyyy'); return false;" 
							            id="alnkValidUntil">
							            <img src="./images/calendar.jpg" border="0" />
							        </a>
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtEffFromDate" class="input" size="12" 
                                        runat="server" maxlength="10" onblur="return ValidateDate(this)" />
                                    
                                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtEffFromDate, 'alnkEffFromDate', 'dd/MM/yyyy'); return false;" 
							            id="alnkEffFromDate">
							            <img src="./images/calendar.jpg" border="0" />
							        </a>
                                ...
                                <td align="left" valign="top" nowrap>
                                    <asp:UpdatePanel ID="upContSingLoc" runat="server">
                                        <ContentTemplate>
                                            &nbsp;
                                            <asp:TextBox ID="txtContractSigningLocation" runat="server" 
                                                OnTextChanged="txtContractSigningLocation_TextChanged" CssClass="input" 
                                                width="40px" MaxLength="10" AutoPostBack="true">
                                            </asp:TextBox>    
                                            
                                            <input type="button" value="..." runat="server" id="btnContractSigningLocation" 
                                                onclick="return BranchPopup('Branch_Popup.aspx?1')" />
                                            <br />           
                                            <label class="blackfnt" id="lblErrorContSignLocation" runat="server" style="color: Red;" visible="false">
                                                &nbsp;Invalid location code!!!
                                            </label>        
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="txtContractSigningLocation" EventName="TextChanged" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtCustomerRepresentative" size="25" 
                                        runat="server" maxlength="50" 
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                </td>
                                ...
                                <td align="left" valign="top" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtCoEmpName" runat="server" size="25" maxlength="50" 
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                </td>
                            </tr>
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtCustRepDesignation" size="25" 
                                        runat="server" maxlength="50" 
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                </td>
                                ...
                                <td align="left" valign="top" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtCoEmpDesignation" runat="server" size="25" maxlength="50" 
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                </td>
                            </tr>
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtCustWitness" size="25" 
                                        runat="server" maxlength="50" 
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                </td>
                                ...
                                <td align="left" valign="top" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtCoWitness" runat="server" 
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtBillingAddress" size="25" 
                                ...
                                <td align="left" valign="top" nowrap>
                                    ...
                                    <input type="text" id="txtCity" runat="server" 
                                        ...
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                    -
                                    <input type="text" id="txtPinCode" runat="server" 
                                        size="4" maxlength="6" 
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                </td>
                            </tr>
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left">
                                    &nbsp;
                                    <asp:DropDownList ID="ddlPartyCategory" runat="server" CssClass="blackfnt">
                                ...
                                <td align="left" valign="top">
                                    &nbsp;
                                    <asp:DropDownList ID="ddlContractCategory" runat="server" CssClass="blackfnt">
                                        <asp:ListItem Selected="True" Text="Select" Value="-1"></asp:ListItem>
                            ...
                            <tr style="background-color: White" runat="server">
                                ...
                                <td style="width:25%;" valign="top" align="left" nowrap>
                                    <input type="checkbox" id="chkSTApp" runat="server" 
                                ...
                                <td align="left" valign="top" nowrap>
                                    &nbsp;
                                    <input type="text" id="txtAccountsRepresentative" runat="server" size="25" maxlength="50" 
                                        onblur="javascript:this.value=this.value.toUpperCase(); this.value = trimAll(this.value)" />
                                </td>
                            </tr>  
