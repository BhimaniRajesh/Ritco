<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="AddCustomerContractStep2.aspx.cs" Inherits="AddCustomerContractStep2" EnableEventValidation="false" %>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="background-color: White">
                                                                            <input type="checkbox" id="chkTSCODDOD" runat="server"  
                                                                                onclick="CODDODChecked(this)" class="blackfnt"  />
                                                                            <label class="blackfnt">
                                                                                COD/DOD
                                                                            </label>
                                                                        </td>
                                                                        ...
                                                                        <td style="background-color: White">
                                                                            ...
                                                                            <input type="checkbox" id="chkTSVolumetric" runat="server"  
                                                                                onclick="VolumetricChecked(this)" class="blackfnt"  />
                                                                            <label class="blackfnt">
                                                                                Volumetric
                                                                            </label>
                                                                        </td>
                                                                        ...
                                                                        <td style="background-color: White" colspan="2" valign="top">
                                                                            ...
                                                                            <input type="checkbox" id="chkTSDACC" runat="server"  
                                                                                onclick="DACCChecked(this)" class="blackfnt"  />
                                                                            <label class="blackfnt">
                                                                                DACC
                                                                            </label>
