...
public partial class EditCustomerContractStep2 : System.Web.UI.Page
{
    ...
    private void displayData()
    {
        ...
        if (dsCCM.Tables[0].Rows.Count > 0)
        {
            ...
            //Door Pickup Charges
            //txtDoorPickupCharge.Value = (dsCCM.Tables[0].Rows[0]["dp_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dp_chrg"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dp_chrg"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dp_chrg"]).ToString("0.00") : ""));
            //txtDoorPickupChargePerKg.Value = (dsCCM.Tables[0].Rows[0]["dp_chrg_perkg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dp_chrg_perkg"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dp_chrg_perkg"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dp_chrg_perkg"]).ToString("0.00") : ""));
            ...
            //txtDoorDeliveryCharge.Value = (dsCCM.Tables[0].Rows[0]["dd_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dd_chrg"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dd_chrg"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dd_chrg"]).ToString("0.00") : ""));
            //txtDoorDeliveryChargePerKg.Value = (dsCCM.Tables[0].Rows[0]["dd_chrg_perkg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dd_chrg_perkg"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dd_chrg_perkg"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dd_chrg_perkg"]).ToString("0.00") : ""));
            ...
            //txtFOVCharge.Value = (dsCCM.Tables[0].Rows[0]["fov_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["fov_chrg"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["fov_chrg"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["fov_chrg"]).ToString("0.00") : ""));
            //txtInsPer.Value = (dsCCM.Tables[0].Rows[0]["insu_per"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["insu_per"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["insu_per"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["insu_per"]).ToString("0.00") : ""));
            ...
            if (chkTSVolumetric.Checked == true)
            {
                ...
                //txtCFTToKg.Value = (dsCCM.Tables[0].Rows[0]["cft2kg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["cft2kg"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["cft2kg"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["cft2kg"]).ToString("0.00") : ""));
            ...
            if (chkTSDACC.Checked == true)
            {
                ...
                //txtDACCChargeRs.Value = (dsCCM.Tables[0].Rows[0]["dacc_chrg_rs"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dacc_chrg_rs"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dacc_chrg_rs"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dacc_chrg_rs"]).ToString("0.00") : ""));
                //txtDACCChargePer.Value = (dsCCM.Tables[0].Rows[0]["dacc_chrg_per"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dacc_chrg_per"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dacc_chrg_per"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dacc_chrg_per"]).ToString("0.00") : ""));
            ...
            //Demurrage Charges
            //txtDemAfterDays.Value = (dsCCM.Tables[0].Rows[0]["dem_day"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dem_day"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToInt32(dsCCM.Tables[0].Rows[0]["dem_day"]) > 0 ? Convert.ToInt32(dsCCM.Tables[0].Rows[0]["dem_day"]).ToString() : "");
            ...
            //txtCreditLimit.Value = (dsCCM.Tables[0].Rows[0]["credit_limit"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["credit_limit"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["credit_limit"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["credit_limit"]).ToString("0.00") : ""));
            ...
            //Charges
            txtSCHG01.Value = dsCCM.Tables[0].Rows[0]["dkt_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG02.Value = dsCCM.Tables[0].Rows[0]["Hamali_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG03.Value = dsCCM.Tables[0].Rows[0]["otchg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG04.Value = dsCCM.Tables[0].Rows[0]["nform_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG05.Value = dsCCM.Tables[0].Rows[0]["hld_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG06.Value = dsCCM.Tables[0].Rows[0]["oct_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG09.Value = dsCCM.Tables[0].Rows[0]["state_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG10.Value = dsCCM.Tables[0].Rows[0]["hld_dlychrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG15.Value = dsCCM.Tables[0].Rows[0]["mathadi_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG16.Value = dsCCM.Tables[0].Rows[0]["risk_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG17.Value = dsCCM.Tables[0].Rows[0]["surcharge"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG18.Value = dsCCM.Tables[0].Rows[0]["st_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG19.Value = dsCCM.Tables[0].Rows[0]["oda_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG20.Value = dsCCM.Tables[0].Rows[0]["fuelchrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG21.Value = dsCCM.Tables[0].Rows[0]["fod_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG22.Value = dsCCM.Tables[0].Rows[0]["DC_DD_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtSCHG23.Value = dsCCM.Tables[0].Rows[0]["STSRE_chrg"].ToString().ToUpper().Trim().Replace("NULL", "0.00");

            txtUCHG01.Value = dsCCM.Tables[0].Rows[0]["User_chrg_1"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG02.Value = dsCCM.Tables[0].Rows[0]["User_chrg_2"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG03.Value = dsCCM.Tables[0].Rows[0]["User_chrg_3"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG04.Value = dsCCM.Tables[0].Rows[0]["User_chrg_4"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG05.Value = dsCCM.Tables[0].Rows[0]["User_chrg_5"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG06.Value = dsCCM.Tables[0].Rows[0]["User_chrg_6"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG07.Value = dsCCM.Tables[0].Rows[0]["User_chrg_7"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG08.Value = dsCCM.Tables[0].Rows[0]["User_chrg_8"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG09.Value = dsCCM.Tables[0].Rows[0]["User_chrg_9"].ToString().ToUpper().Trim().Replace("NULL", "0.00");
            txtUCHG10.Value = dsCCM.Tables[0].Rows[0]["User_chrg_10"].ToString().ToUpper().Trim().Replace("NULL", "0.00");

            //Minimum Freight
            txtAirRateForFreight.Value = dsCCM.Tables[0].Rows[0]["air_rate"].ToString().ToUpper().Trim().Replace("NULL", "");
            txtRoadRateForFreight.Value = dsCCM.Tables[0].Rows[0]["road_rate"].ToString().ToUpper().Trim().Replace("NULL", "");
            txtTrainRateForFreight.Value = dsCCM.Tables[0].Rows[0]["rail_rate"].ToString().ToUpper().Trim().Replace("NULL", "");
            txtExpressRateForFreight.Value = dsCCM.Tables[0].Rows[0]["exp_rate"].ToString().ToUpper().Trim().Replace("NULL", "");

            //txtSCHG01.Value = (dsCCM.Tables[0].Rows[0]["dkt_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["dkt_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["dkt_chrg"]).ToString("0.0"));
            //txtSCHG02.Value = (dsCCM.Tables[0].Rows[0]["Hamali_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["Hamali_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["Hamali_chrg"]).ToString("0.0"));
            //txtSCHG03.Value = (dsCCM.Tables[0].Rows[0]["otchg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["otchg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["otchg"]).ToString("0.0"));
            //txtSCHG04.Value = (dsCCM.Tables[0].Rows[0]["nform_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["nform_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["nform_chrg"]).ToString("0.0"));
            //txtSCHG05.Value = (dsCCM.Tables[0].Rows[0]["hld_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["hld_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["hld_chrg"]).ToString("0.0"));
            //txtSCHG06.Value = (dsCCM.Tables[0].Rows[0]["oct_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["oct_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["oct_chrg"]).ToString("0.0"));
            //txtSCHG09.Value = (dsCCM.Tables[0].Rows[0]["state_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["state_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["state_chrg"]).ToString("0.0"));
            //txtSCHG10.Value = (dsCCM.Tables[0].Rows[0]["hld_dlychrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["hld_dlychrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["hld_dlychrg"]).ToString("0.0"));
            //txtSCHG15.Value = (dsCCM.Tables[0].Rows[0]["mathadi_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["mathadi_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["mathadi_chrg"]).ToString("0.0"));
            //txtSCHG16.Value = (dsCCM.Tables[0].Rows[0]["risk_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["risk_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["risk_chrg"]).ToString("0.0"));
            //txtSCHG17.Value = (dsCCM.Tables[0].Rows[0]["surcharge"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["surcharge"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["surcharge"]).ToString("0.0"));
            //txtSCHG18.Value = (dsCCM.Tables[0].Rows[0]["st_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["st_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["st_chrg"]).ToString("0.0"));
            //txtSCHG19.Value = (dsCCM.Tables[0].Rows[0]["oda_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["oda_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["oda_chrg"]).ToString("0.0"));
            //txtSCHG20.Value = (dsCCM.Tables[0].Rows[0]["fuelchrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["fuelchrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["fuelchrg"]).ToString("0.0"));
            //txtSCHG21.Value = (dsCCM.Tables[0].Rows[0]["fod_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["fuelchrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["fod_chrg"]).ToString("0.0"));
            //txtSCHG22.Value = (dsCCM.Tables[0].Rows[0]["DC_DD_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["DC_DD_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["DC_DD_chrg"]).ToString("0.0"));
            //txtSCHG23.Value = (dsCCM.Tables[0].Rows[0]["STSRE_chrg"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["STSRE_chrg"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["STSRE_chrg"]).ToString("0.0"));

            //txtUCHG01.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_1"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_1"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_1"]).ToString("0.0"));
            //txtUCHG02.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_2"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_2"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_2"]).ToString("0.0"));
            //txtUCHG03.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_3"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_3"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_3"]).ToString("0.0"));
            //txtUCHG04.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_4"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_4"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_4"]).ToString("0.0"));
            //txtUCHG05.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_5"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_5"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_5"]).ToString("0.0"));
            //txtUCHG06.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_6"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_6"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_6"]).ToString("0.0"));
            //txtUCHG07.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_7"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_7"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_7"]).ToString("0.0"));
            //txtUCHG08.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_8"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_8"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_8"]).ToString("0.0"));
            //txtUCHG09.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_9"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_9"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_9"]).ToString("0.0"));
            //txtUCHG10.Value = (dsCCM.Tables[0].Rows[0]["User_chrg_10"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["User_chrg_10"].ToString().ToUpper().Trim() == "" ? "" : Convert.ToDouble(dsCCM.Tables[0].Rows[0]["User_chrg_10"]).ToString("0.0"));

            ////Minimum Freight
            //txtAirRateForFreight.Value = (dsCCM.Tables[0].Rows[0]["air_rate"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["air_rate"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["air_rate"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["air_rate"]).ToString("0.00") : ""));
            //txtRoadRateForFreight.Value = (dsCCM.Tables[0].Rows[0]["road_rate"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["road_rate"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["road_rate"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["road_rate"]).ToString("0.00") : ""));
            //txtTrainRateForFreight.Value = (dsCCM.Tables[0].Rows[0]["rail_rate"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["rail_rate"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["rail_rate"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["rail_rate"]).ToString("0.00") : ""));
            //txtExpressRateForFreight.Value = (dsCCM.Tables[0].Rows[0]["exp_rate"].ToString().ToUpper().Trim() == "NULL" || dsCCM.Tables[0].Rows[0]["exp_rate"].ToString().ToUpper().Trim() == "" ? "" : (Convert.ToDouble(dsCCM.Tables[0].Rows[0]["exp_rate"]) > 0 ? Convert.ToDouble(dsCCM.Tables[0].Rows[0]["exp_rate"]).ToString("0.00") : ""));
