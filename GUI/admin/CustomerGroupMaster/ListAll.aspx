                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GridView1" runat="server" AllowPaging="true" AllowSorting="true"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="GRPNM" HeaderText="Customer Code">
                                                            <ItemStyle CssClass="blackfnt" HorizontalAlign="Left" />
                                                            <HeaderStyle CssClass="bgbluegrey" HorizontalAlign="Left" Wrap="False" />
                                                        </asp:BoundField>
                                                        <asp:TemplateField HeaderText="Edit" HeaderStyle-Font-Bold="true">
                                                            ...
                                                            <ItemTemplate>
                                                                <label class="blackfnt">
                                                                    <asp:HyperLink Font-Underline="True" runat="server" NavigateUrl='<%#"CustomerGroupMasterEdGet.aspx?para=2&gname="+DataBinder.Eval(Container.DataItem, "GRPNM")+"&grpcd="+DataBinder.Eval(Container.DataItem, "GRPCD")%>'
