...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
            ...
            if(mNo == 1)
            {
                window.opener.document.forms[0].ctl00$MyCPH1$txtCstGrpCd.value = objLocation.value
            }
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" ItemStyle-BackColor="white" ItemStyle-Width="40px" >
                                    <ItemTemplate>
                                        <input name="MyRadioButton" type="radio" value='<%# Eval("GRPCD") %>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField DataField="GRPNM" HeaderText="Group Name">
