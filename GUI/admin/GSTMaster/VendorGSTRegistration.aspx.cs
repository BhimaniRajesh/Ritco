...
public partial class GUI_admin_GSTMaster_VendorGSTRegistration : BasePage
{
    public string filename = "VendorGST";
    public string procedure = "Usp_VendorGST_Upload";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack && !IsCallback)
        {
            ...
            using (var oDal = new WebXHelper())
            {
                ...
                { dtFormat = oHelper.GetColumnList("VendorGST"); }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                var oGSTCustomerMasterEntity = new GSTVendorMasterEntity();

                oGSTCustomerMasterEntity.VendorCode = hdnVendorCode.Value;
                ...
                SqlParameter[] prm = {
                                         new SqlParameter("@VendorHdrDetail", XmlUtility.XmlSerializeToString(oGSTCustomerMasterEntity))
                                     };
                ...
                oHelper.strModuleName = "VendorGST";
            ...
            else
            {
                ...
                {
                    checkRowData();
                    var oGSTVendorMasterEntity = new GSTVendorMasterEntity();

                    oGSTVendorMasterEntity.VendorCode = hdnVendorCode.Value;
                    oGSTVendorMasterEntity.Address = txtGSTBillingAddres.Text;

                    oGSTVendorMasterEntity.StateCode = hdnGSTState.Value;
                    oGSTVendorMasterEntity.CityCode = hdnGSTCity.Value;
                    oGSTVendorMasterEntity.CGSTNumber = txtCGSTNumber.Text;
                    oGSTVendorMasterEntity.IGSTNumber = txtIGSTNumber.Text;
                    ...
                    oGSTVendorMasterEntity.ListGSTMasterEntity = lst_GSTMasterEntity;
                    var oGSTMasterController = new GSTMasterController();
                    var dt = oGSTMasterController.InsertVendorGSTDetail(oGSTVendorMasterEntity);
                    ...
                    {
                        //msgBox.Show("Vendor GST Registration details saved successfully.");
                        ConsumeToken();
    ...
    protected void fillData()
    {
        ...
        {
            var oGSTMasterController = new GSTMasterController();
            var dt = oGSTMasterController.GetVendorGSTDetail(hdnVendorCode.Value);
            ...
            {
                lblCutomerID.Text = dt.Tables[0].Rows[0]["VENDORCODE"].ToString() + " : " + dt.Tables[0].Rows[0]["VENDORNAME"].ToString();
            ...
            //tdVendorCriteria.Attributes["disabled"] = "disabled";
    ...
    protected void rptOrderEntry_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            txtGSTTiNumber.Attributes["onblur"] = "return onValidateIGSTNumberExist(this,'VENDOR','" + hdnVendorCode.Value + "');";
            //txtProvisionalNumber.Attributes["onblur"] = "return onValidateCGSTNumberExist(this,'VENDOR','" + hdnVendorCode.Value + "');";//commented on 04-jul-2017, to provide one textbox for both Provisional / GSTIN Number.
        ...
        try
        {
            ...
            if (e.CommandName == "Add")
            {
                ...
                foreach (RepeaterItem grvDet in rptOrderEntry.Items)
                {
                    ...
                    TRD.GSTINumber = txtGSTTiNumber.Text;
    ...
    /// <summary>
    /// Get List For Vendor List
    /// </summary>
    /// <param name="VendorCode"></param>
    /// <returns></returns>
    //[WebMethod]
    //public static string CheckVendorCode(string VendorCode)
    //{
    //    var oGSTMasterController = new GSTMasterController();
    //    var dtResult = oGSTMasterController.ValidateVendor(VendorCode);
    ...
    protected void lnkFormat_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VendorGSTUploadFormat.xls", false);
    }
