...
public partial class GUI_admin_GenralMaster_GenralMaster : System.Web.UI.Page
{
    ...
    protected void data_Save()
    {
        ...
        string sqlAdd = "INSERT INTO webx_master_general(CodeType,CodeId,CodeDesc,CodeAccess,StatusCode,EntryDate,EntryBy,LastUpdatedDate,LastUpdatedBy,noofdigits,noofchar,codefor) VALUES('" + mastercode + "','" + newcode + "','" + txtprimary.Text.Trim() + "','" + headeraccess + "','Y','" + DateTime.Now + "','ADMIN','" + DateTime.Now + "',''," + nodigs + "," + nochars + ",'')";
        //string sqlAdd = "INSERT INTO webx_master_general VALUES('" + mastercode + "','" + newcode + "','" + txtprimary.Text.Trim() + "','" + headeraccess + "','Y','" + DateTime.Now + "','ADMIN','" + DateTime.Now + "',''," + nodigs + "," + nochars + ",'')";
