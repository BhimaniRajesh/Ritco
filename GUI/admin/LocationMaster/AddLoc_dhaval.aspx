<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddLoc_dhaval.aspx.cs" Inherits="AddLoc" EnableEventValidation="false" %>
...
--%>
    ...
    <script language="javascript" type="text/javascript">
        ...
        //        function dataentrylocation(mNo,flag)
        //        {
        //            debugger
        //            window.open("popupbranch.aspx?mNo=" + mNo + "&flag=" + flag,"pbr","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=387,height=220,status=no,left=220,top=70")            
        //        }
        ...
        function ValidateData() {
            //debugger
            document.getElementById("ctl00_MyCPH1_txtLocCod").value = trimAll(document.getElementById("ctl00_MyCPH1_txtLocCod").value);
            if (document.getElementById("ctl00_MyCPH1_txtLocCod").value.length < 3 && document.getElementById("ctl00_MyCPH1_txtLocCod").value.length > 0) {
                //alert("Invalid location code Length")
                document.getElementById("ctl00_MyCPH1_txtLocCod").focus();
                return false;
            }

            document.getElementById("ctl00_MyCPH1_txtLocCod").value = document.getElementById("ctl00_MyCPH1_txtLocCod").value.toUpperCase()
            if (document.getElementById("ctl00_MyCPH1_txtLocCod").value.toUpperCase() != "") {
                if (loccodeval.indexOf(document.getElementById("ctl00_MyCPH1_txtLocCod").value.toUpperCase()) != -1) {
                    //alert("Location Code Already Exists !!")
                    document.getElementById("ctl00_MyCPH1_txtLocCod").focus();
                    return false;
                }
            ...
            mLocStartDate = mLocStartDate.substring(3, 5) + "/" + mLocStartDate.substring(0, 2) + "/" + mLocStartDate.substring(6, 10);
            var mLocEndDate = document.getElementById("ctl00_MyCPH1_txtLocEndDt").value;
            mLocEndDate = mLocEndDate.substring(3, 5) + "/" + mLocEndDate.substring(0, 2) + "/" + mLocEndDate.substring(6, 10);
            ...
            if (document.getElementById("ctl00_MyCPH1_txtLocEndDt").value != "") {
                if (findDateDifference(mToday, mLocEndDate, "d") < 0) {
                    alert("Enter Date Greater Than Today!");
                    document.getElementById("ctl00_MyCPH1_txtLocEndDt").focus();
                    return false;
                }
            }
    ...
    <div align="left" style="width: 10in">
        ...
        <table border="0" width="100%">
            <tr>
                <td>
                    <table border="0" width="100%" cellpadding="0" cellspacing="1" class="boxbg" style="text-align: center">
                        <tr class="bgbluegrey">
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left">
                                <asp:UpdatePanel ID="upRptLoc" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddRptLoc" runat="server" TabIndex="3">
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddLocHir" EventName="SelectedIndexChanged" />
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtLocCod" runat="server" class="input" TabIndex="4" MaxLength="50"
                                    Width="94px" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                            <td align="left">
                                Location Name:
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtLocNm" runat="server" class="input" TabIndex="5" Width="94px"
                                    OnChange="Javascript:this.value=this.value.toUpperCase();" MaxLength="50" BorderStyle="Groove"
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtAdd" runat="server" TextMode="MultiLine" TabIndex="6" OnChange="Javascript:this.value=this.value.toUpperCase();"
                                    MaxLength="200" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="bgwhite">
                            <td align="left">
                            ...
                            <td align="left" valign="top">
                                <asp:UpdatePanel runat="server" ID="updstate">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddState" runat="server" TabIndex="7" AutoPostBack="True" OnSelectedIndexChanged="ddState_SelectedIndexChanged">
                                        </asp:DropDownList>
                            ...
                            <td align="left" class="blackfnt">
                                <asp:TextBox ID="TextBox6" runat="server" TabIndex="8" MaxLength="50" BorderStyle="Groove"
                                    Width="189px" Style="font-size: 11px;">
                                </asp:TextBox>
                                <div id="etabConsResults" runat="server" class="blackfnt" />
                                <%--     <atlas:AutoCompleteExtender ID="Ext1" runat="server" DropDownPanelID="etabConsResults">
                                    <atlas:AutoCompleteProperties  TargetControlID="TextBox6" ServicePath="AtlasAutoComplete.asmx" ServiceMethod="GetCompletionList" MinimumPrefixLength="1"  Enabled="true"  />
                           ...
                           --%>                              
                                <ajaxToolkit:AutoCompleteExtender ID="Ext1" runat="server" Enabled="True" CompletionListItemCssClass="autocomplete_listItem"
                                    ...
                                    ServiceMethod="GetCompletionList" ServicePath="../AtlasAutoComplete.asmx" TargetControlID="TextBox6">
                                </ajaxToolkit:AutoCompleteExtender>
                                <%-- <asp:Button ID="btn_cityPopUp" runat="server" OnClientClick="javascript:return nwOpenCity(5)"
                                    Text="..." />--%>
                            </td>
                            <td align="left">
                                Pin code:
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtPin" onkeypress="javascript:validInt(event)" runat="server" TabIndex="9"
                                    Style="text-align: right" MaxLength="6" Width="94px" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="bgwhite">
                            <td align="left">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtCNCod" runat="server" class="input" TabIndex="10" OnChange="Javascript:this.value=this.value.toUpperCase();"
                                    MaxLength="10" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                            <td align="left">
                            </td>
                            <td align="left">
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtStdCod" onkeypress="javascript:validInt(event)" runat="server"
                                    Style="text-align: right" TabIndex="11" MaxLength="6" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                            <td align="left">
                                Tele. No.:
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtTel" runat="server" Width="94px" onkeypress="javascript:validInt(event)"
                                    Style="text-align: right" TabIndex="12" MaxLength="10" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                            <td align="left">
                                Fax No.:
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtFax" runat="server" Width="94px" onkeypress="javascript:validInt(event)"
                                    Style="text-align: right" TabIndex="13" MaxLength="12" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="bgwhite">
                            <td align="left">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtMob" onkeypress="javascript:validInt(event)" runat="server" Width="94px"
                                    Style="text-align: right" TabIndex="14" MaxLength="12" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                            <td align="left">
                                Email ID:
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtEmail" onblur="EmailCheck(this)" runat="server" TabIndex="15"
                                    Width="215px" MaxLength="50" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                            </td>
                            <td align="left">
                            </td>
                            <td align="left">
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left">
                                Accounting Location:<span style="font-size: 8pt; font-family: Verdana"> </span>
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtAcLoc" runat="server" Width="94px" TabIndex="17" OnChange="Javascript:this.value=this.value.toUpperCase();"
                                    MaxLength="5" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>&nbsp;<asp:Button
                                        ID="btn_accLocPopup" runat="server" OnClientClick="javascript:return nwOpen(1)"
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" valign="top">
                                <asp:UpdatePanel ID="upChkComp" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:TextBox ID="TextBox15" runat="server" Width="18px" ReadOnly="True" TabIndex="20"
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtDataLoc" runat="server" Width="94px" TabIndex="21" OnChange="Javascript:this.value=this.value.toUpperCase();"
                                    MaxLength="10" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                                <asp:Button ID="btn_dataEntryLoc" runat="server" OnClientClick="javascript:return nwOpen(2)"
                                    Text="..." UseSubmitBehavior="False" />
                            </td>
                            <td align="left">
                            </td>
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="TextBox16" runat="server" MaxLength="10" CssClass="input" Width="80px"
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtLocEndDt" runat="server" MaxLength="10" CssClass="input" Width="80px"
                                ...
                                <td align="left">
                                    <asp:UpdatePanel ID="upChkActFlag" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:TextBox ID="txtActFlag" Text="Y" runat="server" Width="17px" ReadOnly="True"
                                                MaxLength="1" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                                        </ContentTemplate>
                                        <Triggers>
                        ...
                        <tr class="bgwhite">
                            <td align="left" style="height: 71px">
                                Booking Operation
                            </td>
                            <td align="left" valign="top" style="height: 71px">
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtNxtLoc" runat="server" TabIndex="28" Width="94px" MaxLength="500"
                                    BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                                <asp:Button ID="btn_NextDefLovPopUp" runat="server" OnClientClick="javascript:return nwOpen(3)"
                                    Text="..." UseSubmitBehavior="False" />
                            </td>
                            <td align="left">
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtNrPrLoc" runat="server" TabIndex="29" Width="94px" MaxLength="500"
                                    BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                                <asp:Button ID="btn_NextPrevLocPopup" runat="server" OnClientClick="javascript:return nwOpen(4)"
                                    Text="..." UseSubmitBehavior="False" />
                            </td>
                            <td align="left">
                                Location Ownership
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddLocOnr" runat="server" Width="94px" TabIndex="30">
        ...
        <asp:UpdatePanel ID="upOperTable" runat="server">
            <ContentTemplate>
                <table align="center" border="0" cellpadding="0" cellspacing="1" class="boxbg" style="width: 100%">
                    ...
                    <%--<tr id="booking" runat="server" class="bgwhite">
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator></td>
                    ...
                    <tr id="trBooking" runat="server" class="bgwhite">
                        ...
                        <td valign="top">
                            ...
                            <asp:TextBox ID="txtBkEndDt" runat="server" MaxLength="10" CssClass="blackfnt" Width="80px"
                                TabIndex="33" BorderStyle="Groove"></asp:TextBox>
                    ...
                    <tr id="trDelivery" runat="server" class="bgwhite">
                        <td valign="top" style="height: 11px; width: 128px;">
                            <font class="blackfnt">Delivery Start Date</font>
                        </td>
                        <td valign="top">
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                            ...
                            class="input" onblur="ValidateDate(this)"/>--%>
                            <asp:TextBox ID="txtdlStrDt" runat="server" MaxLength="10" CssClass="blackfnt" Width="80px"
                                TabIndex="34" BorderStyle="Groove"></asp:TextBox>
                        ...
                        <td valign="top" style="width: 131px; height: 11px;">
                            <font class="blackfnt">Delivery End Date</font>
                        </td>
                        <td valign="top" style="height: 11px; width: 157px;">
                            <asp:TextBox ID="txtdlyEndDt" runat="server" MaxLength="10" CssClass="blackfnt" Width="80px"
                                TabIndex="35" BorderStyle="Groove"></asp:TextBox>
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                    ...
                    <tr id="trTranship" runat="server" class="bgwhite">
                        <td valign="top" style="width: 128px; height: 19px;">
                            <font class="blackfnt">Tranship Start Date</font>
                        </td>
                ...
                ErrorMessage="Invalid Date" ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([-./])(0[13578]|10|12)([-./])(\d{4}))|(([0][1-9]|[12][0-9]|30)([-./])(0[469]|11)([-./])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([-./])(02)([-./])(\d{4}))|((29)(\.|-|\/)(02)([-./])([02468][048]00))|((29)([-./])(02)([-./])([13579][26]00))|((29)([-./])(02)([-./])([0-9][0-9][0][48]))|((29)([-./])(02)([-./])([0-9][0-9][2468][048]))|((29)([-./])(02)([-./])([0-9][0-9][13579][26])))"
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                            <asp:TextBox ID="txttransStrDT" runat="server" MaxLength="10" CssClass="blackfnt"
                                Width="80px" TabIndex="36" BorderStyle="Groove"></asp:TextBox>
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                        ...
                        <td valign="top" style="width: 157px; height: 19px;">
                            ...
                            <asp:TextBox ID="txttransEndDt" runat="server" MaxLength="10" CssClass="blackfnt"
                                Width="80px" TabIndex="37" BorderStyle="Groove"></asp:TextBox>
        ...
        <asp:UpdatePanel ID="upTables" runat="server">
            <ContentTemplate>
                <table id="pay" align="center" border="0" cellpadding="0" cellspacing="1" visible="false"
                    runat="Server" style="width: 100%" class="boxbg">
                    <tr class="bgbluegrey">
                        <td align="center">
                            <font class="blackfnt"><b>Payment Type</b></font>
                        </td>
                    </tr>
                    <tr class="bgwhite">
                        <td nowrap>
                            <table border="0" cellpadding="0" cellspacing="1">
                                <tr class="bgwhite">
                                    ...
                                    <td class="bgwhite">
                                        ...
                                        <%=strPayType%>
                                        <asp:HiddenField ID="hidden_PayTypeStr" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table id="Service" runat="server" visible="false" align="center" border="0" cellpadding="0"
                    ...
                    <tr class="bgbluegrey">
                        <td align="center">
                            <font class="blackfnt"><b>Services</b></font>
                        </td>
                    </tr>
                    <tr>
                        <td class="bgwhite">
                ...
                <br />
                <table id="bkOpr" runat="server" border="0" cellspacing="1" cellpadding="0" style="width: 100%"
                    class="boxbg" visible="false">
                    <tr>
                        <td colspan="8" class="bgbluegrey" valign="top" align="center">
                            <strong>Booking/Delivery Information</strong>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="background-color: white; height: 58px;">
                            <font class="blackfnt">Octroi :</font>
                        </td>
                        <td valign="top" style="background-color: white; height: 58px;">
                            <asp:DropDownList ID="DropDownList1" runat="server" Width="104px" TabIndex="42">
                        ...
                        <td align="left" valign="top" class="bgwhite" style="background-color: white; height: 58px;">
                            <font class="blackfnt">Air Service :</font>
                        </td>
                        <td align="left" valign="top" class="bgwhite" style="background-color: white; height: 58px;">
                            <asp:CheckBox ID="c1" runat="server" OnCheckedChanged="c1_CheckedChanged" AutoPostBack="true"
                                TabIndex="43" /><asp:TextBox ID="TextBox3" runat="server" Width="17px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td align="left" valign="top" style="background-color: white; height: 58px;">
                        ...
                        <td valign="top" style="background-color: white; height: 58px;">
                            &nbsp;<asp:CheckBox ID="c4" runat="server" AutoPostBack="true" OnCheckedChanged="c4_CheckedChanged"
                                TabIndex="44" />
                            <asp:TextBox ID="txtRail" runat="server" Width="17px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td valign="top" style="background-color: white; height: 58px;">
                        ...
                        <td valign="top" style="background-color: white; height: 58px;">
                            <asp:CheckBox ID="c6" runat="server" OnCheckedChanged="c6_CheckedChanged" AutoPostBack="true"
                                TabIndex="45" />
                            <asp:TextBox ID="txtSea" runat="server" Width="16px" ReadOnly="True"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="background-color: white">
                            <font class="blackfnt">CN Generation :</font>
                        </td>
                        <td valign="top" align="left" style="background-color: white">
                            <asp:ListBox ID="ListBox1" runat="server" Width="99px" Height="54px" TabIndex="46">
                                <asp:ListItem>--Select--</asp:ListItem>
                        ...
                        <td valign="top" align="left" style="background-color: white">
                            <font class="blackfnt">
                                <asp:CheckBox ID="c2" runat="server" OnCheckedChanged="c2_CheckedChanged" AutoPostBack="true"
                                    TabIndex="47" /><asp:TextBox ID="txtCutOff" runat="server" Width="18px" ReadOnly="True"></asp:TextBox></font>
                        </td>
                        <td valign="top" style="background-color: white">
                        ...
                        <td valign="top" style="background-color: white">
                            ...
                            class="input" onblur="ValidateDate(this)" />--%>
                            <asp:TextBox ID="TextBox8" runat="server" MaxLength="8" CssClass="input" Width="80px"
                                TabIndex="48"></asp:TextBox><font class="blackfnt"> (hh:mm)</font>
                    ...
                    <tr>
                        ...
                        <td valign="top" style="background-color: white">
                            <font class="blackfnt">Pickup Door :</font>
                        </td>
                        <td valign="top" style="background-color: white">
                            <font class="blackfnt">
                                <asp:CheckBox ID="c3" runat="server" OnCheckedChanged="c3_CheckedChanged" AutoPostBack="true"
                                    TabIndex="49" /><asp:TextBox ID="txtPickDor" runat="server" Width="17px" ReadOnly="True"></asp:TextBox></font>
                        </td>
                        ...
                        <td colspan="1" valign="top" style="background-color: white">
                            <font class="blackfnt">Billed At</font>
                        </td>
                        <td colspan="1" valign="top" style="background-color: white">
                            <asp:TextBox ID="TextBox11" runat="server" Width="46px" OnChange="Javascript:this.value=this.value.toUpperCase();"
                                MaxLength="10" TabIndex="51"></asp:TextBox>
                        </td>
                        <td valign="top" style="background-color: white">
                        </td>
                    </tr>
        ...
        <table style="width: 954px">
            <tr>
                <td align="right" colspan="3" style="height: 90px; text-align: center;">
                    &nbsp;<asp:UpdatePanel ID="upBtnSubmit" runat="server">
                        <ContentTemplate>
                            <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClientClick="return ValidateData()"
                                OnClick="btnSubmit_Click" TabIndex="52" CssClass="blackfnt" />
                        </ContentTemplate>
                        <Triggers>
