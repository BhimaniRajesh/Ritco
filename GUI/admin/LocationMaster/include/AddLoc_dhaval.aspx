                ...
                <td>
                    <table border="0" width="100%" cellpadding="0" cellspacing="1" class="boxbg" style="text-align: center">
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtLocCod" runat="server" class="input" TabIndex="4" MaxLength="50"
                                    Width="94px" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                            <td align="left">
                                Location Name:
                            </td>
                            <td align="left">
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" class="blackfnt" style="font-size: smaller;">
                                <asp:TextBox ID="TextBox6" runat="server" TabIndex="8" MaxLength="50" BorderStyle="Groove" CssClass="blackfnt"  Width="189px">
                         </asp:TextBox> 
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtPin" onkeypress="javascript:validInt(event)" runat="server" TabIndex="9"
                                    Style="text-align: right" MaxLength="6" Width="94px" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                        </tr>
                        <tr class="bgwhite">
                            <td align="left">
                                CN Prefix Code:
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtCNCod" runat="server" class="input" TabIndex="10" OnChange="Javascript:this.value=this.value.toUpperCase();"
                                    MaxLength="10" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                            <td align="left">
                            </td>
                            <td align="left">
                            </td>
                        ...
                        <tr class="bgwhite">
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtStdCod" onkeypress="javascript:validInt(event)" runat="server"
                                    Style="text-align: right" TabIndex="11" MaxLength="6" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                            <td align="left">
                                Tele. No.:
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtTel" runat="server" Width="94px" onkeypress="javascript:validInt(event)"
                                    Style="text-align: right" TabIndex="12" MaxLength="10" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                            <td align="left">
                                Fax No.:
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtFax" runat="server" Width="94px" onkeypress="javascript:validInt(event)"
                                    Style="text-align: right" TabIndex="13" MaxLength="12" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                        </tr>
                        <tr class="bgwhite">
                            <td align="left">
                                Mobile No.:
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txtMob" onkeypress="javascript:validInt(event)" runat="server" Width="94px"
                                    Style="text-align: right" TabIndex="14" MaxLength="12" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                            <td align="left">
                                Email ID:
                            </td>
                            <td align="left">
                                <asp:TextBox ID="txtEmail" onblur="EmailCheck(this)" runat="server" TabIndex="15"
                                    Width="215px" MaxLength="50" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox></td>
                            <td align="left">
                            </td>
                            <td align="left">
                            </td>
                        ...
                        <tr class="bgbluegrey">
                            <td colspan="6" align="center" class="blackfnt">
                                <strong>Operation Information</strong></td>
                        </tr>
                        <tr class="bgwhite">
                            <td align="left" style="height: 71px">
                                Booking Operation</td>
        ...
        <asp:UpdatePanel ID="upTables" runat="server">
            <ContentTemplate>
                ...
                <table id="Service" runat="server" visible="false" align="center" border="0" cellpadding="0"
                    ...
                    <tr class="bgbluegrey">
                        <td align="center">
                            <font class="blackfnt"><b>Services</b></font></td>
                    </tr>
                    <tr>
                        <td class="bgwhite">
                ...
                <table id="bkOpr" runat="server" border="0" cellspacing="1" cellpadding="0" style="width: 100%"
                    ...
                    <tr>
                        <td colspan="8" class="bgbluegrey" valign="top" align="center">
                            <strong>Booking/Delivery Information</strong></td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" valign="top" class="bgwhite" style="background-color: white; height: 58px;">
                            <asp:CheckBox ID="c1" runat="server" OnCheckedChanged="c1_CheckedChanged" AutoPostBack="true"
                                TabIndex="43" /><asp:TextBox ID="TextBox3" runat="server" Width="17px" ReadOnly="True"></asp:TextBox></td>
                        <td align="left" valign="top" style="background-color: white; height: 58px;">
                            <font class="blackfnt">Rail Service</font></td>
                        <td valign="top" style="background-color: white; height: 58px;">
                        ...
                        <td valign="top" align="left" style="background-color: white">
                            <font class="blackfnt">
                                <asp:CheckBox ID="c2" runat="server" OnCheckedChanged="c2_CheckedChanged" AutoPostBack="true"
                                    TabIndex="47" /><asp:TextBox ID="txtCutOff" runat="server" Width="18px" ReadOnly="True"></asp:TextBox></font></td>
                        <td valign="top" style="background-color: white">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="background-color: white">
                            <font class="blackfnt">
                                <asp:CheckBox ID="c3" runat="server" OnCheckedChanged="c3_CheckedChanged" AutoPostBack="true"
                                    TabIndex="49" /><asp:TextBox ID="txtPickDor" runat="server" Width="17px" ReadOnly="True"></asp:TextBox></font></td>
                        ...
                        <td colspan="1" valign="top" style="background-color: white">
                            <asp:TextBox ID="TextBox11" runat="server" Width="46px" OnChange="Javascript:this.value=this.value.toUpperCase();"
                                MaxLength="10" TabIndex="51"></asp:TextBox></td>
                        <td valign="top" style="background-color: white">
                        </td>
                    </tr>
                </table>
