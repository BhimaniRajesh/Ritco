<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddLoc.aspx.cs" Inherits="AddLoc" EnableEventValidation="false" %>
...
//                }
                ...
                if (document.getElementById("ctl00_MyCPH1_Txt_User").value == "") 
                {
                    alert("Plz Select Enter User Name~Code Format")
                    document.getElementById("ctl00_MyCPH1_Txt_User").focus();
                    return false;
                }
                var Search_Char = "~"
                if (document.getElementById("ctl00_MyCPH1_Txt_User").value.indexOf(Search_Char) == -1) 
                {
                    alert("Invalid User Name~Code Format");
                    document.getElementById("ctl00_MyCPH1_Txt_User").focus();
                    return false
                }
                return true;
                                    ...
                                    <tr bgcolor="#ffffff">
                                        ...
                                        <td align="left" style="width: 252px; height: 24px;">
                                            <asp:TextBox ID="txtStdCod" onblur="Nagative_Chk_wDecimal(this)" runat="server" Width="94px"
                                                TabIndex="11" MaxLength="6"></asp:TextBox>&nbsp;</td>
                                        <td align="left" style="width: 210px; height: 24px;">
                                            <font class="blackfnt">Tele. No.:</font>
                                        </td>
                                        <td align="left" style="height: 24px; width: 229px;">
                                            <asp:TextBox ID="txtTel" runat="server" Width="94px" onblur="Nagative_Chk_wDecimal(this)"
                                                TabIndex="12" MaxLength="10"></asp:TextBox>&nbsp;</td>
                                        ...
                                        <td align="left" style="height: 24px; width: 187px;">
                                            ...
                                            <asp:TextBox ID="Txt_User" runat="server" Width="350" BorderStyle="Groove" AutoPostBack="true" OnTextChanged="Txt_User_TextChanged" CssClass="blackfnt"></asp:TextBox>                                            
                                    ...
                                    <tr bgcolor="#ffffff" style="font-size: 8pt; font-family: Verdana">
                                        ...
                                        <td align="left" valign="top" colspan="3" style="height: 20px">
                                            ...
                                            <asp:Label ID="Label2" runat="server" BorderStyle="Groove" Text='<a href="javascript:nwOpen(2)">...</a>'
                                                Width="14px" TabIndex="22"></asp:Label></td>
                                    </tr>
                                    <!--Row 3-->
                                    <tr bgcolor="#ffffff">
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="1" class="boxbg" style="width: 100%">
                        <tr class="bgbluegrey">
                            <td align="center" style="text-align: center; height: 25px; width: 806px;">
                                <font class="bluefnt"><b>Operation Information</b></font></td>
                        </tr>
                        <tr>
                                ...
                                <table align="center" border="0" cellpadding="2" cellspacing="0" style="width: 119%">
                                    <tr bgcolor="#ffffff">
                                        <td valign="top" style="height: 39px; width: 128px;">
                                            <font class="blackfnt">Booking Operation</font></td>
                                        <td valign="top">
                                            <font class="blackfnt">
                                        ...
                                        <td valign="top" style="width: 131px; height: 39px;">
                                            <font class="blackfnt">Delivery Operation</font></td>
                                        ...
                                        <td valign="top" style="width: 96px; height: 39px;">
                                            <font class="blackfnt">Tranship Operation</font></td>
                                    ...
                                    <tr bgcolor="#ffffff">
                                        <td valign="top" style="width: 128px">
                                            <font class="blackfnt">Default Next Location</font></td>
                                        <td valign="top" style="width: 187px">
                                            <font class="blackfnt"></font>
                                            <asp:TextBox ID="txtNxtLoc" runat="server" TabIndex="28" Width="94px" MaxLength="500"></asp:TextBox>
                                            <%--OnChange="Javascript:this.value=this.value.toUpperCase();"--%>
                                            <asp:Label ID="Label3" runat="server" BorderStyle="Groove" Text='<a href="javascript:nwOpen(3)">...</a>'
                                                Width="14px" TabIndex="39"></asp:Label></td>
                                        <td valign="top" style="width: 131px">
                                            <font class="blackfnt">Nearest Previous Location</font></td>
                                        <td valign="top" style="width: 157px">
                                            <asp:TextBox ID="txtNrPrLoc" runat="server" TabIndex="29" Width="94px" MaxLength="500"></asp:TextBox>
                                            <%--OnChange="Javascript:this.value=this.value.toUpperCase();--%>
                                            <asp:Label ID="Label4" runat="server" BorderStyle="Groove" Text='<a href="javascript:nwOpen(4)">...</a>'
                                                Width="14px" TabIndex="41"></asp:Label></td>
                                        <td valign="top" style="width: 96px">
                                            <font class="blackfnt">Location Ownership</font></td>
                                    ...
                                    <tr bgcolor="#ffffff">
                                        <td valign="top" style="height: 11px; width: 128px;">
                                            <font class="blackfnt">UGD</font></td>
            ...
            &nbsp;<asp:TextBox ID="txtUgd" runat="server" Width="18px" ReadOnly="True" TabIndex="35"></asp:TextBox>&nbsp; &nbsp;&nbsp; </font></td>--%>
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator></td>
                                ...
                                <tr id="trBooking" runat="server" bgcolor="#ffffff">
                                    <td valign="top" style="width: 128px; height: 26px;">
                                        <font class="blackfnt">Booking Start Date </font>
                                    </td>
                                    <td valign="top" style="width: 187px; height: 26px;">
                                        <%--<input type="text" id="txtBkStrDt" maxlength="10" size="10" runat="server" 
                            class="input" onblur="ValidateDate(this)" />--%>
                                        <asp:TextBox ID="txtBkStrDt" runat="server" MaxLength="10" CssClass="input" Width="80px"
                                    ...
                                    <td valign="top" style="width: 131px; height: 26px;">
                                        <font class="blackfnt">Booking End Date </font>
                                    </td>
                                    <td valign="top" style="width: 157px; height: 26px;">
                                        ...
                                        <asp:TextBox ID="txtBkEndDt" runat="server" MaxLength="10" CssClass="input" Width="80px"
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                            ...
                            class="input" onblur="ValidateDate(this)"/>--%>
                                        <asp:TextBox ID="txtdlStrDt" runat="server" MaxLength="10" CssClass="input" Width="80px"
                                ...
                                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                                    ...
                                    <td valign="top" style="height: 11px; width: 157px;">
                                        <asp:TextBox ID="txtdlyEndDt" runat="server" MaxLength="10" CssClass="input" Width="80px"
                ...
                ErrorMessage="Invalid Date" ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([-./])(0[13578]|10|12)([-./])(\d{4}))|(([0][1-9]|[12][0-9]|30)([-./])(0[469]|11)([-./])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([-./])(02)([-./])(\d{4}))|((29)(\.|-|\/)(02)([-./])([02468][048]00))|((29)([-./])(02)([-./])([13579][26]00))|((29)([-./])(02)([-./])([0-9][0-9][0][48]))|((29)([-./])(02)([-./])([0-9][0-9][2468][048]))|((29)([-./])(02)([-./])([0-9][0-9][13579][26])))"
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                                        <asp:TextBox ID="txttransStrDT" runat="server" MaxLength="10" CssClass="input" Width="80px"
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                            ...
                            class="input" onblur="ValidateDate(this)" />--%>
                                        ...
                                        <asp:TextBox ID="txttransEndDt" runat="server" MaxLength="10" CssClass="input" Width="80px"
                ...
                ValidationGroup="VGDtFromTo"></asp:RegularExpressionValidator>--%>
                                                ...
                                                <td align="left" valign="top">
                                                    <font class="blackfnt">
                                                        <asp:CheckBox ID="c1" runat="server" OnCheckedChanged="c1_CheckedChanged" AutoPostBack="true"
                                                            TabIndex="43" /><asp:TextBox ID="TextBox3" runat="server" Width="17px" ReadOnly="True"></asp:TextBox></font></td>
                                                <td valign="top">
                                ...
                                &nbsp;<asp:UpdatePanel ID="upBtnSubmit" runat="server">
                                    <ContentTemplate>
                                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClientClick="return ValidateData()"
                                            OnClick="btnSubmit_Click" TabIndex="52" /><br />
                    ...
                    <uc1:UserMessage ID="umsgbox" runat="server" />
