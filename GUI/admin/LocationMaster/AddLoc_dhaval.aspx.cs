...
public partial class AddLoc : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String sql11 = "";
        sql11 = "select location from webx_citymaster";
        SqlCommand cmd1 = new SqlCommand(sql11, cn);
        SqlDataAdapter sda1 = new SqlDataAdapter (cmd1);
        AtlasAutoComplete.dsCity.Clear();
        sda1.Fill(AtlasAutoComplete.dsCity);
    ...
    protected void ddLocHir_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (cn.State == ConnectionState.Closed) cn.Open();
             ...
             string nwsqlstr1 = "Select codedesc as level_type,codeid as level_no from webx_master_general where  codetype='hrchy' and  statuscode='Y' and convert(numeric,codeid)<= " + ddLocHir.SelectedValue + " order by level_no asc";
            ...
            ddRptLoc.Items.Add("--Select--");
            if (cn.State == ConnectionState.Closed) cn.Open();
            string nwsqlstr = "Select distinct LocName + ' : ' + LocCode,LocCode from webx_Location where Loc_Level='1'";  //" + ddRptTo.SelectedValue.ToString() + "'";
    ...
    protected void ddRptTo_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddRptTo.SelectedValue.ToString() == "8")
        {
            ...
            string mynwsqlstr1 = "Select distinct LocName + ' : ' + LocCode,Loccode from webx_Location where Loc_Level='1'";
        ...
        else
        {
            ...
            ddRptLoc.Items.Add("--Select--");
            if (cn.State == ConnectionState.Closed) cn.Open();
            string sqlstr2 = "Select distinct LocName + ' : ' + LocCode,Loccode from webx_Location where Loc_Level='" + ddRptTo.SelectedValue.ToString() + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string sqlinsert = "Insert into webx_location (Loc_Level, Report_Level, LocCode, LocName, Report_Loc, LocAddr, LocState, LocCity, LocPinCode, LOCSTDCode, LocTelNo, LocFaxNo, LocMobile, LOCEmail, LOC_Account, ActiveFlag,LocRegion,Computerised,Dataentry,loc_startdt,loc_enddt,UPDTBY,UPDTON, Payment_Type,Vol,COD_DOD,ODA,op_bkg,op_dly,op_tranship,OutSource_Own,Default_NextLoc,Nearest_PrevLoc,Op_StartDt,Op_EndDt,Dly_StartDt,Dly_EndDt,Transshipment_StartDt,Transshipment_EndDt,CPC,Op_UGD,octroi_io,CN_Prefixcode,BilledAt)values(" + ddLocHir.Text + "," + ddRptTo.Text + ",'" + txtLocCod.Text.Replace("'", "''") + "','" + txtLocNm.Text.Replace("'", "''") + "','" + ddRptLoc.Text + "','" + txtAdd.Text.Replace("'", "''") + "','" + ddState.Text + "','" + TextBox6.Text.Replace("'", "''") + "','" + txtPin.Text.Replace("'", "''") + "','" + txtStdCod.Text.Replace("'", "''") + "','" + txtTel.Text.Replace("'", "''") + "','" + txtFax.Text.Replace("'", "''") + "','" + txtMob.Text.Replace("'", "''") + "','" + txtEmail.Text.Replace("'", "''") + "','" + txtAcLoc.Text.Replace("'", "''") + "','" + txtActFlag.Text.Replace("'", "''") + "','" + ddRgLoc.Text + "','" + TextBox15.Text.Replace("'", "''") + "','" + txtDataLoc.Text.Replace("'", "''") + "','" + loc_startdt + "','" + LocEndDt + "','" + Convert.ToString(Session["empcd"]) + "',getdate(),'" + hPayTypeStr + "','" + txtVol.Text.Replace("'", "''") + "','" + txtCod.Text.Replace("'", "''") + "','" + txtOda.Text.Replace("'", "''") + "','" + txtBkOpr.Text.Replace("'", "''") + "','" + TextBox26.Text.Replace("'", "''") + "','" + txttransOpr.Text.Replace("'", "''") + "','" + ddLocOnr.Text + "','" + txtNxtLoc.Text.Replace("'", "''") + "','" + txtNrPrLoc.Text.Replace("'", "''") + "','" + BkStrDt + "','" + BkEndDt + "','" + dlStrDt + "','" + dlyEndDt + "','" + transStrDT + "','" + transEndDt + "','','" + txtUgd.Text.Replace("'", "''") + "','" + DropDownList1.Text + "','" + txtCNCod.Text.Replace("'", "''") + "','" + TextBox11.Text.Replace("'", "''") + "')";
