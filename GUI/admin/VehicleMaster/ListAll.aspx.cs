...
public partial class GUI_admin_VehicleMaster_ListAll : System.Web.UI.Page
{
    ...
    public void bindGrid()
    {
        cn.Open();
        string sql;
        sql = "select VENDORCODE,VEHNO,VEHMODEL,VEHMADEBY from webx_VEHICLE_HDR order by VENDORCODE";
    ...
    protected void lnkbtnXLS_Click(object sender, EventArgs e)
    {
        ...
        string strSQL = "exec Usp_Vehicle_ListAll";
        CreateXLS(strSQL, "VehicleDetails.xls");
    }
