<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="VehicleMasterEdit.aspx.cs" Inherits="GUI_admin_VehicleMaster_VehicleMasterEdit"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
 ...
 function NoofTyrescheck(str) {
		  ...
		  //if (isNaN(document.getElementById("ctl00_MyCPH1_txtCapacity").value)) {
            ...
            if (document.getElementById("ctl00_MyCPH1_txtManufacturerDt").value != "dd/mm/yyyy") {
                if (ValidateDate(document.getElementById("ctl00_MyCPH1_txtManufacturerDt")) == false) {
                    ...
                    //Check for Date From and Date To Date range
                    if (findDateDifference(mToday,mVehFitDate, "d") < 0) {
                        //alert("Enter 'Manufacturer Date' greater than Today!");
                        //document.getElementById("ctl00_MyCPH1_txtManufacturerDt").focus();
                        //return false;
                    }
                }
                                                                    ...
                                                                    <table border="0" cellspacing="0" width="100%" cellpadding="3">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 169px">
                                                                                <asp:DropDownList ID="ddVehicleType" runat="server" Width="178px">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="blackfnt" valign="top">&nbsp;<asp:TextBox ID="txtDrivers" onblur="return checknumber(this)" runat="server"
   ...
   <td style="height: 28px">
                                                                        ...
                                                                        <tr>
                                                                            <td class="blackfnt"><font color="red">*</font>Vehicle Insurance
                                                                                <br />
                                                                                Validity Date
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td class="blackfnt"><font color="red">*</font>Fitness Certificate Date
                                                                            </td>
                                                                            <td>
