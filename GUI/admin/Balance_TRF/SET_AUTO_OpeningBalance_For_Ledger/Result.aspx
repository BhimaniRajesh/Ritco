                     ...
                     <HeaderStyle  HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                      ...
                      <HeaderTemplate>
                       ...
                       <asp:TemplateField>
                        <HeaderTemplate>
                        <center>
                         <asp:Label runat="server" ID="lblCustcode"  CssClass="blackfnt" text ='Group Code/Name' ></asp:Label>
                         </center>
                       </HeaderTemplate>
                              <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                   ...
                                   <asp:Label runat="server" ID="Custcode"  CssClass="blackfnt"  ><%# DataBinder.Eval(Container.DataItem,"Cd") %>:<%# DataBinder.Eval(Container.DataItem,"NM") %></asp:Label>
                                    <asp:HiddenField ID="hnd_Acccode"  runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"S_typ") %>' />
                                    <asp:HiddenField ID="hnd_Loccode"  runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"Cd") %>' />
                                     </ItemTemplate>
                     </asp:TemplateField>
