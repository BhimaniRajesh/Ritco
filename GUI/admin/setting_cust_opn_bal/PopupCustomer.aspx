<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupCustomer.aspx.cs" Inherits="GUI_admin_setting_cust_opn_bal_PopupCustomer" %>
 ...
 <head id="Head1" runat="server">
     ...
     <link href="../../../GUI/images/style.css" rel="stylesheet" type="text/css" />
        ...
        function Child(obj)
        {
	        ...
	        window.opener.document.aspnetForm.ctl00$MyCPH1$txtCustCode.value=Str;
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                ...
                                <input id="radSelBranch" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "CUSTCD")%>' onclick="SelectCustomer(this);" runat="server" />
                                <%--<input id="radSelBranch" type="radio" onclick="SelectCustomer(this);" value='<%#DataBinder.Eval(Container.DataItem,"CUSTCD") %>' >--
                            </td>
                            <td style="width: 30%" align="left">
