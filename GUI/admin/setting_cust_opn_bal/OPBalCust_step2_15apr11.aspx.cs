...
public partial class GUI_admin_setting_cust_opn_bal_OPBalCust_step2 : System.Web.UI.Page
{
    ...
    protected void btnSubmit1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sqlUpdate = "Insert into  " + tblStr3 + "  (opendebit,opencredit,finyear,acccode,brcd,opendebit_i,opencredit_i,FinStartDate)   values(0,0,'" + Session["Finyear"].ToString() + "','" + Acccode + "','" + custloc + "','" + opendebit_i + "','" + opencredit_i + "',NULL)  ";
    ...
    protected void btnSubmit2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string sql_ind = "select a.acccode as acccode, sum(a.opendebit) as opendebit_i ,sum(a.Opencredit)as opencredit_i  from " + tblStr2 + " a with (NOLOCK) ,webx_vendor_hdr b  with (NOLOCK) where a.empcd=b.vendorcode  and   loccode='" + vendorloc + "' group by a.acccode ";
            SqlCommand cmd_ind = new SqlCommand(sql_ind, conn,trans);
            SqlDataReader dr_ind;
            dr_ind = cmd_ind.ExecuteReader();
            if (dr_ind.Read())
            ...
            sqlUpdate = "insert into     " + tblStr3 + "  (opendebit,opencredit,finyear,acccode,brcd,opendebit_i,opencredit_i,FinStartDate) values(0,0,'" + Session["Finyear"].ToString() + "','" + Vend_account + "','" + vendorloc + "','" + opendebit_i + "','" + opencredit_i + "',NULL)   ";
            cmdUpdate = new SqlCommand(sqlUpdate, conn, trans);
            cmdUpdate.ExecuteNonQuery();
            trans.Commit();
            conn.Close();
    ...
    protected void btnSubmit3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sqlUpdate = "Insert into  " + tblStr3 + " (opendebit,opencredit,finyear,acccode,brcd,opendebit_i,opencredit_i,FinStartDate) values(0,0,'" + Session["Finyear"].ToString() + "','" + Acccode + "','" + DRVloc + "','" + opendebit_i + "','" + opencredit_i + "',NULL)  ";
    ...
    protected void btnSubmit4_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sqlUpdate = "Insert into  " + tblStr3 + " (opendebit,opencredit,finyear,acccode,brcd,opendebit_i,opencredit_i,FinStartDate) values(0,0,'" + Session["Finyear"].ToString() + "','" + Acccode + "','" + Emploc + "','" + opendebit_i + "','" + opencredit_i + "',NULL)  ";
            Response.Write("<BR>sqlUpdate-" + sqlUpdate);
            cmdUpdate = new SqlCommand(sqlUpdate, conn, trans);
            cmdUpdate.ExecuteNonQuery();
