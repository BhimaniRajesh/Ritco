...
public partial class GUI_admin_setting_cust_opn_bal_sel_brnch : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            WebxCustomer.FilterString = txtBranchCode.Text;
            WebxVendor.FilterString = txtBranchCode1.Text;
            WebxDRIVER.FilterString = txtBranchCode2.Text;
            WebxEmployee.FilterString = txtBranchCode3.Text;
            ...
            string sqlDriver = "select  acccode,accdesc from webx_acctinfo where acccode in ('LIA0057') order by acccode";
            ...
            string sqlEmp = "select  acccode,accdesc from webx_acctinfo where acccode in ('ASS0064','IMP0001','CA00016','CLO0005') order by accdesc";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        ManualVoucherV4 Mv = new ManualVoucherV4();
        ...
        if (rd1.Checked == true)
        {
            ...
            string BranchCode = "";
            if (Mv.CheckLocation(txtBranchCode.Text))
                BranchCode = txtBranchCode.Text.Trim();
            else
            {
                string ErrorMsg = "Location Is Not Valid";
                Response.Redirect("../../ErrorPage.aspx?PageHead=Location Error&ErrorMsg=" + ErrorMsg);
            }
        ...
        else if (rd2.Checked == true)
        {
            ...
            string BranchCode = "";
            if (Mv.CheckLocation(txtBranchCode1.Text))
                BranchCode = txtBranchCode1.Text.Trim();
            else
            {
                string ErrorMsg = "Location Is Not Valid";
                Response.Redirect("../../ErrorPage.aspx?PageHead=Location Error&ErrorMsg=" + ErrorMsg);
        ...
        else if (rd3.Checked == true)
        {
           ...
           // Response.Write("<BR>Driver_Code" + Driver_Code);
            ...
            string BranchCode = "";
            if (Mv.CheckLocation(txtBranchCode2.Text))
                BranchCode = txtBranchCode2.Text.Trim();
            else
            {
                string ErrorMsg = "Location Is Not Valid";
                Response.Redirect("../../ErrorPage.aspx?PageHead=Location Error&ErrorMsg=" + ErrorMsg);
        ...
        else if (rd4.Checked == true)
        {
           ...
           // Response.Write("<BR>Driver_Code" + Driver_Code);
            ...
            string BranchCode = "";
            if (Mv.CheckLocation(txtBranchCode3.Text))
                BranchCode = txtBranchCode3.Text.Trim();
            else
            {
                string ErrorMsg = "Location Is Not Valid";
                Response.Redirect("../../ErrorPage.aspx?PageHead=Location Error&ErrorMsg=" + ErrorMsg);
