...
<head id="Head1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function Child(obj)
            {
	            ...
	            window.opener.document.aspnetForm.ctl00$MyCPH1$Txt_Empcd.value=Str;
                ...
                <td>
                    <table border="0" width="90%" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr class="bgbluegrey">
                            ...
                            <td align="left">
                                <font class="blackfnt">&nbsp;Employee Name</font>
                    ...
                    <asp:DataList ID="DataList1" runat="server" width="90%">
                        <ItemTemplate>
                            <table width="100%" border="0" cellpadding="1" cellspacing="1" class="boxbg">
                                <tr>
                                    <td width="10%" bgcolor="white" align="left">&nbsp;<input name="chk" type="radio" onclick="Child(this);" value='<%#DataBinder.Eval(Container.DataItem,"userid") %>' ></td>
