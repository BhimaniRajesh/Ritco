<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="HolidayAdd.aspx.cs" Inherits="GUI_admin_Holiday_HolidayAdd" Title="Untitled Page" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <a><font class="blklnkund"><b>Module</b></font></a>
							...
							<b> &gt; </b>
							<font class="bluefnt"><b>Holiday Master</b></font></div></td>
        </tr>
        <tr> 
                ...
                <td width="39%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <!--START--> 
                            ...
                            <td><font class="blackfnt">: 
                                <asp:TextBox ID="txtDate" onblur=ValidateDate(this) runat="server" Width="124px"></asp:TextBox>
                                <a href="#" onclick="cal.select(ctl00_MyCPH1_txtDate, 'alnkDate', 'dd/MM/yyyy'); return false;" 
                                id="alnkDate">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtDate"
                                    ErrorMessage="Invalid Date" ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([-./])(0[13578]|10|12)([-./])(\d{4}))|(([0][1-9]|[12][0-9]|30)([-./])(0[469]|11)([-./])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([-./])(02)([-./])(\d{4}))|((29)(\.|-|\/)(02)([-./])([02468][048]00))|((29)([-./])(02)([-./])([13579][26]00))|((29)([-./])(02)([-./])([0-9][0-9][0][48]))|((29)([-./])(02)([-./])([0-9][0-9][2468][048]))|((29)([-./])(02)([-./])([0-9][0-9][13579][26])))" SetFocusOnError="True" Display="Dynamic" ForeColor="White"></asp:RegularExpressionValidator></font></td>
