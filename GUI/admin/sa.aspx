<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPageSA.master" AutoEventWireup="true"
    CodeFile="sa.aspx.cs" Inherits="GUI_admin_sa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <table class="boxbg" cellspacing="1" cellpadding="1" border="0" width="400px">
        <tr class="bgbluegrey">
            <td align="center">
                <font class="blackfnt"><b>List of Operations</b></font>
            </td>
        </tr>
        ...
        <tr style="background: white">
            <td align="left">
                <li>
                    <asp:LinkButton runat="server" ID="lnkMngRules" CssClass="bluefnt" Text="Manage Rules"
        ...
        <tr style="background: white">
            <td align="left">
                <li>
                    <asp:LinkButton runat="server" ID="lnkUpdLogo" CssClass="bluefnt" Text="Upload Logo"
                        PostBackUrl="~/GUI/admin/LogoUpload.aspx"></asp:LinkButton>
                </li>
            </td>
        </tr>
        <tr style="background: white">
            <td align="left">
                <li>
                    <asp:LinkButton runat="server" ID="lnkWebConfig" CssClass="bluefnt" Text="Application Settings"
                        PostBackUrl="~/GUI/admin/WebConfigMaster.aspx"></asp:LinkButton>
                </li>
            </td>
        </tr>--%>
        <tr style="background: white">
            <td align="left">
                <li>
                    <asp:LinkButton runat="server" ID="LinkButton1" CssClass="bluefnt" Text="Fleet Rule Settings"
                        PostBackUrl="~/GUI/Fleet/TripRuleMaster/TripRuleMasterPage.aspx"></asp:LinkButton>
                </li>
            </td>
        </tr>
    </table>
