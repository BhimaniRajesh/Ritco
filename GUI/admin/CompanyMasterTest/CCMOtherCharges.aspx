<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="CCMOtherCharges.aspx.cs" Inherits="GUI_admin_CustomerContractMaster_CCMStep3"
    Title="Untitled Page" %>
            ...
            <ContentTemplate>
                ...
                <asp:Table ID="tblmain" runat="server" Width="100%" CssClass="boxbg" CellSpacing="1">
                    ...
                    <asp:TableRow CssClass="bgwhite" runat="server" ID="trlist">
                        ...
                        <asp:TableCell>
                            <asp:DropDownList ID="ddllist" OnSelectedIndexChanged="ddllist_SelectedIndexChanged"
                                AutoPostBack="true" runat="server" CssClass="blackfnt" DataValueField="codeid"
                    ...
                    Charge at time of   
                        ...
                        <asp:TableCell>
                            <asp:DropDownList ID="ddlchargetime" OnSelectedIndexChanged="ddllist_SelectedIndexChanged"
                                AutoPostBack="true" runat="server" CssClass="blackfnt" DataValueField="codeid"
                                DataTextField="codedesc">
                    ...
                    <asp:TableRow ID="trgrid" runat="server" CssClass="bgwhite">
                        <asp:TableCell ColumnSpan="2" HorizontalAlign="Left">
                            <asp:GridView ID="grvcharges" runat="server" HorizontalAlign="Left" BorderWidth="0"
                                CellSpacing="1" Width="80%" CssClass="boxbg" HeaderStyle-CssClass="bgbluegrey"
                                RowStyle-CssClass="bgwhite" RowStyle-HorizontalAlign="Center" AutoGenerateColumns="false"
                                OnRowDataBound="grvcharges_RowDataBound" EmptyDataText="No Records Found...">
                                <Columns>
                                    <asp:TemplateField HeaderText="Charge Name" HeaderStyle-CssClass="blackfnt">
                                        <HeaderStyle Font-Bold="true" />
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblchargename" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"chargename") %>'
                                                CssClass="blackfnt"></asp:Label>
                                            (<asp:Label ID="Label1" runat="server" Font-Bold="true" Text='<%# DataBinder.Eval(Container.DataItem,"operator") %>'
                                                CssClass="blackfnt"></asp:Label>)
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Air">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtchargeair" Text='<%# DataBinder.Eval(Container.DataItem,"chargerateair") %>'
                                                Style="text-align: right;" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"
                                                runat="server" onblur="javascript:return this.value=roundNumber(this.value,2)"
                                                MaxLength="10" CssClass="blackfnt" Width="70px" BorderStyle="Groove"></asp:TextBox>
                                            <asp:Button ID="btnmatrix" CssClass="blackfnt" Text="Charge Matrix" runat="server"
                                                OnClientClick="javascript:return btnmatrixClick()" OnClick="btnmatrix_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Road">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtchargeroad" Text='<%# DataBinder.Eval(Container.DataItem,"chargerateroad") %>'
                                                Style="text-align: right;" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"
                                                runat="server" onblur="javascript:return this.value=roundNumber(this.value,2)"
                                                MaxLength="10" CssClass="blackfnt" Width="70px" BorderStyle="Groove"></asp:TextBox>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Train">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtchargetrain" Text='<%# DataBinder.Eval(Container.DataItem,"chargeratetrain") %>'
                                                Style="text-align: right;" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"
                                                runat="server" onblur="javascript:return this.value=roundNumber(this.value,2)"
                                                MaxLength="10" CssClass="blackfnt" Width="70px" BorderStyle="Groove"></asp:TextBox>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Express">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtchargeexpress" Text='<%# DataBinder.Eval(Container.DataItem,"chargerateexpress") %>'
                                                Style="text-align: right;" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"
                                                runat="server" onblur="javascript:return this.value=roundNumber(this.value,2)"
                                                MaxLength="10" CssClass="blackfnt" Width="70px" BorderStyle="Groove"></asp:TextBox>
                                        </ItemTemplate>
