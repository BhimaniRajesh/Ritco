...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    {
        var optminfreighttype=document.getElementById("ctl00_MyCPH1_optminfreighttype_0");
        ...
        if(optminfreighttype.checked==true)
        {
...
function roundit(Num)
{
    ...
    <script language="javascript" type="text/javascript">
            ...
            function ValidateData()
            {
                ...
                var optbastype=document.getElementById("ctl00_MyCPH1_optminfreighttype_0")
                var optpercenttype=document.getElementById("ctl00_MyCPH1_optminfreighttype_1")
                ...
                var optminfreighttype_bas=document.getElementById("ctl00_MyCPH1_optminfreighttype_0");
                ...
                if(optminfreighttype_bas.checked==true)
                {
            ...
            <asp:TableRow BackColor="white">
                <asp:TableCell HorizontalAlign="Center">
                    ...
                    <asp:DropDownList ID="cmbpaybas" AutoPostBack="true" OnTextChanged="cmbpaybas_TextChanged"
                        ...
                        <asp:ListItem Value="P04" Text="FOC"></asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
                                        ...
                                        <asp:TableCell VerticalAlign="top">
                                            <asp:Table border="0" runat="server" Width="100%" CellSpacing="1" HorizontalAlign="Left"
                                                ...
                                                <asp:TableRow BackColor="White">
                                                    ...
                                                    <asp:TableCell ColumnSpan="5">
                                                        <asp:RadioButtonList ID="optminfreighttype" onclick="javascript:return minFreightTypeClick()"
