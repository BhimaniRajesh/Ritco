...
public partial class CompanyMaster : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("CompanyMasterForODA.aspx?PayBase=" + cmbpaybas.SelectedValue);
    ...
    private void updateRecordInActualTable()
    {
        ...
        try
        {
            ...
            string strSQL = "DELETE FROM webx_default_contract_charge WHERE contract_type='" + cmbpaybas.SelectedValue + "'";
            ...
            for (int i = 1; i < 5; i++)
            {
                strSQL = "INSERT INTO webx_default_contract_charge(contract_type,trans_type,road_yn, express_yn, air_yn,rail_yn,";
                ...
                strSQL = strSQL + "'" + cmbpaybas.SelectedValue + "','" + i.ToString() + "','" + (chkMTRoad.Checked == true ? "Y" : "N") + "','" + (chkMTExpress.Checked == true ? "Y" : "N") + "','" + (chkMTAir.Checked == true ? "Y" : "N") + "','" + (chkMTTrain.Checked == true ? "Y" : "N") + "','";
                ...
                strSQL = strSQL + arrcharges[i, 1].ToString() + "," + arrcharges[i, 2].ToString() + "," + arrcharges[i, 3].ToString() + ",";
                strSQL = strSQL + arrcharges[i, 4].ToString() + "," + arrcharges[i, 5].ToString() + "," + arrcharges[i, 6].ToString() + ",";
                strSQL = strSQL + arrcharges[i, 9].ToString() + "," + arrcharges[i, 10].ToString() + ",";
                // 10 charges
                strSQL = strSQL + arrcharges[i, 15].ToString() + ",";
                strSQL = strSQL + arrcharges[i, 16].ToString() + "," + arrcharges[i, 17].ToString() + "," + arrcharges[i, 18].ToString() + ",";
                strSQL = strSQL + arrcharges[i, 19].ToString() + ",";
                // 20 charges
                strSQL = strSQL + arrcharges[i, 21].ToString() + ",";
                strSQL = strSQL + arrcharges[i, 22].ToString() + "," + arrcharges[i, 23].ToString() + ",";
                // 10 user charges
                strSQL = strSQL + arrcharges[i, 24].ToString() + "," + arrcharges[i, 25].ToString() + "," + arrcharges[i, 26].ToString() + "," + arrcharges[i, 27].ToString() + "," + arrcharges[i, 28].ToString() + ",";
                strSQL = strSQL + arrcharges[i, 29].ToString() + "," + arrcharges[i, 30].ToString() + "," + arrcharges[i, 31].ToString() + "," + arrcharges[i, 32].ToString() + "," + arrcharges[i, 33].ToString() + ",";
    ...
    private void displayData()
    {
        ...
        DataTable dt;
        string strSQL = "SELECT * FROM webx_default_contract_charge WHERE contract_type = '" + cmbpaybas.SelectedValue + "'";
        ...
        if (dsCCM.Tables[0].Rows.Count > 0)
        {
            ...
            optminfreihgttype.SelectedValue = Convert.ToString(dsCCM.Tables[0].Rows[0]["min_freight_type"].ToString());
