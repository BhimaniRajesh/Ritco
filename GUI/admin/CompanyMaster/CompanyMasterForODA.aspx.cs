...
public partial class GUI_admin_CustomerContractMaster_CompanyMasterForODA : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            HidPayBase.Value = Request.QueryString["PayBase"].ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/GUI/admin/CompanyMaster/CompanyMasterMain.aspx"); 
    }
    ...
    private void manageSubmitClick()
    {
        ...
        //Delete Records from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR table
        strSQL = "DELETE FROM WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR WHERE contract_type = '" + HidPayBase.Value + "'";

        sqlCommand = new SqlCommand(strSQL, sqlConn);

        sqlCommand.ExecuteNonQuery();

        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR table for Slab 1
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR (contract_type, matrix_type, " + 
                 "slab_code, slab_from, slab_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlRateType.SelectedValue + "', 'SLAB1', " + 
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR table for Slab 2
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR (contract_type, matrix_type, " +
                 "slab_code, slab_from, slab_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlRateType.SelectedValue + "', 'SLAB2', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR table for Slab 3
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR (contract_type, matrix_type, " +
                 "slab_code, slab_from, slab_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlRateType.SelectedValue + "', 'SLAB3', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR table for Slab 4
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR (contract_type, matrix_type, " +
                 "slab_code, slab_from, slab_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlRateType.SelectedValue + "', 'SLAB4', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR table for Slab 5
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR (contract_type, matrix_type, " +
                 "slab_code, slab_from, slab_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlRateType.SelectedValue + "', 'SLAB5', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR table for Slab 6
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR (contract_type, matrix_type, " +
                 "slab_code, slab_from, slab_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlRateType.SelectedValue + "', 'SLAB6', " +
        ...
        //Delete Records from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR table
        strSQL = "DELETE FROM WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR WHERE contract_type = '" + HidPayBase.Value + "'";

        sqlCommand = new SqlCommand(strSQL, sqlConn);

        sqlCommand.ExecuteNonQuery();

        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR table for Slab 1
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR (contract_type, matrix_type, " +
                 "MIN_ODACHRG, ESS_code, ESS_from, ESS_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlODARateType.SelectedValue + "', " +
        ...
        //(txtMinODACharges.Value == "" ? "NULL" : txtMinODACharges.Value) + ", 
        sqlCommand = new SqlCommand(strSQL, sqlConn);
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR table for Slab 2
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR (contract_type, matrix_type, " +
                 "MIN_ODACHRG, ESS_code, ESS_from, ESS_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlODARateType.SelectedValue + "', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR table for Slab 3
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR (contract_type, matrix_type, " +
                 "MIN_ODACHRG, ESS_code, ESS_from, ESS_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlODARateType.SelectedValue + "', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR table for Slab 4
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR (contract_type, matrix_type, " +
                 "MIN_ODACHRG, ESS_code, ESS_from, ESS_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlODARateType.SelectedValue + "', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR table for Slab 5
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR (contract_type, matrix_type, " +
                 "MIN_ODACHRG, ESS_code, ESS_from, ESS_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlODARateType.SelectedValue + "', " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR table for Slab 6
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR (contract_type, matrix_type, " +
                 "MIN_ODACHRG, ESS_code, ESS_from, ESS_to) VALUES ('" + HidPayBase.Value + "', '" +
                 ddlODARateType.SelectedValue + "', " +
        ...
        //Delete Records from WEBX_Default_CONTRACT_ODAMATRIX_CHARGE table
        strSQL = "DELETE FROM WEBX_Default_CONTRACT_ODAMATRIX_CHARGE WHERE contract_type = '" + HidPayBase.Value + "'";

        sqlCommand = new SqlCommand(strSQL, sqlConn);

        sqlCommand.ExecuteNonQuery();

        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_CHARGE table for Row 1
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_CHARGE (contract_type, ESS_code, trdays, " +
                 "Slab1, Slab2, Slab3, Slab4, Slab5, Slab6) VALUES ('" + HidPayBase.Value + "', " +
                 "'ODA1', " + (txtTrODA1ForRow1.Value == "" ? "NULL" : txtTrODA1ForRow1.Value) + ", " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_CHARGE table for Row 2
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_CHARGE (contract_type, ESS_code, trdays, " +
                 "Slab1, Slab2, Slab3, Slab4, Slab5, Slab6) VALUES ('" + HidPayBase.Value + "', " +
                 "'ODA2', " + (txtTrODA1ForRow2.Value == "" ? "NULL" : txtTrODA1ForRow2.Value) + ", " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_CHARGE table for Row 3
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_CHARGE (contract_type, ESS_code, trdays, " +
                 "Slab1, Slab2, Slab3, Slab4, Slab5, Slab6) VALUES ('" + HidPayBase.Value +
                 "', 'ODA3', " + (txtTrODA1ForRow3.Value == "" ? "NULL" : txtTrODA1ForRow3.Value) + ", " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_CHARGE table for Row 4
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_CHARGE (contract_type, ESS_code, trdays, " +
                 "Slab1, Slab2, Slab3, Slab4, Slab5, Slab6) VALUES ('" + HidPayBase.Value +
                 "', 'ODA4', " + (txtTrODA1ForRow4.Value == "" ? "NULL" : txtTrODA1ForRow4.Value) + ", " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_CHARGE table for Row 5
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_CHARGE (contract_type, ESS_code, trdays, " +
                 "Slab1, Slab2, Slab3, Slab4, Slab5, Slab6) VALUES ('" + HidPayBase.Value + 
                 "', 'ODA5', " + (txtTrODA1ForRow5.Value == "" ? "NULL" : txtTrODA1ForRow5.Value) + ", " +
        ...
        //Insert Record in WEBX_Default_CONTRACT_ODAMATRIX_CHARGE table for Row 6
        strSQL = "Insert into WEBX_Default_CONTRACT_ODAMATRIX_CHARGE (contract_type, ESS_code, trdays, " +
                 "Slab1, Slab2, Slab3, Slab4, Slab5, Slab6) VALUES ('" + HidPayBase.Value +
                 "', 'ODA6', " + (txtTrODA1ForRow6.Value == "" ? "NULL" : txtTrODA1ForRow6.Value) + ", " +
    ...
    private void displayData()
    {
        ...
        string strSQL = "select top 1 " +
                        "(select  top 1 slab_from from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB1') AS Slab1From, " +
                        "(select  top 1 slab_to from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB1') AS Slab1To, " +
                        "(select  top 1 slab_from from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB2') AS Slab2From, " +
                        "(select  top 1 slab_to from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB2') AS Slab2To, " +
                        "(select  top 1 slab_from from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB3') AS Slab3From, " +
                        "(select  top 1 slab_to from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB3') AS Slab3To, " +
                        "(select  top 1 slab_from from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB4') AS Slab4From, " +
                        "(select  top 1 slab_to from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB4') AS Slab4To, " +
                        "(select  top 1 slab_from from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " +  
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB5') AS Slab5From, " +
                        "(select  top 1 slab_to from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB5') AS Slab5To, " +
                        "(select  top 1 slab_from from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " + 
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB6') AS Slab6From, " +
                        "(select  top 1 slab_to from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(slab_code) = 'SLAB6') AS Slab6To, matrix_type " +
                        "FROM WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR OuterODAMatrix WHERE contract_type = '" + HidPayBase.Value + "'";
        ...
        //ODA Distance Slab
        strSQL = "select top 1 " +
                        "(select  top 1 ESS_from from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA1') AS ODA1From, " +
                        "(select  top 1 ESS_to from WEBX_Default_CONTRACT_ODAMATRIX_SLABHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA1') AS ODA1To, " +
                        "(select  top 1 ESS_from from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA2') AS ODA2From, " +
                        "(select  top 1 ESS_to from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA2') AS ODA2To, " +
                        "(select  top 1 ESS_from from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA3') AS ODA3From, " +
                        "(select  top 1 ESS_to from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA3') AS ODA3To, " +
                        "(select  top 1 ESS_from from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA4') AS ODA4From, " +
                        "(select  top 1 ESS_to from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA4') AS ODA4To, " +
                        "(select  top 1 ESS_from from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA5') AS ODA5From, " +
                        "(select top 1 ESS_to from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA5') AS ODA5To, " +
                        "(select top 1 ESS_from from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA6') AS ODA6From, " +
                        "(select top 1 ESS_to from WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR Slab1FromInner " +
                        "where Slab1FromInner.contract_type = OuterODAMatrix.contract_type AND UPPER(ESS_Code) = 'ODA6') AS ODA6To, matrix_type, MIN_ODACHRG " +
                        "FROM WEBX_Default_CONTRACT_ODAMATRIX_DISTHDR OuterODAMatrix WHERE contract_type = '" + HidPayBase.Value + "'";
        ...
        //ODA Charges
        strSQL = "select * from WEBX_Default_CONTRACT_ODAMATRIX_CHARGE WHERE contract_type = '" + HidPayBase.Value + "' order by srno";
