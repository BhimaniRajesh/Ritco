<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="CompanyMasterForODA.aspx.cs" Inherits="GUI_admin_CustomerContractMaster_CompanyMasterForODA" Title="Company Master - ODA" %>
...
//            }
    ...
    <div>
        ...
        <input type="hidden" runat="server" id="HidPayBase" />
				                                                    ...
				                                                    <table border="0" cellpadding="1" width="100%" cellspacing="1" align="center" class="boxbg">
						                                                ...
						                                                <tr style="background-color: White">
							                                                ...
							                                                <td align="left">
							                                                    ...
							                                                    <asp:DropDownList ID="ddlODARateType" runat="server" CssClass="blackfnt">
							                                                        <asp:ListItem Selected="True" Value="-1" Text="Select"></asp:ListItem>
							                                                        <asp:ListItem Value="W" Text="Per Kg."></asp:ListItem>
							                                                        <asp:ListItem Value="P" Text="Per Package"></asp:ListItem>
						                                                ...
						                                                <tr style="background-color: White">
							                                                ...
							                                                <td align="left">
							                                                    <input id="txtMinODACharges" type="text" size="10" 
				                                            ...
				                                            <tr style="background-color: White">
				                                                <td align="center" colspan="4">
				                                                    ...
				                                                    <table border="0" cellpadding="0" width="100%" cellspacing="1" align="center" class="boxbg">
							                                            ...
							                                            <tr style="background-color: White">
							                                                <td align="center">
							                                                    <input id="txtFromODA1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtToODA1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtFromODA2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtToODA2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtFromODA3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtToODA3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtFromODA4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtToODA4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtFromODA5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtToODA5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtFromODA6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtToODA6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                            </tr>
				                                                ...
				                                                <td align="center" colspan="4">
				                                                    ...
				                                                    <table border="0" cellpadding="0" width="100%" cellspacing="1" align="center" class="boxbg">
							                                            ...
							                                            <tr style="background-color: White">
							                                                <td align="center">
							                                                    <label class="blackfnt">
							                                                        Distance <br>From Delivery<br> Location
							                                                    </label>
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <label class="blackfnt">
							                                                        Extra Transit<br> Days
							                                                    </label>
							                                                </td>
							                                            ...
							                                            <tr style="background-color: White">
							                                                ...
							                                                <td align="center">
							                                                    <input id="txtTrODA1ForRow1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_woDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA1ForRow1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center" style="width: 72px">
							                                                    <input id="txtSlabODA2ForRow1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA3ForRow1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA4ForRow1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA5ForRow1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA6ForRow1" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                            </tr>
		                                                                ...
		                                                                <tr style="background-color: White">
							                                                ...
							                                                <td align="center">
							                                                    <input id="txtTrODA1ForRow2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_woDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA1ForRow2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center" style="width: 72px">
							                                                    <input id="txtSlabODA2ForRow2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA3ForRow2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA4ForRow2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA5ForRow2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA6ForRow2" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                            </tr>
                                                                        ...
                                                                        <tr style="background-color: White">
							                                                ...
							                                                <td align="center">
							                                                    <input id="txtTrODA1ForRow3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_woDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA1ForRow3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center" style="width: 72px">
							                                                    <input id="txtSlabODA2ForRow3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA3ForRow3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA4ForRow3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA5ForRow3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA6ForRow3" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                            </tr>
                                                                        ...
                                                                        <tr style="background-color: White">
							                                                ...
							                                                <td align="center">
							                                                    <input id="txtTrODA1ForRow4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_woDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA1ForRow4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center" style="width: 72px">
							                                                    <input id="txtSlabODA2ForRow4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA3ForRow4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA4ForRow4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA5ForRow4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA6ForRow4" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                            </tr>
                                                                        ...
                                                                        <tr style="background-color: White">
							                                                ...
							                                                <td align="center">
							                                                    <input id="txtTrODA1ForRow5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_woDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA1ForRow5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center" style="width: 72px">
							                                                    <input id="txtSlabODA2ForRow5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA3ForRow5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA4ForRow5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA5ForRow5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA6ForRow5" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                            </tr>
                                                                        ...
                                                                        <tr style="background-color: White">
							                                                ...
							                                                <td align="center">
							                                                    <input id="txtTrODA1ForRow6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_woDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA1ForRow6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center" style="width: 72px">
							                                                    <input id="txtSlabODA2ForRow6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA3ForRow6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA4ForRow6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA5ForRow6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                                
							                                                <td align="center">
							                                                    <input id="txtSlabODA6ForRow6" type="text" size="10" 
                                                                                    maxlength="6" onblur="return Nagative_Chk_wDecimal(this)" 
                                                                                    style="margin-left: 5px;" runat="server" />
							                                                </td>
							                                            </tr>
