<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="View_track_Rights.aspx.cs" Inherits="GUI_admin_View_track_Rights" %>
...
--%>
                            ...
                            <Columns>
                                ...
                                <%-- Level 0 --%>
                                <asp:TemplateField  HeaderText="View & Track type " ItemStyle-HorizontalAlign="left"
...
--%>
                                ...
                                <%-- Level 1 --%>
                                <asp:TemplateField Visible="false"  HeaderText="Reports Sub Type" ItemStyle-HorizontalAlign="left" ItemStyle-Font-Bold="true"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                ...
                                <%-- Level 2 --%>
                                <asp:TemplateField  HeaderText="Documnet List" ItemStyle-HorizontalAlign="left"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
