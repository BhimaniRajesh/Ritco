<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="AirLineMasterEdit.aspx.cs" Inherits="GUI_admin_AirportMaster_AirportMasterEdit" Title="Untitled Page" %>
                          ...
                          <td width="440"> 
                            <div align="left">
                                <asp:UpdatePanel ID="upLocationCode" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtAirportCity" runat="server" Width="289px" OnTextChanged="txtAirportCity_TextChanged" AutoPostBack="true" ></asp:TextBox>
