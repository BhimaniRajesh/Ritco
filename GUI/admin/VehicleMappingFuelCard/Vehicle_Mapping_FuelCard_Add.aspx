<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Vehicle_Mapping_FuelCard_Add.aspx.cs" Inherits="GUI_admin_VehicleMappingFuelCard_Vehicle_Mapping_FuelCard_Add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <script type="text/javascript">
        ...
        function ValidRow(e) {
            ...
            var ddlFuelWallet = $(e).closest('tr').find('select[id*="ddlFuelWallet"]');
            if (txtCardNo.val() == '') {
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <table border="1" width="100%">
                            ...
                            <asp:GridView runat="server" CssClass="boxbg" ID="gvFuelCard" AutoGenerateColumns="False" CellSpacing="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="" HeaderStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="lbAdd" CommandName="Add" OnClientClick="return ValidRow(this);" Visible="false"><asp:Image runat="server" ImageUrl="~/images/png/24/button-add.png"/></asp:LinkButton>
                    ...
                    <tr class="hrow">
                        <td align="center" colspan="5">
                            <asp:Button Text="Submit" runat="server" Visible="true" class="btn btn-primary" OnClick="btnSubmit_Click" OnClientClick="javascript:return Confirmation();" ID="btnSubmit" />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
