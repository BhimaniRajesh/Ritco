<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeMapping.aspx.cs" Inherits="GUI_admin_Multi_Company_Master_EmployeeMapping"  %>
...
{   
    ...
    var txtEmpCode = document.getElementById(prefix + "txtEmpCode");
    if(txtEmpCode.value == "")
    {
...
function EmpBlur(id)
 {  
    ...
    var txtEmpCode=document.getElementById(id);
   
    var EmpCode=txtEmpCode.value;
    if(EmpCode=="")
        return false;
    ...
    if(findobj)
    {
        var strpg="CheckExist.aspx?mode=EmpCode&Code=" + EmpCode + "&sid=" + Math.random();
             ...
             if(findobj.readyState==4 && findobj.status==200)
              {
                    ...
                    if(res[0]=="false")
                    {
                        alert("Employee Code is not Valid... Please Enter Valid Employee Code");
                        txtEmpCode.value = "";
                        txtEmpCode.focus();
                        return false;
                    }
...
<div style="text-align: center; width: 10.0in">
    <table cellspacing="1" class="boxbg" width="800">
        <tr class="bgbluegrey">
            <td align="center">
                <strong>Mapping With Employee</strong>
            </td>
        </tr>
    </table>
    <br />
        ...
        <ContentTemplate>
            <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
                <tr style="background-color: White"> 
                    <td width="20%">
                        &nbsp;<asp:Label ID="lblEmpcode" style="text-align:left" runat="server" Text="Employee Code"></asp:Label>
                    </td>
                    <td style="text-align :left; width: 163px;">
                        &nbsp;<asp:TextBox ID="txtEmpCode" CssClass="blackfnt" runat="server" BorderStyle="Groove" Width="100px" style="text-align:left;" onblur="javascript:this.value=this.value.toUpperCase()" MaxLength="10"></asp:TextBox>
                        &nbsp;<input id="btnEmpCode"  nowrap  type="button" value="..." runat="server" />
                    </td>
                    <td colspan="2" style="text-align :left; width: 160px;">
                        &nbsp;<asp:Button ID="btnEmpSubmit" runat="server" OnClientClick="javascript:return CheckEmpData()" OnClick="btnEmpSubmit_Click" BorderStyle="Groove" CssClass="blackfnt" Text="Submit"/>
                    </td>
                </tr>
