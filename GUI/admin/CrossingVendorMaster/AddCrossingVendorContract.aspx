<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddCrossingVendorContract.aspx.cs" Inherits="GUI_admin_CrossingVendorMaster_AddCrossingVendorContract" %>
               ...
               for(j = i+1;j <= Totalcount;j++)
               {
                   if(j<10)
                    {  
                        ...
                        ddlOrigin1=document.getElementById("ctl00_MyCPH1_grvcity_ctl0" + i + "_ddlOrigin");
                    }
                    else
                    {  
                        ...
                        ddlOrigin1=document.getElementById("ctl00_MyCPH1_grvcity_ctl" + i + "_ddlOrigin");
                    }
                    ...
                    {   
                        if(ddlOrigin.value == ddlOrigin1.value)
                        {
                            if(txtDestcity.value == txtDestcity1.value)
                            {
                                ...
                                {   
                                    alert("Duplicate Rate Type For Same Location");
...
//    for(i = 2; i <= TotalRecodrs ; i++)
//    {
//        if(i<10)
//            {  
//               txtDestcity=document.getElementById("ctl00_MyCPH1_grvcity_ctl0" + i + "_txtDestcity").value;
//               //cmbratetype=document.getElementById("ctl00_MyCPH1_grvcity_ctl0" + i + "_cmbratetype");
//               ddlOrigin=document.getElementById("ctl00_MyCPH1_grvcity_ctl0" + i + "_ddlOrigin").value;
//            }
//        else
//            {
//               txtDestcity=document.getElementById("ctl00_MyCPH1_grvcity_ctl" + i + "_txtDestcity").value;
//               //cmbratetype=document.getElementById("ctl00_MyCPH1_grvcity_ctl" + i + "_cmbratetype");
//               ddlOrigin=document.getElementById("ctl00_MyCPH1_grvcity_ctl" + i + "_ddlOrigin").value;
//            }
//                    
//    }
    }
