<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="FixedExpense.aspx.cs" Inherits="GUI_admin_FixedExpense_FixedExpenseEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
    <UserControl:UserMessage runat="server" ID="UserMessage" />
    <script src="../../images/commonJs.js" type="text/javascript"></script>
    <script src="JS/FixedExpense.js?V3" type="text/javascript"></script>
    <div style="width: 6in">
        ...
        <table border="1" width="100%">
            ...
            <tr class="hrow">
                <td align="center" colspan="2">
                    <asp:Button Text="Step-1" runat="server" Visible="true" class="btn btn-primary" OnClientClick="javascript: Step1Click();" OnClick="btnStep1_Click" ID="btnStep1" />
                </td>
            </tr>
        </table>
        <table border="1" width="100%" runat="server" id="tblMain">
            ...
            <tr align="center" class="hrow">
                <td colspan="5">
                    <asp:Button Text="Submit" runat="Server" OnClientClick="javascript: BtnSubmit();" OnClick="btnSubmit_Click" class="btn btn-primary" id="btnSubmit"/>
                </td>
            </tr>
        </table>
    </div>
