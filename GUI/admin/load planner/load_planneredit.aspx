<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="load_planneredit.aspx.cs" Inherits="GUI_admin_VehicleMaster_VehicleMasterEdit"
    Title="Untitled Page" %>
...
var minYear=1900;
var maxYear=2100;
function Chk(ddVehicleType,ddVndrNm,lstPermitStates,lstRut,txtVhclInsuranceDt,txtFitnessDt,btnSubmit)
    {
...
//            }
            ...
            {
                alert("Enter Capacity in positive numeric");
                document.getElementById("ctl00_MyCPH1_txtCapacity").focus();
                return false;
            }
            ...
            <tr>
                <td style="width: 960px">
                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="30" style="width: 974px">
                                <a><font class="blklnkund"><strong>Module</strong></font></a> &gt; <a><font class="blklnkund">
                                    <strong>Administrator </strong></font></a>&gt; <a href="../operations.aspx"><font
                                        class="blklnkund"><strong>Operations</strong></font></a> <font class="bluefnt"><strong>
                                            &gt; Vehicle Master</strong> </font>
                            </td>
                        </tr>
                        <tr>
                            <td class="horzblue" style="width: 974px">
                        ...
                        <tr>
                            <td align="right" style="width: 974px">
                                                    ...
                                                    <td height="300" valign="top" style="width: 907px">
                                                        ...
                                                        <table align="center" border="0" cellpadding="5" cellspacing="1" width="95%" class="boxbg">
                                                            <tr class="bgbluegrey">
                                                                <td colspan="3" align="center">
                                                                    <font class="blackfnt"><b>VEHICLE MASTER SCREEN</b></font></td>
                                                            </tr>
                                                        </table>
                                                        <br />
                                                                    ...
                                                                    <table border="0" cellspacing="0" width="100%" cellpadding="3">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 169px">
                                                                                        <asp:DropDownList ID="ddVehicleType" runat="server" Width="178px" OnSelectedIndexChanged="ddVehicleType_SelectedIndexChanged">
                                                                                        </asp:DropDownList>
                                                                            </td>
                                                                            <td>
                                                                                <font class="blackfnt">Controlling Branch</font></td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtCntrlBranch" runat="server" onblur="return checklocation(this)"
                                                                                    Width="64px" OnChange="Javascript:this.value=this.value.toUpperCase();" MaxLength="50"></asp:TextBox>
                                                                                <asp:Label ID="Label1" runat="server" BorderStyle="Groove" TabIndex="18" Text='<a href="javascript:nwOpen(1)">...</a>'
                                                                                    Width="14px"></asp:Label></td>
                                                                            <td class="blackfnt">
                                                                                Vehicle No. &nbsp; &nbsp;:</td>
                                                                            <td class="blackfnt">
                                                                                <asp:Label ID="lblVhclNo" runat="server" CssClass="blackfnt" ForeColor="#FF8080"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="blackfnt">
                                                                                Vendor Type :</td>
                                                                            <td class="blackfnt">
                                                                                <asp:DropDownList ID="cmbvendortype" runat="server" Width="182px">
                                                                                </asp:DropDownList></td>
                                                                            <td class="blackfnt">
                                                                            ...
                                                                            <td class="blackfnt">
                                                                                <font class="blackfnt">
                                                                                    <asp:ListBox ID="lstPermitStates" runat="server" Height="59px" Width="131px" SelectionMode="Multiple">
                                                                                    </asp:ListBox></font></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="blackfnt" valign="top">
                                                                                Routes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                                                            </td>
                                                                            <td class="blackfnt" valign="top" style="width: 169px">
                                                                                <asp:ListBox ID="lstRut" runat="server" Height="60px" Width="180px" SelectionMode="Multiple">
                                                                                </asp:ListBox></td>
                                                                            <td class="blackfnt" valign="top">
                                                                                No. Of Drivers</td>
                                                                            <td class="blackfnt" valign="top">
                                                                                &nbsp;<asp:TextBox ID="txtDrivers" onblur="return checknumber(this)" runat="server" Width="91px"></asp:TextBox></td>
                                                                            <td>
                                                                            </td>
                                                                            <td>
                                                                                &nbsp;</td>
                                                        ...
                                                        <table align="center" border="0" cellpadding="2" cellspacing="1" width="95%" class="boxbg">
                                                            <tr class="bgbluegrey">
                                                                <td align="center" height="18">
                                                                    <font class="bluefnt"><b />Other Information</font></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3" bgcolor="#FFFFFF">
                                                                    <table border="0" cellspacing="0" width="100%" cellpadding="3">
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <font class="blackfnt">
                                                                                    <asp:TextBox ID="txtRcBookNo" runat="server" Width="107px" OnChange="Javascript:this.value=this.value.toUpperCase();"></asp:TextBox></font></td>
                                                                            <td>
                                                                                <font class="blackfnt">Registration No.</font></td>
                                                                            <td>
                                                                                <font class="blackfnt">
                                                                                    <asp:TextBox ID="txtRgnNo" runat="server" Width="107px" OnChange="Javascript:this.value=this.value.toUpperCase();"></asp:TextBox></font></td>
                                                                            <td class="blackfnt">
                                                                                Registration Date
                                                                            </td>
                                                                            <td>
                                                                                <font class="blackfnt">
                                                                                    <asp:TextBox ID="txtRgnDt" runat="server" Width="86px"></asp:TextBox>
                                                                                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtRgnDt, 'alnktxtRgnDt', 'dd/MM/yyyy'); return false;"
                                                                                        id="alnktxtRgnDt">
                                                                                        <img src="../../../GUI/images/calendar.jpg" border="0" alt="" /></a></font></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="blackfnt">
                                                                                Vehicle Insurance
                                                                            ...
                                                                            <td>
                                                                                <font class="blackfnt">
                                                                                    <asp:TextBox ID="txtVhclInsuranceDt" runat="server" Width="86px" onblur="return ValidateDate(this)"></asp:TextBox>
                                                                                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtVhclInsuranceDt, 'alnktxtVhclInsuranceDt', 'dd/MM/yyyy'); return false;"
                                                                                        ...
                                                                                        <img src="../../../GUI/images/calendar.jpg" border="0" alt="" /></a></font></td>
                                                                            <td class="blackfnt">
                                                                                Fitness Certificate Date</td>
                                                                            <td>
                                                                                <font class="blackfnt"></font>
                                                                                <asp:TextBox ID="txtFitnessDt" runat="server" Width="86px"></asp:TextBox>
                                                                                <a href="#" onclick="cal.select(ctl00_MyCPH1_txtFitnessDt, 'alnktxtFitnessDt', 'dd/MM/yyyy'); return false;"
                                                                                    id="alnktxtFitnessDt">
                                                                                    <img src="../../../GUI/images/calendar.jpg" border="0" alt="" /></a></td>
                                                                            <td>
                                                                                <font class="blackfnt">Date Of Atteching</font></td>
                                                                            <td>
                                                                                <font class="blackfnt">
                                                                                    <asp:TextBox ID="txtAttachingDt" runat="server" Width="86px"></asp:TextBox>
                                                                                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtAttachingDt, 'alnktxtAttachingDt', 'dd/MM/yyyy'); return false;"
                                                                        ...
                                                                        <tr>
                                                                            <td class="blackfnt">
                                                                                Chasis No.</td>
                                                                            <td class="blackfnt">
                                                                                <asp:TextBox ID="txtChasisNo" runat="server" Width="107px" OnChange="Javascript:this.value=this.value.toUpperCase();"></asp:TextBox></td>
                                                                            <td class="blackfnt">
                                                                                Engine No.</td>
                                                                            <td class="blackfnt">
                                                                                <%--onblur="return ValidateFitnessDate(this)"--%>
                                                                                <asp:TextBox ID="txtEngineNo" runat="server" Width="107px" OnChange="Javascript:this.value=this.value.toUpperCase();"></asp:TextBox></td>
                                                                            <td class="blackfnt">
                                                                                Active Flag</td>
                                                                            <td>
                                                                                <font class="blackfnt">
                                                                                    <asp:UpdatePanel ID="upChkActFlag" runat="server">
                                                                                        <ContentTemplate>
                                                                                            <asp:CheckBox ID="c1" runat="server" AutoPostBack="True" OnCheckedChanged="c1_CheckedChanged"
                                                                                                Width="10px" />
                                                                                            <asp:TextBox ID="txtActFlag" runat="server" ReadOnly="True" Width="40px" OnChange="Javascript:this.value=this.value.toUpperCase();">N</asp:TextBox>&nbsp;
                                                                                        </ContentTemplate>
                                                                                        <Triggers>
                                                        ...
                                                        <table align="center" border="0" cellpadding="2" cellspacing="1" width="95%" class="boxbg">
                                                            <tr class="bgbluegrey">
                                                                <td colspan="8">
                                                                    <div align="center">
                                                                        <font class="bluefnt"><b>Inner Dimension in ft</b></font></div>
                                                                </td>
                                                            </tr>
                                                            <tr bgcolor="#FFFFFF">
                                                                <td>
                                                                    <font class="blackfnt">Length&nbsp;&nbsp;&nbsp;:</font></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtLength" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <font class="blackfnt">Width &nbsp;&nbsp;&nbsp;:</font></td>
                                                                <td style="width: 5px">
                                                                    <asp:TextBox ID="txtWidth" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox></td>
                                                                <td>
                                                                    <font class="blackfnt">Height &nbsp;&nbsp;&nbsp;:</font></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtHeight" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <font class="blackfnt">Rate/Km &nbsp;&nbsp;&nbsp;:</font></td>
                                                                <td style="width: 5px">
                                                                    <asp:TextBox ID="txtRate" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr bgcolor="#FFFFFF">
                                                                <td colspan="8">
                                                            ...
                                                            <tr class="bgbluegrey">
                                                                <td colspan="8">
                                                                    <div align="center">
                                                                        <font class="bluefnt"><b>Payload Capacity as per RC in Ton</b></font></div>
                                                                </td>
                                                            </tr>
                                                            <tr bgcolor="#FFFFFF">
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtGVW" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <font class="blackfnt">Unladen&nbsp;&nbsp;&nbsp;:</font></td>
                                                                <td style="width: 5px">
                                                                    <asp:TextBox ID="txtUnladen" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <font class="blackfnt">Payload &nbsp;&nbsp;&nbsp;:</font></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtPayload" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <font class="blackfnt">Capacity &nbsp;&nbsp;&nbsp;:</font></td>
                                                                <td>
                                                                    <asp:TextBox ID="txtCapacity" onblur="return checknumber(this)" runat="server" Width="107px" MaxLength="5"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr bgcolor="#FFFFFF">
                                                                <td colspan="8">
