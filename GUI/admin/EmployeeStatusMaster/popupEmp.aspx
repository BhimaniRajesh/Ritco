...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
            ...
            if(mNo == 1)
            {
                window.opener.document.forms[0].ctl00$MyCPH1$txtEmpCode.value = objLocation.value
            }
//            else if(mNo == 2)
//            {
//                window.opener.document.forms[0].ctl00$MyCPH1$txtCurrentLocationCode.value = objLocation.value
//            }
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" ItemStyle-BackColor="white" ItemStyle-Width="40px" >
                                    <ItemTemplate>
                                        <input name="MyRadioButton" type="radio" value='<%# Eval("empcd") %>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="empcd" HeaderText="Branch Code">
                                ...
                                <asp:BoundField DataField="empnm" HeaderText="Branch Name">
