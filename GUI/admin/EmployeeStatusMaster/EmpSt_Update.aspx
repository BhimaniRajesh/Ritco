<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="EmpSt_Update.aspx.cs" Inherits="GUI_admin_EmployeeStatusMaster_EmpSt_Update" Title="Untitled Page" %>
   ...
   <tr bgcolor="#FFFFFF"> 
      ...
      <td align="left" valign="top">
          <asp:UpdatePanel ID="upLocationCode" runat="server">
                   <ContentTemplate>
                        <asp:TextBox ID="txtEmpStatus" runat="server" OnTextChanged="txtEmpStatus_TextChanged" AutoPostBack="true"></asp:TextBox>
