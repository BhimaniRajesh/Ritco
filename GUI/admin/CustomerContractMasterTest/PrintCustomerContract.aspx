...
<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="PrintCustomerContract.aspx.cs" Inherits="PrintCustomerContract"
    EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <script language="javascript" type="text/javascript">--%>
    
    
    <%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/GUI/admin/CustomerContractMaster/PrintCustomerContract.aspx.cs" Inherits="PrintCustomerContract" %>
    ...
    <asp:Panel ID="pnlMain" runat="server">
                        ...
                        <asp:TableRow>
                            <asp:TableCell>
                                <asp:Panel ID="Panel1" runat="server" Style="width: 10in;" HorizontalAlign="left">
                                    <asp:Table runat="server" CellSpacing="1" ID="tblheader" CssClass="std" Style="width: 100%;">
                                        <asp:TableRow ID="step1" BackColor="White" BorderWidth="1px">
                                ...
                                Contract ID
                                            ...
                                            <asp:TableCell>
                                                <asp:Label ID="lblrcplcontractid" runat="server" CssClass="blackfnt"></asp:Label>
                                            </asp:TableCell>
                                            <asp:TableCell>
                                            </asp:TableCell>
                                            <asp:TableCell>
                                ...
                                Contract ID
                                            ...
                                            <asp:TableCell>
                                                <asp:Label ID="lblcontractid" runat="server" CssClass="blackfnt"></asp:Label>
                                            </asp:TableCell>
                                        </asp:TableRow>
                                ...
                                Commited Business
                                            ...
                                            <asp:TableCell>
                                                <asp:Label ID="lblcommitedbusiness" Style="display: none;" runat="server" CssClass="blackfnt"></asp:Label>
                                            </asp:TableCell>
                    ...
                    &nbsp;
                        ...
                        <asp:TableRow>
                            <asp:TableCell>
                                <br />
                                <asp:Table ID="tbldetail" runat="server" CellSpacing="1" CssClass="std" Style="width: 100%;">
                                    <asp:TableRow ID="step2" BorderWidth="1px" BackColor="White">
                        ...
                        <asp:TableRow>
                            <asp:TableCell BorderWidth="1px" HorizontalAlign="Center">
                                ...
                                <asp:Table runat="server" ID="ChargesMst" HorizontalAlign="Center" CellPadding="1"
                                    CellSpacing="1" Style="width: 7in;" CssClass="std">
                                </asp:Table>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                    ...
                    &nbsp;
                        ...
                        <asp:TableRow>
                            <asp:TableCell>
                                <br />
                                <asp:Table ID="tblminfreight" runat="server" CellSpacing="1" CssClass="std" Style="width: 60%;"
                                    HorizontalAlign="Center">
                                    <asp:TableRow BorderWidth="1px" BackColor="White">
                    ...
                    &nbsp;
                        ...
                        <asp:TableRow>
                            <asp:TableCell>
                                <br />
                                <asp:Table ID="Table1" runat="server" CellSpacing="1" CssClass="std" Width="6in">
                                    <asp:TableRow BorderWidth="1px" BackColor="White">
                                        <asp:TableCell HorizontalAlign="left" ColumnSpan="5">
                        ...
                        <asp:TableRow>
                            <asp:TableCell>
                                ...
                                <asp:Table runat="server" ID="Slabhdr" HorizontalAlign="left" Visible="false" CellPadding="3"
                                    CellSpacing="1" Style="width: 8.5in;" CssClass="std">
                                    <asp:TableRow BorderWidth="1px" BackColor="White">
                        ...
                        <asp:TableRow>
                            <asp:TableCell>
                                <asp:Table runat="server" ID="Table2" HorizontalAlign="left" CellPadding="3" CellSpacing="1"
                                    Style="width: 8.5in;" CssClass="std">
                        ...
                        <asp:TableRow>
                            <asp:TableCell>
                                <asp:Table runat="server" ID="Single_slab" Visible="false" HorizontalAlign="left"
                                    CellPadding="3" CellSpacing="1" Style="width: 8.5in;" CssClass="std">
                                </asp:Table>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
