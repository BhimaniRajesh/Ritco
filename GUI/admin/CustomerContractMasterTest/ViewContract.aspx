                                                ...
                                                <asp:TableRow CssClass="bgwhite">
                                                    <asp:TableCell>
                                                        <asp:GridView HorizontalAlign="left" ID="grvftl" runat="server" BorderWidth="0" CellSpacing="1"
                                                            AllowSorting="true" PagerStyle-HorizontalAlign="left" CssClass="boxbg" BackColor="#8ba0e5"
                                                            HeaderStyle-CssClass="bgbluegrey" FooterStyle-CssClass="<%=boxbg%>" AutoGenerateColumns="true"
                                                            HeaderStyle-Font-Bold="true" Width="100%" RowStyle-HorizontalAlign="Center" RowStyle-CssClass="bgwhite"
                                                            EmptyDataText="No Records Found..." OnRowDataBound="grvftl_RowDataBound">
                                                            <Columns>
                                                            </Columns>
                                                        </asp:GridView>
                                                    </asp:TableCell>
