...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        debugger
            var mNo = <%=Request.QueryString["cd"]%>
            
             window.opener.document.getElementById(mNo).value= objLocation.value
             
              //  window.opener.document.forms[0].mNo  = objLocation.value
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
            ...
            <Columns>
                <asp:TemplateField HeaderText="Select" ItemStyle-BackColor="white" ItemStyle-Width="40px">
                    <ItemTemplate>
                        <input name="MyRadioButton" type="radio" value='<%# Eval("codeid") %>' onclick="SelectLocation(this)" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="codeid" HeaderText="Zone Code">
                ...
                <asp:BoundField DataField="codedesc" HeaderText="Zone Name">
