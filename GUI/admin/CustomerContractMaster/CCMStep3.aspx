                ...
                <asp:Table ID="tblmain" runat="server" Width="100%" CssClass="boxbg" CellSpacing="1">
                    ...
                    <asp:TableRow CssClass="bgwhite" runat="server" ID="trlist">
                        <asp:TableCell Width="400px">
                            <asp:Label ID="lbllistname1" runat="server" CssClass="blackfnt"></asp:Label>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="ddllist1" OnSelectedIndexChanged="ddllist1_SelectedIndexChanged"
                                AutoPostBack="true" runat="server" CssClass="blackfnt" DataValueField="codeid"
                                DataTextField="codedesc">
                            </asp:DropDownList>
                        </asp:TableCell>
                        <asp:TableCell Width="400px">
                            <asp:Label ID="lbllistname2" runat="server" CssClass="blackfnt"></asp:Label>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="ddllist2" style="display:none;" OnSelectedIndexChanged="ddllist2_SelectedIndexChanged"
                                AutoPostBack="true" runat="server" CssClass="blackfnt" DataValueField="codeid"
                                DataTextField="codedesc">
                            </asp:DropDownList>
                        </asp:TableCell>
                    ...
                    Charge at time of   
                        ...
                        <asp:TableCell ColumnSpan="3">
                            <asp:DropDownList ID="ddlchargetime" OnSelectedIndexChanged="ddllist1_SelectedIndexChanged"
                                AutoPostBack="true" runat="server" CssClass="blackfnt" DataValueField="codeid"
                                DataTextField="codedesc">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Charge Rate">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Button ID="btnmatrix" runat="server" Text="Matrix" CssClass="blackfnt" OnClick="btnmatrix_Click"
                                                OnClientClick="javascript:return btnmatrixClick()" />
