...
public partial class GUI_admin_CustomerContractMaster_UnLoadingSundry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlCommand cmd;
            SqlDataAdapter da;
            sqlstr = "SELECT * FROM webx_custcontract_unloadingcharges WHERE contractid='" + contractid + "' AND loctype='L' AND service_class='1'";
            ...
            sqlstr = "SELECT * FROM webx_custcontract_unloadingcharges WHERE contractid='" + contractid + "' AND loctype='C' AND service_class='1'";
            cmd = new SqlCommand(sqlstr, con);
            da = new SqlDataAdapter(cmd);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sqlstr = "DELETE FROM webx_custcontract_unloadingcharges WHERE contractid='" + contractid + "' AND service_class='1'";
