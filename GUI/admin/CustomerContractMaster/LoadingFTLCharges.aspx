<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="LoadingFTLCharges.aspx.cs" Inherits="GUI_admin_CustomerContractMaster_LoadingFTL" %>
...
{   
    ...
    for(var i=2;i<lenbranch+1;i++)
    {
        ...
        if(chkyes.checked==true)
        {
            ...
            var cmbratetype=document.getElementById(pref + "cmbftltype");
            ...
            if(txtrate.value=="")
                ...
                for(var j=2;j<lenbranch+1;j++)
                {
                    ...
                    var cmbJratetype=document.getElementById(Jpref + "cmbftltype");
                               
                     
                     if(i!=j)
                     {
                         
                            if(txtlocation.value==txtJbranch.value && cmbratetype.value==cmbJratetype.value)
                            {
                ...
                for(var j=2;j<lencity+1;j++)
                {
                    ...
                    var cmbJratetype=document.getElementById(Jpref + "cmbratetype");
                     ...
                     if(i!=j)
                     {
                            ...
                            if(txtlocation.value==txtJcity.value && cmbratetype.value==cmbJratetype.value)
                            {
                                alert("Duplicate record Found....");
                                txtlocation.focus();
                                return false;
    ...
    <asp:Panel runat="server" Width="10in">
        <asp:Table runat="server" Width="100%">
                        ...
                        <ContentTemplate>
                            <asp:Table runat="server" Width="100%" CssClass="boxbg" CellSpacing="1" CellPadding="0">
                                <asp:TableRow CssClass="bgbluegrey">
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2" Font-Bold="true">Loading Charges FTL - Branch</asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow BackColor="White">
                                        ...
                                        <asp:GridView CssClass="boxbg" runat="server" ID="grvbranch" CellSpacing="1" Width="99.8%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtlocation" Text='<%# DataBinder.Eval( Container.DataItem,"location") %>'
                                                            onblur="javascript:return locTest(this.getAttribute('id'))"
                                                            BorderStyle="groove" Width="50px" runat="server"></asp:TextBox>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="cmbftltype" runat="server" DataValueField="codeid" DataTextField="codedesc" BackColor="white" CssClass="blackfnt">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtrate" Text='<%# DataBinder.Eval( Container.DataItem,"airrate") %>'
                                                            BorderStyle="groove" Style="text-align: right;" 
                ...
                <asp:TableCell>
                    ...
                    <asp:UpdatePanel ID="upd2" runat="server">
                        <ContentTemplate>
                            <asp:Table runat="server" Width="100%" CssClass="boxbg" CellSpacing="1" CellPadding="0">
                                <asp:TableRow CssClass="bgbluegrey">
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2" Font-Bold="true">Loading Charges FTL - City</asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow BackColor="White">
                                    <asp:TableCell HorizontalAlign="Right" Width="50%">
                    No of Rows :                
                                        ...
                                        <asp:GridView CssClass="boxbg" runat="server" ID="grvcity" CellSpacing="1" Width="99.8%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtlocation" Text='<%# DataBinder.Eval( Container.DataItem,"location") %>'
                                                            onblur="javascript:return cityTest(this.getAttribute('id'))"
                                                            BorderStyle="groove" Width="100px" runat="server"></asp:TextBox>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="cmbftltype" runat="server" DataTextField="codedesc" DataValueField="codeid" BackColor="white" CssClass="blackfnt">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtrate" Text='<%# DataBinder.Eval( Container.DataItem,"airrate") %>'
                                                            ...
                                                            Width="80px" runat="server" MaxLength="12"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
            ...
            <asp:TableRow>
                ...
                <asp:Panel ID="divscroll" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Center">
                <br />
                    <asp:Table runat="server" BorderWidth="0" Width="100%" CellPadding="0" CellSpacing="1" CssClass="boxbg">
                        <asp:TableRow CssClass="bgbluegrey">
                            <asp:TableCell>
