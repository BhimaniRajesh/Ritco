<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="FlatLoadingCharges.aspx.cs" Inherits="GUI_admin_CustomerContractMater_FlatMultiPointCharges" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MyCPH1" ID="cntone">
    ...
    {
          var grid=document.getElementById("ctl00_MyCPH1_grvloadingftl");    
          ...
          {
                if(i<10)
                    pref="ctl00_MyCPH1_grvloadingftl_ctl0" + i + "_";
                else
                    pref="ctl00_MyCPH1_grvloadingftl_ctl" + i + "_";
                ...
                {
                    if(j<10)
                        Jpref="ctl00_MyCPH1_grvloadingftl_ctl0" + j + "_";
                    else
                        Jpref="ctl00_MyCPH1_grvloadingftl_ctl" + j + "_";
          ...
          var gridsundry=document.getElementById("ctl00_MyCPH1_grvloadingsundry");    
          ...
          {
                if(i<10)
                    pref="ctl00_MyCPH1_grvloadingsundry_ctl0" + i + "_";
                else
                    pref="ctl00_MyCPH1_grvloadingsundry_ctl0" + i + "_";
                ...
                { 
                    if(j<10)
                        Jpref="ctl00_MyCPH1_grvloadingsundry_ctl0" + j + "_";
                    else
                        Jpref="ctl00_MyCPH1_grvloadingsundry_ctl0" + j + "_";
                ...
                <asp:Table runat="server" ID="tblftlcapacity" Width="100%" CellSpacing="1" CellPadding="1"
                    ...
                    <asp:TableRow BackColor="White">
                        <asp:TableCell ColumnSpan="2">
                            <asp:GridView HorizontalAlign="center" ID="grvloadingsundry" runat="server" BorderWidth="0"
                                ...
                                PagerSettings-Mode="NumericFirstLast" AutoGenerateColumns="false" OnRowDataBound="grvloadingsundry_RowDataBound"
                                    ...
                                    <asp:TemplateField HeaderText="Charge Rate" HeaderStyle-CssClass="blackfnt" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtrate" runat="server" BorderStyle="Groove" Style="text-align: right;"
                                                ...
                                                onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" MaxLength="12"
                    ...
                    <asp:TableRow BackColor="White">
                        <asp:TableCell ColumnSpan="2">
                            <asp:GridView HorizontalAlign="center" ID="grvloadingftl" runat="server" BorderWidth="0"
                                CellSpacing="1" AllowSorting="true" PagerStyle-HorizontalAlign="left" CssClass="boxbg"
                                HeaderStyle-CssClass="bgbluegrey" FooterStyle-CssClass="<%=boxbg%>"
                                PagerSettings-Mode="NumericFirstLast" AutoGenerateColumns="false" OnRowDataBound="grvloadingftl_RowDataBound"
                                EmptyDataText="No Records Found..." Style="width: 100%;">
                                <Columns>
