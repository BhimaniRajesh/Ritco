...
public partial class EditCCMStep3ASSC : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //              RETRIEVING DATA
            ////////////////////////////////////////////////////////////////////////
            string strsqlcmb = "SELECT TOP 1 rate_type FROM webx_custcontract_locdet WHERE contractid='" + contractid + "'";
            ...
            {
                strsqlcmb = "SELECT TOP 1 rate_type FROM webx_custcontract_regdet WHERE contractid='" + contractid + "'";
                cmd = new SqlCommand(strsqlcmb, con);
                cmbselval = Convert.ToString(cmd.ExecuteScalar());
            }
            ...
            if (cmbselval.CompareTo("") == 0)
            {
                strsqlcmb = "SELECT TOP 1 rate_type FROM webx_custcontract_citydet WHERE contractid='" + contractid + "'";
                cmd = new SqlCommand(strsqlcmb, con);
                cmbselval = Convert.ToString(cmd.ExecuteScalar());
            }
            ...
            string strretrieve = "SELECT rate_type,fromlocode,tolocode,air_rate,air_days,road_rate,road_days,train_rate,train_days,express_rate,express_days FROM webx_custcontract_locdet WHERE contractid='" + contractid + "'";
            ...
            strretrieve = "SELECT fromcity,tocity,air_rate,air_days,road_rate,road_days,train_rate,train_days,express_rate,express_days FROM webx_custcontract_citydet WHERE contractid='" + contractid + "'";
            cmd = new SqlCommand(strretrieve, con);
            da = new SqlDataAdapter(cmd);
    ...
    protected void btnsubmit_Click(object sender,EventArgs e)
    {
        ...
        try
        {
            ...
            string strdel = "DELETE FROM webx_custcontract_locdet WHERE contractid='" + contractid + "'";
            cmd = new SqlCommand(strdel, con,sqltrn);
            cmd.ExecuteNonQuery();

            strdel = "DELETE FROM webx_custcontract_regdet WHERE contractid='" + contractid + "'";
            cmd = new SqlCommand(strdel, con,sqltrn);
            cmd.ExecuteNonQuery();

            strdel = "DELETE FROM webx_custcontract_citydet WHERE contractid='" + contractid + "'";
            cmd = new SqlCommand(strdel, con,sqltrn);
            cmd.ExecuteNonQuery();
