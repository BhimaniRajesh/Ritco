                                    ...
                                    <asp:TableRow>
                                        <asp:TableCell VerticalAlign="top">
                                            <asp:Table border="0" runat="server" Width="100%" CellSpacing="1" HorizontalAlign="center"
                                                ...
                                                <asp:TableRow ID="trcombus" runat="server" Style="background-color: White; display: none;">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="center" Style="width: 100%">
                    ...
                    <asp:GridView ID="grvcharges" runat="server" HorizontalAlign="Center" BorderWidth="0"
                        CellSpacing="1" AllowSorting="true" PagerStyle-HorizontalAlign="left" Width="70%"
