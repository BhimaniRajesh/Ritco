<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="CCMStep1.aspx.cs" Inherits="GUI_Admin_CustomerContractMaster_CCMStep1"
...
{
      var winOpts="toolbar=no,location=no,directories=no,status=no,titlebar=no,menubar=no,scrollbars=yes,resizable=no,width="+500+",height="+400+"";
      var url="";
    ...
    <script language="javascript" type="text/javascript">
        ...
        {   
            ...
            var mContractDate = document.getElementById("ctl00_MyCPH1_txtcontractdate").value.substring(6, 10) + "-" + document.getElementById("ctl00_MyCPH1_txtcontractdate").value.substring(3, 5) + "-" + document.getElementById("ctl00_MyCPH1_txtcontractdate").value.substring(0, 2)
            ...
            var mContractValidUntil = document.getElementById("ctl00_MyCPH1_txtValidUntil").value.substring(6, 10) + "-" + document.getElementById("ctl00_MyCPH1_txtValidUntil").value.substring(3, 5) + "-" + document.getElementById("ctl00_MyCPH1_txtValidUntil").value.substring(0, 2)
            ...
            var mEffectiveFrom = document.getElementById("ctl00_MyCPH1_txtEffFromDate").value.substring(6, 10) + "-" + document.getElementById("ctl00_MyCPH1_txtEffFromDate").value.substring(3, 5) + "-" + document.getElementById("ctl00_MyCPH1_txtEffFromDate").value.substring(0, 2)
                        ...
                        <asp:TableRow Style="background-color: White" runat="server">
                            ...
                            <asp:TableCell HorizontalAlign="left" VerticalAlign="top">
                                ...
                                <input type="button" value="..." class="blackfnt" runat="server" id="btnContractSigningLocation"
                                    onclick="javascript:return windowPopUp('branch','ctl00_MyCPH1_txtcontractsigninglocation','none')" />
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow Style="background-color: White" runat="server">
                            <asp:TableCell Style="width: 25%;" VerticalAlign="top" HorizontalAlign="left">
                        ...
                        <asp:TableRow Style="background-color: White" runat="server">
                            ...
                            <asp:TableCell Style="width: 25%;" VerticalAlign="top" HorizontalAlign="left" >
                                <asp:TextBox ID="txtcustphone" Style="border-style: groove;" runat="server" CssClass="blackfnt"
                                    Width="120px" MaxLength="50" onkeypress="javascript:return validInt(event)" onblur="javascript:this.value=this.value.toUpperCase();"></asp:TextBox>
                            </asp:TableCell>
