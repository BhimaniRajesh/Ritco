...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function submitValidation() {
            ...
            var hdnchargecode = document.getElementById("ctl00_MyCPH1_hdnchargecode");
            ...
            for (var i = 2; i <= len; i++) {
                ...
                var ddlPkgTyp = document.getElementById(pref + "ddlPkgTyp");
                var ddlratetype = document.getElementById(pref + "ddlratetype");
                ...
                if (chkyes.checked == true) {
                    ...
                    for (var j = 2; j < len; j++) {
                        ...
                        var ddlPkgTypj = document.getElementById(jref + "ddlPkgTyp");
                        ...
                        if (chkjyes.checked == true) {
                            ...
                            if (i != j) {
                                ...
                                if (txtto.value == txtjto.value && txtfrom.value == txtjfrom.value) {
                                    var msg = "No Two pair should be same. Please Enter Another Location"
                                    if (hdnchargecode.value == "SCHG17") {
                                        if (ddlPkgTyp.value == ddlPkgTypj.value || ddlPkgTyp.value == "" || ddlPkgTypj.value == "") {
                                        ...
                                        <asp:GridView HorizontalAlign="left" ID="grvcharges" runat="server" BorderWidth="0"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemStyle CssClass="blackfnt" BackColor="White" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlPkgTyp" runat="server" CssClass="blackfnt" BackColor="white">
                                                            <asp:ListItem Value="" Text="All"></asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:HiddenField ID="hdnPkgTyp" runat="server" Value='<%# DataBinder.Eval( Container.DataItem,"PKGTYP") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
