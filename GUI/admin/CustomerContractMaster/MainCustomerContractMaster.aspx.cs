...
public partial class MainCustomerContractMaster : System.Web.UI.Page
{
    ...
    protected void btnnext_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("ContractEditList.aspx?custcode=" + cmbeditcustomer.SelectedValue +"&Flag=View");
        }
        else
        {
            Response.Redirect("ContractEditList.aspx?custcode=" + cmbeditcustomer.SelectedValue + "&Flag=");
        }
    }
}
