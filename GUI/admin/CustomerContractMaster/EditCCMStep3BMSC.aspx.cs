    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       if (strtrnmodes.IndexOf('R') == -1)
        ...
        if (!IsPostBack)
        {
            ...
            /// FILLING UPPER SLAB TYPES
            sqlval = "SELECT slab_code,matrix_type FROM webx_custcontract_frtmatrix_slabhdr WHERE contractid='" + contractid + "'";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
                if (Convert.ToString(dr["slab_code"]).CompareTo("SLAB1") == 0)
                {
                    try
                    {
                ...
                if (Convert.ToString(dr["slab_code"]).CompareTo("SLAB2") == 0)
                {
                    try
                    {
                ...
                if (Convert.ToString(dr["slab_code"]).CompareTo("SLAB3") == 0)
                {
                    try
                    {
                ...
                if (Convert.ToString(dr["slab_code"]).CompareTo("SLAB4") == 0)
                {
                    try
                    {
                ...
                if (Convert.ToString(dr["slab_code"]).CompareTo("SLAB5") == 0)
                {
                    try
                    {
                ...
                if (Convert.ToString(dr["slab_code"]).CompareTo("SLAB6") == 0)
                {
                    try
                    {
            ...
            dr.Close();
            // FINLLING UPPER SLAB TYPES - ENDS HERE




            // HEADER SLAB FILLING 
            sqlval = "SELECT slab_code,slab_from,slab_to FROM WEBX_CUSTCONTRACT_FRTMATRIX_SLABHDR WHERE contractid='" + contractid + "'";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='L'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='L'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='AIR' AND loc_reg='L'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='TRAIN' AND loc_reg='L'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT from_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=from_loccode or codedesc=from_loccode )),to_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=to_loccode or codedesc=to_loccode )),* FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='R'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT from_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=from_loccode or codedesc=from_loccode )),to_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=to_loccode or codedesc=to_loccode )),* FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='R'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT from_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=from_loccode or codedesc=from_loccode )),to_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=to_loccode or codedesc=to_loccode )),* FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='AIR' AND loc_reg='R'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT (select codedesc from webx_master_general where codetype='zone' and ( codeid=from_loccode or codedesc=from_loccode )),to_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=to_loccode or codedesc=to_loccode )),* FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='TRAIN' AND loc_reg='R'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='C'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='C'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='AIR' AND loc_reg='C'";
            cmd = new SqlCommand(sqlval, con);
            ...
            sqlval = "SELECT * FROM webx_custcontract_frtmatrix_slabdet WHERE contractid='" + contractid + "' AND UPPER(trans_type)='TRAIN' AND loc_reg='C'";
            cmd = new SqlCommand(sqlval, con);
    ...
    *=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*/
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strupdate = "DELETE FROM WEBX_CUSTCONTRACT_FRTMATRIX_SLABHDR WHERE contractid = '" + contractid + "'";
            ...
            if (txtFromSlab6.Text.CompareTo("") == 0)
                txtFromSlab6.Text = "0";
            if (txtToSlab6.Text.CompareTo("") == 0)
                txtToSlab6.Text = "0";
            ...
            sqlinsert = sqlinsert + "'" + cmbratetype1.SelectedValue + "',";
            ...
            sqlinsert = sqlinsert + "'" + contractid + "',";
            sqlinsert = sqlinsert + "'" + custcode + "',";
            sqlinsert = sqlinsert + "'" + cmbratetype2.SelectedValue + "',";
            ...
            sqlinsert = sqlinsert + "'" + contractid + "',";
            sqlinsert = sqlinsert + "'" + custcode + "',";
            sqlinsert = sqlinsert + "'" + cmbratetype3.SelectedValue + "',";
            ...
            sqlinsert = sqlinsert + "'" + contractid + "',";
            sqlinsert = sqlinsert + "'" + custcode + "',";
            sqlinsert = sqlinsert + "'" + cmbratetype4.SelectedValue + "',";
            ...
            sqlinsert = sqlinsert + "'" + contractid + "',";
            sqlinsert = sqlinsert + "'" + custcode + "',";
            sqlinsert = sqlinsert + "'" + cmbratetype5.SelectedValue + "',";
            ...
            sqlinsert = sqlinsert + "'" + contractid + "',";
            sqlinsert = sqlinsert + "'" + custcode + "',";
            sqlinsert = sqlinsert + "'" + cmbratetype6.SelectedValue + "',";
        ...
        sqltran.Commit();
            ...
            Response.Redirect("CCM_DisplayResult.aspx?contractid=" + contractid + "&CCMMode=E" + "&custcode=" + custcode);
    }
    ...
    private void insertGrid(GridView grv, string trnmod, string matmode)
    {
        ...
        foreach (GridViewRow grvrow in grv.Rows)
        {
            ...
            if (chk.Checked == true)
            {
                ...
                strgridinsert = strgridinsert + "(contractid, Custcode, from_loccode, to_loccode, trdays, Slab1, Slab2, Slab3, Slab4, Slab5, Slab6, ";
