<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="UnLoadingFTLCharges.aspx.cs" Inherits="GUI_admin_CustomerContractMaster_UnLoadingFTL" %>
                        ...
                        <ContentTemplate>
                            <asp:Table runat="server" Width="100%" CssClass="boxbg" CellSpacing="1" CellPadding="0">
                                <asp:TableRow CssClass="bgbluegrey">
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2" Font-Bold="true">UnLoading Charges FTL - Branch</asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow BackColor="White">
                ...
                <asp:TableCell>
                    ...
                    <asp:UpdatePanel ID="upd2" runat="server">
                        <ContentTemplate>
                            <asp:Table runat="server" Width="100%" CssClass="boxbg" CellSpacing="1" CellPadding="0">
                                <asp:TableRow CssClass="bgbluegrey">
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2" Font-Bold="true">UnLoading Charges FTL - City</asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow BackColor="White">
                                    <asp:TableCell HorizontalAlign="Right" Width="50%">
                    No of Rows :                
