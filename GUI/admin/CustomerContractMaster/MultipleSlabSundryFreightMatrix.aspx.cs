    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            foreach (GridViewRow grv in grvcharges.Rows)
            {
                ...
                strsql = strsql + " AND basedon1='" + hdnbasedon1.Value + "' AND basecode1='" + hdnbasecode1.Value + "'";
                strsql = strsql + " AND basedon2='" + hdnbasedon2.Value + "' AND basecode2='" + hdnbasecode2.Value + "'";
                strsql = strsql + " AND from_loccode='" + txtfrom.Text + "' AND to_loccode='" + txtto.Text.Trim() + "'";
                strsql = strsql + " AND (trans_type='" + hdntransmode.Value + "' OR trans_type='" + hdntransname.Value + "')";
                strsql = strsql + " AND loc_reg='" + hdnmatrixtype.Value + "'";
                ...
                if (chk.Checked == true)
                {
                    ...
                    strsql = strsql + "from_loccode,to_loccode,trdays,slab1,slab2,slab3,slab4,slab5,slab6,";
                    strsql = strsql + "loc_reg,trans_type)";
