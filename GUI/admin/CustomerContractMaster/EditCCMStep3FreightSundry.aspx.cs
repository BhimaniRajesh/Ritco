...
public partial class EditCCMStep3FreightSundry : System.Web.UI.Page
{
    ...
    private void updateSlabInfo(string flag)
    {
        ...
        if (flag.CompareTo("M") == 0)
            str = "UPDATE webx_custcontract_hdr SET multiple_slab_yn = 'Y',single_slab_yn='N' WHERE contractid='" + contractid + "'";
        else
            str = "UPDATE webx_custcontract_hdr SET multiple_slab_yn = 'N',single_slab_yn='Y' WHERE contractid='" + contractid + "'";
