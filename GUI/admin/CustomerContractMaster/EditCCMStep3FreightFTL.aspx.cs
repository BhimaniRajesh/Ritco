...
public partial class GUI_admin_CustomerContractMaster_EditCCMStep3FreightFTL : System.Web.UI.Page
{
    ...
    static string oda = "", ftl = "", slabtype = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        strtrnmodes = "";
        sqlval = "SELECT  road_yn,express_yn,air_yn,rail_yn,sundry_yn,ftl_yn FROM webx_custcontract_charge WHERE contractid='" + contractid + "'";
        cmd = new SqlCommand(sqlval, con);
        dr = cmd.ExecuteReader();
        while (dr.Read())
        {
        ...
        if (!IsPostBack)
        {
            ...
            sqlval = "SELECT  DISTINCT from_loccode,to_loccode,ftltype,srno FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='L' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            if (dr.Read())
            ...
            string s = "";
            sqlval = "SELECT from_loccode,to_loccode,FTL1_TRIP_RATE,FTL1_TRDAYS FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE  contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='L' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            int cnt = 0;
            while (dr.Read())
            ...
            sqlval = "SELECT  DISTINCT from_loccode,to_loccode,ftltype,srno FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE  contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='C' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            if (dr.Read())
            ...
            s = "";
            sqlval = "SELECT from_loccode,to_loccode,FTL1_TRIP_RATE,FTL1_TRDAYS FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE  contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='C' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            cnt = 0;
            while (dr.Read())
            ...
            sqlval = "SELECT  DISTINCT from_loccode,to_loccode,ftltype,srno FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE  contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='R' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            if (dr.Read())
            ...
            arrrow = new string[12];
            s = "";
            sqlval = "SELECT from_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=from_loccode or codedesc=from_loccode )),to_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=to_loccode or codedesc=to_loccode )),FTL1_TRIP_RATE,FTL1_TRDAYS FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE  contractid='" + contractid + "' AND UPPER(trans_type)='ROAD' AND loc_reg='R' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            cnt = 0;
            while (dr.Read())
            ...
            sqlval = "SELECT  DISTINCT from_loccode,to_loccode,ftltype,srno FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='L' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            if (dr.Read())
            ...
            arrrow = new string[12];
            s = "";
            sqlval = "SELECT from_loccode,to_loccode,FTL1_TRIP_RATE,FTL1_TRDAYS FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='L' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            cnt = 0;
            while (dr.Read())
            ...
            sqlval = "SELECT  DISTINCT from_loccode,to_loccode,ftltype,srno FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='C' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            if (dr.Read())
            ...
            arrrow = new string[12];
            s = "";
            sqlval = "SELECT from_loccode,to_loccode,FTL1_TRIP_RATE,FTL1_TRDAYS FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='C' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            cnt = 0;
            while (dr.Read())
            ...
            sqlval = "SELECT  DISTINCT ftltype,srno FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='R' ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            if (dr.Read())
            ...
            arrrow = new string[12];
            s = "";
            sqlval = "SELECT from_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=from_loccode or codedesc=from_loccode )),to_loccode=(select codedesc from webx_master_general where codetype='zone' and ( codeid=to_loccode or codedesc=to_loccode )),FTL1_TRIP_RATE,FTL1_TRDAYS FROM webx_custcontract_frtmatrix_ftlslabhdr WHERE contractid='" + contractid + "' AND UPPER(trans_type)='EXPRESS' AND loc_reg='R'  ORDER BY srno";
            cmd = new SqlCommand(sqlval, con);
            dr = cmd.ExecuteReader();
            cnt = 0;
            while (dr.Read())
