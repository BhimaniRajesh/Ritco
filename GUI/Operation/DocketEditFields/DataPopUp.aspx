<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataPopUp.aspx.cs" Inherits="GUI_Operation_DocketEditFields_DataPopUp" %>
...
<script language="javascript" type="text/javascript">
  ...
  function selectItem(poptp,code1,code2)
  {
        ...
        {
            window.opener.document.getElementById(document.getElementById("hdnCode1").value).value=code1;
            window.opener.document.getElementById(document.getElementById("hdnCode2").value).value=code2;
            window.close();
        }
...
<body>
    ...
    <br /><br />
        <asp:Table CellSpacing="1" ID="tblmain" runat="server" CssClass="boxbg" style="width:470px">
            <asp:TableRow CssClass="bgbluegrey">
                <asp:TableCell ID="td1" CssClass="blackfnt" runat="server">Select</asp:TableCell>
                <asp:TableCell ID="td2" CssClass="blackfnt" runat="server"></asp:TableCell>
                <asp:TableCell ID="td3" CssClass="blackfnt" runat="server"></asp:TableCell>
            </asp:TableRow>        
        </asp:Table>
    </form>
</body>
