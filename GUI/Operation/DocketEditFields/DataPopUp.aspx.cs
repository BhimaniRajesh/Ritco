...
public partial class GUI_Operation_DocketEditFields_DataPopUp : System.Web.UI.Page
{
    string poptp = "";
    public static string code1 = "", code2 = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        hdnCode1.Value = Request.QueryString["code1"].ToString();
        hdnCode2.Value = Request.QueryString["code2"].ToString();
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            sqlstr = "SELECT DISTINCT loccode FROM webx_location WHERE loccode like '" + txt1.Text.Trim() + "%' AND loccode IS NOT NULL AND activeflag='Y' ORDER BY loccode";
        }
