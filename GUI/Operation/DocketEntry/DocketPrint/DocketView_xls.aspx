...
***************************************************************************************************************--%>
		...
		<asp:TableRow CssClass="bgwhite">
                <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">Edited By </asp:TableCell>
                <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">
                    <asp:Label ID="lblEditedby" runat="server"></asp:Label>
                </asp:TableCell>
                <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">Edited Date </asp:TableCell>
                <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">
                    <asp:Label ID="lblEditeddate" runat="server"></asp:Label>
                </asp:TableCell>
                <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left"> </asp:TableCell>
                <asp:TableCell CssClass="blackfnt" HorizontalAlign="Left">
...
***************************************************************************************************************--%>
        ...
        <asp:Table ID="tblinvoice" runat="server" CellSpacing="1" CssClass="boxbg" Style="width: 100%;
            display: none;">
            <asp:TableRow CssClass="bgbluegrey">
