...
public partial class GUI_Operation_DocketEntry_Docket : System.Web.UI.Page
{
    ...
    private void CalculateTotal()
    {
        ...
        //    + WebXConvert.ToDouble(txtSBCess.Text);
        ///* SB Cess */
    ...
    protected void GetOtherCharges(string basedon1, string basecode1, string basedon2, string basecode2, DataTable dtcharges)
    {
        ...
        foreach (GridViewRow grvchrg in grvcharges.Rows)
        {
            ...
            //string[] _param_othercharge_req = new string[17];
            ...
            //_param_othercharge_req[14] = hdntotdeclval.Value;
            //_param_othercharge_req[15] = txtfreightcharge.Text;
            //_param_othercharge_req[16] = cmbpacktype.SelectedValue;
    ...
    protected MR GetMRObject(Docket docket)
    {
        ...
        mr.DockSF = ".";
        mr.EduCess = ucServiceTax.EducationCess;
        mr.EduCessRate = ucServiceTax.EducationCessRate;
        mr.EDD = docket.EDD;
        mr.EntryBy = hdnemployee.Value;
        mr.EntryDate = docket.EntryDate;
        mr.FlagReBook = "N";
        mr.Freight = DocketController.ToDouble(txtfreightcharge.Text);
        mr.HEduCess = ucServiceTax.HigherEducationCess;
        mr.HEduCessRate = ucServiceTax.HigherEducationCessRate;
        mr.MRAmount = Math.Round(ucServiceTax.GrandTotal);
        ...
        mr.ServiceTax = ucServiceTax.ServiceTax;
        mr.STaxRate = ucServiceTax.ServiceTaxRate;
    ...
    protected DocketCharges GetChargesObject()
    {
        ...
        if (subtotal != ucServiceTax.SubTotal)
        {
