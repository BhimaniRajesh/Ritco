    ...
    <script language="javascript" type="text/javascript">
        ...
        function selectItem(poptp, code1, code2) {
            if (poptp == "csgn") {
                ...
                window.opener.document.getElementById("ctl00_MyCPH1_txtto").focus();
                window.close();
            }
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <div id="divupgstep3" runat="server" style="left: 400px; position: absolute; elevation: higher; background-color: White">
