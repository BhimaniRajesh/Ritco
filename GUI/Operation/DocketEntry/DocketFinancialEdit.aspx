...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MyCPH1">
    ...
    <script type="text/javascript" language="javascript" src="DocketScripts.js?03Jun2015"></script>

    <script language="JavaScript" type="text/javascript" src="DocketFinancialEdit.js?04Jan2014"></script>
    <script src="../../Common_UserControls/Js/ServiceTax.js?V2"></script>
