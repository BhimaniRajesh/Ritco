...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MyCPH1">
    ...
    <script type="text/javascript" language="javascript" src="DocketScripts.js?16dec2013"></script>

    <script language="JavaScript" type="text/javascript" src="DocketEntry.js?16dec2013"></script>
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>
                                        ...
                                        Customer Ref.</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="txtcustrefno" TabIndex="12" runat="server" MaxLength="20" Width="80px"
