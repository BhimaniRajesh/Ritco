...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MyCPH1">
    ...
    <script language="JavaScript" type="text/javascript" src="DocketEntry.js"></script>
                        ...
                        <div id="divstep1" runat="server" style="width: 10in;">
                            ...
                            <font class="redfnt"><b>*</b></font>Delivery Location</asp:TableCell>
                                    <asp:TableCell CssClass="blackfnt">
                                        ...
                                        <asp:TextBox ID="txtdelloc" runat="server" BorderStyle="groove" Width="40px" MaxLength="8"
                                        ...
                                        <ajaxToolkit:AutoCompleteExtender ID="acedelloc" runat="server"
                                            Enabled="True" MinimumPrefixLength="1" ServiceMethod="GetDeliveryLocation" CompletionListItemCssClass="autocomplete_listItem"
                            ...
                            <font class="redfnt"><b>*</b></font>Said to Contain</asp:TableCell>
                                    <asp:TableCell>
                                        <asp:DropDownList ID="cmbprodtype" DataTextField="codedesc" DataValueField="codeid"
                                        ...
                                        Policy No. and Date</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="txtpolicyno" runat="server" MaxLength="10" Width="80px" BorderStyle="Groove"
                                                        TabIndex="3" onkeypress="javascript:return withoutQuote(event)" CssClass="blackfnt"></asp:TextBox>
                                                    <asp:TextBox ID="txtpolicydate" runat="server" onblur="javascript:return alertInvalidDate('policy')"
                                                        TabIndex="3" MaxLength="10" Width="70px" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                                                    ...
                                                    <ItemTemplate>
                                                        <center>
                                                            <asp:TextBox ID="txtinvoicedate" runat="server" MaxLength="10" CssClass="blackfnt"
                                                                onblur="javascript:return validateInvoiceDate(this.getAttribute('id'))" TabIndex="4"
