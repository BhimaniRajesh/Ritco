...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MyCPH1">
    ...
    <script type="text/javascript" language="javascript" src="DocketScripts.js?22Nov2013"></script>

    <script language="JavaScript" type="text/javascript" src="DocketFinancialEdit.js"></script>
