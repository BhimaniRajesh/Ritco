...
public partial class GUI_Operation_Singlescreen_docketentry_popup_cust_csgn : System.Web.UI.Page
{
    String strSQL = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        function SelectCustomer(obj)
            ...
            window.opener.update11(Cust_code,Cust_name);
            window.close();
            }
            </script>;";
    ...
    protected void btnSubmit_OnClick(object sender, EventArgs e)
    {
        ...
        strSQL = "SELECT  distinct CUSTCD,CUSTNM  FROM webx_CUSTHDR  where CUSTCD is not null " + loccls + destcls + " and    PATINDEx ('%" + Session["brcd"].ToString() + "%',custloc)>0 order by CUSTNM";
