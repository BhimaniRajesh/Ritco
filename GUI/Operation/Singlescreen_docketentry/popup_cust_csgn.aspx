<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup_cust_csgn.aspx.cs" Inherits="GUI_Operation_Singlescreen_docketentry_popup_cust_csgn" %>
            ...
            <table border="1" width="100%" cellspacing="1" class="boxbg">
                <tr class="bgbluegrey">
                    ...
                    <td style="width: 30%" align="left">
                        &nbsp;<label id="lblCustCodeColHeader" class="blackfnt">Consignor Code
                        </label>
                    </td>
                    <td align="left">
                        &nbsp;
