                                ...
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:TextBox ID="txtdeladdr" ReadOnly="true" runat="server" CssClass="print_sml"
                                            ...
                                            BorderStyle="NONE" TextMode="MultiLine" Style="overflow: hidden;"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </asp:TableCell>
                                ...
                                <asp:TableRow>
                                    <asp:TableCell Width="400px" Style="vertical-align: bottom;" ColumnSpan="5" VerticalAlign="Bottom">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblprivatemark" Text='<%# DataBinder.Eval(Container.DataItem,"privatemark") %>'
                                            runat="server" CssClass="print_sml"></asp:Label> <br /><br /><br />
                                    </asp:TableCell>
                            ...
                            <asp:Table runat="server" ID="Table8" Height="100%" Width="100%">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell Style="width: 240px;" VerticalAlign="Bottom">
                                        <asp:Label ID="lblremarks" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"spl_svc_req") %>' CssClass="print_sml"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell Style="width: 55px;"></asp:TableCell>
                                    <asp:TableCell Style="width: 50px;"></asp:TableCell> 
                                    <asp:TableCell Wrap="true" HorizontalAlign="Right" CssClass="printfnt" Font-Bold="true" Style="width: 145px;"><asp:Label ID="lbldupcop1" Visible="false" runat="server">DUPLICATE</asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell Wrap="true" HorizontalAlign="Left" CssClass="printfnt"  Font-Bold="true" Style="width: 45px;"><asp:Label ID="lbldupcop2" Visible="false" runat="server">COPY</asp:Label></asp:TableCell>
                                    <asp:TableCell Wrap="true" HorizontalAlign="Right" Style="width: 90px;">
                                    </asp:TableCell>
                                    <asp:TableCell><asp:Label ID="lblprintby" runat="server"></asp:Label></asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </asp:TableCell>
                    </asp:TableRow>
