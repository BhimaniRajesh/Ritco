...
<head id="Head1" runat="server">
    <title>MR View/Print</title>
    <link href="../../../../../GUI/images/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <% string NewMR = Request.QueryString["mrsno"];
       string[] Split = NewMR.Split(new Char[] { ',' });
        NewMR = Convert.ToString(Split[0]);
      ...
      %>
        <div>
            <table '<%=strborder %>' cellpadding="1" cellspacing="1" class='<%=boxbg%>' colspan="2"
                width="100%">
                <tr bgcolor="#ffffff">
                    <td align="left" rowspan="4" style="width: 62%">
                        <asp:Image ID="imgLogo" Height="50" runat="server"/><br />
                        <br />
                ...
                <tr bgcolor="#ffffff" style="font-weight: bold; font-size: 8pt; font-family: Verdana">
                    ...
                    <td align="left" style="width: 210px">
                        <font class="blackfnt">&nbsp;<asp:Label ID="lblManualNo" runat="server" CssClass="blackfnt"></asp:Label></font></td>
                </tr>
                <tr bgcolor="#ffffff">
                    <td align="left" style="width: 16%">
            ...
            <br />
            <table '<%=strborder %>' cellpadding="2" cellspacing="1" width="100%" class='<%=boxbg%>'>
                <tr bgcolor="#ffffff">
                    <td align="left" style="height: 39px">
                        <font class="blackfnt"><b><span>To<br />
                            <asp:Label ID="lblAdd" runat="server" CssClass="blackfnt" Height="57px" Width="180px"></asp:Label></span></b>
                            </font></td>
                </tr>
            </table>
            <table '<%=strborder %>' cellpadding="2" cellspacing="1" width="100%" class='<%=boxbg%>'>
                <tr bgcolor="#ffffff">
                    <td align="left" style="height: 39px">
                            ...
                            <asp:Label ID="partyas" runat="server" CssClass="blackfnt" Height="57px" Width="180px"></asp:Label></td>
                     <td align="left" style="height: 39px">
                       
                            <asp:Label ID="pasrtyas_code_name" runat="server" CssClass="blackfnt" Height="57px" Width="180px"></asp:Label></td>
        ...
        <table '<%=strborder %>' cellpadding="2" cellspacing="1" width="100%" class='<%=boxbg%>'>
            <tr bgcolor="#ffffff">
                <td align="left" style="height: 39px">
                    <font class="blackfnt"><b><span style="vertical-align: top">&nbsp;Remarks : <%=Remark%></span></b></font></td>
            </tr>
        </table>
        <br />
        <table '<%=strborder %>' cellpadding="2" cellspacing="1" width="100%" class='<%=boxbg%>'
