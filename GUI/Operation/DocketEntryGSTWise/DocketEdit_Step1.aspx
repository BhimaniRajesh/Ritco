...
<script language ="JavaScript" type="text/javascript">
	...
	{
	    window.open("DataPopUp.aspx?poptp=editsearchparty&code1=ctl00_MyCPH1_txtpartycode&code2=ctl00_MyCPH1_txtpartyname&tbl=none",null,'left=300, top=150, height=300, width= 300, status=n o, resizable= no, scrollbars= yes, toolbar= no,location= no, menubar= no');
	    return false;
	}
</script>
    ...
    <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" width="100%">
          ...
          <tr style="background-color: white">
            <td align="left" valign="top" style="width: 146px">
                <asp:RadioButton ID="optdate" Checked="false" Enabled="false" GroupName="grprad" runat="server" />
          ...
          <tr style="background-color: white">
            ...
            <asp:RadioButton ID="optdockno" Checked="true" Enabled="true" GroupName="grprad" runat="server" />
