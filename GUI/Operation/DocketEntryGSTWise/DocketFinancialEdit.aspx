<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="DocketFinancialEdit.aspx.cs" Inherits="GUI_Operation_DocketEntry_DocketFinacialEdit" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MyCPH1">
    ...
    <script type="text/javascript" language="javascript" src="DocketScripts.js?03Jun2016"></script>

    <script language="JavaScript" type="text/javascript" src="DocketFinancialEdit.js?04Jan2015"></script>
    <script type="text/javascript" src="<%= ResolveUrl("~/GUI/Common_UserControls/Js/jsGSTTaxCalculation.js?1006") %>"></script>
                        ...
                        <asp:Table runat="server" ID="tbladf">
                            ...
                            <font class="redfnt"><b>*</b></font>Delivery Location</asp:TableCell>
                                            ...
                                            <asp:TableRow CssClass="bgwhite" ID="trbtnstep1" runat="server">
                                                <asp:TableCell VerticalAlign="Top" HorizontalAlign="Right" ColumnSpan="5">
                        ...
                        <div id="divcharges" runat="server" style="width: 10in; display: none;">
                            ...
                            EDD</asp:TableCell>
                                ...
                                <asp:TableRow CssClass="bgwhite">
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox ID="txtbilledat" style="display:none;" runat="server" CssClass="blackfnt" BorderStyle="Groove"
                                            onblur="javascript:return locTest(this.getAttribute('id'),'billloc');" MaxLength="5"
                                            Width="50px">
                                        </asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow ID="trfov" runat="server" CssClass="bgwhite" Style="display: none">
                                    <asp:TableCell>
                            FOV Rate(%)
                                    </asp:TableCell>
                                    <asp:TableCell>
                            ...
                            DACC To be Collected
                                ...
                                <asp:TableRow CssClass="bgwhite">
                                    <asp:TableCell ColumnSpan="6">
                                        <%-- Remove Tax Control and add GST Control here --%>
...
------------------------------------------------------------------------------------------------------%>
            ...
            ******************************************************************************************--%>
            ...
            <asp:HiddenField ID="hdncsgncd" runat="server" />
            <asp:HiddenField ID="hdncsgnnm" runat="server" />
            <asp:HiddenField ID="hdncsgecd" runat="server" />
            <asp:HiddenField ID="hdncsgenm" runat="server" />
            <asp:HiddenField  ID="hdnDocketGSTBillingStateCode" runat="server"/>
            <asp:HiddenField  ID="hdnDocketPlaceOfSupply" runat="server"/>
            <asp:HiddenField  ID="hdnDocketGSTExempted" runat="server"/>
            <asp:HiddenField  ID="hdnDocketGSTExemptionCategory" runat="server"/>
            <asp:HiddenField  ID="hdnDocketGSTSacCode" runat="server"/>
            <%--**************************************************************************************--%>
