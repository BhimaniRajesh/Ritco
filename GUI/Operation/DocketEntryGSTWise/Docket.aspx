...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MyCPH1">
    ...
    <script type="text/javascript" language="javascript" src="DocketScripts.js?V3"></script>

    <script language="JavaScript" type="text/javascript" src="DocketEntry.js?V2"></script>
    <script type="text/javascript" src="<%= ResolveUrl("~/GUI/Common_UserControls/Js/jsGSTTaxCalculation.js?1005") %>"></script>
...
function BackDateValidation() {
        ...
        var joo = true;
        if (MyDateCompareV1(hdnserverdate.value, txtdockdate.value) > 0) joo = false;

        if (!joo) {
            alert("Docket Date cannot be greater than Sys. Date:" + hdnserverdate.value);
            txtdockdate.value = hdnserverdate.value;
            txtdockdate.focus();
            return false;
        }


        if (MyDateCompareV1(txtdockdate.value, hdnserverdate.value) > 2) {
            alert("Only 2 Back Days allowed in Docket Date !!");
            txtdockdate.value = hdnserverdate.value;
            txtdockdate.focus();
            return false;
        }
                            ...
                            Date</asp:TableCell>
                                    <asp:TableCell Style="width: 220px;">
                                        <asp:TextBox ID="txtdockdate" runat="server" Width="70px" MaxLength="10" CssClass="blackfnt"
                                            BorderStyle="Groove" onblur="javascript:return BackDateValidation();">
                                        </asp:TextBox>
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>
                                        ...
                                        Customer Ref.</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="txtcustrefno" TabIndex="12" runat="server" MaxLength="100" Width="80px" onblur="setCustomerRefNo()"
                                    ...
                                    Internal Covers</asp:TableCell>
                                        ...
                                        Private Mark</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="txtprivatemark" runat="server" TabIndex="13" MaxLength="100" Width="80px"
                                                        onkeypress="javascript:return withoutQuote(event)" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                                                </asp:TableCell>
                                            </asp:TableRow>
