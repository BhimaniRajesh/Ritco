<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="FrmCriteria.aspx.cs" Inherits="GUI_Finance_MoneyRecipt_Updatemr_step1" %>
                                        ...
                                        Select Criteria
                                            ...
                                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                                ...
                                                <td valign="top" align="left" style="width: 359px">
                                                    ...
                                                    <asp:CustomValidator ID="CustomValidator2" runat="server" OnServerValidate="abc"
                                                        ErrorMessage="To date can not be smaller than from date " Width="255px"></asp:CustomValidator>
                                                </td>
                                            </tr>
                                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                                <td align="left" class="blackfnt">MRs Type</td>
                                                <td colspan="2" align="left" class="blackfnt">
                                                    <asp:DropDownList ID="mrstype" runat="server">
                                                        ...
                                                        <asp:ListItem Value="2">Bill MR</asp:ListItem>
                                                        <asp:ListItem Value="3">Topay MR</asp:ListItem>
                                                        <asp:ListItem Value="6">Delivery MR</asp:ListItem>
                                                        <asp:ListItem Value="11">Delivery Bill MR</asp:ListItem>
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                                <td colspan="3" align="center" class="blackfnt">OR</td>
                                            </tr>
                                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                                <td align="left" valign="top">
                                                    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="MR NO." Width="145px"></asp:Label></td>
                                            ...
                                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                                <td align="left" style="height: 21px" valign="top">
                                                    <asp:Label ID="Label2" runat="server" CssClass="blackfnt" Text="Docket No." Width="145px"></asp:Label></td>
