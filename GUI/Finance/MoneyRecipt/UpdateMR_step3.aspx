...
//				if (dt != FinYear_todate1)
//				{
//						alert( "You Have Selected Wrong Finacial Year ")
//						document.getElementById(Frmnae+"TxtCBSDT").focus();
//						return false;
//				}
...
//																			}
																			...
																			if("<%=Session["Client"].ToString()%>"!="Ritco" &&"<%=Session["Client"].ToString()%>"!="RITCO_TEST")
																			{
   ...
   &gt; <font class="bluefnt"><strong>  
    ...
    <table   border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width:10in"  align="left">
       ...
       <tr bgcolor="white" style="height:25px; font-size: 12pt; font-family: Times New Roman;">
            ...
            <td style="width: 339px"><asp:TextBox ID="TxtCBSDT" runat="server"  Columns="10" MaxLength="10" Enabled="true"></asp:TextBox> 
             <%--<a href="#"  onclick="cal.select(ctl00$MyCPH1$TxtCBSDT,'anchor1','dd/MM/yyyy'); return false;"  name="anchor1" id="anchor1" >
