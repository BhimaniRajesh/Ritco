...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        {
        //MoneyRecipt/MR_Summ_Popup.aspx
               
                window.open(" ../../Finance/Billing_Ver1/Billcollection/MR_Summ_Popup.aspx?mrsno="+mrsno+"&type="+type+"&printyn="+printyn,"pbr","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=500,height=300,status=no,left=220,top=70");
//               }
//               else
//               {
...
//               }
            ...
            function OpenInWindow(MR_Number) {
                ...
                window.open("../Billing_Ver1/MRDotmatrixViewPrint.aspx?mrsno=" + MR_Number, "es", "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
                return false
            }
			function popupmenu2(mrsno) {
            var winOpts = "scrollbars=yes,resizable=yes,width=" + 700 + ",height=" + 400 + "";
            confirmWin = window.open('../Billing_Ver1/MRDotmatrixViewPrint_Freight0.aspx?mrsno=' + mrsno, "", winOpts);
			}
//        function OpenInWindow(MR_Number) 
//        { 
//            //debugger
            ...
            <td colspan="2">
                ...
                <asp:GridView ID="GV_Booking" runat="server" align="center" BorderWidth="1" Width="10in"
                    ...
                    <Columns>
                        ...
                        <%--<asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="Print" HeaderStyle-Font-Bold="true">
                        <HeaderStyle HorizontalAlign="center" Wrap="False" CssClass="blackfnt" />
                        <ItemStyle CssClass="blackfnt" BackColor="white" />
                        <ItemTemplate>
                            <a class="bluefnt"  href="JavaScript:nwOpen('<%#DataBinder.Eval(Container.DataItem, "mrsno") %>','<%#DataBinder.Eval(Container.DataItem, "mrstype") %>',1)">
                     ...
                     <asp:TemplateField HeaderText="View" HeaderStyle-Width="40">
                            <ItemTemplate>
                                <a href="JavaScript:nwOpen('<%#DataBinder.Eval(Container.DataItem, "mrsno") %>','<%#DataBinder.Eval(Container.DataItem, "mrstype") %>',0)">
                                    <font cssclass="Blackfnt">View</font> </a>
                            </ItemTemplate>
                            <HeaderStyle CssClass="blackfnt" />
                            <ItemStyle CssClass="blackfnt" BackColor="white" HorizontalAlign="Center" Wrap="false" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Print" HeaderStyle-Width="40">
                            <ItemTemplate>
                                <a href="JavaScript:nwOpen('<%#DataBinder.Eval(Container.DataItem, "mrsno") %>','<%#DataBinder.Eval(Container.DataItem, "mrstype") %>',1)">
                                    <font cssclass="Blackfnt">Print</font> </a>
                            </ItemTemplate>
                            <HeaderStyle CssClass="blackfnt" />
                            <ItemStyle CssClass="blackfnt" BackColor="white" HorizontalAlign="Center" Wrap="false" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MR Dotmatrix View Print" HeaderStyle-Font-Bold="true">
                            <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                            <ItemStyle CssClass="blackfnt" />
                            <ItemTemplate>
                                <label class="blackfnt">
						...
						<asp:TemplateField HeaderText="MR Tejas Print" HeaderStyle-Font-Bold="true">
                            <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                            <ItemStyle CssClass="blackfnt" />
                            <ItemTemplate>
                                <label class="blackfnt">
                                    <a href="JavaScript:popupmenu2('<%#DataBinder.Eval(Container.DataItem, "mrsno") %>')">
                                    <font cssclass="Blackfnt">Tejas Print</font> </a>
                                </label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
