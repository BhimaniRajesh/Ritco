<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="MR_Cancellation_2.aspx.cs" Inherits="GUI_UNI_MIS_Login_View_Login_2" %>
       ...
       function check_submit()
        {
            Frmnae="ctl00$MyCPH1$"
            var non=0
            if(document.getElementById(Frmnae+"txtdt").value=="")
            {
                            alert("Please enter the MR Cancel Date")
				              document.getElementById(Frmnae+"txtdt").focus();
				              return false;
            }
            
            if(document.getElementById(Frmnae+"txtreson").value=="")
            {
                            alert("Please enter the MR Cancel Reason")
				              document.getElementById(Frmnae+"txtreson").focus();
				              return false;
            }
            if(document.getElementById(Frmnae+"txtdt").value != "")
            {
                if(!isValidDate(document.getElementById(Frmnae+"txtdt").value,"MRCancellation"))
                {
                    document.getElementById(Frmnae+"txtdt").focus();
                    return false;
                 }   
				...
				if (dt>server_dt1)
                {
		                alert( "MR Cancellation Date should not be greater than today's date !!!")
		                document.getElementById(Frmnae+"txtdt").focus();
		                return false;
                } 
            }
        ...
        <br />                                                    
            <p align="center">
                ...
                <asp:Panel ID="p1" runat="server" style="display:none" >
                    <table border="0" cellpadding="3" style="background-color: #808080; width: 341px;" cellspacing="1" align="center" class="boxbg">
                        <tr style="background-color: #ffffff">
                            <td style="height: 10px">
                                <label class="blackfnt">Date :</label>
                            </td>
                            <td style="height: 10px">
                            &nbsp;
                        ...
                        <tr style="background-color: #FFFFFF">
                            <td style="width: 205; height: 22px;">
                                <label class="blackfnt">Customer&nbsp; :</label>
                            </td>
                            <td style="width: 343; height: 22px;">&nbsp;
                                <asp:Label ID="lblcust" runat="server" CssClass="blackfnt"></asp:Label>
                            </td>
                        </tr>
                        <tr style="background-color: #FFFFFF">
                            <td style="width: 205; height: 6px;">
                                <label class="blackfnt"><span style="font-size: 10pt">Bill Type</span> :</label>
                            </td>
                ...
                <asp:Panel ID="p2" runat="server" style="display:none" >
                    <table border="0" cellpadding="3" style="background-color: #808080; width: 341px;" cellspacing="1" align="center" class="boxbg">
                        <tr style="background-color: #ffffff">
                            <td style="height: 10px; width: 60px;">
                                <label class="blackfnt">MR No :</label>
                            </td>
                            <td style="height: 10px; width: 184px;">
                                &nbsp;
                ...
                <asp:Panel ID="p3" runat="server" style="display:none" >
                    <table border="0" cellpadding="3" style="background-color: #808080; width: 343px;" cellspacing="1" align="center" class="boxbg">
                        <tr style="background-color: #ffffff">
                            <td style="height: 10px; width: 80px;">
                                <label class="blackfnt">Docket No :</label>
                            </td>
                            <td style="height: 10px">
                                &nbsp;
                    ...
                    <table cellspacing="1" style="width: 90%; height: 263px;" border="0">
                        <tr align="center">
                            <td style="height: 324px" align="center" colspan="3">
                                <table cellspacing="1" style="width: 75%" class="boxbg" border="0"> 
                                    <tr class="bgbluegrey">
                                    ...
                                    <tr style="background-color: white">
                                        ...
                                        <td align="left" style="height: 25px; width: 40px;">
                                            <asp:TextBox ID="txtdt"  BorderStyle="groove"  runat="server"></asp:TextBox>
                                        </td>
                                        <td align="left" valign="top" width="500"> 
                                            <a href="#" onclick="cal.select(ctl00_MyCPH1_txtdt, 'alnkdt', 'dd/MM/yyyy'); return false;" id="alnkdt">
                                    ...
                                    <tr style="background-color: white">
                                        ...
                                        <td colspan="2" align="left" style="height: 21px">
                                            <asp:TextBox ID ="txtreson" runat="server" TextMode="multiLine" BorderStyle="groove"  Width="200" Height="60"></asp:TextBox>
    ...
    <tr>  
        <asp:GridView ID="GV_Booking" runat="server" align="center" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey" 
            ...
            <Columns>
                ...
                <asp:BoundField  DataField="mrsno"   ItemStyle-Wrap="true" HeaderText="MR No." > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                        <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="mrdt"   ItemStyle-Wrap="true"  HeaderText="MR Date "   > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="mrstype"   ItemStyle-Wrap="true" HeaderText="MR Type"      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                        <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="ptname"   ItemStyle-Wrap="true" HeaderText="MR Party  "      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="mrsamt"   ItemStyle-Wrap="true" HeaderText="  MR Amount  "      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="deduction"   ItemStyle-Wrap="true" HeaderText="  Deduction "      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="netamt"   ItemStyle-Wrap="true" HeaderText="  net Amount  "      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
                <asp:BoundField  DataField="dockno"   ItemStyle-Wrap="true" HeaderText=" Docket No."      > 
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                </asp:BoundField>
            </Columns>
...
<table border="0" cellpadding="0" width="565" style="background-color: #808080;" cellspacing="0" align="center" class="boxbg">
    <tr align="center">   
        <td style="background-color: #ffffff; width: 250px; height: 14px;">
            <asp:LinkButton ID="LinkButton1" OnClick="fst" runat="server" Text="First" ></asp:LinkButton>
        </td>                                                             
        <td style="background-color: #ffffff; width: 249px; height: 14px;">
            <asp:LinkButton ID="LinkButton2" OnClick="lst" runat="server" Text="Last"></asp:LinkButton>
        </td>
    </tr>
    <tr></tr>
</table>
...
<center>
    <asp:Button ID="btn_submit" Text="Submit" runat="server" OnClick="btn_submit1" />
</center>                                         
