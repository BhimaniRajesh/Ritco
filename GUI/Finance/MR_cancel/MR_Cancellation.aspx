<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="MR_Cancellation.aspx.cs" Inherits="octroi_octCustBillStep1" %>
...
<table cellspacing="1" style="width: 70%; height: 263px;" border="0">
                ...
                <tr align="center">
                    <td style="height: 324px" align="center" colspan="3">
                        <table cellspacing="1" style="width: 90%" class="boxbg" border="0"> 
                         ...
                         <td align="left" style="height: 25px; width: 100px;">
                             ...
                             <tr style="background-color: white">
                                <td colspan="3" align="center" style="height: 21px">
                                    <asp:Label ID="Label8" CssClass="blackfnt" 
                                        Font-Bold="true" runat="server">
                                        OR
                                    </asp:Label>
                    ...
                    Width="14px"></asp:Label>
                        ...
                        <asp:Label ID="lblTo" CssClass="blackfnt" runat="server" Text=" To: "></asp:Label><asp:TextBox ID="txtDateTo" runat="Server" ValidationGroup="VGDtFromTo" Width="80"></asp:TextBox>
