<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ContraVoucher.aspx.cs" Inherits="GUI_Finance_Journal_Voucher_JournalVoucher" Title="Untitled Page" %>
...
function roundit(Num)
	...
	{   
        ...
        if(Paymode1.value == "Cash")
        {
            ...
            {
                alert("Your can't Enter Cheque No / Ref. No Or Cheque Date / Ref. Date In Cash Mode");
                Chqno1.value = "";
                Chqdt1.value = "";
                return false;
            }*/
            if(parseFloat(Credit1.value) > 0)
            {
                if(Chqno1.value == "" || Chqdt1.value == "")
                {
                    alert("Plz Enter Ref. No Or Ref. Date In Cash Mode");
                    Chqno1.focus();
                    return false;
                }
                if(Chqno1.value == "")
                {
                    alert("Plz Enter Ref. No");
                    Chqno1.focus();
                    return false;
                }
        ...
        if(Paymode1.value == "Bank")
        {
            if(parseFloat(Credit1.value) > 0)
            {
                if(Chqno1.value == "")
                {
                    alert("Plz Enter Cheque No / Ref. No");
                    Chqno1.focus();
                    return false;
                 }
                if(!isValidDate(Chqdt1.value,"Contra Voucher"))
            ...
            else if(parseFloat(Credit1.value) <= 0)
            {
                if(Chqno1.value != "")
                {
                    alert("Cheque No / Ref. No and Cheque Date / Ref. Date Not Allowed");
                    Chqno1.value = "";
                    Chqdt1.value = "";
                    return false;
                 }
...
<%--<div style="width: 11.0in; text-align: right">
    <a href="javascript:window.history.go(-1)" title="back">
    <img alt="back" src="../../images/back.gif" border="0" /></a>
</div>--%>
<br />
<br />
<div style="text-align: center; width: 11.0in">
    <table cellspacing="1" class="boxbg" width="900">
        <tr class="bgbluegrey">
            <td align="center">
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server"   UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate> 
            <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="900">
                <tr style="background-color: White"> 
                    ...
                    <td colspan="2" width="130" class="blackfnt"  nowrap style="text-align: left"> &nbsp; 
                        <asp:TextBox ID="txtVoucherDate" Enabled="true" runat="server" 
                ...
                <tr style="background-color: White"> 
                  ...
                  <td colspan="2" style="text-align: left"  nowrap  class="blackfnt"> &nbsp;<strong><asp:Label ID="lblpreparedby" runat="server"></asp:Label></strong> </td>
                </tr>
                <tr style="background-color: White"> 
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="900">
                <tr bgcolor="#ffffff"> 
                      <td align="left" class="blckfnt"><font class="redfnt"><strong><asp:CheckBox runat="server" ID="chkRefno" OnCheckedChanged="CheckChqnofield" AutoPostBack="true" Checked="false" /> Check here to Enter Referance No.<br /></strong></font></td>
                </tr>
                <tr style="background-color: White">
                                ...
                                <asp:GridView ID="grvcontrols" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Account Code">
                                            ...
                                            <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlaccountlist" runat="server" Width="350px">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Debit">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtDebitAmt" style="text-align : right"  onchange="javascript:Nagative_Chk_wDecimal(this)" runat="server"
                                                    BorderStyle="Groove" CssClass="input" Width="80px" Text="0.00" MaxLength="12"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-Wrap="true" HeaderText="Cheque/Ref. No">
                                            <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                            <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                            <ItemTemplate>
                                                &nbsp;
                                                <asp:TextBox ID="txtChqno" style="text-align : right" runat="server" BorderStyle="Groove" CssClass="input" Width="90px" MaxLength="50"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-Wrap="true" HeaderText="Cheque/Ref. Date">
                                            <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                            <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                            <ItemTemplate>
                                                &nbsp;
                                                <asp:TextBox ID="txtChqdate" style="text-align : right" onblur="javascript:this.value=this.value.toUpperCase()"  runat="server" BorderStyle="Groove" CssClass="input" Width="90px"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
