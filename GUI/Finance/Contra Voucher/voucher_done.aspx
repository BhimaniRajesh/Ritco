 ...
 <table border="0" width="100%">
                ...
                <%
                    ...
                    switch (voucherType)
                    {
                        ...
                        case "Contra":
                            ...
                            strPrintURL = "../ViewPrint/Voucher Register/Print/ContraView.aspx?voucherno=" + voucherId + "&printyn=Y";
                            break;
                    }
                %>
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
                <a href="ContraVoucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Contra Voucher (With New Date)</font> </a>
            </td>
        </tr>
         <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="ContraVoucher.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Contra Voucher (With Same Date)</font> </a>
        </tr>
        <tr style="background-color: white">
            <td align="left" colspan="3" style="height: 18px">
                <asp:LinkButton ID="LinkButton3" runat="server" Text="Prepare Debit Voucher" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/Debit Voucher/DebitVoucher.aspx?Defaultdate=today" /></td>
        </tr>
        <tr style="background-color: white">
            <td align="left" colspan="3" style="height: 18px">
                <asp:LinkButton ID="LinkButton1" runat="server" Text="Prepare Credit Voucher" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/Credit Voucher/CreditVoucher.aspx?Defaultdate=today" /></td>
        </tr>
        <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 18px">
                <asp:LinkButton ID="LinkButton2" runat="server" Text="Prepare Journal Voucher" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/Journal Voucher/JournalVoucher.aspx?Defaultdate=today" /></td>
        </tr>
          <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
