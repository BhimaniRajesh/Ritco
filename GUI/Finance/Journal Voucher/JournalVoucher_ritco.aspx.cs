...
public partial class GUI_Finance_Journal_Voucher_JournalVoucher : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
       ...
       // {
            ...
            Response.Write("<BR>cOUNT....." + grvcontrols.Rows.Count.ToString());
            ...
            Response.Write("<BR>cOUNT....." + grvcontrols.Rows.Count.ToString() +"<BR>");
            foreach (GridViewRow gridrow in grvcontrols.Rows)
            {
                ...
                Response.Write("<BR> Acccode :-" + Acccode);
                i = i + 1;
                ...
                if (Acccode != "")
                {
                    ...
                    dtaccs = SqlHelper.ExecuteDataset(SessionUtilities.ConnectionString, CommandType.Text, sql_Acccode).Tables[0];
                    ...
                    Xml_Acccode_Details = Xml_Acccode_Details + "</Acccode>";
                    Response.Write("<BR> Xml_Acccode_Details :-" + Xml_Acccode_Details);
                }
            }
            ...
            string sql1 = "USP_GENERATE_MANUALJVACCOUNTDETAILS_VER2 '" + Xml_Acccode_Details.Replace("&", "&amp;").Trim() + "','" + Xml_Other_Details.Replace("&", "&amp;").Trim() + "' ";
            Response.Write("ff " + sql1);
            Response.End();
          ...
          //  cmd.ExecuteNonQuery();
            ...
            LedgerDiff = Convert.ToInt16(SqlHelper.ExecuteScalar(SessionUtilities.ConnectionString, CommandType.Text, sql_Acctrans));
            ...
            {
               // trans.Rollback();
                Response.Write("Xml_Acccode_Details :-" + Xml_Acccode_Details);
                Response.Write("<BR> Xml_Other_Details :-" + Xml_Other_Details);
                Response.End();
            }
