<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="JournalVoucher_ritco.aspx.cs" Inherits="GUI_Finance_Journal_Voucher_JournalVoucher" Title="Journal Voucher" %>
            ...
            <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
                ...
                <tr style="background-color: White"> 
                  <td colspan="6" align="left">
                    <asp:DropDownList ID="Dr_Pbov_list" DataTextField="name" DataValueField="code" runat="server" Width="300px" CssClass="blackfnt">
                    </asp:DropDownList>
                  </td>
                </tr>
                <tr style="background-color: White"> 
...
<table cellspacing="1" class="boxbg" width="800">
    <tr class="bgbluegrey">
        <td align="center">
            <asp:Button ID="btnSubmit" UseSubmitBehavior="true" runat="server" CssClass="blackfnt"  OnClientClick="javascript:return CheckData();" BorderStyle="Solid" BorderWidth="1px" Text="SUBMIT"
