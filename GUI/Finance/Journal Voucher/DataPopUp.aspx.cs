    ...
    protected void btnpartysubmit_Click(object sender, EventArgs e)
    {
        ...
        else if (mode.CompareTo("LocCode") == 0)
        {
            ...
            else if (mode.CompareTo("AccCode") == 0)
            {
                ...
                {
                    qry = "select distinct Company_Acccode as Acccode,Accdesc,Acccode as acctcd  from webx_acctinfo  WITH(NOLOCK) where Activeflag='Y' and " + groupcode;
                }
                else if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") == 0 && cbomaincat.SelectedValue.ToString().CompareTo("") == 0)
                {
                    qry = "select distinct Company_Acccode as Acccode,Accdesc,Acccode as acctcd  from webx_acctinfo WITH(NOLOCK) where Activeflag='Y' " + brcdcheck;
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    if (cbomaincat.SelectedValue.ToString().CompareTo("") == 0)
            ...
            else if (mode.CompareTo("E") == 0)
            {
                ...
                if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select userid,name from webx_master_users WITH(NOLOCK) where status='100'";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select userid,name from webx_master_users WHERE userid like '" + txtcustcode.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") != 0)
                {
                    qry = "select userid,name from webx_master_users WHERE name like '" + txtcustname.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") != 0)
                {
                    qry = "select userid,name from webx_master_users WHERE name like '" + txtcustname.Text.ToString() + "%' and userid like '" + txtcustcode.Text.ToString() + "%'";
                }
                ...
                while (dr.Read())
                {
                    ...
                    //rad.Attributes.Add("onclick", "javascript:return radPartyClick(this.getAttribute('id'),'" + codeid + "','" + nameid + "','" + Convert.ToString(dr["custcd"]) + "','" + Convert.ToString(dr["custnm"]) + "')");
                    rad.Attributes.Add("onclick", "javascript:return radEmpVenCustClick(this.getAttribute('id'),'" + ctlid + "','" + tbl + "')");
