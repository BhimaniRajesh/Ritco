...
function ClearDockets(txtchqno,txtchqdt,txtindchqamt,txtonacctamt,txtonacct,txtindclamt,cbopaytype,colamt,txtbanknm,txtbankbrn,tottds,tdsacccode,netamt,cbsdt)
{
               ...
               // alert(Fromdate1)
                if (dt<Fromdate1)//Fromdate1
				                ...
				                if (dt<server_dt)
				                {
						                alert( "Financial Close Date should not be Less than today's date !!!")
						                document.getElementById(Frmnae+"TxtCBSDT").focus();
						                return false;
				                }
...
//	return false;
	   click_count=parseFloat(document.getElementById("ctl00_MyCPH1_click_count").value)
               // alert(click_count)
				...
				document.getElementById(Frmnae+"submit").style.display="none"	
}
                                                               ...
                                                               <%--   <asp:BoundField  DataField="MRSNO"   ItemStyle-Wrap="False"  HeaderText="MR. No"   > 
                                                                 ...
                                                                 <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="TDS"   Font-Bold="true" CssClass="blackfnt" Text="TDS Rate (%)" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  TabIndex="1"  ID ="txttds_rate"  Enabled="false" runat="server" MaxLength="10" Columns="8"  Text="0"></asp:TextBox>
                                                                     ...
                                                                     <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="tdsamt"  Font-Bold="true"  CssClass="blackfnt" Text="TDS amount (-)" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  ID ="txttdsamt" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" MaxLength="10" Enabled="true"  Columns="8"  runat="server" Text="0"></asp:TextBox>
                                                                     ...
                                                                     <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="DED_OTH"  Font-Bold="true"   CssClass="blackfnt" Text="Other Deduction (-)" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  ID ="txtDED_OTH" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" TabIndex="1"   MaxLength="10" Columns="8"  runat="server" Text="0"></asp:TextBox>
                                                                     ...
                                                                     <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="lblotchg"  Font-Bold="true"  CssClass="blackfnt" Text="Other Charges (+)" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  ID ="txtotchg" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))"   TabIndex="1"   MaxLength="10" Columns="8" runat="server" Text="0"></asp:TextBox>
