<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    Trace="false" CodeFile="FA_REG_1.aspx.cs" Inherits="GUI_Finance_Fix_Asset_aaaaa" %>
    ...
    <table style="width: 1100px">
        <tr>
            <td align="left">
                ...
                <b>&gt; </b><font class="bluefnt"><b>Goods Reciept Note </b></font>
            </td>
            <td align="right">
                ...
                <table cellspacing="1" style="width: 90%" class="boxbg" border="0">
                    ...
                    <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                        ...
                        <td valign="top" align="left">
                            ...
                            <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Date Range Must Be 1 month Only"
                                OnServerValidate="daterange"></asp:CustomValidator><asp:RequiredFieldValidator ID="RFVFromDate"
                                    runat="server" ControlToValidate="txtDateFrom" ErrorMessage="Date From cannot be blank :("
                                    CssClass="blackfnt" ValidationGroup="VGDtFromTo" />
                            ...
                            <asp:RequiredFieldValidator ID="RFVToDate" runat="server" ControlToValidate="txtDateTo"
                                ErrorMessage="Date To cannot be blank :(" CssClass="blackfnt" ValidationGroup="VGDtFromTo" /><asp:RegularExpressionValidator
                                    ID="RegularExpressionValidator2" runat="server" ErrorMessage="Invalid Date To  :("
                    ...
                    <tr style="background-color: white">
                        <td align="left" style="width: 2in">
                            <asp:Label ID="Label4" CssClass="blackfnt" Text="Asset Classification" runat="server"
                                Width="113px"></asp:Label>
                        </td>
                        <td align="left" valign="top" style="height: 24px;">
                            <asp:DropDownList ID="ddastclass" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr style="background-color: white">
                        <td align="left" style="width: 2in">
                            <asp:Label ID="Label2" CssClass="blackfnt" Text="Asset Location" runat="server" Width="113px"></asp:Label>
                        </td>
                        <td align="left" valign="top" style="height: 24px;">
                            <asp:TextBox ID="txtloc" runat="server" Width="100px"></asp:TextBox><asp:Label ID="Label1"
                                runat="server" BorderStyle="Groove" Text='<a href="javascript:nwOpen()">...</a>'
                                Width="14px"></asp:Label>
                        </td>
                    </tr>
                    <tr style="background-color: white">
                        <td align="left">
                            <asp:Label ID="Label7" CssClass="blackfnt" Text="Asset Gross Value " runat="server"
                                Width="213px"></asp:Label>
                        </td>
                        <td align="left" valign="top" style="height: 24px;">
                            <asp:TextBox ID="txtastval" runat="server" Width="100px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="background-color: white">
                        <td align="left" style="width: 2in">
                            <asp:Label ID="Label5" CssClass="blackfnt" Text="Depreciation" runat="server" Width="113px"></asp:Label>
                        </td>
                        <td align="left" valign="top" style="height: 24px;">
                            <asp:DropDownList ID="ddDepreciation" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
