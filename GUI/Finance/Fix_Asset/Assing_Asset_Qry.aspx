<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    Trace="false" CodeFile="Assing_Asset_Qry.aspx.cs"  Inherits="GUI_Finance_Fix_Asset_aaaaa" %>
  ...
  <table style="width: 1100px">
        <tr>
            <td align="left">
                ...
                <b>&gt; </b><font class="bluefnt"><b>Assign Asset </b></font>
            </td>
            <td align="right">
                ...
                <table cellspacing="1" style="width: 90%" class="boxbg" border="0">
                    ...
                    <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                        <td valign="top" align="left">
                            <asp:Label ID="Label3" CssClass="blackfnt" Text="Enter the GRN Date" runat="server"
                    ...
                    <tr style="background-color: white">
                        <td align="left">
                            <asp:Label ID="Label7" CssClass="blackfnt" Text="Enter GRN  " runat="server" Width="213px"></asp:Label>
                        </td>
                        <td align="left" colspan="2" valign="top" style="height: 24px;">
                            <asp:TextBox ID="txtpono" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <br />
