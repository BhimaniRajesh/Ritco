<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupasset.aspx.cs" Inherits="popupbranch" %>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" ItemStyle-BackColor="white" ItemStyle-Width="40px" >
                                    <ItemTemplate>
                                        ...
                                        <input name="MyRadioButton" type="radio"  value='<%# Convert.ToString(Eval("assetcd"))+","+Convert.ToString(Eval("assetname"))%>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="assetcd" HeaderText="Branch Code">
                                ...
                                <asp:BoundField DataField="assetname" HeaderText="Branch Name">
