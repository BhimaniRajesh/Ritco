<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Updatedone.aspx.cs"  EnableEventValidation="false" Inherits="GUI_Operations_Re_Assign_BA_Updatedone" Title="Untitled Page" %>
    ...
    <table border="0" cellpadding="0" class="boxbg" cellspacing="0">
        <tr bgcolor="white">
            <td align="left" colspan="5" height="30" style="width: 459px">
                ...
                <b>Finance & Accounts</b></font></a> <b>&gt; </b><a href=""><font class="blklnkund">
                <b>Advice Cancellation</b></font></a> <b>&gt;</b>
            </td>
        </tr>
    </table>
    <br />
    ...
    <table align="center" bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" width="80%">
        <tr class="bgbluegrey">
            <td class="blackfnt" align="center" colspan="2">
                <b>Advice Cancellation Code Updation DOne Successfully</b>
            </td>
        </tr>
        <tr  bgcolor="white"  colspan="2">
            ...
            <td class="blackfnt" align="center">
                <a href="Advice_Cancellation.aspx">Click here to More Update Advice Cancellation</a>
            </td>
        </tr>
       <%-- <tr  bgcolor="white"  >
            <td class="blackfnt" align="left">
