...
public partial class GUI_Finance_Billing_GST_BillGSTViewPrint_BillGST_ViewPrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack && !IsCallback)
        {
            ...
            var str_Report_Name = "";
            if (strBillType == "F")
                str_Report_Name = "Bill_GST_View";
            else
                str_Report_Name = "Supp_Bill_GST_View";
