<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="SupplementaryBillGenerationDone.aspx.cs" 
    Inherits="GUI_Finance_Billing_GST_BillGeneration_SupplementaryBillGenerationDone" %>
...
<body>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ViewPrint(arg1,arg2)
        {
            ...
            window.open("./viewPrintSuppBill.aspx?billno=" + arg1 + "," + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"); 
        }
       ...
       <tr  class="bgbluegrey" style="height:25px">
        ...
        <tr bgcolor="white" style="font-size: 12pt; font-family: Times New Roman; height: 25px">
            <td align="center" style="width: 282px">
                <font class="blackfnt">Bill No.</font></td>
