<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/GUI/MasterPage.master" CodeFile="prestart.aspx.cs" Inherits="GUI_UNI_MIS_accounts_mis_ledger_prestart" %>
...
<br /><br />
      ...
      <td  align="center" colspan="4"> 
        ...
        <td bgcolor="#FFFFFF" align="center" colspan="2"> 
          <div align="left"><font class="blackfnt">&nbsp;<asp:DropDownList ID="dlstBranch" runat="server" Width="250px">
            ...
            <tr bgcolor="white">
                <td align="center" colspan="4">
                    <asp:RadioButtonList ID="dlstTranType" runat="server" RepeatDirection="Horizontal" Width="321px" CssClass="blackfnt" Font-Bold="True">
                        <asp:ListItem Selected="True" Value="all">All</asp:ListItem>
                        <asp:ListItem Value="reconciled">Reconciled</asp:ListItem>
                        <asp:ListItem Value="notreconciled">Not Reconciled</asp:ListItem>
                    </asp:RadioButtonList></td>
            </tr>
      
				<tr class="bgbluegrey"> 
      <td  align="center" colspan="4"> 
        <p align="center"><font class=blackfnt>Select Voucher Date Range</font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
    ...
    <tr> 
        ...
        <td bgcolor="#FFFFFF" align="center" colspan="3"> 
          <div align="left"><font class=blackfnt>&nbsp;&nbsp;Today</font></div>
        </td>
      </tr>
    <center>
      <tr> 
        ...
        <td bgcolor="#FFFFFF" align="center" colspan="3"> 
          <div align="left"><font class=blackfnt>&nbsp;&nbsp;Last 7 Days</font></div>
        </td>
      </tr>
				 ...
				 <tr class="bgbluegrey"> 
			      ...
			      <tr bgcolor="#FFFFFF"> 
					...
					<td align="center"  height="22" colspan="4">
                        <asp:DropDownList ID="dlstSalesAmount" runat="server"></asp:DropDownList></td>
				  </tr>
				  <%--<tr bgcolor="#FFFFFF"> 
				...
				<center>
					<tr>
						<td bgcolor="#FFFFFF" align="center" colspan="4" height="22">
                            <asp:Button ID="Button1" runat="server" Text="Submit" BorderStyle="None" style="text-decoration: underline" CssClass="blackfnt" Font-Size="10pt" Height="23px" OnClick="Button1_Click" Width="83px" OnClientClick="return Error(this);" /></td>
...
<asp:TextBox ID="chk" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="White" Width="6px">0</asp:TextBox>
</asp:Content>
