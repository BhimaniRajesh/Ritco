<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"  CodeFile="Reoffer_Done.aspx.cs" Inherits="octroi_OctCustBillStep2" %>
    ...
    <tr class="bgbluegrey">
                                <td colspan="3" align="center" style="height: 21px">
                                    <asp:Label ID="lblQry" CssClass="blackfnt" 
                                        Font-Bold="True" runat="server" ForeColor="Red">Following Cheque has Successfully Reoffred </asp:Label>
                                </td>
                            </tr>
