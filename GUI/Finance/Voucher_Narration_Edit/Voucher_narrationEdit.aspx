<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Voucher_narrationEdit.aspx.cs" Inherits="GUI_Finance_Voucher_Narration_Edit_Voucher_narrationEdit" %>
    ...
    <tr>
        <td align="center">
            <table style="WIDTH: 8.5in" class="boxbg" cellspacing="1" align="center">
                <tr class="bgbluegrey">
                    <td align="center"><strong>Voucher Narration Edit</strong></td>
                </tr>
            </table>
                    ...
                    <ContentTemplate>
                        <table style="WIDTH: 8.5in" class="boxbg" cellspacing="1" align="center">
                            <tr style="background-color: #ffffff">
                                <td>
                                    <table style="WIDTH: 8.5in" border="0" cellspacing="1" align="center">
                                        <tr>
                                            <td align="right" width="350px">Enter No. of Rows :</td>
                                            <td align="left">
                                                <asp:TextBox ID="txtRows" Width="50px" runat="server" BorderStyle="Groove">5</asp:TextBox>
                                                <asp:Button ID="btnRows" runat="server"  Text="Add Rows" Width="68px" OnClick="btnRows_Click" />
                                            </td>
                                        </tr>    
                                    </table>
                                </td>
                            ...
                            <%--<tr style="background-color: #ffffff">
                                <td>
                                    <table style="WIDTH: 8.5in" border="0" cellspacing="1" align="center">
                                        <tr>
                                            <td align="right" width="350px">Cancel Reason  :</td>
                                            <td align="left"><asp:TextBox ID="txtcancel" Width="250px" MaxLength="250" runat="server" TextMode="MultiLine" BorderStyle="Groove"></asp:TextBox></td>
                                        </tr>    
                                    </table>
                                </td>
                            </tr>--%>
                                        ...
                                        <asp:TemplateField  HeaderText="Narration" >
                                            ...
                                            <ItemTemplate>
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="txtNarrtion" runat="server" BorderStyle="Groove" CssClass="blackfnt"
                                                                Enabled="false" MaxLength="50" Width="135px" TextMode="MultiLine"></asp:TextBox>                                                            
                                                        </td>                                                        
                                                    </tr>
                                                </table>                                     
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField  HeaderText="Enter Narration" >
                                            <ItemStyle  CssClass="blackfnt" Width="170" HorizontalAlign="Center" BackColor="White" Wrap="False" />
                                            <HeaderStyle CssClass="blackfnt" BackColor="#D4E0E7"  HorizontalAlign="Center" Wrap="False" />
                                            <ItemTemplate>
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="txtNewNarrtion" runat="server" BorderStyle="Groove" CssClass="blackfnt"
                                                                Enabled="true" MaxLength="50" Width="135px" TextMode="MultiLine"></asp:TextBox>                                                            
                                                        </td>                                                        
                                                    </tr>
                                                </table>                                     
                                            </ItemTemplate>
