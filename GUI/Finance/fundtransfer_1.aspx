<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="fundtransfer_1.aspx.cs" Inherits="GUI_finance_fundtransfer" Title="Untitled Page" %>
						...
						<table border=0 cellpadding="5" width="35%" cellspacing="1" align="left" class=boxbg>
                            ...
                            <tr bgcolor="#FFFFFF">
                                                     <td nowrap style="width: 335px" ><font class=blackfnt>
                                                         <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/GUI/finance/Advice_Generation/advice.aspx">Advice Entry</asp:HyperLink><a href="#"></a></font><font class=blackfnt>&nbsp;</font></td>   
                            </tr>	
							<tr bgcolor="#FFFFFF">
                            
                             <td style="width: 335px"><font class=blackfnt>
                                 <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/GUI/finance/Advice_Generation/Adviceacknowledged_step1.aspx">Advice Acknowledgement</asp:HyperLink><a href="#"> </a></font></td>
                            </tr>	    
