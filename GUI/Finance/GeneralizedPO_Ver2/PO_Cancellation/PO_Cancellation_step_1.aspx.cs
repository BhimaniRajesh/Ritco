...
{   
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtPONo.Attributes.Add("onblur", "POBlur('" + txtPONo.ClientID.ToString() + "')");
            txtManualPONo.Attributes.Add("onblur", "POBlur('" + txtManualPONo.ClientID.ToString() + "')");
        }
    }
    protected void submit1_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            final += "&ToDtae=" + ToDtae;
            final += "&PONO=" + txtPONo.Text;
            final += "&ManualPONO=" + txtManualPONo.Text;
            Response.Redirect("PO_Cancellation_step_2.aspx" + final);
        }
    }
