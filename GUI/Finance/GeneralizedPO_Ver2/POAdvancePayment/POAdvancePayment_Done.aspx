<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="POAdvancePayment_Done.aspx.cs" Inherits="GUI_finance_voucher_voucher_done" Title="Untitled Page" %>
                ...
                <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="650">
                    ...
                    <tr style="background-color: White">
                        <td align="left" colspan="3" style="height: 21px">
                            <a href="POAdvancePaymentCriteria.aspx"><font class="blackfnt">Prepare New Advance Payment</font>
                            </a>
