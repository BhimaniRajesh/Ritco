...
public partial class GUI_Finance_GeneralizedPO_POGeneration_GeneralizePO : System.Web.UI.Page
{
    ...
    protected void GV_D_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType==DataControlRowType.DataRow)
        {
            ...
            string strSql = "SELECT CodeId,CodeDesc FROM Webx_Master_General WHERE CodeType='UNTTYP' AND StatusCode='Y' AND CodeId='5' ORDER BY CodeId";
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string ErrorMsg = "Generalized PO Not Made Head Quarter,Only Branch Level Allowed";
                Response.Redirect("../../../ErrorPage.aspx?PageHead=" + "Generalized PO" + "&ErrorMsg=" + ErrorMsg);
            }
            ...
            Xml_POASSET_HDR_Details = Xml_POASSET_HDR_Details + "<POType>" + ddlPOType.SelectedValue.ToString() + "</POType>";
			Xml_POASSET_HDR_Details = Xml_POASSET_HDR_Details + "</POHDR>";
    ...
    public void EnableTrueFalseStep2(bool Bool)
    {
        ...
        trStep1.Visible = Bool;
        TxtCreditDays.Enabled = Bool;
        ddlMatCat.Enabled = Bool;
        ddlPOType.Enabled = Bool;
    }
