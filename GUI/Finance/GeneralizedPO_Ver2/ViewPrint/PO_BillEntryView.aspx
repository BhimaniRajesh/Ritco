            ...
            <table border='<%=strborder %>' cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
                ...
                <tr class="bgbluegrey">
                    <td align="center">
                        ...
                        <font class="blackfnt"><b>Goods Receipt Note Bill Entry Details</b></font>
                    </td>
                </tr>
            </table>
            <br />
                    ...
                    <td>
                        ...
                        <table border='<%=strborder %>' cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
                            ...
                            <tr bgcolor="white">
                                ...
                                <td align="Left">
                                    <font class="blackfnt"><asp:Label ID="lblVendorBillno" runat="server" CssClass="blackfnt"></asp:Label></font>
                                </td>
                                <td align="Left">
                                    <font class="blackfnt">Vendor Bill Date</font>
                                </td>
                                <td align="Left">
                                    <font class="blackfnt"><asp:Label ID="lblVendorBillDt" runat="server" CssClass="blackfnt"></asp:Label></font>
                                </td>
                            </tr>
                            <tr bgcolor="white">
                                <td align="Left">
                                ...
                                <td align="Left">
                                    <font class="blackfnt"><asp:Label ID="lblDueDays" runat="server" CssClass="blackfnt"></asp:Label></font>
                                </td>
                                <td align="Left">
                                    <font class="blackfnt">Due Date</font>
                                </td>
                                <td align="Left">
                                    <font class="blackfnt"><asp:Label ID="lblDueDate" runat="server" CssClass="blackfnt"></asp:Label></font>
                                </td>
                            </tr>
                            <tr bgcolor="white">
                                <td align="Left">
                                ...
                                <td align="Left" colspan="3">
                                    <font class="blackfnt"><asp:Label ID="lblRemarks" runat="server" CssClass="blackfnt"></asp:Label></font>
