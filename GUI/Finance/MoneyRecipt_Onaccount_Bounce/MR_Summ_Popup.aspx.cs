...
public partial class GUI_Operation_Singlescreen_docketentry_DocketPrint_PaidMR_MR_Summ_Popup : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        String Sql = "select MRSSF,convert(varchar,mrsdt,106) as mrsdt,mrsbr,mrbrnnm,ptcd,ptname,ptpin,ptadd,MRSAMT,NETAMT,DEDUCTION,MRSCASH,MRSCHQ,MRSCHQNO,MRSCHQDT,MRSBANKBR,MRSBANK, mrs_closed,paymode from webx_mr_hdr where mrsno='" + MR_Number + "'";
        ...
        Sql = "select a.totbill,a.netamt,a.tdsded,a.frtded,a.clmded,a.unexpded,a.docno,a.docsf,(select convert(varchar,bgndt,106) from Vw_Billmst_details where billno=a.docno) as bgndt from webx_mrdet_bill a,webx_mr_hdr b where b.mrsno='" + MR_Number + "' and a.mrsno=b.mrsno  order by a.mrsno";
