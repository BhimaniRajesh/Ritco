...
<%@ Register  TagPrefix="collectiondetail" TagName="chqdetail" 	Src="~/Usercontrol_Test/WebUserControl.ascx" %>
...
var MyDiv = document.getElementById("ReportingToCombo");
	...
	//***************************************************************
 function fcal_MRamt(tdsrate,tdsamt,other_ded,Other_amt,totalamt,totMramt,Colamt)
{
	...
	tdsamt.value=Math.round(parseFloat(totMramt.value) * (parseFloat(tdsrate.value)/100))
   // col_frt=parseFloat(document.frm.col_frt.value)
	...
	netamt=rounditn(subtotal-var_tdsamt-var_other_ded+var_Other_amt,2)
...
//	document.getElementById("ctl00$MyCPH1$chqdetail11$cbopaytype").focus()
}
								...
								for(i=0;i<3;i++)
								{
																...
																if(chqno!="")
																{
																	//check for valid cheque date
																			if(parseFloat(total_row)>1 && parseFloat(Chq_Counct)>1 )
																			{
																			    alert("Multiple Cheque are Nort Allow For Multiple Mrs.")
																				//txtchqdt[i].focus()
																				return false;
																			}
																			if(txtchqdt[i].value=="")
...
function Manual_Mrsnocheck(d)
        {
                           d.value=d.value.toUpperCase();
                           Client_name="<%=Session["Client"].ToString()%>"
                        if(Client_name=="Varuna_Test")
                        {
                            ...
                            if(d.value!="")
                            {
				                ...
				                if (doc)
				                { 
					                doc.onreadystatechange = Dovalidate; 
					                doc.open("GET", "dyn_combo_dcr.aspx?manualmrsno=" + d.value + "&RandText="+arg, false);
					                doc.send(null);
					                //alert(chqno)
				                }	
				            }
...
function rounditn(Num,decplaces)
	...
	function fcal_MRamt_total(tdsrate,tdsamt,other_ded,Other_amt,totalamt,totMramt,Colamt)
{
    var var_totalamt=0
	for (i=0;i<total_row;i++)
		{
...
function validFloat(event,txtid)
{
    ...
    if(event.keyCode==13)
    {
        alert("User Can't Press Enter Button On TextBox")
...
<body>
  ...
  <tr><td><font class="blackfnt"><b><a href="../../welcome.aspx"><font class="blklnkund"><strong>Module</strong></font></a><strong> &gt; </strong></font>
   ...
   &gt; <font class="bluefnt"><strong>  
    ...
    <table   border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width:10in"  align="left">
       ...
       <tr bgcolor="white" style="height:25px; font-size: 12pt; font-family: Times New Roman;">
            ...
            <td style="width: 339px"><asp:TextBox ID="TxtmanualMR" runat="server"   onblur="return Manual_Mrsnocheck(this)" Columns="12"></asp:TextBox></td>
                                                               ...
                                                               <%--   <asp:BoundField  DataField="MRSNO"   ItemStyle-Wrap="False"  HeaderText="MR. No"   > 
                                                                  ...
                                                                  <asp:BoundField  DataField="ptname"  HeaderStyle-Font-Bold="true"  ItemStyle-Wrap="false"  HeaderText="MR Customer "   > 
                                                                    ...
                                                                    <asp:TemplateField>
                                                                       ...
                                                                       <asp:TemplateField>
                                                                                  <HeaderTemplate >
                                                                                  <asp:Label ID="lblsvctax"   Font-Bold="true" CssClass="blackfnt" Text="Service Tax(+)" runat="server"></asp:Label>
                                                                                  </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                     <asp:Label ID="lblsvctax1" CssClass="blackfnt" Text=<%# DataBinder.Eval(Container.DataItem,"svctax") %> runat="server"></asp:Label>
                                                                 ...
                                                                 <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="TDS"   Font-Bold="true" CssClass="blackfnt" Text="TDS Rate (%)" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  TabIndex="1"  ID ="txttds_rate" runat="server" MaxLength="10" Columns="8"  Text="0"   onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"></asp:TextBox>
                                                                     ...
                                                                     <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="tdsamt"  Font-Bold="true"  CssClass="blackfnt" Text="TDS amount (-)" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  ID ="txttdsamt" MaxLength="10" Enabled="False"  Columns="8"  runat="server" Text="0"  onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"></asp:TextBox>
                                                                     ...
                                                                     <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="DED_OTH"  Font-Bold="true"  CssClass="blackfnt" Text="Other Deduction (-)" runat="server" ></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  ID ="txtDED_OTH" TabIndex="1"   MaxLength="10" Columns="8"  runat="server" Text="0"  onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"></asp:TextBox>
                                                                     ...
                                                                     <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="lblotchg"  Font-Bold="true"  CssClass="blackfnt" Text="Other Charges (+)" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  ID ="txtotchg"  TabIndex="1"   MaxLength="10" Columns="8" runat="server" Text="0"  onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"></asp:TextBox>
                                                                     ...
                                                                     <asp:TemplateField>
                                                                                  ...
                                                                                  <asp:Label ID="lblnetamt"  Font-Bold="true"  CssClass="blackfnt" Text="Net Amount" runat="server"></asp:Label>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <center>
                                                                                                  <asp:TextBox  ID ="totalamt" MaxLength="10" Columns="8"  Enabled="False"  Text=<%# DataBinder.Eval(Container.DataItem,"netamt") %>  runat="server"  onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"></asp:TextBox>
   ...
   <%#DataBinder.Eval(Container.DataItem, "totdkt")%>                                 
      ...
      <td>
       <asp:TextBox MaxLength="200" Rows="3"  TextMode="MultiLine" onchange="javascript=this.value=this.value.toUpperCase()" CssClass="Blackfnt" Columns="30" ID="Remarks" runat="server"></asp:TextBox>
      </td></tr></table>
...
//        window.onload=ChequeText_validation
         window.onload=mrfocus
        function mrfocus()
        {
        //document.getElementById("ctl00$MyCPH1$TxtmanualMR").focus()
        //document.getElementById("ctl00$MyCPH1$chqdetail11$cbopaytype").focus()
        fcal_MRamt_total()
        }
        </script>
