<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="MIscMR_done.aspx.cs" Inherits="Finance_Billing_Billsubmission_Billsub_Step2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
<script language="javascript" type="text/javascript">
function ViewPrint(mode)
 {
    var mrsno = document.getElementById('ctl00_MyCPH1_lblMrNo').innerText;
    window.open("./MiscMR_Print.aspx?mrsno=" + mrsno + "&mode=" + mode ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
 }
</script>
     ...
     <table   border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width:80%"  align="center">
       <tr  class="bgbluegrey" style="height:25px">
        ...
        <tr bgcolor="white" style="font-size: 12pt; font-family: Times New Roman; height: 25px">
            ...
            <td>
                &nbsp;&nbsp;<asp:Label ID="lblMrNo" runat="server" CssClass="blackfnt" Width="308px"></asp:Label>
                  </td>
            <td style="text-align: center">
               <a href="javascript:ViewPrint('0')">View</a> /<a href="javascript:ViewPrint('1')">Print</a>
            </td>
        </tr>
