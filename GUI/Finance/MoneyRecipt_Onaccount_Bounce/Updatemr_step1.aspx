     ...
     <script language="javascript" type="text/javascript">
        ...
        function Submitdata()
        {
           ...
           if (document.getElementById(Form_name+"txtmrsno").value=="" && document.getElementById(Form_name+"txtdocno").value=="")
           {
            ...
            if(document.getElementById(Form_name+"CboTransamode").value=="")
             {
                        alert("PLz Select Transaction Type")
                        document.getElementById(Form_name+"CboTransamode").focus()
                        return false;
             }
             if(document.getElementById(Form_name+"CboTransamode").value=="Cheque")
             {
                        if(document.getElementById(Form_name+"Party_code").value=="")
                         {
                                    alert("PLz Enter Party Code For Cheque Collection")
                                    document.getElementById(Form_name+"Party_code").focus()
                                    return false;
                         }
             }
                        ...
                        <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                             <td  align="left"  class="blackfnt" >
                                ...
                                <td colspan="2" align="left"  class="blackfnt" >
                                   ...
                                   <%-- <asp:ListItem Value="1" >Paid MR</asp:ListItem>
                                     <asp:ListItem Value="3">Topay MR</asp:ListItem>--%>
                                    </asp:DropDownList></td>
                          </tr>
                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                            ...
                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                             ...
                             <tr  class="bgbluegrey" style="font-size: 12pt; font-family: Times New Roman">
                                <td align="center" style="height: 21px" valign="top" colspan="3" class="blackfnt">
                             ...
                             <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                <td align="left" style="height: 21px" valign="top">
                                    <asp:Label ID="Label4" runat="server" CssClass="blackfnt" Text="Transaction Mode"
                                        Width="145px"></asp:Label></td>
                                <td align="left"  colspan="2" style="width: 359px; height: 21px" valign="top">
                                     <asp:DropDownList ID="CboTransamode" runat="server" CssClass="blackfnt">
                                     <asp:ListItem Value="" >Select</asp:ListItem>
                             ...
                             <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                <td align="left" style="height: 21px" valign="top">
                                    <asp:Label ID="Label5" runat="server" CssClass="blackfnt" Text="Select Party"
                                        Width="145px"></asp:Label></td>
                                <td align="left"  colspan="2" style="width: 359px; height: 21px" valign="top">
                                    <asp:TextBox ID="Party_code" runat="server" CausesValidation="True" Width="100" Columns="100"></asp:TextBox>
                <input id="btnPopUp" type="button" value="..." name="custpup12"  runat="server" /> </td>
