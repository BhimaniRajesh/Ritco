<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewRunSheetBalance.aspx.cs"
    Inherits="GUI_Finance_Vendor_BA_payment_PrepareVoucher_RunSheet_ViewRunSheetBalance" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RunSheet Balance Payment</title>
            ...
            <asp:GridView ID="dockdata" runat="server" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass='<%=bgbluegrey%>'
                ...
                <Columns>
                    <asp:TemplateField HeaderText="SRNo.">
                        ...
                        <FooterTemplate>
                            <center>
                                <asp:Label ID="TotalNetamt" runat="server" CssClass="blackfnt" Text="Total"></asp:Label>
                            </center>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                    ...
                    <asp:TemplateField>
                     ...
                     <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblOtherDed" Style="text-align: center" CssClass="blackfnt" Text="Other Ded"
                                runat="server"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <center>
                                <asp:Label ID="indOthded" runat="server" CssClass="blackfnt" Text='<%# DataBinder.Eval(Container.DataItem,"pdc_totded") %>'></asp:Label>
                            </center>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblAdvamt" Style="text-align: center" CssClass="blackfnt" Text=" Adv Amt. (-) "
                                runat="server"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <center>
                        ...
                        <FooterTemplate>
                            <center>
                                <asp:Label ID="TotalNetamtvalue" runat="server" CssClass="blackfnt" Text='<%# DataBinder.Eval(Container.DataItem,"advamt") %>'></asp:Label>
                            </center>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblNetPayable" Style="text-align: center" CssClass="blackfnt" Text="Net Bal Amt."
                                runat="server"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <center>
