                            ...
                            <td colspan="2" width="50%" valign="top">
                                <table border="1" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            &nbsp;<font class="bluefnt"><asp:Label ID="lblStandardAmt" runat="server" Text="Label"></asp:Label></font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
                    ...
                    <center>
                              <asp:TextBox  ID ="balmat" Width="50" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"balamt") %>'></asp:TextBox>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <center>
                                            <asp:TextBox onblur="javascript:totalcal()" ID="incentive" Width="50" runat="server"
