...
public partial class GUI_Finance_Vendor_BA_payment_PrepareVoucher_Vendor_ViewTHCBalance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string sql1 = "select convert(varchar,balvoucherdt,06) as balvoucherdt, convert(varchar,bal_Chqdate,06) as bal_Chqdate,* from webx_THC_SUMMARY where balvoucherNo='" + voucherNo + "'";
