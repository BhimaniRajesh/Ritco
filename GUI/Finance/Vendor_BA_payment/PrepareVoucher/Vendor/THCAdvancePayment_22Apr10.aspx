<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="THCAdvancePayment.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PrepareVoucher_Vendor_THCAdvancePayment" %>
            ...
            <table border="0" style="width:9.5in" bgcolor="#808080" cellpadding="2" cellspacing="1" class="boxbg">
								   <asp:HiddenField ID="click_count" runat="server" Value="0" />
								     <tr bgcolor="#FFFFFF">
										...
										<%--<td align="left" style="width: 20%" colspan="2"><font class="blackfnt">&nbsp;Voucher Date </font></td>
										<td width="20%"><font class="bluefnt"><asp:TextBox ID="txtVoucherDate" runat="server" Width="100px" Columns="8"></asp:TextBox>
								     ...
								     <tr bgcolor="#FFFFFF">
								     	<td colspan="2" valign="top" style="width: 53%">
								     		<table border="1" width="100%">
								     		   <tr>
								     		     <td align="left" style="width: 160px"><font class="blackfnt">Standard Contract Amount</font></td>
								     		      <td align="left" style="width: 13px"><font class="bluefnt"><asp:Label ID="lblStandardAmt" runat="server" Text="Label"  ></asp:Label></font></td>
								     		   </tr>
											   
								     		   <tr>
								     		    <td align="left" style="width: 160px"><font class="blackfnt">Contract Amount (+)</font></td>
								     		     <td align="left" style="width: 13px"><font class="blackfnt"><asp:TextBox  ID="txtContractAmt" runat="server" Enabled="false" Width="70px"  ></asp:TextBox></font></td>
								     		   </tr>
								     		   <tr>
								     		    <td align="left" style="width: 160px"><font class="blackfnt">Other Amount</font></td>
								     		     <td align="left" style="width: 13px"><font class="blackfnt"><asp:TextBox id="txtOtherAmt" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		 
								     		  
								     		   <tr>
								     		    <td align="left" style="width: 160px"><font class="blackfnt">TDS Amount (-)</font></td>
								     		     <td align="left" style="width: 13px"><font class="blackfnt"><asp:TextBox id="txtTDSAmt" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
											     
								     		    <tr>
								     		    <td align="left" style="width: 160px"><font class="blackfnt">Service Tax (+)</font></td>
								     		     <td align="left" style="width: 13px"><font class="blackfnt"><asp:TextBox id="txtServiceTax" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   <tr>
								     		    <td align="left" style="width: 160px"><font class="blackfnt">Cess (+)</font></td>
								     		     <td align="left" style="width: 13px"><font class="blackfnt"><asp:TextBox id="cessamt" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   <tr>
								     		    <td align="left" style="width: 160px"><font class="blackfnt">Higher Edu. Cess (+)</font></td>
								     		     <td align="left" style="width: 13px"><font class="blackfnt"><asp:TextBox id="H_cessamt" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     	...
								     	<table border="1" width="100%">
								     		     ...
								     		     <tr>
								     		    <td align="left"><font class="blackfnt">Advance Amount Paid by</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox ID="txtAdvanceAmtPaidBy" runat="server" Enabled="false" Width="136px"></asp:TextBox></font></td>
								     		   </tr>
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">TDS type</font></td>
								     		     <td align="left"><font class="blackfnt">
										         <asp:DropDownList ID="cboTDSType" runat="server" Mode="Conditional" RenderMode="Inline" Width="152px">
										         <asp:ListItem Text="Select" Value=""></asp:ListItem>
										         </asp:DropDownList>
								     		     </font></td>
								     		   </tr>
											   <tr>
											   <td align="left" bgcolor="#FFFFFF"><font class="blackfnt">TDS Deducted For</font></td>
						                       <td align="left" bgcolor="#FFFFFF">
						                       <asp:DropDownList ID="cboTDSDeducted" runat="server"  Mode="Conditional" RenderMode="Inline" Width="152px">
						                       <asp:ListItem Text="Select" Value=""></asp:ListItem>
						                       ...
						                       <asp:ListItem Text="NonCorporate" Value="NC"></asp:ListItem>
								     		   ...
								     		   <%-- <tr>
								     		    <td align="left"><font class="blackfnt">Advance Amount (-)</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox id="txtAdvanceAmt" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   --%>
								     		    <tr>
								     		    <td align="left"><font class="blackfnt">Advance Paid </font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox id="txtAdvanceAmtPaid" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		    <tr>
								     		    <td align="left"><font class="blackfnt"><b>Balance Amount</b></font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox id="txtBalanceAmt" runat="server" Enabled="false" Width="70px" EnableViewState="true"></asp:TextBox></font></td>
								     		   </tr>
								     		   <tr>
								     		    <td align="left"><font class="blackfnt"><b>Balance Payable at</b></font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox id="txtBalancePayableAt" runat="server" Enabled="false" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
...
<asp:TemplateField>
              ...
              <asp:Label ID="lblcontractAmt"   style="text-align:center" CssClass="blackfnt" Text="Contract Amount (+)" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox   ID ="indpcamt" runat="server" Enabled="false" MaxLength="10" Columns="6"  Text='<%# DataBinder.Eval(Container.DataItem,"PCAMT") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblOtherAmt"    style="text-align:center" CssClass="blackfnt" Text="Other Amount(+) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indothamt" MaxLength="10" Columns="6"  Enabled="false" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHCHRG") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblTDSRate"    style="text-align:center" CssClass="blackfnt" Text="TDS Rate" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indtds_rate" MaxLength="10" Enabled="false" Columns="6"   runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"tds_rate") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblTDSdeduction"   style="text-align:center"  CssClass="blackfnt" Text="TDS Dedn.(-)" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indtdsded" MaxLength="10"  Enabled="false" Columns="6"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"tdsded") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblunexpamt"    style="text-align:center" CssClass="blackfnt" Text="Service Tax Rate" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="cboindsvctaxrate"  MaxLength="10" Columns="6" Enabled="false" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"svrc_rate") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblServiceTax"   style="text-align:center"  CssClass="blackfnt" Text="Service Tax (+) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indsvctax" MaxLength="10"  Enabled="false" Columns="6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"SVCTAX") %>'></asp:TextBox>
                    </center>
                </ItemTemplate>
 </asp:TemplateField>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblcess"    style="text-align:center" CssClass="blackfnt" Text="Cess (+) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indcess" MaxLength="10"  Enabled="false" Columns="6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"CESSAMT") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lbl_H_cess"    style="text-align:center" CssClass="blackfnt" Text="Higher Edu. Cess (+) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="ind_H_cess" MaxLength="10"  Enabled="false" Columns="6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"HEDU_CESS") %>'></asp:TextBox>
...
<asp:TemplateField>
              ...
              <asp:Label ID="lblAdvamt"   style="text-align:center" CssClass="blackfnt" Text=" Advance Amt. (-) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indadvamt" MaxLength="10"   onblur="javascript:calc()"  Columns="6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"ADVAMT") %>'></asp:TextBox>
                 ...
                 <FooterTemplate >
                 <center>
                         <asp:TextBox ID="TotalNetamt"  Font-Bold="true"  runat="server" Enabled="false"    Text="0.00" Columns="6"></asp:TextBox>						            
 ...
 <%--<asp:TemplateField>
              <HeaderTemplate >
              <asp:Label ID="lbldeduction"   style="text-align:center"  CssClass="blackfnt" Text="Deductions(-) " runat="server"></asp:Label>
              </HeaderTemplate>
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indothded" MaxLength="10" Enabled="false" Columns="6"   runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              <HeaderTemplate >
              <asp:Label ID="lblservicededuction"    style="text-align:center" CssClass="blackfnt" Text="Service Tax Dedn.(-) " runat="server"></asp:Label>
              </HeaderTemplate>
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indsvctaxded" MaxLength="10" Columns="6"  Enabled="false" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"SVCTAXDED") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblNetPayable"   style="text-align:center"  CssClass="blackfnt" Text="Net Balance Amt." runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indnetpay"  Enabled="false" MaxLength="10" Columns="6"   runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"NET") %>'></asp:TextBox>
