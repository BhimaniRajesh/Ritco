...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
//Added by sandeep maurya related to error (CLDM_000189) to handle double click issue
        var submit = 0;
        ...
        var NetpaymentAmt = 0;
        totdkt = "<%=totdkt %>"
        function check(txtAdvanceAmtPaid, txtBalanceAmt) {
    ...
    <div align="left">
        ...
        <br />
        <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="blackfnt" OnClick="btnSubmit_Click" OnClientClick="return CheckDouble()"/>
