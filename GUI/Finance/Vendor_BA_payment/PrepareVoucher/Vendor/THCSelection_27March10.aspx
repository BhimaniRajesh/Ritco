<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="THCSelection.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PrepareVoucher_Vendor_THCSelection" EnableEventValidation="false" enableViewStateMac="False" %>
...
<form id="form1">
    ...
    <table border="0" cellpadding="3" cols="1" style="width:9.5in" bgcolor="#808080" cellspacing="1" align="left" class="boxbg">
      ...
      <tr bgcolor="#ffffff"> 
        <td  width="205" align="left"> 
          <div align="left"><font class="blackfnt">Advance/Balance</font> 
            </div>
        </td>
        <td  width="343" align="center"> 
          <div align="left"><font class="blackfnt">
   ...
   <br />
    ...
    <p align="left"><font class="blackfnt"><b>Select THC for prepare Payment</b></font></p>
