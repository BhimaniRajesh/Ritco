        ...
        try
        {
            ...
            foreach (GridViewRow gridrow in dockdata.Rows)
            {
                ...
                if (indtdsded.Enabled)
                {
                    ...
                    {
                        string sql_bal_acct_tds_for_old = "exec usp_THCTransaction 3,'" + THCNO.Text.ToString() + "','.','" + Financial_Year + "','" + Session["empcd"].ToString() + "','" + Vno + "'";
