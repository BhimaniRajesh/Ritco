<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="THCBalancePayment.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PrepareVoucher_Vendor_THCBalancePayment" %>
...
<table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" style="width:9.5in" align="left" class="boxbg">
    ...
    <asp:HiddenField ID="click_count" runat="server" Value="0" />
      <td valign="top" height="18"  colspan="4" align="center"><b><font class="blackfnt"><b>THC Summary</b></b>
       </td>
    </tr>
    </table>
<br />
...
<table border="0" style="width:9.5in" bgcolor="#808080" cellpadding="2" cellspacing="1" class="boxbg">
								     ...
								     <tr bgcolor="#FFFFFF">
								     	<td colspan="2" width="50%" valign="top">
								     		...
								     		<tr>
								     		     <td align="left"><font class="blackfnt">Voucher date</font></td>
								     		      <td align="left"><font class="bluefnt"><asp:TextBox ID="txtVoucherDate" Enabled="true" runat="server" Width="60px" Columns="8"></asp:TextBox>
										<a href="#"  onclick="cal.select(ctl00$MyCPH1$txtVoucherDate,'anchor1','dd/MM/yyyy'); return false;"  name="anchor1" id="anchor1" ><img src="../../../../images/calendar.jpg" border="0" />
                                  </a>
						...
						dd/mm/yyyy
								     		   ...
								     		   <tr>
								     		     <td align="left"><font class="blackfnt">Standard Contract Amount</font></td>
								     		      <td align="left">&nbsp;<font class="bluefnt"><asp:Label ID="lblStandardAmt" runat="server" Text="Label"></asp:Label></font></td>
								     		   </tr>
											   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Contract Amount (+)</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox ID="txtContractAmt" Enabled="false" runat="server" Width="70px" Text="0.00" TabIndex="1"></asp:TextBox></font></td>
								     		   </tr>
								     		     ...
								     		     <tr>
								     		    <td align="left"><font class="blackfnt">Other Amount</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox id="txtOtherAmount" Enabled="false"  runat="server"  Text="0.00" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		    
								     		    <tr>
								     		    <td align="left"><font class="blackfnt">Service Tax + Cess + H.Cess (+)</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox id="txtServiceTax" Enabled="false"  runat="server"  Text="0.00" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">TDS amount (-)</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox id="txtTDSAmt" Enabled="false"  runat="server"  Text="0.00" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
											     
								     		    
								     		  <tr>
								     		    <td align="left"><font class="blackfnt">Advance Paid (-)</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox id="txtAdvPaid"  Enabled="false" runat="server"  Text="0.00" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
                                                 
											  
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Balance Amount Paid by</font></td>
								     		     <td align="left"><font class="blackfnt"><asp:TextBox ID="txtBalPaidBy" Enabled="false"  runat="server"  Text="" Width="136px"></asp:TextBox></font></td>
								     		   </tr>
								     	...
								     	<table border="1" width="100%">
								     		    ...
								     		    <tr>
								     		    <td align="left"><font class="blackfnt"><b>Balance Amount</b></font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox Enabled="false"  Font-Bold="true" id="txtBalanceAmt"  Text="0.00" runat="server" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Incentive (+)</font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox  Enabled="false" id="txtIncentive"  Text="0.00" runat="server" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Penalty (-)</font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox  Enabled="false" id="txtPenalty" Text="0.00"  runat="server" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   <tr>
								     		    <td align="left" style="height: 25px"><font class="blackfnt">Claim (-)</font></td>
								     		     <td align="left" bgcolor="#FFFFFF" style="height: 25px"><font class="blackfnt"><asp:TextBox  Enabled="false"  Text="0.00" id="txtClaim" runat="server" Width="70px"></asp:TextBox></font>
								     		     </td>
								     		   </tr>
								     		   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Handling</font>
								     		    </td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox id="txtHamali2" Enabled="false"  Text="0.00"  runat="server" Width="70px"></asp:TextBox></font>
								     		   ...
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Detention charges (+)</font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox id="txtDetention"  Enabled="false" Text="0.00"  runat="server" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Other Deduction (-)</font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox id="txtOther"  Enabled="false"  Text="0.00" runat="server" Width="70px"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt"><b>Net Amount Paid</b></font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox id="txtNetAmtPaid"  Font-Bold="true"  Enabled="false" Text="0.00"  runat="server" Width="70px" EnableViewState="false"></asp:TextBox></font></td>
								     		   </tr>
								     		   
								     		   
								     		   
								     		   <tr>
								     		    <td align="left"><font class="blackfnt">Re-assign Balance Payable At</font></td>
								     		     <td align="left" bgcolor="#FFFFFF"><font class="blackfnt"><asp:TextBox id="txtReassignBalPymtAt"  runat="server" Width="40px"></asp:TextBox></font></td>
								     		   </tr>
								     ...
								     <table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" style="width:9.5in" align="left" class="boxbg">
                              <tr class="bgbluegrey"> 
      <td valign="top" height="18"  colspan="4" align="center"><b><font class="blackfnt"><b>THC Details</b></b>
       </td>
    </tr>
    </table>
    </td></tr>
<tr><td>
    ...
    <br />
    <div align="left">
    <asp:GridView ID="dockdata" style="width:9.5in" runat="server" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey"
AllowSorting="true" AllowPaging="true" PageSize="50" PagerStyle-HorizontalAlign="left"
...
EmptyDataText="No Records Found..."
 OnRowDataBound="TDS_AT_baltime_RowDataBound"
>
...
<asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              <HeaderTemplate >
              <asp:Label ID="lblActualUnloadingDate" CssClass="blackfnt" Text="Unloading Date" runat="server"></asp:Label>
              </HeaderTemplate>
                <ItemTemplate>
                    <center>
...
<asp:TemplateField HeaderStyle-HorizontalAlign="Center">
 ...
 <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
  ...
  <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              ...
              <asp:Label ID="lblTDSdeduction_rate" CssClass="blackfnt" Text="TDS Rate " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  onblur="javascript:totalcal()"  ID ="indtdsded_rate" Width="50" runat="server" Text='0.00'></asp:TextBox>
 ...
 <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              ...
              <asp:Label ID="lblIncentive" CssClass="blackfnt" Text="Incentive(+) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  onblur="javascript:totalcal()"  ID ="incentive" Width="50" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
 ...
 <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              ...
              <asp:Label ID="lblPenalty" CssClass="blackfnt" Text="Penalty(-) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  onblur="javascript:totalcal()"  ID ="indpenalty" Width="50" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
 ...
 <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              ...
              <asp:Label ID="lblClaim" CssClass="blackfnt" Text="Claim(-) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox   onblur="javascript:totalcal()" ID ="indclaim" Width="50" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
 ...
 <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              <HeaderTemplate>
              <asp:Label ID="lblHamali" CssClass="blackfnt" Text="Handling Chrg" runat="server" Width="100"></asp:Label>
              </HeaderTemplate>
                <ItemTemplate>
                    <center>
                              ...
                              <asp:TextBox  onblur="javascript:totalcal()"  ID ="indhamali" Width="50" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
...
<asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              ...
              <asp:Label ID="lblDetention" CssClass="blackfnt" Text="Detention(+)" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox   onblur="javascript:totalcal()" ID ="inddetention" Width="50" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
 ...
 <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              ...
              <asp:Label ID="lbldeduction" CssClass="blackfnt" Text="Deductions(-) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  onblur="javascript:totalcal()"  ID ="indothded" Width="50" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
 ...
 <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
              ...
              <asp:Label ID="lblNetPayable" CssClass="blackfnt" Text="Net Payable" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                 ...
                 <FooterTemplate >
                    <center>
                         <asp:TextBox ID="TotalNetBalamt"  Font-Bold="true"  runat="server" Enabled="false"    Text="0.00" Columns="6"></asp:TextBox>						            
                     </center>                                                          
                 </FooterTemplate>
 </asp:TemplateField>
...
<tr><td>
<div align="left">
	<p align="left">&nbsp;&nbsp;&nbsp;&nbsp;<font class="blackfnt"><b><u>Note :</u></b> Please enter the payment details if advance amount >0 .</font></p>
</div>
<br />
...
<table border="0" cellspacing="1" cellpadding="4" style="width:9.5in" align="left" class="boxbg">
          ...
          <td colspan="4" align="center"><font class="blackfnt">
           Payment Details</font>
				        ...
				        <ContentTemplate>
				        <asp:DropDownList ID="cboModeOfTransaction" runat="server" Width="60px" OnSelectedIndexChanged="cboModeOfTransaction_SelectedIndexChanged" AutoPostBack="true" onchange="javascript:cahs_N_bank(this)">
          ...
          <td align="left"> 
              ...
              <font class="blackfnt"><asp:TextBox id="txtChequeDate" runat="server" Width="70px"  onblur="javascript:ValidateForm(this)"></asp:TextBox><a href="#"  onclick="cal.select(ctl00$MyCPH1$txtChequeDate,'anchor2','dd/MM/yyyy'); return false;"  name="anchor2" id="anchor2" ><img src="../../../../images/calendar.jpg" border="0" /> 
                                        </a>dd/mm/yyyy 
             </font> 
         ...
         <td align="left"><font class="blackfnt">Payment Amount</font></td>
          <td align="left"> 
              ...
              <font class="blackfnt"><asp:TextBox id="txtPaymentAmt" runat="server"  Enabled="false" Width="70px" Text="0.00"></asp:TextBox></font> 
          
          </td>
          <td align="left"><font class="blackfnt">Cash Amount</font></td>
          <td align="left"> 
              <font class="blackfnt"><asp:TextBox id="txtCashAmount" runat="server" Width="70px" Enabled="false" Text="0.00"></asp:TextBox></font>
          </td>
          </tr>
          <tr bgcolor="#ffffff"> 
         
          <td align="left" ><font class="blackfnt">Narration</font></td>
          <td align="left" > 
              <font class="blackfnt"><asp:TextBox ID="txtNarration" runat="server" Height="56px" Width="200px" TextMode="MultiLine"></asp:TextBox></font> 
          </td>
           <td align="left" ><font class="blackfnt">Behati NO/Date/Amount</font></td>
          <td align="left" > 
              <font class="blackfnt"><asp:TextBox ID="txtBehatiNo" runat="server" Height="56px" Width="200px" TextMode="MultiLine"></asp:TextBox></font> 
          </td>
          </tr>
						 </table>
						 </td></tr>
