    ...
    <table border="0" class="boxbg" cellpadding="1" cellspacing="1" style="width:9.5in">
        ...
        <tr bgcolor="#FFFFFF">
         ...
         <td align="left">
                ...
                <asp:LinkButton ID="LinkButton2" CssClass="bluefnt" runat="server" Font-Bold="false" Text="PRS/DRS-Staff" PostBackUrl="./PaymentAgainstBillEntry/PDC_VER1/PDCSearch.aspx" /><%--../Advice/AdviceViewPrintstep1.aspx--%>
                <font class="blackfnt">|</font>
                ...
                <font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton4" CssClass="bluefnt" runat="server" Font-Bold="false" Text="Others" PostBackUrl="~/GUI/Finance/Vendor_BA_payment/ExpenseEntry/OtherBillentry.aspx" />
            </td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td align="left" width="35%">
             ...
             <td align="left">
                ...
                <font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton8" CssClass="bluefnt" runat="server" Font-Bold="false" Text="Others" PostBackUrl="./VendorBillEntry/Others/THCSearch.aspx?doctype=Others"  />
            </td>
        </tr>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td align="left" width="35%">
             ...
             <td align="left">
               ...
               <%--<font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton12" CssClass="bluefnt" runat="server" Font-Bold="false" Text="Others" PostBackUrl="~/GUI/Finance/Vendor_BA_payment/ExpenseEntry/OtherBillentry.aspx" />--%>
            </td>
