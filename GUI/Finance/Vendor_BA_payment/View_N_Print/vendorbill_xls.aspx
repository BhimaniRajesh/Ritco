...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            %>
            <table width="95%" cellspacing="1" cellpadding="3" align="center" bgcolor="#808080"
                class='<%=boxbg%>'>
                <tr class='<%=bgbluegrey%>'>
            ...
            <br />
            <asp:GridView ID="GridView1" runat="server" align="center" BorderWidth="1" CellPadding="2"
                HeaderStyle-CssClass='<%=bgbluegrey%>' PagerStyle-HorizontalAlign="left" Visible="false"
                CssClass="blackfnt" BackColor="white" FooterStyle-CssClass='<%=bgbluegrey%>'
                AllowPaging="true" PageSize="25" OnPageIndexChanging="pgChange" AllowSorting="False"
                RowStyle-HorizontalAlign="Right" AutoGenerateColumns="false" PagerSettings-FirstPageText="[First]"
            ...
            <asp:GridView ID="GridView2" runat="server" align="center" BorderWidth="1" CellPadding="2"
                HeaderStyle-CssClass='<%=bgbluegrey%>' PagerStyle-HorizontalAlign="left" Visible="false"
                CssClass="blackfnt" BackColor="white" FooterStyle-CssClass='<%=bgbluegrey%>'
                AllowPaging="true" PageSize="25" RowStyle-HorizontalAlign="Right" AutoGenerateColumns="false"
