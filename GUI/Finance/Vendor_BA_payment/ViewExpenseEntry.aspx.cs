...
//from webx_vendorbill_det a , webx_vendorbill_hdr b where a.billno = b.billno
            ...
            while (dr.Read())
            {
                ...
                lblSBCessRate.Text = dr["SBCRate"].ToString();
                lblSBCessValue.Text = dr["SBCess"].ToString();

                lblKKCessRate.Text = dr["KKCRate"].ToString();
                lblKKCessValue.Text = dr["KKCess"].ToString();
