<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Main_ver1.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_Main" %>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td align="left" width="35%">
             ...
             <td align="left">
               ...
               <font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton12" CssClass="bluefnt" runat="server" Font-Bold="false" Text="Others - BIll Entry (Under Test)" PostBackUrl="ExpenseEntry/OtherBillentry.aspx" />
          </td>
