...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
	...
	<div align="left">
		<table style="width: 9.5in" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#808080" class="boxbg">
			<tr class="bgbluegrey">
				<td align="center" colspan="3"><font class="blackfnt"><b>THC Financial Edit Multiple Advance
				</b></font></td>
			</tr>
			...
			<tr bgcolor="#FFFFFF">
				<td colspan="2" align="center">
					<asp:Button ID="btnsubmit1" runat="server" Text="Submit" CssClass="blackfnt" OnClick="btnsubmit1_Click" /></td>
			</tr>
		</table>
	</div>
