...
public partial class VendorPayment_new_vendorbill_xls : System.Web.UI.Page
{
    ...
    public static string DOCNO, reppara;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        str_GenerateBillNo = Request.QueryString["strGenerateBillNo"].ToString();
    ...
    public void disp()
    {
        ...
        string sql2 = "select BILLNO, BILLSF, DOCNO, DOCSF, PCAMT, OTHAMT, SVCTAX, CESS, ADVPAID,OTHDED, SVCTAXDED, voucherNo, paydt,netpay,tdsded,tds_rate,svctaxrate,discount from WEBX_VENDORBILL_DET where BILLNO='" + str_GenerateBillNo + "' ";
