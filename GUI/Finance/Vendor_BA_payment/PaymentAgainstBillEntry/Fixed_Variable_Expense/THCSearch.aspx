<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="THCSearch.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_VendorBillEntry_Vendor_THCSearch" %>
...
function ClearSelection(param)
{
     ...
     if(param=="VENDOR")
     {
        ...
        //document.getElementById('ctl00$MyCPH1$txtVehicleNo').value="";
     }
...
function validcheck()
{
  ...
  if (txtDocNo == "" && txtVendorBillNo=="" && txtVehicleNo=="")
      {
...
<tr><td>
                    <table WIDTH="60%" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#808080" class="boxbg">
                        <tr class="bgbluegrey"> 
                        ...
                        <tr bgcolor="#ffffff"> 
                          ...
                          <td  valign="top" align="left">
                          <asp:TextBox ID="txtVehicleNo" runat="server" Width="164px" onchange="javascript:ClearSelection('VN')"></asp:TextBox><font class="blackfnt">(If Multiple - separated by comma)</font>
                            </td>
