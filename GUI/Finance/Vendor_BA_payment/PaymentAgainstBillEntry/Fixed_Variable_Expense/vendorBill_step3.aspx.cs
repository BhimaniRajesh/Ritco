...
public partial class VendorPayment_new_vendorBill_step3 : System.Web.UI.Page
{

    public static string billno_nos, vendortype, vendor, fromdate, todt, fromdate1, todt1, checkeddockno;
    public int totdkt = 0;
    ...
    public static string sqlTHCPDC, voucherNo;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        GenerateBillNo = billno;
        {
            foreach (GridViewRow gridrow in dockdata.Rows)
            {
                ...
                SqlCommand sqlcmd2 = new SqlCommand(sqlBill_Det, conn);
                ...
                SqlCommand sqlcmd4 = new SqlCommand(sqlTHC, conn);
        ...
        string sqlBill_HDR = "INSERT INTO WEBX_VENDORBILL_HDR (BILLNO, BILLSF, BRCD, BILLDT, VENDORCODE, VENDORNAME, VENDORBILLDT,VENDORBILLNO, PCAMT, ADVAMT, OTHAMT, SVCTAX, DUEDT,ENTRYBY, ENTRYDT, REMARK, PAYDT, OTHERDED, TDSRATE, TDS,SVCTAXDED, OTHERCHRG, NETAMT,tdsfor,cessamt,tdsgrpcode,tdsgrpdesc,betype,tdsacccode,tdsaccdesc,discount,pendamt) VALUES ('" + GenerateBillNo + "','" + "." + "','" + branchcode + "','" + fn.Mydate1(billdt.Text) + "','" + vendor + "','" + fn.GetVendor(vendor) + "','" + fn.Mydate1(vendorbilldt.Text) + "','" + vendorbillno.Text + "','" + totindpcamt + "','" + totadvanceamt + "','" + tototheramount + "','" + totservicestax + "','" + fn.Mydate1(duedt.Text) + "','" + Session["empcd"].ToString() + "',getdate(),'" + Remarks.Text.ToString() + "','" + "" + "','" + tototherdeduction + "','" + tottdsrate + "','" + tottdsdeduction + "','" + totsvctdeduction + "','" + "" + "','" + totnetpayment + "','" + "" + "','" + totcess_1 + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + totnetpayment + "')";
        SqlCommand sqlcmd3 = new SqlCommand(sqlBill_HDR, conn);
