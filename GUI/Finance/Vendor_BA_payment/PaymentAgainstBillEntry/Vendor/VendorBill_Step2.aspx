<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="VendorBill_Step2.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_Vendor_VendorBill_Step2"  enableViewStateMac="False"  EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
     <script language="javascript" type="text/javascript">
        ...
        function CheckDocketSelection(txtdocketlist,txtdocketlist_count)
        {
            ...
            var grid=document.getElementById("ctl00_MyCPH1_docdata");
      ...
      <tr bgcolor="#FFFFFF"> 
        ...
        <td  width="343" align="left"> 
          <div align="left"><font class="blackfnt">
              <asp:Label ID="lblDocDate" runat="server" Text="-"></asp:Label></font></div>
        </td>
      </tr>
      <tr bgcolor="#FFFFFF"> 
        <td  width="205" align="left"> 
        ...
        <td  width="343" align="center"> 
          <div align="left"><font class="blackfnt">
              <asp:Label ID="lblDocType" runat="server" Text="-"></asp:Label></font></div>
        </td>
      </tr>
      <tr bgcolor="#FFFFFF"> 
        <td  width="205" align="left"> 
