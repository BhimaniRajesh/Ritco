...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <table border='<%=strborder %>' style="width: 6.7in" cellspacing="1" cellpadding="3"
            ...
            <asp:GridView ID="GridView1" runat="server" align="left" BorderWidth="1" CellPadding="2"
                HeaderStyle-CssClass='<%=bgbluegrey%>' PagerStyle-HorizontalAlign="left" CssClass="blackfnt"
                BackColor="white" FooterStyle-CssClass='<%=bgbluegrey%>' AllowPaging="true" PageSize="25"
                Style="width: 6.7in" OnPageIndexChanging="pgChange" AllowSorting="False" RowStyle-HorizontalAlign="Right"
