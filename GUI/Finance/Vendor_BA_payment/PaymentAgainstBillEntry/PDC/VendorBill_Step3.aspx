<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="VendorBill_Step3.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_Vendor_VendorBill_Step3" %>
...
function calculation(indothamt,othamt,inddiscount,totdiscount,cboindsvctaxrate,indsvctax,indcess,indadvamt,indothded,indsvctaxded,indtds_rate,indtdsded,indnetpay,indpcamt,advamt,netamt,pcamt,cessamt,tdsded,othded,svctaxded,svctax,hedu_cess)
  {
	var totdkt="<%=totdkt %>"
	var netamount=0
	var billamt=0;
	...
	if (totdkt==1)
	{
			...
			varnetamt=parseFloat(varindpcamt)+parseFloat(varindothamt)+parseFloat(varindsvctax)+parseFloat(varindcess)+parseFloat(var_H_indcess)-parseFloat(varindadvamt)-parseFloat(varindothded)-parseFloat(varindsvctaxded)-parseFloat(varindtdsded)-parseFloat(varinddiscount)
...
function roundit(Num)
   ...
   <table cellspacing="1" style="width:10in" border="0" align="left" >
    ...
    <table border="0" cellpadding="3" colspan="1" style="width:6in" bgcolor="#808080" cellspacing="1" align="center" class="boxbg">
     ...
     <br />
          <table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" width="80%"  align="center" class="boxbg">
    <tr class="bgbluegrey"> 
    ...
    <br />
     ...
     <table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" width="80%" height="189" align="center" class="boxbg">
    <tr> 
      ...
      <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102" class="blackfnt"><asp:TextBox id="billdt" onblur="javascript:ValidateForm(this)" runat="server" Width="70px"></asp:TextBox>  
        <a href="#"  onclick="cal.select(ctl00$MyCPH1$billdt,'anchor3','dd/MM/yyyy'); return false;"  name="anchor3" id="anchor3" ><img src="../../../../images/calendar.jpg" border="0" /> 
                                  </a>DD/MM/YYYY 
    ...
    <tr> 
      ...
      <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="222"><asp:TextBox id="vendorbillno" runat="server" Width="70px"  onblur="javascript:this.value=this.value.toUpperCase()"></asp:TextBox> </td>
    </tr>
    
    
    <tr> 
      <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="129"><font class="blackfnt">Vendor Bill date</font></td>
      <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102" class="balckfnt"><asp:TextBox  onblur="javascript:ValidateForm(this)" id="vendorbilldt" runat="server" Width="70px"></asp:TextBox>  <a href="#"  onclick="cal.select(ctl00$MyCPH1$vendorbilldt,'anchor1','dd/MM/yyyy'); return false;"  name="anchor1" id="anchor1" ><img src="../../../../images/calendar.jpg" border="0" /> 
                                  </a>
       
      </td>
      <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="166"><font class="blackfnt">Due date</font></td>
      <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="222" class="balckfnt"><font class="blackfnt"> <asp:TextBox id="duedt"  onblur="javascript:ValidateForm(this)" runat="server" Width="70px"></asp:TextBox>
       
      <a href="#"  onclick="cal.select(ctl00$MyCPH1$duedt,'anchor2','dd/MM/yyyy'); return false;"  name="anchor2" id="anchor2" ><img src="../../../../images/calendar.jpg" border="0" /> 
                                  </a>DD/MM/YYYY 
      </td>
    </tr>
    <tr> 
...
<asp:TemplateField>
              ...
              <asp:Label ID="lblcontractAmt" CssClass="blackfnt" Text="Contract Amount (+)" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox   Enabled="false" ID ="indpcamt" runat="server" MaxLength="10" Columns="6"  Text='<%# DataBinder.Eval(Container.DataItem,"PCAMT") %>'></asp:TextBox>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblOtherAmt" CssClass="blackfnt" Text="Other Amount(+) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  Enabled="false"  ID ="indothamt" MaxLength="10" Columns="6"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHCHRG") %>'></asp:TextBox>
...
<asp:TemplateField>
              ...
              <asp:Label ID="lblAdvamt" CssClass="blackfnt" Text=" Advance Paid (-) " runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indadvamt" MaxLength="10" Columns="6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"ADVAMT") %>'></asp:TextBox>
                    </center>
                </ItemTemplate>
 </asp:TemplateField>
 <asp:TemplateField>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblTDSRate" CssClass="blackfnt" Text="TDS Rate" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox Enabled="false" ID ="indtds_rate" MaxLength="10" Columns="6"   runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"tds_rate") %>'></asp:TextBox>
                              <%--<asp:TextBox Enabled="false" ID ="indtds_rate" MaxLength="10" Columns="6"   runat="server" Text="1.133"></asp:TextBox>--%>
