    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div align="left">
                ...
                <table border='<%=strborder %>' style="width: 6.7in" cellspacing="1" cellpadding="3" align="left" bgcolor="#808080"
                    class='<%=boxbg%>'>
                    <tr class='<%=bgbluegrey%>'>
                ...
                <asp:GridView ID="GridView1" runat="server" align="left" BorderWidth="1" CellPadding="2"
                    ...
                    AutoGenerateColumns="false" Width="6.7in" PagerSettings-FirstPageText="[First]"
