...
{
    public static string billno_nos, vendortype, vendor, fromdate, todt, fromdate1, todt1, checkeddockno, RouteMode = "", Pdcty = "", Financial_Year="";
    public int totdkt = 0;
