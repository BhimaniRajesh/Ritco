...
public partial class GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_Vendor_vendorbill_xls : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        string sql = "select BILLNO,VENDORNAME,convert(varchar,VENDORBILLDT,6) as VENDORBILLDT,PCAMT,OTHAMT,SVCTAX,CESSAMT,convert(varchar,BILLDT,6) as BILLDT,VENDORBILLNO,convert(varchar,DUEDT,6) as DUEDT,ADVAMT,OTHERDED,SVCTAXDED,TDS,NETAMT,* from WEBX_VENDORBILL_HDR where BILLNO='" + str_GenerateBillNo + "' ";
