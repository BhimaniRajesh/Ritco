<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="VendorBill_Done.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_RunSheet_VendorBill_Done" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
  ...
  <tr>
   ...
   <tr>
    ...
    <td  align="right" bgcolor="#FFFFFF" height="18" colspan="1"><a href="Javascript:ViewPrint('<%=Request.QueryString.Get("GenerateBillNo")%>',0)"><font class="blklnkund">View</font></a> |<a href="Javascript:ViewPrint('<%=Request.QueryString.Get("GenerateBillNo")%>',1)"><font class="blklnkund">Print </font></a>| <font class="blklnkund">XLS</font> | <font class="blklnkund">Email </font></td>
  ...
  <tr  bgcolor="#FFFFFF">
    ...
    <td width="100%" align="left" bgcolor="#FFFFFF" height="18" colspan="3"><font class="blackfnt" color="#0000FF"><a href="#"><font class="blklnkund">Enter more Vendor Bills</font></a></font></td>
  </tr>
  ...
  <tr  bgcolor="#FFFFFF">
    ...
    <td width="100%" align="left" bgcolor="#FFFFFF" height="18" colspan="3"><font class="blackfnt" color="#0000FF"><a href="#"><font class="blklnkund">View & Print Bill Entries</font></a></font></td>
  </tr>
