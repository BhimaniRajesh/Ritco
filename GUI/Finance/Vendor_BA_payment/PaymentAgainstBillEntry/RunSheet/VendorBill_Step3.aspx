<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="VendorBill_Step3.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_RunSheet_VendorBill_Step3" %>
...
<asp:TemplateField>
 ...
 <asp:TemplateField>
              ...
              <asp:Label ID="lblTDSRate" CssClass="blackfnt" Text="TDS Rate" runat="server"></asp:Label>
                ...
                <ItemTemplate>
                    <center>
                              <asp:TextBox  ID ="indtds_rate" MaxLength="10" Columns="6"   runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"tds_rate") %>'></asp:TextBox>
