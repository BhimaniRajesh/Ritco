...
public partial class GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_PendingTHCAdvanceCheque_PendingTHCAdvanceCheque : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (GenerateArgumentAdvanceCheque() != "")
        {
            ...
            string sqlAdvanceChequeInsert = "exec Usp_Thc_AdvanceInstalment_Det_InsertAdvanceChequePending '" + GenerateArgumentAdvanceCheque() + "','" + Session["empcd"].ToString() + "'";
