<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="PendingTHCAdvanceChequeDone.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_PendingTHCAdvanceCheque_PendingTHCAdvanceChequeDone" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <script language="javascript" type="text/javascript">
        function ViewPrint(arg1, arg2, DT, MODE, chqNo, chqDt, amt, PayACC) {
            window.open("../Fixed_Variable_Expense/VendorBillVeiw1.aspx?strGenerateBillNo=" + arg1 + "," + arg2 + "," + DT + "," + MODE + "," + chqNo + "," + chqDt + "," + amt + "," + PayACC, "es", "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=850,height=550,status=no,left=60,top=100");
        }
    </script>
    <br />
    <div align="left">
