...
function fsubmit()
{
        if(document.getElementById(Form_name+"cbovendortype").value=="0")
        {
            alert("Plz select Vendor Type !!!")
            document.getElementById(Form_name+"cbovendortype").focus();
            return false
        }
         if(document.getElementById(Form_name+"cbovendor").value=="0")
        {
            alert("Plz select Vendor !!!")
            document.getElementById(Form_name+"cbovendor").focus();
            return false
        }
        if(document.getElementById(Form_name+"CBOPdcty").value=="")
        {
            alert("Plz select PDC Type !!!")
            document.getElementById(Form_name+"CBOPdcty").focus();
            return false
        }
        ...
        <table border="0" cellpadding="3"  style="width:9.5in" bgcolor="#808080" cellspacing="1" class="boxbg">
                              ...
                              <tr bgcolor="#FFFFFF"> 
                                ...
                                <asp:UpdatePanel ID="updatepanel2" runat="server">
                                  <ContentTemplate>
                                   <asp:DropDownList ID="cbovendortype"  CssClass="blackfnt"  runat="server" Width="170px" AutoPostBack="true" OnSelectedIndexChanged="cboVendorType_SelectedIndexChanged">
