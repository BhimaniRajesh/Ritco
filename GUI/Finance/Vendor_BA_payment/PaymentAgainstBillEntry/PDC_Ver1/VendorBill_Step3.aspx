<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="VendorBill_Step3.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PaymentAgainstBillEntry_Vendor_VendorBill_Step3" %>
	  ...
	  if (dt>server_dt)
				                {
						                ...
						                document.getElementById(Frmnae+"billdt").focus();
						                return false;
				                }
		 ...
		 j = i + 2 ;
                 ...
                 if(j < 10)
                {
                    ...
                    mDerivedControlName_indsvctax = "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$indsvctax"
                     mDerivedControlName_indtds_rate= "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$indtds_rate"
                     mDerivedControlName_ind_H_cess= "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$ind_H_cess"
                     mDerivedControlName_indadvamt= "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$indadvamt"
                      mDerivedindTDS_additional= "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$indTDS_additional"
                   ...
                   document.getElementById(mDerivedControlName_indsvctax).disabled=false
                    document.getElementById(mDerivedControlName_indcess).disabled=false
                     document.getElementById(mDerivedControlName_indtdsded).disabled=false
                      ...
                      document.getElementById(mDerivedControlName_indothamt).disabled=false
                      document.getElementById(mDerivedControlName_indpcamt).disabled=false
                           document.getElementById(mDerivedControlName_indtds_rate).disabled=false 
                             document.getElementById(mDerivedControlName_ind_H_cess).disabled=false  
                             document.getElementById(mDerivedControlName_indadvamt).disabled=false    
                               document.getElementById(mDerivedindTDS_additional).disabled=false                   
                }
                else
                {
                    ...
                    mDerivedControlName_inddiscount = "ctl00$MyCPH1$dockdata$ctl"+ j + "$inddiscount"
                    mDerivedControlName_indadvamt = "ctl00$MyCPH1$dockdata$ctl" + j + "$indadvamt"
                    mDerivedControlName_indcess = "ctl00$MyCPH1$dockdata$ctl" + j + "$indcess"
                    mDerivedControlName_indothded = "ctl00$MyCPH1$dockdata$ctl" + j + "$indothded"
                    mDerivedControlName_indsvctaxded = "ctl00$MyCPH1$dockdata$ctl"+ j + "$indsvctaxded"
                    mDerivedControlName_indtdsded = "ctl00$MyCPH1$dockdata$ctl"+ j + "$indtdsded"
                    mDerivedControlName_indnetpay = "ctl00$MyCPH1$dockdata$ctl"+ j + "$indnetpay"
                    mDerivedControlName_indsvctax = "ctl00$MyCPH1$dockdata$ctl" + j + "$indsvctax"
                      mDerivedControlName_indtds_rate= "ctl00$MyCPH1$dockdata$ctl"+ j + "$indtds_rate"
                       mDerivedControlName_ind_H_cess= "ctl00$MyCPH1$dockdata$ctl" + j + "$ind_H_cess"
                       mDerivedControlName_indadvamt= "ctl00$MyCPH1$dockdata$ctl" + j + "$indadvamt"
                        mDerivedindTDS_additional= "ctl00$MyCPH1$dockdata$ctl" + j + "$indTDS_additional"
...
function calculation(indothamt,othamt,inddiscount,totdiscount,cboindsvctaxrate,indsvctax,indcess,indadvamt,indothded,indsvctaxded,indtds_rate,indtdsded,indnetpay,indpcamt,advamt,netamt,pcamt,cessamt,tdsded,othded,svctaxded,svctax,hedu_cess,pcamt_oth,TDS_oth,TDS_Oth_rate)
  {
	var totdkt="<%=totdkt %>"
	var netamount=0
	var billamt=0;
	...
	if (totdkt==1)
	{
			...
			var_H_indcess=parseFloat(hedu_cess.value)
			...
			varindpcamt_oth=parseFloat(pcamt_oth.value)
			varTDS_Oth_rate=parseFloat(TDS_Oth_rate.value)
			
			
			if(parseFloat(varindpcamt_oth-varinddiscount-varindsvctaxded-varindothded)<0)
            {
                alert("Total Deduction Should Be Less Than Ohter Contract Amount")
                return false;
            }
           
			TDS_oth.value=roundit((varindpcamt_oth -varinddiscount- varindsvctaxded-varindothded )* varTDS_Oth_rate/100)
			// alert("hi...1")
			varindtds_oth=parseFloat(TDS_oth.value)
			...
			{		
					...
					var_H_indcess= Math.round((parseInt(varindsvctax))* parseFloat(0.01))
					indsvctax.value=(varindsvctax)
					indcess.value=(varindcess)
					hedu_cess.value=(var_H_indcess)
			}		 
			...
			//alert("1--"+TDS_Oth_rate.value)
			if(isNaN(TDS_Oth_rate.value))
			{
...
//			}
		//	alert("hi...3")
//			if(parseFloat(varindtds_rate.value)>100)
//			{
...
//			}
			...
			//indtdsded.value=Math.round((varindpcamt)* varindtds_rate/100)
			...
			varnetamt=parseFloat(varindpcamt_oth)-parseFloat(varindtds_oth)+parseFloat(varindpcamt)+parseFloat(varindothamt)+parseFloat(varindsvctax)+parseFloat(varindcess)+parseFloat(var_H_indcess)-parseFloat(varindadvamt)-parseFloat(varindothded)-parseFloat(varindsvctaxded)-parseFloat(varindtdsded)-parseFloat(varinddiscount)
...
//		{
		   ...
		   varnetamt=0
			...
			varindnetpay=parseFloat(indnetpay.value)
			varindtds_rate=parseFloat(indtds_rate.value)
			varpcamt_oth=parseFloat(pcamt_oth.value)
			varTDS_Oth_rate=parseFloat(TDS_Oth_rate.value)
			varinddiscount=parseFloat(inddiscount.value)
			varindsvctaxrate=parseFloat(cboindsvctaxrate.value)
			//TDS_oth.value=Math.round(varpcamt_oth*varTDS_Oth_rate/100)
////			alert(varinddiscount)
////			alert(varpcamt_oth)
////			alert(varindsvctaxded)
////			alert(varindothded)
////			
            if(parseFloat(varpcamt_oth-varinddiscount-varindsvctaxded-varindothded)<0)
            {
                alert("Total Deduction Should Be Less Than Ohter Contract Amount")
                return false;
            }
            
			TDS_oth.value=roundit((varpcamt_oth-varinddiscount-varindsvctaxded-varindothded )* varTDS_Oth_rate/100)
			//routecd=routecd[i]
			varindtds_oth=parseFloat(TDS_oth.value)
...
//			}
			...
			//alert(varindadvamt)
			//alert(varnetamt)
			varnetamt=parseFloat(varpcamt_oth)- parseFloat(TDS_oth.value) + parseFloat(varindpcamt)+parseFloat(varindothamt)+parseFloat(varindsvctax)+parseFloat(varindcess)+parseFloat(var_H_indcess)-parseFloat(varindadvamt)-parseFloat(varindothded)-parseFloat(varindsvctaxded)-parseFloat(varindtdsded)-parseFloat(varinddiscount)
			//alert(varnetamt)
			...
			gndsvctax = gndsvctax + varindsvctax
			gndcess = gndcess + varindcess
			gnd_H_cess = gnd_H_cess + varindcess
			gndindtottds=gndindtottds + parseFloat(varindtdsded) 
			
			gnddiscount = gnddiscount + varinddiscount
			
			gndpcamt_oth = gndpcamt_oth + varpcamt_oth
		...
		for (i=0;i<totdkt;i++)
		{
		 ...
		 j = i + 2 ;
                 ...
                 if(j < 10)
                {
                    ...
                    mDerivedControlName_indsvctax = "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$indsvctax"
                    mDerivedControlName_ind_H_cess = "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$ind_H_cess"
                    mDerivedControlName_ind_Pacmt_oth = "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$indpcamt_additional"
                    mDerivedControlName_ind_TDS_oth = "ctl00$MyCPH1$dockdata$ctl" + "0" + j + "$indTDS_additional"
                    //alert(mDerivedControlName_ind_Pacmt_oth)
                }
                else
                {
                    mDerivedControlName_indothamt = "ctl00$MyCPH1$dockdata$ctl" + j + "$indothamt"
                    ...
                    mDerivedControlName_indsvctax = "ctl00$MyCPH1$dockdata$ctl" + j + "$indsvctax"
                    mDerivedControlName_ind_H_cess = "ctl00$MyCPH1$dockdata$ctl"  + j + "$ind_H_cess"
                    mDerivedControlName_ind_Pacmt_oth = "ctl00$MyCPH1$dockdata$ctl"  + j + "$indpcamt_additional"
                    mDerivedControlName_ind_TDS_oth = "ctl00$MyCPH1$dockdata$ctl" + j + "$indTDS_additional"
                ...
                if(document.getElementById(mDerivedControlName_indothamt))
                {
                    ...
                    var_H_indcess=parseFloat(var_H_indcess)+parseFloat(document.getElementById(mDerivedControlName_ind_H_cess).value)
                    ...
                    vartotPacmt_oth=parseFloat(vartotPacmt_oth)+parseFloat(document.getElementById(mDerivedControlName_ind_Pacmt_oth).value)
                    vartotTDS_oth=parseFloat(vartotTDS_oth)+parseFloat(document.getElementById(mDerivedControlName_ind_TDS_oth).value)
                }
               //-- 
               // alert(vartotPacmt_oth)
               document.getElementById("ctl00$MyCPH1$totPacmt_oth").value=vartotPacmt_oth
               document.getElementById("ctl00$MyCPH1$totTDSamt_oth").value=vartotTDS_oth
            ...
            function calcolamt(indothamt,othamt,inddiscount,totdiscount,cboindsvctaxrate,indsvctax,indcess,indadvamt,indothded,indsvctaxded,indtds_rate,indtdsded,indnetpay,indpcamt,advamt,netamt,pcamt,cessamt,tdsded,othded,svctaxded,svctax)
                {
	                    ...
	                    grd_H_indcess=parseFloat(H_cessamt.value)
	                    ...
	                    //alert(varindsvctax)
	                   // alert(totchrg)
	                    totchrg=grdindpcamt-grdindadvamt+grd_H_indcess+grdindothamt+grdindsvctax+grdindcess-grdindothded-grdindsvctaxded-grdindtdsded-grddiscount
	                    tdsval=0	
	                    //alert(totchrg)
...
function roundit(Num)
    ...
    <div>
        <table cellspacing="1" style="width: 10in" border="0" align="left">
            ...
            <tr>
                <td>
                    <font class="blackfnt"><b><a href="../../../../welcome.aspx"><font class="blklnkund">
                        <strong>Module</strong></font></a><strong> &gt; </strong></font><font class="blackfnt">
                            <strong>Vendor Payment</strong> </font>&gt; <font class="bluefnt"><strong>Vendor Bill
                                Entry </strong></font>
                </td>
            </tr>
            <tr>
            ...
            <tr align="center">
                <td style="height: 100%" align="center" colspan="3">
                    ...
                    <table border="0" cellpadding="3" colspan="1" style="width: 6in" bgcolor="#808080"
                        ...
                        <tr bgcolor="#FFFFFF">
                            ...
                            <td width="343" align="left">
                                <font class="blackfnt">
                                    <asp:Label ID="lblVendorType" runat="server" Text=""></asp:Label></font>
                            </td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                            <td width="205" style="height: 20px">
                            ...
                            <td width="343" align="left">
                                <font class="blackfnt">
                                    <asp:Label ID="lblVendor" runat="server" Text="Label"></asp:Label></font>
                            </td>
                        </tr>
                    </table>
                    <br />
                    <table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" width="80%" align="center"
                        class="boxbg">
                        <tr class="bgbluegrey">
                            <td valign="top" height="18" colspan="4" align="center">
                                <b><font class="blackfnt">
                                    <asp:HiddenField ID="click_count" Value="0" runat="server" /></b>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <br />
                    <table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" width="80%" height="189"
                        ...
                        <tr>
                            ...
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="129">
                                <font class="blackfnt" color="red">System Generated...</font></td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="129">
                                <font class="blackfnt">Bill Entry date</font></td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102" class="blackfnt">
                                <asp:TextBox ID="billdt" onblur="javascript:ValidateForm(this)" runat="server" Width="70px"></asp:TextBox>
                                <a href="#" onclick="cal.select(ctl00$MyCPH1$billdt,'anchor3','dd/MM/yyyy'); return false;"
                        ...
                        <tr>
                            ...
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="222">
                                <asp:TextBox ID="vendorbillno" runat="server" Width="70px" onblur="javascript:this.value=this.value.toUpperCase()"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="129">
                                <font class="blackfnt">Vendor Bill date</font></td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102" class="balckfnt">
                                <asp:TextBox onblur="javascript:ValidateForm(this)" ID="vendorbilldt" runat="server"
                                    Width="70px"></asp:TextBox>
                                <a href="#" onclick="cal.select(ctl00$MyCPH1$vendorbilldt,'anchor1','dd/MM/yyyy'); return false;"
                            ...
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="222" class="balckfnt">
                                <font class="blackfnt">
                                    <asp:TextBox ID="duedt" onblur="javascript:ValidateForm(this)" runat="server" Width="70px"></asp:TextBox>
                                    <a href="#" onclick="cal.select(ctl00$MyCPH1$duedt,'anchor2','dd/MM/yyyy'); return false;"
                        ...
                        <tr>
                            ...
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102">
                                <asp:TextBox ID="pcamt" runat="server" Enabled="false" Width="70px"></asp:TextBox>
                            </td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="166">
                                <font class="blackfnt">Advance Paid (-)</font></td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="222">
                                <font class="blackfnt">
                                    <asp:TextBox ID="advamt" Enabled="false" runat="server" Width="70px"></asp:TextBox>
                                </font>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102">
                                <asp:TextBox ID="othamt" runat="server" Enabled="false" Width="70px"></asp:TextBox>
                            </td>
                            ...
                            <td valign="top" height="26" bgcolor="#FFFFFF" align="left" width="222">
                                <asp:TextBox ID="othded" runat="server" Enabled="false" Width="70px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="135">
                                <font class="blackfnt">Service Tax Charge(+)</font></td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102">
                                <asp:TextBox ID="svctax" runat="server" Enabled="false" Width="70px"></asp:TextBox>
                            </td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="166">
                                <font class="blackfnt">Service Tax Deduction (-)</font></td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="222">
                                <font class="blackfnt" size="-1">
                                    <asp:TextBox Enabled="false" ID="svctaxded" runat="server" Width="70px"></asp:TextBox>
                                </font>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102">
                                <asp:TextBox ID="cessamt" Enabled="false" runat="server" Width="70px"></asp:TextBox>
                                <div align="left">
                                    <font class="blackfnt"><font class="blackfnt"></font>
                                </div>
                            </td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="129">
                                <font class="blackfnt">TDS Deduction</font></td>
                            <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102">
                                <asp:TextBox ID="tdsded" Enabled="false" runat="server" Width="70px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF" align="left">
                                <font class="blackfnt">Discount Received (-)</font></td>
                            <td bgcolor="#FFFFFF" align="left">
                                <asp:TextBox ID="totdiscount" Enabled="false" runat="server" Width="70px"></asp:TextBox></td>
                            <td bgcolor="#FFFFFF" align="left">
                                <font class="blackfnt">Addition Contract Amount(+)</font></td>
                            <td bgcolor="#FFFFFF" align="left">
                                <asp:TextBox ID="totPacmt_oth" Enabled="false" runat="server" Width="70px"></asp:TextBox></td>
                </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" align="left">
                                <font class="blackfnt">Addition TDS (-)</font></td>
                            <td bgcolor="#FFFFFF" align="left">
                                <asp:TextBox ID="totTDSamt_oth" Enabled="false" runat="server" Width="70px"></asp:TextBox></td>
                    <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="129">
                        <font class="blackfnt"><b>Net Payable</b></font></td>
                    <td valign="top" height="18" bgcolor="#FFFFFF" align="left" width="102">
                        <asp:TextBox ID="netamt" Enabled="false" runat="server" Width="70px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td bgcolor="#FFFFFF" align="left" style="height: 26px">
                        <font class="blackfnt">
                            <asp:DropDownList ID="tdsacccode" runat="server" Mode="Conditional" RenderMode="Inline"
                                Width="152px">
                    ...
                    <td bgcolor="#FFFFFF" align="left" style="height: 26px">
                        <font class="blackfnt">
                            <asp:DropDownList ID="tdsfor" runat="server" Mode="Conditional" RenderMode="Inline"
                                Width="152px">
                                <asp:ListItem Text="Select" Value=""></asp:ListItem>
        ...
        <br />
        <table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" width="95%" align="center"
            class="boxbg">
            <tr class="bgbluegrey">
                <td valign="top" height="18" colspan="4" align="center">
        ...
        <br />
        <asp:GridView align="center" ID="dockdata" Width="90%" runat="server" BorderWidth="1"
            CellPadding="2" HeaderStyle-CssClass="bgbluegrey" AllowSorting="true" AllowPaging="true"
...
<ItemStyle CssClass="blackfnt" />
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <center>
                            <asp:TextBox Enabled="false" ID="indpcamt" runat="server" MaxLength="10" Columns="6"
                ...
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:Label ID="lblcontractAmt_additional" CssClass="blackfnt" Text="Additional Contract Amount (+)"
                            runat="server"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <center>
                            <asp:TextBox ID="indpcamt_additional" runat="server" MaxLength="10" Columns="6" Text='0.00'></asp:TextBox>
                        </center>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <center>
                            <asp:TextBox Enabled="false" ID="indothamt" MaxLength="10" Columns="6" runat="server"
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <center>
                            <asp:TextBox ID="inddiscount" MaxLength="10" Columns="6" runat="server" Text="0"></asp:TextBox>
                        </center>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <center>
                            <asp:TextBox ID="cboindsvctaxrate" MaxLength="10" Columns="6" runat="server" Text="0"></asp:TextBox>
                        </center>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                ...
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:Label ID="lbl_h_cess" CssClass="blackfnt" Text="Higher Cess (+) " runat="server"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <center>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <center>
                            <asp:TextBox Enabled="false" ID="indadvamt" MaxLength="10" Columns="6" runat="server"
                                Text='<%# DataBinder.Eval(Container.DataItem,"ADVAMT") %>'></asp:TextBox>
                        </center>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <center>
                            <asp:TextBox ID="indothded" MaxLength="10" Columns="6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OTHDED") %>'></asp:TextBox>
                        </center>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:Label ID="lblservicededuction" CssClass="blackfnt" Text="Service Tax Dedn.(-) "
                            runat="server"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <center>
                            <asp:TextBox ID="indsvctaxded" MaxLength="10" Columns="6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"SVCTAXDED") %>'></asp:TextBox>
                        </center>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <center>
                            <asp:TextBox Enabled="false" ID="indtds_rate" MaxLength="10" Columns="6" runat="server"
                ...
                <ItemStyle  Wrap="false" />
                    <HeaderTemplate>
                        <asp:Label ID="lblTDS_additional" CssClass="blackfnt" Text="Additional TDS(-)"
                            runat="server"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <center>
                            <asp:TextBox ID="indTDS_additional_rate" runat="server" MaxLength="10" Columns="6" Text='0.00'></asp:TextBox>
                            <asp:TextBox  Enabled="false" ID="indTDS_additional" runat="server" MaxLength="10" Columns="6" Text='0.00'></asp:TextBox>
                        </center>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
        ...
        <table cellspacing="1" cellpadding="3" border="0" width="95%" align="center">
            <tr>
                <td bgcolor="#FFFFFF" valign="top" height="18" colspan="4" align="center">
                    <asp:Label ID="Label1" CssClass="blackfnt" runat="server" Text="Remarks" Style="left: -4px;
                        position: relative; top: -19px"></asp:Label>
