<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="THCSearch.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_THCAdvanceCancellation_THCSearch" %>
        ...
        <table style="width: 7.5in" border="0" align="left" cellpadding="3" cellspacing="1"
            ...
            <tr class="bgbluegrey">
                <td align="center" colspan="3">
                    <font class="blackfnt"><b>THC Advance Cancellation </b></font>
                </td>
            </tr>
            <tr bgcolor="#ffffff">
                <td valign="top">
