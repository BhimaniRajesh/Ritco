<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="THCSelection.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_THCAdvanceCancellation_THCSelection"
                                         ...
                                         if(findobj.readyState==4 && findobj.status==200)
                                            {
                                                ...
                                                if(res=="false")
                                                {
                                                    alert("Balance Payment already Done So Please Cancel Balance Payment First");
    ...
    <div align="center">
        <form id="form1">
            <div align="left">
                ...
                <br />
                <p align="left">
                    <font class="blackfnt"><b>Select THC for Advance Cancellation</b></font></p>
                <asp:GridView ID="GridTHCList" runat="server" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Advance VoucherNo">
                        <HeaderStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <center>
                                    <asp:Label ID="lblVoucherNo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"advvoucherno") %>'></asp:Label>
                                </center>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
...
<%--function checkadvancebalance()
            {
                var grvcharges = document.getElementById("ctl00_MyCPH1_GridTHCList");
               ...
               debugger
                ...
                {
                    if(i<10)
                        pref = "ctl00_MyCPH1_GridTHCList_ctl0" + i + "_";
                    else
                        pref = "ctl00_MyCPH1_GridTHCList_ctl" + i + "_";

                     var txtVoucherNo = document.getElementById(pref + "lblVoucherNo").innerText;
                     var findobj=false;
                     var flag=false;
                         ...
                         findobj=GetXMLHttpObject();
                            if(findobj)
                            {
                                 var strpg="CheckExist.aspx?voucherno=" + txtVoucherNo + "&sid=" + Math.random();
                                 findobj.open("GET",strpg);
                                 findobj.onreadystatechange=function()
                                     {
                                         if(findobj.readyState==4 && findobj.status==200)
