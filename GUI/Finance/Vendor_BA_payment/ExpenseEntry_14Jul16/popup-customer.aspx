<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup-customer.aspx.cs" Inherits="GUI_Finance_Debit_Voucher_popup_customer" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript">
    ...
    function Child(obj)
    {
	    var Str = obj.value;
	    Str = Str.split(",");
	   // window.opener.document.aspnetForm.ctl00$MyCPH1$txtcust.value=Str[0]+'~'+Str[1];
            ...
            <asp:DataList ID="DataList1" runat="server" width="90%">
                ...
                <ItemTemplate>
                    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr>
                            <td width="10%" bgcolor="white" align="left">&nbsp;<input name=chk type=radio onclick="Child(this);" value='<%#DataBinder.Eval(Container.DataItem,"custcd")+","+DataBinder.Eval(Container.DataItem, "custnm") %>' ></td>
