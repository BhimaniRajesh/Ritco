    ...
    <table border="0" class="boxbg" cellpadding="1" cellspacing="1" style="width:9.5in">
        ...
        <tr bgcolor="#FFFFFF">
         ...
         <td align="left">
                ...
                <font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton12" CssClass="bluefnt" runat="server" Font-Bold="false" Text="PRS/DRS-BA " PostBackUrl="~/GUI/Finance/Vendor_BA_payment/BA_Payment_ver1/Query_BA_BillEntry.aspx" />
                <font class="blackfnt">|</font>
