<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="vendorpayvoucher_Step2.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_VendorBillEntry_Vendor_vendorpayvoucher_Step2" %>
...
function fsubmit()
{
	...
	if(transtype=="Cash" && parseFloat(document.getElementById('ctl00_MyCPH1_colamt').value)>20000)
	{
	                        alert("Cash Amount Should be Less than Rs.20000")
			                return false;
	}
...
<div align="left">
 ...
 <table><tr><td><asp:HiddenField ID="click_count" Value=0 runat="server" />
                            ...
                            <table cellspacing="1" cellpadding="3" border="0" bgcolor="#808080" style="width:9.5in"  align="left" class="boxbg">
                              <tr> 
                                ...
                                <td valign="top"  bgcolor="#FFFFFF" align="left" width="20%"><font class="blackfnt">
                                  ...
                                  <asp:TextBox id="txtVoucherDt" runat="server" Width="60px" Enabled="false" onblur="javascript:ValidateForm(this)"></asp:TextBox>
                              ...
                              <tr> 
                                ...
                                <asp:TextBox id="netamt" runat="server" Width="70px" Text="0.00"></asp:TextBox>
                                </td>
...
<asp:TemplateField HeaderText="Vendor Code" HeaderStyle-CssClass="blackfnt" FooterStyle-CssClass="bgbluegrey">
                <ItemTemplate>
                    <center>
                    <font class="blackfnt">
                    <asp:Label ID="lblvendor_code" Text='<%# DataBinder.Eval(Container.DataItem,"VendorCode") %>'  runat="server" ></asp:Label>
                    </font>
                    </center>
                </ItemTemplate>
...
<table border="0" cellspacing="1" cellpadding="4" style="width:9.5in" align="left" class="boxbg">
						...
						<asp:AsyncPostBackTrigger ControlID="transtype" EventName="SelectedIndexChanged" />
                              ...
                              <tr bgcolor="#ffffff"> 
                                ...
                                <td> <font class="blackfnt">
                                  <asp:TextBox ID="colamt" runat="server" Width="50px" Text="0.00" Enabled="false"></asp:TextBox>
                                  </font> </td>
                            ...
                            <tr><td  align="center"> <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
                            </td></tr>
                            </table>
