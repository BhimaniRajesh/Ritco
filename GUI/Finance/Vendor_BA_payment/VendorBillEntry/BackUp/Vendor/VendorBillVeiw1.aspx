...
<head runat="server">
    <title>Vendor Bill Payment Voucher</title>
...
<body>
    ...
    <table border='<%=strborder %>' style="width:6.7in" bgcolor="#808080" cellpadding="2" cellspacing="1" class='<%=boxbg%>'>
     <tr bgcolor="white">
                   <td align="center" colspan="4"><font class="blackfnt">
										<b><asp:Label ID="Label1" runat="server" Text="THC BillPayment Voucher"></asp:Label>
										</b></font> </td>
                    </tr>
                                     <tr bgcolor="#FFFFFF">
										<td align="left" style="width:2in" ><font class="blackfnt">&nbsp;Voucher No</font></td>
										<td align="left" ><font class="blackfnt">
										<b><asp:Label ID="lblVoucherNo" runat="server"></asp:Label></b>
										</font> </td>
...
<asp:TemplateField>
 ...
 <asp:TemplateField>
              <HeaderTemplate >
              <asp:Label ID="hdrCurrentPayment"   style="text-align:center"  CssClass="blackfnt" Text="Pending Amount" runat="server"></asp:Label>
              </HeaderTemplate>
              <ItemStyle HorizontalAlign="Right" />
                <ItemTemplate>
...
<table style="width:6.7in" border='<%=strborder %>' cellspacing="1" cellpadding="3" bgcolor="#808080" class='<%=boxbg%>'>
								...
								<tr bgcolor="#FFFFFF">
                                 ...
                                 <tr bgcolor="#ffffff"> 
                                    ...
                                    <td align="right"><font class="blackfnt">
