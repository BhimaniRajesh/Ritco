...
//    function checkTripsheet(row_Index,tb_tripsheet)
//    {
//        alert("hi")
//        
...
//                continue;
//            }
//            if (document.getElementById("ctl00_MyCPH1_dgHSD_OIL_EXP_ctl" + str_Index + "_txtTripsheetNo").value == tb_tripsheet.value)
//            {
//                alert("This Tripsheet already exist at row " + (intIndex - 1));
//                tb_tripsheet.value = "";
//                tb_tripsheet.focus();
//                return;
//            }
...
//                    if (returnValue[0] == "N") 
//                    {
//                        tb_tripsheet.value=tb_tripsheet.value;
//                    }
//                    else
//                    {
//                        alert("This tripsheet no. is already closed & settled !! ");
//                        tb_tripsheet.focus();
//                    }
//                }
//            }
//            alert("wfrm_AJAX_Validator.aspx?Function=checkTripsheet&datetime="+currentTime+"&Tripsheet=" + tb_tripsheet.value+"&ConnStr="+ConnStr);
//            xmlHttpRequest.open("GET", "wfrm_AJAX_Validator.aspx?Function=checkTripsheet&datetime="+currentTime+"&Tripsheet=" + tb_tripsheet.value+"&ConnStr="+ConnStr, false);
...
//    }
    ...
    function CheckBillNumber(txtBillNumber,cboVendor)
    {
        ...
        if (xmlHttpRequest)
        {
            ...
            xmlHttpRequest.open("GET", "wfrm_AJAX_Validator.aspx?Function=CheckBillNumber&datetime="+currentTime+"&BillNo=" + txtBillNumber.value+"&VENDORCODE="+cboVendor.value+"&ConnStr="+ConnStr, false);
            xmlHttpRequest.send(null);
        }
    }
    ...
    function GetTot()
	{
	    var i,Amt,TotAmt,T=0;
           ...
           // alert("T : " + T);
            ...
            T=rounditn(document.getElementById("ctl00_MyCPH1_txtTotalExeAmt").value,2);
            TotAmt=rounditn(document.getElementById("ctl00_MyCPH1_txtTotalExeAmt").value,2);
        ...
        var txtNetPayableAmt=document.getElementById("ctl00_MyCPH1_txtNetPayableAmt");
        txtNetPayableAmt.value=txtNetPay;
        totAmt=txtNetPayableAmt.value;
        CalculatePerc(ddlDiscount,txtPercAmt,txtFinalAmt,txtNetPayableAmt);
	}
...
<table   width="800">
    ...
    <tr><td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td>
                <font class="blackfnt">
                    ...
                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtBillEntryDate,'anchor1','dd/MM/yyyy'); return false;"
                        name="anchor1" id="a2">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td height="21" bgcolor="#FFFFFF" align="left" width="222">
                <font class="blackfnt">
                    <asp:TextBox ID="txtBillAmt"  BorderStyle="None"  Font-Bold="true" runat="server" Width="60px" Text="0.00"></asp:TextBox>
                </font>
            </td>
            <td height="21" bgcolor="#FFFFFF" align="left" width="166">
                <div align="left">
            ...
            <td height="21" bgcolor="#FFFFFF" align="left" width="222">
                <font class="blackfnt">
                    ...
                    <a href="#" onclick="cal.select(ctl00_MyCPH1_txtBillDt,'anchor2','dd/MM/yyyy'); return false;"
                        name="anchor2" id="a3">
                        <img src="../../../../images/calendar.jpg" border="0" />
                    </a>(e.g. dd/mm/yyyy) </font>
            </td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td height="21" bgcolor="#FFFFFF" align="left" width="222">
                <font class="blackfnt">
                    <asp:TextBox ID="txtDueDate" BorderStyle="None"  runat="server" Width="60px"></asp:TextBox>
                </font>
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td>
                <font class="blackfnt">
                    <asp:TextBox ID="txtNetAmt"  BorderStyle="None"  Font-Bold="true"  runat="server" Width="60px" Text="0.00"></asp:TextBox>
                </font>
            </td>
        </tr>
    </table>
                                                    ...
                                                    <td>
                                                        <asp:DataGrid ID="dgHSD_OIL_EXP" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Manual/System Tripsheet No.">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtTripsheetNo" runat="server" CssClass="input" Width="120px" BorderStyle="Groove"
                                                                            MaxLength="25"  OnTextChanged="TripsheetNo_Change" AutoPostBack="true"  ></asp:TextBox> <!--OnTextChanged="TripsheetNo_Change" AutoPostBack="true"-->
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Slip Date (dd/mm/yyyy)">
                                                                    <ItemTemplate>
                                                                        <asp:HiddenField ID="hfVSlipDt" runat="server" Value=""  />
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Amount">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtAmt" runat="server" BorderStyle="none"   Width="60px"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"
     ...
     <br>
      ...
      <Triggers>
        ...
        <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
            ...
            <tr style="background-color: White">
                <td style="text-align: left; height: 11px;" class="blackfnt">
                    &nbsp;Amount Applicable
                </td>
                <td style="text-align: left; height: 11px;" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtAmtAppl" runat="server" BorderStyle="None"  Width="80px"></asp:TextBox></td>
                <td style="text-align: left; height: 11px;" class="blackfnt">
                    &nbsp;Amount Applicable
                </td>
                <td style="text-align: left; height: 11px;" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtAmtApplL" runat="server" BorderStyle="None" Width="80px" OnTextChanged="txtAmtApplL_TextChanged"></asp:TextBox></td>
            </tr>
             <tr style="background-color: White">
            ...
            <tr style="background-color: White">
                ...
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtServiceTax" runat="server" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="None" Width="80px" Text="0.00"></asp:TextBox></td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;TDS Section
                </td>
                <td style="text-align: left" class="blackfnt">
            ...
            <tr style="background-color: White">
                ...
                <td style="text-align: left" class="blackfnt"> 
                    &nbsp;<asp:TextBox ID="txtEduCess" runat="server" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="none"  Width="80px" Text="0.00"></asp:TextBox></td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;TDS Rate
                </td>
                <td style="text-align: left" class="blackfnt">
            ...
            <tr style="background-color: White">
                ...
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtHEduCess" runat="server" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="none" Width="80px" Text="0.00"></asp:TextBox></td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;TDS Amount (-)
                </td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtTDSAmt" runat="server" BorderStyle="None"  Text="0.00" Width="80px"></asp:TextBox></td>
            </tr>
           <%-- <tr style="background-color: White">
                <td style="text-align: left" class="blackfnt">
                    &nbsp;Service Tax Reg No.
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td colspan="2">
                <font class="blackfnt"></font>
                <asp:TextBox ID="txtNetPayableAmt" BorderStyle="None"  Font-Bold="true" runat="server" Width="80px" Text="0.00"></asp:TextBox>
            </td>
        </tr>
