		   ...
		   if(document.getElementById(frm_name+"cboVendorType").value=="")
	        ...
	        document.getElementById('ctl00$MyCPH1$txtNetAmt').value=rounditn(document.getElementById('ctl00$MyCPH1$txtTotalExeAmt').value,2);
              ...
              if(document.getElementById("ctl00_MyCPH1_Svctax_yn").checked==false && document.getElementById("ctl00_MyCPH1_TDS_yn").checked==false)
                {
	                document.getElementById('ctl00$MyCPH1$txtNetPayableAmt').value=rounditn(document.getElementById('ctl00$MyCPH1$txtTotalExeAmt').value,2);
                                                        ...
                                                        <asp:DataGrid ID="dgHSD_OIL_EXP" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Vehicle No.">
                                                                    <ItemTemplate>
                                                                             <asp:Label ID="txtVehicleno" runat="server" Width="20px"></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                        Font-Underline="False" Wrap="False" />
                                                                    <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                               ...
                                                               <%-- <asp:TemplateColumn HeaderText="Petrol Pump Name">
                                                                ...
                                                                <%--<asp:TemplateColumn HeaderText="Oil (Qtn. in litres)">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtOil_Ltr" runat="server" CssClass="input" Width="60px" BorderStyle="Groove"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"
                                                                            MaxLength="6" OnTextChanged="Diesel_Oil_Calc" AutoPostBack="true"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="reqOil_Ltr" runat="server" Display="Dynamic" Text="!"
                                                                            ValidationGroup="VGDtFromTo" ControlToValidate="txtOil_Ltr"></asp:RequiredFieldValidator>
                                                                        <asp:RegularExpressionValidator ID="RegOil_Ltr" runat="server" ErrorMessage="!" ValidationExpression="^\$?[+-]?[\d,]*\.?\d{0,2}$"
                                                                            SetFocusOnError="true" ControlToValidate="txtOil_Ltr" Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                        Font-Underline="False" Wrap="False" />
                                                                    <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Oil Rate/litres">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtOilRate_Ltr" runat="server" CssClass="input" Width="60px" BorderStyle="Groove"   onkeypress="javascript:validFloat(event,this.getAttribute('id'))"
                                                                            MaxLength="6" OnTextChanged="Diesel_Oil_Calc" AutoPostBack="true"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="reqOilRate_Ltr" runat="server" Display="Dynamic"
                                                                            Text="!" ValidationGroup="VGDtFromTo" ControlToValidate="txtOilRate_Ltr"></asp:RequiredFieldValidator>
                                                                        <asp:RegularExpressionValidator ID="RegOilRate_Ltr" runat="server" ErrorMessage="!"
                                                                            ValidationExpression="^\$?[+-]?[\d,]*\.?\d{0,2}$" SetFocusOnError="true" ControlToValidate="txtOilRate_Ltr"
                                                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                        Font-Underline="False" Wrap="False" />
