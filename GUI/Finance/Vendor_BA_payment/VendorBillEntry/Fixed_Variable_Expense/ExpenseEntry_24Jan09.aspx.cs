...
public partial class GUI_Finance_Vendor_BA_payment_Fixed_Variable_Expense_ExpenseEntry : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try  //  try FOR ALL
        {
            ...
            string sqlAcc1 = "usp_Vendor_Fixed_Variable_Billentry_transaction";
            SqlCommand sqlcmdAcc1 = new SqlCommand(sqlAcc1, con, trn);
            sqlcmdAcc1.CommandType = CommandType.StoredProcedure;
            sqlcmdAcc1.Parameters.Add("@currbrcd", SqlDbType.VarChar).Value = Session["brcd"].ToString();
