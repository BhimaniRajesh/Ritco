<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="ExpenseQuery.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_Fixed_Variable_Expense_ExpenseQuey" %>
                ...
                <td>
                    ...
                    <ContentTemplate>
                          ...
                          <table cellspacing="1" cellpadding="3" width="50%" class="boxbg" border="0">
                                <tr style="background-color: white">
                                    <td><font class="blackfnt">Select Expense type</font></td>
                                    <td >
                                 ...
                                 <tr style="background-color: white">
                                    <td valign=top><font class="blackfnt">Select Expense Heads</font></td>
                                    <td valign=top>
