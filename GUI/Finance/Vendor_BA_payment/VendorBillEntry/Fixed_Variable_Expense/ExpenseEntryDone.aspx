...
<script language="javascript" type="text/javascript">
        ...
        { 
        window.open("../../View_N_Print/ViewExpenseEntryFV.aspx?expBillNo=" + arg1 + "," + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"); 
        }
    </script>
    ...
    <table border="0" align="left"  cellspacing="1" bgcolor="#000000" cellpadding="2" class="boxbg" width="60%">
						...
						<font class="blklnkund"></font>
							...
							<tr  bgcolor="#FFFFFF">
							    ...
							    <td width="100%" align="left" bgcolor="#FFFFFF"  colspan="3"><a href="ExpenseQuery.aspx"><font class="blackfnt" color="#0000FF"><font class="blklnkund">Generate more Vendor Bills</font></a></td>
							  </tr>
