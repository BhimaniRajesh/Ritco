        ...
        try
        {
            ...
            foreach (GridViewRow gridrow in BillDetail.Rows)
            {
                ...
                if (chkBill1.Checked == true)
                {
					...
					pendingamount = pendingamt.Value;
            ...
            string sql_voucher_act = "exec usp_Vendor_Payment_transaction_other 4,'" + voucherNo + "','" + Session["brcd"].ToString() + "','" + Financial_Year + "','" + Session["empcd"].ToString() + "','" + voucherNo + "'";
