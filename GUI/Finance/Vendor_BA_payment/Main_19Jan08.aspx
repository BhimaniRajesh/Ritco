        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td align="left" width="35%">
             ...
             <td align="left">
                ...
                <font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton6" CssClass="bluefnt" runat="server" Font-Bold="false" Text="PRS/DRS-Staff" PostBackUrl="./VendorBillEntry/Vendor/THCSearch.aspx"/>
                <font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton7" CssClass="bluefnt" runat="server" Font-Bold="false" Text="PRS/DRS-BA" PostBackUrl="./VendorBillEntry/Vendor/THCSearch.aspx"/>
                <font class="blackfnt">|</font>
                <asp:LinkButton ID="LinkButton8" CssClass="bluefnt" runat="server" Font-Bold="false" Text="Others" PostBackUrl="ExpenseEntry.aspx" />
            </td>
        </tr>
