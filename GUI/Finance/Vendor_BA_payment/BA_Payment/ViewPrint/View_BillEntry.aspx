<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_BillEntry.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_BA_Payment_ViewPrint_View_BillEntry" %>
                    ...
                    <td>
                        <table id="Table3" align="left" runat="server" cellpadding="3" cellspacing="1" style="width: 9.0in;"
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td> <font class="blackfnt">
                                    <asp:Label ID="Label11" Text="" runat="server" CssClass="blackfnt"></asp:Label></font></td>
                                <td> <font class="blackfnt">
                                </td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                ...
                <tr>
                    ...
                    <br />
                        <asp:GridView align="center" ID="dgDocket" runat="server" CellSpacing="1" CellPadding="3" BorderWidth="0"
                            HeaderStyle-CssClass="bgbluegrey"  CssClass="boxbg" AutoGenerateColumns="false"
                        >
                            <Columns>
                            <asp:TemplateField HeaderText="SR.NO." ItemStyle-BackColor="white">
                                ...
                                <asp:BoundField DataField="docno" HeaderText="Docket No">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                    <ItemStyle CssClass="blackfnt" BackColor="white" />
                                </asp:BoundField>
                                <asp:BoundField DataField="docsf" HeaderText="Docket Sf">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                    <ItemStyle CssClass="blackfnt" BackColor="white" />
                                </asp:BoundField>
