...
public partial class VendorPayment_new_BA_Payment_BAPayment_BillEntry_step1 : System.Web.UI.Page
{
    ...
    { 
        ...
        if (!IsPostBack)
        {
            ...
            SQL_Vendor = "select distinct m.vendorcode,vendorname=(m.vendorname+' : '+m.vendorcode) from webx_vendor_hdr m  with (NOLOCK),webx_vendor_det d with (NOLOCK) where m.vendorcode=d.vendorcode  and (vendor_type='8' or vendor_type='08') " + vendorcls + "   order by m.vendorcode";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("BAPayment_BillEntry_step2.aspx" + strFinalQS);
