<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Update_rate_commision_BKG.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_BA_Payment_Update_rate_commision_BKG" %>
...
<tr  class="bgbluegrey"><td  height="30" align="center" colspan="2"><font class="blackboldfnt"> Enter Docket List - For Booking Rates Update</font></td></tr>
 ...
 <asp:GridView align="left" ID="dgDocket" Visible="false" runat="server" CellSpacing="1" CellPadding="2"
                ...
                <Columns>
                  <asp:TemplateField HeaderText="SR.NO." ItemStyle-BackColor="white">
                    ...
                    <asp:BoundField DataField="BACODE" HeaderText="Vendor - BA">
                        <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                        <ItemStyle CssClass="blackfnt"  BackColor="white" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="slabrate_BKG" HeaderText="Slab Rate">
                        <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                        <ItemStyle CssClass="blackfnt"  BackColor="white" />
                    </asp:BoundField>
                    <asp:BoundField DataField="commission_BKG" HeaderText="Commission">
                        <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                        <ItemStyle CssClass="blackfnt"  BackColor="white" />
                    </asp:BoundField>
