...
public partial class GUI_Finance_Vendor_BA_payment_THCBalanceCancellation_CheckExist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string qry = "select balvoucherno,VendorBEno,vendorbillno from webx_thc_summary where balvoucherno='" + advvoucherno + "'";
