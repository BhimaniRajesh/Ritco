        ...
        <div>
            ...
            <table border="0" cellspacing="1" cellpadding="4" width="100%" align="center" class="boxbg">
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="right">
                        <font class="blackfnt"><asp:Label ID="lblSBCessRate" runat="server"></asp:Label></font>
                    </td>
                    <td align="right">
                        <font class="blackfnt"><asp:Label ID="lblSBCessValue" runat="server"></asp:Label></font>
                    </td>
                </tr>
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td>
                        <font class="blackfnt"><font class="blackfnt">Cenvat (Krishi Kalyan Cess) Receivable A/c </font></font>
                    </td>
                    <td align="right">
                        <font class="blackfnt"><asp:Label ID="lblKKCessRate" runat="server"></asp:Label></font>
                    </td>
                    <td align="right">
                        <font class="blackfnt"><asp:Label ID="lblKKCessValue" runat="server"></asp:Label></font>
                    </td>
                </tr>
