<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="THCSearch.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_THC_FIN_Edit_THCSearch" %>
...
<table style="width:9.5in" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#808080" class="boxbg">
    <tr class="bgbluegrey"> 
      <td  align="center" colspan="3"><font class="blackfnt"><b>THC Financial Edit
        </b></font></td>
    </tr>
...
<%--    <tr bgcolor="#FFFFFF"> 
                ...
                <tr bgcolor="#FFFFFF"><td colspan="2" align="center"><asp:Button ID="btnsubmit1" runat="server" Text="Submit"  CssClass="blackfnt" OnClick="btnsubmit1_Click"/></td></tr>
  </table>
  <br />
