<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Runsheet_step1.aspx.cs" Inherits="GUI_Finance_Vendor_BA_payment_PrepareVoucher_Vendor_THCSearch" %>
...
//return false;
    ...
    <div align="left">
        <table style="width: 9.5in" border="0" align="left" cellpadding="3" cellspacing="1"
            ...
            <tr class="bgbluegrey">
                <td align="center" colspan="4">
                    <font class="blackfnt"><b>Prepare Payment Voucher </b></font>
                </td>
            </tr>
            <tr bgcolor="#ffffff">
                <td align="left">
                      <asp:RadioButton ID="optdate" Checked="true" GroupName="grpcri" runat="server" />
                </td>
                <td valign="top">
                    <font class="blackfnt">Document date range </font>
                </td>
                            ...
                            <td valign="top" align="left">
                                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <a href="#" onclick="cal.select(ctl00$MyCPH1$txtDateFrom,'anchor112','dd/MM/yyyy'); return false;"
                                        ...
                                        <a href="#" onclick="cal.select(ctl00$MyCPH1$txtDateTo,'anchor113','dd/MM/yyyy'); return false;"
                                            name="anchor113" id="a1">
                                            <img src="../../../images/calendar.jpg" border="0" />
                                        </a></br>
            ...
            <tr bgcolor="#ffffff">
                <td align="left">
                    <asp:RadioButton ID="optdoc" GroupName="grpcri" runat="server" />
                </td>
                <td valign="top">
                    <font class="blackfnt">
                ...
                <td valign="top" align="left" colspan="2">
                    <asp:TextBox ID="txtDocNo" runat="server" Width="164px"></asp:TextBox><font class="blackfnt">(If
                        Multiple - separated by comma)</font>
                </td>
            </tr>
            <tr bgcolor="#ffffff">
                <td valign="top" colspan="4">
            ...
            <tr bgcolor="#ffffff">
                <td align="left">
                    <asp:RadioButton ID="optman" GroupName="grpcri" runat="server" />
                </td>
                <td valign="top">
                    <font class="blackfnt">
                ...
                <td valign="top" align="left" colspan="2">
                    <asp:TextBox ID="txtManualNo" runat="server" Width="164px"></asp:TextBox><font class="blackfnt">(If
                        Multiple - separated by comma)</font>
                </td>
            </tr>
            <tr bgcolor="#ffffff">
            ...
            <tr bgcolor="#ffffff">
                 <td align="left">
                    <asp:RadioButton ID="optvehno" GroupName="grpcri" runat="server" />
                 </td>
                <td valign="top">
                    <font class="blackfnt">
                ...
                <td valign="top" align="left" colspan="2">
                    <asp:TextBox ID="txtVehicleNo" runat="server" Width="164px"></asp:TextBox><font class="blackfnt">(If
                        Multiple - separated by comma)</font>
                </td>
            </tr>
           <%-- <tr bgcolor="#FFFFFF">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cboAdvanceorBalance" runat="server" AutoPostBack="true" CssClass="blackfnt">
                                ...
                                <asp:ListItem Value="B" Text="Balance"></asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
        ...
        <td>
        <br />
           <table style="width: 9.5in" class="boxbg" cellspacing="1">
                <tr class="bgbluegrey">
                    <td align="center">
