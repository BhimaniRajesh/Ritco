<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="MR_Cancellation_step_1.aspx.cs" Inherits="GUI_Finance_Bill_MR_Cancellation_Bill_MR_Cancellation_step_1"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        {
            if(document.getElementById(Frm_name+"txtMrNo").value=="")
            {
                                ...
                                <table cellspacing="1" style="width: 90%" class="boxbg" border="0">
                                    ...
                                    <tr style="background-color: white">
                                        <td align="left" style="height: 25px; width: 100px;">
                                            <asp:Label ID="lblmrno" CssClass="blackfnt" Text="Enter MRs No. :" runat="server"
                                    ...
                                    <tr style="background-color: white">
                                        ...
                                        <td align="left" style="height: 25px; width: 100px;" colspan="2">
                                            <asp:DropDownList ID="ddrbillmrtype" runat="server" CssClass="blackfnt" DataTextField="CodeDesc" DataValueField="Codeid" 
                                                Width="100px">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
