<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoucherView.aspx.cs" Inherits="GUI_Finance_voucher_VoucherView" %>
            ...
            <asp:GridView ID="dockdata" runat="server" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass='<%=bgbluegrey%>'
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <center>
                                <asp:Label ID="lblAmountPaid" runat="server" CssClass="blackfnt" Text='<%# DataBinder.Eval(Container.DataItem,"PAIDAMT") %>'></asp:Label>
                            </center>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <center>
                                <asp:Label ID="lblCurrentPayment" runat="server" CssClass="blackfnt" Text='<%# DataBinder.Eval(Container.DataItem,"PendingAmount") %>'></asp:Label>
                            </center>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
