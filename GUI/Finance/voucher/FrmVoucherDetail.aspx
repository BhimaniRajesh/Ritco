        ...
        <asp:GridView ID="GridVoucher" Style="width: 10in" Visible="false"
            ...
            <Columns>
                ...
                <%-- <asp:TemplateField HeaderText="Voucher Date">
                    <HeaderStyle CssClass="blackfnt" />
                    <ItemTemplate>
                        <asp:Label ID="lblVoucherDate" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"EntryDt") %>'
                ...
                <%--<asp:TemplateField HeaderText="Voucher Amount">
                    <HeaderStyle CssClass="blackfnt" />
                    <ItemTemplate>
                        <asp:Label ID="lblVoucherAmt" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"Amount") %>'
                            runat="server"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>--%>
