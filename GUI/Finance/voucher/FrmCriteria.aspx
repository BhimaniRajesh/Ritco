<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="FrmCriteria.aspx.cs" Inherits="GUI_Finance_voucher_FrmCriteria" %>
   ...
   <%-- <script language="javascript" type="text/javascript">
                ...
                <td align="left" style="width: 779px">
                    <a><font class="blklnkund"><b>Module</b></font></a> <b>&gt; </b><a><font class="blklnkund">
                        <b>Finance</b></font></a> <b>&gt; </b><a href="../voucher.aspx"><font class="blklnkund">
                            <b>Billing</b></font></a> <b>&gt; </b><font class="bluefnt"><b>Voucher View & Print</b></font>
                </td>
                <td align="right">
    ...
    <div align="left">
        <table border="0" cellpadding="0" cellspacing="1" class="boxbg">
            ...
            <tr bgcolor="#FFFFFF">
                <td align="left">
                    <font class="blackfnt">Select Vendor Type&nbsp;&nbsp;
                        <td colspan="2" align="left">
                            <asp:UpdatePanel ID="updatepanel2" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="cbovendortype" runat="server" Width="200px" AutoPostBack="true"
                                        OnSelectedIndexChanged="cboVendorType_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
      ...
      <table width="100%" height="100%">
          <tr> <td align="left">
            ...
            <tr bgcolor="white">
                <td colspan="2" align="left" class="blackfnt" valign="top">
                <font class="blackfnt">
                OR
                </font>
                </td>
