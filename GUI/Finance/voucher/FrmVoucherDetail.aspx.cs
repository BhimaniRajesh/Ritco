...
public partial class GUI_Finance_voucher_FrmVoucherDetail : System.Web.UI.Page
{
    ...
    public void BindTheData()
    {
        ...
        if (VoucherNo == "" || VoucherNo == null)
        {
            if (DocumentType == "T")
            {
                sql = "select distinct VoucherNo as VoucherNo,betype as DocumentType, BRCD as Branch, VendorName as Vendor from WEBX_VendorBill_hdr where betype='THC' and VoucherNo is not NULL and VendorCode='" + Vendor + "' and convert(varchar,PayDt,106) between convert(varchar,'" + fdate + "',103) and convert(varchar,'" + tdate + "',103) ";
            }
            else if (DocumentType == "P")
            {
                sql = "select distinct VoucherNo as VoucherNo,betype as DocumentType, BRCD as Branch, VendorName as Vendor from WEBX_VendorBill_hdr where betype='PDC' and VoucherNo is not NULL and VendorCode='" + Vendor + "' and convert(varchar,PayDt,106) between convert(varchar,'" + fdate + "',103) and convert(varchar,'" + tdate + "',103) ";
            }
            else if (DocumentType == "B")
            {
                sql = "select distinct VoucherNo as VoucherNo,betype as DocumentType, BRCD as Branch, VendorName as Vendor from WEBX_VendorBill_hdr where betype='BA Payment' and VoucherNo is not NULL and VendorCode='" + Vendor + "' and convert(varchar,PayDt,106) between convert(varchar,'" + fdate + "',103) and convert(varchar,'" + tdate + "',103) ";
            }
            else if (DocumentType == "O")
            {
                sql = "select distinct VoucherNo as VoucherNo,betype as DocumentType, BRCD as Branch,VendorName as Vendor from WEBX_VendorBill_hdr where betype='Expense' and VoucherNo is not NULL and VendorCode='" + Vendor + "' and convert(varchar,PayDt,106) between convert(varchar,'" + fdate + "',103) and convert(varchar,'" + tdate + "',103) ";
            }
            //Response.Write(sql);
            //Response.End();
        ...
        else
        {
            ...
            sql = "select distinct VoucherNo as VoucherNo,PBOV_CODE + ':' + PBOV_NAME as Vendor,BRCD as Branch from webx_vouchertrans_arch where voucherNo='" + VoucherNo + "'";
            //}
            //else if (DocumentType == "P")
            //{
