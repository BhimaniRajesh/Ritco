<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="FrmVoucherPDCVoucher.aspx.cs" Inherits="GUI_Finance_voucher_FrmVoucherPDCVoucher" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    function OpenPopupWindowPrintAdvance(VoucherNo)
    {
        var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=830,height=540,status=no,left=60,top=270"
        var strPopupURL = "../Vendor_BA_payment/PrepareVoucher/RunSheet/ViewRunSheetAdvance.aspx?advvoucher=" + VoucherNo + ",1"
        winNew = window.open(strPopupURL, "_blank", strWinFeature)
    }
    function OpenPopupWindowPrintBalance(VoucherNo)
    {
        var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=830,height=540,status=no,left=60,top=270"
        var strPopupURL = "../Vendor_BA_payment/PrepareVoucher/RunSheet/ViewRunSheetBalance.aspx?advvoucher=" + VoucherNo + ",1"
        winNew = window.open(strPopupURL, "_blank", strWinFeature)
    }
    ...
    <div style="width: 10.5in;" align="center">
        ...
        <br />
        <asp:GridView ID="GridVoucherAdvance" Style="width: 10in" Visible="false"
            CssClass="boxbg"
            ...
            <Columns>
                <asp:TemplateField HeaderText="Voucher Number">
                    ...
                    <ItemTemplate>
                        ...
                        <a href="JavaScript:OpenPopupWindowPrintAdvance('<%#DataBinder.Eval(Container.DataItem, "VoucherNo") %>',0)">
               ...
               <asp:TemplateField HeaderText="Print" HeaderStyle-Width="15">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowPrintAdvance('<%#DataBinder.Eval(Container.DataItem, "VoucherNo") %>',1)">
        ...
        <br />
        <asp:GridView ID="GridVoucherBalance" Style="width: 10in" Visible="false"
            CssClass="boxbg"
            PageSize="10" AutoGenerateColumns="false" HeaderStyle-CssClass="bgbluegrey" BackColor="white"
            runat="server" SelectedIndex="1" Width="686px" EmptyDataText="No Voucher Found For Given Details !!" EmptyDataRowStyle-CssClass="blackfnt" EmptyDataRowStyle-Font-Bold="true">
            <Columns>
                <asp:TemplateField HeaderText="Voucher Number">
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="lblVoucherNo" Visible="false" CssClass="blackfnt" Font-Underline="true"
                            Text='<%# DataBinder.Eval( Container.DataItem,"VoucherNo") %>' runat="server"></asp:LinkButton>
                        <a href="JavaScript:OpenPopupWindowPrintBalance('<%#DataBinder.Eval(Container.DataItem, "VoucherNo") %>',0)">
                            <font cssclass="Blackfnt">
                                <%#DataBinder.Eval(Container.DataItem, "VoucherNo")%></a>
                    </ItemTemplate>
                </asp:TemplateField>
               ...
               <asp:TemplateField HeaderText="Print" HeaderStyle-Width="15">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowPrintBalance('<%#DataBinder.Eval(Container.DataItem, "VoucherNo") %>',1)">
                            <font cssclass="Blackfnt">Print</a>
                    </ItemTemplate>
                    <ItemStyle BackColor="white" CssClass="blackfnt" HorizontalAlign="Center" />
                    <HeaderStyle CssClass="blackfnt" />
