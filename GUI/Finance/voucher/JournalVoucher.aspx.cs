...
public partial class GUI_finance_voucher_JournalVoucher : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                if(strEmpid=="")
                    strEmpid = rdr[0].ToString();
                else
                    strEmpid = strEmpid + "," + rdr[0].ToString();
            }
            rdr.Close();
    ...
    protected void cmdSubmit_Click(object sender, EventArgs e)
    {
        ...
        string docNo = "";
            ...
            if (success)
                Response.Redirect("./voucher_Done.aspx?VoucherType=Journal&VoucherNo=" + docNo , true);
        }
    }
}
