...
public partial class GUI_Finance_voucher_Print_JournalVoucherPrint : System.Web.UI.Page
{
    SqlConnection con;
    ...
    string voucherno = "", transtype = "", autoentry = "", printyn = "", Financial_Year = "", fin_year = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql_mno = "select Manual_Voucherno from webx_vouchertrans_arch where voucherno = '" + voucherno + "'";
        SqlCommand cmd_mno = new SqlCommand(sql_mno, con);
        SqlDataReader dr_mno = cmd_mno.ExecuteReader();
        while (dr_mno.Read())
        {
            lblmanvno.Text = dr_mno["Manual_Voucherno"].ToString();
        }
        dr_mno.Close();
        ...
        string sql = "SELECT * FROM webx_acctrans_" + fin_year + " WHERE voucherno='" + voucherno + "'";
        ...
        if (transtype.ToUpper().CompareTo("NORMAL") == 0)
            ...
            TBL_NAME = "webx_acctrans_" + fin_year;
        ...
        sql = "SELECT acccode,SUM(debit) AS debit FROM " + TBL_NAME + " WHERE voucherno='" + voucherno + "' AND transtype='" + transtype + "' AND brcd='" + Session["brcd"].ToString() + "' AND debit>0 GROUP BY acccode";
        cmd = new SqlCommand(sql, con);
        dr = cmd.ExecuteReader();
        while (dr.Read())
        {
        ...
        string s = "SELECT accdesc=(select accdesc from webx_acctinfo where acccode=a.acccode),* FROM webx_acctrans_" + fin_year + " a WHERE a.voucherno='" + voucherno + "' AND a.transtype='" + transtype + "' AND a.debit>0";
        ...
        while (dr.Read())
        {
            ...
            lblNarration.CssClass = "blackfnt";
        ...
        TableCell tctot5 = new TableCell();
        ...
        sql = "SELECT acccode,SUM(credit) AS credit FROM " + TBL_NAME + " WHERE voucherno='" + voucherno + "' AND transtype='" + transtype + "' AND brcd='" + Session["brcd"].ToString() + "' AND credit>0 GROUP BY acccode";
        cmd = new SqlCommand(sql, con);
        dr = cmd.ExecuteReader();
        while (dr.Read())
        {
        ...
        // SAME QUERY FROM ASP THAT GENERATE DEBIT LIST IN TABLE
        s = "SELECT accdesc=(select accdesc from webx_acctinfo where acccode=a.acccode),* FROM webx_acctrans_" + fin_year + " a WHERE a.voucherno='" + voucherno + "' AND a.transtype='" + transtype + "' AND a.credit>0";
        cmd = new SqlCommand(s, con);
        dr = cmd.ExecuteReader();
        ...
        tctot3.CssClass = "blackfnt";
        tctot4.CssClass = "blackfnt";
        tctot5.CssClass = "blackfnt";

        tctot3.HorizontalAlign = HorizontalAlign.Left;
        tctot4.HorizontalAlign = HorizontalAlign.Left;
        tctot5.HorizontalAlign = HorizontalAlign.Left;
