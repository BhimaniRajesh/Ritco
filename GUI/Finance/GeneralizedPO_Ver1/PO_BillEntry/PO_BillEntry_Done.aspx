<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="PO_BillEntry_Done.aspx.cs" Inherits="GUI_finance_voucher_voucher_done"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    function ViewPrint(arg1,arg2) 
        { 
         window.open("../ViewPrint/PO_BillEntryView.aspx?Billno=" + arg1 + "," + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"); 
        }
            ...
            <td width="90%" align="left">
                <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="650">
                    ...
                    <tr style="background-color: White">
                        ...
                        <td align="center">
                            <asp:Label ID="lblDocNo" runat="server" Text="Document Number" Font-Bold="True" CssClass="blackfnt"></asp:Label>
                        </td>
                        <td align="center">
                    ...
                    <tr style="background-color: White">
                        <td align="center">
                            <asp:Label ID="Lbl_GRN" runat="server" Text="PO Bill Entry" Font-Bold="True" CssClass="blackfnt"></asp:Label>
                        </td>
                        <td align="center">
                            <asp:Label ID="Lbl_GRN_Voucherno" runat="server" Text="" CssClass="blackfnt"></asp:Label>
                        </td>
                        <td align="center">
                            <font class="blackfnt"><font class="blklnkund"><a href="Javascript:ViewPrint('<%=Request.QueryString.Get("Billno")%>',0)">
                                <font class="blklnkund">View</font></a> | <a href="Javascript:ViewPrint('<%=Request.QueryString.Get("Billno")%>',1)">
                    ...
                    <tr style="background-color: White">
                        <td align="left" colspan="3" style="height: 21px">
                            <a href=POBillEntry_Step1.aspx><font class="blackfnt">Prepare More PO Bill Entry</font>
                            </a>
