                        ...
                        <td>
                            ...
                            <table border="0" cellpadding="3" width="800" cellspacing="1" align="left" class="boxbg">
                                ...
                                <tr bgcolor="white">
                                    ...
                                    <td align="Left">
                                        <font class="redfnt">
                                            <asp:TextBox ID="Txt_vendorbillno" Width="70" Text="" Style="text-align: Left" runat="server"
                                                onblur="javascript:return Check_Calc()" BorderStyle="Groove" CssClass="input"></asp:TextBox></font>
                                    </td>
                                    <td align="Left">
                                    ...
                                    <asp:TemplateField HeaderText="Bill  Amount" ItemStyle-Wrap="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="TXTCurramt" runat="server" Width="70" MaxLength="8" Style="text-align: Right"
                                                ...
                                                Text='<%# DataBinder.Eval(Container.DataItem, "Pendamt") %>' onblur="javascript:return Check_Calc()"
