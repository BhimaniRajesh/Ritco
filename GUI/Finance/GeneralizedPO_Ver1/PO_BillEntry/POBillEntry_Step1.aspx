<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    Trace="false" CodeFile="POBillEntry_Step1.aspx.cs" Inherits="GUI_Finance_Fix_Asset_aaaaa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function Submit() {
            ...
            var Manual_PO_NO = document.getElementById(FRM_Name + "txtmanualpono").value
            var PO_Vendor = document.getElementById(FRM_Name + "Txt_Vendor").value
            var ddlMatCat = document.getElementById(FRM_Name + "DDLMatCat");
            if (PO_Vendor == "" && PO_NO == "" && Manual_PO_NO == "") {
            ...
            if (ddlMatCat.value == "") {
                ...
                document.getElementById(FRM_Name + "DDLMatCat").focus()
                return false;
            }
            if (PO_NO == "" && Manual_PO_NO == "") {
    ...
    <table style="width: 1100px">
        <tr>
            <td align="left">
                ...
                <b>&gt; </b><font class="bluefnt"><b>Vendor Bill Entry </b></font>
            </td>
            <td align="right">
    ...
    <div align="left" style="width: 9.5in;">
            ...
            <ContentTemplate>
                <table cellspacing="1" style="width: 90%" class="boxbg" border="0">
                    <tr class="bgbluegrey">
                        <td colspan="3" align="center" style="height: 21px">
                            <asp:Label ID="lblQry" CssClass="blackfnt" Font-Bold="true" runat="server">
                                        Select Purchase Order Bill Entry Criteria
                            </asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr style="background-color: white">
                            ...
                            <td align="left">
                                <asp:DropDownList ID="DDLMatCat" runat="server"></asp:DropDownList>
                            </td>
                    </tr>
                    <tr style="background-color: white">
                        <td align="center">
                    ...
                    <tr style="background-color: white">
                        <td align="left">
                            <asp:Label ID="Label7" CssClass="blackfnt" Text="Enter Purchase Order No" runat="server"
                    ...
                    <tr style="background-color: white">
                        <td align="left">
                            <asp:Label ID="Label1" CssClass="blackfnt" Text="Enter Manual PO No" runat="server"
                                Width="213px"></asp:Label>
                        </td>
                        <td align="left" colspan="2" valign="top" style="height: 24px;">
                            <asp:TextBox ID="txtmanualpono" runat="server" Width="150px" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="background-color: white">
                        <td colspan="3">
        ...
        <div style="width: 9.5in" align="center">
            <asp:Button ID="Button3" runat="server" Text="Submit" CssClass="blackfnt" Width="150"
