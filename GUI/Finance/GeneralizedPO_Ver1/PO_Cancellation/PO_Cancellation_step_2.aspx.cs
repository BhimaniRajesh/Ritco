...
{   
    ...
    {
        string sql = "exec USP_POEntry_Listing '" + FromDtae + "','" + ToDtae + "','" + PONO + "','" + ManualPONO + "'";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            foreach (GridViewRow gr in grvcontrols.Rows)
            {
                ...
                if (chkbox.Checked)
                {
                    string sql_Acctrans = "exec USP_POEntry_Cancellation '" + lblPono.Text + "','" + POcanceldt + "','" + POcancelreason + "','" + SessionUtilities.CurrentEmployeeID.ToString() + "'";
