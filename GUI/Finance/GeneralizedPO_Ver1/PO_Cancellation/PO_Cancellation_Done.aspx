<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="PO_Cancellation_Done.aspx.cs" Inherits="GUI_finance_advice_AdvRecv_Done" Title="Untitled Page" %>
    ...
    <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="50%">
                ...
                RowStyle-CssClass="bgwhite" CssClass="boxbg" CellSpacing="1">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Document No" HeaderStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Center" >
                            <ItemTemplate>
                                <asp:Label ID="lblbillmrno" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"POMrNO")%>'></asp:Label> 
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
                <asp:LinkButton ID="lnkStep1" runat="server" Text="Cancel More PO" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/GeneralizedPO/PO_Cancellation/PO_Cancellation_step_1.aspx"/>
            </td>
        </tr>
    </table>
  </div>
