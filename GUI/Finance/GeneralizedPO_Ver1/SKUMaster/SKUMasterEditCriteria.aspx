<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="SKUMasterEditCriteria.aspx.cs" Inherits="GUI_Finance_GeneralizedPO_SKUMaster_SKUMasterEditCriteria" %>
                    ...
                    <table cellspacing="1" style="width: 8.0in" class="boxbg" align="left">
                        <tr class="bgbluegrey">
                            <td align="center" colspan="3">
                                <font class="blackfnt"><b>Updation of SKU Item</b></font>
                            </td>
                        </tr>
                        <tr style="background-color: white">
                            <td align="left">
                                <font class="blackfnt"><b>Select SKU Item</b></font>
                            </td>
