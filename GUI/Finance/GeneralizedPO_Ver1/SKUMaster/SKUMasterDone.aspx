<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="SKUMasterDone.aspx.cs" Inherits="GUI_Finance_GeneralizedPO_SKUMaster_SKUMasterDone" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <asp:Panel runat="server" Width="8in" ID="divmain">
        ...
        <asp:Table runat="server" ID="tblmain" HorizontalAlign="center" Width="100%" CellSpacing="1"
            ...
            <asp:TableRow CssClass="nrow" ID="trEdit">
                <asp:TableCell HorizontalAlign="left" ColumnSpan="2">
