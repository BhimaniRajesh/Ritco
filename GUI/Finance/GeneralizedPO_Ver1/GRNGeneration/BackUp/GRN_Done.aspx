        ...
        <tr>
            ...
            <td width="90%" align="left">
                <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="650">
                    ...
                    <tr style="background-color: White">
                        <td align="center">
                            <asp:Label ID="Lbl_GRN" runat="server" Text="GRN" Font-Bold="True"
                                CssClass="blackfnt"></asp:Label>
                        </td>
                        <td align="center">
                            <asp:Label ID="Lbl_GRNNo" runat="server" Text="Goods Recipt Note" Font-Bold="True"
                                CssClass="blackfnt"></asp:Label>
                        </td>
                        <td align="center">
                            <font class="blklnkund"><a href="Javascript:ViewPrint('<%=Request.QueryString.Get("GRNNO")%>',0)">
                                <font class="blklnkund">View</font></a> | <a href="Javascript:ViewPrint('<%=Request.QueryString.Get("GRNNO")%>',1)">
                    ...
                    <tr style="background-color: White">
                        <td align="left" colspan="4" style="height: 21px">
                            <a href="GRNCriteria.aspx"><font class="blackfnt">Prepare New GRN</font> </a>
                        </td>
                    </tr>
                </table>
            </td>
