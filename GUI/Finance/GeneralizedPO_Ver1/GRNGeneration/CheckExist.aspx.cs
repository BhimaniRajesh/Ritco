...
public partial class GUI_Finance_GeneralizedPO_POGeneration_CheckExist : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (mode.CompareTo("SKU") == 0)
            ...
            qry = "SELECT Count(*) FROM WEBX_FLEET_SPAREPARTHDR Where Part_Id='" + code + "'";
            ...
            qry = "SELECT COUNT(*) FROM WEBX_FLEET_TYREMODELMST WHERE TYRE_MODEL_ID ='" + code + "'";
        ...
        else if (mode.CompareTo("PONo") == 0)
            qry = "Select COUNT(*) FROM webx_GENERAL_POASSET_HDR Where POCODE='" + code + "'";
