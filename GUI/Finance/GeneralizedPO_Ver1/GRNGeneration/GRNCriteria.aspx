        ...
        function Validate() 
        {
            ...
            //{
              ...
              //      return false;
                //}
            //}
            //else if (document.getElementById('ctl00_MyCPH1_Txt_Custcd').value != '' && document.getElementById("ctl00_MyCPH1_ddlMatCat").value=='All') {
            //    alert('Please select the purchase order type');
                    ...
                    <table border="0" cellpadding="3" cellspacing="1" class="boxbg" style="width: 75%;"
                        ...
                        <tr class="bgbluegrey" style="height: 25px">
                            <td align="center" colspan="3">
                                <strong><span style="font-size: 8pt; font-family: Verdana">GRN Generation</span></strong>
                            </td>
                        </tr>
                        <tr id="Tr1" style="background-color: white" runat="server">
                            ...
                            <td colspan="2" align="left" style="height: 21px">
                                ...
                                <asp:ListItem Selected="True" Value="N" Text="Other"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr bgcolor="white">
