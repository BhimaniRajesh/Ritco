<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="GRNSTN_DetailList.aspx.cs" Inherits="GUI_Finance_GeneralizedPO_GRNGeneration_GRN_DetailList" %>
...
function DocBlur(id)
        {
            ...
            <div align="left" style="width: 9.5in;">
                <table cellspacing="1" width="100%" class="boxbg" border="0">
                    ...
                    <tr style="background-color: white">
                        <td align="left" >
                            <asp:Label ID="Label1" CssClass="blackfnt" Text="STN Number" runat="server"></asp:Label>
                        </td>
                        <td align="left" >
                            <asp:Label ID="LblSTNNo" CssClass="blackfnt" Font-Bold="true" runat="server"></asp:Label>
                        </td>
                        <td align="left" >
                            <asp:Label ID="Label7" CssClass="blackfnt" Text="STN Date" runat="server"></asp:Label>
                        </td>
                        <td align="left" >
                            <asp:Label ID="LblSTNDate" runat="server" Font-Bold="true"></asp:Label>
                        </td>
                        <td align="left" >
                            <asp:Label ID="Label8" CssClass="blackfnt" Text="GC Number" runat="server"></asp:Label>
                        </td>
                        <td align="left" >
                            <asp:Label ID="LblGCNo" runat="server" Font-Bold="true"></asp:Label>
                        </td>
                    </tr>
                    <tr style="background-color: white">
                        <td align="left" >
                            <asp:Label ID="Label6" CssClass="blackfnt" Text="Manual STN Number" runat="server"></asp:Label>
                        </td>
                        <td align="left" >
                            <asp:Label ID="LblManualSTNNo" CssClass="blackfnt" Font-Bold="true" runat="server"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label ID="Label10" CssClass="blackfnt" Text="STN Type" runat="server" ></asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label ID="LblSTNType" runat="server" Font-Bold="true"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label ID="Label9" CssClass="blackfnt" Text="Vehicle Number" runat="server" ></asp:Label>
                        </td>
                        <td align="left">
                ...
                <asp:GridView ID="GV_Booking" runat="server" align="left" BorderWidth="1" CellPadding="2"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="OrderQTY" ItemStyle-Wrap="true" HeaderText="STN Quantity"
                            HeaderStyle-Font-Bold="true">
                            <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                            <ItemStyle Width="150" Wrap="False" HorizontalAlign="Center" CssClass="blackfnt" />
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderStyle-Font-Bold="true" HeaderText="Received Qty (Current GRN)"
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtQty" runat="server" Enabled="False" OnChange="Javascript:return ENABLED_WT(this);"
                        ...
                        <asp:TemplateField HeaderStyle-Font-Bold="true" HeaderText="Pending Qty" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="HDNNarration" runat="server" Value='<%#DataBinder.Eval(Container.DataItem, "Comments") %>' />
                                <asp:HiddenField ID="HidSTNSrno" runat="server" Value='<%#DataBinder.Eval(Container.DataItem, "srno") %>' />
                                <asp:HiddenField ID="HidSdate" runat="server" Value='<%#DataBinder.Eval(Container.DataItem, "STNdate") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
