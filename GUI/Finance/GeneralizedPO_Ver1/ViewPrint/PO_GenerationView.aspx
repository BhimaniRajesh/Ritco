            ...
            <table border='<%=strborder %>' cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
                    ...
                    <td colspan="4" align="center" style="height: 21px">
                        <asp:GridView ID="GV_D" runat="server" align="center" HeaderStyle-CssClass='<%=bgbluegrey %>'
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Asset Code " HeaderStyle-Width="300">
                                    <HeaderStyle HorizontalAlign="Center" CssClass="blackfnt" Font-Bold="true" />
              ...
              <%--  <tr style="background-color: #ffffff">
                    ...
                    <td style="height: 24px">
                        <asp:Label ID="lblRequisitionNo" runat="server" CssClass="blackfnt"></asp:Label>
                    </td>
                    <td style="height: 24px" nowrap>
                        <label class="blackfnt">
                            Requisition Date :</label></td>
                    <td align="right" style="height: 24px">
                        <asp:Label ID="lblRequisitionDate" runat="server" CssClass="blackfnt"></asp:Label>
                    </td>
                </tr>--%>
                <tr style="background-color: #ffffff">
                    <td nowrap>
