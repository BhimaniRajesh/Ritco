<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="POFinalizedCriteria.aspx.cs" Inherits="GUI_Finance_GeneralizedPO_POViewPrint_POViewPrintCriteria" %>
        ...
        <table cellspacing="1" class="boxbg" align="left">
            <tr class="bgbluegrey">
                <td colspan="3" align="center">
                    <asp:Label ID="lblQry" CssClass="ffnt" Font-Bold="true" runat="server" Text="Selection Criteria For PO Details"></asp:Label>
                </td>
            </tr>            
            <tr bgcolor="white">
            ...
            <tr bgcolor="white">
                ...
                <td style="width: 130px">
                    <asp:Label ID="lblDocketNo" runat="server" CssClass="blackfnt" Text="Enter PO Code"></asp:Label>
                </td>
                <td>
            ...
            <tr bgcolor="white">
                ...
                <td style="width: 130px">
                    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="Enter Manual PO No"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtManualPONo" runat="server" BorderStyle="groove" CssClass="ltxt"
                        MaxLength="500"></asp:TextBox>
                </td>
            </tr>
