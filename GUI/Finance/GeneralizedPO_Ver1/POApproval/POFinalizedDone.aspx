...
CodeFile="POFinalizedDone.aspx.cs" Inherits="GUI_Operations_DocketFinalization_DocketFinalizationDone" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <asp:Panel runat="server" Width="8in" ID="divmain">
        ...
        <asp:Table runat="server" ID="tblmain" HorizontalAlign="center" Width="100%" CellSpacing="1"
            ...
            <asp:TableRow CssClass="nrow">
                <asp:TableCell HorizontalAlign="left" ColumnSpan="2">
                    <asp:LinkButton ID="lnkBtnNewDocket" CssClass="bluefnt" runat="server" Font-Bold="false" PostBackUrl="~/GUI/Finance/GeneralizedPO_Ver1/POApproval/POFinalizedCriteria.aspx"></asp:LinkButton>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </asp:Panel>
