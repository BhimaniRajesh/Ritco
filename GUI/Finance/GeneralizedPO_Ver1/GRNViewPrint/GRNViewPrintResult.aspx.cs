...
public partial class GUI_Finance_GeneralizedPO_POViewPrint_POViewPrintResult : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        //string SQLStr = "EXEC USP_GRN_Listing_For_View_Print '" + Type + "','" + VendorCode + "','" + FromDt + "','" + ToDt + "','" + GRNCode + "','" + ManualGRNCode + "','" + Session["empcd"].ToString() + "'";
        string SQLStr = "EXEC USP_GRN_Listing_For_View_Print '" + Type + "','" + VendorCode + "','" + FromDt + "','" + ToDt + "','" + GRNCode + "','" + ManualGRNCode + "','" + SessionUtilities.CurrentBranchCode.Trim() + "'";
