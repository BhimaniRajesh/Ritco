<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="POViewPrintCriteria.aspx.cs" Inherits="GUI_Finance_GeneralizedPO_POViewPrint_POViewPrintCriteria" %>
        ...
        <table cellspacing="1" class="boxbg" align="left">
            <tr class="bgbluegrey">
                <td colspan="3" align="center">
                    <asp:Label ID="lblQry" CssClass="ffnt" Font-Bold="true" runat="server" Text="Selection Criteria For General PO Details"></asp:Label>
                </td>
            </tr>            
            <tr bgcolor="white">
