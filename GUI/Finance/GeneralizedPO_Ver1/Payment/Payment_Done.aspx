<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Payment_Done.aspx.cs" Inherits="GUI_finance_voucher_voucher_done" Title="Untitled Page" %>
        ...
        <tr>
            ...
            <td width="90%" align="left">
                <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="650">
                    ...
                    <tr style="background-color: White">
                        <td align="center">
                            <asp:Label ID="Lbl_GRN" runat="server" Text="Payment Voucherno" Font-Bold="True"
                                CssClass="blackfnt"></asp:Label>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <font class="blackfnt"><font class="blklnkund"><a href="Javascript:ViewPrint('<%=Request.QueryString.Get("Voucherno")%>',0)">
                                <font class="blklnkund">View</font></a> | <a href="Javascript:ViewPrint('<%=Request.QueryString.Get("Voucherno")%>',1)">
                    ...
                    <tr style="background-color: White">
                        <td align="left" colspan="3" style="height: 21px">
                            <a href="Start.aspx"><font class="blackfnt">Make the Payment of More General Purchase</font>
                            </a>
