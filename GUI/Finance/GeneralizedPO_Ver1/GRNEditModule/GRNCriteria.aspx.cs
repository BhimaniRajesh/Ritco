...
public partial class GUI_Finance_GeneralizedPO_GRNGeneration_GRNCriteria : System.Web.UI.Page
{
    ...
    protected void ButSubmit_Click(object sender, EventArgs e)
    {
        ...
        string GRNNO = GRNno.Text.ToString();
        string GRNMANUALNO = GRNManualNo.Text.ToString();
        ...
        string Qstring = "";
        Qstring = "Type=" + TP;
        Qstring = Qstring + "&VendorCode=" + Txt_Custcd.Text;
        Qstring = Qstring + "&GRNNo=" + GRNNO;
        Qstring = Qstring + "&ManualGRNNo=" + GRNMANUALNO;
