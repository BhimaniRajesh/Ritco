...
<br /><br />
 <table border="0" width="100%">
        ...
        <tr style="background-color:White">
         ...
         <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="DebitVoucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Debit Voucher (With New Date)</font> </a>
         ...
         <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="DebitVoucher.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Debit Voucher (With Same Date)</font> </a>
