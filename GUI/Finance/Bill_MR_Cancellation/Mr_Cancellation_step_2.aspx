<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Mr_Cancellation_step_2.aspx.cs" Inherits="GUI_Finance_Bill_MR_Cancellation_Mr_Cancellation_step_2" Title="Untitled Page" %>
...
<table width="70%" border="0" cellpadding="0" cellspacing="0" style="height: 50px">
    <tr>
        <td>
            ...
            <a href=""><b><u>MR Cancellation</u></b></a></font>
        </td>
        <%--<td>
    ...
    <table cellspacing="1" width="50%" align="center" class="boxbg" border="0"> 
        ...
        <tr style="background-color: white">
            <td align="left" style="width: 100px;">
                <asp:Label ID="lbl"  CssClass="blackfnt" Text="Enter MR Cancellation Date" runat="server" Width="202px"></asp:Label>    
            </td>
            <td align="left" style="width: 40px;">
                <asp:TextBox ID="txtMRdt" Width="80px" runat="server"></asp:TextBox>
            </td>
            <td align="left" valign="top" width="500"> 
                <a href="#" onclick="cal.select(ctl00_MyCPH1_txtMRdt, 'alnkdt', 'dd/MM/yyyy'); return false;" id="alnkdt">
                                    ...
                                    <Columns>
                                        <asp:TemplateField ControlStyle-Width="50px" >
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdnMRdt" Value='<%# DataBinder.Eval(Container.DataItem,"MRSDT2")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="MR Type">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblmrstype" Text='<%# DataBinder.Eval(Container.DataItem,"MRTYPE") %>'
                                                    runat="server"></asp:Label>
                                                <asp:HiddenField ID="hdnmrstype" Value='<%# DataBinder.Eval(Container.DataItem,"MRSTYPE") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
