<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Mr_Cancellation_Done.aspx.cs" Inherits="GUI_finance_advice_AdvRecv_Done" Title="Untitled Page" %>
    ...
    <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="60%">
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
                <asp:LinkButton ID="lnkStep1" runat="server" Text="Cancel More Bill/MR" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/Bill_MR_Cancellation/Bill_MR_Cancellation_step_1.aspx"/>
            </td>
        </tr>
    </table>
  </div>
