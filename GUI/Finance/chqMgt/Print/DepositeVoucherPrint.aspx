<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepositeVoucherPrint.aspx.cs" Inherits="GUI_Finance_chqMgt_Print_DepositeVoucherPrint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>WebXpress: Deposite Voucher Print</title>
    <link id="Link1" href="~/GUI/images/style_print.css" rel="Stylesheet" type="text/css" runat="server" />
</head>
<body onload="javascript:window.print();">
    <form id="form1" runat="server">
    <div>
<table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" style="width:9in;" align="center">
    <tr class="blackfnt">
        <td align="center" class="bgbluegrey" width="10%"><font class="blackfnt"><b>Deposite Payment Voucher Summary</b></font></td>
    </tr>
</table>
<br />
<table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" style="width:9in;" align="center">
    ...
    <tr class="blackfnt">
        ...
        <td align="left" bgcolor="#ffffff"><asp:Label ID="lblDepositedInAccount" runat="server"></asp:Label></td>
    </tr>
    <tr class="blackfnt">
        <td align="left" class="bgbluegrey">Narration</td>
        <td align="left" bgcolor="#ffffff"><asp:Label ID="lblNarration" runat="server"></asp:Label></td>
...
<table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" style="width:9in;" align="center">
    <tr class="blackfnt">
        <td class="bgbluegrey">
            <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" style="width:100%;" align="center">
                <tr class="blackfnt">
                    ...
                    <td align="center" class="bgbluegrey" width="15%"><font class="blackfnt">Amount</font></td>
                ...
                <ItemTemplate>
                    <table border=0 cellpadding="3" width="100%" bgcolor="#808080" cellspacing="1" class=boxbg>
                        <tr bgcolor="white"> 
                            ...
                            <td align="center" width="15%"><font class=blackfnt><%#DataBinder.Eval(Container.DataItem, "ChqAmt")%></font></td>
        ...
        <td class="bgbluegrey">
            <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" style="width:100%;" align="center">
                <tr class="blackfnt">
                    ...
                    <td align="center" bgcolor="#ffffff" width="10%"><font class="blackfnt"><b>Total</b></font></td>
                    <td align="center" bgcolor="#ffffff" width="15%"><font class="blackfnt"><b><asp:Label runat="server" ID="lblTotalAmount" Text=""></asp:Label></b></font></td>
    ...
    <tr class="blackfnt">
        <td class="bgbluegrey" colspan="7">
            <table class="bgbluegrey" border="0" cellpadding="3" cellspacing="1" width="100%">
                <tr class="blackfnt">
