...
<br/><br/>
    ...
    <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="70%">
        ...
        <tr style="background-color:White">
            ...
            <td align="center"> 
                <a href="javascript:nwOpenViewWindow('AdviceView.aspx?AdviceNo=<%= Request.QueryString["AdviceNo"].ToString() %>');"><font class="blackfnt">View</font></a>
                <asp:Label ID="lblSep1" runat="server" Text="|" CssClass="blackfnt"></asp:Label>
                <a href="javascript:nwOpenPrintWindow('AdvicePrint.aspx?AdviceNo=<%= Request.QueryString["AdviceNo"].ToString() %>');"><font class="blackfnt">Print</font></a>
