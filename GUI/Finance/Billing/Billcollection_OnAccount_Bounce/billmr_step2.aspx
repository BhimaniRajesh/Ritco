...
//	{
		...
		var  varbillamt=rounditn(parseFloat(txtpendamt.value)-(vartds+varfrtrebate+varclaim+varunexpamt),2)
		//alert(varbillamt)
		var  vartotalamt=rounditn(parseFloat(vartotalamt)+varbillamt,2)//tds+frtrebate+claim+unexpamt
		var varbillamt
		if (varbillamt<0)
		{	
		      ...
		      if(j < 10)
                ...
                if(document.getElementById(mDerivedControlName))
                {
                   // alert(document.getElementById(mDerivedControlName_tds).value)
                    nettotalamt=rounditn(parseFloat(nettotalamt)+parseFloat(document.getElementById(mDerivedControlName).value),2)
                    vartottds=rounditn(parseFloat(vartottds)+parseFloat(document.getElementById(mDerivedControlName_tds).value),2)
                    total_pendamt=rounditn(parseFloat(total_pendamt)+parseFloat(document.getElementById(mDerivedControlName_pendamt).value),2)
                }
                totaltds=vartottds
                
                //alert(totaltds)
		    netamt.value=rounditn(nettotalamt,2)
		}
...
//	return false
	...
	//alert(tottds)
	tottds.value=rounditn(totaltds,2)
	
	varcolamt=rounditn(parseFloat(colamt.value),2)
    ...
    <table   border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width:60%"  align="center">
       ...
       <tr bgcolor="white" style="height:25px; font-size: 12pt; font-family: Times New Roman;">
            ...
            <td style="width: 339px">
              ...
              <asp:TextBox ID="txtVoucherDate" runat="server" Width="60px" Columns="8" onblur="javascript:ValidateForm(this)" Enabled="true"></asp:TextBox>
										 <a href="#"  onclick="cal.select(ctl00$MyCPH1$txtVoucherDate,'anchor1','dd/MM/yyyy'); return false;"  name="anchor1" id="a1" ><img src="../../../images/calendar.jpg" border="0" /> </a> 
										dd/mm/yyyy </td>
