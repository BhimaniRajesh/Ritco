    ...
    <table bgcolor="white" width="60%" border="0" cellspacing="0" cellpadding="3" align="left" class=boxbg>
                    ...
                    <table width="86%" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#808080" class=boxbg>
                        ...
                        <tr bgcolor="#ffffff"> 
                          ...
                          <asp:TextBox ID="txtsubbranch"  CssClass="input" onblur="javascript:PartyBlur(this,'loc')" runat="server" ValidationGroup="VGDtFromTo" Width="80"></asp:TextBox>
                              <asp:Button ID="btnsubbranch" CssClass="input" runat="server"  Text="..." OnClientClick="javascript:nwOpen1(3)" />
                              <%--<input tabIndex="1" type=button value="..." name=branchpopup onclick="fOpenInPopup('../../../webadmin/popup-branch.asp?7')">--%>
                              </font></div></td>
        ...
        <tr>
            ...
            <table width="86%" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#808080" class=boxbg>
                ...
                <tr bgcolor="#ffffff"> 
                  <td width="7%"  class="" height="36"> <div align="center"><font class="blackfnt">1</font></div></td>
                ...
                <tr bgcolor="#ffffff"> 
                  <td width="7%"  class=""> <div align="center"><font class="blackfnt">2</font></div></td>
                  <td width="61%"><font class="blackfnt"><asp:Label ID="lblwarehousingchrg" Text="Ware Housing Charges" CssClass="blackfnt" runat="server" ></asp:Label></font></td>
                ...
                <tr bgcolor="#ffffff"> 
                  <td width="7%"  class=""> <div align="center"><font class="blackfnt">3</font></div></td>
                ...
                <tr bgcolor="#ffffff"> 
                  <td width="7%"  class=""> <div align="center"><font class="blackfnt">4</font></div></td>
                  <td width="61%"><font class="blackfnt">
                ...
                <tr bgcolor="#ffffff"> 
                  <td width="7%"  class=""> <div align="center"><font class="blackfnt">5</font></div></td>
                  <td width="61%"><font class="blackfnt">
                ...
                <tr bgcolor="#ffffff"> 
                  <td width="7%"  class=""> <div align="center"><font class="blackfnt">6</font></div></td>
                  <td width="61%"><font class="blackfnt">
