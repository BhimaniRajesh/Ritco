...
public partial class GUI_UNI_MIS_MR_Summary_MR_Summ_Popup : System.Web.UI.Page
{
    ...
    public string warechrg, vehdetchrg, dischrg, handchrg, rentalcharg, othchrg, hedu_cess, servicetax, cesstax, sbccess, total, print_yn;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        double warechrg_d, vehdetchrg_d, dischrg_d, handchrg_d, rentalcharg_d, othchrg_d, hedu_cess_d, servicetax_d, cesstax_d, sbccess_d, total_d;
