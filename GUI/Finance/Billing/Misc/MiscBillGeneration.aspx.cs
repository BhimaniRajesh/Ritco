...
public partial class GUI_Finance_Billing_MiscBillGeneration : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        sql += "AggrementNo,svctax_rate,cess_rate,hedu_cess,SBCAMT,SBCRATE,KKCAMT,KKCRATE)";
        ...
        sql += rentalchrg.Text + "','" + otherchrg.Text + "','" + dtfrom + "','" + dtto + "','" + txtagrno.Text + "'," + HdnServiceTaxRate.Value + "," + HdnEduCessRate.Value + "," + HdnHEduCessRate.Value + "," + HdnSBCRate.Value + ",'" + SBC.Text + "'," + HdnKKCRate.Value + "," + KKC.Text + ")";
