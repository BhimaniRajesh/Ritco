...
//			alert("dt : " + dt)
				...
				if (dt<Fromdate1)
				{
						...
						alert( "Bill Generation Date Should Be Greater than or Equals to "+ Fromdate +" !!!")
						bgndt.focus();
						return false;
				}
				...
				bduedt1=new Date(months[parseFloat(dt_mm)] + " " + parseFloat(dt_dd) + ", " + parseFloat(dt_yy));
...
<asp:BoundColumn HeaderText="Docket Total" ReadOnly="True"   ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="right" HeaderStyle-Wrap="false"  DataField="dkttot"/>
     ...
     <br />
   <%-- <p>
     <center><font class="blackfnt"><b>List of Dockets for which Bill Can be generated:  </b></font> </center>
    </p>--%>
...
<Columns >
  <asp:TemplateField>
                <ItemTemplate>
                    <center>
                    <asp:CheckBox id="chkDock"    Enabled="true" runat="server"  />
                    </center>
                </ItemTemplate>
     </asp:TemplateField>
...
<asp:BoundField DataField="docknosf" HeaderText="Docket No" >

<HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
<ItemStyle CssClass="blackfnt" />
</asp:BoundField>
<asp:BoundField DataField="paybasdesc" HeaderText="Paybas" >
<HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
<ItemStyle CssClass="blackfnt" />
</asp:BoundField>

<asp:BoundField DataField="modedesc" HeaderText="Mode" >
<HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
<ItemStyle CssClass="blackfnt" />
</asp:BoundField>


<asp:BoundField DataField="dock_cdeldt" HeaderText="Bkg Date : Comm Dely DT" >
<HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
<ItemStyle CssClass="blackfnt" />
</asp:BoundField>

<asp:BoundField DataField="FRT_chrg_RATE" HeaderText="Chrg Wt./Freight" >
<HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
<ItemStyle CssClass="blackfnt" />
</asp:BoundField>

<asp:BoundField DataField="dktchg" HeaderText="Docket Charges" >
<HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
<ItemStyle CssClass="blackfnt" />
</asp:BoundField>
