...
"July", "August", "September", "October", "November", "December");
        ...
        function CheckDocketSelection(party_code,txtDateFrom,txtDateTo)
        {
     ...
     <table   border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width:85%; height: 383px;"  align="center">
       ...
       <tr bgcolor="white" style="height:25px">
        ...
        <td style="width: 210px"  align="center">
            ...
            <td style="width: 339px">
                <asp:DropDownList ID="Cbotrnmod" runat="server" OnSelectedIndexChanged="Cbotrnmod_SelectedIndexChanged">
