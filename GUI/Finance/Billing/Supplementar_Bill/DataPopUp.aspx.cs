    ...
    protected void btnpartysubmit_Click(object sender, EventArgs e)
    {
        ...
        else if (mode.CompareTo("LocCode") == 0)
        {
            ...
            else if (mode.CompareTo("V") == 0)
            {
                ...
                if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select vendorCode,vendorname from webx_VENDOR_HDR WITH(NOLOCK) where ACTIVE='Y' and vendorcode in ( select vendorcode from webx_VENDOR_det WITH(NOLOCK)  where vendorCode is not null and    PATINDEx ('%" + Session["brcd"].ToString() + "%',vendorbrcd)>0 ) order by vendorname";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select vendorCode,vendorname from webx_VENDOR_HDR WITH(NOLOCK) WHERE ACTIVE='Y' and vendorcode in ( select vendorcode from webx_VENDOR_det WITH(NOLOCK)  where vendorCode is not null and    PATINDEx ('%" + Session["brcd"].ToString() + "%',vendorbrcd)>0 ) and vendorCode like '" + txtcustcode.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") != 0)
                {
                    qry = "select vendorCode,vendorname from webx_VENDOR_HDR WITH(NOLOCK) WHERE ACTIVE='Y' and vendorcode in ( select vendorcode from webx_VENDOR_det WITH(NOLOCK)  where vendorCode is not null and    PATINDEx ('%" + Session["brcd"].ToString() + "%',vendorbrcd)>0 ) and vendorname like '" + txtcustname.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") != 0)
                {
            ...
            else if (mode.CompareTo("P") == 0)
            {
                ...
                if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select custcd,custnm from webx_custhdr WITH(NOLOCK) where CUST_ACTIVE='Y' and CUSTCD is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',custloc)>0  order by CUSTNM";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select custcd,custnm from webx_custhdr WITH(NOLOCK) where CUST_ACTIVE='Y' and CUSTCD is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',custloc)>0  and custcd like '" + txtcustcode.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") != 0)
                {
                    qry = "select custcd,custnm from webx_custhdr WITH(NOLOCK) where CUST_ACTIVE='Y' and CUSTCD is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',custloc)>0  and custnm like '" + txtcustname.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") != 0)
                {
                    qry = "select custcd,custnm from webx_custhdr WITH(NOLOCK) where CUST_ACTIVE='Y' and CUSTCD is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',custloc)>0 and custnm like '" + txtcustname.Text.ToString() + "%' and custcd like '" + txtcustcode.Text.ToString() + "%'";
                }
                ...
                while (dr.Read())
                {
                    ...
                    //rad.Attributes.Add("onclick", "javascript:return radPartyClick(this.getAttribute('id'),'" + codeid + "','" + nameid + "','" + Convert.ToString(dr["custcd"]) + "','" + Convert.ToString(dr["custnm"]) + "')");
                    rad.Attributes.Add("onclick", "javascript:return radEmpVenCustClick(this.getAttribute('id'),'" + ctlid + "','" + tbl + "','" + dr["custcd"].ToString() + "')");
            ...
            else if (mode.CompareTo("D") == 0)
            {
                ...
                if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select Manual_Driver_Code,Driver_Name from webx_fleet_drivermst WITH(NOLOCK) where ActiveFlag='Y' and Driver_id is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',Driver_Location)>0  order by Driver_Name";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") == 0)
                {
                    qry = "select Manual_Driver_Code,Driver_Name from webx_fleet_drivermst WITH(NOLOCK) where ActiveFlag='Y' and Driver_id is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',Driver_Location)>0  and Manual_Driver_Code like '" + txtcustcode.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") == 0 && txtcustname.Text.CompareTo("") != 0)
                {
                    qry = "select Manual_Driver_Code,Driver_Name from webx_fleet_drivermst WITH(NOLOCK) where ActiveFlag='Y' and Driver_id is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',Driver_Location)>0  and Driver_Name like '" + txtcustname.Text.ToString() + "%'";
                }
                else if (txtcustcode.Text.CompareTo("") != 0 && txtcustname.Text.CompareTo("") != 0)
                {
                    qry = "select Manual_Driver_Code,Driver_Name from webx_fleet_drivermst WITH(NOLOCK) where ActiveFlag='Y' and Driver_id is not null and PATINDEx ('%" + Session["brcd"].ToString() + "%',Driver_Location)>0 and Driver_Name like '" + txtcustname.Text.ToString() + "%' and Manual_Driver_Code like '" + txtcustcode.Text.ToString() + "%'";
                }
                ...
                while (dr.Read())
                {
                    ...
                    rad.GroupName = "grplist";
                    rad.ID = "rad" + dr["Manual_Driver_Code"].ToString();
            ...
            else if (mode.CompareTo("L") == 0)
            {
                ...
                {
                    qry = "select Vehno as Vehicleno,Vehno as Vehiclename from webx_vehicle_hdr WITH(NOLOCK) where ActiveFlag='Y' and Vehno is not null order by Vehno";
                }
                else if (txtcustcode.Text.CompareTo("") != 0)
                {
                    qry = "select Vehno as Vehicleno,Vehno as Vehiclename from webx_vehicle_hdr WITH(NOLOCK) where ActiveFlag='Y' and Vehno is not null and Vehno like '" + txtcustcode.Text.ToString() + "%'";
                }
