...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fcalbillamt() {
            ...
            totalchrg = parseFloat(subtotal) + parseFloat(sertax) + parseFloat(cess) + parseFloat(H_cess)+ parseFloat(SBC);
        ...
        function GetTot() {
            ...
            if (document.getElementById("ctl00_MyCPH1_svctax_yn").checked) {
                document.getElementById("ctl00_MyCPH1_sertax").value = rounditn((parseFloat(TotAmt.value) * parseFloat(HdnServiceTaxRate.value) / 100), 2);
                document.getElementById("ctl00_MyCPH1_cess").value = rounditn((parseFloat(document.getElementById("ctl00_MyCPH1_sertax").value) * HdnEduCessRate.value / 100), 2);
                document.getElementById("ctl00_MyCPH1_H_cess").value = rounditn((parseFloat(document.getElementById("ctl00_MyCPH1_sertax").value) * HdnHEduCessRate.value / 100), 2);
                document.getElementById("ctl00_MyCPH1_SBC").value = rounditn((parseFloat(TotAmt.value) * parseFloat(HdnSBCRate.value) / 100), 2);
                document.getElementById("ctl00_MyCPH1_KKC").value = rounditn((parseFloat(TotAmt.value) * parseFloat(HdnKKCRate.value) / 100), 2);
            }
            else {
                document.getElementById("ctl00_MyCPH1_sertax").value = "0.00";
                document.getElementById("ctl00_MyCPH1_cess").value = "0.00";
            ...
            var TP = parseFloat(Number(TotAmt.value) + Number(document.getElementById("ctl00_MyCPH1_sertax").value) + Number(document.getElementById("ctl00_MyCPH1_cess").value) + Number(document.getElementById("ctl00_MyCPH1_H_cess").value) + Number(document.getElementById("ctl00_MyCPH1_SBC").value) + Number(document.getElementById("ctl00_MyCPH1_KKC").value));
                ...
                <table bgcolor="white" width="100%" border="0" cellspacing="0" cellpadding="3" align="left" class="boxbg">
                        ...
                        <td bgcolor="white">
                            ...
                            <asp:UpdatePanel ID="UP1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                <contenttemplate>
                                    <table width="86%" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#808080" class="boxbg">
                                        ...
                                        <tr bgcolor="#ffffff">
                                            <td><font class="blackfnt">
                                                <asp:Label ID="Label2" Text="Narration" CssClass="blackfnt" runat="server"></asp:Label></font></td>
                                            ...
                                            <td colspan="3"><font class="blackfnt">
                                                <asp:TextBox ID="txtMainNarration" onblur="javascript:return FillAccNarration()" runat="server" BorderStyle="Groove" CssClass="input" TextMode="MultiLine" Width="250px"></asp:TextBox></font></td>
                                        </tr>
                                        <tr bgcolor="#ffffff">
                                            <td>Document Name</td>
                                            <td align="left">
                            ...
                            <asp:RadioButton ID="RAD_THC" AutoPostBack="true" GroupName="Pbov_list" runat="server" Text='<%=Session["THCCalledAs"].ToString()%>' /></td>
                                            <td align="left" colspan="2">
                                                <asp:TextBox ID="txtdocThc" onblur="javascript:return checkdockthc()" runat="server" BorderStyle="Groove" CssClass="input" Width="150px"></asp:TextBox></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="350" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#808080" class="boxbg">
                                        ...
                                        <tr style="background-color: White">
                                            ...
                                            <td style="text-align: center" class="blackfnt">&nbsp;<asp:TextBox ID="txtRows" runat="server" BorderStyle="Groove" onkeypress="javascript:validInt(event);" CssClass="input" Width="100px"></asp:TextBox>
                    ...
                    <asp:TextBox ID="cess" CssClass="input" Enabled="false" runat="server" ValidationGroup="VGDtFromTo" Width="80" Text="0.00" onblur="javascript:fcalbillamt()" onchange="javascript:return Nagative_Chk_wDecimal(this)" TabIndex="8"></asp:TextBox>
                                ...
                                <tr bgcolor="#ffffff">
                                    ...
                                    <td width="32%" class=""><font class="blackfnt">&nbsp; 
                    			<asp:TextBox ID="KKC" CssClass="input" Enabled="false" runat="server" ValidationGroup="VGDtFromTo" Width="80" Text="0.00" onblur="javascript:fcalbillamt()"
                                    onchange="javascript:return Nagative_Chk_wDecimal(this)" TabIndex="8"></asp:TextBox>
                                    </font></td>
                                </tr>
                                <tr bgcolor="#ffffff">
                                    <td width="7%" class="">&nbsp;</td>
