<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupbranch.aspx.cs" Inherits="popupbranch"  EnableEventValidation="false"%>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" ItemStyle-BackColor="white" ItemStyle-Width="40px" >
                                    <ItemTemplate>
                                        <%--<input name="MyRadioButton" type="radio" value='<%# DataBinder.Eval(Container.DataItem,"CUSTCD") %>' onclick="SelectLocation(this)"/>--%>                
                                        <asp:RadioButton ID="MyRadioButton" Text="<%# DataBinder.Eval(Container.DataItem,"CUSTCD") %>" onclick="SelectLocation(this)" runat="server" />                       
                                    </ItemTemplate>
                                </asp:TemplateField>
