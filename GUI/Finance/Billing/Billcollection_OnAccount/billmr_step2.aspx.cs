        ...
        if (ErrMsg == "")
        {
            ...
            try  //  try FOR ALL
            {
               ...
               // conn.Open();
                ...
                if (Billingtype == "6")
                {
                    Sql_trans = "exec usp_OctroiBIllTransaction 2,'" + MRSNo + "','" + Financial_Year + "'";
                    Sql_trans1 = "exec usp_OctroiBIllTransaction 3,'" + MRSNo + "','" + Financial_Year + "'";
                }
                else if (Billingtype == "2" || Billingtype == "7")
                {
                    Sql_trans = "exec usp_BillTransaction 2,'" + MRSNo + "','" + Financial_Year + "'";
                    Sql_trans1 = "exec usp_BillTransaction 3,'" + MRSNo + "','" + Financial_Year + "'";
                }
                if (Sql_trans != "")
                {
