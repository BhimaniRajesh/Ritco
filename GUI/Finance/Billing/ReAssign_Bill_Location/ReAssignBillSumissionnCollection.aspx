...
function validateBoxes()
{
   ...
   for(var i=2;i<=r;i++)
   {
        ...
        var txtbillno,txtsubloc,txtcolloc,hdnbillstatus;
        if(i<10)
            {
                ...
                hdnbillstatus=document.getElementById("ctl00$MyCPH1$grvcontrols$ctl0" + i + "$hdnbillstatus");
            }
        else
            {
                ...
                hdnbillstatus=document.getElementById("ctl00$MyCPH1$grvcontrols$ctl" + i + "$hdnbillstatus");
            }
            
            if(txtbillno.value != "")
                {
                    non=1;
                    if(hdnbillstatus.value == "Bill Generated")
                    {
                        if(txtsubloc.value == "")
                        {
                    ...
                    if(hdnbillstatus.value == "Bill Submitted")
                    {
                        if(txtsubloc.value != "")
                        {
                            alert("You Cant Change Submission Location Of Submitted Bill");
                            txtsubloc.value="";
                            txtsubloc.focus();
                            return false;
                        }
...
function billBlur(id)
{
    ...
    var txtexsubloc=document.getElementById(str1);
    var txtexcolloc=document.getElementById(str + "txtexcolloc");
    
    var txtsubloc=document.getElementById(str + "txtsubloc");
    var txtcolloc=document.getElementById(str + "txtcolloc");
    var btnsubloc=document.getElementById(str + "btnsubloc");
    
    var hdnbillstatus=document.getElementById(str + "hdnbillstatus");
             ...
             if(findobj.readyState==4 && findobj.status==200)
                {
                    ...
                    if(res[0]=="true")
                    {
                        hdnbillstatus.value = res[3];
                        if(res[3] == "Bill Generated")
                        {
                            txtexsubloc.value=res[1];
                            txtexcolloc.value=res[2];
                            txtsubloc.disabled = false;
                            btnsubloc.disabled = false;
                        }
                        if(res[3] == "Bill Submitted")
                        {
                            txtexsubloc.value=res[1];
                            txtexcolloc.value=res[2];
                            txtsubloc.disabled = true;
                            btnsubloc.disabled = true;
                        }
                    }
                }
         }
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Sr. No.">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdnbillstatus" runat="server" />    
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Bill Number">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" BorderStyle="Groove" MaxLength="30" Width="100px" ID="txtbillno"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Existing Submission Location">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtexsubloc" BorderStyle="Groove" Enabled="false" MaxLength="50" Width="60px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle HorizontalAlign="Center" Wrap="False" BackColor="#d4e0e7" CssClass="blackfnt" />
                                        ...
                                        <ItemStyle CssClass="blackfnt" BackColor="white" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtsubloc" BorderStyle="Groove" MaxLength="50" Width="60px" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnsubloc" Text="..." CssClass="blackfnt" runat="server" Enabled="true" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Existing Bill Collection Location">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtexcolloc" Enabled="false" BorderStyle="Groove" MaxLength="50" Width="60px" runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="New Bill Location">
                                        ...
                                        <ItemStyle CssClass="blackfnt" HorizontalAlign="Center" BackColor="white" />
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtcolloc" BorderStyle="Groove" MaxLength="50" Width="60px" runat="server"></asp:TextBox>
