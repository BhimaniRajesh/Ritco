...
public partial class GUI_Finance_Billing_BillEdit_ReAssignBillSumissionnCollection : System.Web.UI.Page
{
    ...
    protected void grvcontrols_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ((Button)e.Row.FindControl("btnsubloc")).Attributes.Add("onclick", "popuplist('location','" + ((TextBox)e.Row.FindControl("txtsubloc")).ClientID.ToString() + "','none')");
            ((Button)e.Row.FindControl("btncolloc")).Attributes.Add("onclick", "popuplist('location','" + ((TextBox)e.Row.FindControl("txtcolloc")).ClientID.ToString() + "','none')");
        }
