<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="FrmBillDetail_Supp.aspx.cs" Inherits="GUI_Finance_Billing_BillViewPrint_FrmBillDetail_Supp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    var viewprint=viewprint;
        ...
        var strPopupURL = "../Supplementar_Bill/viewPrintSuppBill.aspx?billno=" + strbillno + "," +viewprint
            ...
            <Columns>
               <%-- <asp:TemplateField HeaderText="Bill Number">
                ...
                <asp:TemplateField HeaderText="Bill Type">
                    <HeaderStyle CssClass="blackfnt" />
                    <ItemTemplate>
                        <asp:Label ID="lblbilltype" CssClass="blackfnt" Text="Supplimentry"
                            runat="server"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
