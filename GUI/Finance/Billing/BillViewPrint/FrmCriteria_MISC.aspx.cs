...
public partial class GUI_Finance_Billing_BillViewPrint_FrmCriteria_MISC : System.Web.UI.Page
{
    SqlConnection cn;
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            Response.Redirect("FrmBillDetail_Misc.aspx?FrmDate=" + txtDateFrom.Text + "&ToDate=" + txtDateTo.Text + "&billno=" + txtbillno.Text + "&mbillno=" + txtmbillno.Text + "&partycode=" + txtpartycode.Text + "&billtype=" + cmbbilltype.Text + "&billstatus=" + cmbbillstatus.Text + "");
        }
    }
