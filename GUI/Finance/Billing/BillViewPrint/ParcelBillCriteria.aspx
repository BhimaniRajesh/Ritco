<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ParcelBillCriteria.aspx.cs" Inherits="GUI_Finance_Billing_BillViewPrint_ParcelBillCriteria" %>
            ...
            <tr bgcolor="white">
                ...
                <td align="left" colspan="2" valign="top">
                    <asp:DropDownList ID="cmbbilltype" runat="server">
                        ...
                        <asp:ListItem Value="7">Parcel</asp:ListItem>
                    </asp:DropDownList></td>
                <td align="left" colspan="1" valign="top">
                </td>
            </tr>
