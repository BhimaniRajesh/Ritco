<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="FrmCriteria_MISC.aspx.cs" Inherits="GUI_Finance_Billing_BillViewPrint_FrmCriteria_MISC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
            ...
            <tr>
                <td align="left" style="width: 779px">
                    <a><font class="blklnkund"><b>Module</b></font></a> <b>&gt; </b><a><font class="blklnkund">
                        <b>Finance</b></font></a> <b>&gt; </b><a href="../Billing.aspx"><font class="blklnkund">
                            <b>Billing</b></font></a> <b>&gt; </b><font class="bluefnt"><b>Billing View & Print</b></font>
                </td>
                <td align="right">
    ...
    <div align="left">
        <table border="0" cellpadding="0" cellspacing="1" class="boxbg">
            <tr class="bgbluegrey">
                <td align="center" class="blackfnt" colspan="4">
                    Select Sales Criteria
                </td>
                <td align="center" class="blackfnt" colspan="1">
                </td>
            </tr>
            <tr bgcolor="white">
                ...
                <td align="left" colspan="1" valign="top">
                    ...
                    <asp:CustomValidator ID="CustomValidator1" runat="server" align="left" ErrorMessage="To date can not be smaller than from date "
                        OnServerValidate="abc" Width="255px"></asp:CustomValidator><br />
            ...
            <tr bgcolor="white">
                <td align="left" class="blackfnt" valign="top">
                    Enter Billing Party Code</td>
                <td align="left" colspan="2" valign="top">
                    <asp:TextBox ID="txtpartycode" runat="server"></asp:TextBox><asp:Button ID="BtnCustCode"
                        runat="server" OnClientClick='return BranchPopup("FrmCCodePopUp.aspx")' Width="21px" /></td>
                <td align="left" colspan="1" valign="top">
                </td>
            </tr>
            <tr bgcolor="white">
                <td align="left" class="blackfnt" valign="top">
                    Bill Type</td>
                <td align="left" colspan="2" valign="top">
                    <asp:DropDownList ID="cmbbilltype" runat="server">
                        <asp:ListItem Value="-">-All-</asp:ListItem>
                        <asp:ListItem Value="7">Misc</asp:ListItem>
                    </asp:DropDownList></td>
                <td align="left" colspan="1" valign="top">
                </td>
            </tr>
            <tr bgcolor="white">
                <td align="left" class="blackfnt" valign="top">
                    Select Bill Status</td>
                <td align="left" colspan="2" valign="top">
                    <asp:DropDownList ID="cmbbillstatus" runat="server">
                        <asp:ListItem>-All-</asp:ListItem>
                        <asp:ListItem>Bill Generated</asp:ListItem>
                        <asp:ListItem>Bill Submitted</asp:ListItem>
                        <asp:ListItem>Bill Due, not collected</asp:ListItem>
                        <asp:ListItem>Bill Due, and Collected</asp:ListItem>
                        <asp:ListItem>Bill collected, not due</asp:ListItem>
                        <asp:ListItem>CBS date entered</asp:ListItem>
                    </asp:DropDownList></td>
                <td align="left" colspan="1" valign="top">
                </td>
            </tr>
            <tr bgcolor="white">
                <td colspan="4" class="blackfnt" align="center">
                    Or</td>
            </tr>
            <tr bgcolor="white">
                <td align="left" class="blackfnt">
                    Enter System Bill No.</td>
                <td align="left" class="blackfnt" colspan="3">
                    <asp:TextBox ID="txtbillno" runat="server" Width="204px"></asp:TextBox></td>
            </tr>
            <tr bgcolor="white">
                <td colspan="4" class="blackfnt" align="center">
                    Or</td>
            ...
            <tr bgcolor="white">
                <td align="left" class="blackfnt">
                    Enter Manual Bill No.</td>
                <td align="left" class="blackfnt" colspan="3">
                    <asp:TextBox ID="txtmbillno" runat="server" Width="204px"></asp:TextBox></td>
            </tr>
        </table>
    </div>
