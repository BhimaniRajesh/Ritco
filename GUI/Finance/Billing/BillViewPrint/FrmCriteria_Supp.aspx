<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="FrmCriteria_Supp.aspx.cs" Inherits="GUI_Finance_Billing_BillViewPrint_FrmCriteria_Supp" %>
            ...
            <tr bgcolor="white">
                ...
                <td align="left" colspan="2" valign="top">
                    <asp:DropDownList ID="cmbbilltype" runat="server">
                        ...
                        <asp:ListItem Value="7">Supp</asp:ListItem>
                    </asp:DropDownList></td>
                <td align="left" colspan="1" valign="top">
                </td>
            </tr>
