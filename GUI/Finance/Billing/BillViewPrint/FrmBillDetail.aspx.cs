...
public partial class FrmPaidFollowUp : System.Web.UI.Page
{
    ...
    public void BindTheData()
    {
        ...
        {
            cmd.CommandText = "select billno,bbrcd,ptmscd,ptmsnm,paybas,BILLAMT,bgndt,bsbdt,bduedt,bcldt,bcbsdt,ptmsbrcd,billsubbrcd,billcolbrcd,bill_cancel,BGENEMPCD,billstatus from webx_billmst where manualbillno='" + mbillno + "'"; 
        }
        else
        {
            ...
            else if ((pcode != "") && (billtype != "-"))
            {
                ...
                cmd.CommandText = "select billno,bbrcd,ptmscd,ptmsnm,paybas,BILLAMT,bgndt,bsbdt,bduedt,bcldt,bcbsdt,ptmsbrcd,billsubbrcd,billcolbrcd,billstatus from webx_billmst where ptmscd in ('" + pcode + "') And paybas='" + billtype + "' And ( convert(varchar,bgndt,106) between Convert(datetime,'" + frmdate + "',106) and convert(datetime,'" + todate + "',106))";
            }
            else if ((pcode != ""))
            {
                ...
                cmd.CommandText = "select billno,bbrcd,ptmscd,ptmsnm,paybas,BILLAMT,bgndt,bsbdt,bduedt,bcldt,bcbsdt,ptmsbrcd,billsubbrcd,billcolbrcd,billstatus from webx_billmst where ptmscd in ('" + pcode + "') and paybas like '%' And ( convert(varchar,bgndt,106) between Convert(datetime,'" + frmdate + "',106) and convert(datetime,'" + todate + "',106))";

            }
            else if ((billtype != "-"))
            {
                //cmd.CommandText = "select billno,bbrcd,ptmscd,ptmsnm,paybas,BILLAMT,bgndt,bsbdt,bduedt,bcldt,bcbsdt,ptmsbrcd,billsubbrcd,billcolbrcd,billstatus from webx_billmst where ptmscd like '%%' And paybas='" + billtype + "' And ( convert(varchar,bgndt,106) between Convert(datetime,'" + frmdate + "',106) and convert(datetime,'" + todate + "',106)) union select billno,bbrcd,ptmscd,ptmsnm,paybas,BILLAMT,bgndt,bsbdt,bduedt,bcldt,bcbsdt,ptmsbrcd,billsubbrcd,billcolbrcd,billstatus from webx_billmst_arch where ptmscd like '%%' And paybas='" + billtype + "' And ( convert(varchar,bgndt,106) between Convert(datetime,'" + frmdate + "',106) and convert(datetime,'" + todate + "',106))";
                cmd.CommandText = "select billno,bbrcd,ptmscd,ptmsnm,paybas,BILLAMT,bgndt,bsbdt,bduedt,bcldt,bcbsdt,ptmsbrcd,billsubbrcd,billcolbrcd,billstatus from webx_billmst where ptmscd like '%%' And paybas='" + billtype + "' And ( convert(varchar,bgndt,106) between Convert(datetime,'" + frmdate + "',106) and convert(datetime,'" + todate + "',106))";
            }
            ...
            else
            {
                ...
                cmd.CommandText = "select billno,bbrcd,ptmscd,ptmsnm,paybas,BILLAMT,bgndt,bsbdt,bduedt,bcldt,bcbsdt,ptmsbrcd,billsubbrcd,billcolbrcd,billstatus from webx_billmst where ptmscd like '%%' and paybas like '%' And ( convert(varchar,bgndt,106) between Convert(datetime,'" + frmdate + "',106) and convert(datetime,'" + todate + "',106))";
            }
        }
    ...
    protected void GrdXLS2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        totsvctax = totsvctax + Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "svctax") == System.DBNull.Value ? 0.00 : DataBinder.Eval(e.Row.DataItem, "svctax"));
