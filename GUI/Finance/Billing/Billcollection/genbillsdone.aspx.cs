...
public partial class Finance_Billing_Billgeneration_genbillsdone : System.Web.UI.Page
{
   ...
   public static string fincmplbr;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Button1.Attributes.Add("onclick", "javascript:return CheckDocketSelection(" + txtbgndt.ClientID + "," + txtduedate.ClientID + "," + txtbillsubloc.ClientID + "," + txtbillcolloc.ClientID + "," + txtdocketlist.ClientID + "," + txtdocketlist_count.ClientID + ")");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("Webx_INSERT_billmst", conn);
        cmd.CommandType = CommandType.StoredProcedure;
        ...
        cmd = new SqlCommand("webx_UNI_BillGeneration1_New", conn);

        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add("@docknos", SqlDbType.VarChar).Value = docket_nos.Trim();
        ...
        while (dr.Read())
        {
            ...
            cmd_insert = new SqlCommand("Webx_INSERT_billdet", conn1);
            ...
            cmd_insert = new SqlCommand(sql_update, conn1);
            cmd_insert.ExecuteNonQuery();
        ...
        cmd = new SqlCommand(sql_chgrtae, conn);
        ...
        conn.Close();
        conn.Open();
        cmd_insert = new SqlCommand("usp_BillTransaction", conn1);
        cmd_insert.CommandType = CommandType.StoredProcedure;
        int transno=1;
        string finYear="07";
