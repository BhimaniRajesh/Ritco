<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BankRecoPrint.aspx.cs" Inherits="GUI_Finance_ViewPrint_bankReconciliationStatement_BankRecoPrint" %>
        ...
        <tr>
            ...
            <td width="90%">
                ...
                <%
                    ...
                    //}
                    string YearVal;
                    int YearVal1 = 0, YearVal2 = 0;
                    YearVal1 = Convert.ToInt32(Session["FinYear"]);
                    YearVal2 = Convert.ToInt32(Session["FinYear"]) + 1;
                    YearVal = YearVal1.ToString().Substring(2, 2) + "_" + YearVal2.ToString().Substring(2, 2);
