      ...
      function test()
        {
            ...
            {
                //alert("A");
                var FrmChild = window.open('popup-branch.aspx' ,'myWindow','height=285,width=450,resizable=yes,scrollbars=yes,left=310,top=15'); 
        ...
        function vendor()
        {
            ...
            {
                //alert("B");
                var FrmChild = window.open('popup-vendor1.aspx' ,'myWindow','height=285,width=450,resizable=yes,scrollbars=yes,left=310,top=15'); 
            ...
            {
                //alert("B");
                var FrmChild = window.open('popup-cust1.aspx' ,'myWindow','height=285,width=450,resizable=yes,scrollbars=yes,left=310,top=15'); 
