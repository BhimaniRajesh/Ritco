...
<script language="javascript" type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
     ...
     <table style="width: 1008px">
        ...
        <a><font class="blklnkund"><b>Module</b></font></a>
							<b> &gt; </b>
							<font class="blklnkund"><b>Account</b></font>
							<b> &gt; View & Print</b> <b> &gt; </b>
							<font class="bluefnt"><b>Voucher Register Report</b></font>
	    </td>
	        <td align="right">
    ...
    <br />
    <br />
        <%--<table style="width: 715px;height: 173px;" title="Select Voucher Criteria" cellspacing="1" border="1">
      <tr> <td colspan="3" class="bgbluegrey" style="height: 23px">  <p align="center" style="background-color:#d4e0e7"><label class="blackfnt">Select Voucher Criteria</label></p>
     </td></tr> <tr>
                ...
                <td colspan="2" style="height: 6px; width: 520px;">
                    &nbsp; &nbsp;&nbsp;<asp:RadioButtonList ID="radDate" runat="server" AutoPostBack="true"
                        ...
                        Text=" From: " style="z-index: 100; left: 418px; position: absolute; top: 56px"></asp:Label>
                    <strong><em></em></strong>
                        <asp:TextBox ID="txtDateFrom" runat="Server" ValidationGroup="VGDtFromTo"                        
                            Width="80" style="z-index: 101; left: 459px; position: absolute; top: 53px"></asp:TextBox>
                       
                            <asp:Label ID="lblTo" runat="server" CssClass="blackfnt"
                                Text=" To: " style="z-index: 102; left: 549px; position: absolute; top: 56px"></asp:Label>
                                <asp:TextBox ID="txtDateTo" runat="Server" Width="80" style="z-index: 103; left: 573px; position: absolute; top: 54px"></asp:TextBox>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDateTo"
                        ErrorMessage="To Date Can Not Be Blank" ForeColor="White" style="z-index: 106; left: 561px; position: absolute; top: 100px" Height="1px"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDateFrom"
                        ...
                        Width="181px" style="z-index: 105; left: 381px; position: absolute; top: 125px"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 199px">
                    Select Voucher Type</td>
                <td colspan="2" style="width: 520px">
                    <asp:DropDownList ID="CmbVoucherType" runat="server">
                        <asp:ListItem>All</asp:ListItem>
                        <asp:ListItem Value="1">Debit Voucher</asp:ListItem>
                        <asp:ListItem Value="2">Credit Voucher</asp:ListItem>
                        <asp:ListItem Value="5">Journal Voucher</asp:ListItem>
                        <asp:ListItem Value="6">Cash Withdrwals/Deposit</asp:ListItem>
                        <asp:ListItem Value="7">Expense Register</asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 199px">
                    Enter Advice No.</td>
                <td colspan="2" style="width: 520px">
                    <asp:TextBox ID="TxtAdviceNo" runat="server" Width="204px"></asp:TextBox>&nbsp; [ Seperated
                    by <em><strong>comma</strong></em> if multiple ]</td>
            </tr>
        </table>--%>
        <div align="left">
    <table border="0" cellpadding="0" cellspacing="1" class="boxbg" style="width: 639px;
        height: 90px">
        <tr class="bgbluegrey">
            <td align="center" class="blackfnt" colspan="4" style="height: 23px">
        ...
        <tr bgcolor="white">
            ...
            <td align="left" colspan="2" style="width: 404px; height: 76px" valign="top">
                ...
                &nbsp;<%--<input id="CmdToDate" type="button" value="" onclick="showCalendarControl(txtDateTo);" onmouseout="hidecalendarcontrol();" style="width: 32px"  />--%></td>
            <td align="left" colspan="1" style="height: 76px" valign="top">
        ...
        <tr id="trro" runat="server" bgcolor="white">
            <td align="left" class="blackfnt" style="width: 199px">
                    Select RO</td>
        ...
        <tr bgcolor="white">
                <td class="blackfnt"  align="left" style="width: 199px">
                    Select Voucher Type</td>
                <td class="blackfnt" align="left" colspan="3" style="width: 520px">
                    <asp:DropDownList ID="CmbVoucherType" runat="server">
                        <asp:ListItem>All</asp:ListItem>
                        <asp:ListItem Value="1">Debit Voucher</asp:ListItem>
                        <asp:ListItem Value="2">Credit Voucher</asp:ListItem>
            ...
            <tr bgcolor="white">
                <td align="left" class="blackfnt" style="width: 199px">
                    Enter Voucher No.</td>
                <td align="left" class="blackfnt" colspan="3" style="width: 520px">
                    <asp:TextBox ID="TxtAdviceNo" runat="server" Width="204px"></asp:TextBox>&nbsp; [ Seperated
                    by <em><strong>comma</strong></em> if multiple ]</td>
            </tr>
    </table>
        ...
        <br />
        <div align="center" style="width: 639px">
        ...
        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
          ...
          <asp:CustomValidator ID="CustomValidator1" runat="server" OnServerValidate="abc" ErrorMessage="To date can not be smaller than from date "
              Width="255px"></asp:CustomValidator><asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="Date Range can not be greater than 1 month "
