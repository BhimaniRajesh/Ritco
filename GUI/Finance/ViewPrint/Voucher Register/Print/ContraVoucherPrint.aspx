<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContraVoucherPrint.aspx.cs" Inherits="GUI_Finance_voucher_Print_ContraVoucherPrint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>WebXpress: Contra Voucher Print</title>
                ...
                <asp:Repeater ID="rptrContraVoucher" runat="server">
                    <ItemTemplate>
                        <table border=0 cellpadding="3" width="100%" bgcolor="#808080" cellspacing="1" class=boxbg>
                            <tr bgcolor="white"> 
                                <td align="left" width="30%"><font class=blackfnt><%#DataBinder.Eval(Container.DataItem, "AccountDescription")%></font></td>
                                <td align="right" width="10%"><font class=blackfnt><%#DataBinder.Eval(Container.DataItem, "chqno")%></font></td>
                                <td align="right" width="10%"><font class=blackfnt><%#DataBinder.Eval(Container.DataItem, "dt123")%></font></td>
                                ...
                                <td align="right" width="30%"><font class=blackfnt><%#DataBinder.Eval(Container.DataItem, "Narration")%></font></td>
                            </tr>
                        </table>
                    </ItemTemplate>
                </asp:Repeater>
