...
public partial class GUI_Finance_voucher_Print_ContraVoucherView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		if (Request.QueryString["finyear"] != null ){
			Financial_Year = Request.QueryString["finyear"].ToString().Substring(2, 2);
			fin_year = Request.QueryString["finyear"].ToString();
		}else{
        ...
        sql += " union all select AccountDescription='Total',DebitAmount=sum(cast(round(debit,0) as decimal(12,2))),";
