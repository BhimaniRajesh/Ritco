...
public partial class GUI_Finance_voucher_Print_ContraVoucherView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //  =================================
        string sql = "SELECT brcd, payto, convert(varchar, transdate, 6) as transdate, transtype,acccode,narration,credit,debit,* FROM webx_acctrans_" + YEAR_SUFFIX + " WHERE voucherno='" + voucherno + "' AND Voucher_Cancel != 'Y' ";
        ...
        sql = "select sum(debit) debit,sum(credit) credit from webx_acctrans_" + YEAR_SUFFIX + "  WHERE voucherno='" + voucherno + "' AND Voucher_Cancel != 'Y'";
        ...
        sql = "SELECT webx_acctinfo.accdesc + ':' + " +
            ...
            "End As CreditAmount " +
            "," + strTranTable + ".chqno,convert(varchar, chqdate, 106) as dt123," + strTranTable + ".Narration FROM " + strTranTable + ", webx_acctinfo " +
            "WHERE " + strTranTable + ".acccode = webx_acctinfo.acccode " +
            "And " + strTranTable + ".voucherno = '" + voucherno + "' AND Voucher_Cancel != 'Y' " +
        ...
        totamt = ntt.numberToText(totamt);
