<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreditVoucherView.aspx.cs" Inherits="GUI_Finance_voucher_Print_DebitVoucherView" %>
...
<% if (Request.QueryString["printyn"].ToString() == "N")
   {
       border = "0";
       %>    
        <link id="Link2" href="~/GUI/images/style.css" rel="Stylesheet" type="text/css" runat="server" />
<% } %>
<% else if (Request.QueryString["printyn"].ToString() == "Y")
   {
       border = "1";
       %>    
        <link id="Link3" href="~/GUI/images/style_print.css" rel="Stylesheet" type="text/css" runat="server" />
<% } %>
</head>
<% if (Request.QueryString["printyn"].ToString() == "N")
   { %>
