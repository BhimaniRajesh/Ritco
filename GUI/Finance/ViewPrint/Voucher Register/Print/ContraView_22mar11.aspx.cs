...
public partial class GUI_Finance_voucher_Print_ContraVoucherView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sql = "select b.company_acccode + ' : ' + b.accdesc AccountDescription,cast(debit as decimal(12,2)) DebitAmount,cast(credit as decimal(12,2)) CreditAmount,Chqno,convert(varchar,Chqdate,106) Chqdate,Narration";
        ...
        sql += " union select AccountDescription='Total',DebitAmount=sum(cast(debit as decimal(12,2))),";
        sql += " CreditAmount=sum(cast(credit as decimal(12,2))),Chqno='',Chqdate='',Narration=''";
