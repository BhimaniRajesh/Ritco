...
public partial class FrmCriteria : System.Web.UI.Page
{
    ...
    public void FillRO()
    {
        ...
        string q1 = "Select Loc_level,locname from webx_location where ActiveFlag='Y' AND loccode='" + brcd + "'";
        ...
        if (loclvl <= 2)
        {
            ...
            if (loclvl == 1)
            {
                string sql = "select top 1 'All' as c1,'All' as c2 from webx_location  union select loccode+' : '+locname c1,loccode c2 FROM webx_location where ActiveFlag='Y' AND  LOC_LEVEL='2' or loccode in (select loccode from webx_location where ActiveFlag='Y' AND  loc_level='1')";
    ...
    public void FillLocation()
    {
        ...
        string sql = "select top 1 'All' as c1,'All' as loccode from webx_location  union select loccode+' : '+locname c1,loccode  from webx_location where ActiveFlag='Y' AND report_loc= '" + strro + "'";
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            Response.Redirect("FrmVoucherList.aspx?FrmDate=" + txtDateFrom.Text + "&ToDate=" + txtDateTo.Text + "&RO=" + ro + "&vtype=" + CmbVoucherType.SelectedValue + "&vname=" + CmbVoucherType.SelectedItem + "&voucherno=" + TxtAdviceNo.Text + "&location=" + CmbLoc.Text + "");
        }
    }
