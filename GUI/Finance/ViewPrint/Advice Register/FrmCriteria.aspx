...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
    ...
    <table style="width:10in">
        <tr>
            <td  align="left">  
                ...
                <b>&gt; </b><font class="blklnkund"><b>Account</b></font> 
                <b>&gt; View & Print</b>
		        <b> &gt; </b>
    ...
    <br />
    <table border="0" cellpadding="0" cellspacing="1" class="boxbg" style="width: 639px;height: 90px">
        <tr class="bgbluegrey">
            <td align="center" class="blackfnt" colspan="4" style="height: 23px">
                Select Sales Criteria
            </td>
            <td align="center" class="blackfnt" colspan="1" style="height: 23px"></td>
        </tr>
        <tr bgcolor="white">
            ...
            <td align="left" colspan="1" style="height: 76px" valign="top">
                ...
                <%--<asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="Date Range can not be greater than 3 month "
