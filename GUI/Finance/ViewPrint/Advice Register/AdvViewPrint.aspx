...
<div align="left">
        ...
        <table bgcolor="#808080" border="<%=border%>" cellpadding="3" cellspacing="1" class="boxbg" style="width:7.5in;">
            ...
            <tr class="blackfnt">
                <td align="left" bgcolor="#ffffff" style="width: 154px">Cheque No / Date</td>
                <td align="left" bgcolor="#ffffff" style="width: 290px"><asp:Label ID="lblchqno" runat="server"></asp:Label>
                <asp:Label ID="lblchqdate" runat="server" Text=""></asp:Label></td>
                <td align="left" bgcolor="#ffffff"><asp:Label ID="lblchqno1" runat="server"></asp:Label>
                <asp:Label ID="lblchqdate1" runat="server" Text=""></asp:Label></td>
            </tr>
            <tr class="blackfnt">
