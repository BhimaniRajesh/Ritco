...
FUNCTION FOR ADD DUE DATE
*************************************************************************************************************/
function ADD_DueDate_All_Submission() {
    Check_All('dockdata', 'ChkAll', 'chkDock', 'N');
    ADD_DueDate();
}
function ADD_DueDate() {
    ...
    for (var b = 2; b <= rows - 1; b++) {
        ...
        if (document.getElementById("ctl00_MyCPH1_CHk_Due_dt").checked && document.getElementById(GV_FRM_NM + "chkDock").checked) {
...
function Check_All(Grd_Name, Obj_chk_All, Obj_Chk_Ind, CalC_YN) 
{
    ...
    if (document.getElementById("ctl00$MyCPH1$" + Grid_Id + "$ctl01$" + Obj_chk_All).checked) 
    {
        for (var b = 2; b <= rows - 1; b++) 
        {
            ...
            var HidFMDockNo = document.getElementById(GV_FRM_NM + "HidFMDockNo").value;
            var HidFmAck = document.getElementById(GV_FRM_NM + "HidFmAck").value;
            if ((HidFMDockNo != "" && HidFmAck == "Y") || (HidFMDockNo == "" && HidFmAck == ""))
            {
...
function Check_Calc(Grd_Name, Obj_chk_All, Obj_Chk_Ind) 
{
    ...
    var Dkt_RW_Wise = "0", Charge_Val = "0", Total_OtherChrg = "0";
    var Stax = "0", Cess = "0", HCess = "0", DktTotal = "0", Final_Billamt = "0";
    var StaxRate = document.getElementById(FRM_NM + "Hnd_StaxRate").value
    for (var b = 2; b <= rows - 1; b++) 
    {
        Dkt_RW_Wise = 0;
        if (b < 10)
        ...
        if (document.getElementById(GV_FRM_NM + Obj_Chk_Ind).checked) 
        {
            ...
            for (var k = 0; k < Hnd_SCHG_Arr.length; k++) {
                ...
                if (document.getElementById(GV_FRM_NM + "CHG" + j)) {
                    ...
                    Dkt_RW_Wise = parseFloat(Dkt_RW_Wise) + parseFloat(Charge_Val)
                    //Total_billAmount = parseFloat(Total_billAmount) + parseFloat(Charge_Val)
                    //alert(rounditn(parseFloat(document.getElementById(GV_FRM_NM + "Hnd_Dkttot").value) + parseFloat(Dkt_RW_Wise), 2))
                    document.getElementById(GV_FRM_NM + "Txt_Subtot").value = rounditn(parseFloat(document.getElementById(GV_FRM_NM + "Hnd_Dkttot").value) + parseFloat(Dkt_RW_Wise), 2);
                    if (parseFloat(StaxRate) > 0) {
                        Stax = (parseFloat(Dkt_RW_Wise) * parseFloat(StaxRate)) / 100;
                        Cess = (parseFloat(Stax) * 2) / 100;
                        HCess = (parseFloat(Stax) * 1) / 100;
                    }
                    document.getElementById(GV_FRM_NM + "Txt_Stax").value = rounditn(Stax, 2);
                    document.getElementById(GV_FRM_NM + "Txt_Cess").value = rounditn(Cess, 2);
                    document.getElementById(GV_FRM_NM + "Txt_HCess").value = rounditn(HCess, 2);
                    DktTotal = rounditn(parseFloat(document.getElementById(GV_FRM_NM + "Txt_Subtot").value) + parseFloat(Stax) + parseFloat(Cess) + parseFloat(HCess), 2);
                    document.getElementById(GV_FRM_NM + "Txt_Dkt_Tot_New").value = DktTotal;

                    Final_Billamt = rounditn(parseFloat(Final_Billamt) + parseFloat(DktTotal), 2);
                }
            }
            ...
            document.getElementById(GV_FRM_NM + "Txt_Dkt_Tot_New").value = "0.00";
            document.getElementById(GV_FRM_NM + "Txt_Stax").value = "0.00";
            document.getElementById(GV_FRM_NM + "Txt_Cess").value = "0.00";
            document.getElementById(GV_FRM_NM + "Txt_HCess").value = "0.00";
            document.getElementById(GV_FRM_NM + "Txt_Subtot").value = "0.00";
        }
        if (document.getElementById(GV_FRM_NM + Obj_Chk_Ind).checked) {
            ...
            for (var k = 1; k < 11; k++) {
                if (document.getElementById(GV_FRM_NM + "CHG" + k)) {
                    document.getElementById(GV_FRM_NM + "CHG" + k).disabled = false;
                    document.getElementById(GV_FRM_NM + "CHG" + k).value = rounditn(document.getElementById(GV_FRM_NM + "CHG" + k).value, 2)
                }
            }
        }
        else {
            for (var k = 1; k < 11; k++) {
                if (document.getElementById(GV_FRM_NM + "CHG" + k)) {
                    document.getElementById(GV_FRM_NM + "CHG" + k).disabled = true;
                }
            }
        }
        //var Stax = "0", Cess = "0", HCess = "0", DktTotal = "0";

        Total_billAmount = rounditn(parseFloat(document.getElementById(GV_FRM_NM + "Txt_Dkt_Tot_New").value) + parseFloat(Total_billAmount), 2)
    }
    ...
    if (click_count > 0) {
        ...
        for (var b = 2; b <= rows - 1; b++) {
            ...
            if (b < 10)
                ...
                GV_FRM_NM = "ctl00_MyCPH1_" + Grid_Id + "_ctl" + b + "_";
            document.getElementById(GV_FRM_NM + "Txt_Dkt_Tot_New").disabled = false;
            document.getElementById(GV_FRM_NM + "Txt_Stax").disabled = false;
            document.getElementById(GV_FRM_NM + "Txt_Cess").disabled = false;
            document.getElementById(GV_FRM_NM + "Txt_HCess").disabled = false;
            document.getElementById(GV_FRM_NM + "Txt_Subtot").disabled = false;
        }
...
*************************************************************************************************************/
function Docket_Wise_Calc_1(CNT_Bill, Cnt) 
{
    Grid_Id = "GridView1"
    ...
    for (var l = 2; l < rows; l++) {
        for (var k = 0; k < Hnd_SCHG_Arr.length; k++) {
            ...
            if (document.getElementById(GV_FRM_NM + "CHG" + j)) {
                ...
                if (l < 10)
                    GV_FRM_NM = "ctl00_MyCPH1_" + Grid_Id + "_ctl0" + l + "_";
                else
                    GV_FRM_NM = "ctl00_MyCPH1_" + Grid_Id + "_ctl" + l + "_";

                if (document.getElementById(GV_FRM_NM + "CHG" + j).value == "") {
                    document.getElementById(GV_FRM_NM + "CHG" + j).value = "0.00";
                }
    ...
    *******************************************************************************************************/
    ...
    for (var k = 1; k < 11; k++) {
        // j=parseFloat(k)+parseFloat(1)
        var obj = document.getElementById(GV_FRM_NM + "CHG" + k);
...
function Billing_WiseCalc() 
{
    //debugger;
    var Total_Amount = 0;
    var Total_NetAmt = 0;
    var Total_Amt = 0;
    var Grid_Id = "dockdata";

    var grid = document.getElementById("ctl00_MyCPH1_" + Grid_Id);
    var rows = grid.rows.length;
    var Check_One = "N";

    for (Cnt = 2; Cnt <= rows; Cnt++) 
    {
        if (Cnt < 10)
            GV_FRM_NM = "ctl00_MyCPH1_" + Grid_Id + "_ctl0" + Cnt + "_";            
        else
        ...
        txtbillcolamt = document.getElementById(GV_FRM_NM + "txtbillcolamt").value;
        Pendamt = document.getElementById(GV_FRM_NM + "txtpendamt").value;

        if ((parseFloat(txtbillcolamt) - parseFloat(Pendamt)) > 0) {
            alert("Collection Amount Can't Greater than Pending Amount");
            document.getElementById(GV_FRM_NM + "txtbillcolamt").value = Pendamt;
            txtbillcolamt = document.getElementById(GV_FRM_NM + "txtbillcolamt").value
        }

        UNEXPDED = parseFloat(Pendamt) - parseFloat(txtbillcolamt)
        document.getElementById(GV_FRM_NM + "unexpamt").value = rounditn(UNEXPDED, 2);
        ...
        /* Edited for Bifergate Service Tax 
        var txtSvctaxRate = document.getElementById(GV_FRM_NM + "txtSvctaxRate");
        var txtSvctax = document.getElementById(GV_FRM_NM + "txtSvctax");
        var txtCesstax = document.getElementById(GV_FRM_NM + "txtCesstax");
        var txtHEduCesstax = document.getElementById(GV_FRM_NM + "txtHEduCesstax");
        var txtFreight = document.getElementById(GV_FRM_NM + "txtFreight");

        if (parseFloat(txtSvctaxRate.value) > 0) {
            txtFreight.value = rounditn(txtbillcolamt, 2) / (1 + (rounditn(txtSvctaxRate.value, 2) / 100) + (rounditn(txtSvctaxRate.value, 2) * 2 / 10000) + (rounditn(txtSvctaxRate.value, 2) * 1 / 10000));
            txtSvctax.value = rounditn(txtFreight.value, 2) * rounditn(txtSvctaxRate.value, 2) / 100;
            txtCesstax.value = rounditn(txtSvctax.value, 2) * 2 / 100;
            txtHEduCesstax.value = rounditn(txtSvctax.value, 2) * 1 / 100;

            txtFreight.value = rounditn(txtFreight.value, 2);
            txtSvctax.value = rounditn(txtSvctax.value, 2);
            txtCesstax.value = rounditn(txtCesstax.value, 2);
            txtHEduCesstax.value = rounditn(txtHEduCesstax.value, 2);
        }
        else {
            txtFreight.value = "0.00";
            txtSvctax.value = "0.00";
            txtCesstax.value = "0.00";
            txtHEduCesstax.value = "0.00";
        }
        End  */
    }    
}
...
function Bill_Wise_Calc(Obj, Cnt) 
{
    ...
    if (Cnt) 
    {
        ...
        var rows = grid.rows.length;
        var Check_One = "N";
        var Chrg_Positive = "0.00";
        var Chrg_Negative = "0.00";
        ...
        for (var k = 0; k < Hnd_SCHG_Arr.length; k++) 
        {
            ...
            if (document.getElementById(GV_FRM_NM + "CHG" + j)) 
            {
                ...
                if (Code_Operand == "-")
                    Chrg_Negative = parseFloat(Chrg_Negative) + parseFloat(document.getElementById(GV_FRM_NM + "CHG" + j).value);
                else
                    Chrg_Positive = parseFloat(Chrg_Positive) + parseFloat(document.getElementById(GV_FRM_NM + "CHG" + j).value); 
        ...
        {
            alert("Collection Amount Can't Greater than Pending Amount");
            document.getElementById(GV_FRM_NM + "txtbillcolamt").value = "0.00";
            txtbillcolamt = document.getElementById(GV_FRM_NM + "txtbillcolamt").value
        }        
        
        UNEXPDED = parseFloat(Pendamt) - parseFloat(txtbillcolamt)
        document.getElementById(GV_FRM_NM + "unexpamt").value = rounditn(UNEXPDED, 2);
        var txtMiscCharge = document.getElementById(GV_FRM_NM + "txtMiscCharge").value;
        var MiscCharge = parseFloat(txtMiscCharge == "" ? "0" : txtMiscCharge);
        Tds = document.getElementById(GV_FRM_NM + "tds").value        
        //Deduction = parseFloat(Tds) + parseFloat(UNEXPDED)
        //Total_Amount = rounditn(parseFloat(Pendamt) + parseFloat(Dkt_Deduction_RW_Wise) - parseFloat(Deduction), 2)
        Deduction = parseFloat(Tds) + parseFloat(UNEXPDED)

        Total_Amount = rounditn(parseFloat(Pendamt) + parseFloat(Dkt_Deduction_RW_Wise) - parseFloat(Deduction) + parseFloat(MiscCharge), 2)
        ...
        //var txtStaxAppAmt = document.getElementById(GV_FRM_NM + "txtStaxAppAmt");
        //txtStaxAppAmt.value = parseFloat(Total_Amount) + parseFloat(Tds) + parseFloat(AppAmount);                
        //var txtSvctaxRate = document.getElementById(GV_FRM_NM + "txtSvctaxRate");
        //var txtSvctax = document.getElementById(GV_FRM_NM + "txtSvctax");
        //var txtCesstax = document.getElementById(GV_FRM_NM + "txtCesstax");
        //var txtHEduCesstax = document.getElementById(GV_FRM_NM + "txtHEduCesstax");
        ...
        //Chrg_Negative = parseFloat(Chrg_Negative) + parseFloat(document.getElementById(GV_FRM_NM + "tds").value);

        /*
        if (parseFloat(Chrg_Positive) > parseFloat(Chrg_Negative))
            txtbillcolamt = rounditn(parseFloat(document.getElementById(GV_FRM_NM + "txtbillcolamt").value) + (parseFloat(Chrg_Positive) - parseFloat(Chrg_Negative)), 2);
        else
            txtbillcolamt = document.getElementById(GV_FRM_NM + "txtbillcolamt").value;
        */
        ...
        var Svctax = 0.00
        var Cesstax = 0.00
        var HEduCesstax = 0.00

        var Freight_Ded = 0.00
        var Svctax_Ded = 0.00
        var Cesstax_Ded = 0.00
        var HEduCesstax_Ded = 0.00

        var Freight_Inc = 0.00
        var Svctax_Inc = 0.00
        var Cesstax_Inc = 0.00
        var HEduCesstax_Inc = 0.00

        if (parseFloat(txtSvctaxRate.value) > 0) 
        {
            txtbillcolamt = (parseFloat(Total_Amount) + parseFloat(Tds));
            if (parseFloat(txtbillcolamt) > 0) 
            {
                Freight = rounditn(txtbillcolamt, 2) / (1 + (rounditn(txtSvctaxRate.value, 2) / 100) + (rounditn(txtSvctaxRate.value, 2) * 2 / 10000) + (rounditn(txtSvctaxRate.value, 2) * 1 / 10000));
                Svctax = rounditn(Freight, 2) * rounditn(txtSvctaxRate.value, 2) / 100;
                Cesstax = rounditn(Svctax, 2) * 2 / 100;
                HEduCesstax = rounditn(Svctax, 2) * 1 / 100;
            }
            if (parseFloat(Chrg_Negative) > 0) 
            {
                txtbillcolamt = parseFloat(Chrg_Negative);
                Freight_Ded = (rounditn(txtbillcolamt, 2) / (1 + (rounditn(txtSvctaxRate.value, 2) / 100) + (rounditn(txtSvctaxRate.value, 2) * 2 / 10000) + (rounditn(txtSvctaxRate.value, 2) * 1 / 10000)));
                Svctax_Ded = (rounditn(Freight_Ded, 2) * rounditn(txtSvctaxRate.value, 2) / 100);
                Cesstax_Ded = (rounditn(Svctax_Ded, 2) * 2 / 100);
                HEduCesstax_Ded = (rounditn(Svctax_Ded, 2) * 1 / 100);
            }
            if (parseFloat(Chrg_Positive) > 0) 
            {
                txtbillcolamt = parseFloat(Chrg_Positive);
                Freight_Inc = (rounditn(txtbillcolamt, 2) / (1 + (rounditn(txtSvctaxRate.value, 2) / 100) + (rounditn(txtSvctaxRate.value, 2) * 2 / 10000) + (rounditn(txtSvctaxRate.value, 2) * 1 / 10000)));
                Svctax_Inc = (rounditn(Freight_Inc, 2) * rounditn(txtSvctaxRate.value, 2) / 100);
                Cesstax_Inc = (rounditn(Svctax_Inc, 2) * 2 / 100);
                HEduCesstax_Inc = (rounditn(Svctax_Inc, 2) * 1 / 100);
            }


            txtFreight.value = rounditn((parseFloat(rounditn(Freight, 2)) + parseFloat(rounditn(Freight_Ded, 2))) - parseFloat(rounditn(Freight_Inc, 2)), 2);
            txtSvctax.value = rounditn((parseFloat(rounditn(Svctax, 2)) + parseFloat(rounditn(Svctax_Ded, 2))) - parseFloat(rounditn(Svctax_Inc, 2)), 2);
            txtCesstax.value = rounditn((parseFloat(rounditn(Cesstax, 2)) + parseFloat(rounditn(Cesstax_Ded, 2))) - parseFloat(rounditn(Cesstax_Inc, 2)), 2);
            txtHEduCesstax.value = rounditn((parseFloat(rounditn(HEduCesstax, 2)) + parseFloat(rounditn(HEduCesstax_Ded, 2))) - parseFloat(rounditn(HEduCesstax_Inc, 2)), 2);
    ...
    Total_Amt = Total_NetAmt;
    
    /*
    
    var txtMrDeduction = document.getElementById("ctl00_MyCPH1_txtMrDeduction");
    var txtMrRecovery = document.getElementById("ctl00_MyCPH1_txtMrRecovery");
    
    if (document.getElementById(UC_FRM_NM + 'ddlPayMode').value == "Cash") {
        if (parseFloat(txtMrDeduction.value) > 0) 
        {
            alert("User Cant Enter Deduction amount When Receipt Mode is Cash");
            txtMrDeduction.value = "0.00";
            txtMrDeduction.focus();
            return false;
        }
        if (parseFloat(txtMrRecovery.value) > 0) 
        {
            alert("User Cant Enter Recovery amount When Receipt Mode is Cash");
            txtMrRecovery.value = "0.00";
            txtMrRecovery.focus();
            return false;
        }
    }
    else 
    {
        if (parseFloat(txtMrDeduction.value) > 0) 
        {
            Total_NetAmt = rounditn(parseFloat(Total_NetAmt) - parseFloat(txtMrDeduction.value), 2)
        }
        if (parseFloat(txtMrRecovery.value) > 0) 
        {
            Total_NetAmt = rounditn(parseFloat(Total_NetAmt) + parseFloat(txtMrRecovery.value), 2)
        }
    }
    */
    
    if (parseFloat(Total_NetAmt) <= 0) 
    {
        alert("Total Net Receipt Amount should be Greater than zero");
        //txtMrDeduction.value = "0.00";
        //txtMrRecovery.value = "0.00";
        Total_NetAmt = rounditn(parseFloat(Total_Amt),2);
    }
    ...
    else if (document.getElementById(UC_FRM_NM + 'ddlPayMode').value == "Bank") 
    {
        ...
        document.getElementById(UC_FRM_NM + 'Txt_ColAmt').value = rounditn(Total_NetAmt, 2)
    }
}

function Make_All_Zero_1(CNT_Bill, Cnt) 
{
    //debugger;
    Grid_Id = "GridView1"
    var grid = document.getElementById("ctl00_MyCPH1_" + Grid_Id);
...
function ONSubmit_Collection() {
    ...
    /*if (document.getElementById(UC_FRM_NM + 'ddlPayMode').value == "Cash") 
    {
        if (parseFloat(txtMrDeduction.value) > 0) {
            alert("User Cant Enter Deduction amount When Receipt Mode is Cash");
            document.getElementById(UC_FRM_NM + 'txtCashAmt').value = "";
            document.getElementById(UC_FRM_NM + "txtAmtApplA").value = "0.00";
            document.getElementById(UC_FRM_NM + "txtNetPay").value = "0.00";
            txtMrDeduction.value = "0.00";
            txtMrDeduction.focus();
            return false;
        }
    ...
    if (document.getElementById(UC_FRM_NM + 'ddlPayMode').value == "Bank" || document.getElementById(UC_FRM_NM + 'ddlPayMode').value == "Both") {
        ...
        if (document.getElementById(UC_FRM_NM + 'rdDiposited_0').checked) {
            if (document.getElementById(UC_FRM_NM + 'ddrBankaccode').disabled != true) {
                if (document.getElementById(UC_FRM_NM + 'ddrBankaccode').value == "") {
    ...
    document.getElementById(FRM_NM + "submit").style.display = "none";
