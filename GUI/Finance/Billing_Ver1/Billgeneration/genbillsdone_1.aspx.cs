   ...
   string Party_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            int Duedays = Convert.ToInt16(Lbl_Credit_days.Text);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       string PENDAMT = Txt_BillAmt.Text;
            ...
            Xml_BillMst = Xml_BillMst + "<PTMSTEL>" + PTMSTEL.Trim() + "</PTMSTEL>";
            Xml_BillMst = Xml_BillMst + "<PTMSEMAIL>" + PTMSEMAIL + "</PTMSEMAIL>";
            Xml_BillMst = Xml_BillMst + "<PTMSADDR>" + PTMSADDR.Replace("&", "&amp;").Replace("�"," ") + "</PTMSADDR>";
