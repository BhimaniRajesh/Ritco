<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="genbillsdone.aspx.cs" Inherits="Finance_Billing_Billgeneration_genbillsdone" %>
...
<body>
    ...
    <div>
        <table style="width: 10in" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <table border="0" cellpadding="2" cellspacing="1" class="boxbg" style="width: 80%"
                        align="Left">
                        ...
                        <tr bgcolor="white">
                            ...
                            <td>
                                <asp:Label ID="lblparty" runat="server" Text="Label" Width="313px" CssClass="blackfnt"></asp:Label>
                            </td>
                        </tr>
                        <tr bgcolor="white">
                            <td align="Left">
                            ...
                            <td style="width: 339px; height: 25px;">
                                <asp:Label ID="lbldaterange" runat="server" Text="Label" Width="313px" CssClass="blackfnt"></asp:Label>
                            </td>
                        </tr>
                        <tr bgcolor="white">
                            <td align="Left">
                            ...
                            <td>
                                <asp:Label ID="lblpaybas" runat="server" Text="Label" Width="313px" CssClass="blackfnt"></asp:Label>
                            </td>
                        </tr>
                        <tr bgcolor="white">
                            ...
                            <td style="width: 339px">
                                <asp:Label ID="lblmod" runat="server" Text="Label" Width="313px" CssClass="blackfnt"></asp:Label>
                            </td>
                        </tr>
                        <tr bgcolor="white" runat="server" id="Tr_but" visible="false">
                            ...
                            <td>
                                <asp:Label ID="Lblbut" runat="server" Text="Label" Width="313px" CssClass="blackfnt"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table align="left" border="0" cellpadding="2" cellspacing="1" class="boxbg">
                        ...
                        <tr bgcolor="white">
                            ...
                            <td style="height: 24px">
                                <asp:TextBox ID="txtbgndt" runat="server" MaxLength="10" onblur="javascript:return ValidateDate(this);"
                                    Width="65" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                        ...
                        <tr bgcolor="white">
                            <td style="width: 148px">
                                <font class="blackfnt">Bill Type </font>
                            </td>
                            <td>
                                <font class="blackfnt">Freight Bill</font>
                            </td>
                            <td>
                                <font class="blackfnt">Party name </font>
                            </td>
                            <td colspan="2" nowrap>
                                <asp:Label ID="LblPTMSCD" Font-Bold="true" runat="server" Text="Label" Width="257px"
                        ...
                        <tr bgcolor="white">
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txtremars" runat="server" Width="300" Rows="2" TextMode="MultiLine"
                            ...
                            <td>
                                <asp:TextBox ID="Txt_BillAmt" runat="server" Text="0.00" Enabled="false" Width="60"
                ...
                <td>
                    ...
                    <table border="0" cellpadding="1" cellspacing="1" style="width: 80%" align="Left">
                        <tr style="height: 25px">
                            <td colspan="2" align="center" style="height: 25px">
                                <div id="object" class="message" style="display: none; width: 100%" runat="server">
                                    Bill Amount is Greater then Credit Limit For The Same Customer.</div>
                                <asp:DataGrid ID="dockdata" align="center" runat="server" AutoGenerateColumns="False"
                                    Width="776px" BorderWidth="0" CellSpacing="1" CellPadding="2" BorderStyle="None"
                                    CssClass="boxbg" Style="text-align: left" FooterStyle-BackColor="white" Visible="true"
                                    DataKeyField="dockno" ShowFooter="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn ItemStyle-BackColor="white" HeaderText="Docket NO." HeaderStyle-Wrap="false"
                                            HeaderStyle-CssClass="">
                                            <ItemTemplate>
                                                <center>
                                                    <asp:Label CssClass="blackfnt" ID="docketno" Text='<%# DataBinder.Eval(Container.DataItem,"dockno") %>'
                                                        runat="server">
                                                    </asp:Label>
                                                </center>
                                            </ItemTemplate>
    ...
    <asp:BoundColumn HeaderText="Paybas" ReadOnly="True" ItemStyle-Wrap="false"  DataField="paybasdesc"/>--%>
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="Mode" ReadOnly="True" ItemStyle-Wrap="false"
                                            DataField="modedesc" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="Bkg Date : Comm Dely DT"
                                            ItemStyle-Wrap="false" HeaderStyle-Wrap="false" ReadOnly="True" DataField="dock_cdeldt" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="Chrg Wt./Freight" ReadOnly="True"
                                            ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="right" HeaderStyle-Wrap="false"
                                            DataField="FRT_chrg_RATE" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="Frt. Rate(per Kg/Pkg)" ReadOnly="True"
                                            ItemStyle-Wrap="true" ItemStyle-HorizontalAlign="right" HeaderStyle-Wrap="false"
                                            DataField="FRT_RATE" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="Docket Charges" ReadOnly="True"
                                            ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="right" HeaderStyle-Wrap="false"
                                            DataField="dktchg" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="FOV Charges" ReadOnly="True"
                                            HeaderStyle-Wrap="false" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="right"
                                            DataField="FOV" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="Other Charges" ReadOnly="True"
                                            ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="right" HeaderStyle-Wrap="false"
                                            DataField="otchg" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText="S.Tax + Cess + H.Cess + SB.Cess + KK.Cess" ReadOnly="True"
                                            ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="right" HeaderStyle-Wrap="false"
                                            DataField="SVCTAX" />
                                        <asp:BoundColumn ItemStyle-BackColor="white" HeaderText=" Delivered" ReadOnly="True"
                                            ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="right" HeaderStyle-Wrap="false"
                                            DataField="Delivered" />
                                        <asp:TemplateColumn ItemStyle-BackColor="white" HeaderText="Docket Total" HeaderStyle-Wrap="false"
                                            HeaderStyle-CssClass="" ItemStyle-HorizontalAlign="Right">
                                            <HeaderTemplate>
                                                Docket Total
                                            </HeaderTemplate>
                                            <HeaderStyle CssClass="blackfnt" Font-Bold="false" />
                                            <ItemTemplate>
                                                <asp:Label CssClass="blackfnt" ID="dktamt" Text='<%# DataBinder.Eval(Container.DataItem,"dkttot") %>'
                                                    runat="server">
                     
                                                </asp:Label>
                                                <asp:HiddenField ID="hdndt" runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"dockdt") %>'>
                                                </asp:HiddenField>
                                                <asp:HiddenField ID="Hnd_Dkttot" runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"dkttot") %>'>
                                                </asp:HiddenField>
                                                </center>
                                            </ItemTemplate>
                        ...
                        <tr bgcolor="white">
                            <td align="center" valign="middle">
                                ...
                                <p>
                                    <center>
                                        <asp:Button ID="Button1" runat="server" OnClientClick="javascript:return OnSubmit(this)"
                                            CssClass="blackfnt" Text="Click Here to GENERATE BILL for checked Dockets" OnClick="Button1_Click" /></center>
                                </p>
                            </td>
                        </tr>
                    </table>
