<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MRDotmatrixViewPrint_Freight0.aspx.cs" Inherits="GUI_Finance_Billing_Ver1_MRDotmatrixViewPrint_Freight0" %>
...
<body onload="javascript:return printPage()"> 
    ...
    <div>
        <table class="bgwhite" border="0" cellpadding="0" cellspacing="0" style="height:5in; width:6.75in;">
            <tr>
                <td colspan="4" style="height:1.70in"></td>
            </tr>
            <tr>
                <td  style="width:0.70in ;">
            ...
            <tr>
                ...
                <td style="width:0.40in ;height:22px;height:22px;">
