...
public partial class Finance_Billing_Billsubmission_start : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Type == "F")
            {
                ...
                Cbopaybas.Items.Add(new ListItem("TBB BILL", "2"));
                Cbopaybas.Items.Add(new ListItem("TO PAY BILL", "3"));
                Cbopaybas.Items.Add(new ListItem("MISC BILL", "7"));
                Cbopaybas.Items.Add(new ListItem("DELIVERY BILL", "11"));
				//Cbopaybas.Items.Add(new ListItem("TRIPTHC", "24"));
            }
            else if(Type == "O")
            {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("billmr_step1.aspx?billno=" + billno + "&party_code=" + custcd.ToString() + "&paybas=" + Cbopaybas.SelectedValue.ToString() + "&fromtdate=" + dtFrom + "&todate=" + dtTo + "&manualbillno=" + txtmanualbillno.Text.ToString());
