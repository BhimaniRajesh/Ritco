...
public partial class Finance_Billing_Billcollection_billmr_step2 : System.Web.UI.Page
{
    ...
    protected void submit_Click1(object sender, EventArgs e)
    {
        ...
        sqlCmd.Parameters.Add("@Xml_Dkt_Bill", SqlDbType.Text).Value = GenXml.Replace("&", "&amp;").Trim();//xmlTHC.Trim();
        sqlCmd.Parameters.Add("@Xml_Chq_Det ", SqlDbType.Text).Value = Xml_Chq_Det.Replace("&", "&amp;").Trim();
        sqlCmd.Parameters.Add("@Xml_BillMR_DET", SqlDbType.Text).Value = Xml_BillMR_DET.Replace("&", "&amp;").Trim();//xmlTHC.Trim();
