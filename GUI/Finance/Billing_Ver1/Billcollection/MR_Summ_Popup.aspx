...
<head id="Head1" runat="server">
    ...
    function OpenPopupWindow(strBillno)
    {
        ...
        var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,titlebar=no,scrollbars=yes,width=700,height=400,status=no,left=60,top=270"
        var strPopupURL = "../../Billing/BillViewPrint/FrmAreaBillView.aspx?billno=" + strBillno
                ...
                <tr bgcolor="white">
                    <td bgcolor="white">
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#808080">
                            ...
                            <tr bgcolor="#ffffff">
                                <td width="20%">
                                    <font class="blackfnt">MR Status</font></td>
                                <td width="26%">
                                    <font class="blackfnt">
                                        <asp:Label ID="lblStatus" runat="server" Width="231px"></asp:Label></font></td>
                                <td width="22%">
                                    <font class="blackfnt">VehicleNo</font></td>
                                <td width="32%">
                                    <font class="blackfnt">
                                        <asp:Label ID="lblVehNo" runat="server" Width="286px"></asp:Label></font></td>
                            </tr>
                            <tr bgcolor="#ffffff">
                                <td colspan="4">
                        ...
                        <asp:GridView ID="GrdPaidFollow" ShowFooter="true" EmptyDataText="No Records Found....."
                            ...
                            <Columns>
                                ...
                                <%--<asp:TemplateField HeaderText="Remarks">
                                    <HeaderStyle CssClass="blackfnt" HorizontalAlign="Center" Font-Bold="true" />
                                    <ItemTemplate>
                                            <asp:Label ID="lblRemarks" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"Remarks")%>'
                                            runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField> --%>
