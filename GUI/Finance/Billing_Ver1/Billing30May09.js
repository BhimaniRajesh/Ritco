...
function Check_All(Grd_Name,Obj_chk_All,Obj_Chk_Ind,CalC_YN)
	    ...
	    function Check_Calc_IND(Grd_Name,Obj_chk_All,Obj_Chk_Ind)
	    {        
                //alert(Obj_Chk_Ind)
                 var Total_amount="0.00",NetAmt="0.00",TotalNetAmt="0.00"
                 var Total_billAmount=document.getElementById(FRM_NM+"Txt_BillAmt").value
                // alert(Total_billAmount)
                 Hnd_Dkttot=Obj_Chk_Ind.id.replace("chkOrderNo", "Hnd_Dkttot");
                // alert(document.getElementById(Hnd_Dkttot))
                 
                 if(Obj_Chk_Ind.checked)
                 {
                      Total_billAmount=rounditn(parseFloat(document.getElementById(Hnd_Dkttot).value)+parseFloat(Total_billAmount),2)
                 }
                 else
                 {
                      Total_billAmount=rounditn(parseFloat(Total_billAmount)-parseFloat(document.getElementById(Hnd_Dkttot).value),2)
                 }
                 document.getElementById(FRM_NM+"Txt_BillAmt").value=rounditn(Total_billAmount,2)
	    }
/*************************************************************************************************************
...
function Docket_Wise_Calc()
               ...
               //  alert("hi...")
                  ...
                  for(var b=2;b<=rows-1;b++)
                  {
                                /*    if(b==2)
                                    ...
                                    //alert(document.getElementById(GV_FRM_NM+"frtrebate").value)
                                    // alert("hi...1")
                                   ...
                                   /*   if(b==2)
                                        ...
                                        if(document.getElementById(GV_FRM_NM+"CHG"+k))
                                        {
                                            ...
                                            Code_Operand_Arr=document.getElementById(GV_FRM_NM+"Hnd_CHG"+k).value.split("~");
                                            //if(k=="1")
                                           // {
                                           //     alert("hi...")
                                           // }
                                            Code_Operand=Code_Operand_Arr[3]
                                            Charge_Val=Code_Operand+document.getElementById(GV_FRM_NM+"CHG"+k).value
                                         //   Charge_Val_Tot=parseFloat(Charge_Val_Tot)+parseFloat(Charge_Val)
                                            // if(k=="1")
                                            //{
                                           //     alert("hi...2")
                                            //}
                                           // Dkt_Deduction=parseFloat(Dkt_Deduction)+parseFloat(document.getElementById(GV_FRM_NM+"CHG"+k).value)
                                            Dkt_Deduction=parseFloat(Dkt_Deduction)+parseFloat(Charge_Val)
                                            if(parseFloat(document.getElementById(GV_FRM_NM+"HND_PendAmt").value) < parseFloat(Dkt_Deduction))
                                            {
                                    ...
                                    //Total_Frt_Amt=rounditn(parseFloat(document.getElementById(GV_FRM_NM+"frtrebate").value)+parseFloat(Total_Frt_Amt),2)
                                    //Toall_Claim_Amt=rounditn(parseFloat(document.getElementById(GV_FRM_NM+"Claim").value)+parseFloat(Toall_Claim_Amt),2)
                                    //Dkt_Deduction=parseFloat(Total_Frt_Amt)+parseFloat(Toall_Claim_Amt) 
                                    if(document.getElementById(GV_FRM_NM+"HND_PendAmt").value)
                                    {
                                        if(parseFloat(document.getElementById(GV_FRM_NM+"HND_PendAmt").value) < parseFloat(Dkt_Deduction))
                                        {
                                    ...
                                    /*  if(b==2)
                                        {
                                         ...
                                         alert(GV_FRM_NM+"CHG"+k)
                                         alert(GV_FRM_NM_Footer+"Txt_TOT_CHG"+k)
                                         alert(document.getElementById(GV_FRM_NM+"CHG"+k))
                                         alert(document.getElementById(GV_FRM_NM_Footer+"Txt_TOT_CHG"+k))
                                        }  */
                                        if(document.getElementById(GV_FRM_NM+"CHG"+k))
                                        {
                    ...
                    //document.getElementById(GV_FRM_NM1+"Txt_Frtrebate").value=rounditn(Total_Frt_Amt,2)
                    //document.getElementById(GV_FRM_NM1+"Txt_Claim").value=rounditn(Toall_Claim_Amt,2)
                  ...
                  *******************************************************************************************************/
                  ...
                  var rows=grid.rows.length;  
                  var Check_One="N"
                  var FoterRow=parseFloat(document.getElementById("ctl00_MyCPH1_GridView1").rows.length) 
                   for(var b=2;b<=rows;b++)
                     {
                                    if(b<10)
                                    {
                                        GV_FRM_NM="ctl00_MyCPH1_"+Grid_Id+"_ctl0" + b + "_";
                                        GV_FRM_NM_Footer="ctl00_MyCPH1_GridView1_ctl0" + FoterRow + "_";
                                    }
                                    else
                                    {
                                         GV_FRM_NM="ctl00_MyCPH1_"+Grid_Id+"_ctl" + b + "_";
                                         GV_FRM_NM_Footer="ctl00_MyCPH1_GridView1_ctl" +FoterRow + "_";
                                    }
                                    if(FoterRow<10)
                                    {
                                       // GV_FRM_NM="ctl00_MyCPH1_"+Grid_Id+"_ctl0" + b + "_";
                                    ...
                                    if(document.getElementById(FRM_NM+"HND_Dkt_Billno").value==document.getElementById(GV_FRM_NM+"Hnd_Billno").value)
                                    { 
	            ...
	            // alert("hi.")
                  ...
                  for(var b=2;b<=rows;b++)
                  {
                                    ...
                                    for (var k=1;k<11;k++)
                                    {
                                        ...
                                        //Frt_Rebate=document.getElementById(GV_FRM_NM+"frtrebate").value 
                                        //Claim=document.getElementById(GV_FRM_NM+"Claim").value 
                                       ...
                                       // alert(Pendamt)
                                       // alert("hi..1")
                                        if(parseFloat(Deduction)>parseFloat(Pendamt)) 
                                        {
                                            ...
                                            //document.getElementById(GV_FRM_NM+"Claim").value=rounditn(0,2)
                                            document.getElementById(GV_FRM_NM+"tds").value=rounditn(0,2)
                                            document.getElementById(GV_FRM_NM+"unexpamt").value=rounditn(0,2)
                                           // document.getElementById(GV_FRM_NM+"frtrebate").value=rounditn(0,2)
                                            for (var k=1;k<11;k++)
                                            {
                                                if(document.getElementById(GV_FRM_NM+"CHG"+k))
                                                {
                                       ...
                                       // alert("hi..2")
                                        Total_NetAmt=rounditn(parseFloat(Total_NetAmt)+parseFloat(Total_Amount),2)
                         ...
                         var rows=grid.rows.length;  
                          ...
                          var MinFlag="N"
                                      ...
                                      for(var b=2;b<=rows-1;b++)
                                      {
                                                        ...
                                                        //alert(document.getElementById(GV_FRM_NM+"frtrebate").value)
                                                        //document.getElementById(GV_FRM_NM+"frtrebate").value="0.00"
                                                        //document.getElementById(GV_FRM_NM+"Claim").value="0.00"
                                                        for (var k=1;k<11;k++)
                                                        {
                                                            if(document.getElementById(GV_FRM_NM+"CHG"+k))
                                                            {
                                       ...
                                       //alert(b)
                                                        ...
                                                        for (var m=1;m<11;m++)
                                                        {
                                                            if(document.getElementById(GV_FRM_NM1+"Txt_TOT_CHG"+m))
                                                            {
                                                             document.getElementById(GV_FRM_NM1+"Txt_TOT_CHG"+m).value="0.00"
                                                            }
                                                        } 
                                   // alert("hi..")
                    //document.getElementById(GV_FRM_NM1+"Txt_Frtrebate").value=rounditn(0,2)
                    //document.getElementById(GV_FRM_NM1+"Txt_Claim").value=rounditn(0,2)
             //}
                  /*****************************************************************************
                  TO DISPLAY SUM OF THE DEDUCTION CHARGES
                  *******************************************************************************************************/
                  ...
                  for(var b=2;b<=rows;b++)
                  {
                                   ...
                                   //  alert(document.getElementById(FRM_NM+"HND_Dkt_Billno").value)
                                     if(document.getElementById(FRM_NM+"HND_Dkt_Billno").value==document.getElementById(GV_FRM_NM+"Hnd_Billno").value)
                                     {
                                        ...
                                        Pendamt=document.getElementById(GV_FRM_NM+"txtpendamt").value
                                        Total_Amount=rounditn(parseFloat(Pendamt),2)
                                        Total_NetAmt=rounditn(parseFloat(Total_NetAmt)+parseFloat(Total_Amount),2)
                                        document.getElementById(UC_FRM_NM+"txtAmtApplA").value=rounditn(Total_NetAmt,2)
                                        document.getElementById(UC_FRM_NM+"txtNetPay").value=rounditn(Total_NetAmt,2)
                } 
	    ...
	    function  Make_All_Zero_Bill_Wise()
	    {
	              Grid_Id="dockdata"
	              var grid=document.getElementById("ctl00_MyCPH1_"+Grid_Id);
                  var rows=grid.rows.length;  
...
*************************************************************************************************************/
function ONSubmit_Collection(Obj)
{
                            var server_dt=document.getElementById(FRM_NM+"Hnd_Server_dt").value;
                             var MIn_dt=document.getElementById(FRM_NM+"Hnd_Mindate").value
            var Max_Date =document.getElementById(FRM_NM+"Hnd_Maxdate").value
