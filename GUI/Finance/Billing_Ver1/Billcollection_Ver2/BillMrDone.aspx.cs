...
{
    string  TranXaction="";
    public static string mrsno = "", ToolTip_Str = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (TranXaction != "Done")
        {
            Msg_err.Text = TranXaction;
            Response.Redirect("~/GUI/ErrorPage.aspx?PageHead=" + "Bill Collection" + "&ErrorMsg=" + TranXaction);
            // Response.End();
        }
        else
        {
            ...
            //string sql = "exec Usp_Show_Doc_Accounting '" + mrsno + "','" + Table_Name + "'";
