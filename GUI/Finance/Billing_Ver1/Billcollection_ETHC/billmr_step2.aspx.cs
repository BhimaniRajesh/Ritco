...
public partial class Finance_Billing_Billcollection_billmr_step2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		txtVoucherDate.Attributes.Add("onblur", "javascript:MIn_Max_Date_Validation(this,'15','../../../images/Date_Control_Rule_Check.aspx')");
    }
    public void BindGrid()
    {
        string sql = "WEBX_BILLCollection_Detail_ETHC '" + Session["billnonos"].ToString() + "',''";
    ...
    public void CustomersGridView_RowDataBound(Object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            TextBox txtMiscCharge = (TextBox)e.Row.FindControl("txtMiscCharge");
            ...
            if (oGridView.ID != "GridView1")
            {
                ...
                txtMiscCharge.Attributes.Add("onblur", "javascript:Bill_Wise_Calc(this," + RowCnt + ")");
            }
    ...
    protected void submit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (GridViewRow gridrow in dockdata.Rows)
            {
                ...
                TextBox txtMiscCharge = (TextBox)gridrow.FindControl("txtMiscCharge");
                ...
                Xml_BillMR_DET = Xml_BillMR_DET + "<MiscCharge>" + txtMiscCharge.Text.ToString() + "</MiscCharge>";
            ...
            else if (ddlPayMode.SelectedValue.ToString() == "Bank" && txtChqAmt.Text.ToString().Trim() == "")
            {
                ErrMsg = "Please enter the cheque amount, PLz Tyr Again";
                throw new Exception(ErrMsg);
            }
            else if (ddlPayMode.SelectedValue.ToString() == "Bank" && Convert.ToDecimal(txtChqAmt.Text.ToString().Trim()) == 0)
            {
                ErrMsg = "Please enter the cheque amount, PLz Tyr Again";
                throw new Exception(ErrMsg);
            }
	    if (Onaccount.Checked == false && ddlPayMode.SelectedValue.ToString() == "Bank")
	    {
            ...
            try
            {
                string sql = "Usp_BillMR_Generate_Ethc";
