...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript" src="../BillCollection_ETHC_Ver2.js"></script>
                                        ...
                                        <asp:GridView align="Left" ID="dockdata" Width="100%" runat="server" BorderWidth="0"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Right" ItemStyle-BackColor="white">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtMiscCharge" Width="80" Text="0.00" MaxLength="10" Style="text-align: Right;"
                                                            onkeypress="javascript:return validFloat(event,this.getAttribute('id'))" runat="server"
                                                            BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <tr>
                        <td>
                            ...
                            <table border="0" cellspacing="1" cellpadding="4" width="50%" align="left" class="boxbg">
                                <caption>
                                    <font class="redfnt"><b>Note : Please Enter the Collection Details if Net 
                                    <br />
                                        <tr class="bgbluegrey">
                                        ...
                                        <tr style="background-color: #FFFFFF">
                                            <td align="left" colspan="4">
                                                <asp:UpdatePanel ID="UpdatePanePayment" runat="server" RenderMode="Inline"
