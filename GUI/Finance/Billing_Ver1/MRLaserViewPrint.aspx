<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MRLaserViewPrint.aspx.cs" Inherits="GUI_Finance_Billing_Ver1_MRLaserViewPrint" %>
    ...
    <form id="form1" runat="server">
        ...
        <ItemTemplate>
            ...
            <table class="bgwhite" border="0" cellpadding="0" cellspacing="0" style="height: 5in; width: 6.75in;">
                <tr>
                    <td colspan="4" style="height: 1.25in"></td>
                </tr>
                 <tr>
