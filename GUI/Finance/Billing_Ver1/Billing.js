...
function Datadate(dt) {
    ...
    var dt_new = dd + " " + months1[parseFloat(mm)] + " " + yy
    //alert(dt)
    return dt_new
...
function ONSubmit_Collection() {
    ...
    var MIn_dt = document.getElementById(FRM_NM + "Hnd_Mindate").value
    var Max_Date = document.getElementById(FRM_NM + "Hnd_Maxdate").value
    var Hnd_Party_Code = document.getElementById(FRM_NM + "Hnd_Party_Code");
    var txtCustomerName = document.getElementById(FRM_NM + "txtCustomerName");
    var txtCreditLimit = document.getElementById(FRM_NM + "txtCreditLimit");
    ...
    if (Hnd_Party_Code.value.toUpperCase() == "C00040268") {
    ...
    if (dt < Fromdate1) {
        //alert( "Bill Generation Date Should Be Between  "+ Fromdate +" to "+ Todate +" !!!");
        alert("MR Generation Date Should Be Greater than " + Fromdate + " !!!")
        document.getElementById(FRM_NM + "txtVoucherDate").focus();
        return false;
    }

    if (dt > server_dt) {
        alert("MR date should not be greater than today's date !!!");
        document.getElementById(FRM_NM + "txtVoucherDate").focus();
        return false;
    }
    //alert("hi..")
    if (dt < MIn_dt1) {
        alert("MR Date Should  be Greater than " + MIn_dt + " !!!");
        document.getElementById(FRM_NM + "txtVoucherDate").focus();
        return false;
    }
    if (dt > Max_Date1) {
        alert("MR date should  be less than  " + Max_Date + " !!!");
        document.getElementById(FRM_NM + "txtVoucherDate").focus();
        return false;
    }
