...
<br /><br />
 <table border="0" width="100%">
        ...
        <tr style="background-color:White">
            ...
            <td align="center"> 
                <%
                    ...
                    {
                        case "Journal":
                            //strViewURL = "../Voucher/Print/JournalVoucherView.aspx?voucherno=" + voucherId + "&printyn=N";
                            //strPrintURL = "../Voucher/Print/JournalVoucherPrint.aspx?voucherno=" + voucherId;
                            strViewURL = "../ViewPrint/Voucher Register/Print/JournalVoucherView.aspx?voucherno=" + voucherId + "&printyn=N";
                            strPrintURL = "../ViewPrint/Voucher Register/Print/JournalVoucherPrint.aspx?voucherno=" + voucherId + "&printyn=Y";
                            break;

                        case "Debit":
                            //strViewURL = "../Voucher/Print/DebitVoucherView.aspx?voucherno=" + voucherId + "&printyn=N";
                        ...
                        case "Special":
                            //strViewURL = "../Voucher/Print/DebitVoucherView.aspx?voucherno=" + voucherId + "&printyn=N";
                            //strPrintURL = "../Voucher/Print/DebitVoucherPrint.aspx?voucherno=" + voucherId;
                            strViewURL = "../ViewPrint/Voucher Register/Print/SpecialCostVoucherView.aspx?voucherno=" + voucherId + "&printyn=N";
                            strPrintURL = "../ViewPrint/Voucher Register/Print/SpecialCostVoucherView.aspx?voucherno=" + voucherId + "&printyn=Y";
                            break;

                        case "Credit":
                            //strViewURL = "../Voucher/Print/CreditVoucherView.aspx?voucherno=" + voucherId + "&printyn=N";
                            //strPrintURL = "../Voucher/Print/CreditVoucherPrint.aspx?voucherno=" + voucherId;
                        ...
                        case "Contra":
                            //strViewURL = "../Voucher/Print/ContraVoucherView.aspx?voucherno=" + voucherId + "&printyn=N";
                            //strPrintURL = "../Voucher/Print/ContraVoucherPrint.aspx?voucherno=" + voucherId;
        ...
        <tr style="background-color:White">
         ...
         <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="Special_Cost_Voucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Special Cost Voucher (With New Date)</font> </a>
         ...
         <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="Special_Cost_Voucher.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Special Cost Voucher (With Same Date)</font> </a>
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="LinkButton1" runat="server" Text="Prepare Debit Voucher" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/Debit Voucher/DebitVoucher.aspx" /></td>
        </tr>
        <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="LinkButton2" runat="server" Text="Prepare Credit Voucher" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/Credit Voucher/CreditVoucher.aspx" /></td>
        </tr>
        <tr style="background-color: white">
