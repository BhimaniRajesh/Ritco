...
public partial class octroi_octCustBillStep1 : System.Web.UI.Page
{
    ...
    protected void submit1_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            Response.Redirect("MR_Cancellation_2.aspx?strcust="+ txtcust.Text + "&strmrtype=" + ddlbilltype.SelectedValue.ToString() + "&strdt=" + strDate + "&para1="+para);
        }
    ...
    protected void submit2_Click(object sender, EventArgs e)
    {
            ...
            string para;
            para = "m";
            Response.Redirect("MR_Cancellation_2.aspx?strmrno=" + txtmr.Text + "&para1=" +para);
