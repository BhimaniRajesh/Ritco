<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="MR_Cancellation_old.aspx.cs" Inherits="octroi_octCustBillStep1" %>
                    ...
                    <td style="height: 324px" align="center" colspan="3">
                        <table cellspacing="1" style="width: 90%" class="boxbg" border="0"> 
                         ...
                         <td align="left" style="height: 25px; width: 100px;">
                                    ...
                                    <asp:Label ID="Label8"  CssClass="blackfnt" Text="Docket No :" runat="server" Width="102px"></asp:Label>    
                                    </td>
                                    <td align="left" style="height: 25px; width: 100px;">
                                    <asp:TextBox ID="txtdoc" runat="server"></asp:TextBox>
                                </td>
                                
                                <td align="left" valign="top" style="height: 25px"> <asp:Button  ID="Button2"   runat="server" OnClick="submit3_Click" Text="Submit"/></td>
                                </tr>
                                <tr style="background-color: white">
                                <td colspan="3" align="center" style="height: 21px">
                                    <asp:Label ID="Label9" CssClass="blackfnt" 
                                        Font-Bold="true" runat="server">
                                        OR
                                    </asp:Label>
                    ...
                    Width="14px"></asp:Label>
                         ...
                         <td align="left" style="height: 25px; width: 100px;">
                                    ...
                                    <asp:DropDownList ID="ddlbilltype" runat="server">
                                        ...
                                        <asp:ListItem Value="P01">TBB</asp:ListItem>
