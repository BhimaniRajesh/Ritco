<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="BE_Cancellation.aspx.cs" Inherits="octroi_octCustBillStep1" %>
...
{
    if(document.getElementById(Frm_name+"txtadv").value=="")
    {
    ...
    if(document.getElementById(Frm_name+"Billtype").value=="")
        {
             alert("Plz Select Bill Type ")
            document.getElementById(Frm_name+"Billtype").focus()
            return false;
        }
}
 ...
 function ValidateForm51(obj1,obj2)
{
                                ...
                                <table cellspacing="1" style="width: 90%" class="boxbg" border="0">
                                    ...
                                    <tr style="background-color: white">
                                        <td align="left" style="height: 25px; width: 100px;">
                                            <asp:Label ID="lbl" CssClass="blackfnt" Text="Enter Bill Entry No. :" runat="server"
                                        ...
                                        <td align="left" valign="top" style="height: 25px">
                                           <%-- <asp:Button ID="submit2" runat="server" OnClick="submit2_Click" Text="Submit" />--%></td>
                                        <tr style="background-color: white">
                                            <td colspan="3" align="center" style="height: 21px">
                                        ...
                                        <tr style="background-color: white">
                                        <td align="left" style="height: 25px; width: 100px;">
                                            <asp:Label ID="Label2" CssClass="blackfnt" Text="Bill Entry Type:" runat="server"
                                                Width="122px"></asp:Label>
                                        </td>
                                        <td align="left" style="height: 25px; width: 100px;" colspan="2">
                                           <asp:DropDownList ID="Billtype" runat="server" CssClass="blackfnt">
                                           <asp:ListItem  Value="">Select</asp:ListItem>
                                           <asp:ListItem  Value="THC"> THC Bill Entry</asp:ListItem>
                                           <asp:ListItem  Value="PDC"> PDC Bill Entry</asp:ListItem>
                                        ...
                                        <%--    <tr style="background-color: white">
                                        <td align="left" style="height: 25px; width: 100px;">
                                            <asp:Label ID="Label3" CssClass="blackfnt" Text="Enter Octroi Agent :" runat="server"
