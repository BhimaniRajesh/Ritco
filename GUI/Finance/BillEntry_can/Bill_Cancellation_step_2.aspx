...
function CheckData()
{
    ...
    var txtbilldt = document.getElementById(prefix + "txtcandt");
    ...
    <table cellspacing="1" width="50%" align="center" class="boxbg" border="0"> 
        ...
        <tr style="background-color: white">
            ...
            <td align="left" valign="top" width="500"> 
                <a href="#" onclick="cal.select(ctl00_MyCPH1_txtcandt, 'alnkdt', 'dd/MM/yyyy'); return false;" id="alnkdt">
                        ...
                        <td align="left">
                            <div align="left">
                                <asp:GridView CssClass="boxbg" runat="server" CellSpacing="1" BorderWidth="0" ID="grvcontrols"
                                    ...
                                    EmptyDataText="No Records Found..." HeaderStyle-CssClass="bgbluegrey" 
                                    HeaderStyle-Font-Bold="true" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" >
                                    <Columns>
                                        <asp:TemplateField ControlStyle-Width="50px" >
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdnbilldt" Value='<%# DataBinder.Eval(Container.DataItem,"BILLDT1")%>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Vendor">
                                            <ItemStyle CssClass="blackfnt" BackColor="white" HorizontalAlign="center" Width="10%"/>
                                            <ItemTemplate>
                                                <asp:Label ID="lblvendor" Text='<%# DataBinder.Eval(Container.DataItem,"vendname") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Bill Type">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblbilltype"  Text='<%# DataBinder.Eval(Container.DataItem,"betype") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
