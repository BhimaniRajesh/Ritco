...
function GetTot()
	{
        ...
        for(i = 2; i < rows ; i++)
        {
            ...
            if(Acccode!="")
            {
                ...
                /*if(HdnRoundOffRule.value == "Y")
                    T = rounditn(Math.round((Number(T) + Number(Amt))),2);
                else
                    T = roundNumber((Number(T) + Number(Amt)),2);*/
            }
        }
        ...
        //TotAmt.value = parseFloat(T).toFixed(2);
        ...
        //TP = parseFloat(Number(AmtAppl.value)+ Number(document.getElementById("ctl00_MyCPH1_txtServiceTax").value) + Number(document.getElementById("ctl00_MyCPH1_txtEduCess").value) + Number(document.getElementById("ctl00_MyCPH1_txtHEduCess").value)).toFixed(2);    
	...
	{  
        ...
        var TP = parseFloat(Number(AmtAppl.value)+ Number(txtServiceTax.value) + Number(txtEduCess.value) + Number(txtHEduCess.value)).toFixed(2);
        ...
        {   
            ...
            {   
                var appamount1 = rounditn((parseFloat((Number(HdnTdsAmt.value)) * Number(100)/Number(HdnTDSRate.value)).toFixed(3)),3);
                var appamount2 = rounditn((parseFloat(Number(AmtApplL.value)).toFixed(2)),2);
                var round1 = appamount1.substring(0,appamount1.length - 4);
       ...
       <asp:UpdatePanel ID="UpdatePanel3" runat="server"     UpdateMode="Conditional" RenderMode="Inline">
            <ContentTemplate>  
                  <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
                    <tr style="background-color: White"> 
                      ...
                      <td style="text-align: left" class="blackfnt"> &nbsp; <asp:TextBox ID="txtManualNo" runat="server" BorderStyle="Groove" CssClass="blackfnt" Width="100px" MaxLength="50"></asp:TextBox></td>
                    </tr>
                    <tr style="background-color: White"> 
                      <td style="text-align: left; width: 151px;" class="blackfnt"> &nbsp;Prepared at location</td>
                      <td style="text-align: left" class="blackfnt"> &nbsp; <asp:TextBox ID="txtPreparedLoc" runat="server" BorderStyle="Groove" CssClass="input" Width="100px" MaxLength="5" Enabled="false"></asp:TextBox> 
                        <input id="btnPreparedLoc" type="button" value="..." runat="server" /></td>
                      <td style="text-align: left" class="blackfnt"> &nbsp;Prepared By</td>
                      <td style="text-align: left" class="blackfnt"> &nbsp; <asp:TextBox ID="txtPreparedBy" runat="server" BorderStyle="Groove" CssClass="input" Width="100px" Enabled="false"></asp:TextBox></td>
                    ...
                    <tr style="background-color: White"> 
                      ...
                      <td style="text-align: left" class="blackfnt"> &nbsp; <asp:TextBox ID="txtAccLoc" runat="server" BorderStyle="Groove" CssClass="input" Width="100px" MaxLength="5" Enabled="false"></asp:TextBox> 
                    ...
                    <tr style="background-color: White"> 
                      <td colspan="5" align="left"> 
                        <b>8888 :</b> <asp:TextBox  ID="txtCode" runat="server" BorderStyle="Groove" CssClass="Blackfnt" Width="250px" MaxLength="100"></asp:TextBox></td>
                    </tr>
                   
                    <tr style="background-color: White"> 
                      <td style="text-align: left; width: 151px;" class="blackfnt"> &nbsp;Narration</td>
                      <td style="text-align: left" colspan="5" class="blackfnt"> &nbsp; <asp:TextBox ID="txtNarration" runat="server" onblur="javascript:FillNarration(this)" BorderStyle="Groove" CssClass="blackfnt" TextMode="MultiLine" Width="200px"></asp:TextBox></td>
                    </tr>
                  </table>
        <br />
        ...
        <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="350">
            <tr style="background-color: White">
                ...
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtRows" runat="server" style="text-align:right" onkeypress="javascript:return validInt(event)" BorderStyle="Groove" CssClass="blackfnt" Width="100px" MaxLength="3"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Account Code">
                                        ...
                                        <ItemTemplate>
                                            &nbsp;<asp:TextBox ID="txtAccCode" runat="server" BorderStyle="Groove" CssClass="input"
                                                Enabled="true" Width="100px" MaxLength="20"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtAmt" style="text-align:right" onchange="javascript:Nagative_Chk_wDecimal(this)" runat="server"
                                                BorderStyle="Groove" CssClass="input" Width="100px" Text="0.00" MaxLength="12" ></asp:TextBox>
                                        </ItemTemplate>
                                        <FooterStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center" />
                                        <FooterTemplate>
                                            &nbsp;&nbsp;<asp:TextBox ID="txtTotAmt" style="text-align:right" runat="server" CssClass="input" BorderStyle="Groove"
                                                Width="100px" MaxLength="12" Enabled="False"></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
        ...
        <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
            ...
            <tr style="background-color: White">
                ...
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtAmtApplL" runat="server" style="text-align:right" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False" OnTextChanged="txtAmtApplL_TextChanged"></asp:TextBox></td>
            </tr>
            <tr style="background-color: White">
                <td style="text-align: left" class="blackfnt">&nbsp;Service tax (+)</td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtServiceTax" runat="server" style="text-align:right" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False"></asp:TextBox>
                    <asp:HiddenField ID="HdnServiceTax" runat="server" />
                    <asp:HiddenField ID="HdnServiceTaxRate" runat="server" />
                </td>
                <td style="text-align: left" class="blackfnt">&nbsp;TDS Section</td>
                <td style="text-align: left" class="blackfnt">
            ...
            <tr style="background-color: White">
                <td style="text-align: left" class="blackfnt">&nbsp;Education Cess (+)</td>
                <td style="text-align: left" class="blackfnt"> 
                    &nbsp;<asp:TextBox ID="txtEduCess" runat="server" style="text-align:right" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False"></asp:TextBox>
                    <asp:HiddenField ID="HdnEduCess" runat="server" />
                    <asp:HiddenField ID="HdnEduCessRate" runat="server" />
                </td>
                <td style="text-align: left" class="blackfnt">&nbsp;TDS Rate</td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtTDSRate" runat="server" style="text-align:right" BorderStyle="Groove" onchange="javascript:Nagative_Chk_wDecimal_TDS(this,'Tdsrate')" CssClass="input" Width="80px" MaxLength="7"></asp:TextBox>
                    <asp:HiddenField ID="HdnTDSRate" runat="server" />
                </td>
            </tr>
            <tr style="background-color: White">
                <td style="text-align: left" class="blackfnt">&nbsp;Higher Education Cess (+)</td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtHEduCess" runat="server" style="text-align:right" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False"></asp:TextBox>
                    <asp:HiddenField ID="HdnHEduCess" runat="server" />
                    <asp:HiddenField ID="HdnHEduCessRate" runat="server" />
                </td>
                <td style="text-align: left" class="blackfnt">&nbsp;TDS Amount (-)</td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtTDSAmt" runat="server" style="text-align:right" onchange="javascript:Nagative_Chk_wDecimal_TDS(this,'Tdsamt')" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="true"></asp:TextBox>
            ...
            <%-- End SB Cess--%>
            <tr style="background-color: White">
                <td style="text-align: left" class="blackfnt">&nbsp;Service Tax Reg No.</td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtSrvTaxNo" runat="server" style="text-align:left" BorderStyle="Groove" CssClass="input" Width="140px" MaxLength="20"></asp:TextBox></td>
                <td style="text-align: left" class="blackfnt">&nbsp;PAN Number</td>
                <td style="text-align: left" class="blackfnt">
                    &nbsp;<asp:TextBox ID="txtPanNo" runat="server" style="text-align:left" BorderStyle="Groove" CssClass="input" Columns="10" MaxLength="10" Width="80px"></asp:TextBox>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server"  UpdateMode="Conditional" RenderMode="Inline">
            <ContentTemplate>
                <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
                    <tr style="background-color: White">
                        <td style="text-align: left" class="blackfnt">&nbsp;Payment Mode</td>
                        <td style="text-align: left" class="blackfnt">
                        ...
                        <td style="text-align: left" class="blackfnt">&nbsp;Amount Applicable</td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtAmtApplA" runat="server" style="text-align:right" BorderStyle="Groove" CssClass="blackfnt" Width="80px" Enabled="False"></asp:TextBox></td>
                    </tr>
                    <tr style="background-color: White">
                        <td style="text-align: left" class="blackfnt">&nbsp;Cash Amount</td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtCashAmt" runat="server" style="text-align:right" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False"></asp:TextBox></td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;Account
                        </td>
                        <td style="text-align: left" class="blackfnt"> 
                            &nbsp;<asp:DropDownList ID="ddrCashcode" runat="server"  ></asp:DropDownList>&nbsp;
                        </td>
                    </tr>
                    <tr style="background-color: White">
                        <td style="text-align: left" class="blackfnt">&nbsp;Cheque Amount</td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtChqAmt" runat="server" style="text-align:right" onchange="javascript:Nagative_Chk_wDecimal(this)" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False"></asp:TextBox></td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;Deposited</td>
                        <td style="text-align: left" class="blackfnt">
                    ...
                    <tr style="background-color: White">
                        <td style="text-align: left" class="blackfnt">&nbsp;Cheque No.</td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtChqNo" MaxLength="6" Columns="6" runat="server" style="text-align:right" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False"></asp:TextBox></td>
                        <td style="text-align: left" class="blackfnt">&nbsp;Deposited in Bank</td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:DropDownList ID="ddrBankaccode" runat="server"  ></asp:DropDownList>
                       </td>
                    </tr>
                    <tr style="background-color: white">
                        <td class="blackfnt" style="text-align: left">&nbsp;Cheque Date</td>
                        ...
                        <td class="blackfnt" style="text-align: left">&nbsp;Received From Bank</td>
                        <td class="blackfnt" style="text-align: left">
                    ...
                    <tr style="background-color: White">
                        <td style="text-align: left" class="blackfnt">On Account Yes/NO</td>
                        <td style="text-align: left" class="blackfnt">
                            <asp:CheckBox runat="server" ID="Onaccount" onclick="javascript:GetTot()"  />
                        </td>
                        <td style="text-align: left" class="blackfnt"><strong>&nbsp;NET RECEIVED</strong></td>
                        <td style="text-align: left" class="blackfnt">
                            &nbsp;<asp:TextBox ID="txtNetPay" runat="server" BorderStyle="Groove" CssClass="input" Width="80px" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
