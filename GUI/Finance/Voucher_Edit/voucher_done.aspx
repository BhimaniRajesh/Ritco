        ...
        <tr>
            ...
            <table border="0" class="boxbg" cellpadding="1" cellspacing="1" width="650">
                        ...
                        <%
                            ...
                            switch (voucherType)
                            {
                                case "Journal":
                                    ...
                                    strPrintURL = "../ViewPrint/Voucher Register/Print/JournalVoucherView.aspx?voucherno=" + voucherId;
                                    break;
                                ...
                                case "Contra":
                                    strViewURL = "../ViewPrint/Voucher Register/Print/ContraView.aspx?voucherno=" + voucherId + "&printyn=N";
                                    strPrintURL = "../ViewPrint/Voucher Register/Print/ContraView.aspx?voucherno=" + voucherId;
                                    break;
                            }
                        %>
                ...
                <tr style="background-color:White">
                    ...
                    <a href="../Debit Voucher/DebitVoucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Debit Voucher (With New Date)</font> </a>
                ...
                <tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                    <a href="../Debit Voucher/DebitVoucher.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Debit Voucher (With Same Date)</font> </a>
                ...
                <tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                    <a href="../Credit Voucher/CreditVoucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Credit Voucher (With New Date)</font> </a>
                      <%--  &nbsp;<asp:LinkButton ID="lnkStep2" runat="server" Text="Prepare Debit Voucher (With New Date)" CssClass="blackfnt" PostBackUrl="DebitVoucher.aspx?Defaultdate='today'" />--%></td>
                </tr>
                <tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                    <a href="../Credit Voucher/CreditVoucher.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Credit Voucher (With Same Date)</font> </a>
                        <%--&nbsp;<asp:LinkButton ID="LinkButton4" runat="server" Text="Prepare Debit Voucher (With Same Date)" CssClass="blackfnt" PostBackUrl="DebitVoucher.aspx?Defaultdate=<%=Defaultdate %>" />--%></td>
                </tr>
                <% } %>
                ...
                <tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                    <a href="../Contra Voucher/ContraVoucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Contra Voucher (With New Date)</font> </a>
                      <%--  &nbsp;<asp:LinkButton ID="lnkStep2" runat="server" Text="Prepare Debit Voucher (With New Date)" CssClass="blackfnt" PostBackUrl="DebitVoucher.aspx?Defaultdate='today'" />--%></td>
                </tr>
                <tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                    <a href="../Contra Voucher/ContraVoucher.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Contra Voucher (With Same Date)</font> </a>
                        <%--&nbsp;<asp:LinkButton ID="LinkButton4" runat="server" Text="Prepare Debit Voucher (With Same Date)" CssClass="blackfnt" PostBackUrl="DebitVoucher.aspx?Defaultdate=<%=Defaultdate %>" />--%></td>
                </tr>
                <% } %>
                ...
                <tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                    <a href="../Journal Voucher/JournalVoucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Journal Voucher (With New Date)</font> </a>
                      <%--  &nbsp;<asp:LinkButton ID="lnkStep2" runat="server" Text="Prepare Debit Voucher (With New Date)" CssClass="blackfnt" PostBackUrl="DebitVoucher.aspx?Defaultdate='today'" />--%></td>
                </tr>
                <tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                    <a href="../Journal Voucher/JournalVoucher.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Journal Voucher (With Same Date)</font> </a>
                        <%--&nbsp;<asp:LinkButton ID="LinkButton4" runat="server" Text="Prepare Debit Voucher (With Same Date)" CssClass="blackfnt" PostBackUrl="DebitVoucher.aspx?Defaultdate=<%=Defaultdate %>" />--%></td>
                </tr>
                <% } %>
                <%--<tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
                        <span style="font-size: 8pt; font-family: Verdana"><strong>
                            </strong></span><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/GUI/finance/Journal Voucher/JournalVoucher.aspx">Preapare Journal Voucher</asp:HyperLink></td>
                </tr>
                <tr style="background-color: white">
                    <td align="left" colspan="3" style="height: 18px">
                        <asp:LinkButton ID="LinkButton3" runat="server" Text="Prepare Contra Voucher" CssClass="blackfnt" PostBackUrl="~/GUI/Finance/Contra Voucher/ContraVoucher.aspx" /></td>
                </tr>--%>
                <%--<tr style="background-color:White">
                    <td align="left" colspan="3" style="height: 21px">
