...
function radEmpVenCustClick(id,ctlid,tbl,ctlval)
{    
    var text="";
    var ctlname = "";
    
    ctlname=ctlid.replace( "txtPartyCode", "txtPartyDescription");
    ...
    {
        window.opener.document.getElementById(ctlid).value = text;
        window.opener.document.getElementById(ctlname).value = ctlval;
    }     
    window.close();
}
...
<body style="font-size: 12pt; font-family: Times New Roman">
    ...
    <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" width="85%">   
        <tr bgcolor="#ffffff" id="grouprow" runat="server">
            ...
            <td class="blackfnt" align="left">
                <asp:DropDownList ID="cbomaincat" runat="server" CssClass="blackfnt">
                    ...
                    <asp:ListItem Value="EXPENSE">EXPENSES</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr bgcolor="#ffffff">
        ...
        <tr bgcolor="#ffffff" id="namerow" runat="server">
            <td class="blackfnt" align="right">
        ...
        <tr bgcolor="#ffffff">
            <td colspan="2" align="center" class="blackfnt"> 
                ...
                <asp:HiddenField ID="hdnbrcdcheck" runat="server" />
            </td>
        </tr>
    </table>
