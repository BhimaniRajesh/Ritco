<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="JournalVoucher_Edit.aspx.cs" Inherits="GUI_Finance_Journal_Voucher_JournalVoucher" Title="Journal Voucher" %>
...
function Get_Total()
{
        ...
        for(i = 2; i < rows ; i++)
        {
            var debitamt,creditamt,Acccode
            if(i<10)
            {
               debitamt=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl0" + i + "_txtDebitAmt").value;
               creditamt=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl0" + i + "_txtCreditAmt").value;
               Acccode=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl0" + i + "_txtAccCode").value;
            }
            else
            {
               debitamt=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl" + i + "_txtDebitAmt").value;
               creditamt=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl" + i + "_txtCreditAmt").value;
               Acccode=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl" + i + "_txtAccCode").value;
            }
            if(Acccode != "")
            {
                T1 = parseFloat(Number(T1) + Number(debitamt)).toFixed(2);
                T2 = parseFloat(Number(T2) + Number(creditamt)).toFixed(2);
            }
        }
        ...
        TotDebitAmt.value = T1;
        TotCreditAmt.value = T2;
}
         ...
         //  alert(Totalcount)
           if(i<10)
            ...
            if(Acccode!="")
            {
                    ...
                    if(Cr_Amount.value == "")
                        Cr_Amount.value = "0.00";
                    if(Dr_Amount.value == "")
                        Dr_Amount.value = "0.00";   
            ...
            <table border="0" cellpadding="1" cellspacing="1" class="boxbg" width="800">
                <tr style="background-color: White"> 
                    ...
                    <td class="blackfnt"  nowrap style="text-align: left">
                        <span style="color: #ff0000">&nbsp;&lt;<asp:Label ID="lblvoucherno" runat="server"></asp:Label>&gt;</span>
                    </td>
                ...
                <tr style="background-color: White"> 
                  ...
                  <td colspan="3" style="text-align: left"  nowrap  class="blackfnt"> &nbsp;
                    <strong><asp:Label ID="lblpreparedby" runat="server"></asp:Label></strong> 
                    <asp:HiddenField ID="HdnEmpcd" runat="server" />
                    <asp:HiddenField ID="HdnOppcode" runat="server" />
                  </td>
                </tr>
                <tr style="background-color: White"> 
                                ...
                                <asp:GridView ID="grvcontrols" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Narration">
                                            ...
                                            <ItemTemplate>
                                                &nbsp;
                                                <asp:TextBox ID="txtNarration"  onblur="javascript:this.value=this.value.toUpperCase()"  runat="server" BorderStyle="Groove" CssClass="input" TextMode="MultiLine" MaxLength="200" Width="150px" Text='<%# DataBinder.Eval(Container.DataItem,"Narration") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
            ...
            <table cellspacing="1" class="boxbg" width="800">
                <tr class="bgbluegrey">
                    <td align="center">
                        ...
                        <asp:HiddenField ID="hdnTotDebitAmt" runat="server" Value="0.00" />
                        <asp:HiddenField ID="hdnTotCreditAmt" runat="server" Value="0.00" />
                    </td>
                </tr>
            </table>
            <br />
