<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Voucher_Edit_step_1.aspx.cs" Inherits="GUI_Finance_Voucher_Edit_Voucher_Edit_step_1" Title="Untitled Page" %>
...
<script language="javascript" type="text/javascript">
	   ...
	   var FinYear_to=parseInt(FinYear)+1
        ...
        {
            //debugger;
            if(document.getElementById(Frm_name+"txtVoucherNo").value=="")
            {
            ...
            if(document.getElementById(Frm_name+"Vouchertype").value=="")
                {
                     alert("Plz Select Voucher Type ")
                    document.getElementById(Frm_name+"Vouchertype").focus()
                    return false;
                }
        }
</script>        
                        ...
                        <tr align="center">
                            <td style="height: 324px" align="center" colspan="3">
                                <table cellspacing="1" style="width: 90%" class="boxbg" border="0">
                                    <tr class="bgbluegrey">
                                        <td colspan="3" align="center" style="height: 21px">
                                            <asp:Label ID="lblQry" CssClass="blackfnt" Font-Bold="true" runat="server">
                                                Enter Voucher For Edit
                                            </asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="background-color: white">
                                        <td align="left" style="height: 25px; width: 100px;">
                                            <asp:Label ID="lbl" CssClass="blackfnt" Text="Enter Voucher No. :" runat="server"
                                    ...
                                    <tr style="background-color: white">
                                         <td align="left" style="height: 25px; width: 100px;">
                                                <asp:Label ID="Label2" CssClass="blackfnt" Text="Voucher Type:" runat="server"
                                                    Width="122px"></asp:Label>
                                         </td>
                                         <td align="left" style="height: 25px; width: 100px;" colspan="2">
                                               <asp:DropDownList ID="Vouchertype" runat="server" CssClass="blackfnt">
                                                   <asp:ListItem  Value="">Select</asp:ListItem>
                                                   <asp:ListItem  Value="Debit">Debit Voucher</asp:ListItem>
                                                   <asp:ListItem  Value="Credit">Credit Voucher</asp:ListItem>
                                                   <asp:ListItem  Value="Journal">Journal Voucher</asp:ListItem>
                                                   <asp:ListItem  Value="Contra">Contra Voucher</asp:ListItem>
                                               </asp:DropDownList>
                                         </td>
                                     </tr>
                                    <tr class="bgbluegrey">
                                         <td colspan="3" align="center" style="height: 21px">
                                            <asp:Label ID="Label5" CssClass="blackfnt" Font-Bold="true" runat="server">
                                                    Select Voucher Entry Date 
                                            </asp:Label>
                                         </td>
                                    </tr>
                                    <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                         <td valign="top" align="left">
                                            <asp:Label ID="Label6" CssClass="blackfnt" Text="Select Login Date" runat="server"
