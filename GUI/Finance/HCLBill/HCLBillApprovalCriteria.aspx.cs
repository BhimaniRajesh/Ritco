...
public partial class GUI_Finance_HCLBill_HCLBillApprovalCriteria : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            strFinalQS = strFinalQS + "&BranchCode=" + txtBranchcode.Text;
            Response.Redirect("HCLBillApproval.aspx" + strFinalQS, false);
        }
        catch (Exception Ex)
        {
