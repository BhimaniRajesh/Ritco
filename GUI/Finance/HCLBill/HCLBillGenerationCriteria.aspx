<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="HCLBillGenerationCriteria.aspx.cs" Inherits="GUI_Finance_HCLBill_HCLBillGenerationCriteria" %>
        ...
        <table class="stbl" cellspacing="1" cellpadding="3" style="width: 900px" id="tblCriteria" runat="server">
            <tr class="hrow">
                <td colspan="2" align="center">
                    <b>HCL Bill Generation Criteria</b>
