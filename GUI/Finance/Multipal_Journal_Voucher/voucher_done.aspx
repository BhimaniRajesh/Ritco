...
<br /><br />
 <table border="0" width="100%">
        ...
        <%--<tr style="background-color:White">
         ...
         <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="JournalVoucher_Ver1.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Multiple JV (With New Date)</font> </a>
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="JournalVoucher_Ver1.aspx?Defaultdate=<%=Defaultdate %>"><font class="blackfnt"> Prepare Multiple JV (With Same Date)</font> </a>
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
            <a href="../Journal Voucher/JournalVoucher.aspx?Defaultdate=today"><font class="blackfnt"> Prepare Journal Voucher </font> </a>
                <%--&nbsp;<asp:LinkButton ID="LinkButton4" runat="server" Text="Prepare Debit Voucher (With Same Date)" CssClass="blackfnt" PostBackUrl="DebitVoucher.aspx?Defaultdate=<%=Defaultdate %>" />--%></td>
        </tr>
        <tr style="background-color:White">
            <td align="left" colspan="3" style="height: 21px">
