...
public partial class octroi_octCustBillStep1 : System.Web.UI.Page
{
    ...
    protected void submit1_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            Response.Redirect("Bill_Cancellation_2.aspx?strcust="+ txtcust.Text + "&strbilltype=" + ddlbilltype.SelectedValue.ToString() + "&strdt=" + strDate + "&para1="+para);
        }
    ...
    protected void submit2_Click(object sender, EventArgs e)
    {
            ...
            string para;
            para = "2";
            Response.Redirect("Bill_Cancellation_2.aspx?strbillno=" + txtdoc.Text + "&para1=" +para);
