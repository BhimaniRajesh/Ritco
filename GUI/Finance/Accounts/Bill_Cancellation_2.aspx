<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Cancellation_2.aspx.cs" Inherits="GUI_Finance_Accounts_Bill_Cancellation_2" %>
...
<script language="javascript" type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function check_submit()
        {
            ...
            {
                            alert("Please enter the Bill Cancel Date")
            ...
            {
                            alert("Please enter the Bill Cancel Reason")
				              document.getElementById(Frmnae+"txtreson").focus();
				              return false;
            }
            //alert(document.getElementById(Frmnae+"txtdt").value )
            if(document.getElementById(Frmnae+"txtdt").value != "")
            {
                if(!isValidDate(document.getElementById(Frmnae+"txtdt").value,"BillCancellation"))
                {
                    document.getElementById(Frmnae+"txtdt").focus();
                    return false;
                 }   
				...
				if (dt>server_dt1)
                {
		                alert( "Bill Cancellation Date should not be greater than today's date !!!")
		                document.getElementById(Frmnae+"txtdt").focus();
		                return false;
                } 
            }
            var gridctrl="GV_Booking";
            var mTotalRecords = "<%=intTotalRecords %>";
            //alert(mTotalRecords);
            var mDerivedControlName = "";
            var mDerivedControlName1="";
            var mSelection = 0;
            var j = 0;
            ...
            for (var i=0; i < mTotalRecords; i++)
            {
                ...
                if(j < 10)
                {
                    mDerivedControlName = "ctl00_MyCPH1_" + gridctrl + "_ctl" + "0" + j + "_chkbill";
                }
                else
                {
                     mDerivedControlName = "ctl00_MyCPH1_" + gridctrl + "_ctl"  + j + "_chkbill";
                }
            ...
            if(mSelection == 0)
            {
                alert("Select atleast one bill to cancel !");
                return false;
            }
                                  ...
                                  <table border="0" cellpadding="3" width="565" style="background-color: #808080;" cellspacing="1" align="center" class="boxbg">
                                                                <tr style="background-color: #ffffff">
                                                                    ...
                                                                    <%--<tr style="background-color: #FFFFFF">
                                                                        <td >
                                                                            <label class="blackfnt">
                                                                                <span style="font-size: 10pt">Bill Type</span> :</label></td>
                                                                ...
                                                                <td>
                                                                <br />
<table cellspacing="1" style="width: 90%;" border="0">
                    ...
                    <td align="center" colspan="3">
                        <table cellspacing="1" style="width: 90%" class="boxbg" border="0"> 
                         ...
                         <td align="left" style="width: 100px;">
                                    ...
                                    <asp:TextBox ID="txtdt" runat="server" Width="70" MaxLength=10></asp:TextBox>
                                </td>
                                
                                <td align="left" valign="top" width="500"> 
                                <a href="#" onclick="cal.select(ctl00_MyCPH1_txtdt, 'alnkdt', 'dd/MM/yyyy'); return false;" 
                            id="alnkdt">
                            <img src="../../images/calendar.jpg" border="0" alt="" />&nbsp;<font CssClass="blackfnt">(dd/mm/yyyy)</font>
                                </td>
                                <tr style="background-color: white">
                                <td align="left" >
                                ...
                                <td colspan="2" align="left" >
                                     <asp:TextBox ID ="txtreson" runat="server" TextMode="multiLine" Width="200" ></asp:TextBox>
                                                                ...
                                                                <tr>  
                                                                    <td>
                                                                     <br />
                                                                    <asp:GridView  Width="800" ID="GV_Booking" runat="server" align="center" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey" 
                                                         PagerStyle-HorizontalAlign="left" 
                                                            ...
                                                            PagerSettings-FirstPageText="[First]" PagerSettings-LastPageText="[Last]" EmptyDataText="No Records Found..." >
                                                                ...
                                                                <Columns>
                                                                 ...
                                                                 <asp:BoundField  DataField="loc"   ItemStyle-Wrap="true"  HeaderText="Billing Branch "   > 
                                                                            <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                                                           <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                                                                             </asp:BoundField>
                                                                             
                                                                                             
                                                                 <asp:BoundField  DataField="cust"   ItemStyle-Wrap="true" HeaderText="Party Name"      > 
                                                                            <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                                                           <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                                                                             </asp:BoundField>
                                                                 ...
                                                                 <asp:BoundField  DataField="paybas"   ItemStyle-Wrap="true" HeaderText="Bill Type  "      > 
                                                                            <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                                                           <ItemStyle  Width="150"  Wrap="False"  HorizontalAlign="Center" CssClass="blackfnt" />
                                                                             </asp:BoundField>
                                                                ...
                                                                <tr>
                                                                 <td>
                                                                 <asp:Button ID="btn_submit" Text="Submit" CssClass="blackfnt" runat="server" OnClick="btn_submit1" />
                                                                </td>
                                                                 </tr>
                                                                </table>
