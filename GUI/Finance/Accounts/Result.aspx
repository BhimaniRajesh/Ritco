<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="Result.aspx.cs" Inherits="GUI_Finance_Accounts_Result" %>
    ...
    <table border="0" cellpadding="1" cellspacing="1" class="boxbg" style="width: 80%"
        ...
        <tr class="bgbluegrey">
            <td colspan="3" align="center" style="height: 21px">
                <asp:Label ID="lblQry" CssClass="blackfnt" Font-Bold="True" runat="server" ForeColor="Red">Following Document has Successfully Cancelled </asp:Label>
            </td>
        </tr>
        ...
        <tr bgcolor="white" style="height: 25px">
            <td style="width: 120px">
                <font class="blackfnt"><strong>Bill </strong></font>
            </td>
            <td>
