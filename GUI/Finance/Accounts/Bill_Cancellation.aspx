<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Bill_Cancellation.aspx.cs" Inherits="octroi_octCustBillStep1" %>
...
"July", "August", "September", "October", "November", "December");
        ...
        function SubmitQueryData()
        {
         ...
         document.getElementById('ctl00_MyCPH1_txtdoc').value="";
          var bustype= document.getElementById('ctl00_MyCPH1_cboBusType').value;
          if(bustype=="")
          {
          alert("Please select Customer Business Type ");
          document.getElementById('ctl00_MyCPH1_cboBusType').focus();
          return false;
          }
          
          var custcode=document.getElementById('ctl00_MyCPH1_Party_code').value;
          if(custcode=="")
          {
          alert("Please enter billing party code  ");
          document.getElementById('ctl00_MyCPH1_Party_code').focus();
          return false;
          }
          document.getElementById('ctl00_MyCPH1_txtcust').value=custcode;
          document.getElementById('ctl00_MyCPH1_txtdoc').value="";
          
          
          
//              var BillDate= document.getElementById('ctl00_MyCPH1_txtBillDate').value;
//              if(BillDate=="")
//              {
...
//              
//              
              var FromDate= document.getElementById('ctl00_MyCPH1_txtDateFrom').value;
              if(FromDate=="")
              {
              ...
              var ToDate= document.getElementById('ctl00_MyCPH1_txtDateTo').value;
              if(ToDate=="")
              {
...
<table cellspacing="1"  border="0" align=left>
                    ...
                    <td style="height: 324px" align="center" colspan="3">
                        <table cellspacing="1" style="width: 90%" class="boxbg" border="0"> 
                         ...
                         <td align="left" style="height: 25px; width: 100px;">
                                    ...
                                    <asp:Label ID="lbl"  CssClass="blackfnt" Text="Bill No :" runat="server" Width="102px"></asp:Label>    
                                    </td>
                                    <td align="left" style="height: 25px; width: 100px;">
                                    <asp:TextBox ID="txtdoc" runat="server"></asp:TextBox>
                                </td>
                                
                                <td align="left" valign="top" style="height: 25px"> <asp:Button  ID="submit2"   runat="server" OnClick="submit2_Click" Text="Submit"/></td>
                                <tr style="background-color: white">
                                <td colspan="3" align="center" style="height: 21px">
            ...
            <td  align="left" nowrap>
               <font class="blackfnt">
                   Select Customer Business Type
                  </font>
            </td>
            <td colspan=3 align=left>
            
                <asp:DropDownList ID="cboBusType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ShowData">
                  <asp:ListItem Text="Select" Value=""></asp:ListItem>
                         ...
                         <td align="left" style="height: 25px; width: 100px;">
                                    ...
                                    <asp:TextBox ID="Party_code" runat="server"  width="60" Columns="50" ></asp:TextBox>
                <input id="btnPopUp" type="button" value="..." name="custpup12"  runat="server" />
                <%--<font class="blackfnt"><br />(Type String Characte of Party)</font>--%>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Party_code" ValidationGroup="t2"
                  CssClass="blackfnt"  ErrorMessage=" Please Enter Party code !!!"></asp:RequiredFieldValidator>
                  <asp:TextBox ID="txtcust" runat="server" Visible=true style="position:absolute;visibility:hidden"></asp:TextBox>
...
--%>                                </td>
                         ...
                         <td align="left" style="height: 25px; width: 100px;">
                                    ...
                                    <asp:Label ID="Label4"  CssClass="blackfnt" Text="Bill Type :" runat="server" Width="102px"></asp:Label>    
                                    </td>
                                    <td align="left" colspan="2" style="height: 25px; width: 100px;">
                                 
                                        <% if (cboBusType.SelectedItem.Value=="02")
                                        { %>
                                        <asp:DropDownList ID="ddlbilltypeTS" runat="server">
                                            <asp:ListItem Value="9">Trip Sheet</asp:ListItem>
                                        </asp:DropDownList>
                                        <%}else if (cboBusType.SelectedItem.Value=="01"){ %>
                                        <asp:DropDownList ID="ddlbilltype" runat="server">
                                        <asp:ListItem>All</asp:ListItem>
                                        <asp:ListItem Value="2">TBB</asp:ListItem>
                                        <asp:ListItem Value="6">OCTROI</asp:ListItem>
                                    </asp:DropDownList>
                                    <%} %>
                            ...
                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                                       ...
                                                       <asp:Label ID="Label6"  CssClass="blackfnt" Text="Select Bill Generation Date" runat="server" Width="145px"></asp:Label>    
                                                            </td>
                        ...
                        </a><asp:Label ID="lblTo" CssClass="blackfnt" runat="server" Text=" To: "></asp:Label><asp:TextBox ID="txtDateTo" runat="Server" ValidationGroup="VGDtFromTo" Width="80"></asp:TextBox>
                                                           <a href="#" onclick="cal.select(ctl00_MyCPH1_txtDateTo, 'alnkDateFrom', 'dd/MM/yyyy'); return false;" 
                            id="a1">
                            <img src="../../images/calendar.jpg" border="0" alt="" />
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateFrom"
                                                                ErrorMessage="Date From Can Not Be Blank" ValidationGroup="t2"></asp:RequiredFieldValidator>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDateTo"
                                                                ErrorMessage="Date To Can Not Be Blank" ValidationGroup="t2"></asp:RequiredFieldValidator></td>
                        </tr>
                                </td>
                                </tr>
                                <tr style="background-color: white">
                                ...
                                <asp:Button  ID="Button1"   runat="server" OnClick="submit1_Click" Text="Submit" ValidationGroup="t2"/>
                                </td>
                                </tr>
                                </table>
