...
<script language="javascript" type="text/javascript" src= "../../../GUI/Telecomm/CalendarControl.js"></script> --%>   
    ...
    <asp:UpdatePanel ID="UpdatePanel8" runat="server"  UpdateMode="Conditional" RenderMode="Inline">               
        ...
        <td style="width: 94px">
            <asp:TextBox ID="txtNumber" runat="server" Width="40px" AutoPostBack="true" OnTextChanged="txtNumber_TextChanged">5</asp:TextBox></td>
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtBillNo" runat="server" onblur="JavaScript:this.value=this.value.toUpperCase();" MaxLength="49" />
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Bill Date">
                <ItemTemplate>
                <asp:TextBox ID="txtBillDt" runat="server"/>    <%-- onfocus="showCalendarControl(this);" onlostfocus="hidecalendarcontrol();" --%>                             
                </ItemTemplate>
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtAmt" runat="server" onblur="return AmountChk()" MaxLength="9"  />              
                </ItemTemplate>
                <FooterTemplate>
                <div align="left">
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtSvcTax" runat="server" onblur="return AmountChk()" MaxLength="9"/>
                </ItemTemplate>
                <FooterTemplate>
                <div align="left">
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtCess" runat="server" onblur="return AmountChk()"  MaxLength="9"/>
                </ItemTemplate>
                <FooterTemplate>
                <div align="left">
        ...
        <div id="testdiv1" ></div><%--style="position:absolute;visibility:hidden;background-color:white;z-index:99;"--%>
    </asp:Content>
