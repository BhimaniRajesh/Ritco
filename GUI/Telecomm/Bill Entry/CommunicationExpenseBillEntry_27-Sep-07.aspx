...
function Check()
{
    if(document.getElementById("ctl00_MyCPH1_txtNumber").value !="")
    {
        ...
        {
            //debugger
            GridDevNo = "ctl00_MyCPH1_gvBillDetails_ctl" + (BillNo < 9 ? ("0" + (BillNo + 1)) : (BillNo + 1)) +"_txtDevNo";
...
{ 
    ...
    if(document.getElementById("ctl00_MyCPH1_txtNumber").value !="")
    {
        ...
        {       
         ...
         document.getElementById(GridFootBillAmt).innerText = TotAmt;
         document.getElementById(GridFootSvcTax).innerText = TotSvc;
         document.getElementById(GridFootCess).innerText = TotCess;
         document.getElementById(GridFootTotal).innerText = parseFloat(TotAmt) - parseFloat(TotSvc) - parseFloat(TotCess);
         document.getElementById("ctl00_MyCPH1_lblTotAmt").innerText = TotAmt;
        ...
        <table id="Table2" align="center" cellspacing="1" cellpadding="1" width="85%" class="boxbg" style="width: 80%;">
                <tr bgcolor="white">
                    ...
                    <td align="left" style="width: 214px">
                        &nbsp;<asp:TextBox ID="txtEntryDt" runat="server" Width="76px" onblur=" return DateCheck()"></asp:TextBox></td>
                </tr>
    ...
    <asp:UpdatePanel ID="UpdatePanel8" runat="server"  UpdateMode="Conditional" RenderMode="Inline">               
        ...
        <td style="width: 94px">
            <asp:TextBox ID="txtNumber" runat="server" Width="40px" AutoPostBack="true" OnTextChanged="txtNumber_TextChanged">5</asp:TextBox></td>
                ...
                <br />
                <asp:GridView ID="gvBillDetails" runat="server" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#8BA0E5" BorderWidth="1px" CssClass="blackfnt" ShowFooter="True">
                <Columns>
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtBillNo" runat="server" onblur="JavaScript:this.value=this.value.toUpperCase();" />
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Bill Date">
                <ItemTemplate>
                <asp:TextBox ID="txtBillDt" runat="server"/>
                </ItemTemplate>                    
                <ControlStyle Width="70px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Due Date" FooterText="Total">
                <ItemTemplate>
                <asp:TextBox ID="txtDueDt" runat="server" />
                </ItemTemplate>
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtAmt" runat="server" onblur="return AmountChk()"  />              
                </ItemTemplate>
                <FooterTemplate>
                <div align="left">
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtSvcTax" runat="server" onblur="return AmountChk()"/>
                </ItemTemplate>
                <FooterTemplate>
                <div align="left">
                ...
                <ItemTemplate>
                <asp:TextBox ID="txtCess" runat="server" onblur="return AmountChk()" />
                </ItemTemplate>
                <FooterTemplate>
                <div align="left">
                ...
                <ItemTemplate>
                <asp:TextBox ID="lblTot" runat="server" Enabled="true" />
                </ItemTemplate>
                <FooterTemplate>
