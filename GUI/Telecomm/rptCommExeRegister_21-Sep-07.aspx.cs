...
public partial class rptCommExeRegister : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            {
                Response.Redirect("Cost_Summary_Rpt.aspx?Loc=" + "Loc" + "&Location=" + ddlLoc.SelectedItem.Text + "&User=" + Person + "&Vendor=" + ddlVendor.SelectedItem.Text + "&Device=" + ddlCommType.SelectedItem.Text + "&Number=" + ddlNumber.SelectedItem.Text + "&Months=" + strName + "&Year=" + ddlYear.SelectedItem.Value);
            }
            if (rbVendorWise.Checked == true)
            {
                Response.Redirect("Cost_Summary_Rpt.aspx?Loc=" + "Vendor" + "&Location=" + ddlLoc.SelectedItem.Text + "&User=" + Person + "&Vendor=" + ddlVendor.SelectedItem.Text + "&Device=" + ddlCommType.SelectedItem.Text + "&Number=" + ddlNumber.SelectedItem.Text + "&Months=" + strName + "&Year=" + ddlYear.SelectedItem.Value);
            }
            else
            {
                Response.Redirect("Cost_Summary_Rpt.aspx?Loc=" + "Device" + "&Location=" + ddlLoc.SelectedItem.Text + "&User=" + Person + "&Vendor=" + ddlVendor.SelectedItem.Text + "&Device=" + ddlCommType.SelectedItem.Text + "&Number=" + ddlNumber.SelectedItem.Text + "&Months=" + strName + "&Year=" + ddlYear.SelectedItem.Value);
            }
        }
    }
}
