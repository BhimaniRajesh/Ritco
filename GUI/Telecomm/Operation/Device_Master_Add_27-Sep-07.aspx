                            ...
                            <center>
                                ...
                                <table align="center" bgcolor="#000000" border="0" cellpadding="4" cellspacing="1"
                                    ...
                                    <tr bgcolor="#ffffff" style="font-weight: bold; font-size: 12pt; font-family: Times New Roman">
                                        ...
                                        <td align="left" colspan="3" style="font-size: 8pt; width: 90%; font-family: Verdana">
                                            &nbsp;<asp:TextBox ID="txtNumber" runat="server" AutoPostBack="true" OnTextChanged="txtNumber_TextChanged"
                                                Width="110px"></asp:TextBox><asp:Label ID="lblNumber" runat="server" CssClass="blackfnt"
                                                    ForeColor="#FF8080"></asp:Label><asp:CustomValidator ID="cvNumber" runat="server"
                                    ...
                                    <tr bgcolor="#ffffff" style="font-weight: bold; font-size: 12pt; font-family: Times New Roman">
                                        ...
                                        <td align="left" colspan="3" style="font-size: 12pt; width: 90%; font-family: Times New Roman">
                                            &nbsp;<asp:TextBox ID="txtPerson" runat="server" AutoPostBack="true" MaxLength="15"
                                                OnTextChanged="txtPerson_TextChanged" Width="65px"></asp:TextBox><asp:Label ID="lblPersonName"
                                                    runat="server" CssClass="blackfnt"></asp:Label><asp:CustomValidator ID="cvPerson"
                                                        runat="server" ControlToValidate="txtPerson" CssClass="blackfnt" OnServerValidate="Person"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr bgcolor="#ffffff" style="font-weight: bold; font-size: 12pt; font-family: Times New Roman">
                                        <td style="width: 31%" align="left">
                                    ...
                                    <tr bgcolor="#ffffff" style="font-weight: bold; font-size: 12pt; font-family: Times New Roman">
                                        <td class="blackfnt" align="left">
                                            &nbsp;Customer Ref No.</td>
                                        <td align="left" colspan="3" style="width: 90%">
                                            &nbsp;<asp:TextBox ID="txtRefNo" runat="server" Width="111px"></asp:TextBox></td>
                                    </tr>
                                    <tr bgcolor="#ffffff" style="font-weight: bold">
                                        <td class="blackfnt" align="left">
                                            &nbsp;Billing Code</td>
                                        <td align="left" colspan="3" style="width: 90%">
                                            &nbsp;<asp:TextBox ID="txtBillCode" runat="server" Width="111px"></asp:TextBox></td>
                                    </tr>
                                    <tr bgcolor="#ffffff" style="font-weight: bold">
                                        <td class="blackfnt" align="left">
                                            &nbsp;Credit Amount</td>
                                    ...
                                    <tr bgcolor="#ffffff" style="font-weight: bold">
                                        ...
                                        <td align="left" colspan="3" style="width: 90%">
                                            <asp:CheckBox ID="chkActive" runat="server" AutoPostBack="true" OnCheckedChanged="chkActive_CheckedChanged" /><asp:TextBox
