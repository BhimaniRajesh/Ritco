<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TDS_Cust_Popup.aspx.cs" Inherits="GUI_UNI_MIS_TDS_STMT_TDS_Cust_Popup" %>
...
//                
                ...
                window.opener.document.getElementById("ctl00_MyCPH1_txtPerson").value = objCustomer.value
                window.opener.document.getElementById("ctl00_MyCPH1_lblLocation").innerHTML = objCustomer.Location
                window.opener.document.getElementById("ctl00_MyCPH1_lblPersonName").innerHTML= objCustomer.CustName
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                ...
                                <input id="radSelBranch" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "CustCode")%>' CustName='<%#DataBinder.Eval(Container.DataItem, "CustName")%>' Location='<%#DataBinder.Eval(Container.DataItem, "Location")%>' runat="server" onclick="SelectCustomer(this);" />                               
                            </td>
                            ...
                            <td align="left">
                                <label id="Label2" class="blackfnt">
                                    &nbsp;
