<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_Doc_Date_Diff_Query" %>
                            ...
                            <table cellspacing="1" class="boxbg" style="width: 70%">
                                <tr class="bgbluegrey">
                                    <td align="center" colspan="3">
                                        <asp:Label ID="lblQry" runat="server" CssClass="blackfnt" Font-Bold="True">Search Docket Date Criteria</asp:Label></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left" style="width: 146px">
                                        <asp:Label ID="lblDateRange1" runat="server" CssClass="blackfnt" Font-Bold="True"
                                            Width="16px">Select</asp:Label>
                                        &nbsp; &nbsp; &nbsp;
                                        <asp:DropDownList ID="cboDateDiff" runat="server" Width="100px">
                                            <asp:ListItem Value="dockdt">Booking Date</asp:ListItem>
                                            <asp:ListItem Value="dockdt_entry">Entry Date</asp:ListItem>
                                        </asp:DropDownList></td>
                                ...
                                <tr style="background-color: white">
                                    <td align="left" style="width: 146px">
                                        <asp:Label ID="lblSelLoc" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Select Location" Width="108px"></asp:Label>
                                    </td>
                                    <td align="left" colspan="2">
                                ...
                                <tr style="background-color: white">
                                    <td align="center" colspan="3">
                                        ...
                                        <asp:TextBox ID="txtDateDiff2" runat="server" Width="57px">7</asp:TextBox>&nbsp;</td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="right" colspan="3">
                                        <asp:Button ID="btnShowDateDiff" runat="server" OnClick="btnShowDateDiff_OnClick"
                                            Text="Show Date Difference(s) >>" OnClientClick="return DateCheck()" /></td>
