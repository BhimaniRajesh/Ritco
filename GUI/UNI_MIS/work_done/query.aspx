<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="query.aspx.cs" Inherits="GUI_UNI_MIS_work_done_query" %>
    ...
    <div align="left">
        <table cellspacing="1" style="width: 9.0in" class="boxbg" align="left">
            ...
            <tr style="background-color: white">
                ...
                <td colspan="5" align="left"><asp:TextBox  Enabled="false" ID="txtcustcd" runat="server" ></asp:TextBox></td>
