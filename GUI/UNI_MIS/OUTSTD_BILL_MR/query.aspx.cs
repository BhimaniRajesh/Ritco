...
public partial class GUI_UNI_MIS_OUTSTD_BILL_MR_query : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        st_asondt = txtasondt.Text.ToString();
        st_asondtTo = txtasondt_to.Text.ToString();
        ...
        final += "&st_asondt=" + st_asondt;
        final += "&st_asondtTo=" + st_asondtTo;
