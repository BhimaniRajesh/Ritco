...
--%>
    &nbsp;&nbsp;
    <br />
    <%--<asp:Label ID="Label1" Font-Underline="true" Font-Bold ="true" runat="server" Text="Reports/Operations/DCR Register Query"></asp:Label>--%>
    <br />
    ...
    <br />
    <div align="left">
        <table style="width: 639px; height: 90px;" title="Select To Pay Arrival Criteria"
            border="0" cellpadding="0" cellspacing="1" class="boxbg">
            <tr class="bgbluegrey">
            ...
            <tr bgcolor="white">
                <td align="left" valign="Top" class="blackfnt" style="height: 76px">
                    Select Issue Date At UNHO</td>
                <td align="left" valign="top" colspan="2" style="width: 404px; height: 76px;">
                ...
                <td align="left" valign="top" colspan="1" style="height: 76px">
                    <asp:UpdatePanel ID="UpdatePanel4"  UpdateMode="Conditional" RenderMode="Inline" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtDateFrom" runat="Server" Width="83px"></asp:TextBox><asp:TextBox
                                ID="txtDateTo" runat="Server" Width="86px"></asp:TextBox>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="radDate" EventName="SelectedIndexChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                    <asp:CustomValidator ID="CustomValidator1" align="left" runat="server" OnServerValidate="abc"
                        ErrorMessage="To date can not be smaller than from date " Width="255px"></asp:CustomValidator>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateFrom"
        ErrorMessage="From Date Can Not Be Blank" ForeColor="White"></asp:RequiredFieldValidator><br />
