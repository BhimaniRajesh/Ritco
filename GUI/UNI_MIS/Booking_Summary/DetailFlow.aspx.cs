   ...
   // static string strConnection = "data source=202.87.45.72;UID=sa;PWD=ecfy@pra$$ana;Database=ASL_Live;";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           ...
           if (myreppara == "1")
           {
               lblstatus.Text = "Total " + Session["DocketCalledAs"] .ToString()+ " Booked";
           }
           else if (myreppara == "2")
           {
               lblstatus.Text = "Quick " + Session["DocketCalledAs"].ToString();
           }
           else if (myreppara == "3")
           {
               lblstatus.Text = "Operational " + Session["DocketCalledAs"].ToString();
           }
           else if (myreppara == "4")
           {
               lblstatus.Text = "Financial " + Session["DocketCalledAs"].ToString();
           }
    ...
    protected void btn_csv_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment; filename=Booking_Summary_Report.xls");
        DisplayDocFlowDtl();
    }
