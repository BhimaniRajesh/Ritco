            ...
            <table border="1" cellspacing="1" class="boxbg" width="100%">
                <tr class="bgbluegrey">
                    ...
                    <td align="left" style="width: 30%">
                        &nbsp; Location<label id="lblCustCodeColHeader" class="blackfnt">
                            Code
                        </label>
                    </td>
                    <td align="left">
                        &nbsp; Location<label id="lblCustNameColHeader" class="blackfnt">
                            Name
                        </label>
                    </td>
                </tr>
                        ...
                        <tr style="background-color: White">
                            ...
                            <td style="width: 10%">
                                ...
                                <input id="radSelCustomer" runat="server" onclick="SelectCustomer(this)" radiobuttonbackcolor="White"
                                    style="background-color: White" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "locCode")%>' />
                            </td>
                            <td align="left" style="width: 30%">
                        ...
                        <tr style="background-color: White">
                            ...
                            <td style="width: 10%">
                                ...
                                <input id="radSelCustomer" runat="server" onclick="SelectCustomer(this)" radiobuttonbackcolor="#cccccc"
                                    type="radio" value='<%#DataBinder.Eval(Container.DataItem, "locCode")%>' />
