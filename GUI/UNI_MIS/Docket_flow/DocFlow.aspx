...
//            
             ...
             function nwOpen()
        {
            window.open("BillingParty_Popup.aspx?","pbr","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=387,height=220,status=no,left=220,top=70")
        }
...
<table cellspacing="1" style="width: 9.5in;" align="left"   border="0">
    ...
    <td  align="left">  
        <a><font class="blklnkund"><b>Module</b></font></a>
							...
							<b> &gt; </b>
							<font class="bluefnt"><b>  <%=docketis%> Flow Report </b></font>
	</td>
	<td align="right">
                    ...
                    Width="14px"></asp:Label>
                              ...
                              <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                                        <td valign="top" align ="left">
                                                            <asp:Label ID="Label4"  CssClass="blackfnt" Text="Select" runat="server" Width="35px"></asp:Label>    
                               
                                                            <asp:DropDownList ID="ddlbookdt" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                                                <asp:ListItem Value="dockdt">Booking</asp:ListItem>
                                                                <asp:ListItem Value="dely_dt">Delivery</asp:ListItem>
                                                            </asp:DropDownList>
                                                            <asp:Label ID="Label5"  CssClass="blackfnt" Text="Date" runat="server" Width="40px"></asp:Label>    
			  ...
			  <asp:RequiredFieldValidator ID="RFVFromDate" runat="server" ControlToValidate="txtDateFrom"
                            ...
                            <tr bgcolor="#ffffff" style="font-size: 12pt; font-family: Times New Roman">
                                <td align="center" colspan="3" valign="top">
                                    <asp:RadioButtonList ID="radFlow" runat="server"  CssClass="blackfnt" RepeatDirection="Horizontal">
                                        <asp:ListItem Selected="True" Text="<%=docketis%> Booking Flow" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="<%=docketis%> Delivery Flow" Value="1"></asp:ListItem>
