...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
                ...
                window.opener.document.forms[0].ctl00$MyCPH1$txtPartyCode.value = objLocation.value
    ...
    <form id="form1" runat="server">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CUSTCD" HeaderText="Employee Code">
                                ...
                                <asp:BoundField DataField="CUSTnm" HeaderText="Employee Name">
