<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_MIS_ServiceTax_Collected_Query" %>
...
<div id="testdiv1" style="position:absolute;visibility:hidden;background-color:white;z-index:99;"></div>
    ...
    &gt;
    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="Service Tax Collected"></asp:Label>
                    ...
                    <tr align="center">
                        <td>
                            <table cellspacing="1" class="boxbg" style="width: 70%">
                                ...
                                <tr style="background-color: white">
                                    <td align="center" colspan="3">
                                        &nbsp;<asp:RadioButton ID="rbtOutbound" runat="server" CssClass="blackfnt" OnCheckedChanged="rbtOutbound_CheckedChanged" AutoPostBack="true"
                                            Text="For Outbound Dockets " />
                                        &nbsp;
                                        <asp:RadioButton ID="rbtInbound" runat="server" CssClass="blackfnt" OnCheckedChanged="rbtInbound_CheckedChanged" AutoPostBack="true"
                                            Text="For Inbound Dockets" /></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="right" colspan="3">
                                        <asp:Button ID="btnShowServiceTax" runat="server" OnClientClick="return DateCheck()" OnClick="btnShowServiceTax_OnClick" Text="Show Service Tax Summary(s) >>" /></td>
