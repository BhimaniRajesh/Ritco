<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_MIS_Loc_Performance_Query" %>
...
<script language="javascript" type="text/javascript">
    ...
    &gt;
    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="Location Throughput Performance Report"></asp:Label><br />
    <center>
        &nbsp;</center>
    <center>
                    ...
                    <tr align="center">
                        <td>
                            <table cellspacing="1" class="boxbg" style="width: 70%">
                                ...
                                <tr style="background-color: white">
                                    <td align="center" colspan="3">
                                        <asp:RadioButton ID="rbtLoc" runat="server" OnCheckedChanged="rbtLoc_CheckedChanged" AutoPostBack="true"
                                            Text="Booked At This Location " CssClass="blackfnt" />
                                        &nbsp;
                                        <asp:RadioButton ID="rbtNotBook" runat="server" OnCheckedChanged="rbtNotBook_CheckedChanged" AutoPostBack="true"
                                            Text="Not Booked At This Location " CssClass="blackfnt" />&nbsp; &nbsp;<asp:RadioButton ID="rbtBoth" AutoPostBack="true"
                                                runat="server" OnCheckedChanged="rbtBoth_CheckedChanged" Text="Both" CssClass="blackfnt" /></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="right" colspan="3">
                                        <asp:Button ID="btnShowLoc" runat="server" OnClick="btnShowLoc_OnClick" Text="Show Location Summary(s) >>" OnClientClick="return DateCheck()" /></td>
