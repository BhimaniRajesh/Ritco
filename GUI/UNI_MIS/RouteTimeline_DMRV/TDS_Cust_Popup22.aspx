<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TDS_Cust_Popup22.aspx.cs" Inherits="GUI_UNI_MIS_TDS_STMT_TDS_Cust_Popup" %>
            ...
            <table border="1" width="100%" cellspacing="1" class="boxbg">
                <tr class="bgbluegrey">
                    ...
                    <td style="width: 30%" align="left" class="blackfnt">
                        &nbsp;Branch<label id="lblCustCodeColHeader" class="blackfnt"> Code
                        </label>
                    </td>
                    <td align="left" class="blackfnt">
                        &nbsp; Branch<label id="lblCustNameColHeader" class="blackfnt">
                            Name
                        </label>
                    </td>
                </tr>
