...
public partial class GUI_UNI_MIS_Login_View_Login_view : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            strFinalQS = strFinalQS + "&strcontract_type=" + ddlcon_type.SelectedValue.ToString();
            strFinalQS = strFinalQS + "&stract_dact=" + ddlact_dact.SelectedValue.ToString();
            strFinalQS = strFinalQS + "&cust=" + txtcust.Text;




            Response.Redirect("ShowCustomer_Contract_Report.aspx" + strFinalQS);
