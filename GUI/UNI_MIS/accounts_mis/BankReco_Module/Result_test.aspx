<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Result_test.aspx.cs" Inherits="GUI_Finance_Fix_Asset_aaaaa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
  ...
  function On_Check(Grid_Id)
	    ...
	    function On_OneCheck(obj)
	    {   
	             var Check_One="N"
                 var Check_All="Y"
                 
                 var chksrno = document.getElementById(obj);
                 var Txt_ClearDate = document.getElementById(obj.replace( "chksrno", "Txt_ClearDate"));
                 var Hnd_Flag = document.getElementById(obj.replace( "chksrno", "Hnd_Flag")); 
                 var Txt_Comment = document.getElementById(obj.replace( "chksrno", "Txt_Comment")); 
                 var Hnd_Ch_dt = document.getElementById(obj.replace( "chksrno", "Hnd_Ch_dt")); 
                 
                 //alert(obj);
                 //alert(Hnd_Ch_dt.value);
                 //alert(Hnd_Flag.value);
                 
                 if(chksrno.checked)
                 {
                    Check_One="Y"
                    Txt_ClearDate.disabled=false
                    if(Hnd_Flag.value == "N")
                    { 
                        if(Txt_ClearDate.value == "")
                        {
                            Txt_ClearDate.value=Hnd_Ch_dt.value;
                            Txt_Comment.disabled=false;
                        }
                     }
                 }
                 else
                                {
                                    ...
                                    if(Hnd_Flag.value=="N")
                                    {
                                        Txt_ClearDate.disabled=true
                                        Txt_ClearDate.value=""
                                        Txt_Comment.disabled=true
                                    }
                                }
	    }
     ...
     function On_Submit_Inter_fn(Grid_Id)
	    ...
	    function OnSubmit()
	    {
	        ...
	        return false;
	        //On_Submit_Inter_fn('GV_CHQ_Presented')
	        //On_Submit_Inter_fn('GV_CHQ_Cleared')
                                ...
                                <asp:GridView ID="GV_CHQ_Presented" runat="server" CssClass="dgRowStyle" EmptyDataText="No Records Found..."
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Amount">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCredit" Text='<%# DataBinder.Eval(Container.DataItem, "Credit") %>'
                                                    runat="server">                                        </asp:Label>
                                            </ItemTemplate>
                                            <FooterStyle HorizontalAlign="Right" Wrap="false" />
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Clear Date" ItemStyle-Wrap="false">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="Txt_ClearDate" runat="server" Width="70" MaxLength="10" Style="text-align: Left"
                                                    Enabled="false" Text='' onblur="javascript:return ValidateDate(this);" BorderStyle="Groove"
                                        ...
                                        <asp:TemplateField HeaderText="Comment" ItemStyle-Wrap="false">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="Txt_Comment" runat="server" Width="100" MaxLength="200" Style="text-align: Left"
                                                    Enabled="false" Text='' onblur="javascript:this.value=this.value.toUpperCase();"
