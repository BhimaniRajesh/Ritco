...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="JavaScript" type="text/javascript">
	    ...
	    function OnSubmit()
	    {   
	        var HdnIssueGrid = document.getElementById("ctl00_MyCPH1_HdnIssueGrid");
	        var HdnRecvGrid = document.getElementById("ctl00_MyCPH1_HdnRecvGrid");
	        
	        if(HdnIssueGrid.value == "Y")
	        { 
	            if(!On_Submit_Inter_fn('GV_CHQ_Presented'))
                    return false;
	        }
	        if(HdnRecvGrid.value == "Y")
	        { 
                        ...
                        <tr style="background-color: white">
                            <td colspan="2">
                                <font class="bluefnt"><strong>
                                    <asp:Label ID="lbl_Chq_Issued" runat="server" CssClass="blackfnt" Font-Bold="true">
                                    </asp:Label></strong></font>
                            </td>
                        </tr>
                        <tr style="background-color: white">
                            <td colspan="2">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SR.NO.">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="HdnChqdt" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "chqdt1") %>' />                                                
                                        ...
                                        <asp:TemplateField HeaderText="Cheque Date">
                                            ...
                                            <ItemStyle CssClass="blackfnt" Wrap="false" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblChqdate" Text='<%# DataBinder.Eval(Container.DataItem, "CHQDT") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Received from bank">
                                            ...
                                            <ItemStyle CssClass="blackfnt" Wrap="false" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblbank" Text='<%# DataBinder.Eval(Container.DataItem, "banknm") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Deposite Date">
                                            ...
                                            <ItemStyle CssClass="blackfnt" Wrap="false" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbldate" Text='<%# DataBinder.Eval(Container.DataItem, "transdate") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bank Details">
                                            ...
                                            <ItemStyle CssClass="blackfnt" Wrap="false" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblacccode" Text='<%# DataBinder.Eval(Container.DataItem, "accountDetails") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Reconciled Yes/No">
                                            <HeaderStyle HorizontalAlign="Center" Font-Bold="True" CssClass="blackfnt" />
                                            <ItemStyle CssClass="blackfnt" Wrap="false" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblstatus" Text='<%# DataBinder.Eval(Container.DataItem, "Recostatus") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Clear Date" ItemStyle-Wrap="false">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="Txt_ClearDate" runat="server" Width="70" MaxLength="10" Style="text-align: Left"
                                                    Enabled="true" Text='<%# DataBinder.Eval(Container.DataItem, "RecoDate") %>' 
                    ...
                    <table align="center" cellspacing="1" width="100%" class="boxbg" border="0">
                        <tr class="bgbluegrey">
                            <td colspan="4" align="center" style="height: 21px">
                                ...
                                <asp:HiddenField ID="HdnIssueGrid" runat="server" Value="N" />    
                                <asp:HiddenField ID="HdnRecvGrid" runat="server" Value="N" />    
                            </td>
                        </tr>
                    </table>
                </td>
