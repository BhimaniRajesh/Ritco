...
public partial class GUI_Finance_Fix_Asset_aaaaa : System.Web.UI.Page
{
    ...
    {   
        ...
        sql = "exec USP_Bank_Reconsilation_Module_Ver1 '" + Bankcode + "','" + Fromdate + "','" + Todate + "','Credit','" + TranType + "' ";
        ...
        sql = "exec USP_Bank_Reconsilation_Module_Ver1 '" + Bankcode + "','" + Fromdate + "','" + Todate + "','Debit','" + TranType + "' ";
            ...
            foreach (GridViewRow gridrow in GV_CHQ_Presented.Rows)
            {
                ...
                if (chksrno.Checked)
                {
                    if (Txt_ClearDate.Text != "")
                    {
                         ...
                         */
                        Sql = "Update webx_chq_det set chq_clear='Y',chqcleardate='" + fn.Mydate1(Txt_ClearDate.Text.ToString()) + "',Comment='" + Txt_Comment.Text.ToString() + "'  where  Chqno='" + lblChqno.Text + "' and convert(datetime,chqdt,106)=convert(varchar,'" + lblChqdate.Text + "',106) and chqindex='" + Hnd_SRNO.Value.ToString() + "'";
                        cmd = new SqlCommand(Sql, con, trans);
                        cmd.ExecuteNonQuery();
                    }
                }
