    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (redFromTo.Checked == true)
        {
            if (txtDateFrom.CalendarDate != "" && txtDateTo.CalendarDate != "")
            {
                ...
                Response.Redirect("result.aspx?branch=" + branch + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&strdlstSalesAmount=" + strdlstSalesAmount + "&branText=" + branText + "&strSalesAccountText=" + strSalesAccountText + "&TranType=" + strdlstTranType + "&FinYear=" + FinYear, true);
            }
        }
