<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="FrmCriteria.aspx.cs" Inherits="query" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
            ...
            function BranchPopup()
            {
                ...
                winNew = window.open("FrmCCodePopUp.aspx", "_blank", strWinFeature)
            }
    </script>
    ...
    <div align="left" style="width: 10in">
      ...
      <ContentTemplate>--%>
        ...
        <br />
        <br />
        <table border="0" cellpadding="5" cols="1" bgcolor="#808080" cellspacing="1" class="boxbg"
            width="70%">
            <tr class="bgbluegrey">
            ...
            <tr bgcolor="#FFFFFF">
                <td valign="top" style="width: 154px; height: 152px;">
                    <font class="blackfnt">Select Date </font>
                </td>
                <td valign="top" align="left" style="width: 245px; height: 152px;">
                    <asp:UpdatePanel ID="UpdatePanel3"           UpdateMode="Conditional" RenderMode="Inline" runat="server">
                        <ContentTemplate>
                            <asp:RadioButtonList ID="radDate" runat="server" CssClass="blackfnt" AutoPostBack="true"
                ...
                <td valign="top" align="left" colspan="2" style="height: 152px">
                    <asp:UpdatePanel ID="UpdatePanel4" RenderMode="Inline"          UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDateFrom"
                                ErrorMessage="From Date Can Not Remain Blank" Visible="true" ForeColor="white"
                                Height="20px" SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                            ...
                            <%--<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Date differance can not be greater than 1 month"
                                OnServerValidate="daterange" Width="238px"></asp:CustomValidator>--%><br />
                            <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="To Date Cant Be Smaller Than From Date"
                                OnServerValidate="abc" Width="289px"></asp:CustomValidator>&nbsp;<br />
                        </ContentTemplate>
                        <Triggers>
            ...
            <tr>
                ...
                <td colspan="2" bgcolor="#FFFFFF">
                    <div align="center">
                        <font class="blackfnt">&nbsp;To</font></div>
                </td>
            </tr>
            <tr>
                <td bgcolor="#FFFFFF" style="height: 23px; text-align: left; width: 154px;">
                    <font class="blackfnt">Select RO</font></td>
                <td valign="top" bgcolor="#FFFFFF" style="width: 245px; height: 23px" align="left">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="CmbRO" runat="server" AutoPostBack="True" OnSelectedIndexChanged="CmbRO_SelectedIndexChanged">
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadDestWise" EventName="CheckedChanged" />
                        </Triggers>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadLocWise" EventName="CheckedChanged" />
                        </Triggers>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadCustWise" EventName="CheckedChanged" />
                        </Triggers>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadEmpWise" EventName="CheckedChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                </td>
                <td bgcolor="#FFFFFF" style="width: 100px; height: 23px; text-align: left">
                    <font class="blackfnt">Select RO</font></td>
                <td valign="top" bgcolor="#FFFFFF" style="width: 88px; height: 23px;" align="left">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="CmbRO2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="CmbRO2_SelectedIndexChanged">
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadDestWise" EventName="CheckedChanged" />
            ...
            <tr>
                <td bgcolor="#FFFFFF" style="width: 154px; text-align: left;">
                    <font class="blackfnt">Select Location</font></td>
                <td valign="top" bgcolor="#FFFFFF" style="width: 245px" align="left">
                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="CmbLoc" runat="server">
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadDestWise" EventName="CheckedChanged" />
                ...
                <td bgcolor="#FFFFFF" style="width: 100px; text-align: left;">
                    <font class="blackfnt">Select Location</font></td>
                <td valign="top" bgcolor="#FFFFFF" style="width: 88px" align="left">
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="CmbLoc2" runat="server" Width="98px">
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadDestWise" EventName="CheckedChanged" />
        ...
        <table border="0" cellpadding="5" cols="1" bgcolor="#808080" cellspacing="1" class="boxbg"
            ...
            <tr bgcolor="#FFFFFF">
                <td style="width: 105px; text-align: left;">
                    <font class="blackfnt">PayBasis</font></td>
                <td valign="top" style="width: 238px" align="left">
                    <asp:UpdatePanel ID="UpdatePanel6"     UpdateMode="Conditional" RenderMode="Inline" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="CmbPayBasis" runat="server" Width="161px">
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadPayBas" EventName="CheckedChanged" />
                        </Triggers>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadMode" EventName="CheckedChanged" />
                        </Triggers>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadDestWise" EventName="CheckedChanged" />
                        </Triggers>
                ...
                <td style="width: 227px; text-align: left;">
                    <font class="blackfnt">Select Mode</font></td>
                <td valign="top">
                    <asp:UpdatePanel ID="UpdatePanel7"    UpdateMode="Conditional" RenderMode="Inline" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="CmbMode" runat="server" Width="159px">
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadPayBas" EventName="CheckedChanged" />
            ...
            <tr bgcolor="#FFFFFF">
                <td align="center" colspan="4" class="blackfnt">
                    <asp:UpdatePanel ID="UpdatePanel10"   UpdateMode="Conditional" RenderMode="Inline" runat="server">
                        <ContentTemplate>
                            <asp:RadioButton ID="RadPayBas" runat="server" GroupName="Group" Text="PayBase Wise"
                                OnCheckedChanged="RadPayBas_CheckedChanged" AutoPostBack="True" />
                            <asp:RadioButton ID="RadMode" runat="server" GroupName="Group" Text="Mode Wise" OnCheckedChanged="RadMode_CheckedChanged"
                                AutoPostBack="True" />
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="RadDestWise" EventName="CheckedChanged" />
            ...
            <tr bgcolor="#FFFFFF">
                <td style="width: 105px">
                    <font class="blackfnt">Enter Customer Code</font></td>
                <td colspan="3" valign="top" style="text-align: left">
                    <asp:TextBox ID="TextBox1" runat="server" Width="96px"></asp:TextBox>
                    <%--<asp:Button ID="BtnCustCode" runat="server" Width="39px" OnClick="JavaScript:BranchPopup()" />--%>
                    <input type="button" id="BtnCustCode" runat="server" onclick="JavaScript:BranchPopup()" />
                    <%--OnClick="BranchPopup()"--%>
                </td>
            </tr>
            <tr width="70%" align="center" bgcolor="#FFFFFF">
                <td colspan="4" class="blackfnt">
                    <div align="center">
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>
                                <asp:RadioButton ID="RadDestWise" Visible="false" runat="server" GroupName="RadGroup"
                                    Text="DestinationWise" OnCheckedChanged="RadDestWise_CheckedChanged" AutoPostBack="True" />
                                <%--<Triggers><asp:AsyncPostBackTrigger ControlID="RadDestWise" EventName="CheckedChanged"/></Triggers> --%>
                                <asp:RadioButton ID="RadLocWise" runat="server" GroupName="RadGroup" Text="Location Wise"
                                    OnCheckedChanged="RadLocWise_CheckedChanged" AutoPostBack="True" />
                                <asp:RadioButton ID="RadCustWise" runat="server" GroupName="RadGroup" Text="Customer Wise"
                                    OnCheckedChanged="RadCustWise_CheckedChanged" AutoPostBack="True" />
                                <asp:RadioButton ID="RadEmpWise" Visible="false" runat="server" GroupName="RadGroup"
                                    Text="Employee Wise" AutoPostBack="True" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                </td>
    ...
    <div style="width: 7in" align="center">
        <asp:Button align="center" ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click" /></div>
    <br />
