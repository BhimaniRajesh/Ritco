<table id="tbl_dkt" visible="false" class="boxbg" runat="server" style="width: 8.5in"
...
<table id="tbl_thc" visible="false" class="boxbg" runat="server" style="width: 8.5in"
    border="0" align="left" cellpadding="1" cellspacing="1">
    <tr style="background-color: white">
        <td align="left" width="400">
...
<table id="tbl_prs" visible="false" class="boxbg" runat="server" style="width: 8.5in"
    border="0" align="left" cellpadding="1" cellspacing="1">
