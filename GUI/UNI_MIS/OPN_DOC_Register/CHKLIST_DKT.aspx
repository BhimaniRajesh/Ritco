<table id="tbl_CHKdkt" visible="false" class="boxbg" runat="server" style="width: 8.5in"
        ...
        <td align="left" width="400">
            <asp:checkboxlist id="CheckBoxList1" runat="server" cssclass="blackfnt" repeatdirection="Horizontal"
                repeatcolumns="4" textalign="right" width="750px" cellpadding="2" cellspacing="2">
                                ...
                                <asp:ListItem Value="dockdt" Text="Docket Date"></asp:ListItem>
...
<table id="tbl_thcchk" runat="server" align="left" border="0" cellpadding="1" cellspacing="1"
    class="boxbg" style="width: 8.5in" visible="false">
    <tr class="bgbluegrey">
        <td align="left" valign="top">
...
<table id="tbl_PRSchk" visible="false" class="boxbg" runat="server" style="width: 8.5in"
    border="0" align="left" cellpadding="1" cellspacing="1">
    <tr class="bgbluegrey">
        <td align="left" valign="top">
...
<table id="tbl_DRSchk" visible="false" class="boxbg" runat="server" style="width: 8.5in"
    border="0" align="left" cellpadding="1" cellspacing="1">
    <tr class="bgbluegrey">
        <td align="left" valign="top">
