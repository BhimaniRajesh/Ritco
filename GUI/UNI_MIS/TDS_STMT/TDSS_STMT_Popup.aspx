<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TDSS_STMT_Popup.aspx.cs" Inherits="GUI_UNI_MIS_TDS_STMT_TDSS_STMT_Popup" %>
                ...
                <tr>
                    <td align="left" style="height: 32px">
                        ...
                        <label id="lblNote" class="blackfnt">
                            - For All Vendor list,keep blank both the input box.
                        </label>
                    </td>
                </tr>
            </table>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                ...
                                <input id="radSelBranch" type="radio" value="<%#DataBinder.Eval(Container.DataItem, "CustCode")%>" onclick="Done(this);"  />
