<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="Bill_Sum_Cust_Rpt.aspx.cs" Inherits="GUI_UNI_MIS_Bill_Summary_Bill_Sum_Cust_Rpt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <table border="1" style="width: 98%; background-color: #808080" align="center" cellspacing="0"
        id="Bill_Summary" runat="server" cellpadding="1" class="boxbg">
        <tr>
            <td>
                <tr class="bgbluegrey">
                    <td rowspan="2">
                    ...
                    <td rowspan="2" align="center">
                        <label class="blackfnt">
                            CustCode.CustName</label></td>
                    <td colspan="2" align="center">
                        <label class="blackfnt">
                            Bill Generated&nbsp;</label></td>
                    <td colspan="2" align="center">
                        <label class="blackfnt">
                            Submitted-Due</label></td>
                    <td colspan="2" align="center">
                        <label class="blackfnt">
                            Submitted-Not Due</label><label class="blackfnt"></label></td>
                    <td colspan="2" align="center">
                        <label class="blackfnt">
                            Un-submitted Due</label><label class="blackfnt"></label></td>
                    <td style="height: 25px;" colspan="2" align="center">
                        <label class="blackfnt">
                            Un-submitted Not due
                        </label>
                    </td>
                    <td colspan="2" style="height: 25px">
                        <label class="blackfnt">
                            Collected</label><label class="blackfnt"></label></td>
                </tr>
                <tr class="bgbluegrey">
                    <td style="width: 7%; height: 25px" class="blackfnt" align="center">
                        No</td>
                    <td style="width: 7%; height: 25px" class="blackfnt" align="center">
                        Amount</td>
                    <td style="width: 7%; height: 25px" class="blackfnt" align="center">
                ...
                <asp:Repeater ID="rptBillDetails" runat="server">
                    <ItemTemplate>
                        <tr style="background-color: White">
                            ...
                            <td>
                                <center>
                                    <asp:HyperLink runat="server" Font-Underline="True" ForeColor="#003333" NavigateUrl='<%#"Bil_Summ_SubRpt.aspx?Code="+ "ALL" + "&LocCode="+ DataBinder.Eval(Container.DataItem, "loccodeforURL") + "&BillTyped=" + "Billsubmited" + "&Ro=" + Request.QueryString["Ro"].ToString() + "&Loc=" + Request.QueryString["Loc"].ToString() + "&Sub=" + Request.QueryString["SubLoc"].ToString() + "&CollLoc=" + Request.QueryString["ColLoc"].ToString() +"&CustCode=" + Request.QueryString["Cust"].ToString() +"&BillType=" +Request.QueryString["BillType"].ToString()+ "&BillAmt=" +Request.QueryString["BillAmt"].ToString()+ "&List=" + Request.QueryString["CustWise"].ToString() +"&RDate=" + Request.QueryString["RptDate"].ToString()+ "&dateFrom=" + Request.QueryString["dateFrom"].ToString() + "&dateTo=" + Request.QueryString["dateTo"].ToString()%>'
                                        Text='<%#DataBinder.Eval(Container.DataItem, "Sub_No")%>' ID="Hyperlink2" Visible='<%#DataBinder.Eval(Container.DataItem, "LinkVisible1")%>' />
                                    <label class="blackfnt" id="Label2" runat="server" visible='<%#DataBinder.Eval(Container.DataItem, "LabelVisible1")%>'>
                            ...
                            <td>
                                <center>
                                    <asp:HyperLink runat="server" Font-Underline="True" ForeColor="#003333" NavigateUrl='<%#"Bil_Summ_SubRpt.aspx?Code="+ "ALL" + "&LocCode="+ DataBinder.Eval(Container.DataItem, "loccodeforURL") + "&BillTyped=" + "Billsubmited_Not_Due" + "&Ro=" + Request.QueryString["Ro"].ToString() + "&Loc=" + Request.QueryString["Loc"].ToString() + "&Sub=" + Request.QueryString["SubLoc"].ToString() + "&CollLoc=" + Request.QueryString["ColLoc"].ToString() +"&CustCode=" + Request.QueryString["Cust"].ToString() +"&BillType=" +Request.QueryString["BillType"].ToString()+ "&BillAmt=" +Request.QueryString["BillAmt"].ToString()+ "&List=" + Request.QueryString["CustWise"].ToString() +"&RDate=" + Request.QueryString["RptDate"].ToString()+ "&dateFrom=" + Request.QueryString["dateFrom"].ToString() + "&dateTo=" + Request.QueryString["dateTo"].ToString()%>'
                                        Text='<%#DataBinder.Eval(Container.DataItem, "Sub_Due_No")%>' ID="Hyperlink3"
                                        Visible='<%#DataBinder.Eval(Container.DataItem, "LinkVisible2")%>' />
                                    <label class="blackfnt" id="Label3" runat="server" visible='<%#DataBinder.Eval(Container.DataItem, "LabelVisible2")%>'>
                            ...
                            <td>
                                <center>
                                    <asp:HyperLink runat="server" Font-Underline="True" ForeColor="#003333" NavigateUrl='<%#"Bil_Summ_SubRpt.aspx?Code="+ "ALL" + "&LocCode="+ DataBinder.Eval(Container.DataItem, "loccodeforURL") + "&BillTyped=" + "Billunsubmited" + "&Ro=" + Request.QueryString["Ro"].ToString() + "&Loc=" + Request.QueryString["Loc"].ToString() + "&Sub=" + Request.QueryString["SubLoc"].ToString() + "&CollLoc=" + Request.QueryString["ColLoc"].ToString() +"&CustCode=" + Request.QueryString["Cust"].ToString() +"&BillType=" +Request.QueryString["BillType"].ToString()+ "&BillAmt=" +Request.QueryString["BillAmt"].ToString()+ "&List=" + Request.QueryString["CustWise"].ToString() +"&RDate=" + Request.QueryString["RptDate"].ToString()+ "&dateFrom=" + Request.QueryString["dateFrom"].ToString() + "&dateTo=" + Request.QueryString["dateTo"].ToString()%>'
                                        Text='<%#DataBinder.Eval(Container.DataItem, "UnSub_No")%>' ID="Hyperlink4" Visible='<%#DataBinder.Eval(Container.DataItem, "LinkVisible3")%>' />
                                    <label class="blackfnt" id="Label4" runat="server" visible='<%#DataBinder.Eval(Container.DataItem, "LabelVisible3")%>'>
                            ...
                            <td>
                                <center>
                                    <asp:HyperLink runat="server" Font-Underline="True" ForeColor="#003333" NavigateUrl='<%#"Bil_Summ_SubRpt.aspx?Code="+ "ALL" + "&LocCode="+ DataBinder.Eval(Container.DataItem, "loccodeforURL") + "&BillTyped=" + "Billunsubmited_Not_Due" + "&Ro=" + Request.QueryString["Ro"].ToString() + "&Loc=" + Request.QueryString["Loc"].ToString() + "&Sub=" + Request.QueryString["SubLoc"].ToString() + "&CollLoc=" + Request.QueryString["ColLoc"].ToString() +"&CustCode=" + Request.QueryString["Cust"].ToString() +"&BillType=" +Request.QueryString["BillType"].ToString()+ "&BillAmt=" +Request.QueryString["BillAmt"].ToString()+ "&List=" + Request.QueryString["CustWise"].ToString() +"&RDate=" + Request.QueryString["RptDate"].ToString()+ "&dateFrom=" + Request.QueryString["dateFrom"].ToString() + "&dateTo=" + Request.QueryString["dateTo"].ToString()%>'
                            ...
                            <td>
                                <center>
                                    <asp:HyperLink runat="server" Font-Underline="True" ForeColor="#003333" NavigateUrl='<%#"Bil_Summ_SubRpt.aspx?Code="+ "ALL" + "&LocCode="+ DataBinder.Eval(Container.DataItem, "loccodeforURL") + "&BillTyped=" + "Collected" + "&Ro=" + Request.QueryString["Ro"].ToString() + "&Loc=" + Request.QueryString["Loc"].ToString() + "&Sub=" + Request.QueryString["SubLoc"].ToString() + "&CollLoc=" + Request.QueryString["ColLoc"].ToString() +"&CustCode=" + Request.QueryString["Cust"].ToString() +"&BillType=" +Request.QueryString["BillType"].ToString()+ "&BillAmt=" +Request.QueryString["BillAmt"].ToString()+ "&List=" + Request.QueryString["CustWise"].ToString() +"&RDate=" + Request.QueryString["RptDate"].ToString()+ "&dateFrom=" + Request.QueryString["dateFrom"].ToString() + "&dateTo=" + Request.QueryString["dateTo"].ToString()%>'
                                        Text='<%#DataBinder.Eval(Container.DataItem, "Coll_No")%>' ID="Hyperlink1" Visible='<%#DataBinder.Eval(Container.DataItem, "LinkVisible5")%>' />
                                    <label class="blackfnt" id="Label6" runat="server" visible='<%#DataBinder.Eval(Container.DataItem, "LabelVisible5")%>'>
