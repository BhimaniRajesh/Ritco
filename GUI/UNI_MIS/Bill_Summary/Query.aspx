<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_MR_Billing_Query" %>
...
<script language="javascript" type="text/javascript">
    ...
    &gt;
    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="Bill Report"></asp:Label>&nbsp;
    <center>
        &nbsp;</center>
    <center>
                            ...
                            <table cellspacing="1" class="boxbg" style="width: 70%">
                                <tr class="bgbluegrey">
                                    <td align="center" colspan="3">
                                        <asp:Label ID="lblQry" runat="server" CssClass="blackfnt" Font-Bold="True">Search Bill Criteria</asp:Label>
                                    </td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblDateRange1" runat="server" CssClass="blackfnt" Font-Bold="True"
                                            Width="162px">Created in Date Range:</asp:Label>
                                    </td>
                                ...
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblSelRO" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Select RO"></asp:Label>
                                    </td>
                                ...
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblSelLoc" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Select Location"></asp:Label>
                                    </td>
                                    <td align="left" colspan="2">
                                ...
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblSubLoc" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Submission Location"></asp:Label></td>
                                    <td align="left" colspan="2">
                                        &nbsp;<asp:TextBox ID="txtSubLoc" runat="server" Width="87px"></asp:TextBox>                                        
                                        <input id="btnSubLoc" type="button" name="..." runat="server"/></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblColLoc" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Collection Location"></asp:Label></td>
                                    <td align="left" colspan="2">
                                        &nbsp;<asp:TextBox ID="txtColLoc" runat="server" Width="87px"></asp:TextBox>
                                        <input id="btnColLoc" type="button" name="..." runat="server"/>
                                        </td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblCust" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Customer"></asp:Label></td>
                                    <td align="left" colspan="2">
                                        &nbsp;<asp:TextBox ID="txtCust" runat="server" Width="87px"></asp:TextBox>
                                        <input id="btnCust" type="button" name="..." runat="server"/>
                                        </td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left" style="height: 21px">
                                        &nbsp;<asp:Label ID="lblBill" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Bill Type"></asp:Label></td>
                                    <td align="left" colspan="2" style="height: 21px">
                                        &nbsp;<asp:DropDownList ID="cboBill" runat="server">
                                            <asp:ListItem>TBB</asp:ListItem>
                                            <asp:ListItem>TPCP</asp:ListItem>
                                            <asp:ListItem>Both</asp:ListItem>
                                        </asp:DropDownList></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblBillAmt" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Bill Amount "></asp:Label></td>
                                    <td align="left" colspan="2">
                                        &nbsp;<asp:TextBox ID="txtBillAmt" runat="server"></asp:TextBox></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblList" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Listing"></asp:Label></td>
                                    <td align="left" colspan="2">
                                        &nbsp;<asp:RadioButton ID="rbCust" runat="server" CssClass="blackfnt" Text="Customer wise " AutoPostBack="true" OnCheckedChanged="rbCust_CheckedChanged" />
                                        <asp:RadioButton ID="rbLoc" runat="server" CssClass="blackfnt" Text="Location wise" AutoPostBack="true" OnCheckedChanged="rbLoc_CheckedChanged" /></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        &nbsp;<asp:Label ID="lblRDate" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Report Date"></asp:Label></td>
                                    <td align="left" colspan="2">
                                        &nbsp;<asp:Label ID="lblDate" runat="server" CssClass="blackfnt"></asp:Label></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="right" colspan="3">
                                        <asp:Button ID="btnShowBill" runat="server" OnClick="btnShowBill_OnClick" Text="Show BIll Summary(s) >>" OnClientClick="return DateCheck()" /></td>
