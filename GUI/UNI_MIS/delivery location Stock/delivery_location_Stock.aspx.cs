...
public partial class GUI_UNI_MIS_Login_View_Login_view : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            Session["dt"] = strDate;
            Session["strro"] = ddlro.SelectedValue.ToString();
            ...
            {
                Response.Redirect("Show_Delivery_Summary_Location_stock.aspx" + strFinalQS);
            }
            else
            {
                Response.Redirect("Show_Delivery_Detail_Location_stock.aspx" + strFinalQS);
            }
