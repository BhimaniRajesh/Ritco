...
public partial class GUI_UNI_MIS_Login_View_Login_view : System.Web.UI.Page
{
    ...
    public void popRO()
    {
        ...
        string sql = "select top 1 '-- All --' as c1,'All' as c2 from webx_location  union select loccode+' : '+locname c1,loccode from webx_location where (report_loc='HQTR' and report_loc<>loccode ) or loc_level=(select loc_level from webx_location where loc_level='1' ) order by c1";
    ...
    public void popLOC()
    {
        ...
        //string sql = "select top 1 '-- All --' as c1,'All' as loccode from webx_location union select loccode+' : '+locname c1,loccode from webx_location where report_loc= 'HQTR' and report_loc<>loccode order by c1";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            strFinalQS = strFinalQS + "&strloc2=" + ddlloc2.SelectedValue.ToString();
