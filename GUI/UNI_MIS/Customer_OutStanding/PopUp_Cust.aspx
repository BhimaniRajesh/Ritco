   ...
   <script language="javascript">
    ...
    function Child(obj)
    {
	   ...
	   //alert(obj.value)
	    ...
	    if(ID=='C')
	    {
	     cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtPartyCode.value;
	    }
	    else if(ID=='V')
	    {
	    ...
	    {
	    cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtstartBranch.value;
	    }
	    else if(ID=='L1')
	    {
	    cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtEndBranch.value;
	    }
	    else if(ID=='L2')
	    {
	    cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtEnrouteBranch.value;
	    }
	   ...
	   // alert(ID)
	    ...
	    if(cust_str=="")
	    {
	         if(ID=='C')
	         {
	             window.opener.document.aspnetForm.ctl00$MyCPH1$txtPartyCode.value=Str;
	         }
	         else if(ID=='V')
	        {
	        //cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtVendor.value;
	       ...
	       // cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtAccount.value;
	        ...
	        {
	       // cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtAccount.value;
	        window.opener.document.aspnetForm.ctl00$MyCPH1$txtstartBranch.value=Str;
	        }
	        else if(ID=='L1')
	        {
	       // cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtAccount.value;
	        window.opener.document.aspnetForm.ctl00$MyCPH1$txtEndBranch.value=Str;
	        }
	        else if(ID=='L2')
	        {
	       // cust_str=window.opener.document.aspnetForm.ctl00$MyCPH1$txtAccount.value;
	        window.opener.document.aspnetForm.ctl00$MyCPH1$txtEnrouteBranch.value=Str;
	        }
	    ...
	    else 
	    {
	        if(ID=='C')
	         {
                 window.opener.document.aspnetForm.ctl00$MyCPH1$txtPartyCode.value=Str;
			   //window.opener.document.aspnetForm.ctl00$MyCPH1$txtPartyCode.value=cust_str+','+Str;
	         }
	         else if(ID=='V')
	        {
	      ...
	      window.opener.document.aspnetForm.ctl00$MyCPH1$txtBank.value=cust_str+','+Str;
	        ...
	        {
	      window.opener.document.aspnetForm.ctl00$MyCPH1$txtstartBranch.value=cust_str+','+Str;
	       
	        }
	        else if(ID=='L1')
	        {
	      window.opener.document.aspnetForm.ctl00$MyCPH1$txtEndBranch.value=cust_str+','+Str;
	       
	        }
	        else if(ID=='L2')
	        {
	      window.opener.document.aspnetForm.ctl00$MyCPH1$txtEnrouteBranch.value=cust_str+','+Str;
...
<table border=0 style="width: 8.5in;" align="left" cellspacing=1 cellpadding=0>
    <tr>
        <td><asp:HiddenField ID="QID" runat="server"  />
            <table border="0" style="width: 5.5in;" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr class="bgbluegrey">
            ...
            <asp:DataList ID="DataList1" runat="server" width="90%">                
                <ItemTemplate>
                    <table id="tbl1" style="width: 5.5in;" border="0" runat="server" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr id="tr1" runat="server">
                            <td id="td1" runat="server" width="10%" bgcolor="white" align="left">&nbsp;

                                <input type=checkbox id="chk" runat="server" onclick="javascript:return Child(this);" value='<%# DataBinder.Eval(Container.DataItem,"CUSTCD") %>' />
