<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TDS_Cust_Popup12.aspx.cs" Inherits="GUI_UNI_MIS_TDS_STMT_TDS_Cust_Popup" %>
        ...
        <form id="frmCustomerList" runat="server">
            ...
            <table border="1" width="100%" cellspacing="1" class="boxbg">
                <tr class="bgbluegrey">
                    ...
                    <td style="width: 30%" align="left" class="blackfnt">
                        &nbsp;Customer<label id="lblCustCodeColHeader" class="blackfnt"> Code
                        </label>
                    </td>
                    <td align="left" class="blackfnt">
                        &nbsp; Customer<label id="lblCustNameColHeader" class="blackfnt">
                            Name
                        </label>
                    </td>
                </tr>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                ...
                                <input id="radSelBranch" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "CustCode")%>' onclick="SelectCustomer(this);" runat="server" />
