<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query_CBS.aspx.cs" Inherits="GUI_UNI_MIS_Account_Reports_TRIALBALANCE_PARTYWISE_Query_trailBalne_party"  Title="Untitled Page" %>
...
return true
        ...
        <%-- <asp:HyperLink ID="HyperLink1" runat="server">
           ...
           <br />      
        <table id="Table3"  runat="server"  cellpadding="3"  cellspacing="1" style="width:9.5in;" >
      <tr><td></td></tr>
      <tr style="background-color: #FFFFFF"><td class="blackfnt" style="height: 12px"><font class="blackboldfnt">Reports</font> > <a href="../../rpt_finance.aspx"><font class="blklnkund">Finace & Accounts </font></a>></font><font class="bluefnt"> Cash & Bank Flow  </font></td></tr>  
       <tr> 
        ...
        <br />         
            ...
            <table align="center" cellspacing="1" style="width: 9.5in%; height: 263px;" border="0">
                <tr align="center">
 ...
 <tr class="bgbluegrey">
                    ...
                    <tr style="background-color: white">
                                ...
                                <td  colspan="4" align="center" valign="top" style="height: 25px; width: 395px;">
