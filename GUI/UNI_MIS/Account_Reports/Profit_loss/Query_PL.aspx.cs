...
public partial class GUI_UNI_MIS_Account_Reports_TRIALBALANCE_PARTYWISE_Query_trailBalne_party : System.Web.UI.Page
{
    ...
    public static string RPT_flag, strFinalQS = "", YearString, yearSuffix, finyearstart, brcd;
   ...
   protected void Page_Load(object sender, EventArgs e)
    ...
    //    if (loclevel <= 2)
    //    {
    //        sqlstr = "select 'All' as loccode,'All'  as locname  union select loccode,loccode + ' : '+ locname from webx_location where report_loc='" + ddlro.SelectedValue.ToString() + "' or loccode='" + ddlro.SelectedValue.ToString() + "'";
    //    }
    //    else
    //    {
    ...
    protected void btnShow_Click1(object sender, EventArgs e)
    {
         ...
         if (radFlow.SelectedValue.ToString() == "0")
         {
             Response.Redirect("Cumulative_Result_PL.aspx" + strFinalQS);
         }
         else
         {
             Response.Redirect("Cumulative_Result_PL.aspx" + strFinalQS);
