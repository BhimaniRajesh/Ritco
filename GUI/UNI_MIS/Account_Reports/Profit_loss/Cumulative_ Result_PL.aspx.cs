            ...
            for (int Acc_l_i = 0; Acc_l_i < Str_all_lococde_arr.Length; Acc_l_i++)
            {
                ...
                //{
                    ...
                    if (String_loccode_ACC_INC[Acc_i] == "totinc" || Str_all_lococde_arr[Acc_l_i] == "All" || Convert.ToString(Amt_Bal) == "0" || SubGrp == "Y")
                    {
                        ...
                        if (SubGrp == "Y")
                        {
                            popstr1 = "branText=" + Str_all_lococde_arr[Acc_l_i] + " : " + Str_all_lococde_arr[Acc_l_i] + "&branch=" + Str_all_lococde_arr[Acc_l_i] + "&strdlstSalesAmount=" + String_loccode_ACC_INC[Acc_i] + "&dateFrom=" + a_frmdt + "&dateTo=" + a_todt + "&strdlstTranType=" + rpt_typ;
...
string SubGrp_EXP = "";
                ...
                TableCell tc41E = new TableCell();
                    ...
                    if (String_loccode_ACC_EXP[AccE_i] == "totexp" || Str_all_lococde_arrE[Acc_l_iE] == "All" || Convert.ToString(Amt_BalE) == "0" || SubGrp_EXP == "Y")
                    {
                        ...
                        if (SubGrp_EXP == "Y")
                        {
                            ...
                            popstr = "branText=" + Str_all_lococde_arrE[Acc_l_iE] + " : " + Str_all_lococde_arrE[Acc_l_iE] + "&branch=" + Str_all_lococde_arrE[Acc_l_iE] + "&strdlstSalesAmount=" + String_loccode_ACC_EXP[AccE_i] + "&dateFrom=" + a_frmdt + "&dateTo=" + a_todt + "&strdlstTranType=" + rpt_typ;
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        string chkstate = Request.QueryString["chkstate"].ToString();
