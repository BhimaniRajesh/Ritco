...
public partial class GUI_UNI_MIS_Account_Reports_TRIALBALANCE_PARTYWISE_Query_trailBalne_party : System.Web.UI.Page
{
    ...
    public static string RPT_flag,YearString,yearSuffix,finyearstart, strFinalQS="";
   protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //yrstartdt = Convert.ToDateTime(Session["FinYearStart"].ToString());
    ...
    public void abcd_txt()
    {
       ...
       // string strcust = txtPartyCode.Text;
        ...
        string strrpttype = RptOpt.SelectedValue.ToString();
        ...
        strFinalQS = strFinalQS + "&Reporttype=" + strrpttype;
