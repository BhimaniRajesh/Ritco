<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query_trailBalne_party.aspx.cs" Inherits="GUI_UNI_MIS_Account_Reports_TRIALBALANCE_PARTYWISE_Query_trailBalne_party"  Title="Untitled Page" %>
...
var cal = new CalendarPopup("testdiv1"); 
   ...
   <%-- 
     <link id="Link1" href="~/images/style.css" rel="Stylesheet" 
			...
			function Submitdata1(ddlro,txtDateFrom,txtDateTo,DDVendor,btnShow)
            {
                    // alert("HI11")
					branch=ddlro.value;
					if(branch=="")
			...
			function Submitdata2(ddlro,txtDateFrom,txtDateTo,DDVendor,btnShow)
            {
                    // alert("HI11")
					branch=ddlro.value;
					if(branch=="")
            ...
            <table cellspacing="1" style="width: 9.5in; height: 263px;" border="0">
                    ...
                    <td style="height: 324px" align="center" colspan="3">
                        <table cellspacing="1" style="width: 90%" class="boxbg" border="0"> 
                            ...
                            <tr  style="font-size: 12pt; font-family: Times New Roman;background-color: white">
                                ...
                                <td align="left"  style="width: 395px"><asp:UpdatePanel ID="up3" runat="server">
                                                            <ContentTemplate>
                             ...
                             <tr class="bgbluegrey">
                              ...
                              <tr  style="font-size: 12pt; font-family: Times New Roman;background-color: white">
                                                        <td valign="top"   class="blackfnt"  align ="left">
                                                            Select  Date</td>
                                                        <td   style="font-size: 12pt; font-family: Times New Roman; width: 395px;" align="left" valign="top">
			   ...
			   NAME="anchor2"  id="a1"><img src="../../../images/calendar.jpg" border="0"></img>
                            ...
                            <tr style="background-color: white">
                                ...
                                <td align="left"   style="width: 5px; height: 25px" valign="top">
                              
                                    <asp:Label ID="Label3"  CssClass="blackfnt" Text="Enter Customer Code :" runat="server" Width="164px"></asp:Label>
                                </td>
                                
                                <td align="left" colspan="2" valign="top" style="height: 25px; width: 395px;">
                                   <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                            <ContentTemplate> <asp:TextBox Width="80"   ID="txtPartyCode" runat="server" CssClass="input" MaxLength="15">
                                    </asp:TextBox>
                                    <input  id="btnBranchPopup" runat="server" onclick="BranchPopup('../../POPUPS/BillingParty_Popup.aspx?13')"                                  type="button"  value="..." /></ContentTemplate>
                    ...
                    <td colspan="4" align="center" style="height: 32px">
                         <asp:Label ID="Label1"   CssClass="blackfnt" Text="OR"  runat="server" Width="164px"></asp:Label>
                    ...
                    <tr style="background-color: white">
                                ...
                                <td align="left"   style="width: 5px; height: 25px" valign="top">
                                    ...
                                    <asp:Label ID="Label5"  CssClass="blackfnt" Text="Enter Vemdor Code :" runat="server" Width="164px"></asp:Label>
                                </td>
                                ...
                                <td align="left" colspan="2"  valign="top" style="height: 25px; width: 395px;">
                                   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                     ...
                                     </asp:DropDownList> <asp:TextBox   ID="txtVendor" runat="server" Width="80"  CssClass="input" MaxLength="15">
                                    </asp:TextBox>
                                    
                                    <input  id="Button1" runat="server" onclick="BranchPopup('../../POPUPS/BillingParty_Popup.aspx?13')"
                                        type="button"  value="..." /></ContentTemplate>
                                     </asp:UpdatePanel><%--<asp:Button ID="btnBilledAt" runat="server" Text="..." onclick="BranchPopup(this)" PopupURL="../popup-branch.asp?7,A,A" />--%>
                                </td>
                                <td  align="center" style="height: 32px">
                        <asp:Button ID="btnShow2" runat="server" Text="Show" Width="75px" OnClick="btnShow_Click2"  />
                ...
                <tr style="background-color: white">
                    <td colspan="4" align="center" style="height: 32px">
                         <asp:Label ID="Label2"   CssClass="blackfnt" Text="OR"  runat="server" Width="164px"></asp:Label>
                     ...
                     <tr style="background-color: white">
                                ...
                                <td align="left"   style="width: 5px; height: 25px" valign="top">
                                    ...
                                    <asp:Label ID="Label7"  CssClass="blackfnt" Text="Enter Employee Code :" runat="server" Width="164px"></asp:Label>
                                </td>
                                
                                <td align="left" colspan="2"  valign="top" style="height: 25px; width: 395px;">
                                   <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                            <ContentTemplate>
                                                             <asp:DropDownList ID="DDEmployeeAcc" runat="server" AutoPostBack="True" >
                                        <asp:ListItem Text="-- Select --" Value=""></asp:ListItem>
                                     </asp:DropDownList> <asp:TextBox   ID="txtEmployee" runat="server" Width="80"  CssClass="input" MaxLength="15">
                                    </asp:TextBox>
                                    
                                    <input  id="Button3" runat="server" onclick="BranchPopup('../../POPUPS/BillingParty_Popup.aspx?13')"
                                        type="button"  value="..." /></ContentTemplate>
                                     </asp:UpdatePanel><%--<asp:Button ID="btnBilledAt" runat="server" Text="..." onclick="BranchPopup(this)" PopupURL="../popup-branch.asp?7,A,A" />--%>
                                </td>
                                <td  align="center" style="height: 32px">
                        <asp:Button ID="btnShow3" runat="server" Text="Show" Width="75px" OnClick="btnShow_Click3"  />
