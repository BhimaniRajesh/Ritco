<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query_TB_ACC.aspx.cs" Inherits="GUI_UNI_MIS_Account_Reports_TRIALBALANCE_PARTYWISE_Query_trailBalne_party"  Title="Untitled Page" %>
...
var cal = new CalendarPopup("testdiv1"); 
   ...
   <%-- 
     <link id="Link1" href="~/images/style.css" rel="Stylesheet" 
            ...
            function Submitdata(ddlro,txtDateFrom,txtDateTo,DDAccounts,btnShow)
            {
                    // alert("HI11")
					branch=ddlro.value;
					if(branch=="")
...
return true
      ...
      <tr><td></td></tr>
      <tr style="background-color: #FFFFFF"><td class="blackfnt" style="height: 12px"><font class="blackboldfnt">Reports</font> > <a href="../../rpt_finance.aspx"><font class="blklnkund">Finace & Accounts </font></a>></font><font class="bluefnt"> Trial Balance Accountwise   </font></td></tr>  
       <tr> 
 ...
 <tr class="bgbluegrey">
                ...
                <tr style="background-color: white">
                    <td colspan="4" align="center" style="height: 32px">
                        <asp:Button ID="btnShow3" runat="server" Text="Show" Width="75px" OnClick="btnShow_Click1"  />
