<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillNo_Popup.aspx.cs" Inherits="GUI_UNI_MIS_Bill_Register_BillNo_Popup" %>
...
<body>
    ...
    <img ID="imgLogo" src="../../../images/webxpress_logo.gif" runat="server" />
     ...
     <table id="TABLE2" border="1" cellpadding="1" cellspacing="1" language="javascript"
        ...
        <table id="TABLE1" border="1" cellpadding="1" cellspacing="1" language="javascript"
            ...
            <tr style="background-color: white">
                <td style="width: 51%" valign="top">
                    <label class="blackfnt">
                        <span style="font-size: 8pt; font-family: Verdana">Cargo Courier Charges ( Details
                            as per attachment )</span></label></td>
        ...
        <br />       
    <%--</form>--%><center class="blackfnt"><b>HO COPY</b></center>
    ...
    <img ID="img1" src="../../../images/webxpress_logo.gif" runat="server" />
     ...
     <table id="TABLE3" border="1" cellpadding="1" cellspacing="1" language="javascript"
        ...
        <br />
        <table id="TABLE4" border="1" cellpadding="1" cellspacing="1" language="javascript" style="width: 100%">
            <tr style="background-color: white">
                <td style="width: 51%" valign="top">
                    <label class="blackfnt">
                        <span style="font-size: 8pt; font-family: Verdana">Cargo Courier Charges ( Details
        ...
        <br />       
    <%--</form>--%><center class="blackfnt"><b>CUSTOMER COPY</b></center>
    ...
    <img ID="img2" src="../../../images/webxpress_logo.gif" runat="server" />
     ...
     <table id="TABLE5" border="1" cellpadding="1" cellspacing="1" language="javascript" style="width: 100%">
            <tr>
            <td style="width: 619px" class="blackfnt">
                To,<br />
        ...
        <br />       
    </form><center class="blackfnt"><b>ACKNOWLEDGEMENT COPY</b></center>
</body>
</html>
