<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="BillRegister_ShowBillDetails.aspx.cs" Inherits="BillRegister_ShowBillDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function nwOpen222(mrsno,type,printyn)
        {
 
               
                window.open("frmbilldetail.aspx?Bill_No=" + mrsno,"pbr","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=387,height=220,status=no,left=220,top=70");
        ...
        <tr>
            <td style="height: 758px">
                                ...
                                <asp:Panel ID="p1" runat="server">
                                    <table align="center" border="0" cellpadding="2" cellspacing="1" class="boxbg" style="width: 98%;
                                                ...
                                                <tr style="background-color: White">
                                                    ...
                                                    <td>
                                                        <label class="blackfnt">
                                                            ...
                                                            <asp:HyperLink runat="server" Font-Underline="True" ForeColor="#003333" NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "aHrefLink")%>'
                                                                Text='<%#DataBinder.Eval(Container.DataItem, "BillNo")%>' ID="Hyperlink1">
                                                            </asp:HyperLink>
                                                            </a>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label class="blackfnt">
                                                            <%#DataBinder.Eval(Container.DataItem, "Manual_no")%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label class="blackfnt">
                                                    ...
                                                    <td>
                                                        <label class="blackfnt">
                                                            <%#DataBinder.Eval(Container.DataItem, "Hedu_Cess")%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label class="blackfnt">
                                                    ...
                                                    <td>
                                                        <label class="blackfnt">
                                                            <%#DataBinder.Eval(Container.DataItem, "can_resn")%>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label class="blackfnt">
                                                    ...
                                                    <td>
                                                        <label class="blackfnt">
                                                            <a class="bluefnt" href="JavaScript:nwOpen222('<%#DataBinder.Eval(Container.DataItem, "BillNo") %>',0)">
                                                                XLS </a>
                                                        </label>
                                                    </td>
                                                </tr>
                                        ...
                                        <tr id="trForTotalValues" runat="server" style="background-color: #ffffff">
                                            ...
                                            <td>
                                                <asp:Label ID="lbl_h_cess" runat="server" CssClass="blackfnt" Font-Bold="true">
                                                </asp:Label>
                                            </td>
                                            <td>
                ...
                <table id="tblPageNavigation" runat="server" align="center" border="0" cellpadding="0"
                    ...
                    <tr align="center">
                        <td align="center">
                            <select visible="false" id="ddlPages" runat="server" class="blackfnt" onchange="PageSelectionChanged(this)">
                            </select>
