        ...
        <script language="javascript" type="text/javascript">
            ...
            function SelectCustomer(objCustomer)
            {
                ...
                if(mQSParam == 13)
                {
                    ...
                    window.opener.document.getElementById("ctl00_MyCPH1_HIDBillPartySelFromPopupWindow").value = objCustomer.value
                    //window.opener.document.forms[0].txtPartyCode.value = objCustomer.value
                    //window.opener.document.forms[0].HIDBillPartySelFromPopupWindow.value = objCustomer.value
                }
        ...
        <form id="frmCustomerList" runat="server">
            ...
            <table border="1" width="100%" cellspacing="1" class="boxbg">
                ...
                <asp:Repeater ID="rptCustomer" runat="server">
                    <ItemTemplate>
                        <tr style="background-color: White">  <%--class="trOddRow" orgClassName="trOddRow" style="background-color: White"--%>
                            <td style="width: 10%">
                                &nbsp;
                                <input id="radSelCustomer" type="radio" value=<%#DataBinder.Eval(Container.DataItem, "CustCode")%> onclick="SelectCustomer(this)" runat="server" style="background-color:White" radioButtonBackColor="White" />
                            </td>
                    ...
                    <AlternatingItemTemplate>
                        <tr style="background-color: White"> <%--class="trEvenRow" orgClassName="trEvenRow"--%>
                            <td style="width: 10%">
                                &nbsp;
                                <input id="radSelCustomer" type="radio" value=<%#DataBinder.Eval(Container.DataItem, "CustCode")%> onclick="SelectCustomer(this)" runat="server" radioButtonBackColor="#cccccc" /> <%--style="background-color:#cccccc"--%>
                            </td>
