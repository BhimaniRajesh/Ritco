...
public partial class GUI_UNI_MIS_rpt_finance_new : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String sqlstr = "select report_name,link_name,link_title,discription,Subtitle from webx_reports where  title='F' and srno in (select reportid from Webx_Master_ReportsAccess where HasAccess='Y' and Userid='" + empcd + "') and activeflag='Y' order by subtitle";
