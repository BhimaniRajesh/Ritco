...
public partial class GUI_UNI_MIS_Login_View_Login_2 : System.Web.UI.Page
{
    ...
    private void DisplayDtl()
    {
        ...
        int totbooked = 0, totarrived = 0, totweigth = 0;
        double totval = 0.00;
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            {
                totarrived += Convert.ToInt16(dr["arrived"]);
            }
                ...
                else
                {
                    ...
                    totbooked += Convert.ToInt16(dr["booked"]);
                }
        ...
        if (ds.Tables[0].Rows.Count != 0)
        {
            ...
            GV_Dtl.FooterRow.Cells[7].Text = totarrived.ToString();
            GV_Dtl.FooterRow.Cells[7].HorizontalAlign = HorizontalAlign.Center;
            GV_Dtl.FooterRow.Cells[9].Text = totweigth.ToString();
            GV_Dtl.FooterRow.Cells[9].HorizontalAlign = HorizontalAlign.Center;
            GV_Dtl.FooterRow.Cells[10].Text = totval.ToString();
            GV_Dtl.FooterRow.Cells[10].HorizontalAlign = HorizontalAlign.Center;
    ...
    private void ForCSV()
    {
      ...
      sqlDA.Fill(dds);
        ...
        int totbooked = 0, totarrived = 0, totweigth = 0, totval = 0;
        foreach (DataRow dr in dds.Tables[0].Rows)
        {
            ...
            else
            {
                ...
                totval += Convert.ToInt16(dr["dkttot"]);
            }
