...
//        sqlDA.Fill(dsPages);
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        string Paybasloc = Request.QueryString["Paybasloc"].ToString();
        string Paybascust = Request.QueryString["Paybascust"].ToString();


        string Flow = Request.QueryString["Flow"].ToString();
        string rpt_type = Request.QueryString["rpt_type"].ToString();

        strFinalQS = "?DOCDate=" + DOCDate;
        strFinalQS = strFinalQS + "&RO=" + RO;
        strFinalQS = strFinalQS + "&Location=" + Location;
        strFinalQS = strFinalQS + "&Cust=" + Cust;
        strFinalQS = strFinalQS + "&Paybasloc=" + Paybasloc;
        strFinalQS = strFinalQS + "&Paybascust=" + Paybascust;
        strFinalQS = strFinalQS + "&Flow=" + Flow;
        strFinalQS = strFinalQS + "&rpt_type=" + rpt_type;

        Response.Redirect("Show_CreditResult_xls.aspx" + strFinalQS);
