<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_MIS_FTL_Profit_Query" %>
...
<script language="javascript" type="text/javascript">
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl="~/GUI/UNI_MIS/rpt_finance.aspx">Finanace</asp:HyperLink>
    &gt;
    <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="FTL Profitability"></asp:Label><br />
    <br />
    <center>
        &nbsp;</center>
    <center>
                                ...
                                <table cellspacing="1" class="boxbg" style="width: 70%">
                                    <tr class="bgbluegrey">
                                        <td align="center" colspan="3">
                                            <asp:Label ID="lblQry" runat="server" CssClass="blackfnt" Font-Bold="True">Search FTL Profitability Criteria</asp:Label></td>
                                    </tr>
                                    <tr style="background-color: white">
                                        <td align="left" style="width: 146px">
                                            &nbsp;<asp:Label ID="lblDateRange1" runat="server" CssClass="blackfnt" Font-Bold="True"
                                                Width="144px">Select Booking Date</asp:Label>
                                            &nbsp; &nbsp; &nbsp;
                                        </td>
                                    ...
                                    <tr style="background-color: white">
                                        ...
                                        <td align="left" colspan="2">
                                            &nbsp;<asp:DropDownList ID="cboRo" runat="server"
                                                ValidationGroup="VGDtFromTo" AutoPostBack="true" OnSelectedIndexChanged="cboRo_SelectedIndexChanged">
                                            </asp:DropDownList></td>
                                    </tr>
                                    <tr style="background-color: white">
                                        <td align="left" style="width: 146px">
                                    ...
                                    <tr style="background-color: white">
                                        <td align="left" style="width: 146px">
                                            &nbsp;<asp:Label ID="lblCustCode" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Enter Customer Code"
                                                Width="148px"></asp:Label>
                                        </td>
                                        <td align="left" colspan="2">
                                            &nbsp;<asp:TextBox ID="txtCustCode" runat="server" Width="93px"></asp:TextBox>                                            
                                    ...
                                    <tr style="background-color: white">
                                        <td align="right" colspan="3">
                                            ...
                                            <asp:Button ID="btnShowFTL" runat="server" OnClick="btnShowFTL_OnClick" Text="Show FTL Profitability (s) >>" OnClientClick="return DateCheck()" /></td>
