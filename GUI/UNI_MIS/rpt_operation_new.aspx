<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="rpt_operation_new.aspx.cs" Inherits="GUI_UNI_MIS_rpt_operation_new" %>
...
<font class=bluefnt><strong> &gt; </strong>
        ...
        <asp:TableCell>
        <asp:Label  Text="No Reports Available For This User" CssClass="blackfnt" runat="server"></asp:Label>
        ...
        <tr >
        <td align="center">
        <asp:Label ID="Label1" ForeColor="Red" Text="No Operations Reports Available For This User" CssClass="blackfnt" runat="server"></asp:Label>
        </td>
        </tr>
        </table>
