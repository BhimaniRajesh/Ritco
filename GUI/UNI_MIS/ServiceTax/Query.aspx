<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_MIS_ServiceTax_Query" %>
...
<script language="javascript" type="text/javascript">
    ...
    &gt;
    <asp:Label ID="Label2" runat="server" CssClass="blackfnt" Text="Service Tax"></asp:Label>
    <center>
        &nbsp;</center>
    <center>
                            ...
                            <table cellspacing="1" class="boxbg" style="width: 70%">
                                <tr class="bgbluegrey">
                                    <td align="center" colspan="3">
                                        <asp:Label ID="lblQry" runat="server" CssClass="blackfnt" Font-Bold="True">Search Service Tax Criteria</asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr style="background-color: white">
                                    <td align="left">
                                        <asp:Label ID="lblMRParty" runat="server" CssClass="blackfnt" Font-Bold="True" Text="MR Party"></asp:Label></td>
                                    <td align="left" colspan="2">
                                        <asp:TextBox ID="txtMRParty" runat="server" Width="87px"></asp:TextBox>                                        
                                        <input id="btnParty" type="button" name="..." runat="server"/></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left" style="height: 21px">
                                        <asp:Label ID="lblMRType" runat="server" CssClass="blackfnt" Font-Bold="True" Text="MR Type"></asp:Label></td>
                                    <td align="left" colspan="2" style="height: 21px">
                                        <asp:DropDownList ID="cboMRType" runat="server">
                                            ...
                                            <asp:ListItem Value="5">Misc MR.</asp:ListItem>
                                            <asp:ListItem Value="7">Misc Bill MR.</asp:ListItem>
                                        </asp:DropDownList></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        <asp:Label ID="lblAmt" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Amount Greater then"></asp:Label></td>
                                    <td align="left" colspan="2">
                                        <asp:TextBox ID="txtAmt" runat="server" Width="87px"></asp:TextBox></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="left">
                                        <asp:Label ID="lblRDate" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Enter MR No."></asp:Label></td>
                                    <td align="left" colspan="2">
                                        <asp:TextBox ID="txtMRNo" runat="server" Width="201px"></asp:TextBox>
                                        <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="[seperated by comma if multiple]"></asp:Label></td>
                                </tr>
                                <tr style="background-color: white">
                                    <td align="right" colspan="3">
                                        <asp:Button ID="btnShowServiceTax" runat="server" OnClick="btnShowServiceTax_OnClick" Text="Show Service Tax Summary(s) >>" OnClientClick="return DateCheck()" /></td>
