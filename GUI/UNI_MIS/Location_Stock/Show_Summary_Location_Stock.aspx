<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Show_Summary_Location_Stock.aspx.cs" Inherits="GUI_UNI_MIS_Login_View_Login_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <div align="left" style="width: 9.5in;">
        ...
        <br />
        <br />
        <table border="0" cellpadding="5" cellspacing="1" width="565" align="left" class="boxbg">
            ...
            <tr>
                ...
                <asp:GridView ID="GV_Summ" runat="server" align="center" BorderWidth="0" CellPadding="5"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="locname" ItemStyle-BackColor="white" ItemStyle-Wrap="true"
                            HeaderText="Current Location">
                            <HeaderStyle HorizontalAlign="Center" Width="550" Wrap="true" CssClass="blackfnt" />
                            <ItemStyle Width="1450" Wrap="False" HorizontalAlign="Center" CssClass="blackfnt" />
                        </asp:BoundField>
                        <asp:BoundField DataField="to_locname" ItemStyle-BackColor="white" ItemStyle-Wrap="true"
                            HeaderText="Delivery Location">
                            <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                            <ItemStyle Width="1500" Wrap="False" HorizontalAlign="Center" CssClass="blackfnt" />
                        </asp:BoundField>
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <asp:Label ID="Label2" Text='<%# "Total No. of " + Session["DocketCalledAs"]%>' runat="server"></asp:Label>
                            </HeaderTemplate>
                            ...
                            <ItemTemplate>
                                <label class="blackfnt">
                                    <asp:HyperLink Font-Underline="True" runat="server" NavigateUrl='<%#"Show_Detail_Location_stock.aspx?Cur_loc=" +DataBinder.Eval(Container.DataItem, "loccode")+"&dly_loc=" +DataBinder.Eval(Container.DataItem, "to_loccode")+"&reppara="+"drill"%>'
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <asp:Label ID="Label2" Text='<%# "Total No. of Detained " + docketis%>' runat="server"></asp:Label>
                            </HeaderTemplate>
                            <HeaderStyle HorizontalAlign="Center" Wrap="true" CssClass="blackfnt" />
                            <ItemStyle HorizontalAlign="right" CssClass="blackfnt" BackColor="white" />
                            <ItemTemplate>
                                <asp:Label Text='<%#DataBinder.Eval(Container.DataItem, "detained")%>' runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <%-- <asp:BoundField ItemStyle-BackColor="white" HeaderText='<%"ff" + docketis %>' DataField="TOT_DETAIN_DKT"
                            ItemStyle-Wrap="true">
                            <HeaderStyle HorizontalAlign="Center" Wrap="true" CssClass="blackfnt" />
                            <ItemStyle Width="150" Wrap="False" HorizontalAlign="right" CssClass="blackfnt" />
                        </asp:BoundField>--%>
                        <asp:BoundField ItemStyle-BackColor="white" DataField="ACTUWT" ItemStyle-Wrap="true"
                            HeaderText="Total Act. Wt.">
                            <HeaderStyle HorizontalAlign="Center" Wrap="true" CssClass="blackfnt" />
                            <ItemStyle Width="150" Wrap="False" HorizontalAlign="right" CssClass="blackfnt" />
                        </asp:BoundField>
                      <%--  <asp:BoundField ItemStyle-BackColor="white" DataField="TOT_TOPAYFRT" ItemStyle-Wrap="true"
                            HeaderText="To Pay">
                            <HeaderStyle HorizontalAlign="Center" Wrap="true" CssClass="blackfnt" />
                            <ItemStyle Width="150" Wrap="False" HorizontalAlign="right" CssClass="blackfnt" />
                        </asp:BoundField>--%>
                        <asp:BoundField DataField="freight" ItemStyle-BackColor="white" ItemStyle-Wrap="true"
                            HeaderText="Freight value">
                            <HeaderStyle HorizontalAlign="Center" Wrap="true" CssClass="blackfnt" />
                            <ItemStyle Width="150" Wrap="False" HorizontalAlign="right" CssClass="blackfnt" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TOT_Pkgs" ItemStyle-BackColor="white" ItemStyle-Wrap="true"
                            HeaderText="Packs">
                            <HeaderStyle HorizontalAlign="Center" Wrap="true" CssClass="blackfnt" />
                            <ItemStyle Width="150" Wrap="False" HorizontalAlign="right" CssClass="blackfnt" />
                        </asp:BoundField>
