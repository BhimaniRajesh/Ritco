...
public partial class FrmCriteria : System.Web.UI.Page
{
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid == true)
        {
            ...
            string ro;
            Response.Redirect("FrmMissingDockets.aspx?FrmDate=" + txtDateFrom.Text + "&ToDate=" + txtDateTo.Text + "&RO=" + CmbRO.Text + "&LocCode=" + CmbLoc.Text + "&series=" + CmbSeriesAllocate.Text + "&dockno=" + TxtCNote.Text + "");
        }
    }
    ...
    {
        if (radDate.SelectedItem.Value == "1")
        {
        ...
        {
            if (radDate.SelectedItem.Value == "0")
            {
                DateTime MyDate = DateTime.Today;
            ...
            if (radDate.SelectedItem.Value == "2")
            {
                txtDateFrom.Text = DateTime.Today.ToString("dd/MM/yyyy");
                txtDateTo.Text = txtDateFrom.Text;
                txtDateFrom.ReadOnly = true;
