...
public partial class GUI_Finance_voucher_Print_JournalVoucherView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       //  YEAR_SUFFIX = "07_08";
        ...
        string s = "SELECT accdesc=(select accdesc from webx_acctinfo where acccode=a.acccode),* FROM webx_acctrans_" + YEAR_SUFFIX + " a WHERE a.voucherno='" + voucherno + "' AND a.transtype='" + transtype + "' AND a.debit>0";
        // AND a.acccode NOT IN('" + acccoded + "')
        ...
        tctot5.HorizontalAlign = HorizontalAlign.Right;
        tctot3.HorizontalAlign = HorizontalAlign.Right;
        tctot4.HorizontalAlign = HorizontalAlign.Right;
