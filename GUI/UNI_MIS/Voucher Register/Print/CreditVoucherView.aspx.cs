...
public partial class GUI_Finance_voucher_Print_CreditVoucherView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // YEAR_SUFFIX = "08_09";
        ...
        //  =================================
        sql = "SELECT Sum(credit) As TotalCreditAmount FROM webx_acctrans_" + YEAR_SUFFIX + " WHERE voucherno='" + voucherno + "'";
        cmd = new SqlCommand(sql, con);
        dr = cmd.ExecuteReader();
