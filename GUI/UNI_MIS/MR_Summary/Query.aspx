<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_MIS_MR_Summary_Query" %>
...
<script language="javascript" type="text/javascript">
    ...
    &gt;
    <asp:Label ID="Label1" runat="server" Text="MR Summary" CssClass="blackfnt"></asp:Label><br />
                        ...
                        <table cellspacing="1" class="boxbg" style="width: 70%">
                            <tr class="bgbluegrey">
                                <td align="center" colspan="3">
                                    <asp:Label ID="lblQry" runat="server" CssClass="blackfnt" Font-Bold="True">Search MR Criteria</asp:Label>
                                </td>
                            </tr>
                            <tr style="background-color: white">
                                <td align="left">
                                    &nbsp;<asp:Label ID="lblDateRange1" runat="server" CssClass="blackfnt" Font-Bold="True" Width="162px">Created in Date Range:</asp:Label>
                                </td>
                            ...
                            <tr style="background-color: white">
                                ...
                                <td align="left" colspan="2">
                                    &nbsp;<asp:DropDownList ID="cboSelRo" runat="server" ValidationGroup="VGDtFromTo" AutoPostBack="true" OnSelectedIndexChanged="cboSelRo_SelectedIndexChanged">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr style="background-color: white">
                                <td align="left">
                                    &nbsp;<asp:Label ID="lblSelLoc" runat="server" CssClass="blackfnt" Font-Bold="True" Text="Select Location"></asp:Label></td>
                                <td align="left" colspan="2">
                            ...
                            <tr style="background-color: white">
                                <td align="right" colspan="3">
                                            <asp:Button ID="btnShowMR" runat="server" OnClick="btnShowMR_OnClick" Text="Show MR Summary(s) >>" OnClientClick="return DateCheck()" /></td>
