<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="result_veh.aspx.cs" Inherits="GUI_UNI_MIS_DOC_Profit_result_veh" %>
...
<table width="80%" border="0" align="left" cellpadding="0" cellspacing="0">
    ...
    <asp:GridView Visible="false" align="left" ID="dgDocket" runat="server" BorderWidth="0"
        ...
        <Columns>
            ...
            <asp:TemplateField Visible="false" HeaderText="SR.NO." ItemStyle-BackColor="white">
                <HeaderTemplate>
                    <asp:Label CssClass="blackfnt" ID="lblColname" runat="server"> </asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label CssClass="blackfnt" ID="lbldockno" Text='<% #DataBinder.Eval(Container.DataItem, "vehno")%>'
                        runat="server">
                    </asp:Label>
                </ItemTemplate>
                <HeaderStyle CssClass="blackfnt" />
            ...
            <asp:BoundField DataField="total_THC" HeaderText="Total THC">
                <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
    ...
    <asp:Table id="TBLDKTProf" Visible="false" border="0" HorizontalAlign="left" runat="server" CellPadding="3" CellSpacing="1" style="width:8.5in;" CssClass="boxbg"></asp:Table>
    <br />
  </td>
                    </tr>
                    <tr> 
