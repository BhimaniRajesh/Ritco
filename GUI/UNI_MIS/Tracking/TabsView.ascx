    ...
    <div id="tabs" style="text-align: left; padding: 0px 0px 0px 0px; color: Black; border-bottom-color : DarkGray">
      <table cellspacing="0"  border="1" bordercolor="DarkGray" style="width: 90%">
       ...
       <tr>
            ...
            <td colspan="6"><font class=blackfnt> <atlas:UpdatePanel ID="UpdatePanelContent" runat="server" Mode="conditional">
            <ContentTemplate>
            ...
            <Triggers>
               <atlas:ControlEventTrigger ControlID="btnTab1" EventName="Command" />
               <atlas:ControlEventTrigger ControlID="btnTab2" EventName="Command" />
                <atlas:ControlEventTrigger ControlID="btnTab3" EventName="Command" />
        <%--        <atlas:ControlEventTrigger ControlID="btnTab4" EventName="Command" />--%>
              <%-- <atlas:ControlEventTrigger ControlID="btnTab5" EventName="Command" />--%>
              <%-- <atlas:ControlEventTrigger ControlID="btnTab6" EventName="Command" />--%>
            </Triggers>
        </atlas:UpdatePanel></font></td></tr>
         </table>
    </div>
</div>
