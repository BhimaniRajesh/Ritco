...
public partial class GUI_Tracking_2 : System.Web.UI.Page
{
    ...
    public void DataSummary(string dockno)
    {
        ...
        while (dr_STstus.Read())
        {
            ...
            {
                st_status = "<b>" + status_doc + "</b>   At <b>" + st_docloc + "</b>  by <a href=\"JavaScript:OpenWindowDRS('" + attech_doc + "')\"><u>" + attech_doc + "</u></a>  on <b>" + st_docdate + "</b>";
            }
            ...
            {
                st_status = "<b>" + status_doc + "</b>    by <a href=\"JavaScript:OpenWindow('" + attech_doc + "')\"><u>" + attech_doc + "</u></a>  on <b>" + st_docdate + "</b>";
                
            }
            if (st_docname.ToUpper() == "LS")
            {
                st_status = "<b>" + status_doc + "</b>    by <a href=\"JavaScript:OpenPopupWindow1ls('" + attech_doc + "')\"><u>" + attech_doc + "</u></a>  on <b>" + st_docdate + "</b>";
    ...
    public void LifeCycleOp(string dockno)
    {
       ...
       // da.SelectCommand.Parameters.Add("@DOCKNO", SqlDbType.Text.ToString()).Value = dockno;
        ...
        while (dr3.Read())
        {
            ...
            tr4tc6.Text = "<a href=\"JavaScript:OpenPopupWindow1ls('" + lo_ls_no + "')\">View </a>";
            ...
            tr5tc6.Text = "<a href=\"JavaScript:OpenWindow('" + lo_tcno + "')\">View </a>";
