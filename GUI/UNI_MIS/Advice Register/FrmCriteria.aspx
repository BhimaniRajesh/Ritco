...
--%>
    <br />
    <%--<asp:Label ID="Label1" Font-Underline="true" Font-Bold ="true" runat="server" Text="Reports/Finance & Accounts/ Advice Register Query"></asp:Label><br />--%>
    ...
    <td  align="left">  
        <a><font class="blklnkund"><b>Module</b></font></a>
							...
							<b> &gt; </b>
							<font class="bluefnt"><b>Advice Register</b></font>
	</td>
	<td align="right">
    ...
    <table border="0" cellpadding="0" cellspacing="1" class="boxbg" style="width: 639px;
        ...
        <tr bgcolor="white">
                ...
                <td class="blackfnt" align="left" colspan="3" style="width: 520px">
                    <asp:DropDownList ID="CmbStatus" runat="server">
                        ...
                        <asp:ListItem Value="S">Generated</asp:ListItem>
                        <asp:ListItem Value="C">Canceled</asp:ListItem>
                        <asp:ListItem Value="A">Acknowledged</asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr bgcolor="white">
                <td align="left" class="blackfnt" style="width: 199px">
        ...
        <div id="divDate" style="position:absolute;visibility:hidden;background-color:white;z-index:99;"></div>
          ...
          <asp:Button
            ID="BtnSubmit" runat="server" OnClick="BtnSubmit_Click" Text="Submit" ForeColor="Black" />&nbsp;</div><br />
