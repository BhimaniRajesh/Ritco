<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="rpt_specific_new.aspx.cs" Inherits="GUI_UNI_MIS_rpt_specific_new" %>
...
<font class=bluefnt><strong> &gt; </strong>
		  <strong>Specific</strong> </font></td>
        </tr>
        <tr> 
        ...
        <tr >
        <td align="center">
        <asp:Label ID="Label2"  ForeColor="Red" Text="No Specific Reports Available For This User" CssClass="blackfnt" runat="server"></asp:Label>
        </td>
        </tr>
        </table>
