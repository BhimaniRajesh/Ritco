<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_UNI_MIS_Booking_register_Query" %>
        ...
        <table cellspacing="1" style="width: 9.0in" class="boxbg" align="left">
            ...
            <tr style="background-color: white">
                ...
                <td align="left" colspan="5" valign="top">
                 ...
                 <tr style="background-color: white">
                <td align="left">
                    <asp:Label ID="Label1" CssClass="blackfnt" Text="Enter Customer" runat="server"
                        Width="102px"></asp:Label>
                </td>
                <td align="left"><asp:TextBox ID="txtcustcd" runat="server" ></asp:TextBox><asp:Button  ID="btncustcd"  Text="..." runat="server"/></td>
                <td align="left"><asp:Label ID="Label3" CssClass="blackfnt" Text="OR" runat="server"
                        Width="102px"></asp:Label></td>
                <td align="left"><asp:Label ID="Label4" CssClass="blackfnt"  Text="Enter Vendor" runat="server"
                        Width="102px"></asp:Label></td>
                <td align="left"><asp:TextBox ID="txtvendcd" Enabled="false" runat="server" ></asp:TextBox><asp:Button  ID="btnvendcd" Text="..." runat="server"/></td>
                <td align="left"><asp:Label ID="Label5" CssClass="blackfnt" Text="Select Order" runat="server"
                        Width="102px"></asp:Label></td>
                <td align="left"> <asp:DropDownList ID="DLLOrder" Enabled="false" runat="server"  Mode="Conditional"
                                RenderMode="Inline" Width="102px">
                               <asp:ListItem Text="Date Wise" Value="thcdt"></asp:ListItem>
                               <asp:ListItem Text="Location Wise" Value="thcbr"></asp:ListItem>
                               <asp:ListItem Text="Destination Wise" Value="tobh_code"></asp:ListItem>
                               <asp:ListItem Text="Broker Wise" Value="vendor_name"></asp:ListItem>
                            </asp:DropDownList></td>
                </tr>
                <tr style="background-color: white">
                <td colspan="2" align="left">
                    <asp:Label ID="Label2" CssClass="blackfnt" Text="Select Docket/Bill/Lorry Hire  Date" runat="server"
                        Width="102px"></asp:Label>
                </td>
                <td colspan="2">
               ...
               <td valign="top" colspan="4"><asp:Label ID="lblFrom" CssClass="blackfnt" runat="server" Text=" From: "></asp:Label>
            ...
            <tr align="center" bgcolor="white">
                <td  colspan="7">
                <asp:RadioButtonList  ID="rpttyp" onClick="javascript:Chk(this);" RepeatDirection="horizontal"   CssClass="blackfnt"  runat="server">
                <asp:ListItem  Selected="True" Text="Docket Booking Register " Value="doc_flow"></asp:ListItem>
                <asp:ListItem    Text="Bill Register " Value="bill"></asp:ListItem>
                 <asp:ListItem   Text="Lorry Hire Register" Value="thc"></asp:ListItem>
