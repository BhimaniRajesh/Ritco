<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="result.aspx.cs" Inherits="GUI_UNI_MIS_chequemgt_result" %>
...
<asp:Content ContentPlaceHolderID="MyCPH1" ID="cheque_result" runat="server">
        ...
        function popup2(obj)
    {
        ...
        //debugger;
        var txt = obj.value;
        var FrmChild = window.open('popup-usage_issu.aspx?id='+ txt + ',myWindow,height=285,width=800,resizable=yes,scrollbars=yes,left=310,top=15'); 
        ...
        <tr>
            <td width="100%" align="right">
                <a href="Issuecheque_viewstep1.aspx">
                    <img src="../../../GUI/images/back.gif" border="0" /></a></td>
        </tr>
    </table>
    <table width="75%" border="0">
        <tr>
            ...
            <td width="90%" align="center">
                <table>
                    <tr>
                        <td>
                            <font class="blackfnt"><strong>You Selected</strong></font></td>
                    </tr>
                </table>
                <br />
                <table runat="server" id="table1" border="0" style="display: none" cellpadding="1"
                    cellspacing="1" class="boxbg" width="60%">
                    <tr bgcolor="white">
                        <td width="40%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="Label1" runat="server"></asp:Label></font></td>
                        <td width="60%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="lblEntryDate" runat="server"></asp:Label></font></td>
                    </tr>
                    <tr bgcolor="white">
                        <td width="40%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="Label2" runat="server"></asp:Label></font></td>
                        <td width="60%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="lblParty" runat="server"></asp:Label></font></td>
                    </tr>
                    <tr bgcolor="white">
                        <td width="40%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="Label3" runat="server"></asp:Label></font></td>
                        <td width="60%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="lblCS" runat="server"></asp:Label></font></td>
                    </tr>
                    <tr bgcolor="white">
                        <td width="40%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="Label4" runat="server"></asp:Label></font></td>
                        <td width="60%" align="left">
                            <font class="blackfnt">&nbsp;<asp:Label ID="lblChqAmtStatus" runat="server"></asp:Label></font></td>
                    </tr>
                </table>
                <br />
                <table border="0" cellpadding="0" cellspacing="0" width="90%">
                    <tr>
                        <td>
                            <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" BorderColor="#8BA0E5"
                                BorderWidth="1px" CellPadding="1" CellSpacing="1" CssClass="blackfnt" ShowFooter="True"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="View Usage">
                                        <ItemTemplate>
                                            <input name="chk" type="radio" onclick="popup2(this);" value='<%#DataBinder.Eval(Container.DataItem,"CHQNO") %> ,<%#DataBinder.Eval(Container.DataItem,"CHQDTT")  %>'>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Cheque Number">
                                        <ItemTemplate>
                                            <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"CHQNO") %>'
                                                ID="txt"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                            ...
                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BorderColor="#8BA0E5"
                                BorderWidth="1px" CellPadding="1" CellSpacing="1" CssClass="blackfnt" OnItemDataBound="DataGrid1_ItemDataBound"
                            ...
                            <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" BorderColor="#8BA0E5"
                                BorderWidth="1px" CellPadding="1" CellSpacing="1" CssClass="blackfnt" OnItemDataBound="DataGrid1_ItemDataBound"
                                ShowFooter="True" Width="100%">
                                <FooterStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" />
