<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DebitVoucherView.aspx.cs"
...
<body>
    ...
    <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg"
        ...
        <tr class="blackfnt">
            ...
            <td align="left" bgcolor="#ffffff">
                <asp:Label ID="lblbranch" CssClass="blackfnt" runat="server"></asp:Label></td>
            <td align="left" class="bgbluegrey">
                Voucher No.</td>
            <td align="left" bgcolor="#ffffff">
        ...
        <tr class="blackfnt">
            <td align="left" class="bgbluegrey">
                Location</td>
            <td align="left" bgcolor="#ffffff">
                <asp:Label ID="lbl_Cheque_Entry_Location" CssClass="blackfnt" runat="server"></asp:Label></td>
            <td align="left" class="bgbluegrey">
                Cheque No. & Date</td>
            <td align="left" bgcolor="#ffffff">
                <asp:Label ID="lbl_Cheque_Entry_Date" runat="server"></asp:Label></td>
        </tr>
    ...
    <br />
    <br />
    <font class="blackfnt"><b>A/C. : </b></font>
    <asp:Label CssClass="blackfnt" ID="lblaccno" runat="server"></asp:Label>
    :
        ...
        <tr bgcolor="#ffffff">
            <td align="left" class="blackfnt">
                <table border="0" cellpadding="3" width="100%" bgcolor="#808080" cellspacing="1"
                    class="boxbg">
                    <tr bgcolor="white">
                        <td align="center" class="blackfnt" width="40%">
                            Description</td>
                        <td align="center" class="blackfnt" width="15%">
                            Debit Amount</td>
                        <td align="center" class="blackfnt" width="15%">
                            Credit Amount</td>
                        <td align="center" class="blackfnt" width="30%">
                            Narration</td>
                    </tr>
                </table>
            </td>
        ...
        <tr bgcolor="#ffffff">
            <td align="left" class="blackfnt">
                <table border="0" cellpadding="3" width="100%" bgcolor="#808080" cellspacing="1"
                    class="boxbg">
                    <tr bgcolor="white">
                        <td align="right" class="blackfnt" width="40%">
                            <strong>Total Rs.</strong></td>
                        <td align="right" class="blackfnt" width="15%">
                            <asp:Label ID="lblTotalDebitAmount" runat="server"></asp:Label></td>
                        <td align="right" class="blackfnt" width="15%">
                            <asp:Label ID="lblTotalCreditAmount" runat="server"></asp:Label></td>
                        <td width="35%">
                        </td>
                    </tr>
                </table>
    ...
    <br />
    <div style="width: 7in;" align="left">
    ...
    <br />
    <br />
    <div style="width: 7in;" align="right">
        <font class="blackfnt">Reciver's Signature</font></div>
    <br />
</body>
