...
<body>
    <div align="center" style="width: 7in;">
                ...
                <td align="left" class="bgbluegrey" style="width: 50%;">
                    <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg"
                        ...
                        <tr class="blackfnt">
                            ...
                            <td align="left" bgcolor="#ffffff">
                                <asp:Label ID="lblbranchcode" CssClass="blackfnt" runat="server"></asp:Label>
                                :
                                <asp:Label ID="lblbranchname" CssClass="blackfnt" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <br />
        <asp:Table ID="tblacclist" runat="server" CellPadding="3" CssClass="boxbg" CellSpacing="1"
            Style="width: 7in;">
