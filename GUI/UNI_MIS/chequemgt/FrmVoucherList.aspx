    ...
    function nwOpen(mrsno,type,printyn)
        {
                        ...
                        else if(typ == "CASH RECEIPT" || typ == "BANK RECEIPT" || typ =="CASH RECIEPT")
                        {                   
                      //  credit     
                        ...
                        {                        
                           window.open("Print/ContraVoucherView.aspx?voucherno=" + mrsno + "&printyn=N","es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
                           //,menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=387,height=220,status=no,left=220,top=70);
        ...
        function nwOpen1(mrsno,type,printyn)
        {
                ...
                {           
                    ...
                    window.open("Print/JournalVoucherPrint.aspx?voucherno=" + mrsno + "&printyn=Y","es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
                
                }
                else if(typ == "CASH PAYMENT" || typ == "BANK PAYMENT")
                {            //debit            
                   window.open("Print/DebitVoucherPrint.aspx?voucherno=" + mrsno + "&printyn=Y","es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
                     
                }
                else if(typ == "CASH RECEIPT" || typ == "BANK RECEIPT")
                {                   
              //  credit     
                   window.open("Print/CreditVoucherPrint.aspx?voucherno=" + mrsno + "&printyn=Y","es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
                     
                }
                else if(typ == "CONTRA")
                {                        
                   window.open("Print/ContraVoucherPrint.aspx?voucherno=" + mrsno + "&printyn=Y","es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125");
