...
public partial class GUI_UNI_MIS_Monthly_Sales_query: System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string sql_paybas = " select codeid,codedesc from  webx_master_general  where codetype='paytyp' and statuscode='Y' union select 'All' as codeid,'Total'  as codedesc from webx_master_general  ";
            ...
            payint = ip;
            drpaybas.Close();
            string sql_Trn = " select 'All' as codeid,'Total'  as codedesc from webx_master_general union select codeid,codedesc from  webx_master_general  where codetype='trn' and statuscode='Y'";
    ...
    {
        string report_mode = "",cust8888="", report_Subtype = "",report_type_st="", report_type = "",st_columnlist="", St_year = "", st_paybaslist = "", st_trnmodlist = "", st_ro = "", st_lo = "";
