<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="query.aspx.cs" Inherits="GUI_UNI_MIS_TRF_report_query" %>
                ...
                <tr style="background-color: white">
                    ...
                    <td>
                        <asp:RadioButtonList  ID="radDate" runat="server" ValidationGroup="VGDtFromTo" CssClass="blackfnt"
                            ...
                            <asp:ListItem Enabled="false"  Value="1" Text=" Last Week (Including Today)"></asp:ListItem>
