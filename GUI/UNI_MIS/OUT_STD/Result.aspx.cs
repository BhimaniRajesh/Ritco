    ...
    public void BindGrid()
    {
      ...
      // string dirlldown = "RO=" + RO + "&LO=" + LO + "&fromdt=" + fromdt + "&todt=" + todt + "&RPT=" + RPT + "&RPT=" + RPT + "&st_cust_vend=" + st_cust_vend + "&st_cust_vend_name=" + st_cust_vend_name + "&rpt_SUB=" + rpt_SUB + "&RTP_DT=" + RTP_DT + "&RTP_DT_str=" + RTP_DT_str + "&BM_TYP=" + BM_TYP + "&frm_as_dt=" + frm_as_dt + "&to_as_dt=" + to_as_dt + "&CustRPT=1&RMD=N";
           ...
           // TR1TC1 = new TableCell();
            ...
            if (RPT == "1")
            {
                string dirlldown = "RO=" + RO + "&LO=" + DR["loccode"].ToString() + "&fromdt=" + fromdt + "&todt=" + todt + "&RPT=3&st_cust_vend=" + st_cust_vend + "&st_cust_vend_name=" + st_cust_vend_name + "&rpt_SUB=" + rpt_SUB + "&RTP_DT=" + RTP_DT + "&RTP_DT_str=" + RTP_DT_str + "&BM_TYP=" + BM_TYP + "&frm_as_dt=" + frm_as_dt + "&to_as_dt=" + to_as_dt + "&CustRPT=1&RMD=N";
                TR1TC1 = new TableCell();
                ...
                dirlldown = "RO=" + RO + "&LO=" + DR["loccode"].ToString() + "&fromdt=" + fromdt + "&todt=" + todt + "&RPT=3&st_cust_vend=" + st_cust_vend + "&st_cust_vend_name=" + st_cust_vend_name + "&rpt_SUB=" + rpt_SUB + "&RTP_DT=" + RTP_DT + "&RTP_DT_str=" + RTP_DT_str + "&BM_TYP=" + BM_TYP + "&frm_as_dt=" + frm_as_dt + "&to_as_dt=" + to_as_dt + "&CustRPT=2&RMD=N";
                TR1TC1 = new TableCell();
                ...
                dirlldown = "RO=" + RO + "&LO=" + DR["loccode"].ToString() + "&fromdt=" + fromdt + "&todt=" + todt + "&RPT=3&st_cust_vend=" + st_cust_vend + "&st_cust_vend_name=" + st_cust_vend_name + "&rpt_SUB=" + rpt_SUB + "&RTP_DT=" + RTP_DT + "&RTP_DT_str=" + RTP_DT_str + "&BM_TYP=" + BM_TYP + "&frm_as_dt=" + frm_as_dt + "&to_as_dt=" + to_as_dt + "&CustRPT=3&RMD=N";
                TR1TC1 = new TableCell();
