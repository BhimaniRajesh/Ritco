<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="Transit_Rpt.aspx.cs" Inherits="GUI_UNI_MIS_InTransit_report_Transit_Rpt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <asp:Panel ID="newtab" runat="server">
                                ...
                                <td>
                                    <center>
                                        <asp:HyperLink ID="Hyperlink1" runat="server" Font-Underline="True" ForeColor="#003333"
                                            NavigateUrl='<%#"Transit_Sub_Rpt.aspx?Last_Loc=" + DataBinder.Eval(Container.DataItem, "Last_Loc") + "&Next_Loc=" + DataBinder.Eval(Container.DataItem, "Next_Loc") + "&Day1=" + Request.QueryString["No_Day"].ToString() + "&Day2=" + Request.QueryString["Number_Day"].ToString() %>'
                                            Text='<%#DataBinder.Eval(Container.DataItem, "TotDoc")%>' Visible='<%#DataBinder.Eval(Container.DataItem, "LinkVisible")%>'>
                                        </asp:HyperLink>
        ...
        <table id="tblNoRecords" runat="server" align="center" border="0" cellpadding="2"
            cellspacing="1" class="boxbg" style="background-color: #808080; width: 60%;"
            visible="false">
            <tr style="background-color: #ffffff">
