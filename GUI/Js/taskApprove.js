...
function valid(obja,obj)
    {
        if(obja.checked==true)
        {
            if (obj >= 0 && obj <= 8)
            {
                ...
                document.getElementById('ctl00_MyCPH1_DataGrid1_ctl'+obj+'_hidChecked').value = "Y";
                //document.getElementById('ctl00_MyCPH1_DataGrid1_ctl'+obj+'_txtRemarks').value = "Task Completed";
        ...
        else
        {
            if (obj >= 0 && obj <= 8)
            {
                ...
                document.getElementById('ctl00_MyCPH1_DataGrid1_ctl'+obj+'_hidChecked').value = "";
                document.getElementById('ctl00_MyCPH1_DataGrid1_ctl'+obj+'_txtRemarks').value = "";
            }
            else if (obj >= 9 && obj <= 99)
            {
