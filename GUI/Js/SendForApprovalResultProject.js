...
function valid(obja,obj)
    {
        if(obja.checked==true)
        {
            if (obj >= 0 && obj <= 8)
            {
                ...
                document.getElementById('ctl00_MyCPH1_DataGrid1_ctl'+obj+'_dlstTest_Live').value = "W";
                ...
                document.getElementById('ctl00_MyCPH1_DataGrid1_ctl'+obj+'_txtRemarks').value = "Task Awaiting Approval";
            }
