<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LocationHirarchyActiveLocation.ascx.cs"
    Inherits="GUI_UNI_MIS_LocationHirarchyActiveLocation" %>
    ...
    <div id="tabs" style="text-align: left; padding: 0px 0px 0px 0px; color: Black; border-bottom-color: DarkGray">
        <table cellspacing="1" cellpadding ="3" border="0" class="boxbg" style="width: 100%">
            <tr id="trRO" style="background-color: white" runat="server">
                <td class="blackfnt" id="dtRoLbl" runat="server">
                  Select  RO
                </td>
                <td class="blackfnt">
            ...
            <tr id="trLO" style="background-color: white" runat="server">
                <td class="blackfnt" id="dtLocLbl" runat="server">
                 Select   Location
                </td>
                <td class="blackfnt">
