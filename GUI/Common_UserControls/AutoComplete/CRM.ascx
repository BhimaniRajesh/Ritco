<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CRM.ascx.cs" Inherits="GUI_Operation_DocketEntry_XAC" %>
...
function CodeKeyUp(e,WEBX,init)
{
        ...
        {   
            ...
            if(findobj)
            {
              ...
              var strpg= fileURL.substring(0,cnt) + '/GUI/Common_UserControls/AutoComplete/_xac_data_CRM.aspx?tp='+ WEBX.WebxComplete.Type + '&target1=' + WEBX.WebxComplete.Target1.getAttribute('id');
              //alert(strpg);
...
<asp:Panel ID="divXAC" style="position:absolute; width:300px;display:none; z-index:10000; cursor:pointer; scrollbar-base-color: #d4e0e7; scrollbar-3dlight-color: #d4e0e7; scrollbar-highlight-color: #d4e0e7; scrollbar-shadow-color: #d4e0e7;" ScrollBars="Both" Width="2in" runat="server"></asp:Panel>
