<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RPT_DateTillDateSelected.ascx.cs" Inherits="GUI_Common_UserControls_RPT_DateTillDateSelected" %>
            ...
            <tr style="background-color: white" id="trDtCri" runat="server">              
                    <td>
                        <asp:RadioButtonList ID="radDate" runat="server" ValidationGroup="VGDtFromTo" CssClass="blackfnt"
                            ...
                            <asp:ListItem Selected="True" Value="3" Text=" Till Date:"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
