<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RPT_DateWithYesterDay.ascx.cs" Inherits="GUI_Common_UserControls_RPT_DateWithYesterDay" %>
...
<script language="JavaScript" type="text/javascript">
    ...
    function makeDateRange() {
        ...
        var rbl_Yesterday = document.getElementById("<%=radDate.ClientID %>_3");
        ...
        else if (rbl_Yesterday.checked) {
            tb_From_Date.value = makeDate_1(toDay.getDate()-1, toDay.getMonth() + 1, toDay.getFullYear());
            tb_To_Date.value = makeDate_1(toDay.getDate()-1, toDay.getMonth() + 1, toDay.getFullYear());
            tb_From_Date.disabled = true;
            tb_To_Date.disabled = true;
        }
        return false;
            ...
            <tr style="background-color: white" id="trDtCri" runat="server">              
                    <td>
                        <asp:RadioButtonList ID="radDate" runat="server" ValidationGroup="VGDtFromTo" CssClass="blackfnt"
                            ...
                            <asp:ListItem Value="3" Text=" Yesterday:"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
