...
namespace WebX.CommonControls
{
    public partial class DatePicker : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "LoadOnCallBack_" + txtDate.ClientID, "LoadOnCallBack($('#" + txtDate.ClientID + "'),'" + ConfigHelper.JSDateFormat + "','" + AllowFutureDate + "','" + AllowPastDate + "','" + ResolveClientUrl("~/GUI/images/calendar.png") + "');", true);
