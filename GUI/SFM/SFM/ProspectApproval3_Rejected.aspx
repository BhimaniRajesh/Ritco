<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ProspectApproval3_Rejected.aspx.cs" Inherits="SFM_ProspectApproval3_Rejected" Title="Untitled Page" %>
...
<table style="width: 100%">
        ...
        <tr>
            <td align="left"  colspan="3">
                <asp:Label ID="lblWelcome" runat="server" Text="Rejected" CssClass="blackfnt" Font-Bold="true"></asp:Label>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <asp:GridView align="center" ID="ProspectRejected" runat="server" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey"
            ...
            EmptyDataText="No Records Found..." Width="100%" >
                <Columns>
                    ...
                    <asp:BoundField DataField="ReasonforReject" HeaderText="Reason for Rejection" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                    <ItemStyle CssClass="blackfnt" />
                    </asp:BoundField>
