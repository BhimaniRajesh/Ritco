...
public partial class SFM_TDS_Cust_PopupReschedule : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        employee = Session["empcd"].ToString();
        string scr1 = @"<script>
    ...
    protected void btnSubmit_OnClick(object sender, EventArgs e)
    {
        ...
        strSQL = "select distinct p.ProspectCode,p.CompanyName from webx_ProspectCustomer p,Webx_Appointment a where p.ProspectCode=a.ProspectCode and p.ProspectCode is not null and p.Cflag is null";
        ...
        else if (Session["mainbrcd"].ToString().Trim() == Session["brcd"].ToString().Trim())
        {
            ...
            strSQL = strSQL + " AND p.entryby='" + Session["empcd"].ToString() + "'"; ;
        }
        //strSQL = strSQL;
