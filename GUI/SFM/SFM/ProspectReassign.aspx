<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ProspectReassign.aspx.cs" Inherits="SFM_ProspectReassign" %>
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td align="left"  colspan="3">
                <asp:Label ID="lblWelcome" runat="server" Text="Re-Assign Prospect" CssClass="blackfnt" Font-Bold="true"></asp:Label>
