<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TDS_Cust_PopupReschedule1.aspx.cs" Inherits="SFM_TDS_Cust_PopupReschedule1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Prospect Code</title>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                ...
                                <input id="radSelBranch" type="radio" value='<%# DataBinder.Eval(Container.DataItem, "ProspectCode")%>' onclick="SelectCustomer(this);" runat="server" />
