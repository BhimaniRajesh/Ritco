...
public partial class SFM_Appointment_popup : System.Web.UI.Page
{
    SqlConnection conn;
    ...
    protected void btnSubmit_OnClick(object sender, EventArgs e)
    {
        ...
        strSQL = "select ProspectCode,CompanyName,entryby from webx_ProspectCustomer with(NOLOCK) where ProspectCode is not null";
