<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ProspectReg_Done.aspx.cs" Inherits="SFM_ProspectReg_Done" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
 <table style="width: 100%">

        <tr>
            <td align="left"  colspan="3">
                <asp:Label ID="lblWelcome" runat="server" Text="Prospect Registarion Done" CssClass="blackfnt" Font-Bold="true"></asp:Label>
...
<br />
    <script language="javascript" type="text/javascript">
        ...
        { 
        window.open("./Prosp_View.aspx?strProspectCode=" + arg1 + "," + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"); 
        }
    </script>

    <div align="center">
    <%=Request.QueryString.Get("date1")%>
   ...
   <tr>
    <td  align="center" bgcolor="#FFFFFF" height="18" colspan="2"><font class="blackfnt">New Prospect</font></td>
    <td  align="center" bgcolor="#FFFFFF" height="18" colspan="1"><font class="blackfnt"><%=Request.QueryString.Get("ProspectCode")%></font></td>
    
    <td  align="right" bgcolor="#FFFFFF" height="18" colspan="1"><font class="blackfnt"><a href="Javascript:ViewPrint('<%=Request.QueryString.Get("ProspectCode")%>',0)"><font class="blklnkund">View</font></a> | <a href="Javascript:ViewPrint('<%=Request.QueryString.Get("ProspectCode")%>',1)"><font class="blklnkund">Print </font></a></td>
  </tr>
  <tr>
  ...
  <tr  bgcolor="#FFFFFF">
    ...
    <td width="100%" align="left" bgcolor="#FFFFFF" height="15" colspan="3"><font class="blackfnt" color="#0000FF"><a href="saleCallReg_operations.aspx"><font class="blklnkund">Sales Visit Register</a></font></td>
  </tr>
   <tr  bgcolor="#FFFFFF">
    <td width="2%" height="15" bgcolor="#FFFFFF"> 
					                  <table border="0" cellspacing="0" cellpadding="0">
