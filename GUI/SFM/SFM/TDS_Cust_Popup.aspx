<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TDS_Cust_Popup.aspx.cs" Inherits="TDS_Cust_Popup" EnableEventValidation="false" %>
            ...
            <table border="1" width="100%" cellspacing="1" class="boxbg">
                <tr class="bgbluegrey">
                    ...
                    <td style="width: 30%" align="left">
                        &nbsp;<label id="lblCustCodeColHeader" class="blackfnt">Prospect Code
                        </label>
                    </td>
                    <td align="left">
                        &nbsp;
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                ...
                                <input id="radSelBranch" type="radio" value='<%# DataBinder.Eval(Container.DataItem, "ProspectCode")+"~"+ DataBinder.Eval(Container.DataItem, "entryby")+"~"+ DataBinder.Eval(Container.DataItem, "CompanyName")+"~"+ DataBinder.Eval(Container.DataItem, "Industry")+"~"+ DataBinder.Eval(Container.DataItem, "AcctCategory")+"~"+ DataBinder.Eval(Container.DataItem, "statesub")%>' onclick="SelectCustomer(this);" runat="server" />
