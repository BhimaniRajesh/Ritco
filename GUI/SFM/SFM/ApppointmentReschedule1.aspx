<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ApppointmentReschedule1.aspx.cs" Inherits="SFM_ApppointmentReschedule1" Title="Untitled Page" %>
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td align="left"  colspan="3">
                <asp:Label ID="lblWelcome" runat="server" Text="Appointment Reschedule or Cancel" CssClass="blackfnt" Font-Bold="true"></asp:Label>
