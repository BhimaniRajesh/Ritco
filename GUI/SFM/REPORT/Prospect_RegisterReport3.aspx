<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Prospect_RegisterReport3.aspx.cs" Inherits="REPORT_Prospect_RegisterReport3" %>
        ...
        <div align="left">
				...
				<table botder="0" cellpadding="3"cols="2" width="55%" bgcolor="#ffffff" cellspacing="1" class="boxbg">
					...
					<%--<tr bgcolor="#ffffff">
						...
						<td  align="left">
							<font class="blackfnt">
                                <asp:Label ID="lblCallMade" runat="server" Text="Label"></asp:Label></font></td>
					</tr>		--%>				
					...
					<asp:GridView ID="GridView1" runat="server" align="center" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey" 
                                                         PagerStyle-HorizontalAlign="left" 
                                                            ...
                                                            PagerSettings-FirstPageText="[First]" PagerSettings-LastPageText="[Last]" EmptyDataText="No Records Found..." >
                                                                ...
                                                                <asp:BoundField DataField="personcalled" HeaderText="Meeting With" ItemStyle-HorizontalAlign="Left"/>
