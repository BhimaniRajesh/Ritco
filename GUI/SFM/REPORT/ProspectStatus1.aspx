<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ProspectStatus1.aspx.cs" Inherits="REPORT_ProspectStatus1" Title="Untitled Page" %>
    ...
    <div align="center">
        <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg"
                                                        ...
                                                        <td align="left" bgcolor="#ffffff" colspan="2">
                                                            <div id="Div2">
                                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="true" Mode="Conditional"
                                                                             RenderMode="Inline"
                                                                            Width="152px">
                                                                            <asp:ListItem Text="--All--" Value=""></asp:ListItem>
                                                                        </asp:DropDownList>
                                                    ...
                                                    <tr bgcolor="#ffffff" style="font-weight: bold; font-size: 12pt; font-family: Times New Roman">
                                                        <td align="left">
                                                            <font class="blackfnt">Enter Sales Person id</font></td>
