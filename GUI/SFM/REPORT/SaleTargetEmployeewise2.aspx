<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="SaleTargetEmployeewise2.aspx.cs" Inherits="REPORT_SaleTargetEmployeewise2" %>
...
<table style="width: 100%">
            ...
            <table border="0" cellpadding="3" colspan="2" width="55%" bgcolor="#ffffff" cellspacing="1" class="boxbg">
                <tr bgcolor="#ffffff">
						<td  align="left" width="30%" style="height: 25px">
							<font class="blackfnt"><b>Location</b></font></td>
				...
				<tr bgcolor="#ffffff">
						<td  align="left" width="30%" style="height: 25px">
							<font class="blackfnt"><b>Employee</b></font></td>
						<td  align="left" style="height: 25px">
							<font class="blackfnt">
							<asp:Label ID="lblEmployee" runat="server" width="100%">
							</asp:Label>
							</font>
						</td>
					</tr>
   ...
   <Columns>
          ...
          <%#DataBinder.Eval(Container.DataItem, "ProspectId") + ":" + DataBinder.Eval(Container.DataItem, "companyName")%></a>
          </ItemTemplate>
          </asp:TemplateField>
