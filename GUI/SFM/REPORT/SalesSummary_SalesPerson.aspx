<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="SalesSummary_SalesPerson.aspx.cs" Inherits="REPORT_SalesSummary_SalesPerson" %>
...
<table style="width: 100%">
        ...
        <tr>
            ...
            <font class="blackfnt"><%=callvisit%> Summary-SalesPerson Wise Report</font>
...
<div align="center">
        <table bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg"
                                    ...
                                    <asp:AsyncPostBackTrigger ControlID="radDate" EventName="SelectedIndexChanged" />
                                                    ...
                                                    <tr bgcolor="#ffffff" style="font-weight: bold; font-size: 12pt; font-family: Times New Roman">
                                                        ...
                                                        <td valign="top" align ="left" colspan="2">
                                                            ...
                                                            <asp:Button ID="btnPopUp" runat="server" Text="..." Width="32px" /></td>
                                                    </tr>
                        ...
                        <asp:GridView ID="dgCallsummaryPerson" runat="server" BorderWidth="1" CellSpacing="1" CellPadding="5" HeaderStyle-CssClass="bgbluegrey"
                            ...
                            CssClass="blackfnt" EmptyDataText="No Records Found..." BorderColor="#8ba0e5" OnPageIndexChanging="pgChange" Width="122px">
                            <Columns>
                                
                                    
                               <asp:BoundField DataField="entryby" HeaderText="Employee" HeaderStyle-CssClass ="bgbluegrey" > 
                                ...
                                <asp:BoundField DataField="EMAIL" HeaderText="Mail" HeaderStyle-CssClass ="bgbluegrey" > 
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CHAT" HeaderText="Chat" HeaderStyle-CssClass ="bgbluegrey"> 
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SMS" HeaderText="SMS" HeaderStyle-CssClass ="bgbluegrey"> 
                                    <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                    </asp:BoundField>
