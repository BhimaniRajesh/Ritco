...
public partial class SFM_TDS_Cust_PopupReschedule : System.Web.UI.Page
{
    ...
    protected void btnSubmit_OnClick(object sender, EventArgs e)
    {
        ...
        //strSQL = "select p.ProspectCode,p.CompanyName from webx_ProspectCustomer p,Webx_Appointment a where p.ProspectCode=a.ProspectCode and p.ProspectCode is not null and p.Cflag is null";
        strSQL = "select p.ProspectCode,p.CompanyName from webx_ProspectCustomer p where p.ProspectCode is not null ";
        ...
        if (loclvl == 1)
        {
            ...
            {
                strSQL = strSQL + " AND p.ProspectCode LIKE '" + txtVendorCode.Value.Replace("'", "''") + "%'";
            }
            else if (txtVendorName.Value != "")
            {
                strSQL = strSQL + " AND p.CompanyName LIKE '" + txtVendorName.Value.Replace("'", "''") + "%'";
            }
