<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupLocation.aspx.cs" Inherits="REPORT_PopupLocation" %>
        ...
        <table border="0" width="100%" cellspacing="1" class="boxbg">
                <tr class="bgbluegrey">
                    ...
                    <td style="width: 15%" align="left">
                        &nbsp;
                        <asp:Label ID="lblLocationCode" runat="server" CssClass="blackfnt">Location Code
                        </asp:Label>
                ...
                <asp:Repeater ID="rptBranch" runat="server">
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                &nbsp;
                                <input id="radSelBranch" type="radio" value="<%#DataBinder.Eval(Container.DataItem,"LocCode")%>" onclick="Done(this);" runat="server" />
                            </td>
