<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Popup_Employee_CallRegister.aspx.cs" Inherits="GUI_SFM_REPORT_Popup_Employee_CallRegister" %>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: White">
                            <td style="width: 10%">
                                ...
                                <input id="radSelBranch" type="radio" value='<%# DataBinder.Eval(Container.DataItem, "UserID")%>' onclick="SelectCustomer(this);" runat="server" />
