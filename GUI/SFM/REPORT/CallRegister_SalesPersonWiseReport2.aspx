<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="CallRegister_SalesPersonWiseReport2.aspx.cs" Inherits="REPORT_CallRegister_SalesPersonWiseReport2" %>
...
<table style="width: 100%">
        ...
        <tr>
            <td align="left"  colspan="3">
                <asp:Label ID="lblWelcome" runat="server" Text="'<%callvisit%>' Register-Sales Person Wise Report" CssClass="blackfnt" Font-Bold="true"></asp:Label>
       ...
       <tr bgcolor="#ffffff"> 
        ...
        <td   align="center"> 
          <div align="left"><font class="blackfnt">
              <asp:Label ID="lblSalesPerson" runat="server" Text="Label"></asp:Label></font></div>
        </td>
       </tr>
       <tr bgcolor="#ffffff"> 
        <td> 
...
<asp:GridView ID="dgCallReg" runat="server" BorderWidth="1" CellSpacing="1" CellPadding="5" HeaderStyle-CssClass="bgbluegrey"
