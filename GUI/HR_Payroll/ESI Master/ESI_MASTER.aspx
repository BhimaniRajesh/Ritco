 <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    EnableEventValidation="true" CodeFile="ESI_MASTER.aspx.cs" Inherits="GUI_Finance_Fix_Asset_Fix_Asset_Add" %>
...
//}
     ...
     function ValidateData()
            {
             if(document.getElementById("ctl00_MyCPH1_txtesicd"))
                {
                    if(document.getElementById("ctl00_MyCPH1_txtesicd").value == "")
                    {
                        alert("Enter ESI Code ");
                        document.getElementById("ctl00_MyCPH1_txtesicd").focus();
                        return false;
                    }
              }
                ...
                <asp:Panel ID="pnl1" runat="server">
                    <table align="center" cellspacing="1" style="width: 80%" class="boxbg" border="0">
                        ...
                        <tr style="background-color: #ffffff">
                            ...
                            <td>
                                <%-- <asp:Label ID="txtesicd" CssClass="blackfnt"  ForeColor="red" runat="server">
                                      &lt System Generated... &gt
                    </asp:Label></td>--%>
                                <asp:TextBox ID="txtesicd"  MaxLength="25" onkeypress="javascript:return validAlfaNum(event)"   onblur="return checklocation(this)" runat="server"></asp:TextBox></td>
                            <td>
                                <label class="blackfnt">
                                    Validity Date :
                                </label>
                        ...
                        <tr style="background-color: #ffffff">
                            ...
                            <td>
                                <asp:TextBox ID="txtpfsallimit" Text="7500" onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"
                                    runat="server"></asp:TextBox></td>
                        </tr>
                        <tr style="background-color: #ffffff">
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtemp" Text="1.75" onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"
                                    runat="server"></asp:TextBox></td>
                            <td>
                                <label class="blackfnt">
                                    Employer % :
                            ...
                            <td>
                                <asp:TextBox ID="txtempr" Text="4.75" onkeypress="javascript:return validFloat(event,this.getAttribute('id'));"
                                    runat="server"></asp:TextBox></td>
                        </tr>
                        <tr style="background-color: #FFFFFF">
                            <td colspan="4" align="center" style="height: 21px">
