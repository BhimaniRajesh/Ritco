...
public partial class GUI_HR_Payroll_Master_Leave_master_Leave_Master_Step2 : System.Web.UI.Page
{
    ...
    protected void btnInactivate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string sql_delete = " update WEBX_LEAVETYPEMST set ACTIVEFLAG='Y',updatedby='" + empcd + "',updateddate=getdate() where LEAVE_CODE='" + code + "'";
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string sql_delete = " update WEBX_LEAVETYPEMST set Deleted='Y',updatedby='" + empcd + "',updateddate=getdate() where LEAVE_CODE='" + code + "'";
            SqlCommand sqlcmd1 = new SqlCommand(sql_delete, conn);
            sqlcmd1.Transaction = trans;
            sqlcmd1.ExecuteNonQuery();
