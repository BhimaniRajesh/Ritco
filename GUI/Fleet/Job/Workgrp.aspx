<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"       CodeFile="Workgrp.aspx.cs" Inherits="GUI_Job_Workgrp" %>
     ...
     <%-- <table  align="center" cellspacing="1" style="width: 100%">
        ...
        <td align="center" colspan="2">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" Mode="Conditional" RenderMode="Inline" runat="server">
                    <ContentTemplate>   --%>
      <table cellspacing="1" align="center"   style="width: 80%">
          <tr align="center" >
            <td  colspan="2" >
                <table cellspacing="1" style="width: 70%">
                    <tr style="background-color: white">
                        <td align="left">
                            ...
                            <asp:LinkButton ID="lnkCreateWG" runat="server" Text="Create Work Group" CssClass="bluefnt"   PostBackUrl="~/GUI/Fleet/Job/Workgrpdet.aspx"  ValidationGroup="VGCreate"></asp:LinkButton>    
                        </td>
                    </tr>
                </table>
                ...
                <table cellspacing="1" style="width: 70%" class="boxbg">                                                                    
                        ...
                        <td colspan="2" align="center">
                         ...
                         <tr style="background-color: white" align="center">
                            ...
                            <td  >
                                &nbsp;<asp:DropDownList ID="ddlVehCategory" runat="server">
                        ...
                        <td colspan="2" style="height: 211px">
                           <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                             ...
                             <asp:GridView id="dgWorkgroup" runat="server"  OnRowCommand="dg_RowCommand" CellSpacing="1" BorderColor="#8BA0E5" BorderWidth="1px"  
                              CssClass="dgRowStyle"  HeaderStyle-CssClass="dgHeaderStyle" PageSize="1000" EmptyDataText="No Records Found" DataKeyNames="w_GRPCD"
                             ...
                             Width="100%" Height="1px"  >
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SIDays" HeaderText="Service Intervals Days">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SIKMS" HeaderText="Service Intervals Kms">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
