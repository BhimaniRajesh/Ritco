...
public partial class GUI_Fleet_Job_AckJobNext : System.Web.UI.Page
{
    ...
    protected void cmdSubmit_Click(object sender, EventArgs e)
    {
       ...
       string str = "update WEBX_FLEET_PM_JOBORDER_HDR  set KM_READING='" + KmRead + "',TOT_EST_LABOUR_HRS='" + Hrs + "',TOT_EST_LABOUR_COST='" + Cost + "',  TOT_EST_PART_COST='" + totcost + "' ,Order_status='Acknowledged'  where Job_order_No='" + OrderNo + "'";
       SqlCommand cmd = new SqlCommand(str, conn);
       cmd.ExecuteNonQuery();
       ...
       conn.Close();
       string mOrderNo = lblWONo.Text.Trim();
       Response.Redirect("AckJobResult.aspx?OrderNo=" + mOrderNo);
