<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"      CodeFile="Workgrpdet.aspx.cs" Inherits="GUI_Job_Workgrp" %>
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
   ...
   
   {
     ...
     var Cat=document.getElementById("ctl00_MyCPH1_ddlVehCategory").value;
    ...
    <br/>
       ...
       <table   align="center" cellspacing="1" cellpadding="2" class="boxbg">
                         ...
                         <tr style="background-color: white" align="center">
                             ...
                             <td align="right" >
                                 <asp:Label ID="lblVehicle" runat="server" Text="Enter Vehicle Category" CssClass="bluefnt"  ></asp:Label>
                              &nbsp;
                                </td>
                            <td align="left" >
                                &nbsp;<asp:DropDownList ID="ddlVehCategory" runat="server"    AutoPostBack="true" OnSelectedIndexChanged="ddlVehCategory_SelectedIndexChanged">
                                 
                             </asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="reqddlVehCategory" runat="server" Display="Dynamic" Text="!" ControlToValidate="ddlVehCategory"></asp:RequiredFieldValidator>
                                </td>
                 ...
                 <asp:TextBox ID="txtRow" runat="server" MaxLength="3" Width="30"   onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   BorderStyle="Groove"  Text="0" AutoPostBack="true" OnTextChanged="txtRow_TextChanged"></asp:TextBox>
                            ...
                            <tr style="background-color: white">
                        <td colspan="2">
                             <asp:datagrid id="dgWorkgroup" runat="server" PageSize="1000"   OnItemCommand="dgWorkgroup_ItemCommand" OnItemDataBound="DataGrid1_ItemDataBound"      AutoGenerateColumns="False" CellPadding="2" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CssClass="Styles.css" CellSpacing="1" Width="100%" Height="1px" ItemStyle-HorizontalAlign=Left   >
                                ...
                                <Columns >
	                         	<asp:TemplateColumn HeaderText="Sr.No.">
	                              ...
	                              <asp:TemplateColumn HeaderText="Service Intervals Days"  >
	                               ...
	                               <asp:TemplateColumn HeaderText="Advcnce Notification Days">
	                                <ItemTemplate>
	                                  ...
	                                  <asp:TemplateColumn HeaderText="Advcnce Notification Kms">
	                                <ItemTemplate>
                      ...
                      <tr style="background-color: white">
                          ...
                          <%--      <asp:UpdatePanel ID="UpdatePanel8" Mode="Conditional" RenderMode="Inline" runat="server">
                                    <ContentTemplate>--%>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlVehCategory" EventName="SelectedIndexChanged" />
                          <asp:AsyncPostBackTrigger ControlID="txtRow" EventName="TextChanged" />
                     <%--       <asp:ControlEventTrigger ControlID="ddlUnit" EventName="SelectedIndexChanged" />--%>
                    </Triggers>
                 </asp:UpdatePanel> 
                        </td>
                        </tr>
