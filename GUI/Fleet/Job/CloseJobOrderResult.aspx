<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/GUI/MasterPage.master"  CodeFile="CloseJobOrderResult.aspx.cs" Inherits="GUI_Fleet_Job_CloseJobOrderResult" %>
...
<%
   ...
   if (Flag == "C")
   {
       lblHeader1.Text = "Following Job Order is Closed";
   }
   else
   {
       lblHeader1.Text = "Following Job Order is updated";
   }
 %>
    ...
    <table border="0" class="boxbg" cellpadding="2" cellspacing="1" width="75%">
        <tr class="bgbluegrey">
            <td align="center" colspan="3">
                &nbsp;<asp:Label ID="lblHeader1" runat="server"    Font-Bold="true" Text="Following Job Order is Closed" CssClass="blackfnt"></asp:Label>
            </td>
        </tr>
       ...
       <tr style="background-color:White">
        ...
        <tr style="background-color:White" runat="server" id="rowCloseError" visible="false"  >
            <td align="left" colspan="3">
                <asp:Label ID="lblCloseError" runat="server" Text Font-Bold="true" CssClass="redfnt"></asp:Label>
            </td>
        </tr>
        ...
        <tr class="bgbluegrey">
         ...
         <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="lnkStep2" runat="server" Text="Close More Job Orders" CssClass="blackfnt" PostBackUrl="JobOrderCloseQuery.aspx"/>&nbsp;&nbsp;&nbsp;&nbsp&nbsp;
            </td>
        </tr>
        
        <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="lnkStep1" runat="server" Text="Prepare More Job Orders" CssClass="blackfnt" PostBackUrl="PrepareJob.aspx"/>&nbsp;&nbsp;&nbsp;&nbsp&nbsp;
            </td>
        </tr>
