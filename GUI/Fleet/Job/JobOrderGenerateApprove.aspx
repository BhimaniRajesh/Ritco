<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="JobOrderGenerateApprove.aspx.cs" Inherits="GUI_Fleet_JobOrderGenerate" %>
...
<asp:UpdatePanel ID="u1" UpdateMode="Always" runat="server">
    ...
    <table cellspacing="1" style="width: 100%">
        <tr style="background-color: white">
            <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="true" runat="server">Generation Jobsheet Approval</asp:Label>
            </td>
...
<hr align="center" size="1" color="#8ba0e5">
 ...
 <table cellspacing="1" style="width: 100%">
            <tr align="center">
                <td align="left">  
        <%--<asp:HyperLink ID="hylnkMailSettings" runat="server" Font-Names="Verdana" Font-Size="9pt" 
                 onmouseover="this.style.cursor='pointer';"        Font-Underline="True" ForeColor="Blue" >Mail Settings</asp:HyperLink>--%>
 </td>
 </tr>
            <tr align="center">
                <td align="left">  
       ...
       <table  cellspacing="1" cellpadding="2" style="width: 70%" class="boxbg">
                        ...
                        <tr style="background-color: white">
                            ...
                            <td align="left" >
                                        ...
                                        <asp:TextBox CssClass="input" ID="txtJobOrderNo" runat="Server" ValidationGroup="VGRequestID" BorderStyle="Groove" ></asp:TextBox>
...
<br />
 ...
 <table cellspacing="1" style="width: 85%" align="left">
     ...
     <asp:GridView ID="gvJobOrder" runat="server" PageSize="1000"  
            AutoGenerateColumns="False" CellPadding="2" BackColor="White" 
            BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" 
            CssClass="Styles.css" CellSpacing="1" Width="100%" Height="1px" 
            ItemStyle-HorizontalAlign=Left onrowdatabound="gvJobOrder_RowDataBound"  >
                <FooterStyle BackColor="#8BA0E5" ForeColor="#003399" />
                <SelectedRowStyle BackColor="#009999" Font-Bold="True" ForeColor="#CCFF99" />
                <PagerStyle HorizontalAlign="Center" Font-Bold="True" Font-Underline="True" BackColor="#8BA0E5" ForeColor="White" Wrap="False" CssClass="whitefnt"></PagerStyle>
                ...
                <asp:TemplateField HeaderText="Job Order No">
                    <ItemTemplate>
                        ...
                        NavigateUrl='<%# Eval("JOB_ORDER_NO", "UpdateJob.aspx?OrderNo={0}") %>' 
                ...
                <asp:BoundField DataField="SERVICE_CENTER_TYPE" HeaderText="Service Type">
                 ...
                 <asp:BoundField DataField="Tot_Estimated_Cost" HeaderText="Amount">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                </asp:BoundField>
                ...
                <asp:TemplateField HeaderText="Approve">
                    ...
                    <asp:TemplateField HeaderText="Remarks">
                       <ItemTemplate>
                           <asp:TextBox ID="tb_Remarks" Text='<%# Eval("JS_Approval_Remarks") %>' CssClass="input" BorderStyle="Groove"  runat="server"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
       ...
       <font class="blackfnt" style="color:greeen;">
            <b><asp:Label ID="lblStatus" runat="server" Font-Size="Small" Text=""></asp:Label></b>
        </font>
    </center>
            </td>
        </tr>
