<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/GUI/MasterPage.master"  CodeFile="TirePatternSearch.aspx.cs" Inherits="TyrePatternSearch" %>
                ...
                <table cellspacing="1" style="width: 100%">
                    <tr style="background-color: white">
                        <td align="left" style="height: 26px">
                            ...
                            <asp:LinkButton ID="lnkCreateDriver" runat="server" Text="Create Tyre Pattern" CssClass="bluefnt" Font-Bold="true" PostBackUrl="~/GUI/Fleet/Webadmin/Tyre/TyrePattern.aspx"  ValidationGroup="VGCreate"></asp:LinkButton></td>
                       ...
                       <tr style="background-color: white">
                        <td align="right" style="width: 25%; text-align: left">
                            ...
                            <asp:Label ID="lblTyreSize" runat="server" Text="Enter Tyre Pattern Code:"  Font-Bold="True" CssClass="blackfnt"></asp:Label>
