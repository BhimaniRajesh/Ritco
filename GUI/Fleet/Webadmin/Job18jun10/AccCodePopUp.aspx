...
<body>
    <form id="form1" runat="server">
                    ...
                    <asp:SqlDataSource ID="SqlConn" runat="server" ProviderName="System.Data.SqlClient"
                            SelectCommand="select distinct Company_Acccode as company_Acccode,Accdesc from webx_acctinfo  WITH(NOLOCK) where ACCCATEGORY='EXPENSE' and ActiveFlag='Y'">
                        </asp:SqlDataSource>
                        <asp:DataList ID="DataList1" 
                            HeaderStyle-CssClass="dgHeaderStyle"  runat="server" 
                            DataSourceID="SqlConn" Width="100%" DataKeyField="company_Acccode" Font-Names="Verdana" Font-Size="8pt">
                            ...
                            <ItemTemplate>
                                <table style="width: 100%" cellpadding="0" cellspacing="1"  class="boxbg">
                                    <tr  style="background-color: white">
                                        <td style="width: 10%">
                                            <input type="radio" name="radSelect" onclick="javascript:selectTyre(this);" value='<%#Eval("company_Acccode")%>~<%#Eval("Accdesc")%>'  />
                                        </td>
                                        <td style="width: 20%">
                                            <asp:Label ID="lbl_TYRE_ID" runat="server" Text='<%#Eval("company_Acccode")%>'></asp:Label>
                                        </td>
                                        <td style="width: 70%">
