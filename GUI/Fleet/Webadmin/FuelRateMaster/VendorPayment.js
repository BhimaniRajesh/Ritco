...
function Total_calC_THC_BalPayment(OBJ, Cnt, COl_Cnt, Contract_Type) {
    ...
    if (parseFloat(Tot_ind_Balamt) <= 0) {
        ...
        //	        Hnd_SCHG_Arr_1 = document.getElementById(Form_name + "Hnd_SCHG").value.split("*/");
        //	        for (var k = 0; k < Hnd_SCHG_Arr_1.length; k++) {
        //	            j = parseFloat(k) + parseFloat(1);
        //	            if (document.getElementById(Form_name + "SCHG" + j)) {
        //	                Code_Operand_Arr = Hnd_SCHG_Arr_1[k].split("~");
        //	                document.getElementById(Form_name + "SCHG" + j).value = "0.00";
        //	            }
        //	        }
    }
    else {
...
//                  //}
//                  if (PaymentAmt_Flag == "N") {
//                      //alert(document.getElementById(FRM_NM + "RD_Process_Payment").checked);
//                      if (document.getElementById(FRM_NM + "RD_Process_Payment").checked) {
//                          document.getElementById(Form_name + "indNetBillPaymentAmt").value = rounditn(Tot_ind_Balamt, 2);
//                      }
//                  }
...
function Stax_Tds_Calc() {
    ...
    var txtServiceTaxRate = document.getElementById(FRM_NM + "txtServiceTaxRate");


    if (document.getElementById(FRM_NM + "Svctax_yn").checked) {
        txtServiceTaxRate.disabled = false;
        txtServiceTaxRate.value = hdnServiceTaxRate.value;
        txtServiceTaxRate.disabled = true;
        AmtAply = document.getElementById(FRM_NM + "txtAmtAppl").value
        document.getElementById(FRM_NM + "txtServiceTax").value = rounditn((parseFloat(AmtAply) * parseFloat(hdnServiceTaxRate.value)) / 100, 2)
        document.getElementById(FRM_NM + "txtEduCess").value = rounditn((parseFloat(document.getElementById(FRM_NM + "txtServiceTax").value) * parseFloat(hdnEduCessRate.value)) / 100, 2)
        document.getElementById(FRM_NM + "txtHEduCess").value = rounditn((parseFloat(document.getElementById(FRM_NM + "txtServiceTax").value) * parseFloat(hdnHEduCessRate.value)) / 100, 2)
    ...
    //alert(Total_BalanceAMT)
    // alert(document.getElementById(FRM_NM+"DDL_Process").value)
...
function GetServiceTax() {
    ...
    var txtVoucherDate = document.getElementById(FRM_NM + "Txt_VDate");
    var hdnOldVendorBillDate = document.getElementById(FRM_NM + "hdnOldVendorBillDate");
    ...
    if (hdnOldVendorBillDate.value != txtVoucherDate.value) {
        ...
        if (xmlHttpRequest) {
            ...
            xmlHttpRequest.open("GET", "../../AjaxResponse.aspx?Method=GetServiceTax&Parameter1=" + txtVoucherDate.value + "&datetime=" + currentTime, false);
...
function Check_Calc_BA(Grd_Name, Obj_chk_All, Obj_Chk_Ind) {
    ...
    for (var b = 2; b <= rows; b++) {
        ...
        Check_Calc_BA_Individual(document.getElementById(GV_FRM_NM + Obj_Chk_Ind));
...
function Calc_BA_OtherAmount() {
    ...
    document.getElementById(FRM_NM + "txtAmtApplL").value = rounditn(parseFloat(TaxAmount) + parseFloat(AmtAply_Tds) + parseFloat(document.getElementById(FRM_NM + "Txt_OthAmt").value) - parseFloat(document.getElementById(FRM_NM + "Txt_Oth_ded").value), 2);
    document.getElementById(FRM_NM + "txtTDSRate").value = rounditn(document.getElementById(FRM_NM + "txtTDSRate").value, 3)
    if (document.getElementById(FRM_NM + "TDS_yn").checked) {
        AmtAply = parseFloat(document.getElementById(FRM_NM + "txtAmtApplL").value);
        //alert(AmtAply)
        document.getElementById(FRM_NM + "txtTDSAmt").value = rounditn((parseFloat(AmtAply) * parseFloat(document.getElementById(FRM_NM + "txtTDSRate").value)) / 100, 2)
        TaxAmount = parseFloat(TaxAmount) - parseFloat(document.getElementById(FRM_NM + "txtTDSAmt").value)
