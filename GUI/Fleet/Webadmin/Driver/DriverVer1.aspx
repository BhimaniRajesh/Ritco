<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="DriverVer1.aspx.cs" Inherits="GUI_Fleet_Webadmin_Driver_DriverVer1" %>
                ...
                <table cellspacing="1" style="width: 70%">
                    <tr style="background-color: white">
                        <td align="left">
                            ...
                            <asp:LinkButton ID="lnkCreateDriver" runat="server" Text="Create Driver" CssClass="bluefnt" Font-Bold="true" PostBackUrl="~/GUI/Fleet/Webadmin/Driver/DriverDetVer1.aspx"  ValidationGroup="VGCreate"></asp:LinkButton>    
                        ...
                        <asp:GridView ID="dgDriver" runat="server" BorderWidth="1px" CellSpacing="1" CellPadding="5" HeaderStyle-CssClass="dgHeaderStyle" 
                            ...
                            <Columns>
                                <asp:HyperLinkField DataTextFormatString="--Select--" DataTextField="Driver_Id" DataNavigateUrlFields="Driver_Id"
                                    DataNavigateUrlFormatString="~/GUI/Fleet/Webadmin/Driver//DriverDetVer1.aspx?id={0}" >
