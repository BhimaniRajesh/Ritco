...
<script language="javascript" type="text/javascript">
 ...
 function lnkbtnXLS_Click()
     ...
     function lnkbtnView_Click()
    {
     ...
     window.open('GeneralTaskReport.aspx','new_win','width=700,height=500,scrollbars=yes');
      //window.open("GeneralTaskReport.aspx","");
    }
    function lnkbtnPrint_Click()
    {
      window.open("GeneralTaskReport.aspx?print=0','new_win','width=600,height=500,scrollbars=yes");
      //window.open("GeneralTaskReport.aspx","");
    }
...
<%--                    <Triggers>
                        <asp:ControlEventTrigger ControlID="cmdSubmit" EventName="Click" />
                              
                                 <asp:ControlEventTrigger ControlID="btnSubmit" EventName="Click" />
                                     <asp:ControlEventTrigger ControlID="txtRow" EventName="TextChanged" />
                    </Triggers>
               --%>
                                </asp:UpdatePanel>
