...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="Claim Tyre Register"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table width="700px" border="1" align="left" cellpadding="0" cellspacing="0" class="boxbg">
                    ...
                    <tr style="background-color: white">
                        <td align="left" valign="top">
                            <asp:Label ID="Label2" runat="server" CssClass="blackfnt" Font-Bold="true" Text="Select Date :"></asp:Label>
                        </td>
                        <td valign="top">
                    ...
                    <tr style="background-color: white">
                        <td>
                            <asp:Label ID="Label6" runat="server" CssClass="blackfnt" Font-Bold="true" Text="Enter Vendor :"
                    ...
                    <tr class="bgwhite">
                        <td>
                            <asp:Label ID="Label3" runat="server" CssClass="blackfnt" Font-Bold="true" Text="Select Status :"></asp:Label>
                        </td>
                        <td>
