...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="Old Tyre Register"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table width="700PX" border="1" align="left" cellpadding="0" cellspacing="0" class="boxbg">
                    <tr class="bgbluegrey">
                        <td colspan="2" align="center">
                            <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="Old Tyre Register"></asp:Label>
                        </td>
                    </tr>
