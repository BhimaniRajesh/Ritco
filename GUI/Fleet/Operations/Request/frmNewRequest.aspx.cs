...
public partial class Request_frmNewRequest : System.Web.UI.Page
{
    ...
    protected void SubmitData(object sender, EventArgs e)
    {
        ...
        IssueYear = Convert.ToDateTime(DtCal.CalenderText(), year);
        ...
        //if (Session["FinYear_Change"] != null)
        {
            ...
            string yr = "";
            selvaluesArr1 = mYearVal.Split(new char[] { '_' });
            ...
            if (mYear.Substring(2, 3).Trim() != mYearVal.Substring(0, 2).Trim() &&  mYear.Substring(2, 3).Trim() != yr.Trim())
            {
                ErrMsg = "Selected Financial Year & Issue Date Year should be Same";
        ...
        if (lblError.Text == "")
        {
            ...
            else
            {
                ...
                string thisYear = Convert.ToString(DtCal.CalenderText());
