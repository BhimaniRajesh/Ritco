 ...
 %>
    ...
    <p align="center">
        <table cellspacing="1" cellpadding="3" style="width: 85%" class="boxbg" border="0">
            ...
            <tr class="bgbluegrey">
                <td colspan="4" align="center">
                    <asp:Label ID="lblHeader" runat="server" CssClass="blackfnt" Font-Bold="true" Text="NEW VEHICLE REQUEST FORM"></asp:Label></td>
    ...
    <%--                    <asp:TextBox ID="txtRequestBy" CssClass="input" runat=server MaxLength="50" Width="240" BorderStyle="Groove"></asp:TextBox>
    ...
    --%>                    <asp:DropDownList ID="cboRequestBy" runat=server  OnSelectedIndexChanged="FillOrgnAddr" AutoPostBack=true></asp:DropDownList>
