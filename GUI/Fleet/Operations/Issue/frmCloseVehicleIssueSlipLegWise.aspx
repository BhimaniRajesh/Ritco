...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script type="text/javascript" language="javascript" src="AJAX_Validator/NewTripGenerate.js?v2"></script>
      
    <script type="text/javascript" language="javascript" src="AJAX_Validator/NewTripDetailsUpdate.js?v2"></script>
    <script src="AJAX_Validator/TripClousre.js" type="text/javascript"></script>
                                        ...
                                        <asp:TemplateField HeaderText="Amount Spent">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtAmount" CssClass="input" Width="75px" Style="text-align: right"
                                                    runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"Amount") %>' onkeypress="javascript : return validFloat(event,this.getAttribute('id'))"
