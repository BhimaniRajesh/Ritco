...
public partial class Issue_frmVehicleIssueSlipClose_result : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        string sql = "select Top 1 VoucherRefno,end_dt_tm from WEBX_TRIPSHEET_ADVEXP A, webx_fleet_vehicle_issue I where I.vslipno=a.tripsheetno and tripsheetno='" + VSlipNo + "' and branchcode='" + SessionUtilities.CurrentBranchCode.ToString().Trim() + "' ORDER BY A.Entrydt DESC";
