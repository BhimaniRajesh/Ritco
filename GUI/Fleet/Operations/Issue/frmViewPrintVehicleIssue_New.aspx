<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="frmViewPrintVehicleIssue_New.aspx.cs"
    Inherits="GUI_Fleet_Operations_Issue_frmViewPrintVehicleIssueSlipLegWise" %>
    ...
    <table cellspacing="1" cellpadding="2" width="95%" align="center" class="boxbg" border="0"
        ...
        <tr style="background-color: white">
            <td colspan="4" align="left" style="vertical-align: top; text-align: left">
                <div>
                        ...
                        font-family: Verdana">
                         ...
                         <tr>
                            <td align="left" colspan="6" valign="top">
                                <asp:GridView ID="gvTHCDet" runat="server" CellPadding="1" AutoGenerateColumns="False"
                                    Width="100%">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FreightAmt" HeaderText="Freight Amount">
                                            <HeaderStyle HorizontalAlign="right" Wrap="False" />
                                            <ItemStyle HorizontalAlign="right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="LabourAmt" HeaderText="Labour Amount">
                                            <HeaderStyle HorizontalAlign="right" Wrap="False" />
                                            <ItemStyle HorizontalAlign="right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="OtherAmt" HeaderText="Other Amount">
                                            <HeaderStyle HorizontalAlign="right" Wrap="False" />
                                            <ItemStyle HorizontalAlign="right" />
                                        </asp:BoundField>
                    ...
                    <table border="0" cellpadding="3" cellspacing="0" style="font-size: 7pt; width: 100%;
                        ...
                        <tr>
                            <td align="left" colspan="6" valign="top">
                                <asp:GridView ID="gvVehicleLogEntry" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    PagerSettings-Mode="Numeric" PagerStyle-HorizontalAlign="left" Visible="true">
                                    <Columns>
                                        <asp:BoundField DataField="From_Point" HeaderText="From City">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="To_Point" HeaderText="To City">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Start_Date_Tm" HeaderText="Start Date">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="End_Date_Tm" HeaderText="End Date">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="KM_Read" HeaderText="Distance KM">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                        ...
                        <tr>
                            <td align="left" colspan="6" valign="top">
                                <asp:GridView ID="gvExternalTHC" runat="server" Width="100%" AutoGenerateColumns="False"
                                    BorderWidth="1px" CellPadding="1" CellSpacing="1" EmptyDataText="No Records Found..."
                                    PagerSettings-Mode="Numeric" PagerStyle-HorizontalAlign="left" Visible="true">
                                    <Columns>
                                        <asp:BoundField DataField="ExternalTHCNo" HeaderText="External THCNo">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ContractAmount" HeaderText="Contract Amt">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="BalanceAmount" HeaderText="Balance Amt">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="ADV_VOUCHERNO" HeaderText="ADV_VOUCHERNO">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="TransporterChallanNo" HeaderText="Transporter ChallanNo">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="LoadingDate" HeaderText="Loading Date">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="BrokerName" HeaderText="Broker Name">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="BalancePayment" HeaderText="Branch Code">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                    </Columns>
                        ...
                        <tr>
                            <td align="left" colspan="6" valign="top">
                                <asp:GridView ID="gvTripBill" runat="server" Width="100%" AutoGenerateColumns="False"
                                    BorderWidth="1px" CellPadding="1" CellSpacing="1" EmptyDataText="No Records Found..."
                                    PagerSettings-Mode="Numeric" PagerStyle-HorizontalAlign="left" Visible="true">
                                    <Columns>
                                        <asp:BoundField DataField="THCNo" HeaderText="External THCNo">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="THCDt" HeaderText="THC Date">
            ...
            <asp:Label ID="lblChecklist" Text="Checklist" runat="server"></asp:Label></td>--%>
                ...
                <div>
                    <br />
                    <table id="Table2" runat="server" border="0" cellpadding="1" cellspacing="0" style="font-size: 7pt;
                        width: 100%; font-family: Verdana">
                        <tr>
                            <td align="left" style="width: 17%;" valign="top" rowspan="3">
                    ...
                    <table border="0" cellpadding="3" cellspacing="0" style="font-size: 7pt; width: 100%;
                        ...
                        <tr>
                            <td align="left" colspan="6" valign="top" style="font-weight: bold; height: 20px;
                                vertical-align: bottom; text-align: left;">
                                <asp:Label ID="Label3" Text="EXTERNAL CUSTOMER DETAILS" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="3" valign="top" style="width: 100%;">
                                <asp:GridView ID="gvExternalCustomer" runat="server" CellPadding="1" AutoGenerateColumns="False"
                                    Width="100%" ShowFooter="false" ShowHeader="true">
                                    <Columns>
                                        <asp:BoundField DataField="LEG" HeaderText="LEG">
                                        ...
                                        <asp:BoundField DataField="CHALLAN_DETAILS" HeaderText="CHALLAN DETAILS">
                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="BROKER_DETAILS" HeaderText="BROKER DETAILS">
                                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="BILL_FREIGHT_AMT" HeaderText="BILL FREIGHT AMT">
                                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="FREIGHT_ADVANCE" HeaderText="FREIGHT ADVANCE">
                                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="FREIGHT_BALANCE" HeaderText="FREIGHT BALANCE">
                                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                    ...
                    <table border="0" cellpadding="3" cellspacing="0" style="font-size: 7pt; width: 100%;
                        ...
                        <tr>
                            <td align="left" colspan="3" valign="top" style="width: 60%;">
                                <asp:GridView ID="GridView1" runat="server" CellPadding="1" AutoGenerateColumns="False"
                                    Width="100%" ShowFooter="false" ShowHeader="false">
                                    <Columns>
                                        <asp:BoundField DataField="" HeaderText="Legname1">
                                        ...
                                        <asp:BoundField DataField="Legname1" HeaderText="Legname1">
                                            <ItemStyle HorizontalAlign="Left" Width="8%" Font-Bold="true" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Legname2" HeaderText="Legname2">
                                            <ItemStyle HorizontalAlign="Left" Width="8%" Font-Bold="true" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Legname3" HeaderText="Legname3">
                                            <ItemStyle HorizontalAlign="Left" Width="8%" Font-Bold="true" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Legname4" HeaderText="Legname4">
                                            <ItemStyle HorizontalAlign="Left" Width="8%" Font-Bold="true" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Legname5" HeaderText="Legname5">
                                            <ItemStyle HorizontalAlign="Left" Width="8%" Font-Bold="true" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Legname6" HeaderText="Legname6">
                                            <ItemStyle HorizontalAlign="Left" Width="8%" Font-Bold="true" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                            ...
                            <td align="left" colspan="3" valign="top" style="width: 60%;">
                                <asp:GridView ID="gvExpDetails" runat="server" CellPadding="1" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Standard1" HeaderText="Standard">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Actual1" HeaderText="Actual">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Standard2" HeaderText="Standard">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Actual2" HeaderText="Actual">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Standard3" HeaderText="Standard">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Actual3" HeaderText="Actual">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Standard4" HeaderText="Standard">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Actual4" HeaderText="Actual">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Standard5" HeaderText="Standard">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Actual5" HeaderText="Actual">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Standard6" HeaderText="Standard">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                            <FooterStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Actual6" HeaderText="Actual">
                                            <ItemStyle HorizontalAlign="Right" Width="4%" />
                                            <HeaderStyle HorizontalAlign="Left" Wrap="False" />
