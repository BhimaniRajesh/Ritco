<%@ Page Language="C#"    MasterPageFile="~/GUI/MasterPage.master"    AutoEventWireup="true" CodeFile="TripsheetQuery.aspx.cs" Inherits="GUI_Fleet_Operations_Issue_TripsheetQuery" %>
  ...
  <asp:UpdateProgress ID="uppMain" runat="server">
    ...
    <table cellspacing="1" style="width: 100%">
        <tr style="background-color: white">
            <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="true" runat="server">Edit/Update Trip Sheet Advance Detail >> Query</asp:Label>
...
<table  align="center" cellspacing="1" width="100%">
            <tr align="left">
                <td align="left">  
       <table align="left"  cellspacing="1" cellpadding="2" width="65%" class="boxbg">
                        <tr class="bgbluegrey">
                    ...
                    <ContentTemplate>
                     ...
                     <asp:datagrid id="DataGrid1" runat="server" PageSize="1000"  AutoGenerateColumns="False" CellPadding="2" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CssClass="Styles.css" CellSpacing="1" Width="100%" Height="1px" ItemStyle-HorizontalAlign=Left  ><%--OnItemDataBound="DataGrid1_ItemDataBound"--%>
                                ...
                                <asp:BoundColumn DataField="IssueStatus" HeaderText="Status">
                                 ...
                                 <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo"   DataNavigateUrlFormatString="TripsheetEdit.aspx?id={0}" Text="Edit" HeaderText="Edit/Update" HeaderStyle-HorizontalAlign="Left">
