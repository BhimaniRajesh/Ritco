...
function onSubmitt(obj) {
    var lblIssueDt = document.getElementById("ctl00_MyCPH1_lblIssueDt"); 
    var grid1 = document.getElementById("ctl00_MyCPH1_dgAdvancedet");
    var r1 = grid1.rows.length;
    ...
    for (i = 0; i < r1 - 1; i++) {
        ...
        var txtAdvDt = document.getElementById(pref + "txtAdvDt");
        if (!IsDateGreater(txtAdvDt.value, lblIssueDt.innerText))
        {
            alert("Advance date can not be less than Issue Slip date " + lblIssueDt.innerText + "!!!")
            document.getElementById(pref + "txtAdvDt").focus();
            return false
        }
