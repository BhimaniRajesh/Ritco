<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup-city1.aspx.cs" Inherits="GUI_Operation_Singlescreen_docketentry_popup_city1" %>
     ...
     <link href="../../../images/style.css"rel="stylesheet" type="text/css" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            function SelectCustomer(objCustomer)
            {
                ...
                var mQSParam = qs.get("city_mode");
                
                if(mQSParam == 13)
                {
                    window.opener.document.forms[0].txtFromCity.value = objCustomer.value
                }
                
                //Get count of records fetched
                var mTotalRecords = document.getElementById("hfintTotalRecords").value;
            ...
            <table border="0" width="99%" cellspacing="1" cellpadding="0">
                <tr>
                    <td align="left" style="height: 32px">
                        <asp:HiddenField ID="hfintTotalRecords" runat="server" />
                        ...
                        <label id="lblNote" class="blackfnt">
                            - For All Cities list,keep blank both the input box.
                        </label>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td align="left">
                        ...
                        <label id="lblSelCustomerNote" class="blackfnt">
                            - Click on radio buton to select City.
                        </label>
                    </td>
                </tr>
            </table>
