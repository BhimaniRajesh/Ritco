<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AMACValidation.ascx.cs" Inherits="GUI_Fleet_Operations_Issue_AutoComplete1_AMAC" %>
    ...
    function dacCodeKeyUp(e, WEBX, init) {
        ...
        if (code == 40) {
            ...
            if (findobj) {
                ...
                var strpg = fileURL.substring(0, cnt) + '/GUI/Fleet/Operations/Issue/AutoComplete1/_mac_data.aspx?tp=' + WEBX.WebxComplete.Type + '&target1=' + WEBX.WebxComplete.Target1.getAttribute('id');
