        ...
        <td colspan=4 align=left>
           <table cellspacing="1" cellpadding="2" width="100%" align="left" class="boxbg" border="1" bgcolor="#8BA0E5">
            ...
            <tr style="background-color: white">
                ...
                <td align="left">
                  <font class=blackfnt><%=Custcode%>/<%=Custname%></font>
                </td>
                <%  }
              ...
              <tr class="bgbluegrey">
                <td colspan=4 align=left><font class=blackfnt><b>THC Details</b></font></td>
            </tr>
         ...
         <tr style="background-color: white">
             ...
             <tr style="background-color: white">
              <td align="left" >
                ...
                <td align="left">
                   <font class=blackfnt >
                       <font class=blackfnt><%=Driver1Name%>
                ...
                <td align="left">
                   <font class=blackfnt >
                     <font class=blackfnt><%=Driver2Name%>
                     <%if (Driver2MCode!=""){%>
            ...
            <tr style="background-color: white">
              <td align="left" >
                ...
                <td align="left">
                   <font class=blackfnt >
                       <font class=blackfnt><%=Driver1MCode%></font>
                   </font>
                </td>
                ...
                <td align="left">
                   <font class=blackfnt >
                     <font class=blackfnt><%=Driver2MCode%></font>
                   </font>
                </td>
             ...
             <tr style="background-color: white">
              <td align="left" >
                ...
                <td align="left">
                   <font class=blackfnt >
                       <font class=blackfnt><%=Drvier1_License_no%></font>
                   </font>
                </td>
                ...
                <td align="left">
                   <font class=blackfnt >
                     <font class=blackfnt><%=Drvier2_License_no%></font>
                   </font>
                </td>
            ...
            <tr style="background-color: white">
              <td align="left" >
                ...
                <td align="left">
                   <font class=blackfnt >
                       <font class=blackfnt><%=Driver1_valdity_dt%></font>
                   </font>
                </td>
                ...
                <td align="left">
                   <font class=blackfnt >
                     <font class=blackfnt><%=Driver2_valdity_dt%></font>
                   </font>
                </td>
            ...
            <tr style="background-color: white">
              <td align="left" >
                ...
                <td align="left" colspan=3>
                   <font class=blackfnt >
                       <font class=blackfnt><%=Driver1_OpBal%></font>
                   </font>
                </td>
             ...
             <tr style="background-color: white">
              <td align="left" >
                ...
                <td align="left" >
                 ...
                 <td align="left">
                   <font class=blackfnt><%=Set_Unset%></font> 
                </td>
                </tr>
                ...
                <td align="left" >
                 ...
                 <td align="left">
                   <font class=blackfnt><asp:Label ID="lblPreDr2" runat="server" Text=""></asp:Label></font> 
                </td>
                </tr>
                ...
                <td align="left" >
                 ...
                 <td align="left" >
                  <font class=blackfnt><asp:Label ID="lblPreDrv1Man" runat="server" Text=""></asp:Label></font> 
                </td>
                 ...
                 <td align="left">
                   <font class=blackfnt><asp:Label ID="lblPreDrv2Man" runat="server" Text=""></asp:Label></font> 
                </td>
                </tr>
             ...
             <tr style="background-color: white">
                <td colspan=4 align=left>
                 ...
                 <tr class="bgbluegrey" runat="server" id="vehlogentryhdr"  >
                <td colspan=4 align=left><font class=blackfnt><b>Vehicle Log Entry</b></font></td>
            </tr>
         
            
             <tr style="background-color:White" align="center" runat="server" id="vehlogentrydet"  >
...
<%--           New Change--%>
       <tr class="bgbluegrey">
            ...
            <tr class="bgbluegrey" id="DriverLedgerHdr" runat=server visible="false">
                <td colspan="4" align="left">
                    <asp:Label ID="Label6" runat="server" CssClass="blackfnt" Font-Bold="true" Text="Driver Settlement Details"></asp:Label></td>
             </tr>
            <tr style="background-color: white" id="DriverLedgerDet" runat=server  visible="false">
                <td colspan=4 align=left>
                 <table cellspacing="1" cellpadding="3" width="100%" align=left class="boxbg" border="1" >
                    ...
                    <tr style="background-color: white">
                        <td align=Left><asp:Label ID="Label7" Text="Driver Settlement Date" runat="server" CssClass="bluefnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="LblSettleDt" runat="server" CssClass="blackfnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="Label9" runat="server"  Text="Payment Mode" CssClass="bluefnt"></asp:Label></td>
                         <td align=Left><asp:Label ID="LblPayMode"  runat="server" CssClass="blackfnt"></asp:Label></td>
                    </tr> 
                    <tr style="background-color: white">
                        <td align=Left><asp:Label ID="Label10" Text="Amt. Recvd. From Driver" runat="server" CssClass="bluefnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="LblAmtRecvdFromDriver" runat="server" CssClass="blackfnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="Label11" Text="Amt. Paid to Driver"  runat="server" CssClass="bluefnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="LblAmtPaidToDriver" runat="server" CssClass="blackfnt"></asp:Label></td>
                    </tr> 
                    
                    <tr style="background-color: white">
                        <td align=Left><asp:Label ID="Label13" Text="Balance to Driver Ledger" runat="server" CssClass="bluefnt"></asp:Label></td>
                        <td align=Left colspan=3><asp:Label ID="LblBalanceToDriverLedger" runat="server" CssClass="blackfnt"></asp:Label></td>
                    </tr> 
                    
                     <tr style="background-color: white">
                        <td align=Left><asp:Label ID="Label12" Text="Cheque No." runat="server" CssClass="bluefnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="LblChqno" runat="server" CssClass="blackfnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="Label14" Text="Cheque Date"  runat="server" CssClass="bluefnt"></asp:Label></td>
                        <td align=Left><asp:Label ID="LblChqDt" runat="server" CssClass="blackfnt"></asp:Label></td>
                    </tr> 
