...
public partial class GUI_Fleet_Operations_Issue_AutoComplete_mac_dataD2 : System.Web.UI.UserControl
{
    ...
    {
        string strsql = "SELECT WFD.Driver_id,WFD.Driver_Name,WFD.VEHNO FROM WEBX_FLEET_DRIVERMST WFD INNER JOIN Webx_Master_General WMG ON isnull(WFD.D_category,'2')=WMG.CodeId and  codetype = 'DRVCAT' and  WMG.CodeDesc='SECOND' ";
