...
public partial class GUI_Fleet_Operations_Issue_AutoComplete_MACD2 : System.Web.UI.UserControl
{
    string tname1, tname2, tname3, txtfilt, txtfilt2;
    TextBox txt1, txt2, txt3, txtf, txtf2;
    Int16 minlen;
    MasterEntityD2 _oWE = MasterEntityD2.Driver;
    ...
    public MasterEntityD2 MasterEntityD2 { get { return _oWE; } set { _oWE = value; } }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string entity = MasterEntityD2.ToString();
        ...
        string BlurEvent = Convert.ToString(CodeTextBox.Attributes["onblur"]);
        CodeTextBox.Attributes.Add("onblur", "dacCodeBlur(" + fs_st.ClientID + "," + divXAC.ClientID + "," + ino.ClientID + "," + CodeTextBox.ClientID + "," + init.ClientID + ");" + BlurEvent);
