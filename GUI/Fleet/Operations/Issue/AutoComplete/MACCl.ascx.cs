 ...
 */
public enum MasterEntityCl
{
    Driver = 0,
    Branch,
    City
}
public partial class GUI_Fleet_Operations_Issue_AutoComplete_MACCl : System.Web.UI.UserControl
{
    string tname1, tname2, tname3, txtfilt, txtfilt2;
    TextBox txt1, txt2, txt3, txtf, txtf2;
    Int16 minlen;
    MasterEntityCl _oWE = MasterEntityCl.Driver;
    ...
    public MasterEntityCl MasterEntityCl { get { return _oWE; } set { _oWE = value; } }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string entity = MasterEntityCl.ToString();
