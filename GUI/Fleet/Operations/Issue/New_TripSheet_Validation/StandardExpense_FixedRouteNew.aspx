<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="StandardExpense_FixedRouteNew.aspx.cs" Inherits="GUI_Fleet_Operations_Issue_New_TripSheet_Validation_StandardExpense_FixedRouteNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    <asp:UpdatePanel ID="upDCRReDeAllot" UpdateMode="Conditional" RenderMode="Inline" runat="server">
        <ContentTemplate>
            ...
            <table border="0" cellspacing="1" cellpadding="3" width="930px" class="boxbg" id="tblDCRCriteria" runat="server">
                <tr class="bgbluegrey">
                ...
                <tr bgcolor="white">
                    ...
                    <td align="left" style="width: 120px">
                        ...
                        <%--<asp:TextBox runat="server" ID="txtRouteNo" Width="70px" BorderStyle="Groove" CssClass="input" />--%>
                    </td>
                                ...
                                <table align="left" id="tblGrid" runat="server" cellspacing="1" cellpadding="2" class="boxbg">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                                                <ContentTemplate>
                                                    <asp:GridView ID="dgWorkgroup" runat="server" PageSize="1000"
                                                        ...
                                                        BorderColor="#006699" BorderStyle="None" CssClass="blackfnt" OnRowDataBound="dgWorkgroup_RowDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Border">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtBorder" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Check Post">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtCheckPost" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="RTO">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtRto" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Loading">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtLoading" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Unloading">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtUnLoading" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="60px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Incentive">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtIncentive" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="60px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Driver D.A.">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtDriverDA" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Telephone">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtTelephone" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="60px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="ENROUTE REPAIR INCENTIVE">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtEnrouteRepair" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Penalty">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtPenalty" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Height">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtHeight" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Brokarage">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtBrokarage" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="60px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Guide">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtGuide" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="PROTSAHAN RASHI">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtBehtiExp" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Green Tax">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtGreenTax" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="P. Exp">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtPExp" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Misl. Expense">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtMislExp" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Other Expense">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtOtherExp" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderText="PENALTY(-)">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtMExp" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="50px" runat="server"></asp:TextBox>
                                                             ...
                                                             <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Tyre Puncture">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtTyrePuncture" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                             ...
                                                             <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Servicing">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtServicing" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                             ...
                                                             <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Parking">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtParking" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                              ...
                                                              <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Mechanical">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtMechanical" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                               ...
                                                               <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Greecing">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtGreecing" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                               ...
                                                               <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Air Check">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtAirCheck" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtDandaTax" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtKaanta" OnBlur="javascript:return CalulateAmount()" Text="0.00"  onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Sub Total">
                                                                <ItemTemplate>
                                                                  <%--  <asp:TextBox ID="txtSubTotal" onkeypress="javascript:validFloat(event,this.getAttribute('id'))" CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                                    ...
                                                                    <asp:Label runat="server" ID="lblSubTotal" CssClass="input" BorderStyle="Groove" Width="40px" Text="0.00"></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Toll">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtToll" OnBlur="javascript:return CalulateAmount()" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))"   CssClass="input" BorderStyle="Groove" Width="40px" runat="server" ></asp:TextBox>
                                                                    <asp:RegularExpressionValidator ID="RegtxtRow29" runat="server"
                                                                        ErrorMessage="!" ValidationExpression="^\$?[+-]?[\d,]*\.?\d{0,2}$" SetFocusOnError="true"
                                                              ...
                                                              <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Grand Total">
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="lblGrandTotal" CssClass="input" BorderStyle="Groove" Width="40px" Text="0.00"></asp:Label>
                                                                    <asp:HiddenField ID="hdnGrandTotal" runat="server" Value="0.00" />
                                                              ...
                                                              <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Fuel(Ltrs)">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtFuel" Text="0.00" onkeypress="javascript:validFloat(event,this.getAttribute('id'))" CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                           ...
                                                           <%-- <asp:TemplateField HeaderStyle-Width="60px" HeaderText="Total: Cash Fuel">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtCashRate" onkeypress="javascript:validFloat(event,this.getAttribute('id'))" CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>

                                                                    <asp:TextBox ID="txtCashLtr" onkeypress="javascript:validFloat(event,this.getAttribute('id'))" CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>

                                                                    <asp:TextBox ID="txtCashTotal" onkeypress="javascript:validFloat(event,this.getAttribute('id'))" CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                    Font-Underline="False" Wrap="False" />
                                                                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                           ...
                                                           <%-- <asp:TemplateField HeaderStyle-Width="60px" HeaderText="Grand Total: Cash Fuel">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtGCashRate" onkeypress="javascript:validFloat(event,this.getAttribute('id'))" CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>

                                                                    <asp:TextBox ID="txtGCashLtr" onkeypress="javascript:validFloat(event,this.getAttribute('id'))" CssClass="input" BorderStyle="Groove" Width="40px" runat="server"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                    Font-Underline="False" Wrap="False" />
                                                                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                            ...
                                                            <%--<asp:TemplateField HeaderStyle-Width="80px" HeaderText="Add Vehicle">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="AddRow" runat="server" Text="Select Vehicle" CssClass="blackfnt" Font-Bold="true"
                                                                        CausesValidation="false"></asp:LinkButton>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtVehNo"  CssClass="input" onblur="javascript:return CheckVhNo()" BorderStyle="Groove" Width="100px" runat="server" TabIndex="1"></asp:TextBox>
                                                                    <ajaxToolkit:AutoCompleteExtender ID="Ext1" runat="server" Enabled="True" CompletionListItemCssClass="autocomplete_listItem"
                                                                        ...
                                                                        ServiceMethod="AutoVhNo" ServicePath="~/GUI/Fleet/AtlasAutoComplete.asmx" TargetControlID="txtVehNo">
                                                                    </ajaxToolkit:AutoCompleteExtender>

                                                                    <asp:TextBox runat="server" CssClass="input" BorderStyle="Groove" Width="300px" ID="txtVehList"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                    Font-Underline="False" Wrap="False" />
                                                                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="80px">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtCstLoc" CssClass="input" BorderStyle="Groove" runat="server" MaxLength="298" Width="300px" OnChange="Javascript:this.value=this.value.toUpperCase();"></asp:TextBox>
                                                                    <%--<asp:Label ID="Label2" runat="server" BorderStyle="Groove" TabIndex="18" Text='<a href="javascript:nwOpen('<%= Label2.ClientId %>')">...</a>' Width="14px"></asp:Label>--%>
                                                                    <asp:Label ID="Label2" runat="server" BorderStyle="Groove" TabIndex="18" Text="..." onclick="javascript:nwOpen(this.id)"  Width="14px"></asp:Label>
                                                                    <%-- <asp:Button ID="BtnCustCode" runat="server" Width="21px" OnClientClick="javascript:nwOpen();" Text="..." />--%>

                                                                    <%--<asp:Button ID="BtnCustCode" runat="server" Width="21px"  OnClientClick="javascript: nwOpen(this)" Text="..." />--%>
                                                                </ItemTemplate>
                                                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                    Font-Underline="False" Wrap="False" />
                                                                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <tr style="background-color: white">
                                        <td colspan="3" align="center">
                                            <asp:Button ID="btnFinalSubmit" runat="server" OnClick="btnFinalSubmit_Click" Text="Submit" Visible="false" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
