...
public partial class GUI_Fleet_Operations_Issue_New_TripSheet_Validation_PendingDriverBalWithoutVehicle : System.Web.UI.Page
{
    ...
    protected void ShowDateVice(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@Driver", txtDriver1.Text);
        SqlDataReader dr = cmd.ExecuteReader();
        dgGeneral.DataSource = dr;
        dgGeneral.DataBind();
        if (dgGeneral.Rows.Count == 0)
