...
public partial class GUI_Fleet_Operations_Issue_New_TripSheet_Validation_StandardExpense_FixedRouteSelectView : System.Web.UI.Page
{
    bool success = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            while (dr1.Read())
            {
                ...
                ddlro.Items.Add(new ListItem(dr1.GetValue(0).ToString()));
            }
            dr1.Close();
            ddlro.SelectedValue = loccd;
            conn.Close();
