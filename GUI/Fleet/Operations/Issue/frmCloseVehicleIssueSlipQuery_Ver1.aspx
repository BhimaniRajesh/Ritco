<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="frmCloseVehicleIssueSlipQuery_Ver1.aspx.cs" Inherits="Issue_frmCloseVehicleIssueSlipQuery_Ver1" %>
                ...
                <table cellspacing="1" cellpadding="2" class="boxbg" width="800px">
                    ...
                    <tr style="background-color: white">
                        ...
                        <td align="left">
                            ...
                            <asp:DropDownList CssClass="input" ID="ddlUpdClose" runat="Server" Width="180px" BorderStyle="Groove">
                            </asp:DropDownList>
                ...
                <asp:UpdatePanel ID="u1" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:DataGrid ID="DataGrid1" runat="server" PageSize="1000" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="Row#" HeaderText="Sr. No.">
                                ...
                                <asp:BoundColumn DataField="VSlipDt" HeaderText="Open date">
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="TripSubmissionDate" HeaderText="Trip Submission Date">
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="isApprovedDate" HeaderText="Approved Date">
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="TripFinacialCloseEntryDt" HeaderText="Financial Closure Date">
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="ContractAmount" HeaderText="Approval Amount">
                                    <HeaderStyle HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="QtyContractAmount" HeaderText="Approval Qty">
                                    <HeaderStyle HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="AdvanceAmount" HeaderText="Advance Amount">
                                    <HeaderStyle HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="QtyAdvanceAmount" HeaderText="Advance Qty">
                                    <HeaderStyle HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="BalanceAmount" HeaderText="Balance Amount">
                                    <HeaderStyle HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="QtyBalanceAmount" HeaderText="Balance Qty">
                                    <HeaderStyle HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmTripsheetUpdate.aspx?id={0}&mode=Advance" Text="Advance Entry" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmCloseVehicleIssueSlip.aspx?id={0}&mode=Close" Text="Close - Operational" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmDriverSettlementIssueSlip.aspx?id={0}" Text="Driver Settlement" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmCloseVehicleIssueSlip.aspx?id={0}&mode=FE" Text="Financial Edit" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmDriverSettlementIssueSlipVer1.aspx?VSlipNo={0}" Text="Driver Settlement" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
								<asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmTripsheetUpdateV2.aspx?id={0}&mode=Advance&Type=Request" Text="Advance Entry" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                            </Columns>
                        ...
                        <asp:DataGrid ID="DataGrid2" runat="server" PageSize="1000" AutoGenerateColumns="False"
                            CellPadding="2" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px"
                            CssClass="Styles.css" CellSpacing="1" Width="100%" Height="1px" ItemStyle-HorizontalAlign="Left"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="VSlipNo" HeaderText="Trip Sheet No">
                                  ...
                                  <asp:BoundColumn DataField="VSlipDt" HeaderText="Tripsheet Date">
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="VehicleNo" HeaderText="Vehicle No.">
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
								...
								<asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmTripsheetUpdateV2.aspx?id={0}&mode=Advance&Type=C" Text="Advance Entry With Cash" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="frmTripsheetUpdateV2.aspx?id={0}&mode=Advance&Type=B" Text="Advance Entry" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                            </Columns>
