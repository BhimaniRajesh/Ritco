...
public partial class Issue_frmViewPrintVehicleIssueSlip : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                vehlogentrydet.Visible = true;
                vehlogentryhdr.Visible = true; 
            }
            else
            {
                vehlogentryhdr.Visible = false;
                vehlogentrydet.Visible = false;
            }
        }
    }
    ...
    public void VehicleLogEntryDetails()
    {
        SqlConnection conn = new SqlConnection(Session["SqlProvider"].ToString().Trim());
        conn.Open();
