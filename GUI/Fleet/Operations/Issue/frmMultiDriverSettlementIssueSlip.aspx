<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="frmMultiDriverSettlementIssueSlip.aspx.cs" Inherits="GUI_Fleet_Operations_Issue_frmMultiDriverSettlementIssueSlip" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <table cellspacing="1" style="width: 100%">
        <tr style="background-color: white">
            <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="true" runat="server">Pending Driver Balance Received/Paid</asp:Label>
            </td>
            <td align="right"></td>
        </tr>
    </table>
    ...
    <table cellspacing="1" style="width: 100%">
        <tr style="background-color: white">
            <td style="vertical-align: top !important; display:none">
                <table cellspacing="1">
                    <tr align="left">
                        <td>
            ...
            <td style="vertical-align: top !important;">
                ...
                <table cellspacing="1" cellpadding="2" class="boxbg">
                    ...
                    <tr style="background-color: white">
                        <td colspan="3" style="vertical-align: top !important; display:none">
                        ...
                        <td colspan="2" style="vertical-align: top !important; display:none" >
