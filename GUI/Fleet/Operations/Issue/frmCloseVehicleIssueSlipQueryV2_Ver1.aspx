<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="frmCloseVehicleIssueSlipQueryV2_Ver1.aspx.cs" Inherits="Issue_frmCloseVehicleIssueSlipQueryV2_Ver1" %>
            ...
            <td>
                <table cellspacing="1" cellpadding="2" class="boxbg" width="800px">
                    ...
                    <tr style="background-color: white;display:none">
                        <td align="left">
                            <asp:Label ID="Label1" CssClass="blackfnt" runat="server" Font-Bold="True">Select Tripsheet action</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr style="background-color: white">
                        <td align="left">
                            <asp:DropDownList ID="ddlTripsheet" runat="server">
                                <asp:ListItem Value="V" Text="Enter Vehicle No.:" Selected="true"></asp:ListItem>
                    ...
                    <ContentTemplate>
                        <asp:DataGrid ID="DataGrid1" runat="server" PageSize="1000" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="Trip_route_type" HeaderText="Route Type">
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:BoundColumn>
                                ...
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" DataNavigateUrlFormatString="./../Issue_FA/frmNewTripDetailsUpdate.aspx?id={0}&mode=TD"
                                    Text="Trip Update" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                                ...
                                <asp:HyperLinkColumn DataNavigateUrlField="VSlipNo" 
                                    DataNavigateUrlFormatString="New_TripSheet_Validation/TripSubmission_CloseVer1.aspx?VSlipNo={0}"
                                    Text="Trip Close" HeaderText="Next Step">
                                    <ItemStyle CssClass="bluefnt" HorizontalAlign="Left" />
                                    <HeaderStyle Width="90px" />
                                </asp:HyperLinkColumn>
                            </Columns>
