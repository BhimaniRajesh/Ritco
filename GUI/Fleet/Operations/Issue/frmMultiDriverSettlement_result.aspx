<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="frmMultiDriverSettlement_result.aspx.cs" Inherits="GUI_Fleet_Operations_Issue_frmMultiDriverSettlement_result" %>
    ...
    <script language="javascript" type="text/javascript">
        function ViewPrint(tVSlipId, tPrintMode) {
		   ...
		   function ViewPrintVer1(tVSlipId, tPrintMode) {
            //var strurl = "frmViewPrintVehicleIssueSlip.aspx?VSlipNo=" + tVSlipId + "&PrintMode=" + tPrintMode
            //popup = window.open(strurl, "", "height=475,width=850,scrollbars=yes,left=100,top=125");
		       var strurl = "frmMultiDriverSettlementIssueSlipViewVer1.aspx?id=" + tVSlipId + "&PrintMode=" + tPrintMode
            popup = window.open(strurl, "", "height=475,width=1050,scrollbars=yes,left=100,top=125");
        }
    </script>
    <%
