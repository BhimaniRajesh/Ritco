<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="frmVehicleIssueSlipQuery.aspx.cs" Inherits="Issue_frmVehicleIssueSlipQuery" %>
       ...
       <table cellspacing="1" cellpadding="2" style="width: 70%" class="boxbg">
	     ...
	     <tr style="background-color: white">
                            <td align="left" valign=top>
                                <asp:Label ID="Label11" CssClass="bluefnt" runat="server" >Enter Request Journey start date:</asp:Label>
                            </td>
