<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="DownloadExternalThcScannDocQuery.aspx.cs" Inherits="GUI_Fleet_Operations_Issue_ExternalThcAudit_DownloadExternalThcScannDocQuery" %>
                    ...
                    <table cellspacing="1" class="boxbg" align="left">
                        <tr class="bgbluegrey">
                            <td colspan="2" align="center" style="height: 21px">
                                <asp:Label ID="lblQry" CssClass="blackfnt" Font-Bold="true" runat="server">Select Download Criteria </asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr bgcolor="white">
                            <td width="100">
                                <asp:Label ID="lblFMNo" CssClass="blackfnt" runat="server" Text="Enter External Thc No"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtExternalThcNo" runat="server"></asp:TextBox>
