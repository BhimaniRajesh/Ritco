<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"     CodeFile="EditTripResult.aspx.cs" Inherits="GUI_Fleet_Operations_Issue_EditTripResult" %>
        ...
        <tr style="background-color:White">
          ...
          <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="lnkStep1" runat="server" Text="Edit More Tripsheet" CssClass="blackfnt" PostBackUrl="TripsheetQuery1.aspx"/>
            </td>
        </tr>
