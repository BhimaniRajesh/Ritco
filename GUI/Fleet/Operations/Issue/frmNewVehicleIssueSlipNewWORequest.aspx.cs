...
public partial class GUI_Fleet_Operations_Issue_frmNewVehicleIssueSlipNewWORequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtVehno.Attributes.Add("Onblur", "javascript:GetVehicleDetails(this);");

            txtDriver1.Attributes.Add("Onblur", "javascript:GetDriver1Details(this); GetDriver1DetailsVehicleWise(this);");
            txtDriver2.Attributes.Add("Onblur", "javascript:GetDriver2Details(this); GetDriver2DetailsVehicleWise(this);");
    ...
    protected void gvFuelSlip_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow || e.Row.RowType == DataControlRowType.EmptyDataRow)
        {
            ...
            objTs.BindDropDown(ddlFuelVendor, "select A.VENDORCODE as CodeId,(A.VENDORCODE +' : '+ A.VENDORNAME) as CodeDesc from webx_VENDOR_HDR as A inner join webx_VENDOR_det as B on A.VENDORCODE=b.VENDORCODE where VENDOR_TYPE='12' and B.VENDORBRCD like '%" + SessionUtilities.CurrentBranchCode.ToString().Trim() + "%'");
    ...
    protected void SubmitData(object sender, EventArgs e)
    {
        ...
        if (lbl_Manual_TS_Err.Text == "")
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Usp_Insert_Webx_Fleet_AddVehicleIssue", conn, trans);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if (chkFuelSlipFlag.Checked == true)
                {
                    foreach (GridViewRow gridrow in gvFuelSlip.Rows)
                    {
                        ...
                        string mYearValfuel = "";
                        GetFinancialYear objFinYear123 = new GetFinancialYear(Convert.ToString(Session["SqlProvider"]));
