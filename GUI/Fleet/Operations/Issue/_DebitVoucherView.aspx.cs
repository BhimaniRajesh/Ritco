...
public partial class GUI_Finance_voucher_Print_DebitVoucherView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        printyn = Request.QueryString["PrintMode"].ToString();
        //voucherno = "VR/ANR_/08/001239";
        //printyn = "0";
        ...
        Financial_Year = SessionUtilities.FinYear.ToString().Trim().Substring(2, 2);
        fin_year = SessionUtilities.FinYear.ToString().Trim();
        ...
        sql += " where a.voucherno=b.voucherno and a.voucherno='" + voucherno + "'";
        */

        string sql = "select top 1 convert(varchar, a.transdate, 6) as VoucherDate,'' as Manual_Voucherno,a.Brcd as PreparedAt,";
        sql += "a.Entryby as PreparedBy,'' as Business_type, a.brcd as Accounting_Brcd,'' as preparefor,'' as Refno,a.Payto,a.pbov_code,";
        sql += "a.pbov_name,a.narration,chqno=(select chqno from " + strTranTable + " where voucherno='" + voucherno + "' and credit>0),chqdate=(select convert(varchar,chqdate,6)  from " + strTranTable + " where voucherno='" + voucherno + "' and credit>0),a.transtype,'' as transmode";
        sql += " from  " + strTranTable + " a ";
        sql += " where a.voucherno='" + voucherno + "'";
        ...
        sql += " where a.voucherno='" + lblvoucherno.Text + "' and a.acccode = b.acccode order by srno";
        ...
        sql += " from " + strTranTable + " where voucherno='" + lblvoucherno.Text + "'";
        ...
        // Code For Number to Text
        
        lblinwords.Text = ntt.numberToText(lblTotalDebitAmount.Text).ToString();
        ...
        string Sql2 = "select b.company_acccode + ' : ' + b.accdesc as AccountHeader from " + strTranTable + " a,webx_acctinfo b where a.acccode=b.acccode and b.Acccategory != 'TDS' and a.voucherno='" + lblvoucherno.Text + "' and a.debit = 0";
        ...
        while (dr2.Read())
        {
            //lblAccHead.Text = dr2["AccountHeader"].ToString();
            if (strAccHead == "")
            {
                strAccHead = dr2["AccountHeader"].ToString();
            }
            else
            {
        ...
        lblAccHead.Text = strAccHead.ToString();
