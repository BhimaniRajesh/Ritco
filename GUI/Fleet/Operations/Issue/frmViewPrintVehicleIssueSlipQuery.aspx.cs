...
public partial class Issue_frmViewPrintVehicleIssueSlipQuery : System.Web.UI.Page
{
    ...
    public void RetrieveGridData()
    {
        ...
        dtfi.DateSeparator = "/";
        {
            if (txtDateFrom.Text != "")
            {
                ...
                dtTo = Convert.ToDateTime(txtDateTo.Text + " 23:59:59.000", dtfi);
            }
            else
            {
                ...
                dtTo = Convert.ToDateTime(strrightnow + " 23:59:59.000", dtfi);
            }
        }
