<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/GUI/MasterPage.master"   CodeFile="FixedExpResult.aspx.cs" Inherits="GUI_Fleet_Operations_Expense_FixedExpResult" %>
...
<script language="javascript">
 ...
 function ViewPrint(mVoucherNo,tPrintMode)
 {
	...
	var strurl="ExpenseVoucherFixedAddPrint.aspx?VNo=" + mVoucherNo + "&PrintMode=" + tPrintMode  
...
<br>
    ...
    <table border="0" class="boxbg" cellpadding="2" cellspacing="1" width="50%">
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="lnkStep1" runat="server" Text="Generate Fixed Expense Voucher" CssClass="blackfnt" PostBackUrl="ExpenseVoucherFixedAdd.aspx"/>
            </td>
        </tr>
