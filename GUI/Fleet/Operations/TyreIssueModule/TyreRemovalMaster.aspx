                ...
                <table cellspacing="1" cellpadding="3" style="width: 100%" class="boxbg" border="0">
                    <tr style="background-color: white">
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtAxel" runat="server" Text="" onBlur="this.focus()" BorderStyle="Groove"
                        ...
                        <td>
                            <asp:TextBox ID="txtActualTyre" runat="server" onBlur="this.focus()" CssClass="rtxt"
                                Text="0"></asp:TextBox>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtPendingTyre" runat="server" CssClass="rtxt" onBlur="this.focus()"></asp:TextBox>
                        </td>
                    </tr>
                    <%--<tr style="background-color: white">
                                <td colspan="10">
