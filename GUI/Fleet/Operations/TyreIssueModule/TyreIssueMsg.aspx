<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="TyreIssueMsg.aspx.cs" Inherits="GUI_Fleet_TyreIssueModule_TyreIssueMsg" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
 <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td height="30">
                <font class="blackfnt"><strong>Tyre Issue Master</strong></font>
            </td>
        </tr>
        <tr>
            <td class="horzblue">
    ...
    <br />
    <table style="width: 30%" class="boxbg">
        <tr class="bgbluegrey">
            <td align="center" class="blackfnt">
                <b>Tyre Issue Master</b>
            </td>
        </tr>
        <tr class="bgwhite">
            <td align="center" class="blackfnt">
