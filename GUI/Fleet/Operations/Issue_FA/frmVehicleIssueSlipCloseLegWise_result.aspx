                                    ...
                                    <asp:TemplateField HeaderText="Download Document" Visible="true">
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink ID="lblUloadLink" runat="server" Font-Underline="true" Text="View"
                                                Target="_blank" CssClass="bluefnt" NavigateUrl='<%# string.Format("./../Issue/ViewETScammedDocument.aspx?DocName={0}", Server.UrlEncode(DataBinder.Eval(Container.DataItem,"lblUloadLink").ToString()))  %>'></asp:HyperLink>
                                        </ItemTemplate>
