            ...
            try
            {
                ...
                foreach (GridViewRow gridrow in gvVehicleLogEntry.Rows)
                {
                    if (((Label)gridrow.FindControl("LabelExternalTHCNoM")).Text.ToString().Trim() == "")
                    {
                        ...
                        SqlCommand sql_insert_ExternalTHC = new SqlCommand("USP_WEBX_FLEET_ExternalTHC_ExternalTHC_FA", conn, trans);
                    ...
                    else
                    {
                        ...
                        rTSmCityC.Close();
                        SqlCommand sql_insert_ExternalTHC = new SqlCommand("USP_WEBX_FLEET_ExternalTHC_ExternalTHC_Update_FA", conn, trans);
                        sql_insert_ExternalTHC.CommandType = CommandType.StoredProcedure;
