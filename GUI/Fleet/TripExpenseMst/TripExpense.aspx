...
<div align="left">
    ...
    <asp:UpdatePanel ID="u1" runat ="server" UpdateMode="Always" RenderMode="Inline" >
        <ContentTemplate >
            <table id="tb_add" border="0" class="boxbg" cellpadding="1" cellspacing="1" border="1" width="800">
                <tr runat="server" bgcolor="white" >
                    <td align="left" class="blackfnt"  style="font-weight: bold; font-size: 8pt;
                        width: 15%; color: white; font-family: Verdana; height: 17px; background-color: #006699">
                    ...
                    <td align="left" class="blackfnt" style="font-weight: bold; font-size: 8pt;
                        ...
                        Trip Expense</td>
                    <td class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 10%;
                        color: white; font-family: Verdana; height: 17px; background-color: #006699">
                        Polarity</td>
                    <td class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 10%;
                        color: white; font-family: Verdana; height: 17px; background-color: #006699">
                        Active Flag</td>
                         <td class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 45%;
                        color: white; font-family: Verdana; height: 17px; background-color: #006699">
                        Account Code</td>
                </tr>
                ...
                <tr id="RowNo" runat="server" bgcolor="white" >
                    ...
                    <td align="left" class="blackfnt" style="width: 20%">
                        <asp:TextBox CssClass="input" ID="tb_Trip_Exp" runat="server"  onblur="CheckValidExp(this)" BorderStyle="Groove" />
                    ...
                    <td class="blackfnt" style="width: 10%">
                        <asp:TextBox CssClass="input" ID="tb_Polarity" Width="50px" MaxLength="1"   runat="server" onblur="PlusMinus(this,event)" BorderStyle="Groove" ></asp:TextBox>
                    ...
                    <td class="blackfnt" style="width: 45%">
                        ...
                        <asp:Label ID="lbl_Err_AccCode" runat="server" Text="" style="font-size: 8pt; color: red; font-family: Verdana"></asp:Label>
            ...
            <table id="Table1" border="0" class="boxbg" cellpadding="1" cellspacing="1" width="800">
             <tr id="Tr1" runat="server" bgcolor="white">
                <td class="blackfnt" colspan="2" >
                    <asp:GridView ID="gv_Trip_Expense" runat="server" BackColor="White" 
                        BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                        Width="100%" AutoGenerateColumns="False" 
                        OnSelectedIndexChanged="gv_Trip_Expense_SelectedIndexChanged" 
                        AllowPaging="True" OnPageIndexChanged="gv_Trip_Expense_PageIndexChanged" 
                        OnPageIndexChanging="gv_Trip_Expense_PageIndexChanging" PageSize="15" 
                        ShowHeader="False" onrowdatabound="gv_Trip_Expense_RowDataBound">
