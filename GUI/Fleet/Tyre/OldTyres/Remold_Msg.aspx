<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Remold_Msg.aspx.cs" Inherits="GUI_Fleet_Tyre_OldTyres_Remold_Msg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <table width="500px" cellpadding="0" cellspacing="0" border="1" class="boxbg">
        ...
        <tr class="bgwhite">
            <td align="center">
                <asp:Label ID="lblRemoldId" runat="server" CssClass="blackboldfnt" Text=""></asp:Label>
            </td>
        </tr>
        <tr class="bgwhite">
            <td align="left">
                <asp:Label ID="Label1" runat="server" Text="System Generated Bill No. :      " Font-Bold="true"></asp:Label>
                <asp:Label ID="lblBillno" runat="server" CssClass="blackboldfnt" Text=""></asp:Label>
            </td>
        </tr>
        <tr class="bgwhite">
            <td>
