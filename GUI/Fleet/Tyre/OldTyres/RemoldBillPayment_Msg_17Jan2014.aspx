<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="RemoldBillPayment_Msg.aspx.cs" Inherits="GUI_Fleet_Tyre_OldTyres_RemoldBillPayment_Msg" %>
...
<table width="100%">
    ...
    <table width="500px" cellpadding="0" cellspacing="0" border="1" class="boxbg">
        ...
        <tr class="bgwhite">
            <td align="left">
                <asp:Label ID="Label1" runat="server" Text="System Generated Voucher No. :      " Font-Bold="true"></asp:Label>
