...
public partial class TyreOdometerSearch : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            lnkbtnView.Attributes.Add("onClick", "javascript:PopupWindow("+ txtVehNo.ClientID.ToString() +")");
            lnkbtnPrint.Attributes.Add("onClick", "javascript:PopupWindowP(" + txtVehNo.ClientID.ToString() +")");
    ...
    public void BindGrid()
    {
        ...
        da.SelectCommand.Parameters.Add("@VehNo", SqlDbType.VarChar).Value = txtVehNo.Text;
    ...
    {
        string strSQL = "SELECT VehicleNo AS [Vehicle No.],Last_Km_Reading AS [Last KM Reading],Odometer_Reading AS [Odometer Reading],CONVERT(VARCHAR,Odometer_Reading_Dt,105) AS [Odometer Reading Date]  FROM WEBX_FLEET_ODOMETERTRANS ORDER BY VehicleNo,Tran_Dt DESC";
        CreateXLS(strSQL, "TyreOdometer.xls");
    }
}
