...
public partial class GUI_admin_CustomerContractMaster_CCM_DisplayResult : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblview.Attributes.Add("onclick", "javascript:return window.open('Secondary_Contract_View.aspx?Customer_Code=" + custcode + "&Contract_Code=" + contractid + "','','scrollbars=yes,resizable=yes,statusbar=yes,width=500,height=400')");
    }
    protected void lnklist_Click(object sender, EventArgs e)
    {
        Response.Redirect("StepSelection.aspx?Customer_Code=" + custcode + "&Contract_Code=" + contractid + "&Contract_Type=" + Request.QueryString["Contract_Type"].ToString());
    }

    protected void lnkcontract_Click(object sender, EventArgs e)
    {
        Response.Redirect("ContractEditList.aspx?Customer_Code=" + custcode+"&Contract_Type=" + Request.QueryString["Contract_Type"].ToString());
    }
