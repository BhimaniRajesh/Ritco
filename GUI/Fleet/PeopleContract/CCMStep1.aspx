            ...
            <asp:TableRow>
                <asp:TableCell Style="width: 100%">
                    <asp:Table runat="server" CellSpacing="1" CssClass="boxbg" Width="100%">
                        <asp:TableRow ID="TableRow2" class="bgbluegrey" runat="server">
                            <asp:TableCell ColumnSpan="4" HorizontalAlign="left" Style="height: 25px;">
                                <asp:Label ID="lbl_Error" CssClass="redfnt" runat="server" Text="Label"></asp:Label>
                            </asp:TableCell>
                        </asp:TableRow>
                        ...
                        <asp:TableRow ID="TableRow1" Style="background-color: White" runat="server">
                            ...
                            <asp:TableCell ColumnSpan="3" VerticalAlign="top" HorizontalAlign="left">
                                <asp:TextBox ID="txtAccManagerName" runat="server" Width="500px" MaxLength="80" onblur="this.value=this.value.toUpperCase()"
                                    CssClass="blackfnt" BorderStyle="groove"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
