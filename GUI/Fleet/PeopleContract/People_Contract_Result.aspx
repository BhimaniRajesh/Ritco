<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"
    CodeFile="People_Contract_Result.aspx.cs" Inherits="People_Contract_Result" %>
...
<script language="javascript">
    ...
    function ViewPrint(tPrintMode) {
        ...
        var strurl = "People_Contract_View.aspx?Contract_Code=" + qs.get("Contract_Code") + "&PrintMode=" + tPrintMode
