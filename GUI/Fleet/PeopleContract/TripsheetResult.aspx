<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="TripsheetResult.aspx.cs" Inherits="TripsheetResult" %>
...
//	var strurl="frmViewPrintVehicleIssueSlipView.aspx?VSlipNO=" + tTripSheetNo + "&PrintMode=" + tPrintMode  
...
<br>
    ...
    <tr style="background-color:White">
     ...
     <%} %>  
        ...
        <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="lnkStep1" runat="server" Text="Generate More Trip Sheet" CssClass="blackfnt" PostBackUrl="Tripsheet_Entry.aspx"/>
            </td>
        </tr>
       <%-- <tr style="background-color:White">
            <td align="left" colspan="3">
         ...
         <tr style="background-color:White">
            <td align="left" colspan="3">
                <asp:LinkButton ID="LinkButton2" runat="server" Text="View & Print Trip Sheet" CssClass="blackfnt" />
            </td>
        </tr>
