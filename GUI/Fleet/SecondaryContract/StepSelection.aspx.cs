...
public partial class GUI_admin_CustomerContractMaster_StepSelection : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            Server.Transfer("CCMStep1.aspx?Customer_Code=" + hdncustcode.Value + "&Contract_Code=" + hdncontractid.Value);
        }
        else if (optservices.Checked == true)
        {
            Server.Transfer("SecondaryContract_Step1.aspx?Customer_Code=" + hdncustcode.Value + "&Contract_Code=" + hdncontractid.Value);
        }
    }
