<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_Fleet_Reports_EventDriverType_Query" %>
     ...
     function OnSub_DATACHECK()
    {
      var txtDateFrom=document.getElementById("ctl00$MyCPH1$DT$txtDateFrom");
       var txtDateTo=document.getElementById("ctl00$MyCPH1$DT$txtDateTo");
         var ddlEvent=document.getElementById("ctl00_MyCPH1_ddlEvent");     
       var txtDriver=document.getElementById("ctl00_MyCPH1_txtDriver");
   
        //window.open("Result.aspx?FromDt=" + txtDateFrom.value + "&ToDt=" + txtDateTo.value + "&EventType=" + ddlEvent.value + "&Driver=" + txtDriver.value + "");
        window.open("Result.aspx?FromDt=" + txtDateFrom.value + "&ToDt=" + txtDateTo.value + "&EventType=" + ddlEvent.value + "&Driver=" + txtDriver.value + "");
        return false;
    }
</script>
    ...
    <table cellspacing="1" cellpadding="2" style="width:700px" class="boxbg">
            ...
            <tr style="background-color: white">
               <td align="right" style="vertical-align: top; width: 25%; text-align: left">
                 <asp:Label ID="Label4" runat="server" CssClass="blackfnt" Font-Bold="True" Width="150px">Event Type :</asp:Label></td>
                   <td align="left" style="width: 123%;">
                       <asp:DropDownList ID ="ddlEvent"  runat="server" Width="150px" ></asp:DropDownList> 
               </td>
            </tr>
            <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                <asp:Label ID="Label5" CssClass="blackfnt" runat="server" Font-Bold="True">Driver.</asp:Label>
                </td>
                <td align="left" colspan="2">
                ...
                <ajaxToolkit:AutoCompleteExtender
                   ...
                   <input id="Manual_Driver_Code" runat="server"   type="button" value="..." onclick="javascript:nwOpen('Popup-Driver1.aspx',null,'height=250,width=300,left=350,top=200,status=no,resizable=no,scrollbars=yes,toolbar=no,location=no,menubar=no');" />
