...
<script language="javascript">
    ...
    function OnSub_DATACHECK()
    {
       var txtDateFrom=document.getElementById("ctl00$MyCPH1$DT$txtDateFrom");
        ...
        var txtTyreNo=document.getElementById("ctl00_MyCPH1_txtTyreNo");
  ...
  window.open("TyrePosChangeHistoryReport.aspx?TyreNo="+txtTyreNo.value+"&PosHisDateFrom="+txtDateFrom.value+"&PosHisDateTo="+txtDateTo.value+"&Company_Code="+ ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value+ "");
        //return false;
    }
       ...
       <table cellspacing="1" cellpadding="2" style="width: 100%" class="boxbg">
           ...
           <tr style="background-color: white">
               ...
               <td align="left" colspan="2">
                   ...
                   <tr style="background-color: white">
                        <td align="right" valign="center" style="width: 30%; text-align: left; height: 112px;">
