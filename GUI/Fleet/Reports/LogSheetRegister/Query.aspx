...
<asp:Content ID="Content2" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OnSubmit() {
            ...
            window.open("Result.aspx?FromDt=" + txtDateFrom.value + "&ToDate=" + txtDateTo.value + "&Vehicle=" + txtVehicle.value + "&Loc=" + ddlLocation.value+"&Company_Code=" + ddlCompanyList.value, "pbr", "scrollbars=yes,resizable=yes,statusbar=yes,width=1000,height=600'")
            return false;
        } 
    </script>
