...
function OnSub_DATACHECK()
    {
        ...
        window.open("Result.aspx?FROM_DT=" + txtDateFrom.value + "&TO_DT=" + txtDateTo.value + "&VEH_NO=" + tb_TextBox.value + "&Company_Code=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
   ...
   <input type="hidden" id="hdnRptId" runat="server" /> <%-- added by Manisha 20/5/2014 --%>
    ...
    <table cellspacing="1" style="width: 100%">
        <tr style="background-color: white">
            <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="True" runat="server">Fleet Module  > Reports >Tyre Gap Analysis</asp:Label>
            </td> 
    ...
    <br> 
    <asp:Panel ID="pnlCriteriaHdr" Width="720px" runat="server">
