...
public partial class Reports_FollowDetail : System.Web.UI.Page
{
   // SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.AppSettings["dbConnection"]);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           // Value = Request.QueryString["id"];
            ...
            City = Request.QueryString["id1"].Trim();
    ...
    public void getReportName()
    {
        ...
        if (Value == "ReqAck")
        {
            mValue = "Request Acknowledged";
        }
        if (Value == "ReqNAck")
        {
            mValue = "Request Not Acknowledged";

        }
        if (Value == "TripIssued")
        {
            mValue = "Trip Sheet Issued ";
        }
        if (Value == "TripNIssued")
        {
            mValue = "Trip Sheet Not Issued";
        }
        if (Value == "JCNo")
        {
        ...
        if (Value == "JTNo")
        {
            mValue = "Journey/Trips Not  Completed";
        }
    ...
    public void BindGrid()
    {
        ...
        string sql = "usp_FollowDetailReport";
        ...
        da.SelectCommand.Parameters.Add("@mainStatus", SqlDbType.VarChar).Value = Session["status"];
    ...
    {
        Response.Redirect("RequestFollowReport.aspx");
    }
}
