<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="VehicleLogBookReport.aspx.cs" Inherits="GUI_Fleet_Reports_VehicleLogBookReport" Title="Untitled Page" %>
...
<table cellspacing="1" style="width: 100%">
    ...
    <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="True" runat="server">Fleet Module  > Reports >Vehicle LogBook Report</asp:Label>
            </td> 
    ...
    <table cellspacing="1" cellpadding="2" style="width:700px" class="boxbg">
           ...
           <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                    <asp:Label ID="Label4" CssClass="blackfnt" runat="server" Font-Bold="True">Tripsheet No</asp:Label></td>
                <td align="left" colspan="2">
                 <asp:TextBox ID="txtTripsheetNo" runat="server" CssClass="input" Width="200px" style="font-size: 8pt; font-family: Verdana" BorderStyle="Groove"></asp:TextBox>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                    <ContentTemplate>
                       <%-- <asp:Button ID="btnShow" runat="server" Text="Submit" OnClientClick="javascript:return Validation()"  OnClick="btnShow_Click" /> --%>
                        <asp:Button ID="btnShow1" runat="server" Text="Submit"  OnClick="btnShow1_Click" /> 
                    </ContentTemplate>
                </asp:UpdatePanel>
               </td>
             </tr>                                
          ...
          <tr style="background-color: white">
           ...
           <tr style="background-color: white">
            ...
            <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                <asp:Label ID="Label5" CssClass="blackfnt" runat="server" Font-Bold="True">Customer</asp:Label>
                </td>
                <td align="left" colspan="2">
            ...
            <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                <asp:Label ID="Label10" CssClass="blackfnt" runat="server" Font-Bold="True">VehicleNo</asp:Label>
                </td>
                <td align="left" colspan="2">
                <asp:TextBox ID="txtVehNo" runat="server" CssClass="input" Width="100px" style="font-size: 8pt; font-family: Verdana" BorderStyle="Groove"></asp:TextBox>
                    <ajaxToolkit:AutoCompleteExtender
                            runat="server" 
             ...
             <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                <asp:Label ID="Label6" CssClass="blackfnt" runat="server" Font-Bold="True">Category</asp:Label></td>
             ...
             <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                <asp:Label ID="Label7" CssClass="blackfnt" runat="server" Font-Bold="True">Product Type</asp:Label></td>
                <td align="left" colspan="2" style="width: 73%">
              ...
              <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                <asp:Label ID="Label1" CssClass="blackfnt" runat="server" Font-Bold="True">Company Name</asp:Label></td>
                <td align="left" colspan="2" style="width: 73%">
