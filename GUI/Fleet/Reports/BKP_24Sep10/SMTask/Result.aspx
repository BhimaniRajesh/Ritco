    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>SM Task Details</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
...
<rsweb:ReportViewer ID="rvDocuments" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="500px"
                ShowParameterPrompts="false" ShowPageNavigationControls="true" ShowBackButton="true" ProcessingMode="Remote" Width="950px">
            </rsweb:ReportViewer>
        </ContentTemplate>
    </asp:UpdatePanel>                
</asp:Content>