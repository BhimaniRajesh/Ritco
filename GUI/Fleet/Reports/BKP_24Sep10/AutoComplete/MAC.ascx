    ...
    function dacCodeKeyUp(e, WEBX, init) {
        ...
        if (code == 40) {
            ...
            if (findobj) {
                ...
                var strpg = fileURL.substring(0, cnt) + '/GUI/Fleet/Reports/AutoComplete/_mac_data.aspx?tp=' + WEBX.WebxComplete.Type + '&target1=' + WEBX.WebxComplete.Target1.getAttribute('id');
