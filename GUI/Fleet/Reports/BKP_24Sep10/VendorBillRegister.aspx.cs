...
public partial class admin_TireSearch : System.Web.UI.Page
{
    ...
    public void DropDownVendorType()
    {
        ...
        string strVendorType = "SELECT CodeId,CodeDesc FROM dbo.webx_master_general where codetype= 'vendty' and statuscode = 'Y' UNION SELECT 0,'ALL' FROM dbo.webx_master_general ORDER BY CodeDesc  ";
