<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="DieselCardListReport.aspx.cs" Inherits="GUI_Fleet_Reports_DieselCardListReport" %>
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>Diesel Card List Report</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
