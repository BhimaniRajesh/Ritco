<%@ Page Language="C#"   MasterPageFile="~/GUI/MasterPage.master"    AutoEventWireup="true" CodeFile="VehicleWiseKMPLReport.aspx.cs" Inherits="GUI_Fleet_Reports_VehicleWiseKMPLReport" %>
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>VehicleWise KMPL Report</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
