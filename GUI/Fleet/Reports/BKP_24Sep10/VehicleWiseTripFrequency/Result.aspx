<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_Fleet_Reports_VehicleWiseTripFrequency_Result" Title="Untitled Page" %>
   ...
   <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>Vehicle Wise Trip Frequency</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
