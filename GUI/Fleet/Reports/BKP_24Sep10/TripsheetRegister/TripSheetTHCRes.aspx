    ...
    <%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/GUI/MasterPage.master"     CodeFile="TripSheetTHCRes.aspx.cs" Inherits="GUI_Fleet_Reports_TripSheet" %>
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>Trip Register Report</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
