                    ...
                    <table cellspacing="1" style="width: 9.0in" class="boxbg" align="left">
                        ...
                        <tr style="background-color: white">
                            <td align="left" valign="top">
                             <asp:Label ID="Label8" runat="server" CssClass="blackfnt" Text="Tripsheet :"></asp:Label>                               
                             <asp:DropDownList ID="ddlDate" runat="server">
                                    <asp:ListItem Text="Driver Settlement" Value="0" Selected="True"></asp:ListItem>
                                    <asp:ListItem Text="Tripsheet" Value="1"></asp:ListItem>
                                    
                                </asp:DropDownList>
                                                          
                                <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="Date Range :" Width="102px"></asp:Label>                               
                            </td>
                            <td valign="top">
