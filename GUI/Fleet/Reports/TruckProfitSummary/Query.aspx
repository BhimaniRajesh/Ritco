...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OnSub_DATACHECK() {
            ...
            window.open("Result.aspx?FROMDT=" + txtDateFrom.value + "&TODT=" + txtDateTo.value + "&RO=" + cboRO.value + "&LO=" + cboLO.value + "&hdnRptId=" + hdnRptId.value + "");
            return false;
        }
...
<table cellspacing="1" style="width: 100%">
        <tr style="background-color: white">
            <td align="left">
                <asp:Label ID="lblPageHead" runat="server" CssClass="blackfnt" Font-Bold="True">Truck Profitability Summary</asp:Label>
                            ...
                            <tr style="background-color: white">
                                <td colspan="2" align="right" style="width: 100%">
                                    <asp:UpdatePanel ID="UPShowCustomer" UpdateMode="Always" RenderMode="Inline" runat="server">
                                        <ContentTemplate>
                                            <asp:Button ID="btnShow"  OnClientClick="Javascript: return OnSub_DATACHECK();"  runat="server" Text="Submit" Width="75px" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
