...
<script language="javascript" type="text/javascript">
         ...
         function OnSub_DATACHECK()
    {
     var txtDateFrom=document.getElementById("ctl00$MyCPH1$DT$txtDateFrom");
       ...
       var ddlVehicleNo=document.getElementById("ctl00_MyCPH1_ddlVehicleNo");
     ...
     window.open("DriverStatusResult.aspx?CreatedFrom=" + txtDateFrom.value + "&CreatedTo=" + txtDateTo.value + "&VehicleNo=" + ddlVehicleNo.value + "&Company_Code=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
    return false;
    }
    </script>
      ...
      <table cellspacing="1" style="width: 100%">
       ...
       <table cellspacing="1" cellpadding="2" class="boxbg">
                   ...
                   <%--     <tr style="background-color: white">
                        ...
                        <td   align="left" colspan="2" style="width: 112px"  >
