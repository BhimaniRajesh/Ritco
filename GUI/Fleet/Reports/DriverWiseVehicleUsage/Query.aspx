...
<script language="javascript" type="text/javascript">  
    ...
    function OnSub_DATACHECK()
    {
      ...
      var txtDateFrom=document.getElementById("ctl00$MyCPH1$DT$txtDateFrom");
       ...
       window.open("Result.aspx?VSlipDt_From=" + txtDateFrom.value + "&VSlipDt_To=" + txtDateTo.value + "&DRIVERNAME=" + txtDriver1.value + "&Company_Code=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
        return false;
    }
