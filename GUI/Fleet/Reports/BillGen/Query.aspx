<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query.aspx.cs" Inherits="GUI_Fleet_Reports_BillGen_Query" %>
...
<%-- <div >
        <table border="0" cellpadding="1" cellspacing="0" class="boxbg">
            <tr class="bgbluegrey">
                <td>
                    <font class="blackfnt"><center><strong>Trip Bill Pending for Submission</center></strong></font>
                </td>
            </tr>
        </table>
    </div>--%>
<div id="testdiv1" style="position: absolute; visibility: hidden; background-color: white; layer-background-color: white; z-index: 99;">
 ...
 <%-- by amruta  <input type="hidden" id="hdnRptId" runat="server" />--%>
            ...
            <td>
                <asp:Table ID="Table3" runat="server" CssClass="boxbg" CellPadding="3" CellSpacing="1"
                    ...
                    <asp:TableHeaderRow CssClass="bgbluegrey">
                        <asp:TableHeaderCell>
                            Trip Bill Pending for Submission
                        </asp:TableHeaderCell>
                    </asp:TableHeaderRow>
                </asp:Table>
            </td>
                ...
                <asp:Table ID="Table1" runat="server" CssClass="boxbg" CellPadding="3" CellSpacing="1"
                    ...
                    <asp:TableHeaderRow CssClass="bgbluegrey">
                        <asp:TableHeaderCell ColumnSpan="1">
                            <asp:Button ID="btnSubmit" OnClientClick="Javascript:return OnSub_DATACHECK();" runat="server"
                                Text="Submit" />
                        </asp:TableHeaderCell>
                    </asp:TableHeaderRow>
                </asp:Table>
