...
public partial class GUI_Fleet_Reports_Vehicle_Expen_Query : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        Cls_VehicleRegister.StrStart_dt = txtDateFrom.Text.ToString().Trim();
        Cls_VehicleRegister.StrEnd_dt = txtDateTo.Text.ToString().Trim();
        Cls_VehicleRegister.Strloccode = ddlBranch.SelectedItem.Text.ToString().Trim();
        Cls_VehicleRegister.StrVehicleNo = txtVehicleNo.Text.ToString().Trim();
