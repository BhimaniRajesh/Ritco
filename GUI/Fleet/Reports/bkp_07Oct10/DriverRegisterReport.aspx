<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/GUI/MasterPage.master" CodeFile="DriverRegisterReport.aspx.cs" Inherits="admin_TireSearch" %>
...
<script language="javascript" type="text/javascript">
 ...
 function OnSub_DATACHECK()
    {
        window.open("DriverRegisterResult.aspx","");
        return false;
    }
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                ...
                <table cellspacing="1" style="width: 100%" class="boxbg">
                    ...
                    <tr style="background-color: white">
                        <td align="left" >
                            <asp:Label ID="Label5" runat="server" CssClass="blackfnt" Font-Bold="True">Driver Status</asp:Label></td>
                        ...
                        <td colspan="4" align="right" style="width: 100%">
                           <asp:UpdatePanel ID="UPShowDriver" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                                <ContentTemplate>
                                 ...
                                 ValidationGroup="VGDtFromTo" OnClick="btnShow_Click" OnClientClick="Javascript: return OnSub_DATACHECK();"  />
