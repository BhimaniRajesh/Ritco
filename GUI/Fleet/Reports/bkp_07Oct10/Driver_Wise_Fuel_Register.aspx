...
//    {
//        window.open("Driver_Wise_Fuel_Register_Report.aspx","");
//        return false;
//    }
    </script>
...
<ProgressTemplate>
    ...
    <table cellspacing="1" style="width: 100%">
        <tr style="background-color: white">
            <td align="left">
                <asp:Label ID="lblPageHead" runat="server" CssClass="blackfnt" Font-Bold="True">Driver wise Fuel Register  </asp:Label>
            ...
            <td><asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                ...
                <table cellspacing="1" style="width: 100%" class="boxbg">
                    ...
                    <tr id="Tr1" visible="true" runat="server" style="background-color: white">
                     ...
                     <tr style="background-color: white">
                        <td align="left" valign="center" style="width: 15%;">
