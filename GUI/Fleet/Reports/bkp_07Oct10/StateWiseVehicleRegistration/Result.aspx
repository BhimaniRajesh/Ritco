<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_Fleet_Reports_StateWiseVehicleRegistration_Result" Title="Untitled Page" %>
   ...
   <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>State Wise Vehicle Registration</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
...
<rsweb:reportviewer id="ReportViewer1" runat="server" ShowBackButton="true"
                        processingmode="Remote" Height="1200px" Width="1200px" SizeToReportContent="True">
                        </rsweb:reportviewer>
            </td>
        </tr>
    </table>
