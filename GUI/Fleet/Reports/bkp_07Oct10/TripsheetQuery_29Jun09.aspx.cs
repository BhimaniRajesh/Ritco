...
public partial class GUI_Fleet_Reports_TripsheetQueryNew : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        if (chklstTripsheetDet.Items[0].Selected == true) { strTripsheetNo = "TripsheetNo"; }
        if (chklstTripsheetDet.Items[1].Selected == true) { strTripsheetStartDate = "TripsheetStartDate"; }
        if (chklstTripsheetDet.Items[2].Selected == true) { strTripsheetEndDate = "TripsheetEndDate"; }
        if (chklstTripsheetDet.Items[3].Selected == true) { strStartLocation = "StartLocation"; }


        if (chklstTripsheetDet.Items[4].Selected == true) { strEndLocation = "EndLocation"; }
        if (chklstTripsheetDet.Items[5].Selected == true) { strFromCity = "FromCity"; }
        if (chklstTripsheetDet.Items[6].Selected == true) { strToCity = "ToCity"; }
        if (chklstTripsheetDet.Items[7].Selected == true) { strCategory = "Category"; }
        if (chklstTripsheetDet.Items[8].Selected == true) { strTotalKms = "TotalKms"; }
        if (chklstTripsheetDet.Items[9].Selected == true) { strVehicleNo = "VehicleNo"; }

        if (chklstTripsheetDet.Items[10].Selected == true) { strVehicleCateGory = "VehicleCateGory"; }
        if (chklstTripsheetDet.Items[11].Selected == true) { strDriverName = "DriverName"; }
        if (chklstTripsheetDet.Items[12].Selected == true) { strStatus = "Status"; }
        if (chklstTripsheetDet.Items[13].Selected == true) { strStartingKM = "StartingKM"; }


        if (chklstTripsheetDet.Items[14].Selected == true) { strClosingKM = "ClosingKM"; }
        if (chklstTripsheetDet.Items[15].Selected == true) { strTotalKM = "TotalKM"; }
        if (chklstTripsheetDet.Items[16].Selected == true) { strApprovedKMPL = "ApprovedKMPL"; }
        if (chklstTripsheetDet.Items[17].Selected == true) { strActualKMPL = "ActualKMPL"; }

        if (chklstTripsheetDet.Items[18].Selected == true) { strDieselQuantity = "DieselQuantity"; }
        if (chklstTripsheetDet.Items[19].Selected == true) { strBillPrepared = "BillPrepared"; }
        if (chklstTripsheetDet.Items[20].Selected == true) { strBillNo = "BillNo"; }
        if (chklstTripsheetDet.Items[21].Selected == true) { strThcAttached = "ThcAttached"; }


        if (chklstTripsheetDet.Items[22].Selected == true) { strCustomername = "Customername"; }
        if (chklstTripsheetDet.Items[23].Selected == true) { strTotalTHCAmount = "TotalTHCAmount"; }

        //Expense Details 6
        string strAdvance = "", strRepair = "", strClaims = "", strFuel = "", strIncded = "", strSpare = "";

        if (chklstExpDet.Items[0].Selected  == true) { strAdvance = "Advance"; }
        if (chklstExpDet.Items[1].Selected == true) { strRepair = "Repair"; }
        if (chklstExpDet.Items[2].Selected == true) { strClaims = "Claims"; }
        if (chklstExpDet.Items[3].Selected == true) { strFuel = "Fuel"; }

        if (chklstExpDet.Items[4].Selected == true) { strIncded = "Incded"; }
        if (chklstExpDet.Items[5].Selected == true) { strSpare = "Spare"; }
        ...
        if (chklstEnrouteExp.Items[0].Selected == true) { strRTO = "RTO"; }
        if (chklstEnrouteExp.Items[1].Selected == true) { strBorderCheckPost = "BorderCheckPost"; }
        if (chklstEnrouteExp.Items[2].Selected == true) { strToll = "Toll"; }
        if (chklstEnrouteExp.Items[3].Selected == true) { strSalesTaxseal = "SalesTaxseal"; }


        if (chklstEnrouteExp.Items[4].Selected == true) { strEscorts = "Escorts"; }
        if (chklstEnrouteExp.Items[5].Selected == true) { strOctroi = "Octroi"; }
        if (chklstEnrouteExp.Items[6].Selected == true) { strLoading = "Loading"; }
        if (chklstEnrouteExp.Items[7].Selected == true) { strUnloading = "Unloading"; }


        if (chklstEnrouteExp.Items[8].Selected == true) { strEnrouteRapairs = "EnrouteRapairs"; }
        if (chklstEnrouteExp.Items[9].Selected == true) { strPenalty = "Penalty"; }
        if (chklstEnrouteExp.Items[10].Selected == true) { strTyrePuncture = "TyrePuncture"; }
        if (chklstEnrouteExp.Items[11].Selected == true) { strWeighBridgeExpenses = "WeighBridgeExpenses"; }


        if (chklstEnrouteExp.Items[12].Selected == true) { strParking = "Parking"; }
        if (chklstEnrouteExp.Items[13].Selected == true) { strTelephone = "Telephone"; }
        if (chklstEnrouteExp.Items[14].Selected == true) { strTemporaryPermit = "TemporaryPermit"; }
        if (chklstEnrouteExp.Items[15].Selected == true) { strDriverDailyAllowance = "DriverDailyAllowance"; }

        if (chklstEnrouteExp.Items[16].Selected == true) { strIncentivePayable = "IncentivePayable"; }
        if (chklstEnrouteExp.Items[17].Selected == true) { strOtherExpense = "OtherExpense"; }
        if (chklstEnrouteExp.Items[18].Selected == true) { strBrokerCommission = "BrokerCommission"; }
        ...
        if (chklstActExp.Items[0].Selected == true) { strTRIPSHEET_INCOME = "TRIPSHEET_INCOME"; }
        if (chklstActExp.Items[1].Selected == true) { strACTUAL_EXP = "ACTUAL_EXP"; }
        if (chklstActExp.Items[2].Selected == true) { strACTUAL_LOADUNLOAD = "ACTUAL_LOADUNLOAD"; }
        if (chklstActExp.Items[3].Selected == true) { strACTUAL_BROKERAGE = "ACTUAL_BROKERAGE"; }
        if (chklstActExp.Items[4].Selected == true) { strACTUAL_REPAIR = "ACTUAL_REPAIR"; }
        if (chklstActExp.Items[5].Selected == true) { strACTUAL_OCTROI = "ACTUAL_OCTROI"; }
        if (chklstActExp.Items[6].Selected == true) { strACTUAL_DRIVERALLOWANCE = "ACTUAL_DRIVERALLOWANCE"; }
        if (chklstActExp.Items[7].Selected == true) { strACTUAL_ClaimsAmt = "ACTUAL_ClaimsAmt"; }
        if (chklstActExp.Items[8].Selected == true) { strACTUAL_TOT_EXP = "ACTUAL_TOT_EXP"; }
