<%@ Page Language="C#"  MasterPageFile="~/GUI/MasterPage.master" CodeFile="DriverRegisterResult.aspx.cs" Inherits="GUI_Fleet_Reports_DriverRegisterResult" %>
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>Driver Register Report</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
