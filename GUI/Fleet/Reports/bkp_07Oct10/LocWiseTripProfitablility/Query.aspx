...
//           window.open("Result.aspx?FDT="+txtDateFrom.value+"&TDT="+txtDateTo.value+"&TDT="+txtDateTo.value+"&PSTS="+ddlProfStatus.value+"&MRF="+txtMRFrom.value+"&MRT="+txtMRTo.value+"TSNo=&VHNo=&RO="+RO.value+"&LO="+LO.value+"&LO_List="+txtLocs.value+"");
//           
//            return false;
//        }
    </script>
