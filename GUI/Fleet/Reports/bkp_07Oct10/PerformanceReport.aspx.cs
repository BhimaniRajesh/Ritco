...
public partial class Reports_PerformanceReport : System.Web.UI.Page
{
    ...
    public void addVehicle()
    {
        ...
        string STR = "select VEHNO from webx_VEHICLE_HDR  where ActiveFlag='Y'   and  Vendortype='05' order by VEHNO";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        {
            /////////Assign Procedure/////////////////
            sql = "usp_PerformanceReport_List";
            conn.Open();
            SqlCommand sqlcmd = new SqlCommand(sql, conn);
            sqlcmd.CommandType = CommandType.StoredProcedure;
            ...
            if (ddlCategory.SelectedItem.Text == "Vehicle-Wise")
            {
                //helper.RegisterGroup("VehicleNo", true, true);
            ...
            if (ddlCategory.SelectedItem.Text == "Vehicle-Wise")
            {
                helper.RegisterSummary("Total_No_of_Days", SummaryOperation.Sum, "VehicleNo");
                helper.RegisterSummary("Total_Kms", SummaryOperation.Sum, "VehicleNo");
            }
            else
            {
                helper.RegisterSummary("Total_No_of_Days", SummaryOperation.Sum, "RouteCode");
                helper.RegisterSummary("Total_Kms", SummaryOperation.Sum, "RouteCode");
