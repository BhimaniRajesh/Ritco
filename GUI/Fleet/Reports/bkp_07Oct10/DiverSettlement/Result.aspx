<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master"  AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_Fleet_Reports_DriverSettlement_Result" %>
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>Driver Settlement Report</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
...
<rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="500px"
                ShowPageNavigationControls="true" ShowBackButton="true" ProcessingMode="Remote" Width="100%">
            </rsweb:ReportViewer>
        </ContentTemplate>
    </asp:UpdatePanel>                
</asp:Content>
