...
public partial class GUI_Fleet_Reports_StateWiseVehicleRegistration_Result : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportFleetPathPrefix + "StateWiseVehReg";


        ReportParameter[] parameters = new ReportParameter[3];
        parameters[0] = new ReportParameter("state", Request.QueryString["state"].ToString());
