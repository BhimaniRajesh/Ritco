...
public partial class Reports_Result_vehicle_print : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        string location = Session["location"].ToString().Trim();//Request.QueryString.Get("location");
        string vehicle = Session["vehicle"].ToString().Trim();//Request.QueryString.Get("vehicle");
        string vehlist = Session["vehlist"].ToString().Trim();//Request.QueryString.Get("vehlist");
