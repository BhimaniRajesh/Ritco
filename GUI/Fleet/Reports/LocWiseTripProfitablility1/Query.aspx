...
//           alert ("Result.aspx?FDT="+txtDateFrom.value+"&TDT="+txtDateTo.value+"&TDT="+txtDateTo.value+"&PSTS="+ddlProfStatus.value+"&MRF="+txtMRFrom.value+"&MRT="+txtMRTo.value+"&TSNo="+ TempDocNo.value +"&RO="+RO.value+"&LO="+LO.value+"&LO_List="+txtLocs.value+"&Company_Code="+ ddlCompanyList+"")
//           window.open("Result.aspx?TripStartLoc="+txtLocs.value+"&RO=&TripSheetNo=&VehicleNo=&FromDate="+txtDateFrom.value+"&ToDate="+txtDateTo.value+"MarginFrom="+txtMRFrom.value+"&MRT="+txtMRTo.value+"&ProfStatus="+ddlProfStatus.value+"&TripStartLocList=&Company_Code="+ ddlCompanyList+"");
//           
//            return false;
//        }
    </script>
    ...
    <table width="80%" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td valign="top">
                ...
                <br />
                <div align="left">
                    <table cellspacing="1" style="width: 55%" class="boxbg" align="left">
                        <tr class="bgbluegrey">
                        ...
                        <td   align="left" colspan="1" style="width: 250px"  >
                            <asp:Label ID="Label9"  Font-Bold="True" CssClass="blackfnt" Text="Select Company" runat="server"></asp:Label>
                        </td>
                        ...
                        <tr id="Tr1" style="background-color: white;" runat="server" visible="false">
                            <td align="left" valign="top" colspan="3" Width="280px">
                        ...
                        <tr style="background-color: white">
                            <td align="left" valign="top" width="250px">
                                <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Text="Select Date :" Width="250px"></asp:Label>
                            </td>
                            <td valign="top">
