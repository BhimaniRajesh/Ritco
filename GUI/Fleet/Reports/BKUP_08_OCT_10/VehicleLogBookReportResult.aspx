<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="VehicleLogBookReportResult.aspx.cs" Inherits="GUI_Fleet_Reports_VehicleLogBookReportResult" Title="Untitled Page" %>
   ...
   <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>Vehicle LogBook Register Report</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
...
<rsweb:reportviewer id="ReportViewer1" runat="server" 
                        processingmode="Remote" Height="1200px" Width="2000px" SizeToReportContent="True">
                        </rsweb:reportviewer>
                    </ContentTemplate>
                </asp:UpdatePanel>
