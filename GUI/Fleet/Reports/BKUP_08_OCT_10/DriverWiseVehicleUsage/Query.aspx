<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_Fleet_Reports_DriverWiseVehicleUsage_Query" Title="Untitled Page" %>
...
<script language="javascript" type="text/javascript">
        ...
        function OnSub_DATACHECK()
    {
      ...
      var ddlCompanyList=document.getElementById("ctl00$MyCPH1$CMPFT1$ddlCompanyList");
       ...
       window.open("Result.aspx?VSlipDt_From=" + txtDateFrom.value + "&VSlipDt_To=" + txtDateTo.value + "&DRIVERNAME=" + txtDriver1.value + "&Company_Code=" + ddlCompanyList.value + "");
...
<table cellspacing="1" style="width: 100%">
    ...
    <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="True" runat="server">Fleet Module  > Reports >Driver Wise Vehicle Usage</asp:Label>
            </td> 
    ...
    <table cellspacing="1" cellpadding="2" style="width:55%" class="boxbg">
   ...
   <tr id="Tr1" visible="true" runat="server" style="background-color: white">
            ...
            <tr style="background-color: white">
                <td align="right" valign="center" style="width: 154px; text-align: left;">
                <asp:Label ID="Label5" CssClass="blackfnt" runat="server" Font-Bold="True">Driver Name</asp:Label>
                </td>
                <td align="left" colspan="2">
                <asp:TextBox ID="txtDriver1" runat="server"></asp:TextBox>&nbsp;
                <ajaxToolkit:AutoCompleteExtender
                            runat="server" 
                            BehaviorID="AutoCompleteEx2"
                            ID="autoComplete5" 
                            TargetControlID="txtDriver1"
                            ServicePath="~/services/FleetAutoComplet.asmx" 
                            ServiceMethod="GetDriverName"
                ...
                <input id="Driver" runat="server"   type="button" value="..." onclick="javascript:nwOpen('Popup-Driver1.aspx',null,'height=250,width=300,left=350,top=200,status=no,resizable=no,scrollbars=yes,toolbar=no,location=no,menubar=no');" />
