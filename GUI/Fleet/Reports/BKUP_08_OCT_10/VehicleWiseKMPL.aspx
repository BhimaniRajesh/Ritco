...
function OnSub_DATACHECK()
    {
     ...
     window.open("VehicleWiseKMPLReport.aspx?VEHNO=" + tb_TextBox.value + "&VSlip_FROMDT=" + txtDateFrom.value + "&VSLIP_TODT=" + txtDateTo.value + "&Company_Code=" + ddlCompanyList.value + "");
