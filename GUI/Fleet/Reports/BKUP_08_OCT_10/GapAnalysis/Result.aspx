<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Result.aspx.cs" Inherits="GUI_UNI_Net_MIS_Trip_Profitablility_Report_Result"  %>
...
<asp:UpdateProgress ID="uppMain" runat="server">
        <ProgressTemplate>
            ...
            <div style="position: absolute; z-index: 10; left: expression((this.offsetParent.clientWidth/2)-(this.clientWidth/2)+this.offsetParent.scrollLeft);
                ...
                <img src="../GUI/images/loading.gif" /><font face="verdana" color="blue" size="4">&nbsp;<b>Please
                    Wait...</b></font></div>
        </ProgressTemplate>
    </asp:UpdateProgress>
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30">
                ...
                <font class="bluefnt"><strong>Trip Gap Analysis</strong></font>&nbsp;</td>
        </tr>
        <tr>
            <td class="horzblue">
                <img src="../GUI/images/clear.gif" width="2" height="1"></td>
        </tr>
        <tr>
            <td>
                <img src="../GUI/images/clear.gif" width="15" height="10"></td>
        </tr>
    </table>   
    <br />
    <br />
...
<rsweb:ReportViewer ID="rvDocuments" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="500px"
                ShowParameterPrompts="false" ShowPageNavigationControls="true" ShowBackButton="true" ProcessingMode="Remote" Width="95%" ToolBarItemPressedHoverBackColor="221, 238, 247">
