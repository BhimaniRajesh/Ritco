...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
  <script language="javascript" type="text/javascript">
    ...
    {
        window.open("TripSheetRes.aspx","");
        return false;
    }
    function DATACHECK()
    {
        window.open("TripSheetTHCRes.aspx","");
        return false;
    }
  </script>
       ...
       <table cellspacing="1" cellpadding="2" class="boxbg" style="width: 800px">
                        ...
                        <tr   class="bgbluegrey">
                         ...
                         <tr style="background-color: white" align="center">
                             ...
                             <td align="right" colspan="1" style="width: 250px">
                                 <asp:Label ID="lblStatus" runat="server" Text="Status :"  CssClass="blackfnt"  
                            ...
                            <tr style="background-color: white" align="center">
                             ...
                             <td align="right" colspan="1" style="width: 250px">
                                 <asp:Label ID="Label1" runat="server" Text="Manual Driver wise :"  
                    ...
                    <asp:Label ID="Label9"      runat="server" BorderStyle="Groove" TabIndex="18" Text='<a href="javascript:nwOpen3(1)">...</a>'
                            ...
                            <tr style="background-color: white" align="center">
                             ...
                             <td align="right" colspan="1" style="width: 250px; height: 29px;">
                                 <asp:Label ID="Label2" runat="server" Text="Vehicle wise :"  
                                     CssClass="blackfnt"  Font-Bold="True"></asp:Label>&nbsp;
                              ...
                              <tr style="background-color: white">
                                  <td align="right" colspan="4" style="vertical-align: top; text-align: left">
                                      <asp:CheckBoxList ID="chklstTripsheetDet" runat="server" RepeatColumns="4" RepeatDirection="Horizontal"
                                          ...
                                          <asp:ListItem>Previous Driver1</asp:ListItem>
                                          <asp:ListItem>Previous Driver2</asp:ListItem>
                                          <asp:ListItem>Driver Settlement Status</asp:ListItem>
                                          <asp:ListItem>Driver Settlement Date</asp:ListItem>
                                                ...
                                                <caption>
                                                    ...
                                                    <tr class="bgbluegrey">
                                                        <td align="left" colspan="4" style="width: 100%; text-align: center;">
                                                            <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" Text="Submit" 
                                                                ValidationGroup="VGDtFromTo" OnClientClick="Javascript: return OnSub_DATACHECK();" />
                                                            <asp:Button ID="btnSubmitThc" runat="server" OnClick="btnSubmitThc_Click" 
                                                                Text="THC Details" ValidationGroup="VGDtFromTo" OnClientClick="Javascript: return DATACHECK();"/>
                                                        </td>
                                                    </tr>
                                                    <tr style="background-color: white">
