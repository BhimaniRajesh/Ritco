<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_Fleet_Reports_VehicleWiseFuelFill_Query" Title="Untitled Page" %>
...
<script language="javascript" type="text/javascript">  
 ...
 function cust(ID)
        ...
        function OnSub_DATACHECK()
    {
     ...
     window.open("Result.aspx?VEHNO=" + txtVehNo.value + "&VSlipDt_From=" + txtDateFrom.value + "&VSlipDt_To=" + txtDateTo.value + "&Company_Code=" + ddlCompanyList.value + "");
...
<table cellspacing="1" style="width: 100%">
    ...
    <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="True" runat="server">Fleet Module  > Reports >Vehicle Wise Fuel Fill Frequency</asp:Label>
            </td> 
