<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="GUI_Fleet_Reports_Vehicle_Expen_Query" %>
...
<script src="../../../images/CalendarPopup.js"  language="javascript" type="text/javascript"></script>
  <script language="javascript" type="text/javascript">
           ...
           function OnSub_DATACHECK()
    {
       ...
       window.open("Result.aspx?Start_dt=" + txtDateFrom.value + "&End_dt=" + txtDateTo.value + "&loccode=" + ddlBranch.value + "&VehicleNo=" + txtVehicleNo.value + "&Company_Code=" + ddlCompanyList.value + "");
            ...
            <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                ...
                <table cellspacing="1" style="width: 100%" class="boxbg">
                   ...
                   <tr style="background-color: white">
                        ...
                        <asp:Label ID="Label6" CssClass="blackfnt" runat="server" Font-Bold="True" Width="171px">Date Range:</asp:Label></td>
                     ...
                     <tr style="background-color: white">
                        ...
                        <td align="left" style="width: 123%;">
                               <asp:TextBox ID="txtVehicleNo" runat="server" CssClass="Input" Width="129px"></asp:TextBox><input id="Vehno" runat="server"   type="button" value="..." onclick="javascript:nwOpen('Popup-Vehicle.aspx',null,'height=250,width=300,left=350,top=200,status=no,resizable=no,scrollbars=yes,toolbar=no,location=no,menubar=no');"  />
