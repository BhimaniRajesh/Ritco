...
<script language="javascript" type="text/javascript">
        ...
        function OnSub_DATACHECK()
    {
     ...
     window.open("VendorBillRegisterResult.aspx?CreatedFrom=" + txtDateFrom.value + "&CreatedTo=" + txtDateTo.value + "&Status=" + ddlStatus.value + "&VendorType=" + ddlVendorType.value + "&VendorName=" + ddlVendorName.value + "&Company_Code=" + ddlCompanyList.value + "");
                    ...
                    <tr style="background-color: white">
                        <td colspan="3" align="right" style="width: 100%">
                            <asp:UpdatePanel ID="UPShowTyre" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="btnShow" runat="server" Text="Show Vendors >>" ValidationGroup="VGDtFromTo" OnClientClick="Javascript: return OnSub_DATACHECK();"/>
