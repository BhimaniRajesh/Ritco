...
<script src="../../images/CalendarPopup.js"  language="javascript" type="text/javascript"></script>
  ...
  <script language="javascript">
         ...
         function OnSub_DATACHECK()
    {
       ...
       window.open("Vehical_Expnse_Summary_Result.aspx?Start_dt=" + txtDateFrom.value + "&End_dt=" + txtDateTo.value + "&loccode=" + ddlBranch.value + "&Type_Code=" + ddlvehmodel.value + "&VehicleNo=" + txtVehicleNo.value + "&Company_Code=" + ddlCompanyList.value + "");
   ...
   <tr style="background-color: white">
                        <td colspan="4" align="right" style="width: 100%">
                           <asp:UpdatePanel ID="UPShowCustomer" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                                <ContentTemplate>
                                 <asp:Button ID="btnShow" runat="server" Text="Submit"  OnClientClick="javascript:OnSub_DATACHECK();" /> 
                                </ContentTemplate>
                            </asp:UpdatePanel>
