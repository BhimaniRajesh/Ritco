...
public partial class admin_TireSearch : System.Web.UI.Page
{
    ...
    {
        //string strVendorType = "SELECT Type_Code,Type_Name FROM dbo.webx_Vendor_Type UNION SELECT 'ALL','ALL' FROM dbo.webx_Vendor_Type ORDER BY Type_Name ";
    ...
    {
        string strVendorNm = "SELECT VENDORCODE,VENDORNAME FROM dbo.webx_VENDOR_HDR UNION SELECT 'ALL','ALL' FROM dbo.webx_VENDOR_HDR ORDER BY VENDORCODE";
        DataSet ds = new DataSet();
