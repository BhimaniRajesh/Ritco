...
<script src="../../images/CalendarPopup.js"  language="javascript" type="text/javascript"></script>
  ...
  <script language="javascript" type="text/javascript">
     ...
     function OnSub_DATACHECK()
    {
      ...
      window.open("DieselCardTranReport.aspx?VehNo=" + tb_TextBox1.value + "&CardNo=" + tb_TextBox.value + "&VSlipDt_From=" + txtDateFrom.value + "&VSlipDt_To=" + txtDateTo.value + "&Company_Code=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
