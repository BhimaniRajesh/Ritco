...
public partial class popup_MultiValueSelection : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        cmd.Parameters.Add("@Where1", SqlDbType.VarChar, 4000).Value = Convert.ToString(Request.QueryString["Where1"]);
        cmd.Parameters.Add("@Where2", SqlDbType.VarChar, 4000).Value = Convert.ToString(Request.QueryString["Where2"]);
        cmd.Parameters.Add("@Where1_Val", SqlDbType.VarChar, 4000).Value = Convert.ToString(Request.QueryString["Where1_Val"]);
        cmd.Parameters.Add("@Where2_Val", SqlDbType.VarChar, 4000).Value = Convert.ToString(Request.QueryString["Where2_Val"]);
