...
public partial class GUI_Fleet_Reports_JobApprovePendingClosure_Result : System.Web.UI.Page
{
...
if (!IsPostBack)
       ...
       // parameters.Add(new ReportParameter("Route", cust.ToString()));
        ...
        ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportFleetPathPrefix + "JobApprovalPendingClosure";
