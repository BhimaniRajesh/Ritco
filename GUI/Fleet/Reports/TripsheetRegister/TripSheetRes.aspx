<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TripSheetRes.aspx.cs" Inherits="GUI_Fleet_Reports_TripSheet" %>
    ...
    <div>
        <table width="100%">
            <tr>
                ...
                <td align="right">
                    <asp:ImageButton ID="imgbtnBack" ImageUrl="~/GUI/images/back.gif" runat="server"
