<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Popup_ManualNo.aspx.cs" Inherits="GUI_Fleet_Reports_Popup_ManualNo" %>
...
<head id="Head1" runat="server">
   ...
   <%-- <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
            ...
            //if(mNo == 1)
            {
                window.opener.document.forms[0].ctl00$MyCPH1$txtManual.value = objLocation.value;
                window.close();
            }
...
<table border="1" cellspacing="1" cellpadding="2" style="width: 41%">
  ...
  <tr>
   <td style="width: 172px"><font class="blackfnt">Manual Tripsheet No.</font></td>
   <td><font class="blackfnt">
        <asp:TextBox ID="txtManualTrip" runat="server"></asp:TextBox></font></td>
  </tr>
<tr>
                         ...
                         <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" >
                                    <ItemTemplate>
                                        <input name="MyRadioButton" type="radio" value='<%# Eval("Manual_Tripsheetno") %>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
                                    <ItemStyle BackColor="White" Width="40px" />
                                </asp:TemplateField>
 
                                <asp:BoundField DataField="Manual_Tripsheetno" HeaderText="Manual Tripsheet No.">
