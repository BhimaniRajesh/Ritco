<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Popup_ModelType.aspx.cs" Inherits="GUI_Fleet_Reports_Popup_ModelType" %>
...
<head id="Head1" runat="server">
   ...
   <script language="javascript" type="text/javascript">
        ...
        function SelectLocation(objLocation)
        {
            ...
            var mNo = "1"
            window.opener.document.forms[0].ctl00$MyCPH1$txtModel.value = objLocation.value
            window.close()
...
<br />- Please enter Location start with 'S' as 'S'
...
<table border="1" cellspacing="1" cellpadding="2" style="width: 41%">
  ...
  <tr>
   <td style="width: 172px"><font class="blackfnt">Model Name</font></td>
   <td><font class="blackfnt"><b>
        <asp:TextBox ID="txtModel" runat="server"></asp:TextBox></b></font></td>
  </tr>
 <%-- <tr>
                         ...
                         <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" >
                                    <ItemTemplate>
                                        <input name="MyRadioButton" type="radio" value='<%# Eval("MODEL_NO") %>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
                                    <ItemStyle BackColor="White" Width="40px" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="MODEL_NO" HeaderText="Model Name">
