...
//            window.opener.document.forms[0].ctl00$MyCPH1$txtVehNo.focus();
//            window.close()
...
<table border="1" cellspacing="1" cellpadding="2" style="width: 41%">
  ...
  <tr>
   <td style="width: 172px"><font class="blackfnt">Vehicle Number</font></td>
                         ...
                         <asp:GridView ID="GridView1" runat="server" AllowPaging="false" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Select" >
                                    <ItemTemplate>
                                        <input name="MyRadioButton" type="radio" value='<%# Eval("Vehno") %>~<%# Eval("veh_internal_no") %>' onclick="SelectLocation(this)"/>
                                    </ItemTemplate>
