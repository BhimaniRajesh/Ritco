...
public partial class GUI_Fleet_Operations_Issue_Popup_Vehicle : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (txtVehNo.Text != "")
        {
            ...
            //{
                sql = " select VEHNO  from webx_vehicle_hdr where   ActiveFLAG='Y'   and     vehno like '" + txtVehNo.Text + "%' " + " order by VEHNO";
            //}
            //else
            //{
            ...
            else
            {
                //if (Session["mBranch"].ToString() == "ALL")
                //{
                    sql = " select VEHNO  from webx_vehicle_hdr where   ActiveFLAG='Y'  order by VEHNO";
                //}
                //else
               //{
