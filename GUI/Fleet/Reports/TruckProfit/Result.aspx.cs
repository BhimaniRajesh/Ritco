...
public partial class GUI_Fleet_Reports_TruckProfit_Result : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportFleetPathPrefix + "Truck_Profitability_New";//Changes done by Amruta M 07/11/2013
            ...
            parameters[0] = new ReportParameter("VEHICLENO", Request.QueryString["VEHNO"].ToString());
            parameters[1] = new ReportParameter("From_dt", strFromDate);
            parameters[2] = new ReportParameter("To_dt", strToDate);
            parameters[3] = new ReportParameter("RO", Request.QueryString["RO"].ToString());
            parameters[4] = new ReportParameter("LO", Request.QueryString["LO"].ToString());
