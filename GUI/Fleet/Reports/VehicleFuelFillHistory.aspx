...
<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/GUI/MasterPage.master"     CodeFile="VehicleFuelFillHistory.aspx.cs" Inherits="GUI_Fleet_Reports_VehicleFuelFillHistory" %>
...
<script language="javascript" type="text/javascript">
    ...
    {
         var ddlVehType=document.getElementById("ctl00_MyCPH1_ddlVehType");
         ...
         window.open("VehicleFuelFillHistoryReport.aspx?TYPE_NAME=" + ddlVehType.value + "&VEHNO=" + tb_TextBox.value + "&FROMDT=" + txtDateFrom.value + "&TODT=" + txtDateTo.value + "&Company_Code=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
        //return false;
    }
    </script>
...
<ProgressTemplate>
 ...
 <table cellspacing="1" style="width: 100%">
    ...
    <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="True" runat="server">Fleet Module  > Reports >Vehicle Fuel Fill History</asp:Label>
            </td> 
    ...
    <hr align="center" size="1" color="#8ba0e5">
      ...
      <table cellspacing="1" style="width: 700px">
       ...
       <table cellspacing="1" cellpadding="2" style="width: 100%" class="boxbg">
                        <tr class="bgbluegrey">
                            <td colspan="3" align="center" style="vertical-align: top; width: 25%; text-align: left">
           ...
           <tr style="background-color: white">
               <td align="left" valign="center" width="23%">
                   <asp:Label ID="Label1" runat="server" CssClass="blackfnt" Font-Bold="True">Select Vehicle Type:</asp:Label></td>
               <td align="left" colspan="1" style="width: 77%">
                   <asp:DropDownList ID="ddlVehType" runat="server" Width="205px" AutoPostBack="True">
                   </asp:DropDownList></td>
           </tr>
                    ...
                    <tr style="background-color: white">
                        <td align="right" valign="center" style="width: 173px; text-align: left; height: 112px;">
                        <asp:Label ID="Label6" CssClass="blackfnt" runat="server" Font-Bold="True">Bill Date</asp:Label></td>
           ...
           <tr style="background-color: white">
               <td align="right" style="vertical-align: top; width: 173px; text-align: left">
               </td>
