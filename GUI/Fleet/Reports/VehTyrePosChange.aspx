...
<script src="../../images/CalendarPopup.js"  language="javascript" type="text/javascript"></script>
      ...
      function OnSub_DATACHECK()
    {
     ...
     window.open("VehTyrePosChangeReport.aspx?VehPosNotChangeDay=" + txtDays.value + "&VehNo=" + txtVehicleNo.value + "&Dt_From=" + txtDateFrom.value + "&Dt_To=" + txtDateTo.value + "&Company_Code=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
    return false;
    }
