...
public partial class GUI_Fleet_Reports_VehTyrePosChangeReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[0] = new ReportParameter("VehPosNotChangeDay", Request.QueryString["VehPosNotChangeDay"].ToString());
            parameters[1] = new ReportParameter("VehNo", Request.QueryString["VehNo"].ToString());
            parameters[2] = new ReportParameter("Dt_From", Request.QueryString["Dt_From"].ToString());
            parameters[3] = new ReportParameter("Dt_To", Request.QueryString["Dt_To"].ToString());
