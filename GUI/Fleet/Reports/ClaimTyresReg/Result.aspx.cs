...
public partial class GUI_Fleet_Reports_TyreSale_Result : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportFleetPathPrefix + "ClaimTyres_Dtls";
            ...
            parameters.Add(new ReportParameter("VendorCD", Request.QueryString["VendorCD"].ToString()));
