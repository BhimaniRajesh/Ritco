...
<script src="../../images/CalendarPopup.js"  language="javascript" type="text/javascript"></script>
  ...
  <script language="javascript" type="text/javascript">
    ...
    function OnSub_DATACHECK()
    {
       ...
       var tb_TextBox=document.getElementById("ctl00_MyCPH1_popUpCard_tb_TextBox");
       var tb_TextBox1=document.getElementById("ctl00_MyCPH1_popUpVehicle_tb_TextBox");
       var txtCardValueFrom=document.getElementById("ctl00_MyCPH1_txtCardValueFrom");
       var txtCardValueTo=document.getElementById("ctl00_MyCPH1_txtCardValueTo");
      ...
      window.open("DieselCardListReport.aspx?CARDNO=" + tb_TextBox.value + "&VEHNO=" + tb_TextBox1.value + "&CARDVAL_FROM=" + txtCardValueFrom.value + "&CARDVAL_TO=" + txtCardValueTo.value + "&COMPANY=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
        //return false;
      ...
      <table cellspacing="1" style="width: 700px">
       ...
       <table cellspacing="1" cellpadding="2" style="width: 100%" class="boxbg">
                     ...
                     <tr id="Tr1" visible="true" runat="server" style="background-color: white">
                            <td align="left">
                                <asp:Label ID="Label12" CssClass="blackfnt" Text="Select Company" runat="server"></asp:Label></td>
