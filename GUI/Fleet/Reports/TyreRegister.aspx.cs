...
public partial class GUI_Fleet_Reports_TyreRegister : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        TextBox txtTyreNo = (TextBox)this.popUpTyreNo.FindControl("tb_TextBox");
          ...
          company.SelectedValue.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_NO = txtTyreType.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_CATEGORY = txtTyreCat.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_MFG = txtTyreMfg.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_MODEL = txtTyreModelNo.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_SIZE = txtTyreSize.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_PATTERN = txtTyrePattern.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_TYPE = txtTyreType.Text.ToString().Trim();
          Cls_Report_TyreRegister.strPUR_DT_FROM = txtDateFrom.Text.ToString().Trim();
          Cls_Report_TyreRegister.strPUR_DT_TO = txtDateTo.Text.ToString().Trim();
          Cls_Report_TyreRegister.strNSD_FROM = txtNSDRangeF.Text.ToString().Trim();
          Cls_Report_TyreRegister.strNSD_TO = txtNSDTo.Text.ToString().Trim();
          Cls_Report_TyreRegister.strVEH_NO = txtVehicle.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_SIZE = txtTyreSize.Text.ToString().Trim();
          Cls_Report_TyreRegister.strKMRUN_FROM = txtKMF.Text.ToString().Trim();
          Cls_Report_TyreRegister.strKMRUN_TO = txtKMT.Text.ToString().Trim();
          Cls_Report_TyreRegister.strTYRE_STATUS = ddlTyreStatus.SelectedItem.Text.ToString().Trim();
          Cls_Report_TyreRegister.strCompany = company.SelectedItem.Text.ToString().Trim(); 
