...
{    
    ...
    //{
       ...
       //  Cls_Tripprofeblity.strFromDate =txtDateFrom.Text.ToString().Trim();

       // Cls_Tripprofeblity.strToDate= txtDateTo.Text.ToString().Trim();
       //Cls_Tripprofeblity.strProfStatus= ddlProfStatus.SelectedItem.Text.ToString().Trim();
       // Cls_Tripprofeblity.strMarginFrom = txtMRFrom.Text.ToString().Trim();
       // Cls_Tripprofeblity.strMarginTo = txtMRTo.Text.ToString().Trim();
       // Cls_Tripprofeblity.strTripSheetNo = ddlDocType.SelectedItem.Text.ToString().Trim();
       // Cls_Tripprofeblity.strVehicleNo = ddlDocType.SelectedItem.Text.ToString().Trim();
       //Cls_Tripprofeblity.strCompany_Code = company.SelectedValue.ToString().Trim();
    //    string QStrig = "Result.aspx";
    //    QStrig += "?TSNo=";
    //    QStrig += "&VHNo=";
