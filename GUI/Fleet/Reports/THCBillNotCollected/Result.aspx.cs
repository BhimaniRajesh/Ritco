...
public partial class GUI_Fleet_Reports_THCBillNotCollected_Result : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // parameters.Add(new ReportParameter("Route", cust.ToString()));
        ...
        ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportFleetPathPrefix + "THCBillNotCollect";
