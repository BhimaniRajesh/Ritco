<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query.aspx.cs" Inherits="GUI_Fleet_Reports_THCBillNotCollected_Query" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
            ...
            <td>
                <asp:Table ID="Table3" runat="server" CssClass="boxbg" CellPadding="3" CellSpacing="1"
                    ...
                    <asp:TableHeaderRow CssClass="bgbluegrey">
                        <asp:TableHeaderCell>
                            Trip bill (THC wise) Submitted but yet to be Collected.
                        </asp:TableHeaderCell>
                    </asp:TableHeaderRow>
                </asp:Table>
            </td>
   ...
   <table style="width: 100%;">
     ...
     <script type="text/javascript">
        ...
        document.getElementById('ctl00_MyCPH1_dtBookingDate_txtDateFrom').value = "01/01/2012";
  </script>
</asp:Content>
