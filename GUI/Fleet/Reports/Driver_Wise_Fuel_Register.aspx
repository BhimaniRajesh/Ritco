   ...
   function OnSub_DATACHECK()
    {
      ...
      window.open("Driver_wise_Fuel_Register_Report.aspx?Start_dt=" + txtDateFrom.value + "&End_dt=" + txtDateTo.value + "&driver1=" + ddlmanualname.value + "&Company_Code=" + ddlCompanyList.value + "&hdnRptId=" + hdnRptId.value + "");
