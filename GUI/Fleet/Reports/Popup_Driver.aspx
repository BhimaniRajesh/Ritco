<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Popup_Driver.aspx.cs" Inherits="GUI_Fleet_Operations_Issue_Popup_Driver" %>
                ...
                <tr>
                    <td>
                        <font class="blackfnt"><b><u>Note:</u></b>
                            <br />
                            - Please enter Driver Code start with 'S' as 'S'
                            <br />
                            - Please enter Driver Name start with 'S' as 'S' </font>
                    </td>
                </tr>
            </table>
            <br />
            <table border="1" cellspacing="1" cellpadding="2" style="width: 41%">
                ...
                <tr>
                    <td style="width: 172px">
                        <font class="blackfnt">Driver Code</font>
                    </td>
                    <td>
                        <font class="blackfnt"><b>
                            <asp:TextBox ID="txtDCode" runat="server"></asp:TextBox>OR</b></font>
                    </td>
                </tr>
                <tr>
                    <td style="width: 172px">
                    ...
                    <td>
                        <font class="blackfnt">
                            <asp:TextBox ID="txtDName" runat="server"></asp:TextBox></font>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
