<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/GUI/MasterPage.master"  EnableEventValidation="false" CodeFile="RequestFollowReport.aspx.cs" Inherits="Request_RequestFollowReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <td align="left">
                <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="true" runat="server">Fleet Module  > Reports >Request Follow-up Report</asp:Label>
    ...
    <hr align="center" size="1" color="#8ba0e5">
      ...
      <table cellspacing="1" style="width: 100%">
       ...
       <table cellspacing="1" cellpadding="2"   class="boxbg">
                        ...
                        <tr style="background-color: white">
                            <td align="left" valign="center" style="width: 250px">
                                &nbsp;<asp:Label ID="Label6" CssClass="blackfnt" runat="server" Font-Bold="True">Request Created in Date Range</asp:Label>&nbsp;</td>
                            <td align="left">
                        ...
                        <tr   class="bgbluegrey">
                         ...
                         <tr style="background-color: white" align="center">
                             ...
                             <td align="left" colspan="1">
                                 <asp:Label ID="lblStatus" runat="server"  CssClass="blackfnt" Text="Status" Font-Bold="True"></asp:Label>&nbsp;
...
<br />
            ...
            <td align="Left">
                &nbsp;<asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                   ...
                   <asp:BoundField   DataField="origin" HeaderText="Location"   />
                             <asp:HyperLinkField DataTextField="RequestNo"  ControlStyle-Font-Underline="true"   Target="_blank"   DataNavigateUrlFields="RequestNo,origin"  DataNavigateUrlFormatString="~/GUI/Fleet/Reports/FollowDetail.aspx?id= RequestNo &id1={1}" HeaderText="Total Request">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:HyperLinkField> 
                                <asp:HyperLinkField DataTextField="ReqAck" ControlStyle-Font-Underline="true"    Target="_blank"   DataNavigateUrlFields="ReqAck,origin" DataNavigateUrlFormatString="~/GUI/Fleet/Reports/FollowDetail.aspx?id= ReqAck &id1={1}"  HeaderText="Request Acknowledged">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataTextField="ReqNAck"  ControlStyle-Font-Underline="true"  Target="_blank"    DataNavigateUrlFields="ReqNAck,origin" DataNavigateUrlFormatString="~/GUI/Fleet/Reports/FollowDetail.aspx?id= ReqNAck &id1={1}"  HeaderText="Request Not Acknowledged">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataTextField="TripIssued" ControlStyle-Font-Underline="true"  Target="_blank"   DataNavigateUrlFields="TripIssued,origin"   DataNavigateUrlFormatString="~/GUI/Fleet/Reports/FollowDetail.aspx?id= TripIssued &id1={1}" HeaderText="Trip Sheet Issued">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataTextField="TripNIssued" ControlStyle-Font-Underline="true" Target="_blank"     DataNavigateUrlFields="TripNIssued,origin"  DataNavigateUrlFormatString="~/GUI/Fleet/Reports/FollowDetail.aspx?id= TripNIssued &id1={1}"  HeaderText="Trip Sheet Not Issued">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataTextField="JCNo"  ControlStyle-Font-Underline="true" Target="_blank"      DataNavigateUrlFields="JCNo,origin" DataNavigateUrlFormatString="~/GUI/Fleet/Reports/FollowDetail.aspx?id= JCNo &id1={1}" HeaderText="Trip/Journey Completed"  />
                                <asp:HyperLinkField DataTextField="JTNo" ControlStyle-Font-Underline="true" Target="_blank"    DataNavigateUrlFields="JTNo,origin"  DataNavigateUrlFormatString="~/GUI/Fleet/Reports/FollowDetail.aspx?id= JTNo &id1={1}"  HeaderText="Trip/Journey In-transit"   />
 ...
 <P align="center">
  ...
  <td align="center" style="height: 21px">
    <asp:LinkButton ID="LinkButton1" Font-Bold="true"  Visible="false" runat="server" OnClick="LinkButton1_Click">Transform To XLS</asp:LinkButton>
  </td>
