...
public partial class GUI_Fleet_Reports_VehicleMaintenance_Result : System.Web.UI.Page
{
...
if (!IsPostBack)
       ...
       // parameters.Add(new ReportParameter("Route", cust.ToString()));
        ...
        ReportViewer1.ServerReport.ReportPath = ReportServiceUtilities.ReportFleetPathPrefix + "VehicleMaintenance";
