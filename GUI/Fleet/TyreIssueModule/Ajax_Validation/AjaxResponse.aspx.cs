...
public partial class GUI_admin_KPI_Master_Ajax_Validation_AjaxResponse : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["Function"] == "CheckVehicle") { Response.Clear(); Response.Write(CheckVehicle()); Response.End(); }
        if (Request.QueryString["Function"] == "CheckTyre_KM") { Response.Clear(); Response.Write(CheckTyre_KM()); Response.End(); }
    }
