<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TripFinance.aspx.cs" Inherits="GUI_Admin_TripExpense"
        ...
        <asp:UpdatePanel runat="server" ID="UpPanel">
            <ContentTemplate>
                <ajaxToolkit:TabContainer runat="server" ID="tabExpenseMaster" Height="400px" ActiveTabIndex="0"
                    ...
                    <ajaxToolkit:TabPanel runat="server" ID="Panel1" HeaderText="Expense Master">
                        <ContentTemplate>
                                ...
                                <ContentTemplate>
                                    <table id="tb_add" border="0" class="boxbg" cellpadding="1" cellspacing="1" border="1"
                                        ...
                                        <tr id="Tr1" runat="server" class="bgbluegrey">
                                            <td align="left" style="font-size: 8pt; width: 15%; color: black; font-family: Verdana;
                                                height: 17px;">
                                                Edit
                                            </td>
                                            <td align="left" style="font-size: 8pt; width: 20%; color: black; font-family: Verdana;
                                                height: 17px;">
                                                Trip Expense
                                            </td>
                                            <td style="font-size: 8pt; width: 10%; color: black; font-family: Verdana; height: 17px;">
                                                Polarity
                                            </td>
                                            <td style="font-size: 8pt; width: 10%; color: black; font-family: Verdana; height: 17px;">
                                                Active Flag
                                            </td>
                                            <td style="font-size: 8pt; width: 45%; color: black; font-family: Verdana; height: 17px;">
                                                Account Code
                                            </td>
                                        </tr>
                                        <%-- 
                                            <td align="left" class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 15%;
                                            ...
                                            <td align="left" class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 20%;
                                                color: white; font-family: Verdana; height: 17px; background-color: #006699">
                                                Trip Expense
                                            </td>
                                            <td class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 10%; color: white;
                                                font-family: Verdana; height: 17px; background-color: #006699">
                                                Polarity
                                            </td>
                                            <td class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 10%; color: white;
                                                font-family: Verdana; height: 17px; background-color: #006699">
                                            ...
                                            <td class="blackfnt" style="font-weight: bold; font-size: 8pt; width: 45%; color: white;
                                                font-family: Verdana; height: 17px; background-color: #006699">
                                                Account Code
                                            </td>
                                        </tr>--%>
                                        ...
                                        <tr id="Tr2" runat="server" bgcolor="white">
                                            <td class="blackfnt" colspan="2">
                                                <asp:GridView ID="gv_Trip_Expense" runat="server" OnSelectedIndexChanged="gv_Trip_Expense_SelectedIndexChanged"
                                                    ...
                                                    AutoGenerateColumns="False" BorderColor="#8BA0E5" BorderWidth="1px" CssClass="dgRowStyle"
                                                    AllowPaging="true" HeaderStyle-CssClass="dgHeaderStyle" PagerStyle-HorizontalAlign="left"
                                                    Width="100%">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Trip Expense">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_TripExpHdr" runat="server" Text='<%# Bind("CodeDesc") %>'></asp:Label>
                                                                <asp:HiddenField ID="hfId" runat="server" Value='<%# Bind("CodeId") %>' />
                                                                <asp:HiddenField ID="hfCodeType" runat="server" Value='<%# Bind("CodeType") %>' />
                                                            </ItemTemplate>
                                                            <ItemStyle Width="20%" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Active Flag">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_Active_Flag" runat="server" Text='<%# Bind("StatusCode") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="10%" />
                                                        </asp:TemplateField>
