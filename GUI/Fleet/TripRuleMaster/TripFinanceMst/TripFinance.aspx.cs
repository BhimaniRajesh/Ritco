...
public partial class GUI_Admin_TripExpense : System.Web.UI.Page
{
    ...
    {
        TripFinance objTripExpense = new TripFinance(Session["SqlProvider"].ToString().Trim());
        objTripExpense.ID = "";
        objTripExpense.CodeType = "";
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (chk_Active_Flag.Checked == true) { objTripExpense.Active_Flag = "Y"; } else { objTripExpense.Active_Flag = "N"; }


            objTripExpense.BeginTransaction();
            try
            {
                if (hfId.Value != "" && hfType.Value != "")
                {
                    objTripExpense.ID = hfId.Value;
                    objTripExpense.CodeType = hfType.Value;
    ...
    protected void gv_Trip_Expense_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        HiddenField hfCodeType = (HiddenField)gv_Trip_Expense.Rows[gv_Trip_Expense.SelectedIndex].FindControl("hfCodeType");
