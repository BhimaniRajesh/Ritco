...
function AccBlur(tb_AccCode,tb_Description)
{
    ...
    var lbl_Err_AccCode = document.getElementById("tabExpenseMaster_Panel1_lbl_Err_AccCode");
...
{
    var lbl_Polarity_Err = document.getElementById("tabExpenseMaster_Panel1_lbl_Polarity_Err");
...
{
    var currentTime = new Date();
    var lbl_Trip_Exp_Err = document.getElementById("tabExpenseMaster_Panel1_lbl_Trip_Exp_Err");
    var hfId = document.getElementById("tabExpenseMaster$Panel1$hfId");
...
{
    var tb_Trip_Exp = document.getElementById("tabExpenseMaster_Panel1_tb_Trip_Exp");
    var lbl_Trip_Exp_Err = document.getElementById("tabExpenseMaster_Panel1_lbl_Trip_Exp_Err");
    var tb_Polarity = document.getElementById("tabExpenseMaster_Panel1_tb_Polarity");
    var lbl_Polarity_Err = document.getElementById("tabExpenseMaster_Panel1_lbl_Polarity_Err");
