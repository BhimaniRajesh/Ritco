    ...
    <div>
        ...
        <asp:GridView Visible="false" align="center" ID="dgMenifest" runat="server" BorderWidth="0"
            ...
            <Columns>
                <asp:TemplateField HeaderText="View" HeaderStyle-Width="15">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowManifest('<%#DataBinder.Eval(Container.DataItem, "tcno") %>,0')">
                            <font cssclass="Blackfnt">View </a>
                        <%-- <asp:LinkButton ID ="LnkView" Text="View" PostBackUrl ='<%#"~/GUI/Tracking/FrmMenifestView.aspx?tcno=" + DataBinder.Eval(Container.DataItem, "tcno") + ""%>' runat="server"  CssClass="blackfnt"></asp:LinkButton> --%>
                    </ItemTemplate>
                     <ItemStyle Wrap="false" BackColor="white" CssClass="blackfnt" HorizontalAlign="Center" />
        ...
        <asp:GridView Visible="false" align="center" ID="dgLS" runat="server" BorderWidth="0"
            ...
            <Columns>
                <asp:TemplateField HeaderText="View" HeaderStyle-Width="15">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowLSNO('<%#DataBinder.Eval(Container.DataItem, "tcno") %>,0')">
                            <font cssclass="Blackfnt">View </a>
                    </ItemTemplate>
                    <ItemStyle BackColor="white" CssClass="blackfnt" HorizontalAlign="Center" />
                    <HeaderStyle CssClass="blackfnt" />
        ...
        <asp:GridView Visible="false" align="center" ID="dgTHC" runat="server" BorderWidth="0"
            ...
            <Columns>
                ...
                <%--<asp:BoundField DataField="thcno" HeaderText="THC No">
                 ...
                 <asp:TemplateField HeaderText="THC No" HeaderStyle-Width="15" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowTHC_XLS('<%#DataBinder.Eval(Container.DataItem, "thcno") %>')">
                            <font class="Blackfnt"><%#DataBinder.Eval(Container.DataItem, "thcno")%></font> </a>
                    </ItemTemplate>
                     <ItemStyle Wrap="false" BackColor="white" CssClass="blackfnt" HorizontalAlign="Center" />
                    <HeaderStyle CssClass="blackfnt" />
                </asp:TemplateField>
            ...
            <Columns>
                <asp:TemplateField HeaderText="View" HeaderStyle-Width="15">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowTHC('<%#DataBinder.Eval(Container.DataItem, "thcno") %>,0')">
                            <font cssclass="Blackfnt">View </a>
                    </ItemTemplate>
                    <ItemStyle BackColor="white" CssClass="blackfnt" HorizontalAlign="Center" />
                    <HeaderStyle CssClass="blackfnt" />
        ...
        <asp:GridView Visible="false" align="center" ID="dgPDC" runat="server" BorderWidth="0"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="PDC No" HeaderStyle-Width="15" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowPDC_XLS('<%#DataBinder.Eval(Container.DataItem, "pdcno") %>')">
                            <font class="Blackfnt"><%#DataBinder.Eval(Container.DataItem, "pdcno")%></font> </a>
                    </ItemTemplate>
                     <ItemStyle Wrap="false" BackColor="white" CssClass="blackfnt" HorizontalAlign="Center" />
                    <HeaderStyle CssClass="blackfnt" />
                </asp:TemplateField>
            ...
            <Columns>
                <asp:TemplateField HeaderText="View" HeaderStyle-Width="15">
                    <ItemTemplate>
                        <a href="JavaScript:OpenPopupWindowPDC('<%#DataBinder.Eval(Container.DataItem, "pdcno") %>','<%#DataBinder.Eval(Container.DataItem, "PDCTY") %>',0)">
                            <font cssclass="Blackfnt">View </a>
                    </ItemTemplate>
                    <ItemStyle BackColor="white" CssClass="blackfnt" HorizontalAlign="Center" />
                    <HeaderStyle CssClass="blackfnt" />
