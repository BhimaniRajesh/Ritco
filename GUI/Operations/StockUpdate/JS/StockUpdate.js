...
function PassSelectedTHCForStockUpdate(){
    if(eval(doc+"hTHCSelected").value==""){
        alert('Please select a THC for Stock Update');
        return false;
    }
    return true;
}
...
function ValidateDocketData(){
   ...
   // alert(parseInt(eval(doc+"hStockList").value))
   
   /* for(var i=0;i<=parseInt(eval(doc+"hStockList").value)-1;i++)
       {
           if(i<10)
            {
                 DKTCHK = 'document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + '0'+ i +'_CHKSTUP';
            }
            else
            {
                 DKTCHK = 'document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl'+ i +'_CHKSTUP';
            }
      //  alert(DKTCHK)
       // alert(eval(DKTCHK).checked)
        
         if(eval(DKTCHK).checked==true)
           { 
                iCkCnt=iCkCnt+1;
            }
    ...
    */
    ...
    //-----------------------------------------------------
    //Loop FOR declare  MisRoute Dockets 
    //-----------------------------------------------------
    ...
    else
    {
       ...
       if(MSRCHK.checked==true)
            {                 
                xmlData_MSRDKT = xmlData_MSRDKT + "<SU><SUDate>" + tmpDt + "</SUDate>"; 
    ...
    for(i=0;i<parseInt(eval(doc+"hStockList").value);i++){
        ...
        //xmlData = xmlData + "<STOCKUPDATEDT>" + Trim(eval(doc+"txtStockUpdateDate").value) + "</STOCKUPDATEDT>";
        //-----------------------------------------------------
        //Package Validation
        //-----------------------------------------------------
        ...
        }//END Of Check BOX Checked Condition
        else
        {
         xmlData_NonArr = xmlData_NonArr + "<SU><SUDate>" + tmpDt + "</SUDate>";
                 if(i>9)
                {
                    xmlData_NonArr = xmlData_NonArr + "<TCNO>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + i +'_hMF').value) + "</TCNO>"
                    xmlData_NonArr = xmlData_NonArr + "<DOCKET>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + i +'_hDocket').value) + "</DOCKET>"
                    xmlData_NonArr = xmlData_NonArr + "<DOCKETSF>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + i +'_hDocketSF').value) + "</DOCKETSF>"
                    xmlData_NonArr = xmlData_NonArr + "<MSR_PKGSNO>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + i +'_txtArrvPkgs').value) + "</MSR_PKGSNO>"
                    xmlData_NonArr = xmlData_NonArr + "<MSR_ACTUWT>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + i +'_txtArrvWt').value) + "</MSR_ACTUWT>"
                   
                    
                } else 
                {
                    xmlData_NonArr = xmlData_NonArr + "<TCNO>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl'+ '0' + i +'_hMF').value) + "</TCNO>"
                    xmlData_NonArr = xmlData_NonArr + "<DOCKET>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + '0' + i +'_hDocket').value) + "</DOCKET>"
                    xmlData_NonArr = xmlData_NonArr + "<DOCKETSF>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + '0' + i +'_hDocketSF').value) + "</DOCKETSF>"
                    xmlData_NonArr = xmlData_NonArr + "<MSR_PKGSNO>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + '0' + i +'_txtArrvPkgs').value) + "</MSR_PKGSNO>"
                    xmlData_NonArr = xmlData_NonArr + "<MSR_ACTUWT>" + Trim(eval('document.aspnetForm.ctl00_MyCPH1_rptDocketList_ctl' + '0' + i +'_txtArrvWt').value) + "</MSR_ACTUWT>"
                  
                }
                
    
               xmlData_NonArr = xmlData_NonArr + "</SU>";
        
        }
         //End If Dely On Arrival 
    }//End of Loop Through SU Details

//alert("XML..1." +xmlData_MSRDKT)
//alert("xmlData_NonArr..1." +xmlData_NonArr)
    xmlData = xmlData + "</root>";
    xmlData_NonArr = xmlData_NonArr + "</root>";
    xmlData_MSRDKT = xmlData_MSRDKT + "</root>";
       
       
       eval(doc+"hXMLData").value=xmlData;
       eval(doc+"hXMLData_NonArr").value=xmlData_NonArr;
       eval(doc+"hXMLData_MSRDKT").value=xmlData_MSRDKT;
       
          document.getElementById("ctl00_MyCPH1_btnStockUpdate").style.display = "none";
//    alert(eval(doc+"hXMLData").value);
//    return false;
