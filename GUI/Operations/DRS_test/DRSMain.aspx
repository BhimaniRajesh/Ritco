<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="DRSMain.aspx.cs" Inherits="GUI_Operations_DRS_DRSCreateMain"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <asp:UpdatePanel ID="upDRSGenerate"  UpdateMode="Conditional" RenderMode="Inline" runat="server">
        <ContentTemplate>
            <table cellspacing="1" style="width: 100%">
                <tr style="background-color: white">
                    <td align="left">
                        <asp:Label ID="lblPageHead" CssClass="blackfnt" Font-Bold="true" runat="server">Generate DRS:</asp:Label>
            ...
            <table border="0" cellspacing="1" cellpadding="3" width="900px" class="boxbg" id="tblDocketCreteria" runat="server"  visible="true">
                ...
                <tr bgcolor="white">
                    <td align="left">
                        <asp:RadioButton ID="radTillDate" GroupName="Dates" runat="server" Text="" AutoPostBack="true" OnCheckedChanged="ResetDocketList"/>
                ...
                <tr bgcolor="white">
                    <td align="left">
                        <font class="blackfnt">Delivery At:</font>
                    </td>
                    <td>
                        <asp:DropDownList ID="cboDelyAt" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ResetDocketList">
            ...
            <table border="0" cellspacing="1" cellpadding="3" width="900px" class="boxbg" id="tblDRSHeader" runat="server" visible="true">
                <tr class="bgbluegrey">
...
--%>                    </td>
                ...
                <tr style="background-color: White">
                    <td align="right" colspan="6">
                        <asp:Button ID="btnSubmit" runat="server" Text="List Dockets for DRS Generation >>" OnClick="ListDocketsForDRSGeneration"/>
                    </td>
                </tr>
            </table>
            ...
            <table cellpadding="3" cellspacing="1" border="0" class="boxbg" id="tblResult" runat="server" width="900px" visible="false">
                <tr bgcolor="white">
                    <td align="left">
                        <font class="blackfnt"><b>DRS Generation Result</b></font>
                    </td>
                </tr>
...
<%--                                <asp:TemplateField  HeaderText="Docket #" ItemStyle-HorizontalAlign="left"
                                ...
                                <asp:TemplateField  HeaderText="Pay Basis" ItemStyle-HorizontalAlign="left"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lnk5" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "PayBasis")%>'
                                            CssClass="blackfnt" Font-Underline="false" CommandArgument="<%# Container.DataItemIndex %>"
                                             />
                                    </ItemTemplate>
                                </asp:TemplateField>
--%>
                                <asp:TemplateField  HeaderText="DRS #" ItemStyle-HorizontalAlign="left"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnk6" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "PDCNo")%>'
                                            CssClass="blackfnt" Font-Underline="false" PostBackUrl='<%# "~/GUI/Operations/DRS/DRS_View_Print.aspx?DRSNo=" + DataBinder.Eval(Container.DataItem, "PDCNo")%>'
                                             />
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <table cellpadding="3" cellspacing="1" border="0" class="boxbg" id="tblDocketList" runat="server" width="900px" visible="false">
                <tr style="background-color:White">
                    <td align="center">
                        <font class="blackfnt"><b>Dockets available for DRS Generation</b></font>
                    </td>
                </tr>
            ...
            <table cellpadding="3" cellspacing="1" border="0" id="tblSubmitBtn" runat="server" width="900px" visible="false">
                <tr bgcolor="white">
                    <td align="right">
                        <asp:Button ID="btnCreateDRS" runat="server" Text="Generate DRS >>" OnClick="GenerateDRS"/>
                    </td>
                </tr>
            </table>
        </ContentTemplate>
