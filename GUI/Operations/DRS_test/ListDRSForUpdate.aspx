<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="ListDRSForUpdate.aspx.cs" Inherits="GUI_Operations_DRS_ListDRSForUpdate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
   ...
   <script language="javascript" type="text/javascript">
        ...
        function CheckDRSSelection()
        {
            //Check for DRS No. selection
            if(document.getElementById("ctl00_MyCPH1_HidSelectedDRSNo"))
            {
                if(document.getElementById("ctl00_MyCPH1_HidSelectedDRSNo").value == "")
                {
                    alert("Select " + document.getElementById("ctl00_MyCPH1_HidDRS").value + " Details to Update!");
                    return false;
                }
            }
        ...
        function SelectDRSNo(objDRS)
        {
            if(document.getElementById("ctl00_MyCPH1_HidSelectedDRSNo"))
            {
                document.getElementById("ctl00_MyCPH1_HidSelectedDRSNo").value = objDRS.value;
            }
            
            //Loop through radio buttons and uncheck rest of the radio buttons
            var mTotalRecords = 0;
            ...
            {
                mDerivedControlName = "ctl00_MyCPH1_rptDocketList_ctl" + (mLoopCounter > 9 ? "" : "0") + mLoopCounter + "_radSelectDRS";
                
                if(mDerivedControlName != objDRS.id)
                {
										    ...
										    <table width="100%" border="0" cellspacing="0" cellpadding="0">
										        <tr> 
											        <td valign="top">
										                ...
										                <center>
										                    <table border="0" class="boxbg" cellspacing="1" cellpadding="1" width="55%">
                                                                <tr class="bgbluegrey">
                                                                    ...
                                                                    <td align="right">
                                                                        <label class="blackfnt" id="lblDockets" runat="server">
                                                                            <%--<b>
                                                                                No. of <%=Session["DocketCalledAs"].ToString() %>(s) in DRS
                                                                                &nbsp;
                                                                            </b>--%>
                                                                        </label>
                                                                    </td>
                                                                ...
                                                                <tr id="trNoRecsForDocketList" runat="server" style="background-color: White" visible="false">
                                                                    <td align="left" colspan="5">
                                                                        <label class="blackfnt" style="color: Red" id="lblNoRecsForDRS" runat="server">
                                                                            <%--DRS details not found for the given criteria.--%>
                                                                        </label>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <asp:Repeater ID="rptDocketList" runat="server" Visible="false">
                                                                    <ItemTemplate>
                                                                        <tr style="background-color: White">
                                                                            <td align="center">
                                                                                <input type="radio" id="radSelectDRS" runat="server" value='<%#DataBinder.Eval(Container.DataItem, "DRSNo")%>' 
                                                                                    onclick="SelectDRSNo(this)" />
                                                                            </td>
                                                                            ...
                                                                            <td align="left">
                                                                                <label class="blackfnt">
                                                                                    <%#DataBinder.Eval(Container.DataItem, "DRSNo")%>
                                                                                </label>
                                                                            </td>
                                                                            
                                                                            <td align="left">
                                                                                <label class="blackfnt">
                                                                                    <%#DataBinder.Eval(Container.DataItem, "DRSDate")%>
                                                                                </label>
                                                                            </td>
                                                                            
                                                                            <td align="right">
                                                                                <label class="blackfnt">
                                                                                    <%#DataBinder.Eval(Container.DataItem, "TotalDocketsInDRS")%>
                                                                                    &nbsp;
                                                                                </label>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <tr style="background-color: White" id="trUpdateSelectedDRS" runat="server" visible="false">
                                                                    <td colspan="5" align="center">
                                                                        <br style="font-size: 2pt;" />
                                                                        <asp:Button ID="btnSelectDRS" runat="server" OnClientClick="return CheckDRSSelection()" 
                                                                            OnClick="btnSelectDRS_Click" />
                                                                    </td>
                                                                </tr>
                                                                
                                                                <tr style="background-color: White" id="trLinkSelectDRSDetails" runat="server" visible="false">
                                                                    <td colspan="5" align="center">
                                                                        <br style="font-size: 2pt;" />
                                                                        <asp:LinkButton ID="lbtnSelectDRSDetails" runat="server" PostBackUrl="~/GUI/Operations/DRS/UpdateDRSMain.aspx" Font-Underline="true" ></asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <input type="hidden" id="HidSelectedDRSNo" runat="server" />
										                </center>
											        </td>
										        </tr>
