...
public partial class GUI_Operations_DeliveryMR_DelMRCancel : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        strsql = "SELECT CONVERT(VARCHAR,mrsdt,103) AS mrdate,* FROM webx_mr_hdr m INNER JOIN webx_gatepass g ON m.mrsno=g.mrsno";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                SetMessage("Delivery MR " + dr["mrsno"].ToString() + " is already cancelled."); return;
            }
    ...
    private void CancelMR(DataRow drmain, DataRow drbill)
    {
        ...
        try
        {
            ...
            strsql = "UPDATE webx_trans_docket_status SET delivered='N',dely_date=NULL,gatepassno=NULL,receivercode=NULL,receivername=NULL ";
