...
<script language="javascript" type="text/javascript">
  ...
  function selectItem(poptp,code1,code2)
  {
        ...
        {
            var hdncode1=document.getElementById("hdncode1");
            window.opener.document.getElementById(hdncode1.value).value=code1;
            window.close();
        }
...
<asp:ScriptManager ID="ScriptManager" runat="server" EnablePartialRendering="true">
    ...
    <br /><br />
        ...
        <asp:HiddenField ID="hdncode1" runat="server" Value="" />
         <asp:HiddenField ID="hdncode2" runat="server" Value="" />
    </form>
</body>
</html>
