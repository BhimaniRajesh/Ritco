    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <table class="boxbg" style="width: 10in" border="0" cellpadding="0" cellspacing="1">
                <tr bgcolor="white">
                    <td align="center" class="blackfnt">
                        ...
                        <asp:TextBox ID="TxtRows" runat="server" BorderStyle="Groove" MaxLength="2" CssClass="blackfnt"
                            onblur="javascript:return checkrows(this)" Style="text-align: right;" Width="44px"></asp:TextBox>
                        <asp:Button ID="CmdAddRows" CausesValidation="false" OnClientClick="return checkrows()"
                            runat="server" OnClick="CmdAddRows_Click" CssClass="blackfnt" Text="Add Rows"
                            Width="66px" />
                    </td>
                </tr>
                <tr bgcolor="White">
                    <td>
                        <asp:GridView Width="10in" Style="margin: 1px 1px 1px 1px;" ID="grvdocket" runat="server"
                            AutoGenerateColumns="false" CssClass="boxbg" HeaderStyle-CssClass="bgbluegrey"
                ...
                <tr class="bgbluegrey">
                    <td align="center">
                        <asp:Button ID="btnUpdt" OnClientClick="javascript:return clickSubmit()" runat="server"
                            Text="Submit" OnClick="btnUpdt_Click" />
                    </td>
                </tr>
            </table>
