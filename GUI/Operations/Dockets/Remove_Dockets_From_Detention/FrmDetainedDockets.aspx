...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
   ...
   function checkuncheckall(obj)
   {
         ...
         var rows = document.getElementById("ctl00_MyCPH1_GrdPaidFollow").rows.length;
                    ...
                    if(chkall == true)
                    {
                        document.getElementById("ctl00_MyCPH1_GrdPaidFollow_ctl02_chkheader").checked = true
                    }
                    else
                    {
                        document.getElementById("ctl00_MyCPH1_GrdPaidFollow_ctl02_chkheader").checked = false
                    }
   ...
   function checkuncheck(obj)
   {
                ...
                if (obj.checked == true)
                {
                    for(i=0;i<rows-2;i++)
                    {
                        ...
                        if (j<10)
                        {
                            document.getElementById("ctl00_MyCPH1_GrdPaidFollow_ctl0"+j+"_chkselect").checked = true
                        }
                        else
                        {
                            document.getElementById("ctl00_MyCPH1_GrdPaidFollow_ctl"+j+"_chkselect").checked = true
                        }
                    }   
                }
                else if (obj.checked == false)
                {
                    for(i=0;i<rows-2;i++)
                    {
                        ...
                        if (j<10)
                        {
                            document.getElementById("ctl00_MyCPH1_GrdPaidFollow_ctl0"+j+"_chkselect").checked = false
                        }
                        else
                        {
                            document.getElementById("ctl00_MyCPH1_GrdPaidFollow_ctl"+j+"_chkselect").checked = false
                        }
                    }    
                }
                return true
   ...
   function checkone()
   {
                ...
                <a><font class="blklnkund"><b>Module</b></font></a> <b>&gt; </b><a><font class="blklnkund">
                    <b>Reports</b></font></a> <b>&gt; </b><a href="../../../admin/operations.aspx"><font
                        class="blklnkund"><b>Operations</b></font></a> <b>&gt; </b><font class="bluefnt"><b>
                            Remove Dockets From Detention</b></font>
            </td>
            <td align="right">
    ...
    <div align="left">
        ...
        <asp:GridView ID="GrdPaidFollow" OnPageIndexChanging="PageIndexChanged_Click" PagerStyle-Mode="NumericPages"
            ...
            runat="server" OnRowDataBound="GrdPaidFollow_RowDataBound"
            OnRowCreated="GrdPaidFollow_RowCreated" EmptyDataRowStyle-CssClass="blackfnt" EmptyDataRowStyle-BackColor="white"
            EmptyDataText="No Records Found !!" Width="999px">
            <Columns>
                <asp:TemplateField HeaderText="Select">
                    <HeaderStyle CssClass="blackfnt" />
                    <HeaderTemplate>
                        <asp:Label Text="Select" CssClass="blackfnt" ID="lblselect" runat="server"></asp:Label><br />
                        <asp:CheckBox ID="chkheader" AutoPostBack="false" onclick="return checkuncheck(this)"
                            runat="server" />
                    </HeaderTemplate>
                    <ItemTemplate>
            ...
            <EmptyDataRowStyle CssClass="blackfnt" BackColor="White" />
        </asp:GridView>
        ...
        <div align="center" style="width:999px">
            <asp:Button ID="cmdexcel" runat="server" OnClientClick="return checkone()" OnClick="cmdexcel_Click"
                Text="Submit" Width="54px" Visible="False" />
        </div>
    </div>
</asp:Content>
