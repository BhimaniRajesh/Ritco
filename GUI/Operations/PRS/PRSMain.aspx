<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="PRSMain.aspx.cs" Inherits="GUI_Operations_PRS_PRSMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function setFocusInDocket()
        {
            if(document.getElementById("ctl00_MyCPH1_txtDocket"))
            {
                document.getElementById("ctl00_MyCPH1_txtDocket").focus();
            }
        }
        ...
        function ShowList()
        {
            ...
            //Check for Docket No. Entry
            if(document.getElementById("ctl00_MyCPH1_radDocket"))
            {
                if(document.getElementById("ctl00_MyCPH1_radDocket").checked == true)
                {
                    if(document.getElementById("ctl00_MyCPH1_txtDocket"))
                    {
                        if(document.getElementById("ctl00_MyCPH1_txtDocket").value == "")
                        {
                            alert("Enter " + document.getElementById("ctl00_MyCPH1_HidDocket").value + " No.!");
                            document.getElementById("ctl00_MyCPH1_txtDocket").focus();
                            return false;
                        }
                    }
                    ...
                    {
                        alert("Input Box is not available to enter " + document.getElementById("ctl00_MyCPH1_HidDocket").value + " No.");
                        return false;
                    }
                }
            }
    ...
    <div>
        ...
        <input type="hidden" id="HidPRS" runat="server" />       
				    ...
				    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
					    <%--<tr>
						    <td style="height: 30">
								...
								<asp:LinkButton ID="lnkBookOper" CssClass="blklnkund" runat="server" Text="Booking Operations" Font-Bold="true" PostBackUrl="#" />
								<b> &gt; </b>
											                        ...
											                        <table border="0" class="boxbg" cellspacing="1" cellpadding="1" width="75%">
                                                                        <tr class="bgbluegrey">
                                                                            <td align="center" colspan="2" style="height: 30px;">
                                                                                <label class="blackfnt" id="lblSelCriteria" runat="server">
                                                                                    <%--<b>
                                                                                        Select Docket Criteria By Arrival Date
                                                                                    </b>--%>
                                                                                </label>
                                                                            </td>
                                                                        </tr>
                                                                            ...
                                                                            <td valign="top" align="left" colspan="2">
	                                                                            <table>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td colspan="2">
                                                                                            <label class="blackfnt" id="lblLWDockets" runat="server">
                                                                                                <%--Last Week <%=Session["DocketCalledAs"].ToString() %>(s) (Including Today)--%>
                                                                                            </label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
	                                                                                    <td>
	                                                                                        <input type="radio" id="radDocket" runat="server" onclick="setFocusInDocket()" />
	                                                                                    </td>
                                                                                        <td colspan="2">
                                                                                            <label class="blackfnt" style="vertical-align:text-top" id="lblDockets" runat="server">
                                                                                                <%--<%=Session["DocketCalledAs"].ToString() %> No.(s): --%>
                                                                                            </label>
                                                                                            &nbsp;
                                                                                            <input type="text" id="txtDocket" maxlength="1000" size="45" class="input" runat="server" 
                                                                        ...
                                                                        <tr style="background-color: White">
                                                                            <td align="right" colspan="2">
                                                                                <asp:Button ID="btnSubmit" Text="Submit" runat="server" OnClientClick="return ShowList()" 
                                                                                    OnClick="btnSubmit_Click" ToolTip="Click here to Show List" />
                                                                            </td>
                                                                        </tr>
