<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="GeneratePRSResult.aspx.cs" Inherits="GUI_Operations_PRS_GeneratePRSResult" %>
    ...
    <div>
        ...
        <table border="0" class="boxbg" cellspacing="1" cellpadding="1" width="70%">
            ...
            <tr style="background-color: White">
                <td align="center" style="width: 37%;">
                    <label class="blackfnt" id="lblPRSCaption" runat="server">
                    </label>
                </td>
...
<%--            <tr class="bgbluegrey">
        ...
        <table border="0" class="boxbg" cellspacing="1" cellpadding="1" width="70%">
            <tr style="background-color: White">
                ...
                <td align="left">
                    <label class="blackfnt" id="lblMorePRS" runat="server">
                    </label>    
                </td>
            </tr>
        </table>
