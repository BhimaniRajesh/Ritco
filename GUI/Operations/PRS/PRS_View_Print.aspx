<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PRS_View_Print.aspx.cs" Inherits="GUI_Tracking_DRS_View_Print" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table border='<%=strborder %>' cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
                ...
                <tr bgcolor="white">
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="1" class='<%=boxbg %>' width="100%">
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td width="50%">
                                    <font class="blackfnt">PRS Location</font>
                                </td>
                                <td width="50%">
                                    <font class="blackfnt"><b></b></font><font class="blackfnt"><b>
                ...
                <tr bgcolor="#FFFFFF">
                    <td colspan="2" align="left" valign="top">
                        <font class="blackfnt" size="4"><b>PickUp Run Sheet </b></font>
                    </td>
                </tr>
            </table>
            <br />
            <table border='<%=strborder %>' cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
                ...
                <tr bgcolor="white">
                    <td align="left">
                        <font class="blackfnt">PRS made by</font>
                    </td>
                    <td align="left">
                        <font class="blackfnt">
                ...
                <tr bgcolor="white">
                    <td align="left">
                        <font class="blackfnt">Pickup charges </font>
                    </td>
                    <td align="left">
                        <font class="blackfnt">
