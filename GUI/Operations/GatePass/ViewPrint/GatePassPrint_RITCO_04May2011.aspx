...
<body onload="window.print()" style="margin: 10px 0px 0px 0px;" class="print_sml">
    <form id="form1" runat="server">
        <asp:Repeater ID="repgatepass" runat="server" OnItemDataBound="repgatepass_ItemDataBound">
            <ItemTemplate>
                <asp:Table ID="tblmain" runat="server" Width="5in" HorizontalAlign="Left" CssClass="print_sml"
                    ...
                    <asp:TableRow>
                        <asp:TableCell VerticalAlign="Top" CssClass="print_sml">Recieved From</asp:TableCell>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell ColumnSpan="2" Width="50%">
                            <asp:Table runat="server" CellPadding="0" CssClass="print_sml" CellSpacing="0" Width="100%"
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>Dem Charges</asp:TableCell>
                                    <asp:TableCell HorizontalAlign="Right">
                    ...
                    <asp:TableRow>
                        <asp:TableCell CssClass="print_sml">&nbsp;</asp:TableCell>
                        <asp:TableCell>
                        &nbsp;
                        </asp:TableCell>
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell>S.Tax 2.56%</asp:TableCell>
                        <asp:TableCell HorizontalAlign="Right">
