<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="ImportEnrouteStatusUpdateFromXLS_Docket.aspx.cs" Inherits="GUI_Operations_Enroute_Status_Update_ImportEnrouteStatusUpdateFromXLS_Docket" %>
                    ...
                    <table border="0" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr class="bgbluegrey">
                            <td class="blackfnt" align="center" colspan="2">
                                <b>Enroute Status Update Via XLS - <%=SessionUtilities.DocketCalledAs.ToString() %></b>
                            </td>
                        </tr>
                        <tr bgcolor="white">
                            <td>
        ...
        <div class="blackfnt">
            ...
            <table border="0" cellpadding="3" cellspacing="1" class="boxbg">
                <tr class="bgbluegrey">
                    ...
                    <td align="center" valign="top">
                        <b><%=SessionUtilities.DocketCalledAs.ToString() %>No</b>
                    </td>
                    <td align="center" valign="top">
                        <b>Date</b>
                    </td>
                    ...
                    <asp:GridView ID="gvInvalid" runat="server" CellSpacing="1" Border="0" HeaderStyle-CssClass="bgbluegrey"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <center>
                                        <asp:Label ID="lbl2" runat="server" Text='<%#SessionUtilities.DocketCalledAs +" No"%>'></asp:Label>
                                    </center>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblDockNo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DocketNo")%>'
                                        CssClass="blackfnt" Font-Underline="false" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Wrap="false"/>
                                <ItemStyle BackColor="white" CssClass="blackfnt" Wrap="false" HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <center>
                                        <asp:Label ID="lbl3" runat="server" Text="Date"></asp:Label>
                                    </center>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <center>
                                        <asp:Label ID="lbl4" runat="server" Text="Hour"></asp:Label>
                                    </center>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <center>
                                        <asp:Label ID="lbl5" runat="server" Text="Minute"></asp:Label>
                                    </center>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <center>
                                        <asp:Label ID="lbl6" runat="server" Text="Location"></asp:Label>
                                    </center>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <center>
                                        <asp:Label ID="lbl7" runat="server" Text="Remarks"></asp:Label>
                                    </center>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblLocation" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Remarks")%>'
                                        CssClass="blackfnt" Font-Underline="false" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Wrap="false"/>
                                <ItemStyle BackColor="white" CssClass="blackfnt" Wrap="true" HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <center>
                                        <asp:Label ID="lbl7" runat="server" Text="Error Message"></asp:Label>
                                    </center>
                                </HeaderTemplate>
                                <ItemTemplate>
