...
public partial class GUI_Operations_DRS_GenerateDRSResult : System.Web.UI.Page
{
    ...
    private void paintDocketListing()
    {
        ...
        string strSQL = "Select Dockno,mrsno, mrstype From webx_MR_HDR Where Dockno in (Select  Dockno From WebX_Trans_Docket_DRS Where DRSNo = '" + strDRSCode.Trim() + "' and DockSF='.')";
