<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateDRSMain.aspx.cs" Inherits="GUI_Operations_DRS_UpdateDRSMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function setFocusInDRS()
        {
            if(document.getElementById("ctl00_MyCPH1_txtDRS"))
            {
                document.getElementById("ctl00_MyCPH1_txtDRS").focus();
            }
        }
        ...
        function ShowList()
        {
            ...
            //Check for DRS No. Entry
            if(document.getElementById("ctl00_MyCPH1_radDRS"))
            {
                if(document.getElementById("ctl00_MyCPH1_radDRS").checked == true)
                {
                    if(document.getElementById("ctl00_MyCPH1_txtDRS"))
                    {
                        if(document.getElementById("ctl00_MyCPH1_txtDRS").value == "")
                        {
                            alert("Enter " + document.getElementById("ctl00_MyCPH1_HidDRS").value + " No.!");
                            document.getElementById("ctl00_MyCPH1_txtDRS").focus();
                            return false;
                        }
                    }
                    ...
                    {
                        alert("Input Box is not available to enter " + document.getElementById("ctl00_MyCPH1_HidDRS").value + " No.s");
                        return false;
                    }
                }
            }
                                                                        ...
                                                                        <tr class="bgbluegrey">
                                                                            <td align="center" colspan="2" style="height: 30px;">
                                                                                <label class="blackfnt" id="lblSelCriteria" runat="server">
                                                                                    <%--<b>
                                                                                        Search Criteria To Update DRS Details
                                                                                    </b>--%>
                                                                                </label>
                                                                            </td>
                                                                        </tr>
	                                                                            ...
	                                                                            <table>
	                                                                                <tr>
	                                                                                    ...
	                                                                                    <td align="left" valign="top">
	                                                                                        <label class="blackfnt" style="vertical-align:text-top" id="lblDRSDateFrom" runat="server">
	                                                                                            <%--DRS Date From:--%>
	                                                                                        </label>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <label class="blackfnt" id="lblLSDRS" runat="server">
                                                                                                <%--Last Week DRS(s) (Including Today)--%>
                                                                                            </label>
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td colspan="2">
                                                                                            <label class="blackfnt" id="lblLSDRSTillDate" runat="server">
                                                                                                <%--DRS(s) Till Date--%>
                                                                                            </label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
	                                                                                    <td>
	                                                                                        <input type="radio" id="radDRS" runat="server" onclick="setFocusInDRS()" />
	                                                                                    </td>
                                                                                        <td colspan="2">
                                                                                            <label class="blackfnt" style="vertical-align:text-top" id="lblDRSNo" runat="server">
                                                                                                <%--DRS No.(s): --%>
                                                                                            </label>
                                                                                            &nbsp;
                                                                                            <input type="text" id="txtDRS" maxlength="1000" size="45" class="input" runat="server" 
                                                                        ...
                                                                        <tr style="background-color: White">
                                                                            <td align="right" colspan="2">
                                                                                <asp:Button ID="btnShowList" Text="Show List" runat="server" OnClientClick="return ShowList()" 
                                                                                    OnClick="btnShowList_Click" ToolTip="Click here to Show List" />
                                                                            </td>
                                                                        </tr>
