    ...
    &nbsp;&nbsp;&nbsp;
            ...
            <table border="0" cellspacing="1" cellpadding="3" width="900px" class="boxbg" id="tblDRSHeader" runat="server" visible="false">
                ...
                <tr style="background-color: White">
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtEngineNo" runat="server" MaxLength="20" Width="100"></asp:TextBox>
                    </td>
                    <td align="left">
                        <font class="blackfnt">Chasis No.:</font>
                    </td>
                    <td align="left">
                        <asp:TextBox ID="txtChasisNo" runat="server" MaxLength="20" Width="100"></asp:TextBox>
                    </td>
                    <td align="left">
                        <font class="blackfnt">RC Book No.:</font>
                    </td>
                    <td align="left">
                        <asp:TextBox ID="txtRCBookNo" runat="server" MaxLength="20" Width="100"></asp:TextBox>
                    </td>
                </tr>
                <tr style="background-color: White">
                    <td align="left">
