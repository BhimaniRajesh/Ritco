...
<body>
    <form id="form1" runat="server">
        ...
        %>
        <div>
            <table border="0" cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
                style="width: 6.7in">
                <tr bgcolor="white">
                    ...
                    <td>
                        <%--<table cellspacing="0" cellpadding="1" class='<%=boxbg %>' width="100%">
                            <tr bgcolor="#FFFFFF">
                                <td>
                                    <table border="1" cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
                                        width="100%">
                                        <tr bgcolor="white">
                        ...
                        <table cellspacing="0" border="1" cellpadding="1" class='<%=boxbg %>' width="100%">
                            <tr bgcolor="#FFFFFF">
                                <td width="50%">
                                    <font class="blackfnt">DRS No. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                    </font>&nbsp;<font class="blackfnt"><b><asp:Label ID="lblDrsNo" runat="server" CssClass="blackfnt"></asp:Label></b></font><br />
                                    <font class="blackfnt">DRS Date.</font> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                    <font class="blackfnt"><b>
                                        <asp:Label ID="lblDrsDate" runat="server" CssClass="blackfnt"></asp:Label></b></font><br />
                                    <font class="blackfnt">Manual DRS No.</font> &nbsp; &nbsp; &nbsp;<font class="blackfnt"><b><asp:Label
                                        ID="lblManualDrsNo" runat="server" CssClass="blackfnt"></asp:Label></b></font><br />
                                    <font class="blackfnt">DRS Location &nbsp; &nbsp; &nbsp; &nbsp; </font>&nbsp;<font
                                        class="blackfnt"><b><asp:Label ID="lblDRSlocation" runat="server" CssClass="blackfnt"></asp:Label></b></font>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <br />
            <asp:GridView ID="Dockdata" style="width: 6.7in" ShowFooter="true" FooterStyle-CssClass='<%=boxbg %>'
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label3" CssClass="blackfnt" Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem,"EDD")) %>'
                                runat="server"></asp:Label><br />
                            <asp:Label ID="lblCODDODAmount" CssClass="blackfnt" Text="COD/DOD amount" Font-Bold="true"
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblconsignor" CssClass="blackfnt" Text='<%# Convert.ToString(DataBinder.Eval( Container.DataItem,"consignor"))%>'
                                runat="server"></asp:Label><br />
                            <asp:Label ID="lblCODDODCharge" CssClass="blackfnt" Text="CODDODCharge" Font-Bold="true"
                                Visible="false" runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                        <FooterTemplate>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblpkgs" CssClass="blackfnt" Text='<%# Convert.ToString(DataBinder.Eval( Container.DataItem,"pkgsno"))%>'
                                runat="server"></asp:Label><br />
                            <asp:Label ID="lblactualweight" CssClass="blackfnt" Text='<%# Convert.ToString(DataBinder.Eval( Container.DataItem,"ACTUWT"))%>'
                                runat="server"></asp:Label><br />
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <br />
                            <asp:Label ID="lblCODDODCollected" CssClass="blackfnt" Font-Bold="true" Text="CODDODcollected"
                                Visible="false" runat="server"></asp:Label>
                        </ItemTemplate>
        ...
        <br />
        <table border='<%=strspace %>' cellspacing='<%=strspace %>' cellpadding="0" class='<%=boxbg %>'
            style="width: 6.7in">
                        <tr bgcolor="white">
