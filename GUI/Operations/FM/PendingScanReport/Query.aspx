<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="Query.aspx.cs" Inherits="GUI_Operations_FM_PendingScanReport_Query"
    Title="Untitled Page" %>
            ...
            <tr>
                <td height="30">
                    ...
                    <font class="blklnkund"><strong>DFM </strong></font><strong>&gt; </strong><font class="bluefnt">
                        <strong>Document Tet To Scan</strong></font>
                </td>
            </tr>
            <tr>
                <td class="horzblue">
                    ...
                    <table cellspacing="1" class="boxbg" align="left">
                        ...
                        <tr style="background-color: white">
                            <td align="left" valign="top" width="104">
                                <asp:Label ID="Label1" CssClass="blackfnt" Text="Document Type" runat="server"></asp:Label>
                            </td>
