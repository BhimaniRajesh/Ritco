<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="DisplayFMFWDDocumentsResult.aspx.cs" Inherits="GUI_Operations_FM_DisplayFMFWDDocumentsResult" Title="FM - Forward Documents - Result" %>
		    ...
		    <tr>
			    <td>
				    <label class="blackfnt">
				        ...
				        <hr align="center" size="1" color="#8ba0e5" id="HR1" onclick="return HR1_onclick()">
				    </label>    
			    </td>
		    </tr>
                                                                    ...
                                                                    <td align="center" style="width: 34%;">
                                                                        <label class="blackfnt">
                                                                           <%-- <a href="JavaScript:alert('Yet to be implemented!');">--%>
                                                                                    ...
                                                                                    <a href="Javascript:ViewPrint('<%=strFMNo %>','<%=strFMID %>',0)"><font class="blklnkund">View</font></a> | <a href="Javascript:ViewPrint('<%=strFMNo %>','<%=strFMID %>',1)"><font class="blklnkund">Print
                                                                        </label>
                                                                    </td>
                                                                </tr>
