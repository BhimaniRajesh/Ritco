...
public partial class GUI_Operations_THC_THCDeparturesMain : System.Web.UI.Page
{
    ...
    protected void ShowTHCForDeparture(object sender, EventArgs e)
    {
        BindGrid();
    }

    protected void PassSelectedTHCForDeparture(object sender, EventArgs e)
    {
        Response.Redirect("THCDepartureSubmit.aspx?THCNO=" + hTHCSelected.Value + "&BRCD=" + Session["brcd"].ToString().Trim());
    }
    ...
    protected void SetDataSet()
    {
        ...
        string sql = "usp_THC_For_Departure";
