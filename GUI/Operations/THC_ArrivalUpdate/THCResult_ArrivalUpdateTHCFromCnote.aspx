<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="THCResult_ArrivalUpdateTHCFromCnote.aspx.cs" Inherits="GUI_Operations_THC_ArrivalUpdate_THCResult_ArrivalUpdateTHCFromCnote" %>
        ...
        <SelectParameters>
            ...
            <asp:SessionParameter Name="BRCD" SessionField="brcd" Type="String" DefaultValue="HYDB" />
             <asp:QueryStringParameter Name="TYP" QueryStringField="TYP" DefaultValue="1"
                Type="String" />
            <asp:QueryStringParameter Name="THCFromCnote" QueryStringField="THCFromCnote" DefaultValue="Y"
                Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="SR.NO." ItemStyle-BackColor="white">
                                 ...
                                 <asp:TemplateField HeaderText="SR.NO." ItemStyle-BackColor="white">
                                    ...
                                    <ItemTemplate>
                                      <a href="./THC_ArrivalProcessTHCFromCnote.aspx?THCno=<%# DataBinder.Eval(Container.DataItem, "thcno")%>&TYP=B" >   <asp:Label CssClass="blackfnt" ID="lblarrupdt1" 
                                 ...
                                 <asp:TemplateField HeaderText="SR.NO." ItemStyle-BackColor="white">
                                    ...
                                    <ItemTemplate>
                                      <a href="./THC_ArrivalProcessTHCFromCnote.aspx?THCno=<%# DataBinder.Eval(Container.DataItem, "thcno")%>&TYP=A" >   <asp:Label CssClass="blackfnt" ID="lblarrst" 
                                         Font-Underline="true"        runat="server">
                                            </asp:Label></a>
                                ...
                                <asp:TemplateField HeaderText="SR.NO." ItemStyle-BackColor="white">
                                    ...
                                    <ItemTemplate>
                                      <a href="./THC_ArrivalProcessTHCFromCnote.aspx?THCno=<%# DataBinder.Eval(Container.DataItem, "thcno")%>&TYP=S" >   <asp:Label CssClass="blackfnt" ID="lblstockst" 
                                           Font-Underline="true"      runat="server">
                                            </asp:Label></a>
