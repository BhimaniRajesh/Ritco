...
public partial class GUI_Operations_THC_ArrivalUpdate_THC_ArrivalUpdateTHCFromCnote : System.Web.UI.Page
{
    string process = "";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        final += "&THCFromCnote=Y";
        final += "&process=" + process;

        Response.Redirect("THCResult_ArrivalUpdateTHCFromCnote.aspx" + final);
    }
}
