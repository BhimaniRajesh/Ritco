<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="GenGatePassEntry.aspx.cs" Inherits="GUI_Operation_DeliveryMR_DeliveryMR"
    Title="Untitled Page" %>
                            ...
                            <asp:Panel ID="divstep2" runat="server">
                                <asp:Table ID="Table1" runat="server" CssClass="boxbg" CellSpacing="1" Width="100%">
                                    <asp:TableRow CssClass="bgwhite">
                                        ...
                                        <asp:TableCell>
                                            <asp:TextBox ID="TxtGatePassDate" Enabled="false" runat="server" Width="70px" MaxLength="10"
                                                CssClass="blackfnt" BorderStyle="Groove"></asp:TextBox>
                                            <asp:Label ID="lblmrdateimage" runat="server">
                                                <a href="#" onclick="cal.select(document.aspnetForm.ctl00_MyCPH1_TxtGatePassDate,'ancmrdate','dd/MM/yyyy'); return false;" name="ancmrdate" id="ancmrdate">
                                    ...
                                    <asp:TableRow ID="trbtnstep2" runat="server" CssClass="bgbluegrey">
                                        <asp:TableCell ColumnSpan="4" HorizontalAlign="Right">
                                            <asp:Button ID="btnstep2" Text="Gate Pass Entry" OnClientClick="javascript:return step2Click()"
