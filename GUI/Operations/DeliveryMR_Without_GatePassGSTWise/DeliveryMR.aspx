<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="DeliveryMR.aspx.cs" Inherits="GUI_Operation_DeliveryMRGSTWise_DeliveryMR"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <%@ Register Src="~/GUI/Common_UserControls/GSTTaxControl.ascx" TagPrefix="UserControl" TagName="ucGSTTaxControl" %>
    <script type="text/javascript" language="javascript">
        var serviceUrl = "<%= ResolveUrl("~/GUI/services/WebService.asmx") %>";
		var serviceUrlGSTCommonService = "<%=ResolveClientUrl("~/services/GSTCommonService.asmx")%>";
        var urlPoupFileUpload = "<%= ResolveUrl("~/GUI/Common_UserControls/UploadHelper.aspx")%>";
    </script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        *****************************************************************************************************************/
        ...
        function calculateTotalforDeliveryMr() {
...
if (document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge") != null)
            ...
            //GST Change
            SubTotalsSet(roundNumber(subtotal, 2));
			var dktTot=DocketTotalGet();
			if (hdnflagroundoff.value == "Y")
			{		
				DocketTotalSet(Math.round(dktTot));
			}
			else
			{
				DocketTotalSet(roundNumber(dktTot, 2));
			}
            txtcollamt.value = DocketTotalGet();
            //GST Change
            return false;
        }
...
if (document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge") != null)
        ...
        function btnsubmitClick() {
            ...
            if ((parseFloat(hdnarrpkgqty.value) == parseFloat(hdnpkgsno.value) && ddlsuffix.value == "M") || ddlsuffix.value == ".") {
                ...
                if (parseFloat(txtcollamt.value) > parseFloat(DocketTotalGet())) {
                ...
                if (parseFloat(txtcollamt.value) < parseFloat(DocketTotalGet())) {
                    ...
                    //var billamt = parseFloat(DocketTotalGet()) - parseFloat(txtcollamt.value)
                        ...
                        <asp:TableCell>
                            <asp:Table runat="server" Width="100%" CssClass="boxbg" CellSpacing="1">
                                ...
                                <asp:TableRow CssClass="bgwhite">
                                    <asp:TableCell ColumnSpan="4">
                                        <%--GST Change--%>
                                        <UserControl:ucGSTTaxControl runat="server" ID="ucGSTTaxControl" />
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </asp:TableCell>
