<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="DelMRCancelDone.aspx.cs" Inherits="GUI_Operation_Singlescreen_docketentry_Docket_submit_done" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
 ...
 function docPrint()
 {
    ...
    window.open(fileURL.substring(0,cnt) + hdn_psp_url.value.substring(1,hdn_psp_url.value.length) + '?tp=0&gatepassnos=' + hdngatepassno.value,"",null);
 }     
                    ...
                    <table border="0" cellpadding="1" cellspacing="1" class="boxbg">
                        <tr class="bgbluegrey" style="height: 25px">
                            <td align="left" colspan="4" style="height: 25px">
                                <font class="blackfnt"><b>Following document has been cancelled successfully</b></font></td>
                        </tr>
                        ...
                        <tr bgcolor="#FFFFFF">
                            ...
                            <td width="100%" align="left" bgcolor="#FFFFFF" colspan="5" style="height: 25px">
                                <font class="blackfnt"><u><a href="DelMRCancel.aspx"><font class="blklnkund">Click Here to Cancel More Delivery MRs</a></u></font>
                            </td>
                        </tr>
                    </table>
                </td>
