<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="CrossingChallanDone.aspx.cs" Inherits="GUI_Operations_Crossing_CrossingChallanDone" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <br />
    <asp:Table ID="Table1" runat="server" BorderWidth="1" CssClass="boxbg" Width="9in" CellSpacing="1">
        <asp:TableRow CssClass="bgbluegrey">
            <asp:TableCell ColumnSpan="3" Font-Bold="true" HorizontalAlign="Center">
            Crossing Challan Generated
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow CssClass="bgwhite">
            ...
            <asp:TableCell HorizontalAlign="Center">
                <asp:Label ID="lblCrossingChallanNo" runat="server" Text=""></asp:Label>
            </asp:TableCell>
            <asp:TableCell HorizontalAlign="Center">
            <a href="Javascript:ViewPrint('<%=Request.QueryString.Get("CrossingChallanNo")%>',0)">View</a> |
           <a href="Javascript:ViewPrint('<%=Request.QueryString.Get("CrossingChallanNo")%>',1)">Print</a>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow CssClass="bgwhite">
