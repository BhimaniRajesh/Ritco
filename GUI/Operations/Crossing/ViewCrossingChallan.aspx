    ...
    <div>
        ...
        <asp:Table ID="Table2" runat="server" CssClass="boxbg" Width="9in" CellSpacing="1"
                ...
                <asp:TableCell Font-Bold="true">
                    <asp:GridView ID="DocketDetail" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Charge Weight" HeaderStyle-CssClass="blackfnt" FooterStyle-CssClass="bgbluegrey"
                                HeaderStyle-Font-Bold="true">
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                                    <asp:Label ID="lblChargeWt" Text='<%# DataBinder.Eval(Container.DataItem,"CHRGWT") %>'
                                        runat="server"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center" />
                                <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="True" />
                                ...
                                <FooterTemplate>
                                    <right>
                                            <asp:Label ID="lblTotChgWeight" runat="server"></asp:Label>
                                        </right>
                                </FooterTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Ser. Tax" HeaderStyle-CssClass="blackfnt" FooterStyle-CssClass="bgbluegrey"
                                HeaderStyle-Font-Bold="true">
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                                    <center>
                                        <asp:Label ID="lblSvcTax" Text='<%# DataBinder.Eval(Container.DataItem,"SVCTAX") %>'
                                            runat="server"></asp:Label>
                                    </center>
                                </ItemTemplate>
                                <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Right" />
                                ...
                                <FooterTemplate>
                                    <center>
                                        <asp:Label ID="lblTotSvcTax" Text='<%# DataBinder.Eval(Container.DataItem,"SVCTAX") %>'
                                            runat="server"></asp:Label>
                                    </center>
                                </FooterTemplate>
                            </asp:TemplateField>
           ...
           Service Tax Payable
                            ...
                            <asp:TableCell Font-Bold="true">
                                <asp:Label ID="lblTotalSvcTax" runat="server"></asp:Label>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow CssClass="bgwhite">
                            <asp:TableCell>
