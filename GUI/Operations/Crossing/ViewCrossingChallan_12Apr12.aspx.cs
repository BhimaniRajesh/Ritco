...
public partial class GUI_Operations_Crossing_ViewCrossingChallan : System.Web.UI.Page
{
    ...
    double pkgs = 0.0, weight = 0.0, ToPay = 0.0, varCrossing = 0.0, varDDC = 0.0, Bulky = 0.0, NetAmt = 0.0;
