<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="CrossingChallanSearch.aspx.cs" Inherits="GUI_Operations_Crossing_Exception_CrossingChallanSearch" %>
        ...
        <table style="width: 9.5in" border="0" align="left" cellpadding="3" cellspacing="1"
            ...
            <tr class="bgbluegrey">
                <td align="center" colspan="3">
                    <font class="blackfnt"><b>Crossing Challan Cancellation</b></font>
                </td>
            </tr>
            <tr bgcolor="#ffffff">
                <td valign="top">
                    <font class="blackfnt">Challan Date Range </font>
                </td>
            ...
            <tr bgcolor="#ffffff">
                <td valign="top">
                    <font class="blackfnt">
                        <asp:Label ID="lblDocument" runat="server" Text="Enter Challan No"></asp:Label>
                    </font>
                </td>
                <td valign="top" align="left">
