<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="CrossingChallanPaymentView2.aspx.cs" Inherits="GUI_Operations_Crossing_ViewPrint_CrossingChallanPaymentView2" %>
    ...
    <div align="center">
        <form id="form1">
            <div align="left">
                ...
                <br />
                <p align="left">
                    <font class="blackfnt"><b>Crossing Voucher List</b></font></p>
                <br />
                <asp:GridView ID="GridVoucherList" runat="server" BorderWidth="1" CellPadding="2" HeaderStyle-CssClass="bgbluegrey"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <HeaderTemplate>
                                Crossing Voucher No</HeaderTemplate>
                            <HeaderStyle CssClass="blckfnt" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <center>
                                    <a href="javascript:ViewPrint('<%# DataBinder.Eval(Container.DataItem,"VoucherNo") %>','0')">
                        ...
                        <itemtemplate>
                                <center>
                                    <a href="javascript:ViewPrint('<%# DataBinder.Eval(Container.DataItem,"VoucherNo") %>','1')">
