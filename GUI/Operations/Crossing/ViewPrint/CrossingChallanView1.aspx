<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="CrossingChallanView1.aspx.cs" Inherits="GUI_Operations_Crossing_ViewPrint_CrossingChallanView1" %>
        ...
        <table style="width: 9.5in" border="0" align="left" cellpadding="3" cellspacing="1"
            ...
            <tr class="bgbluegrey">
                <td align="center" colspan="3">
                    <font class="blackfnt"><b>View & Print Crossing Challan Entry </b></font>
                </td>
            </tr>
            <tr bgcolor="#ffffff">
                <td valign="top">
            ...
            <tr bgcolor="#ffffff">
                <td valign="top">
                    <font class="blackfnt">
                        <asp:Label ID="lblDocument" runat="server" Text="Enter CrossingChallan No"></asp:Label>
                    </font>
                </td>
                <td valign="top" align="left">
