<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="MFMain.aspx.cs" Inherits="GUI_Operations_LoadingSheet_MFMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateDocketFromDate(objDocketFromDate, objFocusControl)
        {
            ...
            //Check for Docket From Date <= Manifest Date
            var mMFDate = "";
            if(document.getElementById("ctl00_MyCPH1_txtMFDate"))
            {
                mMFDate = document.getElementById("ctl00_MyCPH1_txtMFDate").value;
                mMFDate = mMFDate.substring(3, 5) + "/" + mMFDate.substring(0, 2) + "/" + mMFDate.substring(6, 10)
                
                if(findDateDifference(mMFDate, mDocketFromDate, "d") > 0)
                {
                    alert(document.getElementById("ctl00_MyCPH1_HidDocket").value + " From Date cannot be Greater than " + document.getElementById("ctl00_MyCPH1_HidMF").value + " Date, " + document.getElementById("ctl00_MyCPH1_txtMFDate").value + "!");
                    objFocusControl.focus();
                    return false;
                }
            }
            ...
            {
                alert("Input Box for " + document.getElementById("ctl00_MyCPH1_HidMF").value + " Date is not available!");
                return false;
            }
            
            //Check for MF From Date >= MF To Date
        ...
        function ValidateMFToDate(objDocketToDate, objFocusControl)
        {
            ...
            //Check for Docket To Date <= MF Date
            var mMFDate = "";
            if(document.getElementById("ctl00_MyCPH1_txtMFDate"))
            {
                mMFDate = document.getElementById("ctl00_MyCPH1_txtMFDate").value;
                ...
                if(findDateDifference(mMFDate, mDocketToDate, "d") > 0)
                {
                    alert(document.getElementById("ctl00_MyCPH1_HidDocket").value + " To Date cannot be Greater than " + document.getElementById("ctl00_MyCPH1_HidMF").value + " Date, " + document.getElementById("ctl00_MyCPH1_txtMFDate").value + "!");
                    objFocusControl.focus();
                    return false;
                }
            }
        ...
        function ValidateMFDate(objMFDate)
        {
            if(ValidateDate(objMFDate) == false)
            {
                return false;
            }
            
            //Check for Manifest Date <= System Date
            var mSystemDate = "<%=strSystemDate %>";
            mSystemDate = mSystemDate.substring(3, 5) + "/" + mSystemDate.substring(0, 2) + "/" + mSystemDate.substring(6, 10)
            
            var mMFDate = objMFDate.value;
            mMFDate = mMFDate.substring(3, 5) + "/" + mMFDate.substring(0, 2) + "/" + mMFDate.substring(6, 10)
            
            if(findDateDifference(mSystemDate, mMFDate, "d") > 0)
            {
                alert(document.getElementById("ctl00_MyCPH1_HidMF").value + " Date cannot be Greater than Today's Date, " + "<%=strSystemDate %>" + "!");
                objMFDate.focus();
                return false;
            }
            ...
            if(document.getElementById("ctl00_MyCPH1_txtFromDate"))
            {
                if(ValidateDocketFromDate(document.getElementById("ctl00_MyCPH1_txtFromDate"), objMFDate) == false)
                {
                    return false;               
                }
            }
            ...
            if(document.getElementById("ctl00_MyCPH1_txtToDate"))
            {
                if(ValidateMFToDate(document.getElementById("ctl00_MyCPH1_txtToDate"), objMFDate) == false)
                {
                    return false;               
                }
            }
        ...
        function SelectDocket(strDocketMode, strDocketNo, objDocket)
        {
            ...
            var mArrSelectedChargeWeights;
            var mSelectedChargeWeights = "";
            ...
            if(objDocket.checked == false)
            {
                ...
                if(document.getElementById("ctl00_MyCPH1_HidSelectedDockets"))
                {
                    ...
                    mArrSelectedChargeWeights = document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value.split(",");
                    ...
                    for(var mLoopCounter = 0; mLoopCounter < mArrSelectedDockets.length; mLoopCounter++)
                    {
                        if(mArrSelectedDockets[mLoopCounter] != strDocketNo)
                        {
                            ...
                            mSelectedChargeWeights = (mSelectedChargeWeights == "" ? mArrSelectedChargeWeights[mLoopCounter] : mSelectedChargeWeights + "," + mArrSelectedChargeWeights[mLoopCounter]);
                        }
                    }
                    ...
                    document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value = mSelectedChargeWeights;
                }
            }
            else
            {
                ...
                var mDerivedControlNameForChargeWeights;
                
                for(var mLoopCounter = 0; mLoopCounter < mTotalRecords; mLoopCounter++)
                {
                    if(mLoopCounter < 10)
                    {
                        mDerivedControlNameForPackages = "ctl00_MyCPH1_rptDocketList_ctl" + "0" + mLoopCounter + "_txtPackagesLB"
                        mDerivedControlNameForWeights = "ctl00_MyCPH1_rptDocketList_ctl" + "0" + mLoopCounter + "_txtWeightLB"
                        mDerivedControlNameForChargeWeights = "ctl00_MyCPH1_rptDocketList_ctl" + "0" + mLoopCounter + "_txtChargeWeight"
                    }
                    else
                    {
                        mDerivedControlNameForPackages = "ctl00_MyCPH1_rptDocketList_ctl" + mLoopCounter + "_txtPackagesLB"
                        mDerivedControlNameForWeights = "ctl00_MyCPH1_rptDocketList_ctl" + mLoopCounter + "_txtWeightLB"
                        mDerivedControlNameForChargeWeights = "ctl00_MyCPH1_rptDocketList_ctl" + mLoopCounter + "_txtChargeWeight"
                    }
                    ...
                    if(document.getElementById(mDerivedControlNameForChargeWeights))
                    {
                        if(document.getElementById(mDerivedControlNameForChargeWeights).DocketNo == strDocketNo)
                        {
                            document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value = (document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value == "" ? document.getElementById(mDerivedControlNameForChargeWeights).value : document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value + "," + document.getElementById(mDerivedControlNameForChargeWeights).value);
                        }
                    }
                }
	    ...
	    function checkTotalPackagesWeight(objTotalPackagesWeight, mFromControl)
	    {
	        ...
	        if(objTotalPackagesWeight.value != '')
	        {
			    if(!isNaN(objTotalPackagesWeight.value))
		        {
			        ...
			        {
				        alert('Entered ' + mAlertMessageKeyword + ' greater than Actual ' + mAlertMessageKeyword + '!');
				        objTotalPackagesWeight.value = mOrgValue;
				        objTotalPackagesWeight.focus();
		        	}
			    }
		    ...
		    if(mFromControl == '1')
		    {
		        if(document.getElementById("ctl00_MyCPH1_HidSelectedDockets") && document.getElementById("ctl00_MyCPH1_HidSelectedPackages") && document.getElementById("ctl00_MyCPH1_HidSelectedWeights") && document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights"))
                {
                    ...
                    var mArrChargeWeight = document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value.split(",");
                    
                    var mSelectedPackages = "";
                    var mSelectedWeight = "";
                    var mSelectedChargeWeight = "";
                    ...
                    for(var mLoopCounter = 0; mLoopCounter < mArrDockets.length; mLoopCounter++)
                    {
                        ...
                        {
                            if(mAlertMessageKeyword == "Packages")
                            {
                                mSelectedPackages = (mSelectedPackages == "" ? objTotalPackagesWeight.value : mSelectedPackages + "," + objTotalPackagesWeight.value);
                            }
                            else if(mAlertMessageKeyword == "Weight")
                            {
                                mSelectedWeight = (mSelectedWeight == "" ? objTotalPackagesWeight.value : mSelectedWeight + "," + objTotalPackagesWeight.value);
                            }
                            else if(mAlertMessageKeyword == "Charge Weight")
                            {
                                mSelectedChargeWeight = (mSelectedChargeWeight == "" ? objTotalPackagesWeight.value : mSelectedChargeWeight + "," + objTotalPackagesWeight.value);
                            }
                        }
                        else
                        {
                            ...
                            {
                                mSelectedChargeWeight = (mSelectedChargeWeight == "" ? mArrChargeWeight[mLoopCounter] : mSelectedChargeWeight + "," + mArrChargeWeight[mLoopCounter]);
                            }
                        }
                    }
                    ...
                    {
                        document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value = mSelectedChargeWeight;
                    }
                }
            }
	    }
    
        function SelectDocketForMF(strDocketMode, strDocketNo, strGiveAlert, objDocket)
        {
            var mArrSelectedDockets;
            var mSelectedDockets = "";
    ...
    <script language="javascript" type="text/javascript">
        ...
        {   
            //Check for Manual MF No.
            if(document.getElementById("ctl00_MyCPH1_txtManualMFNo"))
            {
                if(document.getElementById("ctl00_MyCPH1_txtManualMFNo").value != "")
                {
                    if(document.getElementById("ctl00_MyCPH1_lblManualMFNo"))
                    {
                        if(document.getElementById("ctl00_MyCPH1_lblManualMFNo").style.display == '')
                        {
                            alert("Invalid 'Manual " + document.getElementById("ctl00_MyCPH1_HidMF").value + " No.'");
                            document.getElementById("ctl00_MyCPH1_txtManualMFNo").focus();
                            return false;
                        }
                    }
                }
                else
                {
                    if(document.getElementById("ctl00_MyCPH1_HidManNoManYN"))
                    {
                        ...
                        {
                            alert("Enter 'Manual " + document.getElementById("ctl00_MyCPH1_HidMF").value + " No.'");
                            document.getElementById("ctl00_MyCPH1_txtManualMFNo").focus();
                            return false;
                        }
                    }
            ...
            if(document.getElementById("ctl00_MyCPH1_txtNextStop"))
            {
                if(document.getElementById("ctl00_MyCPH1_txtNextStop").value == "")
                {
                    alert("'Next Stop' must be entered");
                    document.getElementById("ctl00_MyCPH1_txtNextStop").focus();
                    return false;
                }
            }
        ...
        {            
            ...
            if(document.getElementById("ctl00_MyCPH1_txtMFDate"))
            {
                if(document.getElementById("ctl00_MyCPH1_txtMFDate").value == "")
                {
                    alert("Enter " + document.getElementById("ctl00_MyCPH1_HidMF").value + " Date in 'DD/MM/YYYY' Format!");
                    document.getElementById("ctl00_MyCPH1_txtMFDate").focus();
                    return false;
                }
                
                var mMFDate = document.getElementById("ctl00_MyCPH1_txtMFDate").value.substring(3, 5) + "/" + document.getElementById("ctl00_MyCPH1_txtMFDate").value.substring(0, 2) + "/" + document.getElementById("ctl00_MyCPH1_txtMFDate").value.substring(6, 10)
                var mSystemDate = document.getElementById("ctl00_MyCPH1_HidSystemDate").value.substring(3, 5) + "/" + document.getElementById("ctl00_MyCPH1_HidSystemDate").value.substring(0, 2) + "/" + document.getElementById("ctl00_MyCPH1_HidSystemDate").value.substring(6, 10)
                
                if(findDateDifference(mMFDate, mSystemDate, "d") < 0)
                {
                    alert(document.getElementById("ctl00_MyCPH1_HidMF").value + " Date can't be grater than '" + document.getElementById("ctl00_MyCPH1_HidSystemDate").value + "', Today!");
                    document.getElementById("ctl00_MyCPH1_txtMFDate").focus();
                    return false;
                }
            }
            ...
            if(segregateDocketDetails() == false)
            {
                return false;
            }           
        ...
        function segregateDocketDetails()
        {
            ...
            var mArrChargeWeights = document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeightNos").value.split(',');
            var mArrSelectedChargeWeights = document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeights").value.split(',');
            ...
            var mActualWeight;
            var mActualPackages;
            var mActualChargeWeight;
            var mTotalWeight = 0;
            var mTotalChargeWeight = 0;
            var mTotalPackages = 0;
            
            var mSelectedDocketDetails = "";
            ...
            for(var mLoopCounter = 0; mLoopCounter < mArrSelectedWeights.length; mLoopCounter++)
            {
                ...
                mActualChargeWeight = getActualChargeWeight(mArrSelectedDockets[mLoopCounter]);
                mActualPackages = getActualPackage(mArrSelectedDockets[mLoopCounter]);
                
                mSelectedDocketDetails = (mSelectedDocketDetails == "" ? mArrSelectedDockets[mLoopCounter] + "~" + mArrSelectedPackages[mLoopCounter] + "~" + mArrSelectedWeights[mLoopCounter] + "~" + mActualPackages + "~" + mActualWeight + "~" + (eval(mActualPackages) - eval(mArrSelectedPackages[mLoopCounter])) + "~" + (eval(mActualWeight) - eval(mArrSelectedWeights[mLoopCounter])) + "~" + mArrSelectedChargeWeights[mLoopCounter] + "~" + (eval(mActualChargeWeight) - eval(mArrSelectedChargeWeights[mLoopCounter])) : mSelectedDocketDetails + "," + mArrSelectedDockets[mLoopCounter] + "~" + mArrSelectedPackages[mLoopCounter] + "~" + mArrSelectedWeights[mLoopCounter] + "~" + mActualPackages + "~" + mActualWeight + "~" + (eval(mActualPackages) - eval(mArrSelectedPackages[mLoopCounter])) + "~" + (eval(mActualWeight) - eval(mArrSelectedWeights[mLoopCounter])) + "~" + mArrSelectedChargeWeights[mLoopCounter] + "~" + (eval(mActualChargeWeight) - eval(mArrSelectedChargeWeights[mLoopCounter])));
                
                mTotalWeight += eval(mArrSelectedWeights[mLoopCounter]);
                mTotalChargeWeight += eval(mArrSelectedChargeWeights[mLoopCounter]);
                mTotalPackages += eval(mArrSelectedPackages[mLoopCounter]);
            }
            
            if(document.getElementById("ctl00_MyCPH1_HidFinalDocketDetails"))
            {
                document.getElementById("ctl00_MyCPH1_HidFinalDocketDetails").value = mSelectedDocketDetails;
            }
            else
            {
                alert("Hidden element for " + document.getElementById("ctl00_MyCPH1_HidDocket").value + " details is not available!");
                return false;
            }
            
            if(document.getElementById("ctl00_MyCPH1_HidTotalPackages"))
            {
                document.getElementById("ctl00_MyCPH1_HidTotalPackages").value = mTotalPackages;
            }
            else
            {
                alert("Hidden element for total packages is not available!");
                return false;
            }
            
            if(document.getElementById("ctl00_MyCPH1_HidTotalWeight"))
            {
                document.getElementById("ctl00_MyCPH1_HidTotalWeight").value = mTotalWeight;
            }
            else
            {
                alert("Hidden element for total weight is not available!");
                return false;
            }
            
            if(document.getElementById("ctl00_MyCPH1_HidTotalChargeWeight"))
            {
                document.getElementById("ctl00_MyCPH1_HidTotalChargeWeight").value = mTotalChargeWeight;
            }
            else
            {
                alert("Hidden element for total charge weight is not available!");
                return false;
            }
        ...
        function checkPackagesWeightChanges()
        {
            ...
            for(var mLoopCounter = 0; mLoopCounter < mArrSelectedWeights.length; mLoopCounter++)
            {
                ...
                if(eval(mActualPackages) != eval(mArrSelectedPackages[mLoopCounter]) || eval(mActualWeight) == eval(mArrSelectedWeights[mLoopCounter]) || eval(mActualChargeWeight) != eval(mArrSelectedChargeWeights[mLoopCounter]))
                {
                    ...
                    if(eval(mActualPackages) != eval(mArrSelectedPackages[mLoopCounter]) && eval(mActualChargeWeight) == eval(mArrSelectedChargeWeights[mLoopCounter]))
                    {
                        alert("You have changed Packages, but not changed corresponding Charge Weight. You must change Charge Weight too!");
                        setFocusForPackageWeight(3, mArrSelectedDockets[mLoopCounter]);
                        return false;
                    }
                    ...
                    if(eval(mActualPackages) == eval(mArrSelectedPackages[mLoopCounter]) && eval(mActualChargeWeight) != eval(mArrSelectedChargeWeights[mLoopCounter]))
                    {
                        alert("You have changed Charge Weight, but not changed corresponding Packages. You must change Packages too!");
                        setFocusForPackageWeight(1, mArrSelectedDockets[mLoopCounter]);
                        return false;
                    }
                }
...
//                } 
            ...
            for(var mLoopCounter = 0; mLoopCounter < mTotalRecords; mLoopCounter++)
            {
                ...
                if(mIndex == 3)
                {
                    if(document.getElementById(mDerivedControlNameForChargeWeights))
                    {
                        if(document.getElementById(mDerivedControlNameForChargeWeights).DocketNo == strDocketNo)
                        {
                            document.getElementById(mDerivedControlNameForChargeWeights).focus();
                        }
                    }
                }
            }    
        ...
        function getActualChargeWeight(strDocketNo)
        {
            var mArrChargeWeights = document.getElementById("ctl00_MyCPH1_HidSelectedChargeWeightNos").value.split(',');
            var mArrDockets = document.getElementById("ctl00_MyCPH1_HidSelectedDocketNos").value.split(',');
            
            for(var mLoopCounter = 0; mLoopCounter < mArrChargeWeights.length; mLoopCounter++)
            {
                if(mArrDockets[mLoopCounter] == strDocketNo)
                {
                    return mArrChargeWeights[mLoopCounter];
                }
            }
										                ...
										                <center>
											                <table border="0" class="boxbg" cellspacing="1" cellpadding="1" width="100%">
                                                                <tr class="bgbluegrey"> 
                                                                    <td align="center" colspan="8" style="height: 30px;">
                                                                        <label class="blackfnt" id="lblCriteria" runat="server">
                                                                            <%--<b>
                                                                                Select criteria for preparing Manifest
                                                                            </b>--%>
                                                                        </label>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr style="background-color: White"> 
                                                                    ...
                                                                    <td align="left" style="width: 18%">
                                                                        <label class="blackfnt" id="lblMFDate" runat="server">
                                                                            <%--Manifest Date:--%>
                                                                        </label>
                                                                    </td>
                                                                    
                                                                    <td colspan="5" align="left">
                                                                        <input type="text" id="txtMFDate" maxlength="10" size="10" runat="server" 
				                                                            class="input" onblur="ValidateMFDate(this)" />
				                                                        <label class="blackfnt" style="vertical-align:text-top">
                                                                            &nbsp;(dd/mm/yyyy)
                                                                        </label>
                                                                        <label class="bluefnt" style="vertical-align:text-top" id="lblMFDateHint" runat="server">
                                                                ...
                                                                <tr style="background-color: White">
                                                                    ...
                                                                    <td colspan="7" align="left">
                                                                        <asp:UpdatePanel ID="upManualMFNo" runat="server">
                                                                            <ContentTemplate>
                                                                                <asp:TextBox ID="txtManualMFNo" MaxLength="15" Width="147px" CssClass="input" runat="server" 
                                                                                    OnTextChanged="txtManualMFNo_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                                <label class="blackfnt" id="lblManualMFNo" runat="server" style="color: Red;" visible="false">
                                                                                    <%--&nbsp;Duplicate Manual Manifest No.!!!--%>
                                                                                </label>
                                                                                <label class="bluefnt" style="vertical-align:text-top" id="lblManualMFNoHint" runat="server">
                                                                                    <%--&nbsp;Hint: Enter NA if Manual Manifest No. is not available.--%>
                                                                                </label>
                                                                            </ContentTemplate>
                                                                            <Triggers>
                                                                                <asp:AsyncPostBackTrigger ControlID="txtManualMFNo" EventName="TextChanged" />
                                                                            </Triggers> 
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                </tr>
                                                                    ...
                                                                    <td align="left" colspan="7" nowrap>
                                                                        <asp:UpdatePanel ID="upNextStop" runat="server">
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <label class="blackfnt" id="lblMFNextStopHint" runat="server">
                                                                                    <%--( MF<i>
                                                                                        will be prepared for this Next Location
                                                                                    </i>
                                                                                    )--%>
                                                                                </label>
                                                                            </ContentTemplate>
	                                                        ...
	                                                        <table border="0" cellpadding="1" width="100%" cellspacing="1" class="boxbg">
	                                                            <tr style="background-color: White">
	                                                                <td  align="center" colspan="2">
	                                                                    <label class="blackfnt" id="lblDocketSelCriteria" runat="server">
	                                                                        <%--<b>
	                                                            ...
	                                                            <tr style="background-color: White">
                                                                    <td valign="top" align="left">
                                                                        <label class="blackfnt" id="lblDocketDate" runat="server">
	                                                                        ...
	                                                                        <tr>
                                                                                ...
                                                                                <td align="left" valign="top">
                                                                                    ...
                                                                                    <input type="text" id="txtToDate" maxlength="10" size="10" class="input" runat="server" 
                                                                                        onblur="ValidateMFToDate(this, this)" />
		                                                                                <a href="#"
                                                            ...
                                                            <asp:UpdatePanel ID="upRepeater" runat="server">
                                                                <ContentTemplate>
                                                                            ...
                                                                            <td style="width: 100%">
	                                                                            <table cellspacing="1" cellpadding="1" border="0" width="100%" class="boxbg">
        	                                                                        ...
        	                                                                        <tr style="background-color: White" id="trLSCaptionWithLink" visible="false" runat="server">
	                                                                                    <td colspan="11" align="left">
	                                                                                        <label class="blackfnt" id="lblMFNoCaption" runat="server">
	                                                                                            <%--<b>
	                                                                                                Manifest No.&nbsp;
	                                                                                            </b>--%>
	                                                                                        </label>
	                                                                                        
                                                                                            <asp:LinkButton ID="lnkbtnDocketsinMFForTH" runat="server" OnClick="lnkbtnDocketsinMFForTH_Click" CssClass="blackfnt" Font-Bold="true" Font-Underline="true">
                                                                                            </asp:LinkButton>
	                                                                                ...
	                                                                                <tr class="bgbluegrey" id="trTableHeadersForMF" runat="server" visible="false">
	                                                                                    <td style="background-color: White" id="tdForMF" runat="server">
	                                                                                ...
	                                                                                <tr id="trNoRecsForDocketList" runat="server" style="background-color: White" visible="false">
                                                                                        <td align="left" colspan="11">
                                                                                            <label id="lblNoRecsMessage" class="blackfnt" runat="server" style="color: Red">
	                                                                                ...
	                                                                                <asp:Repeater ID="rptDocketList" runat="server" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <tr style="background-color: White">
                                                                                                <td align="center">
                                                                                                    <label class="blackfnt">
                                                                                                        <%#DataBinder.Eval(Container.DataItem, "CheckBoxOrSpace")%>
                                                                                                    </label>
                                                                                                </td>
                                                                                                ...
                                                                                                <td align="left" nowrap>
                                                                                                    <input type="text" id="txtChargeWeight" runat="server" value='<%#DataBinder.Eval(Container.DataItem, "ChargeWeight")%>'
                                                                                                        class="input" size="4" maxlength="8" OrgValue='<%#DataBinder.Eval(Container.DataItem, "ChargeWeight")%>'  
                                                                                                        DocketNo='<%#DataBinder.Eval(Container.DataItem, "DocketNo")%>' 
                                                                                                        AlertMessageKeyword="Charge Weight" onblur="return checkTotalPackagesWeight(this, '1')"
                                                                                                         />
                                                                                                    <label class="blackfnt"  style="color: <%#DataBinder.Eval(Container.DataItem, "RowColor")%>">
                                                                                                        /<%#DataBinder.Eval(Container.DataItem, "ChargeWeight")%>
                                                                                                    </label>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </ItemTemplate>
                                                                                    ...
                                                                                    <tr style="background-color: White" runat="server" id="trPrepareManifest" visible="false">
                                                                                        <td colspan="11" align="center">
                                                                                            <asp:Button ID="btnPrepareMF" Text="Submit" runat="server" OnClientClick="return CheckDocketSelection()" 
                                                                                                OnClick="btnPrepareMF_Click" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    
                                                                                    <tr style="background-color: White" runat="server" id="trPrepareMFErrorMsg" visible="false">
                                                                                        <td colspan="11" align="left">    
                                                                                            <label runat="server" class="blackfnt" style="color: Red;" id="lblPrepareMFErrorMsg">
                                                                                            </label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr style="background-color: White" runat="server" id="trPrepareMoreMF" visible="false">
                                                                                        <td colspan="11" align="left">
                                                                                            <label class="blackfnt">
                                                                                                <a href="./MFMain.aspx">
                                                                                                    <u>
                                                                                                        Click here to prepare more Manifests
                                                                                                    </u>
                                                                                                </a>
                                                                                            </label>
                                                                                        </td>
                                                                                    ...
                                                                                    <tr style="background-color: White" runat="server" id="trPrepareMoreTHC" visible="false">
                                                                                        <td colspan="11" align="left">
                                                                                            <label class="blackfnt">
                                                                    ...
                                                                    <input type="hidden" id="HidFinalDocketDetails" runat="server" />
                                                                    <input type="hidden" id="HidTotalPackages" runat="server" />
                                                                    <input type="hidden" id="HidTotalWeight" runat="server" />
                                                                    <input type="hidden" id="HidSelectedChargeWeightNos" runat="server" />
                                                                    <input type="hidden" id="HidManNoManYN" runat="server" />
                                                                    <input type="hidden" id="HidLSReqForMF" runat="server" />
                                                                    ...
                                                                    <input type="hidden" id="HidSelectedChargeWeights" runat="server" />
                                                                    <input type="hidden" id="HidTotalChargeWeight" runat="server" />
                                                                </ContentTemplate>
                                                                <Triggers>
                                                                    <asp:AsyncPostBackTrigger ControlID="btnSubmit" EventName="Click" />
                                                                    <asp:AsyncPostBackTrigger ControlID="btnPrepareMF" EventName="Click" />
                                                                    <asp:AsyncPostBackTrigger ControlID="lnkbtnDocketsinMFForTH" EventName="Click" />
                                                                </Triggers>
                                                            </asp:UpdatePanel>
										                </center>
											        </td>
