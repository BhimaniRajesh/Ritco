...
public partial class GUI_Finance_GeneralizedPO_POViewPrint_POViewPrintResult : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        string SQLStr = "EXEC USP_DDMR_Listing_For_UpdateProcess '" + Type + "','" + VendorCode + "','" + FromDt + "','" + ToDt + "','" + DDMRCode + "','" + DocketCode + "','" + SessionUtilities.CurrentBranchCode.ToString().Trim() + "'";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        {
            RadioButton Chk_Docno = (RadioButton)gridrow.FindControl("Chk_Docno");
            Label LblMRSNO = (Label)gridrow.FindControl("LblMRSNO");
            if (Chk_Docno.Checked == true)
            {
                final += "?DDMRCode=" + LblMRSNO.Text.ToString();
                final += "&DocketCode=";
                Response.Redirect("DDMRDocketWiseUpdate.aspx" + final, false);
            }
        }
