<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="DDMRUpdateProcessCriteria.aspx.cs" Inherits="GUI_Finance_GeneralizedPO_POViewPrint_POViewPrintCriteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
	...
	cal.showNavigationDropdowns();
     ...
     function Validation() 
     {
        ...
        if (document.getElementById('ctl00_MyCPH1_rdDocketCri').checked == true && document.getElementById('ctl00_MyCPH1_txtDocketNo').value == '' && document.getElementById('ctl00_MyCPH1_txtDDMRNo').value == '')
        {
        ...
        <table cellspacing="1" class="boxbg" align="left">
            <tr class="bgbluegrey">
                <td colspan="3" align="center">
                    <asp:Label ID="lblQry" CssClass="ffnt" Font-Bold="true" runat="server" Text="Selection Criteria For DDMR Update Process"></asp:Label>
                </td>
            </tr>            
            <tr bgcolor="white">
            ...
            <tr bgcolor="white">
                ...
                <td style="width: 150px">
                    <asp:Label ID="lblDocketNo" runat="server" CssClass="blackfnt" Text="DDMR COMPLETLY"></asp:Label>
                </td>
                <td>
