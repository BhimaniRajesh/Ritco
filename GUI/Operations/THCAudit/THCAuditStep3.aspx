<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="THCAuditStep3.aspx.cs" Inherits="GUI_Operations_THCAudit_THCAuditStep3" %>
            ...
            <tr>
                <td height="300" valign="top">
                    <table cellspacing="1" style="width: 9.5in" class="boxbg" align="left">
                        <tr class="bgbluegrey">
                            <td colspan="3">
                                <font class="blackfnt"><b>THC Audited Successfully…. </b></font>
                            </td>
                        </tr>
                        <tr align="center" bgcolor="white">
                            <td colspan="3">
                                 <a href="THCAuditStep1.aspx"><font class="Blackfnt"><u>Click here for more THC Audit</u></font></a>
                            </td>
                        </tr>
                    </table>
                </td>
