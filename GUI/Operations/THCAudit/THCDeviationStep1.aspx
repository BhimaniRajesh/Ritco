<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master" CodeFile="THCDeviationStep1.aspx.cs" Inherits="GUI_Operations_THCAudit_THCDeviationStep1" %>
            ...
            <tr>
                <td height="300" valign="top">
                    ...
                    DataTextField="LocName" DataValueField="LocCode" />
                        ...
                        <tr align="center" bgcolor="white">
                            <td colspan="4">
                                <asp:Button ID="btnSubmit" OnClick="btnSubmit_Click" runat="server" Text="Show" Width="75px" />
                            </td>
                        </tr>
                    </table>
                </td>
