...
public partial class GUI_Operations_THCAudit_THCAuditStep1 : System.Web.UI.Page
{
...
// cboLoc.DataSource = SqlHelper.ExecuteDataset(Session["SqlProvider"].ToString().Trim(), CommandType.StoredProcedure, "usp_locations_all").Tables[0];           
 cboLoc.DataBind();
        }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        final += "&Loc=" + cboLoc.SelectedValue;
        Response.Redirect("THCAuditStep2.aspx" + final);
    }
}
