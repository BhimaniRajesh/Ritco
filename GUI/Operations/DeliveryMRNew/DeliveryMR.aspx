                                        ...
                                        <asp:TableCell>
                                            <asp:Table ID="tblparty" runat="server">
                                                ...
                                                <asp:TableRow ID="trpartyc" runat="server">
                                                    <asp:TableCell ColumnSpan="2">
                                                       <asp:TextBox ID="txtpartycode" runat="server" BorderStyle="Groove" Width="100px"
                                                            CssClass="blackfnt" autocomplete="off" onblur="javascript:return CustomerChange()"></asp:TextBox>-<asp:TextBox ID="txtpartyname"
                                                                Enabled="false" runat="server" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox><br />
