<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true"
    CodeFile="DeliveryMR.aspx.cs" Inherits="GUI_Operation_DeliveryMR_DeliveryMR"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    <script type="text/javascript" language="javascript" src="../../Js/json3.min.js"></script>
    ...
    <script language="JavaScript" type="text/javascript">
        function initializer() {
            var txtpartycode = $('#<%=txtpartycode.ClientID%>');
            var txtpartyname = $('#<%=txtpartyname.ClientID%>');
            SetAutoComplete(txtpartycode, txtpartyname, 'GetCustomerList1');
        }
        function OnError(responseText) {
            //debugger;
            alert(responseText._message);
        }
        function SetAutoComplete(txtCode, txtName, methodName) {
            txtCode.autocomplete({
                source: function (request, response) {

                    var queryString = "";
                    switch (methodName) {
                        case 'GetCustomerList1': queryString = "{'locationCode':'<%=SessionUtilities.CurrentBranchCode%>','customerCode':'" + request.term + "'}"; break;
                        default: queryString = "{'prefixText':'" + request.term + "'}"; break;
                    }

                    var callMethodName = methodName;

                    if (methodName == 'GetCustomerList1')
                        callMethodName = 'GetCustomerList1';

                    $.ajax({
                        url: '<%=ResolveUrl("~/GUI/services/WebService.asmx/")%>' + callMethodName,
                        data: queryString,
                        dataType: 'json',
                        type: 'POST',
                        async: false,
    ...
    <script type="text/javascript" language="javascript">
        ...
        function step2Click() {
            ...
            var txtCreditLimit = document.getElementById("ctl00_MyCPH1_txtCreditLimit");
            ...
            if (txtpartycode.value.toUpperCase() == "C00040268") {
                if (txtCustomerName.value == "") {
                    alert("Please Enter Customer Name...");
                    txtCustomerName.focus();
                    return false;
                }
                if (txtCreditLimit.value == "") {
                    alert("Please Enter Credit Days...");
                    txtCreditLimit.focus();
                    return false;
                }
            }
            //if (txtVendorName.value == "" || txtVendorName.value.indexOf("~") == -1) {
        ...
        *****************************************************************************************************************/
        ...
        function octAmountChange(id) {
            ...
            document.getElementById("ctl00_MyCPH1_hdnoctproccharge").value = txtoctproccharge.value;
        ...
        function calculateTotal() {
                ...
                var RdbFOC_0 = document.getElementById("ctl00_MyCPH1_RdbFOC_0");
                var RdbFOC_1 = document.getElementById("ctl00_MyCPH1_RdbFOC_1");
                var RdbDDLChg_0 = document.getElementById("ctl00_MyCPH1_RdbDDLChg_0");
                var RdbDDLChg_1 = document.getElementById("ctl00_MyCPH1_RdbDDLChg_1");
                //alert(RdbFOC_0.checked);
                //alert(RdbDDLChg_0.checked);
                ...
                for (var i = 2; i < len; i++) {
                    ...
                    var txtdelcharge = document.getElementById(pref + "txtdelcharge");
                    var hdnchargecode = document.getElementById(pref + "hdnchargecode");
                    var hdnRiskCharges = document.getElementById(pref + "HdnRiskCharges");
                    var HdnDemCharges = document.getElementById(pref + "HdnDemCharges");
                    var HdnDocCharges = document.getElementById(pref + "HdnDocCharges");
                    var HdnMiscCharges = document.getElementById(pref + "HdnMiscCharges");
                    var HdnDDCharges = document.getElementById(pref + "HdnDDCharges");
                    var HdnFovCharges = document.getElementById(pref + "HdnFovCharges");
                    var HdnSurCharges = document.getElementById(pref + "HdnSurCharges");
                    var HdnCarCharges = document.getElementById(pref + "HdnCarCharges");

                    if (hdnchargecode.value == "SCHG01") {
                        if (parseFloat(HdnDocCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = HdnDocCharges.value;
                            alert("User Can't Decrease Docket Charge.");
                            //return false;
                        }
                    }
                    if (hdnchargecode.value == "SCHG03") {
                        if (parseFloat(HdnMiscCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = HdnMiscCharges.value;
                            alert("User Can't Decrease Misc./Prev. Charge.");
                            //return false;
                        }
                    }
                    if (hdnchargecode.value == "SCHG08") {
                        if (parseFloat(HdnDDCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = HdnDDCharges.value;
                            alert("User Can't Decrease Door Dly Charge.");
                            //return false;
                        }
                    }
                    if (hdnchargecode.value == "SCHG11") {
                        if (parseFloat(HdnFovCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = HdnFovCharges.value;
                            alert("User Can't Decrease FOV Charge.");
                            //return false;
                        }
                    }
                    if (hdnchargecode.value == "SCHG14") {
                        if (parseFloat(HdnDemCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = HdnDemCharges.value;
                            alert("User Can't Decrease Dem Charges.");
                            //return false;
                        }
                    }
                    if (hdnchargecode.value == "SCHG16") {
                        if (parseFloat(hdnRiskCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = hdnRiskCharges.value;
                            alert("User Can't Decrease Risk Charge.");
                            //return false;
                        }
                    }
                    if (hdnchargecode.value == "SCHG17") {
                        if (parseFloat(HdnSurCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = HdnSurCharges.value;
                            alert("User Can't Decrease Sur Charge.");
                            //return false;
                        }
                    }
                    if (hdnchargecode.value == "UCHG08") {
                        if (parseFloat(HdnCarCharges.value) > parseFloat(txtdelcharge.value)) {
                            txtdelcharge.value = HdnCarCharges.value;
                            alert("User Can't Decrease Cartage Charge.");
                            //return false;
                        }
                    }
                    ...
                    if (RdbFOC_0.checked && RdbDDLChg_0.checked && i == 5) {
                        subtotal = subtotal;
                    }
                    else {
                        subtotal = subtotal + parseFloat(txtdelcharge.value);
                    }
                    if (RdbFOC_1.checked && RdbDDLChg_1.checked && hdnchargecode.value == "SCHG08") {
                        DoorDly = 0.00;
                    }
                    subtotal = subtotal + DoorDly;
                    if (RdbDDLChg_1.checked) {
                        //subtotal = subtotal - parseFloat(document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge").value);
                        //document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge").value = "0.00";
if (document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge") != null)
		    {
                        document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge").disabled = true;
}
                    }
                    else {
if (document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge") != null)
		    {
                        document.getElementById("ctl00_MyCPH1_grvdelcharges_ctl05_txtdelcharge").disabled = false;
}
                    }
                ...
                document.getElementById("ctl00_MyCPH1_hdnSubtotal").value = txtsubtotal.value;
                calculateMRAmount();
                return false;
        }
        ...
        function calculateMRAmount() {
            ...
            var SBCRate = parseFloat(document.getElementById("ctl00_MyCPH1_lblSBCRate").innerText);
            var txtSBCTax = document.getElementById("ctl00_MyCPH1_txtSBCTax");

            var KKCRate = parseFloat(document.getElementById("ctl00_MyCPH1_lblKKCRate").innerText);
            var txtKKCTax = document.getElementById("ctl00_MyCPH1_txtKKCTax");
            ...
            if (servicetaxrate == 4.20 || servicetaxrate == 4.2 || servicetaxrate == 14.00 || servicetaxrate == 14.0 || servicetaxrate == 14) {
            }
            else {
            ...
            txtSBCTax.value = roundNumber(SBC, 2);
            txtKKCTax.value = roundNumber(KKC, 2);
        ...
        *****************************************************************************************************************/
        function serviceTaxBlur() {
            ...
            var hdnmramount = document.getElementById("ctl00_MyCPH1_hdnmramount");
            var hdncollamt = document.getElementById("ctl00_MyCPH1_hdncollamt");

            var hdnservicetax = document.getElementById("ctl00_MyCPH1_hdnservicetax");
            var hdnSBCTax = document.getElementById("ctl00_MyCPH1_hdnSBCTax");
            var hdnKKCTax = document.getElementById("ctl00_MyCPH1_hdnKKCTax");
            ...
            hdnservicetax.value = roundNumber(txtservicetax.value, 2);
            hdnSBCTax.value = roundNumber(txtSBCTax.value, 2);
            hdnKKCTax.value = roundNumber(txtKKCTax.value, 2);

            var mrtotal = 0.00;
            mrtotal = parseFloat(txtsubtotal.value) + parseFloat(txtservicetax.value) + parseFloat(txteducess.value) + parseFloat(txtheducess.value) + parseFloat(txtSBCTax.value) + parseFloat(txtKKCTax.value);

            txtmramount.value = roundNumber(mrtotal, 2);
            txtcollamt.value = roundNumber(mrtotal, 2);

            hdnmramount.value = roundNumber(mrtotal, 2);
            hdncollamt.value = roundNumber(mrtotal, 2);
            return false;
        }
        /*****************************************************************************************************************/
        ...
        function btnsubmitClick() {
            ...
            if ((parseFloat(hdnarrpkgqty.value) == parseFloat(hdnpkgsno.value) && ddlsuffix.value == "M") || ddlsuffix.value == ".") {
                ...
                if (parseFloat(txtcollamt.value) < parseFloat(txtmramount.value)) {
                    ...
                    var txtSBCTax = document.getElementById("ctl00_MyCPH1_txtSBCTax");
                    var checkbillamt = Math.abs(parseFloat(txtfreightdiff.value)) + parseFloat(txtservicetax.value) + parseFloat(txteducess.value) + parseFloat(txtheducess.value) + parseFloat(txtSBCTax.value);
        ...
        function CustomerChange() {
            var txtpartycode = document.getElementById("ctl00_MyCPH1_txtpartycode");
            var trcustcredit = document.getElementById("ctl00_MyCPH1_trcustcredit");
            if (txtpartycode.value.toUpperCase() == "C00040268") {
                trcustcredit.style.display = "block";
            }
            else {
                trcustcredit.style.display = "none";
            }
            return true;

        }

        function CheckMaxLen(id) {

            var txtremarks = id;
            var len = txtremarks.value.length;
            if (len > 100) {
                alert("MAximum 100 Characters allowed for Remarks");
            }
        }
    ...
    <asp:Panel ID="divmain" runat="server" Width="10in">
        ...
        <asp:Table ID="tblmain" runat="server" Width="100%" CellSpacing="1">
                ...
                <asp:TableCell ColumnSpan="4">
                    <asp:Panel ID="divstep2" runat="server">
                        <asp:Table ID="Table1" runat="server" CssClass="boxbg" CellSpacing="1" Width="100%">
                            ...
                            <%--<asp:TableRow CssClass="bgwhite" ID="TableRow3" runat="server" Style="display: block;">
                                        <asp:TableCell ColumnSpan="2"></asp:TableCell>
                                        <asp:TableCell>
                                            Total Outstanding
                                        </asp:TableCell>
                                        <asp:TableCell>
                                            <asp:TextBox ID="TxtTotalOutstanding" runat="server" BorderStyle="Groove" Width="100px"
                                                CssClass="blackfnt" Enabled="false" onkeypress="javascript:return validInt(event,this.getAttribute('id'))"></asp:TextBox>
                                        </asp:TableCell>
                                    </asp:TableRow>--%>
                                        ...
                                        <asp:TableRow ID="trpartyc" runat="server">
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:UpdatePanel ID="updone" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtpartycode" runat="server" autocomplete="off" onblur="javascript:return CustomerChange()"
                                                            BorderStyle="Groove" Width="100px" CssClass="blackfnt" OnTextChanged="txtpartycode_TextChanged" AutoPostBack="true"></asp:TextBox>-
                                                        <asp:TextBox ID="txtpartyname" Enabled="false" runat="server" BorderStyle="Groove" CssClass="blackfnt"></asp:TextBox><br />
                                ...
                                <asp:TableCell>
                                            ...
                                            <asp:Table runat="server">
                                                <asp:TableRow runat="server">
                                                    <asp:TableCell>Credit Type</asp:TableCell>
                                                 </asp:TableRow>
                                                <asp:TableRow runat="server">
                                                    <asp:TableCell>Pending Outstanding</asp:TableCell>
                                                 </asp:TableRow>
                                                <asp:TableRow runat="server">
                                                    <asp:TableCell>Total Outstanding</asp:TableCell>
                                                 </asp:TableRow>
                                            </asp:Table>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:Table runat="server">
                                                ...
                                                <asp:TableRow runat="server">
                                                    <asp:TableCell>
                                                        <asp:Label ID="LblCreditType" runat="server" CssClass="blackfnt"></asp:Label>
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                                <asp:TableRow runat="server">
                                                    <asp:TableCell>
                                                        <asp:TextBox ID="TxtPendingOutstanding" runat="server" BorderStyle="Groove" Width="100px"
                                                            CssClass="blackfnt" Enabled="false" Text="0.00"></asp:TextBox>
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                                <asp:TableRow runat="server">
                                                    <asp:TableCell>
                            ...
                            <asp:TableRow CssClass="bgwhite" ID="trcustcredit" runat="server" Style="display: none;">
                                <asp:TableCell>
                                        Customer Name
                                </asp:TableCell>
                                <asp:TableCell Font-Bold="true">
                                    <asp:TextBox ID="txtCustomerName" runat="server" BorderStyle="Groove" Width="240px"
                                        onblur="javascript:this.value=this.value.toUpperCase()" CssClass="blackfnt" MaxLength="100"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell>
                                            Credit Days
                                </asp:TableCell>
                                <asp:TableCell>
                                    <asp:TextBox ID="txtCreditLimit" runat="server" BorderStyle="Groove" Width="100px"
                                        CssClass="blackfnt" onkeypress="javascript:return validInt(event,this.getAttribute('id'))"></asp:TextBox>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow CssClass="bgwhite" ID="TableRow4" runat="server" Style="display: block;">
                                ...
                                <asp:TableCell HorizontalAlign="Left">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:Label ID="LblCommittedBusiness" runat="server" CssClass="blackfnt"></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow CssClass="bgwhite">
                                        ...
                                        <asp:TableRow ID="trrecc" runat="server">
                                            <asp:TableCell>
                                                <asp:TextBox ID="txtreceivercode" runat="server" onblur="javascript:return receiverTest(this.getAttribute('id'))"
                                                    BorderStyle="Groove" Width="100px" CssClass="blackfnt"></asp:TextBox>-
                                            </asp:TableCell>
                                            <asp:TableCell>
                                ...
                                <asp:TableCell>
                                    <asp:TextBox ID="txtremarks" runat="server" TextMode="MultiLine" MaxLength="100"
                                        BackColor="white" Width="150px" BorderStyle="Groove" CssClass="blackfnt" OnBlur="javascript:return CheckMaxLen(this)"></asp:TextBox>
                                </asp:TableCell>
                            </asp:TableRow>
                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtVendorName" runat="server"
                                                BackColor="white" BorderStyle="Groove" CssClass="blackfnt" Width="150px"></asp:TextBox>
                                            <ajaxToolkit:AutoCompleteExtender ID="Ext1" runat="server" Enabled="True"
                                                CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                                MinimumPrefixLength="1" ServiceMethod="GetVendorName_Gatepass" ServicePath="AtlasAutoComplete.asmx"
                                                TargetControlID="txtVendorName">
            ...
            <asp:TableRow ID="trcharges" runat="server" CssClass="bgwhite">
                <asp:TableCell>
                    <asp:UpdatePanel runat="server" ID="updatecharges">
                        <ContentTemplate>
                            <asp:Table runat="server" Width="100%" CssClass="boxbg" CellSpacing="1">
                                <asp:TableRow CssClass="bgwhite">
                                    <asp:TableCell ColumnSpan="4">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Charge at time of Delivery">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="HdnRiskCharges" runat="server" Value="0.00" />
                                                        <asp:HiddenField ID="HdnDemCharges" runat="server" Value="0.00" />
                                                        <asp:HiddenField ID="HdnDocCharges" runat="server" Value="0.00" />
                                                        <asp:HiddenField ID="HdnMiscCharges" runat="server" Value="0.00" />
                                                        <asp:HiddenField ID="HdnDDCharges" runat="server" Value="0.00" />
                                                        <asp:HiddenField ID="HdnFovCharges" runat="server" Value="0.00" />
                                                        <asp:HiddenField ID="HdnSurCharges" runat="server" Value="0.00" />
                                                        <asp:HiddenField ID="HdnCarCharges" runat="server" Value="0.00" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                ...
                                <asp:TableRow CssClass="bgwhite">
                                    <asp:TableCell HorizontalAlign="Left">Door Delivery Charge</asp:TableCell>
                                    <asp:TableCell HorizontalAlign="Right">
                                        <asp:RadioButtonList ID="RdbDDLChg" runat="server">
                                            <asp:ListItem Text="Y" Value="Y" OnClick="calculateTotal();"></asp:ListItem>
                                            <asp:ListItem Selected="True" Text="N" Value="N" OnClick="calculateTotal();"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </asp:TableCell>
                                    <asp:TableCell HorizontalAlign="Left">FOC</asp:TableCell>
                                    <asp:TableCell HorizontalAlign="Right">
                                        <asp:RadioButtonList ID="RdbFOC" runat="server">
                                            <asp:ListItem Text="Y" Value="Y" OnClick="calculateTotal();"></asp:ListItem>
                                            <asp:ListItem Selected="True" Text="N" Value="N" OnClick="calculateTotal();"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </asp:TableCell>
                        ...
                        Higher Educational Cess Collected</asp:TableCell>
                                ...
                                <asp:TableRow CssClass="bgwhite">
                                    <asp:TableCell>
                            Swachh Bharat Cess Rate (%)</asp:TableCell>
                                    <asp:TableCell>
                                        <asp:Label ID="lblSBCRate" runat="server" Text="0.50" CssClass="bluefnt"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell>
                        Swachh Bharat Cess</asp:TableCell>
                                    <asp:TableCell HorizontalAlign="Right">
                                        <asp:TextBox ID="txtSBCTax" runat="server" CssClass="blackfnt" BorderStyle="Groove"
                                            Enabled="false" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))"
                                            onblur="javascript:return serviceTaxBlur()" MaxLength="10" Width="80px">
                                        </asp:TextBox>
                                    </asp:TableCell>
                                ...
                                <asp:TableRow CssClass="bgwhite">
                                    <asp:TableCell>
                                                    Krishi Kalyan Cess Rate (%)</asp:TableCell>
                                    <asp:TableCell>
                                        <asp:Label ID="lblKKCRate" runat="server" Text="0.50" CssClass="bluefnt"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell>Krishi Kalyan Cess </asp:TableCell>
                                    <asp:TableCell HorizontalAlign="Right">
                                        <asp:TextBox ID="txtKKCTax" runat="server" CssClass="blackfnt" BorderStyle="Groove"
                                            Enabled="false" Style="text-align: right;" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))"
                                            onblur="javascript:return serviceTaxBlur()" MaxLength="10" Width="80px">
                                        </asp:TextBox>
                                    </asp:TableCell>
        ...
        <asp:HiddenField ID="hdnPKGSTY" runat="server" />
        <asp:HiddenField ID="hdnSubtotal" runat="server" />
        <asp:HiddenField ID="hdnoctproccharge" runat="server" />
        <asp:HiddenField ID="hdnmramount" runat="server" />
        <asp:HiddenField ID="hdncollamt" runat="server" />
        <asp:HiddenField ID="hdnservicetax" runat="server" />
        <asp:HiddenField ID="hdnSBCTax" runat="server" />
        <asp:HiddenField ID="hdnKKCTax" runat="server" />
