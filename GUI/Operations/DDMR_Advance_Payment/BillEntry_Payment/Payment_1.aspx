            ...
            <tr>
                <td>
                    <table cellspacing="1"  width="100%" class="boxbg" border="0">
                        ...
                        <tr style="background-color: white">
                            ...
                            <td align="left" colspan="2" valign="top" style="height: 24px;">
                                ...
                                <div id="Abc" runat="server" class="boxbg" />
                                 ...
                                 <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" Enabled="True" CompletionListItemCssClass="autocomplete_listItem"
                        ...
                        <tr style="background-color: white">
                            <td align="left">
                                <asp:Label ID="Label3" CssClass="blackfnt" Text="Select Bill Type" runat="server"
                                    Width="213px"></asp:Label>
                            </td>
                            <td align="left" colspan="2" valign="top" style="height: 24px;">
                                <asp:DropDownList runat="server" ID="ddlBetype">
                                    <asp:ListItem Selected="True" Text="DDMR" Value="DDMR"></asp:ListItem>
                                    <%--<asp:ListItem Text="Other" Value="Expense"></asp:ListItem>--%>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr style="background-color: white">
