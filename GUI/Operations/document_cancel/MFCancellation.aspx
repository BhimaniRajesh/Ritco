<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="MFCancellation.aspx.cs" Inherits="GUI_Operations_document_cancel_MFCancellation" %>
            ...
            function MFBlur(d)
                 {
                    ...
                    var txtManualno=d;
                    //hidMF
                    document.getElementById("ctl00_MyCPH1_hidMF").value=txtMF;
                    txtFrom=txtFrom.replace( "txtMFNo", "lblFrom");
                    document.getElementById("ctl00_MyCPH1_hidFrom").value=txtFrom;
                    txtDate=txtDate.replace( "txtMFNo", "lblMFDate");
                    document.getElementById("ctl00_MyCPH1_hidDate").value=txtDate;
                    txtManualno=txtManualno.replace( "txtMFNo", "lblManualMFNo");
                    ...
                    var txtMFNo=document.getElementById(d);
                  
                    var MFNo=txtMFNo.value;
                    if(MFNo=="")
                        return false;
                   ...
                   var r=tbl.rows.length;
                    ...
                    if(findobj)
                    {
                     ...
                     var strpg="CheckMF.aspx?MF=" + MFNo + "&sid=" + Math.random();
                             ...
                             if(findobj.readyState==4 && findobj.status==200)
                                {
                                    ...
                                    if(res[0]=="false")
                                    {
                                        alert("MF NO is not Valid... Please Enter Valid MF No");
                                        txtMFNo.value="";
                                        txtMFNo.focus();
                                        return false;
                                    }
                                    if(res[0]=="true")
                                    {
				                        ...
				                        {
						                        alert( "You have Selected Finacial Year as "+Sle_finyear +" , SO MF Date Should Be Between  "+ FinYear_fromdate +" to "+ FinYear_todate +" !!!")
						                        var thc_Number= document.getElementById("ctl00_MyCPH1_hidMF").value;
                ...
                function CheckData()
                {
                    ...
                    var ChkSel;
                       for(i = 2; i < rows ; i++)
                       {
                        if(i<10)
                        {
                           MFNo=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl0" + i + "_txtMFNo").value;
                           ChkSel=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl0" + i + "_ChkSel").checked;
                        }
                        else
                        {
                           MFNo=document.getElementById("ctl00_MyCPH1_grvcontrols_ctl" + i + "_txtMFNo").value;
                         ...
                         if(ChkSel == true)
                         {
                            ...
                            if(MFNo == '')
                            {
                                alert("Please Enter the MF Number");
                                return false;
                            }
                        ...
                        <td align="Center" class="blackfnt">
                            <asp:GridView ID="grvcontrols" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="MF No">
                                        <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center" />
                                        <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                            &nbsp;<asp:TextBox ID="txtMFNo" runat="server" BorderStyle="Groove" CssClass="blackfnt"
                                                Enabled="true" MaxLength="50" Width="100px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Manual MF No.">
                                        <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                        <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                        <asp:TextBox ID="lblManualMFNo" runat="server" BorderStyle="Groove" Width="100px" Enabled="false"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="MF Date">
                                        ...
                                        <HeaderStyle BackColor="#D4E0E7" CssClass="blackfnt" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                        <asp:TextBox ID="lblMFDate" runat="server" BorderStyle="Groove" Width="100px" Enabled="false"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <tr style="background-color: #ffffff">
                        <td class="blackfnt" style="text-align: center">
                            <asp:Button ID="btnsubmit" runat="server" OnClick="btnsubmit_Click" OnClientClick="javascript:return CheckData();"
                                Text="Submit" />
                                <asp:HiddenField ID="hidMF" runat="server" />
