...
public partial class GUI_Operation_DeliveryMR_DeliveryMR : System.Web.UI.Page
{
    ...
    protected void btnstep1_Click(object sender, EventArgs e)
    {
        ...
        strsql = strsql + " prodcd,csgecd,csgenm,stax_exmpt_yn,CONVERT(INT,pkgsno) AS totpkgs,stax_paidby,curr_loc,invamt,GP.CodeDesc AS product,";
        strsql = strsql + " godown=(SELECT godown_desc AS godownname FROM dbo.webx_godownmst WITH(NOLOCK) WHERE godown_srno=s.godown),isNULL(arrpkgqty,d.PKGSNO) as arrpkgqty,isNULL(arrweightqty,d.ACTUWT) as arrweightqty";
    ...
    protected void calculateFreightDifference()
    {
        ...
        double freightdiff = 0, ActualFreightDiff = 0;
        TextBox txtdiffsubtotal = (TextBox)grvcharges.FooterRow.FindControl("txtdiffsubtotal");
        HiddenField Hdndiffsubtotal = (HiddenField)grvcharges.FooterRow.FindControl("Hdndiffsubtotal");
