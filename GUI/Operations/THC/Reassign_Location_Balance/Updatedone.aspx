<%@ Page Language="C#" MasterPageFile="~/GUI/MasterPage.master" AutoEventWireup="true" CodeFile="Updatedone.aspx.cs" Inherits="GUI_Operations_THC_Reassign_Location_Balance_Updatedone" %>
    ...
    <table border="0" cellpadding="0" class="boxbg" cellspacing="0">
        <tr bgcolor="white">
            <td align="left" colspan="5" height="30" style="width: 459px">
                ...
                <b>Exception</b></font></a> <b>&gt; </b><a href=""><font class="blklnkund">
                <b>Re-Assign THC Balance Payment Location Code</b></font></a> <b>&gt;</b>
            </td>
        </tr>
    </table>
    <br />
    ...
    <table align="center" bgcolor="#808080" border="0" cellpadding="3" cellspacing="1" class="boxbg" width="80%">
        <tr class="bgbluegrey">
            <td class="blackfnt" align="center" colspan="2">
                <b>Re-Assign THC Balance Payment Location Done Successfully</b>
            </td>
        </tr>
        <tr  bgcolor="white"  colspan="2">
            ...
            <td class="blackfnt" align="center">
                <a href="./THCBalanceLocationQuery.aspx">Click here to More Update THC Balance Payment Location</a>
            </td>
        </tr>
