<%@ Page Language="C#" AutoEventWireup="true" CodeFile="thcprintview_new.aspx.cs"
    Inherits="GUI_Operations_THC_ViewPrint_thcprintview_new" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td width="433" valign="top">
                        <table border="0" cellpadding="2" cellspacing="1" style="width: 5.0in" class="boxbg">
                            <tr bgcolor="#FFFFFF">
                                <td align="left">
                                    <font class="blackfnt">THC Number: </font>
                                </td>
                                <td align="left">
                                    <font class="blackfnt">
            ...
            <table style="width: 9.0in" border="0" cellspacing="1" cellpadding="2" class="boxbg">
                ...
                <tr bgcolor="#FFFFFF">
                    <td align="left">
                        <font class="blackfnt">THC Mode</font></td>
                    <td align="left">
