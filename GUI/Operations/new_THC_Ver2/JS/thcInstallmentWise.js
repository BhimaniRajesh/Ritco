...
function CheckManualDocNo() {
    var txtManualDOCNo = document.getElementById("ctl00_MyCPH1_txtManualTHCNo");
    var hdnajaxstate = document.getElementById("ctl00_MyCPH1_hdnajaxstate");

    hdnajaxstate.value = "1";

    if (txtManualDOCNo.value == "") {
    ...
    if (findobj) {
        strpg = "AjaxResponce.aspx?mode=ManualDOCNo&code1=" + txtManualDOCNo.value + "&sid=" + Math.random() + "&sid=" + Math.random();
        ...
        findobj.onreadystatechange = function () {
            if ((findobj.readyState == 4) && (findobj.status == 200)) {
                ...
                if (res[0] == "False") {
                    alert("entered Manual THC #:  " + txtManualDOCNo.value + " Already Exist in System. Please enter other Manual THC # ");
                    txtManualDOCNo.value = "NA";
                    txtManualDOCNo.focus();
                    return false;
                }
            }
        }
        ...
        case 'S'://Road
            ...
            switch (eval(doc + "cboVendorType").value) {
                ...
                default:
                    ...
                    if (eval(doc + "cboVehicles").value == 'O') {
                        if (Trim(eval(doc + "txtMktVeh").value) == '') {
                            alert('Enter Market Vehicle # :(');
                            eval(doc + "txtMktVeh").focus();
                            return false;
...
function GenerateTHC() {
    ...
    if (ret_boo) {
        ...
        if (eval(doc + "cboVendorType").value != "05") // Not Equal to Market
        {
    ...
    if (ret_boo)
    {
        eval(doc + "btnGenerateTHC").setAttribute("style", "display:none");
    }
...
function check_advancedetail() {
    ...
    //if (eval(doc + "hdnAdvpaidby").value == "") {
    //    alert("Please Select Advance Amount Paid By from dropdown.")
    //    return false;
    //}
    if (eval(doc + "hdnBalamtbr").value == "") {
        alert("Please Select Balance Payable At from dropdown.")
        return false;
    }
