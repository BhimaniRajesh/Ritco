            ...
            if ((parseFloat(hdnarrpkgqty.value) == parseFloat(hdnpkgsno.value) && ddlsuffix.value == "M") || ddlsuffix.value == ".") {
                ...
                if (parseFloat(txtcollamt.value) < parseFloat(DocketTotalGet())) {
                    ...
                    //GST Change
                        ...
                        //var checkbillamt = Math.abs(parseFloat(txtfreightdiff.value)) + parseFloat(txtservicetax.value) + parseFloat(txteducess.value) + parseFloat(txtheducess.value) + parseFloat(txtSBCTax.value) + parseFloat(txtKKCTax.value);
                                   ...
                                   Mode
                                    ...
                                    <asp:TableCell ColumnSpan="3">
                                        <asp:TextBox ID="txtcollamt" runat="server" MaxLength="9" Width="120px" Style="text-align: right"
                                            BorderStyle="Groove" CssClass="blackfnt" Text="0" onkeypress="javascript:return validFloat(event,this.getAttribute('id'))"
