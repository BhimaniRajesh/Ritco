...
public partial class GUI_Operations_DeliveryMR_DelMRCancel : System.Web.UI.Page
{
    ...
    private void CancelMR(DataRow drmain, DataRow drbill)
    {
        ...
        try
        {
            ...
            strsql = "UPDATE webx_trans_docket_status SET delivered='N',dely_date=NULL,gatepassno=NULL,receivercode=NULL,receivername=NULL,Delivery_Mr_Location=null,GatePass_Gen_Location=null,GatePass_Closure_Location=null,Op_Status=' Pending For Delivery MR' ";
