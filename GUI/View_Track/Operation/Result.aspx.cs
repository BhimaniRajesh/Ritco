        ...
        while (dr.Read())
        {
          ...
          //  // CS_JS1 = CS_JS1 + "\n   </script>";
            ...
            if (st_doctyp == "THC")
            {
                ...
                TR3TC3.Text = "<a href=\"#\" id='" + Clickdivid + "' rel='" + divid + "'><u>Track</u></a>  | <A href=\"JavaScript:OpenWindowTHC('" + dr["docno"].ToString() + ".,0')\"><u>View</u></a>| <A href=\"JavaScript:OpenWindowTHC('" + dr["docno"].ToString() + ".,1')\"><u>Print</u></a> ";
