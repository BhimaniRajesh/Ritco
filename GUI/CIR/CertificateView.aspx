<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GUI/MasterPage.master"  CodeFile="CertificateView.aspx.cs" Inherits="GUI_CIR_CertificateView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
  ...
  <br/>
     <hr/> 
      ...
      <tr style="background-color:White" align="center">
      <td align="left" >
                   <asp:Label ID="Label1"   class="blackfnt"  runat="server" Font-Bold="true" >Issusing Office</asp:Label>
