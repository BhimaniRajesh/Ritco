<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/GUI/MasterPage.master"  CodeFile="CIRAdded.aspx.cs" Inherits="GUI_CIR_CIRAdded" %>
...
<br><br>
    ...
    <table border="0" class="boxbg" cellpadding="2" cellspacing="1" width="70%">
        ...
        <tr style="background-color:White">
            <td align="center"> 
                <asp:Label ID="lblDocType" runat="server" Text=" Claim Investigation Report already added for this DocketNo!!" Font-Bold="true" CssClass="blackfnt"></asp:Label>
            </td>
