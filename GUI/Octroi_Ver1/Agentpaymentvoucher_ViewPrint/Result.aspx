...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    function OpenPopupWindow(arg1,arg2,arg3)
    {
        debugger;
        if(arg3=="0")
        {
            ...
            var strPopupURL = "../BillEntry_Payment/PaymentVoucherView.aspx?Voucherno=" + arg1 + "&VoucherType=" + arg2
            winNew = window.open(strPopupURL, "_blank", strWinFeature)            
        }
        else
        {
            var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=830,height=540,status=no,left=60,top=270"
            var strPopupURL = "../BillEntry_Payment/PaymentVoucherView1.aspx?Voucherno=" + arg1 + "&VoucherType=" + arg2
            winNew = window.open(strPopupURL, "_blank", strWinFeature)            
        }
                        ...
                        <tr>
                            <td height="30">
                                <font class="blklnkund"><strong>Module</strong></font> <strong>&gt; </strong><font
                                    ...
                                    </strong><strong>Agent Payment Voucher View & Print</strong> </font>
                            </td>
                        </tr>
                        <tr>
                            <td class="horzblue">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Voucher No">
                                ...
                                <ItemTemplate>
                                    ...
                                    <a href="JavaScript:OpenPopupWindow('<%#DataBinder.Eval(Container.DataItem, "VOUCHERNO") %>','BillPayment',0)">
                            ...
                            <asp:TemplateField HeaderText="Payment Date">
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                <ItemTemplate>
                                    <asp:Label ID="lblAgentdate" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"PayDt") %>'
                                        runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                           
                            ...
                            <asp:TemplateField HeaderText="Pending Amount">
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                <ItemTemplate>
                                    <asp:Label ID="lblPendamt" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"PendAmt") %>'
                                        runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Covering Letter">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblCover" Visible="false" CssClass="blackfnt" Font-Underline="true"
                                        Text='<%# DataBinder.Eval( Container.DataItem,"VOUCHERNO") %>' runat="server"></asp:LinkButton>
                                    <a href="JavaScript:OpenPopupWindow('<%#DataBinder.Eval(Container.DataItem, "VOUCHERNO") %>','BillPayment',1)">
                                        <font cssclass="Blackfnt">
                                            <%#DataBinder.Eval(Container.DataItem, "VOUCHERNO")%></a>
                                </ItemTemplate>
                            </asp:TemplateField>
