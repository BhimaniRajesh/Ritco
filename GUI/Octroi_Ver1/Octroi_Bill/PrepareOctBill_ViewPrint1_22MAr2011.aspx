<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrepareOctBill_ViewPrint1.aspx.cs" Inherits="GUI_Octroi_Ver1_Octroi_Bill_PrepareOctBill_ViewPrint1" %>
                    ...
                    <td style="width: 900px;" align="left">
                        ...
                        <asp:Panel ID="pnlFooter" runat="server">
                            <asp:GridView ID="gvOctroiDetails" OnPageIndexChanging="PageIndexChanged_Click" PagerStyle-Mode="NumericPages"
                                PageSize="50" AutoGenerateColumns="false" BackColor="white" runat="server" SelectedIndex="1" EmptyDataText="No Records Found..."
