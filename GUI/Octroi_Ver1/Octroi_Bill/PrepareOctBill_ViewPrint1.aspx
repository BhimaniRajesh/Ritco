<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrepareOctBill_ViewPrint1.aspx.cs"
    Inherits="GUI_Octroi_Ver1_Octroi_Bill_PrepareOctBill_ViewPrint1" %>
...
<body>
    ...
    <% string printyn = Request.QueryString.Get("printyn"); %>
    <div>
        <br />
            ...
            <tr>
                <td style="width: 900px;" align="left">
                    ...
                    <asp:Panel ID="pnlDetail" runat="server">
                        <table align="left" border="1" cellpadding="3" cellspacing="1" width="100%">
                            <tr style="height: 25px">
                            ...
                            <tr bgcolor="white" style="height: 15px">
                                ...
                                <td>
                                    <asp:Label ID="lblbillsubloc" runat="server" CssClass="blackfnt" Width="200px"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr bgcolor="white">
                                ...
                                <td>
                                    <asp:Label ID="lblbillcolloc" runat="server" CssClass="blackfnt" Width="200px"></asp:Label>
                                </td>
                            ...
                            <tr bgcolor="white">
                                ...
                                <td>
                                    <asp:Label ID="lblManualbillno" runat="server" CssClass="blackfnt" Width="150px"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr bgcolor="white">
                                ...
                                <td colspan="2">
                                    <asp:Label ID="lblRemark" runat="server" CssClass="blackfnt" Width="270px"></asp:Label>
                                </td>
                                <td>
                ...
                <td style="width: 900px;" align="left">
                    ...
                    <asp:Panel ID="pnlFooter" runat="server">
                        <asp:GridView ID="gvOctroiDetails" OnPageIndexChanging="PageIndexChanged_Click" PagerStyle-Mode="NumericPages"
                            PageSize="50" AutoGenerateColumns="false" BackColor="white" runat="server" SelectedIndex="1"
