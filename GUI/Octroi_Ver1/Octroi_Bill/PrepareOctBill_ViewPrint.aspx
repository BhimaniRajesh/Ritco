<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrepareOctBill_ViewPrint.aspx.cs" Inherits="GUI_Octroi_Ver1_Octroi_Bill_PrepareOctBill_ViewPrint" %>
                    ...
                    <asp:Panel ID="pnlDetail" runat="server">
                        <table align="left" border="0" cellpadding="3" cellspacing="1" class="boxbg" width="100%">
                            ...
                            <tr bgcolor="white" style="height: 15px">
                                ...
                                <td>
                                    <asp:Label ID="lblbgndt" runat="server" CssClass="blackfnt"
                                        Width="65px"></asp:Label><a href="#" onclick="cal.select(document.aspnetForm.ctl00_MyCPH1_txtbgndt,'anchor112','dd/MM/yyyy'); return false;"
                                ...
                                <td colspan="2">
                                    <asp:Label ID="lblduedate" runat="server" CssClass="blackfnt"
                            ...
                            <tr bgcolor="white" style="height: 15px">
                                ...
                                <td>                                   
                                    <asp:Label ID="lblbillsubloc" runat="server" CssClass="blackfnt"
                                        Width="200px"></asp:Label></td>
                                <td>
                                    <font class="blackfnt">Billing Party Address</font></td>
                                <td colspan="2">
                                    <asp:Label ID="Lbl_Party_address" runat="server" CssClass="blackfnt" Height="16px" Width="200px"></asp:Label>
                                </td>
                            </tr>
                            <tr bgcolor="white">
                                <td>
                                ...
                                <td>                                   
                                        <asp:Label ID="lblbillcolloc" runat="server" CssClass="blackfnt"
                                            Width="200px"></asp:Label></td>
                            ...
                            <tr bgcolor="white">
                                ...
                                <td>
                                    <asp:Label ID="lblManualbillno" runat="server" CssClass="blackfnt"
                            ...
                            <tr bgcolor="white">
                                ...
                                <td>
                                    &nbsp;<asp:Label ID="lblbillamt" runat="server" CssClass="blackfnt"
            ...
            <tr>
                ...
                <br />
                    <asp:Panel ID="pnlFooter" runat="server">
                        <asp:GridView ID="gvOctroiDetails" runat="server" BorderWidth="0px" CellPadding="2" CellSpacing="1" HeaderStyle-CssClass="bgbluegrey"
                                CssClass="boxbg" EmptyDataText="No Records Found..." AutoGenerateColumns="false" Width="100%">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Dockno" HeaderText="Cnote No.">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="True" CssClass="blackfnt" />
                                    <ItemStyle BackColor="White" CssClass="blackfnt" HorizontalAlign="Center"/>
                                </asp:BoundField>
