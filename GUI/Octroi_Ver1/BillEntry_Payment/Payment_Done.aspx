...
//    }
    ...
    function ViewPrint(arg1,arg2) 
        { 
         window.open("PaymentVoucherView.aspx?Voucherno=" + arg1 + "&VoucherType=" + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"); 
        }
