...
<script language="javascript" type="text/javascript">
    function ViewPrint(arg1,arg2) 
        { 
         window.open("../../Finance/VendorPayment_Ver1/ViewPrint/PO_BillPaymentView.aspx?Voucherno=" + arg1 + "," + arg2 ,"es","menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=650,height=290,status=no,left=60,top=125"); 
        }
</script>
...
<br /><br />
 <table border="0" width="100%">
      ...
      <tr style="background-color:White">
            <td align="center"> 
                <asp:Label ID="Lbl_GRN" runat="server" Text="Payement Voucerno" Font-Bold="True" CssClass="blackfnt"></asp:Label>
            </td>
            <td align="center"> 
