...
<asp:Content ID="Content1" ContentPlaceHolderID="MyCPH1" runat="Server">
    ...
    function OpenPopupWindow(arg1,arg2)
    {
        if(arg2=="0")
        {
            ...
            var strPopupURL = "../AgentBillEntry/Agent_Bill_Entry_ViewPrint.aspx?billno=" + arg1 + "&printyn=" + arg2
            winNew = window.open(strPopupURL, "_blank", strWinFeature)            
        }
        else
        {
            var strWinFeature = "menubar=no,toolbar=no,location=no,resizable=yes,scrollbars=yes,width=830,height=540,status=no,left=60,top=270"
            var strPopupURL = "../AgentBillEntry/Agent_Bill_Entry_ViewPrint1.aspx?billno=" + arg1 + "&printyn=" + arg2
            winNew = window.open(strPopupURL, "_blank", strWinFeature)            
        }
                        ...
                        <tr>
                            <td height="30">
                                <font class="blklnkund"><strong>Module</strong></font> <strong>&gt; </strong><font
                                    ...
                                    </strong><strong>Agent Octroi Bill View & Print</strong> </font>
                            </td>
                        </tr>
                        <tr>
                            <td class="horzblue">
            ...
            <tr>
                <td align="left">
                    <table id="tblall" runat="server" align="left" border="0" cellpadding="3" colspan="2"
                        ...
                        <tr bgcolor="#ffffff">
                            <td align="left">
                                <font class="blackfnt"><b>Agent Bill No.</b></font></td>
                            <td align="left">
                                <font class="blackfnt">
                    ...
                    <asp:GridView ID="GrdLoadUnload" Style="width: 10in" OnPageIndexChanging="PageIndexChanged_Click"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Bill Number">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblbillno" Visible="false" CssClass="blackfnt" Font-Underline="true"
                                        Text='<%# DataBinder.Eval( Container.DataItem,"OCBILLNO") %>' runat="server"></asp:LinkButton>
                                    <a href="JavaScript:OpenPopupWindow('<%#DataBinder.Eval(Container.DataItem, "OCBILLNO") %>',0)">
                                        <font cssclass="Blackfnt">
                                            <%#DataBinder.Eval(Container.DataItem, "OCBILLNO")%></a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Agent Name">
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                <ItemTemplate>
                                    <asp:Label ID="lblpartycode" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"Agent") %>'
                                        runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Agent Bill Date">
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" CssClass="blackfnt" />
                                <ItemTemplate>
                                    <asp:Label ID="lblAgentdate" CssClass="blackfnt" Text='<%# DataBinder.Eval( Container.DataItem,"AgentBillDt") %>'
                                        runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                           
                            ...
                            <asp:TemplateField HeaderText="Covering Letter">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblCover" Visible="false" CssClass="blackfnt" Font-Underline="true"
                                        Text='<%# DataBinder.Eval( Container.DataItem,"OCBILLNO") %>' runat="server"></asp:LinkButton>
                                    <a href="JavaScript:OpenPopupWindow('<%#DataBinder.Eval(Container.DataItem, "OCBILLNO") %>',1)">
                                        <font cssclass="Blackfnt">
                                            <%#DataBinder.Eval(Container.DataItem, "OCBILLNO")%></a>
                                </ItemTemplate>
                            </asp:TemplateField>
